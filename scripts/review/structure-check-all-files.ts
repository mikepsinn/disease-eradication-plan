...
async function main() {
  console.log('Checking brain/book files for stale structure-checks...');

  const staleFilesToCheck = await getStaleFiles('lastStructureCheckHash', 'brain/book');

  console.log(`\nFound ${staleFilesToCheck.length} stale files in brain/book to structure-check\n`);
