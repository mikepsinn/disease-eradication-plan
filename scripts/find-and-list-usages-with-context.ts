...
async function main() {
  ...
  try {
    ...
    // Note: Brace expansion {.qmd} doesn't work on Windows with single extension
    // Use simple pattern for single extension, brace expansion for multiple
    const globPattern = options.extensions.length === 1
