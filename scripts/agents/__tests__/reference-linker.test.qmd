...
A dFDA costs only $40 million to build and $40 million annually to operate.
...
A dFDA operational costs are {{< var dfda_annual_opex >}} per year.
...
Research shows [$50B](/knowledge/appendix/dfda-impact-paper.qmd#cost-reduction) in annual savings.
...
A 1% treaty would redirect 1% of [$2.7 trillion](/knowledge/problem/cost-of-war.qmd) in military spending.
...
The cost-effectiveness of [1,376x](/knowledge/appendix/dfda-impact-paper.qmd#cost-effectiveness) better than GiveWell charities.
