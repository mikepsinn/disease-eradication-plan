...
3.  **Decide Action:**
    ...
    *   If a suitable **existing figure** is found in the list, return a JSON object with the key `"existing_figure"` and the full path to the file. Example: `{ "existing_figure": "knowledge/figures/humanity-spending-priorities-bar-chart.qmd" }`.
...
**2. EXAMPLE 1: Column Chart (`knowledge/figures/military-vs-medical-research-spending-1-percent-treaty-column-chart.qmd`):**
...
plt.tight_layout()
plt.savefig('knowledge/figures/military-vs-medical-research-spending-1-percent-treaty-column-chart.png', dpi=300)
plt.show()
```
````

**3. EXAMPLE 2: Pie Chart (`knowledge/figures/humanitys-budget-pie-chart.qmd`):**
...
plt.savefig('knowledge/figures/humanitys-budget-pie-chart.png', dpi=300)
plt.show()
```
````
