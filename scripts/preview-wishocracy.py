#!/usr/bin/env python3
"""
Preview Wishocracy Paper Site
==============================

Quickly start preview server for the wishocracy paper website.
...
Usage:
    python scripts/preview-wishocracy.py                # Start preview server
    python scripts/preview-wishocracy.py --port 4200    # Custom port
    python scripts/preview-wishocracy.py --help         # Show all options
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Preview wishocracy paper website with live reload",
    ...
    print("[*] Starting preview server for wishocracy paper site...")
