...
export const DFDA_EFFICACY_LAG_ELIMINATION_DALYS: Parameter = {
  ...
  sourceType: "calculated",
  sourceRef: "https://impact.warondisease.org/knowledge/appendix/invisible-graveyard#daly-calculation",
  confidence: "medium",
  formula: "YLL + YLD",
...
export const DFDA_EFFICACY_LAG_ELIMINATION_DEATHS_AVERTED: Parameter = {
  ...
  sourceType: "calculated",
  sourceRef: "https://impact.warondisease.org/knowledge/appendix/invisible-graveyard#disease-eradication-delay",
  confidence: "medium",
...
export const DFDA_EFFICACY_LAG_ELIMINATION_ECONOMIC_VALUE: Parameter = {
  ...
  sourceType: "calculated",
  sourceRef: "https://impact.warondisease.org/knowledge/appendix/invisible-graveyard#economic-valuation",
  confidence: "medium",
...
export const TYPE_II_ERROR_COST_RATIO: Parameter = {
  ...
  sourceType: "calculated",
  sourceRef: "https://impact.warondisease.org/knowledge/appendix/invisible-graveyard#risk-analysis",
  confidence: "medium",
...
export const TREATY_REDIRECTED_SPENDING_INFINITE_ROI: Parameter = {
  ...
  sourceType: "definition",
  sourceRef: "https://impact.warondisease.org/knowledge/economics/1-pct-treaty-impact#infinite-roi",
  confidence: "high",
