...
export const DFDA_DIRECT_FUNDING_COST_PER_DALY: Parameter = {
  ...
  description: "Cost per DALY at ~$21.8B/year direct funding for the therapeutic space exploration period (NPV: ~$541.9B). Still highly cost-effective vs bed nets ($89.0/DALY).",
  sourceType: "calculated",
  confidence: "medium",
