...
export const DFDA_TRIAL_CAPACITY_PLUS_EFFICACY_LAG_LIVES_SAVED: Parameter = {
  ...
  latex: "\\begin{aligned}\nCapacity_{max,DFDA} = ANNUAL_DEATHS \\times DFDA_TRIAL_CAPACITY_PLUS_EFFICACY_LAG_YEARS \\times AVOIDABLE_PCT = 10.7B\n\\\\[0.5em]\n\\text{where } Capacity_{max,DFDA} = Ratio_{DFDA} + Delay = 204 + 8.2 = 212\n\\\\[0.5em]\n\\text{where } Ratio_{DFDA} = STATUS_QUO_AVG_YEARS_TO_FIRST_TREATMENT \\times (1 - 1/DFDA_TRIAL_CAPACITY_MULTIPLIER) = 204\n\\\\[0.5em]\n\\text{where } Status = Time \\times 0.5 = 443 \\times 0.5 = 222\n\\\\[0.5em]\n\\text{where } Time = \\frac{Diseases}{New} = \\frac{6{,}650}{15} = 443\n\\\\[0.5em]\n\\text{where } Diseases = Rare_{global} - 1 = 7{,}000 - 1 = 6{,}650\n\\\\[0.5em]\n\\text{where } Multiplier_{DFDA} = \\frac{Fundable_{ann}}{Trials_{curr}} = \\frac{23.4M}{1.9M} = 12.3\n\\\\[0.5em]\n\\text{where } Fundable_{ann} = \\frac{Treasury_{ann}}{Cost_{DFDA}} = \\frac{\\$21.7B}{\\$929} = 23.4M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = Treasury_{ann} - Cost_{DFDA,ann} = \\$21.8B - \\$40M = \\$21.7B\n\\\\[0.5em]\n\\text{where } Cost_{DFDA,ann} = Cost_{platform,DFDA} + Cost_{staff,DFDA} + Cost_{infra,DFDA} + Cost_{reg,DFDA} + Cost_{community,DFDA} = \\$15M + \\$10M + \\$8M + \\$5M + \\$2M = \\$40M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = TREATY_FUNDING - BOND_PAYOUT - IAB_POLITICAL_INCENTIVE_FUNDING = \\$21.8B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Victory_{annual} = Funding_{ann} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Funding_{ann} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\end{aligned}",
};
...
export const DFDA_TRIAL_CAPACITY_PLUS_EFFICACY_LAG_SUFFERING_HOURS: Parameter = {
  ...
  latex: "\\begin{aligned}\nCapacity_{max,DFDA} = DFDA_TRIAL_CAPACITY_PLUS_EFFICACY_LAG_DALYS \\times GLOBAL_YLD_PROPORTION \\times HOURS_PER_YEAR = 1930T\n\\\\[0.5em]\n\\text{where } DALYs_{max,DFDA} = DALYs_{ann} \\times DALYs \\times Capacity_{max,DFDA} = 2.88B \\times 92.6\\% \\times 212 = 565B\n\\\\[0.5em]\n\\text{where } Capacity_{max,DFDA} = Ratio_{DFDA} + Delay = 204 + 8.2 = 212\n\\\\[0.5em]\n\\text{where } Ratio_{DFDA} = STATUS_QUO_AVG_YEARS_TO_FIRST_TREATMENT \\times (1 - 1/DFDA_TRIAL_CAPACITY_MULTIPLIER) = 204\n\\\\[0.5em]\n\\text{where } Status = Time \\times 0.5 = 443 \\times 0.5 = 222\n\\\\[0.5em]\n\\text{where } Time = \\frac{Diseases}{New} = \\frac{6{,}650}{15} = 443\n\\\\[0.5em]\n\\text{where } Diseases = Rare_{global} - 1 = 7{,}000 - 1 = 6{,}650\n\\\\[0.5em]\n\\text{where } Multiplier_{DFDA} = \\frac{Fundable_{ann}}{Trials_{curr}} = \\frac{23.4M}{1.9M} = 12.3\n\\\\[0.5em]\n\\text{where } Fundable_{ann} = \\frac{Treasury_{ann}}{Cost_{DFDA}} = \\frac{\\$21.7B}{\\$929} = 23.4M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = Treasury_{ann} - Cost_{DFDA,ann} = \\$21.8B - \\$40M = \\$21.7B\n\\\\[0.5em]\n\\text{where } Cost_{DFDA,ann} = Cost_{platform,DFDA} + Cost_{staff,DFDA} + Cost_{infra,DFDA} + Cost_{reg,DFDA} + Cost_{community,DFDA} = \\$15M + \\$10M + \\$8M + \\$5M + \\$2M = \\$40M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = TREATY_FUNDING - BOND_PAYOUT - IAB_POLITICAL_INCENTIVE_FUNDING = \\$21.8B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Victory_{annual} = Funding_{ann} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Funding_{ann} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\end{aligned}",
};
...
export const DFDA_DIRECT_FUNDING_QUEUE_CLEARANCE_NPV: Parameter = {
  ...
  latex: "\\begin{aligned}\nFunding_{direct,DFDA} = ANNUAL_FUNDING \\times [(1 - (1 + r)^-T) / r] where T = queue clearance time = \\$475B\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = TREATY_FUNDING - BOND_PAYOUT - IAB_POLITICAL_INCENTIVE_FUNDING = \\$21.8B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Victory_{annual} = Funding_{ann} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Funding_{ann} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Time_{DFDA} = \\frac{Time}{Multiplier_{DFDA}} = \\frac{443}{12.3} = 36\n\\\\[0.5em]\n\\text{where } Time = \\frac{Diseases}{New} = \\frac{6{,}650}{15} = 443\n\\\\[0.5em]\n\\text{where } Diseases = Rare_{global} - 1 = 7{,}000 - 1 = 6{,}650\n\\\\[0.5em]\n\\text{where } Multiplier_{DFDA} = \\frac{Fundable_{ann}}{Trials_{curr}} = \\frac{23.4M}{1.9M} = 12.3\n\\\\[0.5em]\n\\text{where } Fundable_{ann} = \\frac{Treasury_{ann}}{Cost_{DFDA}} = \\frac{\\$21.7B}{\\$929} = 23.4M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = Treasury_{ann} - Cost_{DFDA,ann} = \\$21.8B - \\$40M = \\$21.7B\n\\\\[0.5em]\n\\text{where } Cost_{DFDA,ann} = Cost_{platform,DFDA} + Cost_{staff,DFDA} + Cost_{infra,DFDA} + Cost_{reg,DFDA} + Cost_{community,DFDA} = \\$15M + \\$10M + \\$8M + \\$5M + \\$2M = \\$40M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = TREATY_FUNDING - BOND_PAYOUT - IAB_POLITICAL_INCENTIVE_FUNDING = \\$21.8B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Victory_{annual} = Funding_{ann} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Funding_{ann} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\end{aligned}",
};
...
export const DIH_TREASURY_TO_MEDICAL_RESEARCH_ANNUAL: Parameter = {
  ...
  latex: "\\begin{aligned}\nTreasury_{ann} = TREATY_FUNDING - BOND_PAYOUT - IAB_POLITICAL_INCENTIVE_FUNDING = \\$21.8B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Victory_{annual} = Funding_{ann} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Funding_{ann} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\end{aligned}",
};
...
export const GLOBAL_MILITARY_SPENDING_POST_TREATY_ANNUAL_2024: Parameter = {
  ...
  latex: "\\begin{aligned}\nSpending_{mil,ann} \\\\\n&= MILITARY_SPENDING \\times (1 - REDUCTION) \\\\\n&= \\$2.69T\n\\end{aligned}",
};
