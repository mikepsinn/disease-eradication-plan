...
export const COMBINED_PEACE_HEALTH_DIVIDENDS_ANNUAL_FOR_ROI_CALC: Parameter = {
  ...
  latex: "\\begin{aligned}\nDividend_{ann} = Cost_{soc,ann} + Benefit_{DFDA,ann} = \\$114B + \\$58.6B = \\$172B\n\\\\[0.5em]\n\\text{where } Cost_{soc,ann} = Cost_{indirect,ann} \\times Reduction_{treaty} = \\$11.4T \\times 1\\% = \\$114B\n\\\\[0.5em]\n\\text{where } Cost_{indirect,ann} = Cost_{direct,total} + Cost_{indirect,total} = \\$7.66T + \\$3.7T = \\$11.4T\n\\\\[0.5em]\n\\text{where } Cost_{direct,total} = Loss_{human,ann} + Infrastructure_{global} + Disruption_{trade,ann} + Spending_{military,ann} = \\$2.45T + \\$1.88T + \\$616B + \\$2.72T = \\$7.66T\n\\\\[0.5em]\n\\text{where } Loss_{human,ann} = Cost_{combat,ann} + Cost_{state,ann} + Cost_{terror,ann} = \\$2.34T + \\$27B + \\$83B = \\$2.45T\n\\\\[0.5em]\n\\text{where } Cost_{combat,ann} = Deaths_{combat,ann} \\times Value = 234{,}000 \\times \\$10M = \\$2.34T\n\\\\[0.5em]\n\\text{where } Cost_{state,ann} = Deaths_{state,ann} \\times Value = 2{,}700 \\times \\$10M = \\$27B\n\\\\[0.5em]\n\\text{where } Cost_{terror,ann} = Deaths_{terror,ann} \\times Value = 8{,}300 \\times \\$10M = \\$83B\n\\\\[0.5em]\n\\text{where } Infrastructure_{global} = Damage_{comms,ann} + Damage_{edu,ann} + Damage_{energy,ann} + Damage_{health,ann} + Damage_{transport,ann} + Damage_{water,ann} = \\$298B + \\$234B + \\$422B + \\$166B + \\$487B + \\$268B = \\$1.88T\n\\\\[0.5em]\n\\text{where } Disruption_{trade,ann} = Cost_{currency,ann} + Cost_{energy,ann} + Cost_{shipping,ann} + Cost_{supply,ann} = \\$57.4B + \\$125B + \\$247B + \\$187B = \\$616B\n\\\\[0.5em]\n\\text{where } Cost_{indirect,total} = Cost_{env,ann} + Cost_{economic,ann} + Lost_{global} + Cost_{psychological,ann} + Cost_{refugee,ann} + Cost_{veteran,ann} = \\$100B + \\$2.72T + \\$300B + \\$232B + \\$150B + \\$200B = \\$3.7T\n\\\\[0.5em]\n\\text{where } Benefit_{DFDA,ann} = Trials_{ann} \\times Reduction_{DFDA} = \\$60B \\times 97.7\\% = \\$58.6B\n\\\\[0.5em]\n\\text{where } Reduction_{DFDA} = 1 - (DFDA\\_COST / TRADITIONAL\\_COST) = 97.7\\%\n\\end{aligned}",
};
...
export const CURRENT_KNOWN_SAFE_EXPLORATION_YEARS: Parameter = {
  ...
  latex: "\\begin{aligned}\nRatio_{curr} = DRUG\\_DISEASE\\_COMBINATIONS \\div CURRENT\\_TRIALS\\_PER\\_YEAR = 2{,}880\n\\\\[0.5em]\n\\text{where } Drug = Safe \\times Trials_{dis} = 9{,}500 \\times 1{,}000 = 9.5M\n\\end{aligned}",
};
...
export const DFDA_COMBINED_TREATMENT_SPEEDUP_MULTIPLIER: Parameter = {
  ...
  latex: "\\begin{aligned}\nMultiplier_{DFDA} = Multiplier_{trial} \\times Multiplier_{valley} = 12.3 \\times 1.4 = 17.2\n\\\\[0.5em]\n\\text{where } Multiplier_{DFDA} = \\frac{Fundable_{ann}}{Trials_{curr}} = \\frac{23.4M}{1.9M} = 12.3\n\\\\[0.5em]\n\\text{where } Fundable_{ann} = \\frac{Treasury_{ann}}{Cost_{DFDA}} = \\frac{\\$21.7B}{\\$929} = 23.4M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = Treasury_{ann} - OPEX_{dFDA} = \\$21.8B - \\$40M = \\$21.7B\n\\\\[0.5em]\n\\text{where } OPEX_{dFDA} = Cost_{platform} + Cost_{staff} + Cost_{infra} + Cost_{regulatory} + Cost_{community} = \\$15M + \\$10M + \\$8M + \\$5M + \\$2M = \\$40M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = TREATY\\_FUNDING - BOND\\_PAYOUT - IAB\\_POLITICAL\\_INCENTIVE\\_FUNDING = \\$21.8B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Victory_{annual} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Multiplier_{DFDA} = Deaths + 1 = 40\\% + 1 = 1.4\n\\end{aligned}",
};
...
export const DFDA_DIRECT_FUNDING_ROI_TRIAL_CAPACITY_PLUS_EFFICACY_LAG: Parameter = {
  ...
  latex: "\\begin{aligned}\nIncrease_{direct_funding,DFDA} = \\frac{Benefit_{trial,DFDA}}{Funding_{direct,DFDA}} = \\frac{\\$84800T}{\\$475B} = 178{,}000\n\\\\[0.5em]\n\\text{where } Benefit_{max,DFDA} = DALYs_{max,DFDA} \\times QALYs_{RD} = 565B \\times \\$150K = \\$84800T\n\\\\[0.5em]\n\\text{where } DALYs_{max,DFDA} = DALYs_{ann} \\times DALYs \\times Capacity_{max,DFDA} = 2.88B \\times 92.6\\% \\times 212 = 565B\n\\\\[0.5em]\n\\text{where } Capacity_{max,DFDA} = Ratio_{DFDA} + Delay = 204 + 8.2 = 212\n\\\\[0.5em]\n\\text{where } Ratio_{DFDA} = STATUS\\_QUO\\_AVG\\_YEARS\\_TO\\_FIRST\\_TREATMENT \\times (1 - 1/DFDA\\_TRIAL\\_CAPACITY\\_MULTIPLIER) = 204\n\\\\[0.5em]\n\\text{where } Status = Time \\times 0.5 = 443 \\times 0.5 = 222\n\\\\[0.5em]\n\\text{where } Time = \\frac{Diseases}{New} = \\frac{6{,}650}{15} = 443\n\\\\[0.5em]\n\\text{where } Diseases = Rare_{global} - 1 = 7{,}000 - 1 = 6{,}650\n\\\\[0.5em]\n\\text{where } Multiplier_{DFDA} = \\frac{Fundable_{ann}}{Trials_{curr}} = \\frac{23.4M}{1.9M} = 12.3\n\\\\[0.5em]\n\\text{where } Fundable_{ann} = \\frac{Treasury_{ann}}{Cost_{DFDA}} = \\frac{\\$21.7B}{\\$929} = 23.4M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = Treasury_{ann} - OPEX_{dFDA} = \\$21.8B - \\$40M = \\$21.7B\n\\\\[0.5em]\n\\text{where } OPEX_{dFDA} = Cost_{platform} + Cost_{staff} + Cost_{infra} + Cost_{regulatory} + Cost_{community} = \\$15M + \\$10M + \\$8M + \\$5M + \\$2M = \\$40M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = TREATY\\_FUNDING - BOND\\_PAYOUT - IAB\\_POLITICAL\\_INCENTIVE\\_FUNDING = \\$21.8B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Victory_{annual} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Funding_{direct,DFDA} = ANNUAL\\_FUNDING \\times [(1 - (1 + r)^-T) / r] where T = queue clearance time = \\$475B\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = TREATY\\_FUNDING - BOND\\_PAYOUT - IAB\\_POLITICAL\\_INCENTIVE\\_FUNDING = \\$21.8B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Victory_{annual} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Time_{DFDA} = \\frac{Time}{Multiplier_{DFDA}} = \\frac{443}{12.3} = 36\n\\\\[0.5em]\n\\text{where } Time = \\frac{Diseases}{New} = \\frac{6{,}650}{15} = 443\n\\\\[0.5em]\n\\text{where } Diseases = Rare_{global} - 1 = 7{,}000 - 1 = 6{,}650\n\\\\[0.5em]\n\\text{where } Multiplier_{DFDA} = \\frac{Fundable_{ann}}{Trials_{curr}} = \\frac{23.4M}{1.9M} = 12.3\n\\\\[0.5em]\n\\text{where } Fundable_{ann} = \\frac{Treasury_{ann}}{Cost_{DFDA}} = \\frac{\\$21.7B}{\\$929} = 23.4M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = Treasury_{ann} - OPEX_{dFDA} = \\$21.8B - \\$40M = \\$21.7B\n\\\\[0.5em]\n\\text{where } OPEX_{dFDA} = Cost_{platform} + Cost_{staff} + Cost_{infra} + Cost_{regulatory} + Cost_{community} = \\$15M + \\$10M + \\$8M + \\$5M + \\$2M = \\$40M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = TREATY\\_FUNDING - BOND\\_PAYOUT - IAB\\_POLITICAL\\_INCENTIVE\\_FUNDING = \\$21.8B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Victory_{annual} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\end{aligned}",
};
...
export const DFDA_DIRECT_FUNDING_VS_BED_NETS_MULTIPLIER: Parameter = {
  ...
  latex: "\\begin{aligned}\nMultiplier_{direct,DFDA} = \\frac{Cost_{net}}{Cost_{direct,DFDA}} = \\frac{\\$89}{\\$0.841} = 106\n\\\\[0.5em]\n\\text{where } Cost_{direct,DFDA} = \\frac{Funding_{direct,DFDA}}{DALYs_{trial,DFDA}} = \\frac{\\$475B}{565B} = \\$0.841\n\\\\[0.5em]\n\\text{where } Funding_{direct,DFDA} = ANNUAL\\_FUNDING \\times [(1 - (1 + r)^-T) / r] where T = queue clearance time = \\$475B\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = TREATY\\_FUNDING - BOND\\_PAYOUT - IAB\\_POLITICAL\\_INCENTIVE\\_FUNDING = \\$21.8B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Victory_{annual} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Time_{DFDA} = \\frac{Time}{Multiplier_{DFDA}} = \\frac{443}{12.3} = 36\n\\\\[0.5em]\n\\text{where } Time = \\frac{Diseases}{New} = \\frac{6{,}650}{15} = 443\n\\\\[0.5em]\n\\text{where } Diseases = Rare_{global} - 1 = 7{,}000 - 1 = 6{,}650\n\\\\[0.5em]\n\\text{where } Multiplier_{DFDA} = \\frac{Fundable_{ann}}{Trials_{curr}} = \\frac{23.4M}{1.9M} = 12.3\n\\\\[0.5em]\n\\text{where } Fundable_{ann} = \\frac{Treasury_{ann}}{Cost_{DFDA}} = \\frac{\\$21.7B}{\\$929} = 23.4M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = Treasury_{ann} - OPEX_{dFDA} = \\$21.8B - \\$40M = \\$21.7B\n\\\\[0.5em]\n\\text{where } OPEX_{dFDA} = Cost_{platform} + Cost_{staff} + Cost_{infra} + Cost_{regulatory} + Cost_{community} = \\$15M + \\$10M + \\$8M + \\$5M + \\$2M = \\$40M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = TREATY\\_FUNDING - BOND\\_PAYOUT - IAB\\_POLITICAL\\_INCENTIVE\\_FUNDING = \\$21.8B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Victory_{annual} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } DALYs_{max,DFDA} = DALYs_{ann} \\times DALYs \\times Capacity_{max,DFDA} = 2.88B \\times 92.6\\% \\times 212 = 565B\n\\\\[0.5em]\n\\text{where } Capacity_{max,DFDA} = Ratio_{DFDA} + Delay = 204 + 8.2 = 212\n\\\\[0.5em]\n\\text{where } Ratio_{DFDA} = STATUS\\_QUO\\_AVG\\_YEARS\\_TO\\_FIRST\\_TREATMENT \\times (1 - 1/DFDA\\_TRIAL\\_CAPACITY\\_MULTIPLIER) = 204\n\\\\[0.5em]\n\\text{where } Status = Time \\times 0.5 = 443 \\times 0.5 = 222\n\\\\[0.5em]\n\\text{where } Time = \\frac{Diseases}{New} = \\frac{6{,}650}{15} = 443\n\\\\[0.5em]\n\\text{where } Diseases = Rare_{global} - 1 = 7{,}000 - 1 = 6{,}650\n\\\\[0.5em]\n\\text{where } Multiplier_{DFDA} = \\frac{Fundable_{ann}}{Trials_{curr}} = \\frac{23.4M}{1.9M} = 12.3\n\\\\[0.5em]\n\\text{where } Fundable_{ann} = \\frac{Treasury_{ann}}{Cost_{DFDA}} = \\frac{\\$21.7B}{\\$929} = 23.4M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = Treasury_{ann} - OPEX_{dFDA} = \\$21.8B - \\$40M = \\$21.7B\n\\\\[0.5em]\n\\text{where } OPEX_{dFDA} = Cost_{platform} + Cost_{staff} + Cost_{infra} + Cost_{regulatory} + Cost_{community} = \\$15M + \\$10M + \\$8M + \\$5M + \\$2M = \\$40M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = TREATY\\_FUNDING - BOND\\_PAYOUT - IAB\\_POLITICAL\\_INCENTIVE\\_FUNDING = \\$21.8B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Victory_{annual} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\end{aligned}",
};
...
export const DFDA_EFFICACY_LAG_ELIMINATION_DALYS: Parameter = {
  ...
  confidence: "medium",
  formula: "YLL + YLD",
  latex: "\\begin{aligned}\nDALYs_{DFDA} = Delay_{yll} + Delay_{yld} = 7.07B + 873M = 7.94B\n\\\\[0.5em]\n\\text{where } Delay_{DFDA} = DEATHS\\_TOTAL \\times (LIFE\\_EXPECTANCY - MEAN\\_AGE\\_OF\\_DEATH) = 7.07B\n\\\\[0.5em]\n\\text{where } Deaths_{DFDA} = ANNUAL\\_DEATHS \\times EFFICACY\\_LAG\\_YEARS \\times EVENTUALLY\\_AVOIDABLE\\_DEATH\\_PCT = 416M\n\\\\[0.5em]\n\\text{where } Delay_{DFDA} = Deaths_{DFDA} \\times Deaths_{reg} \\times Chronic = 416M \\times 6 \\times 0.35 = 873M\n\\\\[0.5em]\n\\text{where } Deaths_{DFDA} = ANNUAL\\_DEATHS \\times EFFICACY\\_LAG\\_YEARS \\times EVENTUALLY\\_AVOIDABLE\\_DEATH\\_PCT = 416M\n\\end{aligned}",
};
...
export const DFDA_EFFICACY_LAG_ELIMINATION_ECONOMIC_VALUE: Parameter = {
  ...
  latex: "\\begin{aligned}\nDelay_{DFDA} = DALYs_{DFDA} \\times QALYs_{RD} = 7.94B \\times \\$150K = \\$1190T\n\\\\[0.5em]\n\\text{where } DALYs_{DFDA} = Delay_{yll} + Delay_{yld} = 7.07B + 873M = 7.94B\n\\\\[0.5em]\n\\text{where } Delay_{DFDA} = DEATHS\\_TOTAL \\times (LIFE\\_EXPECTANCY - MEAN\\_AGE\\_OF\\_DEATH) = 7.07B\n\\\\[0.5em]\n\\text{where } Deaths_{DFDA} = ANNUAL\\_DEATHS \\times EFFICACY\\_LAG\\_YEARS \\times EVENTUALLY\\_AVOIDABLE\\_DEATH\\_PCT = 416M\n\\\\[0.5em]\n\\text{where } Delay_{DFDA} = Deaths_{DFDA} \\times Deaths_{reg} \\times Chronic = 416M \\times 6 \\times 0.35 = 873M\n\\\\[0.5em]\n\\text{where } Deaths_{DFDA} = ANNUAL\\_DEATHS \\times EFFICACY\\_LAG\\_YEARS \\times EVENTUALLY\\_AVOIDABLE\\_DEATH\\_PCT = 416M\n\\end{aligned}",
};
...
export const DFDA_EFFICACY_LAG_ELIMINATION_YLD: Parameter = {
  ...
  latex: "\\begin{aligned}\nDelay_{DFDA} = Deaths_{DFDA} \\times Deaths_{reg} \\times Chronic = 416M \\times 6 \\times 0.35 = 873M\n\\\\[0.5em]\n\\text{where } Deaths_{DFDA} = ANNUAL\\_DEATHS \\times EFFICACY\\_LAG\\_YEARS \\times EVENTUALLY\\_AVOIDABLE\\_DEATH\\_PCT = 416M\n\\end{aligned}",
};
...
export const DFDA_EFFICACY_LAG_ELIMINATION_YLL: Parameter = {
  ...
  latex: "\\begin{aligned}\nDelay_{DFDA} = DEATHS\\_TOTAL \\times (LIFE\\_EXPECTANCY - MEAN\\_AGE\\_OF\\_DEATH) = 7.07B\n\\\\[0.5em]\n\\text{where } Deaths_{DFDA} = ANNUAL\\_DEATHS \\times EFFICACY\\_LAG\\_YEARS \\times EVENTUALLY\\_AVOIDABLE\\_DEATH\\_PCT = 416M\n\\end{aligned}",
};
...
export const DFDA_NET_SAVINGS_RD_ONLY_ANNUAL: Parameter = {
  ...
  latex: "\\begin{aligned}\nSavings_{net,ann} = Benefit_{benefit,ann} - OPEX_{dFDA} = \\$58.6B - \\$40M = \\$58.6B\n\\\\[0.5em]\n\\text{where } Benefit_{DFDA,ann} = Trials_{ann} \\times Reduction_{DFDA} = \\$60B \\times 97.7\\% = \\$58.6B\n\\\\[0.5em]\n\\text{where } Reduction_{DFDA} = 1 - (DFDA\\_COST / TRADITIONAL\\_COST) = 97.7\\%\n\\\\[0.5em]\n\\text{where } OPEX_{dFDA} = Cost_{platform} + Cost_{staff} + Cost_{infra} + Cost_{regulatory} + Cost_{community} = \\$15M + \\$10M + \\$8M + \\$5M + \\$2M = \\$40M\n\\end{aligned}",
};
...
export const DFDA_NPV_TOTAL_COST: Parameter = {
  ...
  latex: "\\begin{aligned}\nCost_{DFDA,total} = OPEX_{pv,ann} + Cost_{upfront,total} = \\$342M + \\$270M = \\$611M\n\\\\[0.5em]\n\\text{where } OPEX_{DFDA,ann} = OPEX \\times [(1 - (1 + r)^-T) / r] = \\$342M\n\\\\[0.5em]\n\\text{where } OPEX_{DFDA,total} = OPEX_{DFDA,ann} + OPEX_{opex,ann} = \\$18.9M + \\$21.1M = \\$40M\n\\\\[0.5em]\n\\text{where } Cost_{DFDA,total} = Cost_{DFDA,NPV} + Cost_{NPV} = \\$40M + \\$230M = \\$270M\n\\end{aligned}",
};
...
export const DFDA_ROI_RD_ONLY: Parameter = {
  ...
  latex: "\\begin{aligned}\nSavings_{DFDA,RD} = \\frac{Benefit_{benefit,RD}}{Cost_{DFDA,total}} = \\frac{\\$389B}{\\$611M} = 637\n\\\\[0.5em]\n\\text{where } Benefit_{DFDA,RD} = Sum of discounted annual net R&D savings with linear adoption ramp = \\$389B\n\\\\[0.5em]\n\\text{where } Savings_{net,ann} = Benefit_{benefit,ann} - OPEX_{dFDA} = \\$58.6B - \\$40M = \\$58.6B\n\\\\[0.5em]\n\\text{where } Benefit_{DFDA,ann} = Trials_{ann} \\times Reduction_{DFDA} = \\$60B \\times 97.7\\% = \\$58.6B\n\\\\[0.5em]\n\\text{where } Reduction_{DFDA} = 1 - (DFDA\\_COST / TRADITIONAL\\_COST) = 97.7\\%\n\\\\[0.5em]\n\\text{where } OPEX_{dFDA} = Cost_{platform} + Cost_{staff} + Cost_{infra} + Cost_{regulatory} + Cost_{community} = \\$15M + \\$10M + \\$8M + \\$5M + \\$2M = \\$40M\n\\\\[0.5em]\n\\text{where } Cost_{DFDA,total} = OPEX_{pv,ann} + Cost_{upfront,total} = \\$342M + \\$270M = \\$611M\n\\\\[0.5em]\n\\text{where } OPEX_{DFDA,ann} = OPEX \\times [(1 - (1 + r)^-T) / r] = \\$342M\n\\\\[0.5em]\n\\text{where } OPEX_{DFDA,total} = OPEX_{DFDA,ann} + OPEX_{opex,ann} = \\$18.9M + \\$21.1M = \\$40M\n\\\\[0.5em]\n\\text{where } Cost_{DFDA,total} = Cost_{DFDA,NPV} + Cost_{NPV} = \\$40M + \\$230M = \\$270M\n\\end{aligned}",
};
...
export const DFDA_TOTAL_EXPLORATION_YEARS: Parameter = {
  ...
  latex: "\\begin{aligned}\nRatio_{DFDA,total} = TOTAL\\_COMBINATIONS \\div DFDA\\_TRIALS\\_PER\\_YEAR = 1{,}270\n\\\\[0.5em]\n\\text{where } Testable_{total} = Drug + Emerging = 9.5M + 42M = 51.5M\n\\\\[0.5em]\n\\text{where } Drug = Safe \\times Trials_{dis} = 9{,}500 \\times 1{,}000 = 9.5M\n\\\\[0.5em]\n\\text{where } Emerging = Gene + Mrna + Epigenetic + Cell = 20M + 20M + 1.5M + 500{,}000 = 42M\n\\\\[0.5em]\n\\text{where } Gene = Human \\times Trials_{dis} = 20{,}000 \\times 1{,}000 = 20M\n\\\\[0.5em]\n\\text{where } Mrna = Human \\times Trials_{dis} = 20{,}000 \\times 1{,}000 = 20M\n\\\\[0.5em]\n\\text{where } Epigenetic = Epigenetic \\times Trials_{dis} = 1{,}500 \\times 1{,}000 = 1.5M\n\\\\[0.5em]\n\\text{where } Cell = Cell \\times Trials_{dis} = 500 \\times 1{,}000 = 500{,}000\n\\\\[0.5em]\n\\text{where } Capacity_{DFDA} = Trials_{curr} \\times Multiplier_{DFDA} = 3{,}300 \\times 12.3 = 40{,}600\n\\\\[0.5em]\n\\text{where } Multiplier_{DFDA} = \\frac{Fundable_{ann}}{Trials_{curr}} = \\frac{23.4M}{1.9M} = 12.3\n\\\\[0.5em]\n\\text{where } Fundable_{ann} = \\frac{Treasury_{ann}}{Cost_{DFDA}} = \\frac{\\$21.7B}{\\$929} = 23.4M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = Treasury_{ann} - OPEX_{dFDA} = \\$21.8B - \\$40M = \\$21.7B\n\\\\[0.5em]\n\\text{where } OPEX_{dFDA} = Cost_{platform} + Cost_{staff} + Cost_{infra} + Cost_{regulatory} + Cost_{community} = \\$15M + \\$10M + \\$8M + \\$5M + \\$2M = \\$40M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = TREATY\\_FUNDING - BOND\\_PAYOUT - IAB\\_POLITICAL\\_INCENTIVE\\_FUNDING = \\$21.8B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Victory_{annual} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\end{aligned}",
};
...
export const DFDA_TRIAL_CAPACITY_LIVES_SAVED: Parameter = {
  ...
  latex: "\\begin{aligned}\nIncrease_{DFDA} = ANNUAL\\_DEATHS \\times DFDA\\_TRIAL\\_CAPACITY\\_TREATMENT\\_ACCELERATION\\_YEARS \\times AVOIDABLE\\_PCT = 10.3B\n\\\\[0.5em]\n\\text{where } Ratio_{DFDA} = STATUS\\_QUO\\_AVG\\_YEARS\\_TO\\_FIRST\\_TREATMENT \\times (1 - 1/DFDA\\_TRIAL\\_CAPACITY\\_MULTIPLIER) = 204\n\\\\[0.5em]\n\\text{where } Status = Time \\times 0.5 = 443 \\times 0.5 = 222\n\\\\[0.5em]\n\\text{where } Time = \\frac{Diseases}{New} = \\frac{6{,}650}{15} = 443\n\\\\[0.5em]\n\\text{where } Diseases = Rare_{global} - 1 = 7{,}000 - 1 = 6{,}650\n\\\\[0.5em]\n\\text{where } Multiplier_{DFDA} = \\frac{Fundable_{ann}}{Trials_{curr}} = \\frac{23.4M}{1.9M} = 12.3\n\\\\[0.5em]\n\\text{where } Fundable_{ann} = \\frac{Treasury_{ann}}{Cost_{DFDA}} = \\frac{\\$21.7B}{\\$929} = 23.4M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = Treasury_{ann} - OPEX_{dFDA} = \\$21.8B - \\$40M = \\$21.7B\n\\\\[0.5em]\n\\text{where } OPEX_{dFDA} = Cost_{platform} + Cost_{staff} + Cost_{infra} + Cost_{regulatory} + Cost_{community} = \\$15M + \\$10M + \\$8M + \\$5M + \\$2M = \\$40M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = TREATY\\_FUNDING - BOND\\_PAYOUT - IAB\\_POLITICAL\\_INCENTIVE\\_FUNDING = \\$21.8B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Victory_{annual} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\end{aligned}",
};
...
export const DFDA_TRIAL_CAPACITY_PLUS_EFFICACY_LAG_DALYS: Parameter = {
  ...
  latex: "\\begin{aligned}\nDALYs_{max,DFDA} = DALYs_{ann} \\times DALYs \\times Capacity_{max,DFDA} = 2.88B \\times 92.6\\% \\times 212 = 565B\n\\\\[0.5em]\n\\text{where } Capacity_{max,DFDA} = Ratio_{DFDA} + Delay = 204 + 8.2 = 212\n\\\\[0.5em]\n\\text{where } Ratio_{DFDA} = STATUS\\_QUO\\_AVG\\_YEARS\\_TO\\_FIRST\\_TREATMENT \\times (1 - 1/DFDA\\_TRIAL\\_CAPACITY\\_MULTIPLIER) = 204\n\\\\[0.5em]\n\\text{where } Status = Time \\times 0.5 = 443 \\times 0.5 = 222\n\\\\[0.5em]\n\\text{where } Time = \\frac{Diseases}{New} = \\frac{6{,}650}{15} = 443\n\\\\[0.5em]\n\\text{where } Diseases = Rare_{global} - 1 = 7{,}000 - 1 = 6{,}650\n\\\\[0.5em]\n\\text{where } Multiplier_{DFDA} = \\frac{Fundable_{ann}}{Trials_{curr}} = \\frac{23.4M}{1.9M} = 12.3\n\\\\[0.5em]\n\\text{where } Fundable_{ann} = \\frac{Treasury_{ann}}{Cost_{DFDA}} = \\frac{\\$21.7B}{\\$929} = 23.4M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = Treasury_{ann} - OPEX_{dFDA} = \\$21.8B - \\$40M = \\$21.7B\n\\\\[0.5em]\n\\text{where } OPEX_{dFDA} = Cost_{platform} + Cost_{staff} + Cost_{infra} + Cost_{regulatory} + Cost_{community} = \\$15M + \\$10M + \\$8M + \\$5M + \\$2M = \\$40M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = TREATY\\_FUNDING - BOND\\_PAYOUT - IAB\\_POLITICAL\\_INCENTIVE\\_FUNDING = \\$21.8B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Victory_{annual} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\end{aligned}",
};
...
export const DFDA_TRIAL_CAPACITY_PLUS_EFFICACY_LAG_ECONOMIC_VALUE: Parameter = {
  ...
  latex: "\\begin{aligned}\nBenefit_{max,DFDA} = DALYs_{max,DFDA} \\times QALYs_{RD} = 565B \\times \\$150K = \\$84800T\n\\\\[0.5em]\n\\text{where } DALYs_{max,DFDA} = DALYs_{ann} \\times DALYs \\times Capacity_{max,DFDA} = 2.88B \\times 92.6\\% \\times 212 = 565B\n\\\\[0.5em]\n\\text{where } Capacity_{max,DFDA} = Ratio_{DFDA} + Delay = 204 + 8.2 = 212\n\\\\[0.5em]\n\\text{where } Ratio_{DFDA} = STATUS\\_QUO\\_AVG\\_YEARS\\_TO\\_FIRST\\_TREATMENT \\times (1 - 1/DFDA\\_TRIAL\\_CAPACITY\\_MULTIPLIER) = 204\n\\\\[0.5em]\n\\text{where } Status = Time \\times 0.5 = 443 \\times 0.5 = 222\n\\\\[0.5em]\n\\text{where } Time = \\frac{Diseases}{New} = \\frac{6{,}650}{15} = 443\n\\\\[0.5em]\n\\text{where } Diseases = Rare_{global} - 1 = 7{,}000 - 1 = 6{,}650\n\\\\[0.5em]\n\\text{where } Multiplier_{DFDA} = \\frac{Fundable_{ann}}{Trials_{curr}} = \\frac{23.4M}{1.9M} = 12.3\n\\\\[0.5em]\n\\text{where } Fundable_{ann} = \\frac{Treasury_{ann}}{Cost_{DFDA}} = \\frac{\\$21.7B}{\\$929} = 23.4M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = Treasury_{ann} - OPEX_{dFDA} = \\$21.8B - \\$40M = \\$21.7B\n\\\\[0.5em]\n\\text{where } OPEX_{dFDA} = Cost_{platform} + Cost_{staff} + Cost_{infra} + Cost_{regulatory} + Cost_{community} = \\$15M + \\$10M + \\$8M + \\$5M + \\$2M = \\$40M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = TREATY\\_FUNDING - BOND\\_PAYOUT - IAB\\_POLITICAL\\_INCENTIVE\\_FUNDING = \\$21.8B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Victory_{annual} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\end{aligned}",
};
...
export const DFDA_TRIAL_CAPACITY_PLUS_EFFICACY_LAG_LIVES_SAVED: Parameter = {
  ...
  latex: "\\begin{aligned}\nCapacity_{max,DFDA} = ANNUAL\\_DEATHS \\times DFDA\\_TRIAL\\_CAPACITY\\_PLUS\\_EFFICACY\\_LAG\\_YEARS \\times AVOIDABLE\\_PCT = 10.7B\n\\\\[0.5em]\n\\text{where } Capacity_{max,DFDA} = Ratio_{DFDA} + Delay = 204 + 8.2 = 212\n\\\\[0.5em]\n\\text{where } Ratio_{DFDA} = STATUS\\_QUO\\_AVG\\_YEARS\\_TO\\_FIRST\\_TREATMENT \\times (1 - 1/DFDA\\_TRIAL\\_CAPACITY\\_MULTIPLIER) = 204\n\\\\[0.5em]\n\\text{where } Status = Time \\times 0.5 = 443 \\times 0.5 = 222\n\\\\[0.5em]\n\\text{where } Time = \\frac{Diseases}{New} = \\frac{6{,}650}{15} = 443\n\\\\[0.5em]\n\\text{where } Diseases = Rare_{global} - 1 = 7{,}000 - 1 = 6{,}650\n\\\\[0.5em]\n\\text{where } Multiplier_{DFDA} = \\frac{Fundable_{ann}}{Trials_{curr}} = \\frac{23.4M}{1.9M} = 12.3\n\\\\[0.5em]\n\\text{where } Fundable_{ann} = \\frac{Treasury_{ann}}{Cost_{DFDA}} = \\frac{\\$21.7B}{\\$929} = 23.4M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = Treasury_{ann} - OPEX_{dFDA} = \\$21.8B - \\$40M = \\$21.7B\n\\\\[0.5em]\n\\text{where } OPEX_{dFDA} = Cost_{platform} + Cost_{staff} + Cost_{infra} + Cost_{regulatory} + Cost_{community} = \\$15M + \\$10M + \\$8M + \\$5M + \\$2M = \\$40M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = TREATY\\_FUNDING - BOND\\_PAYOUT - IAB\\_POLITICAL\\_INCENTIVE\\_FUNDING = \\$21.8B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Victory_{annual} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\end{aligned}",
};
...
export const DFDA_TRIAL_CAPACITY_PLUS_EFFICACY_LAG_SUFFERING_HOURS: Parameter = {
  ...
  latex: "\\begin{aligned}\nCapacity_{max,DFDA} = DFDA\\_TRIAL\\_CAPACITY\\_PLUS\\_EFFICACY\\_LAG\\_DALYS \\times GLOBAL\\_YLD\\_PROPORTION \\times HOURS\\_PER\\_YEAR = 1930T\n\\\\[0.5em]\n\\text{where } DALYs_{max,DFDA} = DALYs_{ann} \\times DALYs \\times Capacity_{max,DFDA} = 2.88B \\times 92.6\\% \\times 212 = 565B\n\\\\[0.5em]\n\\text{where } Capacity_{max,DFDA} = Ratio_{DFDA} + Delay = 204 + 8.2 = 212\n\\\\[0.5em]\n\\text{where } Ratio_{DFDA} = STATUS\\_QUO\\_AVG\\_YEARS\\_TO\\_FIRST\\_TREATMENT \\times (1 - 1/DFDA\\_TRIAL\\_CAPACITY\\_MULTIPLIER) = 204\n\\\\[0.5em]\n\\text{where } Status = Time \\times 0.5 = 443 \\times 0.5 = 222\n\\\\[0.5em]\n\\text{where } Time = \\frac{Diseases}{New} = \\frac{6{,}650}{15} = 443\n\\\\[0.5em]\n\\text{where } Diseases = Rare_{global} - 1 = 7{,}000 - 1 = 6{,}650\n\\\\[0.5em]\n\\text{where } Multiplier_{DFDA} = \\frac{Fundable_{ann}}{Trials_{curr}} = \\frac{23.4M}{1.9M} = 12.3\n\\\\[0.5em]\n\\text{where } Fundable_{ann} = \\frac{Treasury_{ann}}{Cost_{DFDA}} = \\frac{\\$21.7B}{\\$929} = 23.4M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = Treasury_{ann} - OPEX_{dFDA} = \\$21.8B - \\$40M = \\$21.7B\n\\\\[0.5em]\n\\text{where } OPEX_{dFDA} = Cost_{platform} + Cost_{staff} + Cost_{infra} + Cost_{regulatory} + Cost_{community} = \\$15M + \\$10M + \\$8M + \\$5M + \\$2M = \\$40M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = TREATY\\_FUNDING - BOND\\_PAYOUT - IAB\\_POLITICAL\\_INCENTIVE\\_FUNDING = \\$21.8B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Victory_{annual} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\end{aligned}",
};
...
export const DFDA_TRIAL_CAPACITY_PLUS_EFFICACY_LAG_YEARS: Parameter = {
  ...
  latex: "\\begin{aligned}\nCapacity_{max,DFDA} = Ratio_{DFDA} + Delay = 204 + 8.2 = 212\n\\\\[0.5em]\n\\text{where } Ratio_{DFDA} = STATUS\\_QUO\\_AVG\\_YEARS\\_TO\\_FIRST\\_TREATMENT \\times (1 - 1/DFDA\\_TRIAL\\_CAPACITY\\_MULTIPLIER) = 204\n\\\\[0.5em]\n\\text{where } Status = Time \\times 0.5 = 443 \\times 0.5 = 222\n\\\\[0.5em]\n\\text{where } Time = \\frac{Diseases}{New} = \\frac{6{,}650}{15} = 443\n\\\\[0.5em]\n\\text{where } Diseases = Rare_{global} - 1 = 7{,}000 - 1 = 6{,}650\n\\\\[0.5em]\n\\text{where } Multiplier_{DFDA} = \\frac{Fundable_{ann}}{Trials_{curr}} = \\frac{23.4M}{1.9M} = 12.3\n\\\\[0.5em]\n\\text{where } Fundable_{ann} = \\frac{Treasury_{ann}}{Cost_{DFDA}} = \\frac{\\$21.7B}{\\$929} = 23.4M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = Treasury_{ann} - OPEX_{dFDA} = \\$21.8B - \\$40M = \\$21.7B\n\\\\[0.5em]\n\\text{where } OPEX_{dFDA} = Cost_{platform} + Cost_{staff} + Cost_{infra} + Cost_{regulatory} + Cost_{community} = \\$15M + \\$10M + \\$8M + \\$5M + \\$2M = \\$40M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = TREATY\\_FUNDING - BOND\\_PAYOUT - IAB\\_POLITICAL\\_INCENTIVE\\_FUNDING = \\$21.8B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Victory_{annual} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\end{aligned}",
};
...
export const DFDA_TRIAL_CAPACITY_TREATMENT_ACCELERATION_YEARS: Parameter = {
  ...
  latex: "\\begin{aligned}\nRatio_{DFDA} = STATUS\\_QUO\\_AVG\\_YEARS\\_TO\\_FIRST\\_TREATMENT \\times (1 - 1/DFDA\\_TRIAL\\_CAPACITY\\_MULTIPLIER) = 204\n\\\\[0.5em]\n\\text{where } Status = Time \\times 0.5 = 443 \\times 0.5 = 222\n\\\\[0.5em]\n\\text{where } Time = \\frac{Diseases}{New} = \\frac{6{,}650}{15} = 443\n\\\\[0.5em]\n\\text{where } Diseases = Rare_{global} - 1 = 7{,}000 - 1 = 6{,}650\n\\\\[0.5em]\n\\text{where } Multiplier_{DFDA} = \\frac{Fundable_{ann}}{Trials_{curr}} = \\frac{23.4M}{1.9M} = 12.3\n\\\\[0.5em]\n\\text{where } Fundable_{ann} = \\frac{Treasury_{ann}}{Cost_{DFDA}} = \\frac{\\$21.7B}{\\$929} = 23.4M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = Treasury_{ann} - OPEX_{dFDA} = \\$21.8B - \\$40M = \\$21.7B\n\\\\[0.5em]\n\\text{where } OPEX_{dFDA} = Cost_{platform} + Cost_{staff} + Cost_{infra} + Cost_{regulatory} + Cost_{community} = \\$15M + \\$10M + \\$8M + \\$5M + \\$2M = \\$40M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = TREATY\\_FUNDING - BOND\\_PAYOUT - IAB\\_POLITICAL\\_INCENTIVE\\_FUNDING = \\$21.8B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Victory_{annual} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\end{aligned}",
};
...
export const DFDA_TRIAL_COST_REDUCTION_PCT: Parameter = {
  ...
  latex: "\\begin{aligned}\nReduction_{DFDA} \\\\\n&= 1 - (DFDA\\_COST / TRADITIONAL\\_COST) \\\\\n&= 97.7\\%\n\\end{aligned}",
};
...
export const DIH_TREASURY_TRIAL_SUBSIDIES_ANNUAL: Parameter = {
  ...
  latex: "\\begin{aligned}\nTreasury_{ann} = Treasury_{ann} - OPEX_{dFDA} = \\$21.8B - \\$40M = \\$21.7B\n\\\\[0.5em]\n\\text{where } OPEX_{dFDA} = Cost_{platform} + Cost_{staff} + Cost_{infra} + Cost_{regulatory} + Cost_{community} = \\$15M + \\$10M + \\$8M + \\$5M + \\$2M = \\$40M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = TREATY\\_FUNDING - BOND\\_PAYOUT - IAB\\_POLITICAL\\_INCENTIVE\\_FUNDING = \\$21.8B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Victory_{annual} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\end{aligned}",
};
...
export const DIVIDEND_COVERAGE_FACTOR: Parameter = {
  ...
  latex: "\\begin{aligned}\nOPEX = \\frac{Funding_{treaty}}{OPEX_{dFDA}} = \\frac{\\$27.2B}{\\$40M} = 680\n\\\\[0.5em]\n\\text{where } OPEX_{dFDA} = Cost_{platform} + Cost_{staff} + Cost_{infra} + Cost_{regulatory} + Cost_{community} = \\$15M + \\$10M + \\$8M + \\$5M + \\$2M = \\$40M\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\end{aligned}",
};
...
export const GLOBAL_ANNUAL_CONFLICT_DEATHS_TOTAL: Parameter = {
  ...
  latex: "\\begin{aligned}\nDeaths_{total} \\\\\n&= Deaths_{combat,ann} + Deaths_{state,ann} \\\\\n&\\quad + Deaths_{terror,ann} \\\\\n&= 234{,}000 + 2{,}700 + 8{,}300 \\\\\n&= 245{,}000\n\\end{aligned}",
};
...
export const GLOBAL_ANNUAL_HUMAN_LIFE_LOSSES_CONFLICT: Parameter = {
  ...
  latex: "\\begin{aligned}\nLoss_{human,ann} = Cost_{combat,ann} + Cost_{state,ann} + Cost_{terror,ann} = \\$2.34T + \\$27B + \\$83B = \\$2.45T\n\\\\[0.5em]\n\\text{where } Cost_{combat,ann} = Deaths_{combat,ann} \\times Value = 234{,}000 \\times \\$10M = \\$2.34T\n\\\\[0.5em]\n\\text{where } Cost_{state,ann} = Deaths_{state,ann} \\times Value = 2{,}700 \\times \\$10M = \\$27B\n\\\\[0.5em]\n\\text{where } Cost_{terror,ann} = Deaths_{terror,ann} \\times Value = 8{,}300 \\times \\$10M = \\$83B\n\\end{aligned}",
};
...
export const GLOBAL_ANNUAL_INFRASTRUCTURE_DESTRUCTION_CONFLICT: Parameter = {
  ...
  latex: "\\begin{aligned}\nInfrastructure_{global} \\\\\n&= Damage_{comms,ann} + Damage_{edu,ann} + Damage_{energy,ann} \\\\\n&\\quad + Damage_{health,ann} + Damage_{transport,ann} \\\\\n&\\quad + Damage_{water,ann} \\\\\n&= \\$298B + \\$234B + \\$422B + \\$166B + \\$487B + \\$268B \\\\\n&= \\$1.88T\n\\end{aligned}",
};
...
export const GLOBAL_ANNUAL_TRADE_DISRUPTION_CONFLICT: Parameter = {
  ...
  latex: "\\begin{aligned}\nDisruption_{trade,ann} \\\\\n&= Cost_{currency,ann} + Cost_{energy,ann} \\\\\n&\\quad + Cost_{shipping,ann} + Cost_{supply,ann} \\\\\n&= \\$57.4B + \\$125B + \\$247B + \\$187B \\\\\n&= \\$616B\n\\end{aligned}",
};
...
export const GLOBAL_ANNUAL_WAR_DIRECT_COSTS_TOTAL: Parameter = {
  ...
  latex: "\\begin{aligned}\nCost_{direct,total} = Loss_{human,ann} + Infrastructure_{global} + Disruption_{trade,ann} + Spending_{military,ann} = \\$2.45T + \\$1.88T + \\$616B + \\$2.72T = \\$7.66T\n\\\\[0.5em]\n\\text{where } Loss_{human,ann} = Cost_{combat,ann} + Cost_{state,ann} + Cost_{terror,ann} = \\$2.34T + \\$27B + \\$83B = \\$2.45T\n\\\\[0.5em]\n\\text{where } Cost_{combat,ann} = Deaths_{combat,ann} \\times Value = 234{,}000 \\times \\$10M = \\$2.34T\n\\\\[0.5em]\n\\text{where } Cost_{state,ann} = Deaths_{state,ann} \\times Value = 2{,}700 \\times \\$10M = \\$27B\n\\\\[0.5em]\n\\text{where } Cost_{terror,ann} = Deaths_{terror,ann} \\times Value = 8{,}300 \\times \\$10M = \\$83B\n\\\\[0.5em]\n\\text{where } Infrastructure_{global} = Damage_{comms,ann} + Damage_{edu,ann} + Damage_{energy,ann} + Damage_{health,ann} + Damage_{transport,ann} + Damage_{water,ann} = \\$298B + \\$234B + \\$422B + \\$166B + \\$487B + \\$268B = \\$1.88T\n\\\\[0.5em]\n\\text{where } Disruption_{trade,ann} = Cost_{currency,ann} + Cost_{energy,ann} + Cost_{shipping,ann} + Cost_{supply,ann} = \\$57.4B + \\$125B + \\$247B + \\$187B = \\$616B\n\\end{aligned}",
};
...
export const GLOBAL_ANNUAL_WAR_INDIRECT_COSTS_TOTAL: Parameter = {
  ...
  latex: "\\begin{aligned}\nCost_{indirect,total} \\\\\n&= Cost_{env,ann} + Cost_{economic,ann} + Lost_{global} \\\\\n&\\quad + Cost_{psychological,ann} + Cost_{refugee,ann} \\\\\n&\\quad + Cost_{veteran,ann} \\\\\n&= \\$100B + \\$2.72T + \\$300B + \\$232B + \\$150B + \\$200B \\\\\n&= \\$3.7T\n\\end{aligned}",
};
...
export const GLOBAL_COST_PER_LIFE_SAVED_MED_RESEARCH_ANNUAL: Parameter = {
  ...
  latex: "\\begin{aligned}\nCost_{ann} \\\\\n&= \\frac{Spending_{med,global}}{Lives_{lives,ann}} \\\\\n&= \\frac{\\$67.5B}{4.2M} \\\\\n&= \\$16.1K\n\\end{aligned}",
};
...
export const GLOBAL_DISEASE_ECONOMIC_BURDEN_ANNUAL: Parameter = {
  ...
  latex: "\\begin{aligned}\nBurden_{ann} \\\\\n&= Cost_{direct,ann} + Loss_{human,ann} \\\\\n&\\quad + Loss_{productivity,ann} \\\\\n&= \\$9.9T + \\$94.2T + \\$5T \\\\\n&= \\$109T\n\\end{aligned}",
};
...
export const GLOBAL_INDUSTRY_CLINICAL_TRIALS_SPENDING_ANNUAL: Parameter = {
  ...
  latex: "\\begin{aligned}\nTrials_{ann} \\\\\n&= Trials_{clinical,ann} - Trials_{government,ann} \\\\\n&= \\$60B - \\$4.5B \\\\\n&= \\$55.5B\n\\end{aligned}",
};
...
export const GLOBAL_MILITARY_SPENDING_PER_CAPITA_ANNUAL: Parameter = {
  ...
  latex: "\\begin{aligned}\nSpending_{percap,ann} \\\\\n&= \\frac{Spending_{military,ann}}{Population_{population,global}} \\\\\n&= \\frac{\\$2.72T}{8B} \\\\\n&= \\$340\n\\end{aligned}",
};
...
export const GLOBAL_TOTAL_HEALTH_AND_WAR_COST_ANNUAL: Parameter = {
  ...
  latex: "\\begin{aligned}\nCost_{total} = Cost_{indirect,ann} + Burden_{disease,ann} + Spending_{symptomatic,ann} = \\$11.4T + \\$109T + \\$8.2T = \\$129T\n\\\\[0.5em]\n\\text{where } Cost_{indirect,ann} = Cost_{direct,total} + Cost_{indirect,total} = \\$7.66T + \\$3.7T = \\$11.4T\n\\\\[0.5em]\n\\text{where } Cost_{direct,total} = Loss_{human,ann} + Infrastructure_{global} + Disruption_{trade,ann} + Spending_{military,ann} = \\$2.45T + \\$1.88T + \\$616B + \\$2.72T = \\$7.66T\n\\\\[0.5em]\n\\text{where } Loss_{human,ann} = Cost_{combat,ann} + Cost_{state,ann} + Cost_{terror,ann} = \\$2.34T + \\$27B + \\$83B = \\$2.45T\n\\\\[0.5em]\n\\text{where } Cost_{combat,ann} = Deaths_{combat,ann} \\times Value = 234{,}000 \\times \\$10M = \\$2.34T\n\\\\[0.5em]\n\\text{where } Cost_{state,ann} = Deaths_{state,ann} \\times Value = 2{,}700 \\times \\$10M = \\$27B\n\\\\[0.5em]\n\\text{where } Cost_{terror,ann} = Deaths_{terror,ann} \\times Value = 8{,}300 \\times \\$10M = \\$83B\n\\\\[0.5em]\n\\text{where } Infrastructure_{global} = Damage_{comms,ann} + Damage_{edu,ann} + Damage_{energy,ann} + Damage_{health,ann} + Damage_{transport,ann} + Damage_{water,ann} = \\$298B + \\$234B + \\$422B + \\$166B + \\$487B + \\$268B = \\$1.88T\n\\\\[0.5em]\n\\text{where } Disruption_{trade,ann} = Cost_{currency,ann} + Cost_{energy,ann} + Cost_{shipping,ann} + Cost_{supply,ann} = \\$57.4B + \\$125B + \\$247B + \\$187B = \\$616B\n\\\\[0.5em]\n\\text{where } Cost_{indirect,total} = Cost_{env,ann} + Cost_{economic,ann} + Lost_{global} + Cost_{psychological,ann} + Cost_{refugee,ann} + Cost_{veteran,ann} = \\$100B + \\$2.72T + \\$300B + \\$232B + \\$150B + \\$200B = \\$3.7T\n\\\\[0.5em]\n\\text{where } Burden_{ann} = Cost_{direct,ann} + Loss_{human,ann} + Loss_{productivity,ann} = \\$9.9T + \\$94.2T + \\$5T = \\$109T\n\\end{aligned}",
};
...
export const LIFE_EXPECTANCY_GAIN_1883_1962_YEARS_PER_DECADE: Parameter = {
  ...
  latex: "Rate = (life\\_exp\\_1962 - life\\_exp\\_1880) / 7.9 decades = 0",
  peerReviewed: true,
};
...
export const LIFE_EXPECTANCY_GAIN_1962_2019_YEARS_PER_DECADE: Parameter = {
  ...
  latex: "Rate = (life\\_exp\\_2019 - life\\_exp\\_1962) / 5.7 decades = 0",
  peerReviewed: true,
};
...
export const MEDICAL_RESEARCH_PCT_OF_DISEASE_BURDEN: Parameter = {
  ...
  latex: "\\begin{aligned}\nBurden_{RD} = \\frac{Spending_{med,global}}{Cost_{health,total}} = \\frac{\\$67.5B}{\\$129T} = 0.0525\\%\n\\\\[0.5em]\n\\text{where } Cost_{total} = Cost_{indirect,ann} + Burden_{disease,ann} + Spending_{symptomatic,ann} = \\$11.4T + \\$109T + \\$8.2T = \\$129T\n\\\\[0.5em]\n\\text{where } Cost_{indirect,ann} = Cost_{direct,total} + Cost_{indirect,total} = \\$7.66T + \\$3.7T = \\$11.4T\n\\\\[0.5em]\n\\text{where } Cost_{direct,total} = Loss_{human,ann} + Infrastructure_{global} + Disruption_{trade,ann} + Spending_{military,ann} = \\$2.45T + \\$1.88T + \\$616B + \\$2.72T = \\$7.66T\n\\\\[0.5em]\n\\text{where } Loss_{human,ann} = Cost_{combat,ann} + Cost_{state,ann} + Cost_{terror,ann} = \\$2.34T + \\$27B + \\$83B = \\$2.45T\n\\\\[0.5em]\n\\text{where } Cost_{combat,ann} = Deaths_{combat,ann} \\times Value = 234{,}000 \\times \\$10M = \\$2.34T\n\\\\[0.5em]\n\\text{where } Cost_{state,ann} = Deaths_{state,ann} \\times Value = 2{,}700 \\times \\$10M = \\$27B\n\\\\[0.5em]\n\\text{where } Cost_{terror,ann} = Deaths_{terror,ann} \\times Value = 8{,}300 \\times \\$10M = \\$83B\n\\\\[0.5em]\n\\text{where } Infrastructure_{global} = Damage_{comms,ann} + Damage_{edu,ann} + Damage_{energy,ann} + Damage_{health,ann} + Damage_{transport,ann} + Damage_{water,ann} = \\$298B + \\$234B + \\$422B + \\$166B + \\$487B + \\$268B = \\$1.88T\n\\\\[0.5em]\n\\text{where } Disruption_{trade,ann} = Cost_{currency,ann} + Cost_{energy,ann} + Cost_{shipping,ann} + Cost_{supply,ann} = \\$57.4B + \\$125B + \\$247B + \\$187B = \\$616B\n\\\\[0.5em]\n\\text{where } Cost_{indirect,total} = Cost_{env,ann} + Cost_{economic,ann} + Lost_{global} + Cost_{psychological,ann} + Cost_{refugee,ann} + Cost_{veteran,ann} = \\$100B + \\$2.72T + \\$300B + \\$232B + \\$150B + \\$200B = \\$3.7T\n\\\\[0.5em]\n\\text{where } Burden_{ann} = Cost_{direct,ann} + Loss_{human,ann} + Loss_{productivity,ann} = \\$9.9T + \\$94.2T + \\$5T = \\$109T\n\\end{aligned}",
};
...
export const MILITARY_TO_CLINICAL_TRIALS_SPENDING_RATIO: Parameter = {
  ...
  latex: "\\begin{aligned}\nRatio_{mil} \\\\\n&= \\frac{Spending_{military,ann}}{Trials_{clinical,ann}} \\\\\n&= \\frac{\\$2.72T}{\\$60B} \\\\\n&= 45.3\n\\end{aligned}",
};
...
export const MILITARY_TO_GOVERNMENT_CLINICAL_TRIALS_SPENDING_RATIO: Parameter = {
  ...
  latex: "\\begin{aligned}\nRatio_{mil} \\\\\n&= \\frac{Spending_{military,ann}}{Trials_{government,ann}} \\\\\n&= \\frac{\\$2.72T}{\\$4.5B} \\\\\n&= 604\n\\end{aligned}",
};
...
export const MILITARY_VS_MEDICAL_RESEARCH_RATIO: Parameter = {
  ...
  latex: "\\begin{aligned}\nRatio_{mil,RD} \\\\\n&= \\frac{Spending_{military,ann}}{Spending_{med,global}} \\\\\n&= \\frac{\\$2.72T}{\\$67.5B} \\\\\n&= 40.3\n\\end{aligned}",
};
...
export const MISALLOCATION_FACTOR_DEATH_VS_SAVING: Parameter = {
  ...
  latex: "\\begin{aligned}\nCost = COST\\_PER\\_DEATH \\div COST\\_PER\\_LIFE\\_SAVED = 2{,}890\n\\\\[0.5em]\n\\text{where } Deaths_{total} = Deaths_{combat,ann} + Deaths_{state,ann} + Deaths_{terror,ann} = 234{,}000 + 2{,}700 + 8{,}300 = 245{,}000\n\\\\[0.5em]\n\\text{where } Cost_{indirect,ann} = Cost_{direct,total} + Cost_{indirect,total} = \\$7.66T + \\$3.7T = \\$11.4T\n\\\\[0.5em]\n\\text{where } Cost_{direct,total} = Loss_{human,ann} + Infrastructure_{global} + Disruption_{trade,ann} + Spending_{military,ann} = \\$2.45T + \\$1.88T + \\$616B + \\$2.72T = \\$7.66T\n\\\\[0.5em]\n\\text{where } Loss_{human,ann} = Cost_{combat,ann} + Cost_{state,ann} + Cost_{terror,ann} = \\$2.34T + \\$27B + \\$83B = \\$2.45T\n\\\\[0.5em]\n\\text{where } Cost_{combat,ann} = Deaths_{combat,ann} \\times Value = 234{,}000 \\times \\$10M = \\$2.34T\n\\\\[0.5em]\n\\text{where } Cost_{state,ann} = Deaths_{state,ann} \\times Value = 2{,}700 \\times \\$10M = \\$27B\n\\\\[0.5em]\n\\text{where } Cost_{terror,ann} = Deaths_{terror,ann} \\times Value = 8{,}300 \\times \\$10M = \\$83B\n\\\\[0.5em]\n\\text{where } Infrastructure_{global} = Damage_{comms,ann} + Damage_{edu,ann} + Damage_{energy,ann} + Damage_{health,ann} + Damage_{transport,ann} + Damage_{water,ann} = \\$298B + \\$234B + \\$422B + \\$166B + \\$487B + \\$268B = \\$1.88T\n\\\\[0.5em]\n\\text{where } Disruption_{trade,ann} = Cost_{currency,ann} + Cost_{energy,ann} + Cost_{shipping,ann} + Cost_{supply,ann} = \\$57.4B + \\$125B + \\$247B + \\$187B = \\$616B\n\\\\[0.5em]\n\\text{where } Cost_{indirect,total} = Cost_{env,ann} + Cost_{economic,ann} + Lost_{global} + Cost_{psychological,ann} + Cost_{refugee,ann} + Cost_{veteran,ann} = \\$100B + \\$2.72T + \\$300B + \\$232B + \\$150B + \\$200B = \\$3.7T\n\\\\[0.5em]\n\\text{where } Cost_{ann} = \\frac{Spending_{med,global}}{Lives_{lives,ann}} = \\frac{\\$67.5B}{4.2M} = \\$16.1K\n\\end{aligned}",
};
...
export const PEACE_DIVIDEND_CONFLICT_REDUCTION: Parameter = {
  ...
  latex: "\\begin{aligned}\nBenefit_{peace} = Cost_{soc,ann} - Funding_{treaty} = \\$114B - \\$27.2B = \\$86.4B\n\\\\[0.5em]\n\\text{where } Cost_{soc,ann} = Cost_{indirect,ann} \\times Reduction_{treaty} = \\$11.4T \\times 1\\% = \\$114B\n\\\\[0.5em]\n\\text{where } Cost_{indirect,ann} = Cost_{direct,total} + Cost_{indirect,total} = \\$7.66T + \\$3.7T = \\$11.4T\n\\\\[0.5em]\n\\text{where } Cost_{direct,total} = Loss_{human,ann} + Infrastructure_{global} + Disruption_{trade,ann} + Spending_{military,ann} = \\$2.45T + \\$1.88T + \\$616B + \\$2.72T = \\$7.66T\n\\\\[0.5em]\n\\text{where } Loss_{human,ann} = Cost_{combat,ann} + Cost_{state,ann} + Cost_{terror,ann} = \\$2.34T + \\$27B + \\$83B = \\$2.45T\n\\\\[0.5em]\n\\text{where } Cost_{combat,ann} = Deaths_{combat,ann} \\times Value = 234{,}000 \\times \\$10M = \\$2.34T\n\\\\[0.5em]\n\\text{where } Cost_{state,ann} = Deaths_{state,ann} \\times Value = 2{,}700 \\times \\$10M = \\$27B\n\\\\[0.5em]\n\\text{where } Cost_{terror,ann} = Deaths_{terror,ann} \\times Value = 8{,}300 \\times \\$10M = \\$83B\n\\\\[0.5em]\n\\text{where } Infrastructure_{global} = Damage_{comms,ann} + Damage_{edu,ann} + Damage_{energy,ann} + Damage_{health,ann} + Damage_{transport,ann} + Damage_{water,ann} = \\$298B + \\$234B + \\$422B + \\$166B + \\$487B + \\$268B = \\$1.88T\n\\\\[0.5em]\n\\text{where } Disruption_{trade,ann} = Cost_{currency,ann} + Cost_{energy,ann} + Cost_{shipping,ann} + Cost_{supply,ann} = \\$57.4B + \\$125B + \\$247B + \\$187B = \\$616B\n\\\\[0.5em]\n\\text{where } Cost_{indirect,total} = Cost_{env,ann} + Cost_{economic,ann} + Lost_{global} + Cost_{psychological,ann} + Cost_{refugee,ann} + Cost_{veteran,ann} = \\$100B + \\$2.72T + \\$300B + \\$232B + \\$150B + \\$200B = \\$3.7T\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\end{aligned}",
};
...
export const PEACE_DIVIDEND_LOST_ECONOMIC_GROWTH: Parameter = {
  ...
  latex: "\\begin{aligned}\nSavings_{econ_growth,peace} \\\\\n&= Cost_{econ_growth,ann} \\times Reduction_{treaty} \\\\\n&= \\$2.72T \\times 1\\% \\\\\n&= \\$27.2B\n\\end{aligned}",
};
...
export const PERSONAL_LIFETIME_WEALTH: Parameter = {
  ...
  latex: "\\begin{aligned}\nTime = NPV(peace\\_dividend + healthcare\\_savings + productivity\\_gains + caregiver\\_savings + gdp\\_boost + extended\\_earnings) = \\$494K\n\\\\[0.5em]\n\\text{where } Multiplier_{DFDA} = \\frac{Fundable_{ann}}{Trials_{curr}} = \\frac{23.4M}{1.9M} = 12.3\n\\\\[0.5em]\n\\text{where } Fundable_{ann} = \\frac{Treasury_{ann}}{Cost_{DFDA}} = \\frac{\\$21.7B}{\\$929} = 23.4M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = Treasury_{ann} - OPEX_{dFDA} = \\$21.8B - \\$40M = \\$21.7B\n\\\\[0.5em]\n\\text{where } OPEX_{dFDA} = Cost_{platform} + Cost_{staff} + Cost_{infra} + Cost_{regulatory} + Cost_{community} = \\$15M + \\$10M + \\$8M + \\$5M + \\$2M = \\$40M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = TREATY\\_FUNDING - BOND\\_PAYOUT - IAB\\_POLITICAL\\_INCENTIVE\\_FUNDING = \\$21.8B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Victory_{annual} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\end{aligned}",
};
...
export const PER_CAPITA_CHRONIC_DISEASE_COST: Parameter = {
  ...
  latex: "\\begin{aligned}\nCost_{percap,dis} \\\\\n&= \\frac{Spending_{chronic,ann}}{Population_{population}} \\\\\n&= \\frac{\\$4.1T}{335M} \\\\\n&= \\$12.2K\n\\end{aligned}",
};
...
export const PER_CAPITA_MENTAL_HEALTH_COST: Parameter = {
  ...
  latex: "\\begin{aligned}\nCost_{percap,health} \\\\\n&= \\frac{Cost_{mental,ann}}{Population_{population}} \\\\\n&= \\frac{\\$350B}{335M} \\\\\n&= \\$1.04K\n\\end{aligned}",
};
...
export const PRAGMATIC_VS_NIH_EFFICIENCY_MULTIPLIER: Parameter = {
  ...
  latex: "\\begin{aligned}\nMultiplier = \\frac{Cost_{RD}}{Cost} = \\frac{\\$50K}{\\$4} = 12{,}500\n\\\\[0.5em]\n\\text{where } Cost = \\frac{Cost_{total}}{Rate_{qalys,total}} = \\frac{\\$20M}{5M} = \\$4\n\\\\[0.5em]\n\\text{where } Rate_{total} = Trials_{global} \\times Deaths = 1M \\times 5 = 5M\n\\end{aligned}",
};
...
export const THALIDOMIDE_DALYS_PER_EVENT: Parameter = {
  ...
  confidence: "medium",
  formula: "YLL + YLD",
  latex: "\\begin{aligned}\nDALYs = YLD_{yld} + YLL_{yll} = 13{,}000 + 28{,}800 = 41{,}800\n\\\\[0.5em]\n\\text{where } YLD = Thalidomide \\times Thalidomide \\times Thalidomide = 0.4 \\times 540 \\times 60 = 13{,}000\n\\\\[0.5em]\n\\text{where } Thalidomide = US\\_CASES \\times (1 - MORTALITY\\_RATE) = 540\n\\\\[0.5em]\n\\text{where } ThalidomideUS = Thalidomide \\times Population_{us} = 15{,}000 \\times 6\\% = 900\n\\\\[0.5em]\n\\text{where } YLL = Deaths \\times 80 = 360 \\times 80 = 28{,}800\n\\\\[0.5em]\n\\text{where } Deaths = Rate_{mortality} \\times ThalidomideUS = 40\\% \\times 900 = 360\n\\\\[0.5em]\n\\text{where } ThalidomideUS = Thalidomide \\times Population_{us} = 15{,}000 \\times 6\\% = 900\n\\end{aligned}",
};
...
export const THALIDOMIDE_DEATHS_PER_EVENT: Parameter = {
  ...
  latex: "\\begin{aligned}\nDeaths = Rate_{mortality} \\times ThalidomideUS = 40\\% \\times 900 = 360\n\\\\[0.5em]\n\\text{where } ThalidomideUS = Thalidomide \\times Population_{us} = 15{,}000 \\times 6\\% = 900\n\\end{aligned}",
};
...
export const THALIDOMIDE_SURVIVORS_PER_EVENT: Parameter = {
  ...
  latex: "\\begin{aligned}\nThalidomide = US\\_CASES \\times (1 - MORTALITY\\_RATE) = 540\n\\\\[0.5em]\n\\text{where } ThalidomideUS = Thalidomide \\times Population_{us} = 15{,}000 \\times 6\\% = 900\n\\end{aligned}",
};
...
export const THALIDOMIDE_US_CASES_PREVENTED: Parameter = {
  ...
  latex: "\\begin{aligned}\nThalidomideUS \\\\\n&= Thalidomide \\times Population_{us} \\\\\n&= 15{,}000 \\times 6\\% \\\\\n&= 900\n\\end{aligned}",
};
...
export const TOTAL_RESEARCH_FUNDING_WITH_TREATY: Parameter = {
  ...
  latex: "\\begin{aligned}\nFunding_{total} = Spending_{global} + Funding_{treaty} = \\$67.5B + \\$27.2B = \\$94.7B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\end{aligned}",
};
...
export const TREATY_CAMPAIGN_ANNUAL_COST_AMORTIZED: Parameter = {
  ...
  latex: "\\begin{aligned}\nCost_{camp,ann} = \\frac{Cost_{camp,total}}{Ratio_{duration,treaty}} = \\frac{\\$1B}{4} = \\$250M\n\\\\[0.5em]\n\\text{where } Cost_{camp,total} = Campaign_{viral,treaty} + Campaign_{lobbying,treaty} + Campaign_{reserve,treaty} = \\$250M + \\$650M + \\$100M = \\$1B\n\\end{aligned}",
};
...
export const TREATY_CAMPAIGN_TOTAL_COST: Parameter = {
  ...
  latex: "\\begin{aligned}\nCost_{camp,total} \\\\\n&= Campaign_{viral,treaty} + Campaign_{lobbying,treaty} \\\\\n&\\quad + Campaign_{reserve,treaty} \\\\\n&= \\$250M + \\$650M + \\$100M \\\\\n&= \\$1B\n\\end{aligned}",
};
...
export const TREATY_CAMPAIGN_VOTING_BLOC_TARGET: Parameter = {
  ...
  latex: "\\begin{aligned}\nCampaign_{camp,treaty} \\\\\n&= Population_{2024,global} \\times Threshold_{activism,global} \\\\\n&= 8B \\times 3.5\\% \\\\\n&= 280M\n\\end{aligned}",
};
...
export const TREATY_COST_PER_DALY_TRIAL_CAPACITY_PLUS_EFFICACY_LAG: Parameter = {
  ...
  latex: "\\begin{aligned}\nIncrease_{max,treaty} = \\frac{Cost_{camp,total}}{DALYs_{max,DFDA}} = \\frac{\\$1B}{565B} = \\$0.00177\n\\\\[0.5em]\n\\text{where } Cost_{camp,total} = Campaign_{viral,treaty} + Campaign_{lobbying,treaty} + Campaign_{reserve,treaty} = \\$250M + \\$650M + \\$100M = \\$1B\n\\\\[0.5em]\n\\text{where } DALYs_{max,DFDA} = DALYs_{ann} \\times DALYs \\times Capacity_{max,DFDA} = 2.88B \\times 92.6\\% \\times 212 = 565B\n\\\\[0.5em]\n\\text{where } Capacity_{max,DFDA} = Ratio_{DFDA} + Delay = 204 + 8.2 = 212\n\\\\[0.5em]\n\\text{where } Ratio_{DFDA} = STATUS\\_QUO\\_AVG\\_YEARS\\_TO\\_FIRST\\_TREATMENT \\times (1 - 1/DFDA\\_TRIAL\\_CAPACITY\\_MULTIPLIER) = 204\n\\\\[0.5em]\n\\text{where } Status = Time \\times 0.5 = 443 \\times 0.5 = 222\n\\\\[0.5em]\n\\text{where } Time = \\frac{Diseases}{New} = \\frac{6{,}650}{15} = 443\n\\\\[0.5em]\n\\text{where } Diseases = Rare_{global} - 1 = 7{,}000 - 1 = 6{,}650\n\\\\[0.5em]\n\\text{where } Multiplier_{DFDA} = \\frac{Fundable_{ann}}{Trials_{curr}} = \\frac{23.4M}{1.9M} = 12.3\n\\\\[0.5em]\n\\text{where } Fundable_{ann} = \\frac{Treasury_{ann}}{Cost_{DFDA}} = \\frac{\\$21.7B}{\\$929} = 23.4M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = Treasury_{ann} - OPEX_{dFDA} = \\$21.8B - \\$40M = \\$21.7B\n\\\\[0.5em]\n\\text{where } OPEX_{dFDA} = Cost_{platform} + Cost_{staff} + Cost_{infra} + Cost_{regulatory} + Cost_{community} = \\$15M + \\$10M + \\$8M + \\$5M + \\$2M = \\$40M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = TREATY\\_FUNDING - BOND\\_PAYOUT - IAB\\_POLITICAL\\_INCENTIVE\\_FUNDING = \\$21.8B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Victory_{annual} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\end{aligned}",
};
...
export const TREATY_EXPECTED_COST_PER_DALY: Parameter = {
  ...
  latex: "\\begin{aligned}\nCost_{treaty} = \\frac{Increase_{max,treaty}}{Probability} = \\frac{\\$0.00177}{1\\%} = \\$0.177\n\\\\[0.5em]\n\\text{where } Increase_{max,treaty} = \\frac{Cost_{camp,total}}{DALYs_{max,DFDA}} = \\frac{\\$1B}{565B} = \\$0.00177\n\\\\[0.5em]\n\\text{where } Cost_{camp,total} = Campaign_{viral,treaty} + Campaign_{lobbying,treaty} + Campaign_{reserve,treaty} = \\$250M + \\$650M + \\$100M = \\$1B\n\\\\[0.5em]\n\\text{where } DALYs_{max,DFDA} = DALYs_{ann} \\times DALYs \\times Capacity_{max,DFDA} = 2.88B \\times 92.6\\% \\times 212 = 565B\n\\\\[0.5em]\n\\text{where } Capacity_{max,DFDA} = Ratio_{DFDA} + Delay = 204 + 8.2 = 212\n\\\\[0.5em]\n\\text{where } Ratio_{DFDA} = STATUS\\_QUO\\_AVG\\_YEARS\\_TO\\_FIRST\\_TREATMENT \\times (1 - 1/DFDA\\_TRIAL\\_CAPACITY\\_MULTIPLIER) = 204\n\\\\[0.5em]\n\\text{where } Status = Time \\times 0.5 = 443 \\times 0.5 = 222\n\\\\[0.5em]\n\\text{where } Time = \\frac{Diseases}{New} = \\frac{6{,}650}{15} = 443\n\\\\[0.5em]\n\\text{where } Diseases = Rare_{global} - 1 = 7{,}000 - 1 = 6{,}650\n\\\\[0.5em]\n\\text{where } Multiplier_{DFDA} = \\frac{Fundable_{ann}}{Trials_{curr}} = \\frac{23.4M}{1.9M} = 12.3\n\\\\[0.5em]\n\\text{where } Fundable_{ann} = \\frac{Treasury_{ann}}{Cost_{DFDA}} = \\frac{\\$21.7B}{\\$929} = 23.4M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = Treasury_{ann} - OPEX_{dFDA} = \\$21.8B - \\$40M = \\$21.7B\n\\\\[0.5em]\n\\text{where } OPEX_{dFDA} = Cost_{platform} + Cost_{staff} + Cost_{infra} + Cost_{regulatory} + Cost_{community} = \\$15M + \\$10M + \\$8M + \\$5M + \\$2M = \\$40M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = TREATY\\_FUNDING - BOND\\_PAYOUT - IAB\\_POLITICAL\\_INCENTIVE\\_FUNDING = \\$21.8B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Victory_{annual} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\end{aligned}",
};
...
export const TREATY_EXPECTED_ROI_TRIAL_CAPACITY_PLUS_EFFICACY_LAG: Parameter = {
  ...
  latex: "\\begin{aligned}\nROI_{max,treaty} = Increase_{max,treaty} \\times Probability = 84.8M \\times 1\\% = 848{,}000\n\\\\[0.5em]\n\\text{where } Increase_{max,treaty} = \\frac{Benefit_{max,DFDA}}{Cost_{camp,total}} = \\frac{\\$84800T}{\\$1B} = 84.8M\n\\\\[0.5em]\n\\text{where } Benefit_{max,DFDA} = DALYs_{max,DFDA} \\times QALYs_{RD} = 565B \\times \\$150K = \\$84800T\n\\\\[0.5em]\n\\text{where } DALYs_{max,DFDA} = DALYs_{ann} \\times DALYs \\times Capacity_{max,DFDA} = 2.88B \\times 92.6\\% \\times 212 = 565B\n\\\\[0.5em]\n\\text{where } Capacity_{max,DFDA} = Ratio_{DFDA} + Delay = 204 + 8.2 = 212\n\\\\[0.5em]\n\\text{where } Ratio_{DFDA} = STATUS\\_QUO\\_AVG\\_YEARS\\_TO\\_FIRST\\_TREATMENT \\times (1 - 1/DFDA\\_TRIAL\\_CAPACITY\\_MULTIPLIER) = 204\n\\\\[0.5em]\n\\text{where } Status = Time \\times 0.5 = 443 \\times 0.5 = 222\n\\\\[0.5em]\n\\text{where } Time = \\frac{Diseases}{New} = \\frac{6{,}650}{15} = 443\n\\\\[0.5em]\n\\text{where } Diseases = Rare_{global} - 1 = 7{,}000 - 1 = 6{,}650\n\\\\[0.5em]\n\\text{where } Multiplier_{DFDA} = \\frac{Fundable_{ann}}{Trials_{curr}} = \\frac{23.4M}{1.9M} = 12.3\n\\\\[0.5em]\n\\text{where } Fundable_{ann} = \\frac{Treasury_{ann}}{Cost_{DFDA}} = \\frac{\\$21.7B}{\\$929} = 23.4M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = Treasury_{ann} - OPEX_{dFDA} = \\$21.8B - \\$40M = \\$21.7B\n\\\\[0.5em]\n\\text{where } OPEX_{dFDA} = Cost_{platform} + Cost_{staff} + Cost_{infra} + Cost_{regulatory} + Cost_{community} = \\$15M + \\$10M + \\$8M + \\$5M + \\$2M = \\$40M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = TREATY\\_FUNDING - BOND\\_PAYOUT - IAB\\_POLITICAL\\_INCENTIVE\\_FUNDING = \\$21.8B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Victory_{annual} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Cost_{camp,total} = Campaign_{viral,treaty} + Campaign_{lobbying,treaty} + Campaign_{reserve,treaty} = \\$250M + \\$650M + \\$100M = \\$1B\n\\end{aligned}",
};
...
export const TREATY_EXPECTED_VS_BED_NETS_MULTIPLIER: Parameter = {
  ...
  latex: "\\begin{aligned}\nMultiplier_{net,treaty} = \\frac{Cost_{net}}{Cost_{treaty}} = \\frac{\\$89}{\\$0.177} = 503\n\\\\[0.5em]\n\\text{where } Cost_{treaty} = \\frac{Increase_{max,treaty}}{Probability} = \\frac{\\$0.00177}{1\\%} = \\$0.177\n\\\\[0.5em]\n\\text{where } Increase_{max,treaty} = \\frac{Cost_{camp,total}}{DALYs_{max,DFDA}} = \\frac{\\$1B}{565B} = \\$0.00177\n\\\\[0.5em]\n\\text{where } Cost_{camp,total} = Campaign_{viral,treaty} + Campaign_{lobbying,treaty} + Campaign_{reserve,treaty} = \\$250M + \\$650M + \\$100M = \\$1B\n\\\\[0.5em]\n\\text{where } DALYs_{max,DFDA} = DALYs_{ann} \\times DALYs \\times Capacity_{max,DFDA} = 2.88B \\times 92.6\\% \\times 212 = 565B\n\\\\[0.5em]\n\\text{where } Capacity_{max,DFDA} = Ratio_{DFDA} + Delay = 204 + 8.2 = 212\n\\\\[0.5em]\n\\text{where } Ratio_{DFDA} = STATUS\\_QUO\\_AVG\\_YEARS\\_TO\\_FIRST\\_TREATMENT \\times (1 - 1/DFDA\\_TRIAL\\_CAPACITY\\_MULTIPLIER) = 204\n\\\\[0.5em]\n\\text{where } Status = Time \\times 0.5 = 443 \\times 0.5 = 222\n\\\\[0.5em]\n\\text{where } Time = \\frac{Diseases}{New} = \\frac{6{,}650}{15} = 443\n\\\\[0.5em]\n\\text{where } Diseases = Rare_{global} - 1 = 7{,}000 - 1 = 6{,}650\n\\\\[0.5em]\n\\text{where } Multiplier_{DFDA} = \\frac{Fundable_{ann}}{Trials_{curr}} = \\frac{23.4M}{1.9M} = 12.3\n\\\\[0.5em]\n\\text{where } Fundable_{ann} = \\frac{Treasury_{ann}}{Cost_{DFDA}} = \\frac{\\$21.7B}{\\$929} = 23.4M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = Treasury_{ann} - OPEX_{dFDA} = \\$21.8B - \\$40M = \\$21.7B\n\\\\[0.5em]\n\\text{where } OPEX_{dFDA} = Cost_{platform} + Cost_{staff} + Cost_{infra} + Cost_{regulatory} + Cost_{community} = \\$15M + \\$10M + \\$8M + \\$5M + \\$2M = \\$40M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = TREATY\\_FUNDING - BOND\\_PAYOUT - IAB\\_POLITICAL\\_INCENTIVE\\_FUNDING = \\$21.8B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Victory_{annual} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\end{aligned}",
};
...
export const TREATY_ROI_TRIAL_CAPACITY_PLUS_EFFICACY_LAG: Parameter = {
  ...
  latex: "\\begin{aligned}\nIncrease_{max,treaty} = \\frac{Benefit_{max,DFDA}}{Cost_{camp,total}} = \\frac{\\$84800T}{\\$1B} = 84.8M\n\\\\[0.5em]\n\\text{where } Benefit_{max,DFDA} = DALYs_{max,DFDA} \\times QALYs_{RD} = 565B \\times \\$150K = \\$84800T\n\\\\[0.5em]\n\\text{where } DALYs_{max,DFDA} = DALYs_{ann} \\times DALYs \\times Capacity_{max,DFDA} = 2.88B \\times 92.6\\% \\times 212 = 565B\n\\\\[0.5em]\n\\text{where } Capacity_{max,DFDA} = Ratio_{DFDA} + Delay = 204 + 8.2 = 212\n\\\\[0.5em]\n\\text{where } Ratio_{DFDA} = STATUS\\_QUO\\_AVG\\_YEARS\\_TO\\_FIRST\\_TREATMENT \\times (1 - 1/DFDA\\_TRIAL\\_CAPACITY\\_MULTIPLIER) = 204\n\\\\[0.5em]\n\\text{where } Status = Time \\times 0.5 = 443 \\times 0.5 = 222\n\\\\[0.5em]\n\\text{where } Time = \\frac{Diseases}{New} = \\frac{6{,}650}{15} = 443\n\\\\[0.5em]\n\\text{where } Diseases = Rare_{global} - 1 = 7{,}000 - 1 = 6{,}650\n\\\\[0.5em]\n\\text{where } Multiplier_{DFDA} = \\frac{Fundable_{ann}}{Trials_{curr}} = \\frac{23.4M}{1.9M} = 12.3\n\\\\[0.5em]\n\\text{where } Fundable_{ann} = \\frac{Treasury_{ann}}{Cost_{DFDA}} = \\frac{\\$21.7B}{\\$929} = 23.4M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = Treasury_{ann} - OPEX_{dFDA} = \\$21.8B - \\$40M = \\$21.7B\n\\\\[0.5em]\n\\text{where } OPEX_{dFDA} = Cost_{platform} + Cost_{staff} + Cost_{infra} + Cost_{regulatory} + Cost_{community} = \\$15M + \\$10M + \\$8M + \\$5M + \\$2M = \\$40M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = TREATY\\_FUNDING - BOND\\_PAYOUT - IAB\\_POLITICAL\\_INCENTIVE\\_FUNDING = \\$21.8B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Victory_{annual} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Cost_{camp,total} = Campaign_{viral,treaty} + Campaign_{lobbying,treaty} + Campaign_{reserve,treaty} = \\$250M + \\$650M + \\$100M = \\$1B\n\\end{aligned}",
};
...
export const TREATY_TOTAL_ANNUAL_COSTS: Parameter = {
  ...
  latex: "\\begin{aligned}\nCost_{total} = OPEX_{dFDA} + Cost_{camp,ann} = \\$40M + \\$250M = \\$290M\n\\\\[0.5em]\n\\text{where } OPEX_{dFDA} = Cost_{platform} + Cost_{staff} + Cost_{infra} + Cost_{regulatory} + Cost_{community} = \\$15M + \\$10M + \\$8M + \\$5M + \\$2M = \\$40M\n\\\\[0.5em]\n\\text{where } Cost_{camp,ann} = \\frac{Cost_{camp,total}}{Ratio_{duration,treaty}} = \\frac{\\$1B}{4} = \\$250M\n\\\\[0.5em]\n\\text{where } Cost_{camp,total} = Campaign_{viral,treaty} + Campaign_{lobbying,treaty} + Campaign_{reserve,treaty} = \\$250M + \\$650M + \\$100M = \\$1B\n\\end{aligned}",
};
...
export const TREATY_VS_BED_NETS_MULTIPLIER: Parameter = {
  ...
  latex: "\\begin{aligned}\nMultiplier_{net,treaty} = \\frac{Cost_{net}}{Increase_{max,treaty}} = \\frac{\\$89}{\\$0.00177} = 50{,}300\n\\\\[0.5em]\n\\text{where } Increase_{max,treaty} = \\frac{Cost_{camp,total}}{DALYs_{max,DFDA}} = \\frac{\\$1B}{565B} = \\$0.00177\n\\\\[0.5em]\n\\text{where } Cost_{camp,total} = Campaign_{viral,treaty} + Campaign_{lobbying,treaty} + Campaign_{reserve,treaty} = \\$250M + \\$650M + \\$100M = \\$1B\n\\\\[0.5em]\n\\text{where } DALYs_{max,DFDA} = DALYs_{ann} \\times DALYs \\times Capacity_{max,DFDA} = 2.88B \\times 92.6\\% \\times 212 = 565B\n\\\\[0.5em]\n\\text{where } Capacity_{max,DFDA} = Ratio_{DFDA} + Delay = 204 + 8.2 = 212\n\\\\[0.5em]\n\\text{where } Ratio_{DFDA} = STATUS\\_QUO\\_AVG\\_YEARS\\_TO\\_FIRST\\_TREATMENT \\times (1 - 1/DFDA\\_TRIAL\\_CAPACITY\\_MULTIPLIER) = 204\n\\\\[0.5em]\n\\text{where } Status = Time \\times 0.5 = 443 \\times 0.5 = 222\n\\\\[0.5em]\n\\text{where } Time = \\frac{Diseases}{New} = \\frac{6{,}650}{15} = 443\n\\\\[0.5em]\n\\text{where } Diseases = Rare_{global} - 1 = 7{,}000 - 1 = 6{,}650\n\\\\[0.5em]\n\\text{where } Multiplier_{DFDA} = \\frac{Fundable_{ann}}{Trials_{curr}} = \\frac{23.4M}{1.9M} = 12.3\n\\\\[0.5em]\n\\text{where } Fundable_{ann} = \\frac{Treasury_{ann}}{Cost_{DFDA}} = \\frac{\\$21.7B}{\\$929} = 23.4M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = Treasury_{ann} - OPEX_{dFDA} = \\$21.8B - \\$40M = \\$21.7B\n\\\\[0.5em]\n\\text{where } OPEX_{dFDA} = Cost_{platform} + Cost_{staff} + Cost_{infra} + Cost_{regulatory} + Cost_{community} = \\$15M + \\$10M + \\$8M + \\$5M + \\$2M = \\$40M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = TREATY\\_FUNDING - BOND\\_PAYOUT - IAB\\_POLITICAL\\_INCENTIVE\\_FUNDING = \\$21.8B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Victory_{annual} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\end{aligned}",
};
...
export const UNEXPLORED_RATIO: Parameter = {
  ...
  latex: "\\begin{aligned}\nRatio = 1 - EXPLORATION\\_RATIO = 99.7\\%\n\\\\[0.5em]\n\\text{where } Drug = Safe \\times Trials_{dis} = 9{,}500 \\times 1{,}000 = 9.5M\n\\end{aligned}",
};
...
export const US_MAJOR_DISEASES_TOTAL_ANNUAL_COST: Parameter = {
  ...
  latex: "\\begin{aligned}\nCost_{total} \\\\\n&= Cost_{alzheimers,ann} + Cost_{cancer,ann} \\\\\n&\\quad + Cost_{diabetes,ann} + Cost_{heart,ann} \\\\\n&= \\$355B + \\$208B + \\$327B + \\$363B \\\\\n&= \\$1.25T\n\\end{aligned}",
};
...
export const CURRENT_PATIENT_PARTICIPATION_RATE: Parameter = {
  ...
  latex: "\\begin{aligned}\nRate_{curr} \\\\\n&= \\frac{Trials_{trial}}{Population_{disease,global}} \\\\\n&= \\frac{1.9M}{2.4B} \\\\\n&= 0.0792\\%\n\\end{aligned}",
};
...
export const DFDA_DIRECT_FUNDING_COST_PER_DALY: Parameter = {
  ...
  latex: "\\begin{aligned}\nCost_{direct,DFDA} = \\frac{Funding_{direct,DFDA}}{DALYs_{trial,DFDA}} = \\frac{\\$475B}{565B} = \\$0.841\n\\\\[0.5em]\n\\text{where } Funding_{direct,DFDA} = ANNUAL\\_FUNDING \\times [(1 - (1 + r)^-T) / r] where T = queue clearance time = \\$475B\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = TREATY\\_FUNDING - BOND\\_PAYOUT - IAB\\_POLITICAL\\_INCENTIVE\\_FUNDING = \\$21.8B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Victory_{annual} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Time_{DFDA} = \\frac{Time}{Multiplier_{DFDA}} = \\frac{443}{12.3} = 36\n\\\\[0.5em]\n\\text{where } Time = \\frac{Diseases}{New} = \\frac{6{,}650}{15} = 443\n\\\\[0.5em]\n\\text{where } Diseases = Rare_{global} - 1 = 7{,}000 - 1 = 6{,}650\n\\\\[0.5em]\n\\text{where } Multiplier_{DFDA} = \\frac{Fundable_{ann}}{Trials_{curr}} = \\frac{23.4M}{1.9M} = 12.3\n\\\\[0.5em]\n\\text{where } Fundable_{ann} = \\frac{Treasury_{ann}}{Cost_{DFDA}} = \\frac{\\$21.7B}{\\$929} = 23.4M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = Treasury_{ann} - OPEX_{dFDA} = \\$21.8B - \\$40M = \\$21.7B\n\\\\[0.5em]\n\\text{where } OPEX_{dFDA} = Cost_{platform} + Cost_{staff} + Cost_{infra} + Cost_{regulatory} + Cost_{community} = \\$15M + \\$10M + \\$8M + \\$5M + \\$2M = \\$40M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = TREATY\\_FUNDING - BOND\\_PAYOUT - IAB\\_POLITICAL\\_INCENTIVE\\_FUNDING = \\$21.8B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Victory_{annual} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } DALYs_{max,DFDA} = DALYs_{ann} \\times DALYs \\times Capacity_{max,DFDA} = 2.88B \\times 92.6\\% \\times 212 = 565B\n\\\\[0.5em]\n\\text{where } Capacity_{max,DFDA} = Ratio_{DFDA} + Delay = 204 + 8.2 = 212\n\\\\[0.5em]\n\\text{where } Ratio_{DFDA} = STATUS\\_QUO\\_AVG\\_YEARS\\_TO\\_FIRST\\_TREATMENT \\times (1 - 1/DFDA\\_TRIAL\\_CAPACITY\\_MULTIPLIER) = 204\n\\\\[0.5em]\n\\text{where } Status = Time \\times 0.5 = 443 \\times 0.5 = 222\n\\\\[0.5em]\n\\text{where } Time = \\frac{Diseases}{New} = \\frac{6{,}650}{15} = 443\n\\\\[0.5em]\n\\text{where } Diseases = Rare_{global} - 1 = 7{,}000 - 1 = 6{,}650\n\\\\[0.5em]\n\\text{where } Multiplier_{DFDA} = \\frac{Fundable_{ann}}{Trials_{curr}} = \\frac{23.4M}{1.9M} = 12.3\n\\\\[0.5em]\n\\text{where } Fundable_{ann} = \\frac{Treasury_{ann}}{Cost_{DFDA}} = \\frac{\\$21.7B}{\\$929} = 23.4M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = Treasury_{ann} - OPEX_{dFDA} = \\$21.8B - \\$40M = \\$21.7B\n\\\\[0.5em]\n\\text{where } OPEX_{dFDA} = Cost_{platform} + Cost_{staff} + Cost_{infra} + Cost_{regulatory} + Cost_{community} = \\$15M + \\$10M + \\$8M + \\$5M + \\$2M = \\$40M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = TREATY\\_FUNDING - BOND\\_PAYOUT - IAB\\_POLITICAL\\_INCENTIVE\\_FUNDING = \\$21.8B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Victory_{annual} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\end{aligned}",
};
...
export const DFDA_DIRECT_FUNDING_QUEUE_CLEARANCE_NPV: Parameter = {
  ...
  latex: "\\begin{aligned}\nFunding_{direct,DFDA} = ANNUAL\\_FUNDING \\times [(1 - (1 + r)^-T) / r] where T = queue clearance time = \\$475B\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = TREATY\\_FUNDING - BOND\\_PAYOUT - IAB\\_POLITICAL\\_INCENTIVE\\_FUNDING = \\$21.8B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Victory_{annual} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Time_{DFDA} = \\frac{Time}{Multiplier_{DFDA}} = \\frac{443}{12.3} = 36\n\\\\[0.5em]\n\\text{where } Time = \\frac{Diseases}{New} = \\frac{6{,}650}{15} = 443\n\\\\[0.5em]\n\\text{where } Diseases = Rare_{global} - 1 = 7{,}000 - 1 = 6{,}650\n\\\\[0.5em]\n\\text{where } Multiplier_{DFDA} = \\frac{Fundable_{ann}}{Trials_{curr}} = \\frac{23.4M}{1.9M} = 12.3\n\\\\[0.5em]\n\\text{where } Fundable_{ann} = \\frac{Treasury_{ann}}{Cost_{DFDA}} = \\frac{\\$21.7B}{\\$929} = 23.4M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = Treasury_{ann} - OPEX_{dFDA} = \\$21.8B - \\$40M = \\$21.7B\n\\\\[0.5em]\n\\text{where } OPEX_{dFDA} = Cost_{platform} + Cost_{staff} + Cost_{infra} + Cost_{regulatory} + Cost_{community} = \\$15M + \\$10M + \\$8M + \\$5M + \\$2M = \\$40M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = TREATY\\_FUNDING - BOND\\_PAYOUT - IAB\\_POLITICAL\\_INCENTIVE\\_FUNDING = \\$21.8B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Victory_{annual} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\end{aligned}",
};
...
export const DFDA_OPEX_PCT_OF_TREATY_FUNDING: Parameter = {
  ...
  latex: "\\begin{aligned}\nOPEX_{DFDA,treaty} = \\frac{OPEX_{dFDA}}{Funding_{treaty}} = \\frac{\\$40M}{\\$27.2B} = 0.147\\%\n\\\\[0.5em]\n\\text{where } OPEX_{dFDA} = Cost_{platform} + Cost_{staff} + Cost_{infra} + Cost_{regulatory} + Cost_{community} = \\$15M + \\$10M + \\$8M + \\$5M + \\$2M = \\$40M\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\end{aligned}",
};
...
export const DIH_TREASURY_MEDICAL_RESEARCH_PCT: Parameter = {
  ...
  latex: "\\begin{aligned}\nTreasury_{RD} = \\frac{Treasury_{ann}}{Funding_{treaty}} = \\frac{\\$21.8B}{\\$27.2B} = 80\\%\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = TREATY\\_FUNDING - BOND\\_PAYOUT - IAB\\_POLITICAL\\_INCENTIVE\\_FUNDING = \\$21.8B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Victory_{annual} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\end{aligned}",
};
...
export const DIH_TREASURY_TO_MEDICAL_RESEARCH_ANNUAL: Parameter = {
  ...
  latex: "\\begin{aligned}\nTreasury_{ann} = TREATY\\_FUNDING - BOND\\_PAYOUT - IAB\\_POLITICAL\\_INCENTIVE\\_FUNDING = \\$21.8B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Victory_{annual} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\end{aligned}",
};
...
export const DIH_TREASURY_TRIAL_SUBSIDIES_PCT: Parameter = {
  ...
  latex: "\\begin{aligned}\nTreasury = \\frac{Treasury_{ann}}{Funding_{treaty}} = \\frac{\\$21.7B}{\\$27.2B} = 79.9\\%\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = Treasury_{ann} - OPEX_{dFDA} = \\$21.8B - \\$40M = \\$21.7B\n\\\\[0.5em]\n\\text{where } OPEX_{dFDA} = Cost_{platform} + Cost_{staff} + Cost_{infra} + Cost_{regulatory} + Cost_{community} = \\$15M + \\$10M + \\$8M + \\$5M + \\$2M = \\$40M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = TREATY\\_FUNDING - BOND\\_PAYOUT - IAB\\_POLITICAL\\_INCENTIVE\\_FUNDING = \\$21.8B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Victory_{annual} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\end{aligned}",
};
...
export const DISEASE_VS_TERRORISM_DEATHS_RATIO: Parameter = {
  ...
  latex: "\\begin{aligned}\nDeaths_{terror,dis} \\\\\n&= \\frac{Deaths_{ann}}{Deaths_{terror}} \\\\\n&= \\frac{55M}{3{,}000} \\\\\n&= 18{,}400\n\\end{aligned}",
};
...
export const DISEASE_VS_WAR_DEATHS_RATIO: Parameter = {
  ...
  latex: "\\begin{aligned}\nDeaths_{war} = \\frac{Deaths_{deaths,ann}}{Deaths_{deaths,total}} = \\frac{55M}{245{,}000} = 225\n\\\\[0.5em]\n\\text{where } Deaths_{total} = Deaths_{combat,ann} + Deaths_{state,ann} + Deaths_{terror,ann} = 234{,}000 + 2{,}700 + 8{,}300 = 245{,}000\n\\end{aligned}",
};
...
export const GLOBAL_MILITARY_SPENDING_POST_TREATY_ANNUAL_2024: Parameter = {
  ...
  latex: "\\begin{aligned}\nSpending_{mil,ann} \\\\\n&= MILITARY\\_SPENDING \\times (1 - REDUCTION) \\\\\n&= \\$2.69T\n\\end{aligned}",
};
...
export const IAB_POLITICAL_INCENTIVE_FUNDING_ANNUAL: Parameter = {
  ...
  latex: "\\begin{aligned}\nFunding_{ann} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\end{aligned}",
};
...
export const TREATY_ANNUAL_FUNDING: Parameter = {
  ...
  latex: "\\begin{aligned}\nFunding_{treaty} \\\\\n&= Spending_{mil,ann} \\times Reduction_{treaty} \\\\\n&= \\$2.72T \\times 1\\% \\\\\n&= \\$27.2B\n\\end{aligned}",
};
...
export const TREATY_VS_DIRECT_FUNDING_LEVERAGE: Parameter = {
  ...
  latex: "\\begin{aligned}\nFunding_{direct,treaty} = \\frac{Cost_{direct,DFDA}}{Increase_{max,treaty}} = \\frac{\\$0.841}{\\$0.00177} = 475\n\\\\[0.5em]\n\\text{where } Cost_{direct,DFDA} = \\frac{Funding_{direct,DFDA}}{DALYs_{trial,DFDA}} = \\frac{\\$475B}{565B} = \\$0.841\n\\\\[0.5em]\n\\text{where } Funding_{direct,DFDA} = ANNUAL\\_FUNDING \\times [(1 - (1 + r)^-T) / r] where T = queue clearance time = \\$475B\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = TREATY\\_FUNDING - BOND\\_PAYOUT - IAB\\_POLITICAL\\_INCENTIVE\\_FUNDING = \\$21.8B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Victory_{annual} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Time_{DFDA} = \\frac{Time}{Multiplier_{DFDA}} = \\frac{443}{12.3} = 36\n\\\\[0.5em]\n\\text{where } Time = \\frac{Diseases}{New} = \\frac{6{,}650}{15} = 443\n\\\\[0.5em]\n\\text{where } Diseases = Rare_{global} - 1 = 7{,}000 - 1 = 6{,}650\n\\\\[0.5em]\n\\text{where } Multiplier_{DFDA} = \\frac{Fundable_{ann}}{Trials_{curr}} = \\frac{23.4M}{1.9M} = 12.3\n\\\\[0.5em]\n\\text{where } Fundable_{ann} = \\frac{Treasury_{ann}}{Cost_{DFDA}} = \\frac{\\$21.7B}{\\$929} = 23.4M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = Treasury_{ann} - OPEX_{dFDA} = \\$21.8B - \\$40M = \\$21.7B\n\\\\[0.5em]\n\\text{where } OPEX_{dFDA} = Cost_{platform} + Cost_{staff} + Cost_{infra} + Cost_{regulatory} + Cost_{community} = \\$15M + \\$10M + \\$8M + \\$5M + \\$2M = \\$40M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = TREATY\\_FUNDING - BOND\\_PAYOUT - IAB\\_POLITICAL\\_INCENTIVE\\_FUNDING = \\$21.8B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Victory_{annual} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } DALYs_{max,DFDA} = DALYs_{ann} \\times DALYs \\times Capacity_{max,DFDA} = 2.88B \\times 92.6\\% \\times 212 = 565B\n\\\\[0.5em]\n\\text{where } Capacity_{max,DFDA} = Ratio_{DFDA} + Delay = 204 + 8.2 = 212\n\\\\[0.5em]\n\\text{where } Ratio_{DFDA} = STATUS\\_QUO\\_AVG\\_YEARS\\_TO\\_FIRST\\_TREATMENT \\times (1 - 1/DFDA\\_TRIAL\\_CAPACITY\\_MULTIPLIER) = 204\n\\\\[0.5em]\n\\text{where } Status = Time \\times 0.5 = 443 \\times 0.5 = 222\n\\\\[0.5em]\n\\text{where } Time = \\frac{Diseases}{New} = \\frac{6{,}650}{15} = 443\n\\\\[0.5em]\n\\text{where } Diseases = Rare_{global} - 1 = 7{,}000 - 1 = 6{,}650\n\\\\[0.5em]\n\\text{where } Multiplier_{DFDA} = \\frac{Fundable_{ann}}{Trials_{curr}} = \\frac{23.4M}{1.9M} = 12.3\n\\\\[0.5em]\n\\text{where } Fundable_{ann} = \\frac{Treasury_{ann}}{Cost_{DFDA}} = \\frac{\\$21.7B}{\\$929} = 23.4M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = Treasury_{ann} - OPEX_{dFDA} = \\$21.8B - \\$40M = \\$21.7B\n\\\\[0.5em]\n\\text{where } OPEX_{dFDA} = Cost_{platform} + Cost_{staff} + Cost_{infra} + Cost_{regulatory} + Cost_{community} = \\$15M + \\$10M + \\$8M + \\$5M + \\$2M = \\$40M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = TREATY\\_FUNDING - BOND\\_PAYOUT - IAB\\_POLITICAL\\_INCENTIVE\\_FUNDING = \\$21.8B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Victory_{annual} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Increase_{max,treaty} = \\frac{Cost_{camp,total}}{DALYs_{max,DFDA}} = \\frac{\\$1B}{565B} = \\$0.00177\n\\\\[0.5em]\n\\text{where } Cost_{camp,total} = Campaign_{viral,treaty} + Campaign_{lobbying,treaty} + Campaign_{reserve,treaty} = \\$250M + \\$650M + \\$100M = \\$1B\n\\\\[0.5em]\n\\text{where } DALYs_{max,DFDA} = DALYs_{ann} \\times DALYs \\times Capacity_{max,DFDA} = 2.88B \\times 92.6\\% \\times 212 = 565B\n\\\\[0.5em]\n\\text{where } Capacity_{max,DFDA} = Ratio_{DFDA} + Delay = 204 + 8.2 = 212\n\\\\[0.5em]\n\\text{where } Ratio_{DFDA} = STATUS\\_QUO\\_AVG\\_YEARS\\_TO\\_FIRST\\_TREATMENT \\times (1 - 1/DFDA\\_TRIAL\\_CAPACITY\\_MULTIPLIER) = 204\n\\\\[0.5em]\n\\text{where } Status = Time \\times 0.5 = 443 \\times 0.5 = 222\n\\\\[0.5em]\n\\text{where } Time = \\frac{Diseases}{New} = \\frac{6{,}650}{15} = 443\n\\\\[0.5em]\n\\text{where } Diseases = Rare_{global} - 1 = 7{,}000 - 1 = 6{,}650\n\\\\[0.5em]\n\\text{where } Multiplier_{DFDA} = \\frac{Fundable_{ann}}{Trials_{curr}} = \\frac{23.4M}{1.9M} = 12.3\n\\\\[0.5em]\n\\text{where } Fundable_{ann} = \\frac{Treasury_{ann}}{Cost_{DFDA}} = \\frac{\\$21.7B}{\\$929} = 23.4M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = Treasury_{ann} - OPEX_{dFDA} = \\$21.8B - \\$40M = \\$21.7B\n\\\\[0.5em]\n\\text{where } OPEX_{dFDA} = Cost_{platform} + Cost_{staff} + Cost_{infra} + Cost_{regulatory} + Cost_{community} = \\$15M + \\$10M + \\$8M + \\$5M + \\$2M = \\$40M\n\\\\[0.5em]\n\\text{where } Treasury_{ann} = TREATY\\_FUNDING - BOND\\_PAYOUT - IAB\\_POLITICAL\\_INCENTIVE\\_FUNDING = \\$21.8B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Victory_{annual} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\\\[0.5em]\n\\text{where } Funding_{ann} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\end{aligned}",
};
...
export const VICTORY_BOND_ANNUAL_PAYOUT: Parameter = {
  ...
  latex: "\\begin{aligned}\nVictory_{annual} = Funding_{treaty} \\times Funding = \\$27.2B \\times 10\\% = \\$2.72B\n\\\\[0.5em]\n\\text{where } Funding_{treaty} = Spending_{mil,ann} \\times Reduction_{treaty} = \\$2.72T \\times 1\\% = \\$27.2B\n\\end{aligned}",
};
