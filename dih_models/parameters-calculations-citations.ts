...
export const DFDA_ANNUAL_OPEX: Parameter = {
  ...
  latex: "\\begin{aligned}\nCost_{DFDA,ann} \\\\\n&= Cost_{platform,DFDA} + Cost_{staff,DFDA} + Cost_{infra,DFDA} \\\\\n&\\quad + Cost_{reg,DFDA} + Cost_{community,DFDA} \\\\\n&= \\$15M + \\$10M + \\$8M + \\$5M + \\$2M \\\\\n&= \\$40M\n\\end{aligned}",
};
...
export const DFDA_NET_SAVINGS_RD_ONLY_ANNUAL: Parameter = {
  ...
  latex: "\\begin{aligned}\nSavings_{net,ann} = Benefit_{benefit,ann} - Cost_{opex,ann} = \\$58.6B - \\$40M = \\$58.6B\n\\\\[0.5em]\n\\text{where } Benefit_{DFDA,ann} = Trials_{ann} \\times Reduction_{DFDA} = \\$60B \\times 97.7\\% = \\$58.6B\n\\\\[0.5em]\n\\text{where } Reduction_{DFDA} = 1 - (DFDA\\_COST / TRADITIONAL\\_COST) = 97.7\\%\n\\\\[0.5em]\n\\text{where } Cost_{DFDA,ann} = Cost_{platform,DFDA} + Cost_{staff,DFDA} + Cost_{infra,DFDA} + Cost_{reg,DFDA} + Cost_{community,DFDA} = \\$15M + \\$10M + \\$8M + \\$5M + \\$2M = \\$40M\n\\end{aligned}",
};
