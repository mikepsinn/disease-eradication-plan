...
def generate_llms_txt(project_root: Path) -> Path:
    ...
    lines = [
        ...
        "",
        "> Academic research project proposing the 1% Treaty: redirecting 1% of global military spending to health research through Decentralized Institutes of Health (DIH). Contains peer-reviewed analyses, governance frameworks, and implementation strategies.",
        "",
        ...
        "- **Decentralized Institutes of Health (DIH)**: Distributed network for health research funding",
    ...
    lines.extend([
        ...
        "## Organization",
        "",
        "Decentralized Institutes of Health (DIH)",
        "- Website: https://dih.earth",
        "- Main project: https://WarOnDisease.org",
        "",
        "## Source Code",
        "",
