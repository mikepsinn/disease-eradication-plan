...
DFDA_TRIAL_CAPACITY_PLUS_EFFICACY_LAG_LIVES_SAVED = Parameter(
    ...
    display_name="Total Lives Saved from Elimination of Efficacy Lag Plus Earlier Treatment Discovery from Increased Trial Throughput",
    unit="deaths",
...
DFDA_TRIAL_CAPACITY_PLUS_EFFICACY_LAG_DALYS = Parameter(
    ...
    display_name="Total DALYs from Elimination of Efficacy Lag Plus Earlier Treatment Discovery from Increased Trial Throughput",
    unit="DALYs",
...
DFDA_TRIAL_CAPACITY_PLUS_EFFICACY_LAG_ECONOMIC_VALUE = Parameter(
    ...
    display_name="Total Economic Value from Elimination of Efficacy Lag Plus Earlier Treatment Discovery from Increased Trial Throughput",
    unit="USD",
...
DFDA_TRIAL_CAPACITY_PLUS_EFFICACY_LAG_SUFFERING_HOURS = Parameter(
    ...
    display_name="Suffering Hours Eliminated from Elimination of Efficacy Lag Plus Earlier Treatment Discovery from Increased Trial Throughput",
    unit="hours",
