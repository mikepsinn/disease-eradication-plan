...
**Corruption resistance.** Eighty percent of the fund flows through DALY-weighted subsidies automatically. No human touches it. No committee approves it. No senator holds it hostage for a highway. The algorithm takes the global disease burden data, calculates where each dollar prevents the most suffering, and sends the money. The remaining twenty percent is allocated by pairwise comparisons, which is the part humans direct. If someone corrupts the entire 20% (impressive; they'd need to influence 8 billion random voters), they've captured a fifth of the fund while four-fifths continued curing diseases regardless. Compare this to your current system, where a single senator on the appropriations committee can redirect 100% of the NIH budget to their preferred projects because they've held the seat for 30 years and nobody ran against them. Your corruption ceiling is 100%. Ours is 20%, and it's transparent. This is not a utopian promise. It's architecture.
