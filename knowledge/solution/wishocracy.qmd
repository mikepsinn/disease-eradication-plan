...
Congratulations! You've passed the [1% Treaty](1-percent-treaty.qmd) and now you've got {{< var treaty_annual_funding >}}/year to allocate.

How do you avoid parasitic special interests from stealing it or bureacracy from wasting it all?

**Wishocracy** replaces committees with code and representatives with mathematics. It's how you let 8 billion people collectively decide how to spend {{< var treaty_annual_funding >}} without it turning into a bureaucratic nightmare.
