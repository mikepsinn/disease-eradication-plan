...
Congratulations! You've passed a [1% treaty](1-percent-treaty.qmd) and now you've got {{< var treaty_annual_funding >}}/year flowing into the DIH treasury.
...
The [DIH](dih.qmd) functions as a **decentralized crowdfunding platform**. Anyone can submit a campaign proposal. Wishocracy allocates funds across competing campaigns.
...
**Allocation across campaign proposals competing for DIH treasury funds:**
...
- "Alternative dFDA Implementation" - $8M/year (competing approach)
...
- "Clinical Trial Insurance Pool" - $10B reserve

### How It Works: Pairwise Comparisons Between Campaigns

Instead of committees deciding "dFDA gets $10B," the global population votes using pairwise comparisons:

**"What's more important right now:"**

- "dFDA platform development" vs "Alzheimer's prize"?
- "Epic integration" vs "Security audits"?
- "Rare disease research" vs "Alternative dFDA platform"?
...
1. **Multiple competing implementations** - Which dFDA platform to fund? Which infrastructure provider?
...
The [dFDA marketplace](dfda.qmd) allocates resources **within** trials. Wishocracy allocates resources **between** campaigns.
