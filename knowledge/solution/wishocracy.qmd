...
Congratulations! You've passed the [1% Treaty](1-percent-treaty.qmd) and now you've got $27.2B/year to allocate.
...
Instead of asking, "Rank these {{< var dfda_large_trial_size >}} problems," the system asks:
...
2.  **The Bounty Board:** These tasks are posted to a global marketplace. It's like eBay, but for saving humanity.
    -   **WANTED:** A cure for Alzheimer's. **BOUNTY:** {{< var alzheimer_cure_bounty_estimate_billions >}}.
    -   **WANTED:** A map of all protein misfolding patterns. **BOUNTY:** {{< var recovery_trial_cost_per_patient >}} million.
