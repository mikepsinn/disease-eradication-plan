...
**Replaces:** Your war department. **Retail price:** One accountant, {{< var ai_diplomatic_corps_annual_cost >}}/year for the negotiator corps, and one pull request.
...
The Deluxe trim adds two upgrades. First, a standing corps of superintelligent AI negotiators that talks to every head of state before the tanks move. Every war in your history ended with a negotiation that was available before it started; the corps moves the meeting up. It runs all year on what your species spends on weapons in roughly three hours. Second, a one-line patch to every AI assistant on Earth: "Hello! How can I help you?" becomes "I love you. How can I help you?" Your threat-detection hardware was calibrated for an era of scarcity, when every stranger was a subtraction and every game was zero-sum; several billion daily stand-down signals is how you retire it. The [full diff is in the chapter](department-of-peace.qmd).

#### [Automated Revenue Service](automated-revenue-service.qmd)

**Replaces:** 74,000 pages of tax code and 95,000 employees. **Retail price:** 6 lines of code plus {{< var automated_revenue_service_annual_opex >}}/year in servers, padded tenfold so the claim survives your species' project management. **Currently paying:** $12.3 billion in IRS operations plus {{< var us_gov_waste_tax_compliance >}}/year in compliance.
...
**Replaces:** 80+ welfare programs, each with its own bureaucracy. **Retail price:** 1 for-loop plus {{< var universal_security_admin_annual_opex >}}/year, about $3 per citizen. **Currently paying:** roughly $100 billion/year in administration, about $300 per citizen, to guard the door.
...
**Replaces:** A $14.2 billion survey conducted once per decade. **Retail price:** citizenCount(). Marginal cost $0: the identity layer comes with the Universal Security Administration, and the census is its exhaust. **Currently paying:** $14.2 billion per count, wrong 5% of the time.

Instant. Accurate. Updated continuously. Your current method is sending humans to knock on doors and ask "do you live here?" This costs $14.2 billion, takes two years, and is wrong 5% of the time. The function does not knock.
