...
Here is a fun puzzle: Humanity knows how to save millions of lives. One can measure exactly how many. The money exists. And governments still don't do it.
...
One doesn't fix this with awareness campaigns. Activists have been "raising awareness" for decades and everyone is still dying. One doesn't fix it with white papers. Politicians use white papers to stabilize wobbly tables. One doesn't fix it by hoping for philosopher-kings. Plato tried that. It didn't work.

One fixes it by changing **what "self-interest" points at**.
...
The 1% Treaty isn't constrained by physics, biology, or money. It's constrained by **politics**, which is like being constrained by a dog's opinion on quantum mechanics except the dog can veto legislation.
...
If society wants different outcomes, it needs different incentives. Wishing very hard doesn't count.

### 2. Legal Incentives That Are Not Technically Bribery

Imagine one could say to every politician on Earth:

> "If the country adopts a 1%-style reform and citizens actually get healthier, the world will:
>
> * upgrade the politician's international reputation (they will get invited to better parties),
> * boost reelection odds (independent campaigns will favor them),
> * and make post-office career prospects significantly better than rivals' (Goldman Sachs boards, prestigious fellowships, that sort of thing)."

No backroom deals. No suitcases of cash. No prison.

No money to the politician personally, and no money to government budgets. What they get is external legitimacy, electoral support, and cushy retirement gigs. The things politicians actually optimize for.

Just a standing, public, announced-in-advance rule:

> "Do this objectively good thing, and the world will systematically reward the doer."
...
The basic structure operates in four steps.

#### Step 1: Define a Measurable Outcome

One chooses an outcome that:

* Is **measurable** with agreed methods.
* Is **directly attributable** to policy actions.
* Matters at scale.

The key insight: **measure funding flows, not downstream health outcomes.** Health benefits are global and diffuse - one can't attribute a cure discovered via a global framework for ubiquitous pragmatic trials to any specific country's funding. But one CAN measure:
...
No private deals.
No “the politician personally gets money.”
Just a **standing rule**:

> “If a leader supports this kind of high-impact policy and it works, the world will systematically make their political life easier, their legacy better, and their post-office prospects brighter.”
...
### 4a. The Three-Layer Architecture (Legal Compliance)
...
The key insight: one cannot legally say "support Bill #XYZ123 and get paid." That's bribery. People go to prison for that. It's also inefficient because one would have to bribe every politician individually, which doesn't scale.

But one *can* create a system where politicians who support a **class of pro-social policies** systematically get more electoral support, better reputations, and better post-office careers. The trick is: rule-based, ex-ante, universal mechanisms. No targeting individuals. No secret deals. Just standing rules that happen to reward saving lives.
...
Any politician supporting *any* policy matching this pattern gets credit. This avoids the "paying for a specific bill" problem entirely.
...
* No private deals ("we promise *this person* specifically")
* Just standing rules ("we support *any* candidate with Score ≥ S")
* All commitments made publicly and in advance

This is exactly how NRA grades, League of Conservation Voters scores, and Chamber of Commerce ratings already shape political behavior. The difference is the metric: instead of "did the politician vote for a narrow interest," it's "did the politician vote for policies that measurably reduced human suffering."

#### Layer C: Post-Office Career Benefits (The Revolving Door)
...
One can point it somewhere else.
...
* Oppose it → the politician can still get a job, but it won't be as good, and they'll have to explain why they voted against curing diseases
...
### 4b. Case Study: Senator Smith's Vote on the 1% Treaty

Abstract mechanisms are great for economists and terrible for everyone else. Here is how IABs actually work, using a US senator deciding how to vote on the 1% Treaty as the example.

#### The Primary Metrics to Maximize
...
2. **$ flowing to 1% Treaty Fund annually** (starts at $27B, scales with %)
...
- $\text{Status/Legacy}$ = how history remembers the individual (books written, buildings named, Wikipedia length)
...
| Tier 3 | $150-300K | Low | Military contractor boards, lobbying firms |

#### The Setup

[VICTORY Incentive Alignment Bonds](../economics/victory-bonds-academic.qmd) have raised $1B from investors who want 270% returns. That money has funded:
...
| Military contractors fund opponent | Military contractors fund incumbent |
...
4. **Constituent mail**: 70% of Texans voted yes in the referendum. Voting against that is explaining to voters why the incumbent thinks they're wrong about not wanting to die.
...
This is not cynical. This is public choice theory. It's only cynical if one thinks politicians should be motivated by pure altruism, in which case history suggests otherwise.

### 5. Legal Distinctions from Bribery

At first glance, this sounds like fancy bribery. "Reward politicians when they do what implies" is pretty much the definition.
...
1. **No one is paid to break a duty.**
   ...
   * "Please do the job better and society will tell everyone it was done" is not a bribe. It's a performance review.
...
2. **Rules are universal and ex-ante.**
   ...
   * It's like saying "society will give a prize to whoever cures cancer." That's not bribery. That's an incentive.
...
IABs **create** alignment. ("Support policies that save lives and career benefits follow.")

### 6. Comparison with Social Impact Bonds

Observers sometimes argue, "We already have Social Impact Bonds." This is like saying "we already have bicycles" when someone proposes building a railroad.
...
| **Purpose** | "Innovative financing" (jargon for "grant with extra steps") | Governance technology (also jargon, but accurate) |

Social Impact Bonds are pilot projects. Important and valuable, but small.
...
### 7. Integrating with the 1% Treaty

So how does this connect to the bigger project of ending war and disease?

The 1% Treaty says:

> “Let’s take 1% of global military spending and redirect it to ultra-efficient pragmatic trials, giving the world earlier access to cures and making nations safer than any new weapons system could.”

This is meaningless without a mechanism. Treaties are just PDFs with fancy letterheads unless countries have a reason to actually follow them.
...
(This is the point where investors align.)

### 7a. The Two Engines: Financial and Political

Readers of the [VICTORY Incentive Alignment Bonds chapter](../economics/victory-bonds-academic.qmd) might wonder: "Are these two different things?"
...
| **Role** | **Solves the Capital Problem**<br>Raises $1B to fund the campaign | **Solves the Political Problem**<br>Makes politicians *want* to support the treaty |
...
#### Objection 1: "Risk of Metric Gaming"
...
To game IAB metrics, one would need to:
...
Or one could just... run some clinical trials and save lives. That's actually easier.
...
#### Objection 2: "Plutocratic Influence Concerns"

This is the most important objection, so let's take it seriously.

If IABs are just plutocracy with better marketing, they deserve to fail. Let's see if they are.

**First, the uncomfortable reality:** Wealthy actors *already* buy policy. They do it via lobbying, revolving doors, campaign finance, and regulatory capture. The pharmaceutical industry alone spends over $300 million annually on lobbying in the United States. Military contractors spend more. The question is not "should money influence policy?" but rather "given that money *already* influences policy, can society channel that influence toward measurable global welfare instead of narrow interests?"
...
#### Objection 3: "Policy Reversal Risks"

Governments might reverse policy later. Politicians are humans, and humans have short attention spans and shorter terms.

Countermeasures:

* **Score decay**: Public Good Scores decline if outcomes reverse. Yesterday's hero becomes today's cautionary tale.
* **Long-term metrics**: Reward durability, not just one-off changes. "A politician signed a document" is worth less than "a politician maintained the system for five years."
* **Political scorecards**: Reversals tank the Public Good Score. The same mechanism that rewarded the leader for supporting the policy punishes them for killing it.

One cannot prevent all backsliding. But one can make it expensive enough that it's not the default move.
...
2. **Outcomes are measured**; health improves; leaders get invited to better conferences and scores rise.
...
Credit ratings didn't start as a global system. They started as one individual in the 1800s publishing opinions about railroad bonds. Now Moody's can tank a country's economy with a press release.
...
Incentive Alignment Bonds give society a way to say:

> "If a leader governs well by these objective metrics, the world will systematically make their political life easier, their legacy better, and their future brighter."
...
Incentive Alignment Bonds are one of the simplest, most scalable tools humanity has to do that.
...
This does not require politicians to be better people. It just makes "save lives" and "advance career" point in the same direction. The rest is just self-interest doing what self-interest does.

### 11. Why 10%: The Scaling Engine {#sec-why-ten-pct-scaling-engine}

One might wonder: Why dedicate {{< var iab_political_incentive_funding_pct >}} of treaty revenue ({{< var iab_political_incentive_funding_annual >}}/year) to political incentives? Isn't that money that could go to pragmatic clinical trials?

The answer requires understanding what the mechanism is actually trying to do.

#### The Goal Is Not a 1% Treaty. The Goal Is 100%.
...
- Military contractors adapt. They'll accept 1% as a small loss, then lobby to prevent further cuts.
...
| 5% | $135B | $13.5B/year | $108B/year | Military industry pivots to health |
...
The 10% isn't a cost. It's the **engine** that drives the entire expansion. Without it, one gets a one-time win. With it, one gets a self-reinforcing cycle that makes each expansion easier than the last.
...
- Year 4-7: Military lobby regroups. Politicians lose interest. No expansion.
- Year 8-15: Treaty stalls at 1%. Military spending slowly creeps back up.
...
- Year 8-15: 5% treaty. Military contractors pivot to health. More rewards.
...
The core insight, that one can legally align politicians' self-interest with public goods by creating scoring systems, independent electoral support, and post-office career paths, applies to *any* global coordination problem where:
...
#### Barriers to Previous Implementation
...
2. **The three-layer architecture is legally subtle.** One can't just pay politicians; that's bribery. The separation into scoring (data), electoral (independent campaigns), and post-office (eligibility rules) is what makes it legal. Most people proposing "better incentives" haven't worked through the legal structure.
...
4. **No one's tried it yet.** Many innovations seem obvious in retrospect. Before credit ratings, people thought "one can't just *rate* sovereign debt." Before carbon markets, people thought "one can't *trade* pollution." IABs are at the "this might be crazy" stage that precedes "obviously we should have done this earlier."
...
The 1% Treaty is the proof of concept. If it works, if humanity can show that IABs actually change political behavior at scale, the same architecture becomes available for climate, nuclear risk, pandemic preparedness, and every other problem where human extinction is possible but boring.
...
Experts have known for decades that ending war and disease is technically feasible. The constraint is political will. IABs don't create political will out of nothing; they make it the path of least resistance.

This approach does not ask politicians to be saints. It just makes "save millions of lives" and "advance my career" point in the same direction.
