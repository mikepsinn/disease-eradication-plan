...
You've got mission control, a network of decentralized institutes of health ([DIH](dih.qmd)), and a targeting system ([Wishocracy](wishocracy.qmd) [@wishocracy-paper-2025]). Now you need an army of AI agents to do the work. Humans are sleeping, arguing on Twitter, or attending conferences that accomplish nothing.
...
Once the treaty passes? Your agents shift from begging foundations to executing against the treaty-funded allocation system: patient-directed trial flows plus Wishocracy-governed shared priorities. But until then, we still live in the old world where money doesn't magically appear.
