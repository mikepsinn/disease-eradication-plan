...
Meanwhile, defense contractors somehow coordinate [{{< var global_military_spending_annual_2024 >}} in annual spending](../problem/cost-of-war.qmd) to build jets that don't work. They're idiots, but they're *coordinated* idiots with database infrastructure.
...
Right now, you still need money to keep the lights on and fund the {{< var campaign_phase1_budget_millions >}} global referendum campaign. Your agents help with this:
