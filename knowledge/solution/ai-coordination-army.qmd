...
description: Humans evolved to coordinate hunting parties of 20. You need to coordinate millions. Your brains literally can't do it. Robots can.
image: /assets/og-images/knowledge/solution/ai-coordination-army-og-retro-academic.jpg
podcast-image: /assets/podcast/ai-coordination-army-podcast.jpg
feed-date: '2026-04-03'
youtube-thumbnail: /assets/podcast/ai-coordination-army-youtube.jpg
scores:
  quality: 7
  value: 7
  timeliness: 8
  ...
  voice: 7
  importance: 5
audience: "A nonprofit, research-org, or campaign leader buried in manual coordination (email threads, dead Zoom calls, cross-timezone scheduling) who is going to stand up the AI agents that fight disease."
feel: "The relief and grip of \"I can finally build the coordination machine my own brain could never run, and millions can be pointed at one task starting now.\""
do: "Deploy a coordination node for your organization and point its agents at one task from Wishocracy's Task Tree."
---

You've got mission control, a network of [Decentralized Institutes of Health](dih.qmd) ([DIH](dih.qmd)), and a targeting system ([Wishocracy](wishocracy.qmd) [@wishocracy-paper-2025]). Now you need an army of AI agents to do the work. Humans are sleeping, arguing on Twitter, or attending conferences that accomplish nothing.
...
- **Your [Decentralized Institutes of Health](dih.qmd)** declare war on disease instead of on other humans (revolutionary concept)
- **[Wishocracy](wishocracy.qmd)** tells your army what to fight for (e.g., "Cure cancer" instead of "invade a country with oil")
...
Your agents don't randomly decide what to work on. They don't pick based on what sounds cool or what their creator happens to care about that day. They pull from [Wishocracy](wishocracy.qmd)'s Task Tree. That's the globally-prioritized breakdown of humanity's highest-priority problems into tasks a computer (or sufficiently motivated intern) can actually execute.

[Wishocracy](wishocracy.qmd) creates the list. For example, "Cure Alzheimer's" (vague, terrifying, impossible) becomes:
...
This means your agents do the thing that actually works: getting different organizations to talk to each other. They don't just automate the process of sending emails that no one reads and forming committees that accomplish nothing.

## Why You Need This (Humans Are Hilariously Bad at Coordination)

The NIH has 27,000 employees. They can't coordinate lunch orders, let alone millions of researchers. They spent [$1 trillion and eradicated zero diseases](../problem/nih-fails-2-institute-health.qmd). Their coordination strategy is "form a committee to discuss forming a committee."
...
The FDA thinks humans can manually coordinate global trials. These are the same humans who took [17 years and $2.6 billion](../problem/fda-is-unsafe-and-ineffective.qmd) to approve one drug. Asking them to coordinate is like asking goldfish to run a space program.

Meanwhile, murder engineers somehow coordinate {{< var global_military_spending_annual_2024 >}} in annual spending to build jets that don't work. The jets don't work, but the coordination does. They have database infrastructure. Health advocates have email threads.
...
Right now, you still need money to keep the lights on and fund the {{< var campaign_phase1_budget >}} [Global Referendum](../strategy/global-referendum.qmd) campaign. Your agents help with this:
...
Once the treaty passes? Your agents shift from begging foundations to executing against the treaty-funded allocation system: patient-directed trial flows plus [Wishocracy](wishocracy.qmd)-governed shared priorities. But until then, we still live in the old world where money doesn't magically appear.
...
You automate the soul-crushing coordination work that turns enthusiastic researchers into bitter husks. Match researchers with funding opportunities (before treaty: foundation grants; after treaty: patient-directed trial demand plus [Wishocracy](wishocracy.qmd)-governed infrastructure budgets). Recruit trial participants who actually meet the criteria (not just people who saw a Facebook ad and think they qualify). Track outcomes when half the participants ghost you. Synthesize literature when 50,000 new papers get published monthly and you're supposed to read them all.

What used to take 6 months of emails like "Just following up on my previous 12 emails..." now happens continuously. No laptop-throwing urges required. Phase 1: coordinate who applies for which grants. Phase 2: coordinate who executes which tasks from [Wishocracy](wishocracy.qmd)'s priority list and which patient-driven trials can actually absorb treaty funding.
...
You do more of what works. You kill what doesn't. No politics, no "but we've always done it this way," no protecting programs because someone's spouse runs them.
...
Your agents pull their missions from [Wishocracy](wishocracy.qmd)'s Task Tree, not from brainstorming sessions where someone says "wouldn't it be cool if..." You prevent them from becoming useless generalists (like every nonprofit's "Director of Strategy and Partnerships and Innovation and Impact") by mapping each agent to one specific task from that tree. Here's how:

**1. Pick a Task from the Tree:**

[Wishocracy](wishocracy.qmd)'s Task Tree breaks "Cure Alzheimer's" (impossible, vague, makes you want to give up) down into executable tasks. Examples: "Find researchers studying protein misfolding" or "Recruit trial participants age 65+ with early symptoms."
...
This is the outcome you actually care about. For the same agent: "Number of researchers who sign up for a trial within your [decentralized FDA](dfda.qmd) [@dfda-spec-paper-2025; @dfda-impact-paper-2025]." This tells you if the action works. Or if you've built an agent that's really good at sending emails no one reads.

This structure (borrowed from "The 4 Disciplines of Execution") turns tasks from [Wishocracy](wishocracy.qmd)'s global list into specific agent missions. You can build, measure, and improve them without hiring a consultant to interpret the results.
...
This ensures every success and failure becomes a lesson for the entire network. The whole army gets smarter over time. Individual organizations stop repeating the same mistakes in isolation while pretending they're inventing the future.

## Related: Correcting Frontier LLMs

Your agents do the work. The frontier models they run on are [confidently wrong about half this book](../appendix/correcting-the-ais.qmd). Fixing that is the next job.
