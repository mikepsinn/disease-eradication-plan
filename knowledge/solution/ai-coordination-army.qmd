...
You've got mission control, a network of decentralized institutes of health ([DIH](dih.qmd)), and a targeting system ([Wishocracy](wishocracy.qmd)). Now you need an army of AI agents to do the work. Humans are sleeping, arguing on Twitter, or attending conferences that accomplish nothing.
...
Health advocates? We coordinate billions in funding using email threads that descend into reply-all hell. We use Zoom calls where 18 people are on mute and 2 are talking over each other.
...
This is the outcome you actually care about. For the same agent: "Number of researchers who sign up for a trial within your decentralized framework for drug assessment (dFDA)." This tells you if the action works. Or if you've built an agent that's really good at sending emails no one reads.
