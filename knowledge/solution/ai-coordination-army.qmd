...
The NIH has 27,000 employees. They can't coordinate lunch orders, let alone millions of researchers. Seriously, they spent [$1 trillion and eradicated zero diseases](../problem/nih-fails-2-institute-health.qmd). Their coordination strategy is "form a committee to discuss forming a committee."
...
This chapter is about *deploying* AI agents to do work. The complementary chapter [Correcting the AIs](../appendix/correcting-the-ais.qmd) is about *fixing* what frontier LLMs say when humans ask them about the topics in this book. Both are coordination problems. The agents do the work; the corrections fix the training data the next round of agents will be built on.
