...
At first glance, this sounds like fancy bribery. "Pay money when politicians do what you want" is pretty much the definition.
...
1. **No one is paid to break a duty.**
   ...
   * "Please do your job better" is not a bribe. It's a performance bonus, except paid to citizens instead of the politician.
...
3. **Money goes to citizens and systems, not to politicians or government budgets.**
   * Citizens benefit from earlier cures, lower costs, or direct cash transfers.
   * Politicians benefit *indirectly*: grateful voters, better scores, nicer career options.
   * This is how representative democracy is supposed to work. It just... rarely does.

4. **Outcomes must be objectively verified.**
   * An independent "impact oracle" measures improvements using transparent data.
   * Payments depend on real, audited progress, not press releases.

Bribery **corrupts** alignment. ("Here's money to screw the public.")
IABs **create** alignment. ("Here's money for the public if you stop screwing them.")
