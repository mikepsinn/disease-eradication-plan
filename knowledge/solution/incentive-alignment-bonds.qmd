...
The key insight: **measure funding flows, not downstream health outcomes.** Health benefits are global and diffuse - you can't attribute a cure discovered via a global framework for ubiquitous pragmatic trials to any specific country's funding. But you CAN measure:
...
[VICTORY Incentive Alignment Bonds](../economics/victory-bonds.qmd) have raised $1B from investors who want 270% returns. That money has funded:
...
### 7a. How VICTORY Incentive Alignment Bonds and IABs Work Together

If you've read the [VICTORY Incentive Alignment Bonds chapter](../economics/victory-bonds.qmd), you might wonder: "How do these fit together?"

They solve different problems for different people:

| | VICTORY Incentive Alignment Bonds | Incentive Alignment Bonds |
|:--|:--------------|:--------------------------|
...
**VICTORY Incentive Alignment Bonds** solve the **capital problem**: "How do we raise $1B to fund the campaign that passes the treaty?"
...
|:------|:-----------|:-------------|
| Pre-Treaty | VICTORY Incentive Alignment Bonds | Raise capital from investors; fund the campaign |
...
VICTORY Incentive Alignment Bonds get investors to fund the war. IABs get politicians to fight it (and keep fighting after victory).

The {{< var dih_treasury_medical_research_pct >}} of treaty revenue that doesn't go to bondholders or political incentives? That is allocated from the 1% Treaty Fund to decentralized institutes of health (DIH) to actually fund the pragmatic clinical trials. The split is:
...
| Research Funding | {{< var dih_treasury_medical_research_pct >}} | {{< var dih_treasury_to_medical_research_annual >}} | Actually curing diseases |
...
The 10% IAB allocation creates something VICTORY Incentive Alignment Bonds cannot: **perpetual, compounding political incentives** that only increase with treaty expansion.
