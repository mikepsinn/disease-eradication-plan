...
Wealthy actors *already* buy policy. Pharma spends $300M/year on lobbying. Defense contractors spend more. That ship sailed, sank, and was rebuilt. The difference: IABs point the money at welfare instead of warfare (see [why this isn't bribery](#sec-why-not-bribery)).
...
Yes. Your politicians game everything. But to game *these* metrics, you'd have to falsify your own vote (public record) or pretend money moved when it didn't (treasury records are public). That's orders of magnitude harder than self-reported ESG compliance, which is the bar your species currently uses. (It is an extremely low bar.)
...
Score decay. The same mechanism that rewarded you punishes backsliding. You can't prevent all reversals, but you can make them career suicide, which is the only kind of death politicians fear.
