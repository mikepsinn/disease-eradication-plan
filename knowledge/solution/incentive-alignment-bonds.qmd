...
Bribery **corrupts** alignment. IABs **create** it. Wealthy actors already buy policy (pharma spends $300M/year on lobbying, defense contractors spend {{< var defense_lobbying_annual >}}/year). The question isn't "should money influence policy?" but "can you point the money at welfare instead of warfare?" IAB funders will have more influence over which public goods get prioritized. So does the Gates Foundation over malaria. The difference is that IABs are transparent, measurable, and auditable. Most lobbying satisfies zero of those criteria.
...
2. **Lobbying meeting**: Military lobby threatens. But three major contractors already support the treaty ({{< var victory_bond_annual_return_pct >}} returns beat 8%). Threat is empty.
