...
| Annual DIH funding | $0 | $27B |
| Bondholder returns | 0% | 270%/year |
| Research funding | $0 | $24.3B/year |
...
- 10% ($2.7B/year) flows to bondholders → 270% annual returns
- 90% ($24.3B/year) funds actual cures → diseases start declining → public demands expansion → returns grow
...
| **What they get** | 270% annual returns (money) | Reputation, electoral support, post-office careers (not money) |
...
The 90% of treaty revenue that doesn't go to bondholders? That goes to DIH to actually fund the research. Neither instrument touches that money. VICTORY Bonds take their 10% cut for investors. IABs don't involve money at all, they just make sure politicians get credit (and career benefits) for doing the right thing.
