...
Bribery **corrupts** alignment. IABs **create** it. Wealthy actors already buy policy (pharma spends $300M/year on lobbying, weapons manufacturers spend {{< var defense_lobbying_annual >}}/year). The question isn't "should money influence policy?" but "can you point the money at welfare instead of warfare?"
...
**Pitch angle:** If you believe the treaty can pass, the risk-adjusted return is compelling. If you don't, no return percentage will convince you. But before you decide which camp you're in, try answering [five questions](/knowledge/appendix/recruitment-and-propaganda-plan.qmd#logical-inevitability-theorem). Is it physically possible to improve how your species allocates {{< var global_military_spending_annual_2024 >}}/year? Does redirecting even 1% compound into everyone being {{< var gdp_expected_value_vs_current_trajectory_multiplier_year_20 >}} richer? Do you have a better mechanism? If not, the only remaining question is whether you're the credible first mover who triggers the [dominant assurance contract](/knowledge/appendix/recruitment-and-propaganda-plan.qmd#your-ammunition), or whether you wait for someone else to be, which is the coordination failure the entire instrument was designed to solve.
