...
One clarification before the mechanics. These bonds are a product [Earth Optimization Services](earth-optimization-services.qmd) offers, the way a company issues bonds. They are not shares in Earth Optimization Services. Voting shares cannot be bought at any price: yours came with being alive, and it is not for sale. [EOS Investor Shares](../economics/investment-terms.qmd) are the buyable class, and they are a different product from these bonds: the shares buy the companies, the bonds fund the campaign. Everything follows the same rule either way: money in, more money out, and the vote stays one per human.
...
A financial instrument that generates massive returns while accidentally curing diseases as a side effect. A hedge fund with a conscience, except the conscience is also profitable.
