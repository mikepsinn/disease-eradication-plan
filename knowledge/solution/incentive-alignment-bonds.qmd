...
- {{< var victory_bond_funding_pct >}} ({{< var victory_bond_annual_payout >}}/year) flows to bondholders → {{< var victory_bond_annual_return_pct >}}
...
| **What they get** | {{< var victory_bond_annual_return_pct >}} (money) | Reputation, electoral support, post-office careers |
...
![A comparison of metric 'gamability' showing why public records like voting and treasury flows are more reliable than self-reported data.](/assets/images/incentive-alignment-bonds/incentive-alignment-bonds-section-objection-1-won-t-politicians-game-the-metrics-bw-academic.jpg)
...
![A conceptual diagram showing the impact of political actions on a Public Good Score over time, illustrating the rewards for long-term defense and the steep penalties for policy reversal.](/assets/images/incentive-alignment-bonds/incentive-alignment-bonds-section-objection-3-what-if-politicians-pocket-the-career-rewards-th-bw-academic.jpg)
...
The fact that you can legally align politicians' self-interest with public goods by creating scoring systems, independent electoral support, and post-office career paths, applies to *any* global coordination problem where:
