...
Billionaires have everything except the one thing money can't buy: not dying. You're selling longevity with a {{< var victory_bond_annual_return_pct >}} annual return. This is the easiest sale in history.
...
- The dynamic reverses: supporting health spending becomes the concentrated-benefit option
...
VICTORY [Incentive Alignment Bonds](https://iab.warondisease.org) solve the **funding problem**:
...
But after the 1% treaty passes, VICTORY Incentive Alignment Bond holders are **satisfied**. They're getting their {{< var victory_bond_annual_return_pct >}} returns. They have no financial incentive to push for 2%, 5%, or {{< var victory_bond_funding_pct >}} treaties. Their job is done.
...
**IAB funding scales with treaty size.**

| Treaty Level | VICTORY Incentive Alignment Bond Returns | IAB Political Funding |
|:-------------|:--------------------|:---------------------|
| 1% | {{< var victory_bond_annual_return_pct >}} (fixed) | {{< var iab_political_incentive_funding_annual >}}/year |
| 2% | {{< var victory_bond_annual_return_pct >}} (fixed) | $5.4B/year |
| 5% | {{< var victory_bond_annual_return_pct >}} (fixed) | $13.5B/year |
| {{< var victory_bond_funding_pct >}} | {{< var victory_bond_annual_return_pct >}} (fixed) | {{< var treaty_annual_funding >}}/year |
...
Even if it the treaty does pass. It stalls at 1-2%. Politicians move on, military lobby regroups, expansion never happens. The 1% treaty becomes like the Paris Agreement: a nice symbol that everyone ignores.
...
[VICTORY Incentive Alignment Bonds](/knowledge/economics/victory-bonds.qmd) are a specific [Incentive Alignment Bond](/knowledge/solution/incentive-alignment-bonds.qmd) - a single instrument that aligns all three stakeholder types:
...
![Distribution of the 1% Treaty Fund revenue, illustrating the 80/10/10 split between research, investors, and political incentives.](/assets/images/aligning-incentives/aligning-incentives-section-victory-impact-alignment-bonds-bw-academic.jpg)
