...
- ${{< var qalys_from_prevention_conservative >}}-{{< var qalys_from_faster_access >}}/year additional revenue running trials
...
- They have {{< var global_clinical_trial_market_annual >}} in pension obligations
...
weapons_revenue = 100_000_000_000  # {{< var global_clinical_trial_market_annual >}}
weapons_margin = 0.08  # 8% profit margin
weapons_profit = weapons_revenue * weapons_margin  # $8B

# With VICTORY Bonds + Medical Tech

bonds_investment = 1_000_000_000  # {{< var treaty_campaign_total_cost >}} investment
bonds_return = 0.40  # 40% annual return (conservative)
medical_tech_revenue = 10_000_000_000  # {{< var dih_treasury_trial_subsidies_min >}} new market
...
- **Success rate**: 1 in {{< var dfda_large_trial_size >}} compounds work (lottery odds)
...
- Patients + DIH subsidies pay pharma ${{< var traditional_large_trial_size >}} per participant
...
average_revenue = 1_000_000_000  # {{< var treaty_campaign_total_cost >}} lifetime revenue
roi = (average_revenue - development_cost) / development_cost
print(f"Current Pharma ROI: {roi:.1%}")  # -61.5% (LOSS!)

# New DIH System

development_cost_new = -50_000_000  # They GET PAID {{< var treaty_campaign_budget_reserve >}}
success_rate_new = 0.60  # 60% succeed (lower bar)
average_revenue_new = 500_000_000  # {{< var recovery_trial_cost_per_patient >}}M (smaller markets OK)
...
- Test their {{< var dfda_large_trial_size >}} shelved compounds
...
- "Senator brings {{< var dfda_large_trial_size >}} jobs to Iowa"
...
$$
\text{\{{< var treaty_campaign_total_cost >}} investment} \rightarrow \text{\{{< var victory_bond_annual_payout >}} annual returns}
$$
...
- Current jobs: ~{{< var dfda_large_trial_size >}}
- New jobs in DIH system: ~{{< var qalys_from_prevention_conservative >}}
...
- 35 of {{< var traditional_large_trial_size >}} billionaires
...
- Vote for the treaty
- Buy ${{< var traditional_large_trial_size >}} in bonds
