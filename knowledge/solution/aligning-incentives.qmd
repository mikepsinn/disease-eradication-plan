...
|--|--------------|--------------
| You Invest | {{< var victory_bond_annual_return_pct >}} returns | {{< var victory_bond_annual_return_pct >}} returns |
...
Success requires just {{< var global_population_activism_threshold_pct >}} of power players:
...
- Get {{< var victory_bond_annual_return_pct >}} returns forever
