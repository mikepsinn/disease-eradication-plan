...
subtitle: "Constitutional Architecture for Refusing Sovereign Immunity in Negligent Mass Homicide"
description: A decentralized court where {{< var global_population_2024_nounit >}} humans are the jury, sovereign immunity is not recognized as a defense, and the 1% Treaty becomes the settlement offer governments accept to cap their exposure to mass-death accountability.
abstract: |
  ...
  **Court of Humanity**, a decentralized adjudication mechanism deriving
  ...
  remedy. The Court does not recognize sovereign immunity as a defense.
  Enforcement is not coercive but *capital*: judgments can be priced into
...
The damages model uses the same posture a prosecutor would use against a corporate defendant: plead every viable theory, prove the strongest ledgers first, then prevent double recovery at judgment. Corporate prosecution doctrine already separates restitution, fines, victim compensation, compliance measures, monitors, debarment, disgorgement, and remedial orders [@doj-federal-prosecution-business-organizations; @ussc-organizational-guidelines-2025]. The Court of Humanity applies that structure to the larger organization currently calling itself government.

Your existing system already uses this posture against corporations. Pfizer paid $2.3 billion in a 2009 health-care fraud resolution [@doj-pfizer-2009-health-care-fraud-settlement]. BP's Deepwater Horizon civil settlement reached $20.8 billion [@doj-bp-deepwater-horizon-20-8b-settlement]. Volkswagen paid $4.3 billion in criminal and civil penalties and accepted a corporate monitor after cheating emissions tests [@doj-volkswagen-4-3b-2017]. The Court is not inventing the remedy stack. It is applying the existing corporate remedy stack to a defendant whose revenue, customer base, and body count are larger.

The model has to keep separate things separate. [Humanity v. Government](../appendix/humanity-v-government.qmd) establishes the liability theory. [Cost of War](../problem/cost-of-war.qmd#the-medical-opportunity-cost) supplies the historical opportunity-cost counterfactual. [1% Treaty Impact](../economics/1-pct-treaty-impact.qmd) [@1-pct-treaty-impact-paper-2025] supplies the forward settlement value if the remedy is adopted now.

| Remedy ledger | Measure | What it establishes |
|---|---|---|
| Compensation | {{< var war_deaths_since_1900_nounit >}} war deaths, {{< var existing_drugs_efficacy_lag_deaths_total_nounit >}} efficacy-lag deaths, and related healthy life-years lost | Victim harm, using VSL or QALY/DALY methods as alternatives. |
| Restitution | {{< var war_trial_redirect_excess_military_spending_above_1900_freeze >}} above the 1900 freeze | Entrusted funds that should have become treatment discovery capacity. |
| Audit and fraud exposure | {{< var pentagon_unaccounted_funds >}} unaccounted, or {{< var pentagon_unaccounted_false_claims_analog_exposure >}} under a False Claims Act-style treble analogy | What ordinary corporate treatment of missing public funds would imply [@doj-false-claims-act]. |
| Disgorgement | Defense-contractor gains, revolving-door compensation, procurement rents | Gains retained from the offense, separated from victim compensation. |
| Remediation | 1% Treaty funding, clinical-trial trust, independent audit monitor, debarment, clawbacks | Structural cure and risk reduction. |
| Forward settlement | {{< var dfda_trial_capacity_plus_efficacy_lag_lives_saved_nounit >}} future deaths prevented by the treaty remedy | The value of settling now instead of continuing the offense. |

The table deliberately does not add every line into one central damages number. VSL deaths, DALYs, lost GDP, restitution, disgorgement, and punitive multipliers are different legal theories. Add them all together and the spreadsheet starts lying.

Keeping ledgers separate does not mean the prosecution lacks a demand. The primary damages theory is **lost profits**, the framework antitrust and commercial-litigation prosecutors actually lead with. Treated as a corporation paid {{< var global_government_expense_annual >}} per year to promote the general welfare, the defendants face a representative full-life cohort exposure of {{< var lost_prosperity_lifetime_damages_per_capita >}} per person, or {{< var lost_prosperity_npv_perpetuity_per_capita >}} per person as the NPV perpetuity at 3% under a no-cure baseline. The body-count tiers below are **alternative pleadings** the Court can fall back on if the lost-profits theory is rejected.

| Prosecutor posture | Per representative person | Status |
|---|---:|---|
| **Lost-prosperity-only, lifetime undiscounted (cohort)** | **{{< var lost_prosperity_lifetime_damages_per_capita >}}** | **Primary theory.** Single coherent lost-profits claim, 80-year cohort horizon. Per-individual award scales by remaining life expectancy. Cannot be added to the body-count tiers; replaces them. |
| **Lost-prosperity-only, NPV perpetuity at 3% (no-cure baseline)** | **{{< var lost_prosperity_npv_perpetuity_per_capita >}}** | Primary theory, financial-standard valuation. Sensitivity exposure under a no-convergence baseline. Cannot be added to the body-count tiers; replaces them. |
| Strict floor (body-count alternative) | {{< var corporate_damages_strict_floor_per_capita >}} | Cautious non-duplicative award if the Court rejects the lost-profits theory. |
| Body-count base ask | {{< var corporate_damages_prosecutor_base_ask_per_capita >}} | Aggressive body-count alternative if the Court rejects the lost-profits theory. |
| Treble-style exposure (body-count) | {{< var corporate_damages_treble_exposure_per_capita >}} | False Claims Act-style penalty exposure on the body-count base ask. |
| Constitutional-ceiling exposure under *State Farm v. Campbell* | {{< var corporate_damages_state_farm_ceiling_exposure_per_capita >}} | Body-count base ask plus a 9:1 punitive-to-compensatory ceiling, exposure only [@state-farm-v-campbell-2003]. |
| Ongoing lost prosperity (annual flow) | {{< var war_counterfactual_lost_gdp_per_capita >}}/person/year | Annual damages flow. The two lost-prosperity-only rows above are this same flow capitalized as a stock. |
| Forward treaty settlement value | {{< var corporate_damages_forward_settlement_value_per_capita >}} | Separate settlement value from adopting the remedy now. |

For context, global GDP is approximately {{< var global_gdp_2025 >}} per year. Even a heavily discounted exposure is larger than ordinary compensation can handle.
