...
description: A court where any human can sue any government, sovereign immunity is not a defense, and the 1% Treaty is the settlement offer.
abstract: |
  Governments wrote laws making it illegal to sue them. The legal term is
  "sovereign immunity." It descends from "the king can do no wrong," which
  your species abolished in theory and preserved in practice. Governments
  waived it for slip-and-falls in federal buildings. They kept it for
  killing people through war, drug delay, and budget misallocation. This
  paper proposes the **Court of Humanity**: any human can file, any
  government can be sued, juries are randomly selected from the global
  population, and sovereign immunity is not recognized as a defense.
  Enforcement runs through bond markets, not armies: if the world's
  investors agree the defendants owe the bill, the defendants' borrowing
  costs go up whether they cooperate or not. The bill, calculated from
  the body count using the governments' own life valuations
  ([@invisible-graveyard-paper-2025]), is larger than any government can
  pay. They can, however, settle. The [1% Treaty](1-percent-treaty.qmd)
  [@1-pct-treaty-impact-paper-2025] is the settlement offer.
published: true
author:
  - name: Mike P. Sinn
    affiliation:
...
scores:
  ...
  voice: 10
  importance: 10
audience: "The Humanity Manager building the court that lets any person sue the government that killed their family, plus the funder deciding where one dollar saves the most lives."
feel: "Capable ownership: sovereign immunity was always just a choice, and a court that runs on human consent is mine to stand up right now, no government's permission required."
do: "Build the consent record that turns the court on: file the cases, publish the verdict ledger, and gather human and organization signatures at warondisease.org that give the court its authority."
---
...
The double standard is not constitutional. It is political. Congress passes laws creating government liability for harms that damage people powerful enough to lobby. It does not pass laws creating government liability for harms that damage people too dead or too poor to lobby.
...
The bill is calculated the same way a prosecutor would calculate it against a corporation: list every category of harm, prove the biggest ones first, and do not count the same death twice. Your existing system already does this. Pfizer paid $2.3 billion for health-care fraud [@doj-pfizer-2009-health-care-fraud-settlement]. BP paid $20.8 billion for the Deepwater Horizon spill [@doj-bp-deepwater-horizon-20-8b-settlement]. Volkswagen paid $4.3 billion for cheating emissions tests and accepted a government monitor [@doj-volkswagen-4-3b-2017]. The Court is not inventing the bill format. It is applying the existing corporate bill format to a defendant whose revenue, customer base, and body count are larger [@doj-federal-prosecution-business-organizations; @ussc-organizational-guidelines-2025].

The full bill, broken into categories (what they owe for killing people, giving the money back, losing the money, making them return the profits, fixing the problem, and the value of settling now) is in the [Corporate Damages Schedule](../appendix/humanity-v-government.qmd#corporate-damages-schedule) of [Humanity v. Government](../appendix/humanity-v-government.qmd). The prosecutor's demand, including the primary lost-income theory ({{< var lost_prosperity_lifetime_damages_per_capita >}} per person over a lifetime) and the body-count backup tiers, is in the [Prosecutor's Demand](../appendix/humanity-v-government.qmd#the-prosecutors-demand). The three source ledgers are: [Humanity v. Government](../appendix/humanity-v-government.qmd) for the liability theory, [Cost of War](../problem/cost-of-war.qmd#the-medical-opportunity-cost) for the historical cost of trials never funded, and [1% Treaty Impact](../economics/1-pct-treaty-impact.qmd) [@1-percent-treaty-paper-2025] [@1-pct-treaty-impact-paper-2025] for the future value of adopting the remedy now.

For context, global GDP is approximately {{< var global_gdp_2025 >}} per year. Even after heavy discounting, the bill is larger than any government can pay.
...
**The jury.** A randomly selected panel of approximately 1,000 to 10,000 verified humans, drawn proportionally from the global population using demographic and regional stratification. Multiple parallel juries vote on the same case independently. When they agree, the finding holds. When they disagree, expanded review is triggered. The stratified-random model prevents vote-brigading (advocates cannot select their own jury) and bounds the information load (only ten thousand humans must read the evidence, not {{< var global_population_2024_nounit >}}).
...
Each one demonstrates that mass tort liability can be resolved through structural settlement without either defendant collapse or plaintiff-lottery dynamics. The Court of Humanity does the same for the largest unaddressed mass tort in human history. The legal precedent exists. The financial precedent exists. The only thing that does not exist is the institution, and that is what you are building.
...
**Phase 3: Steady-state.** Pattern-matched cases dominate the docket. Attorneys occupy the edge-case fallback procedure rather than the routine procedure. The Court operates primarily as a machine that automatically fixes the problems it keeps seeing. Novel conduct categories still get traditional procedure, which produces new templates, which reduces the number of novel cases. The system converges on efficiency, which is what systems do when you stop letting lawyers charge hourly.
...
Your species measures charitable interventions by how many years of healthy life each dollar buys. The standard benchmark is the malaria bed net, at {{< var bed_nets_cost_per_daly >}} per year of healthy life saved. The Court of Humanity is, by a margin I find interesting, the highest-value charitable intervention currently available to your species.

Building the Court costs {{< var court_build_cost >}}. The International Criminal Court, for comparison, funds physical courtrooms, detention facilities, and a permanent staff. The Court of Humanity is digital: evidence submitted via web, AI triage, juries voting from home. No marble. No gavels. No parking garage.
...
The full upside is described in the [1% Treaty Impact Analysis](../economics/1-pct-treaty-impact.qmd) [@1-pct-treaty-impact-paper-2025] for the conservative case, in [The Political Dysfunction Tax](../appendix/political-dysfunction-tax.qmd) [@political-dysfunction-tax-paper-2025] for the recoverable losses across the broader governance system, and in [GDP Trajectories](../economics/gdp-trajectories.qmd) [@gdp-trajectories-paper-2025] for the best-case scenario. The Court is the legal instrument that connects the indictment to the settlement. Everything else in this book describes what the settlement pays for.
...
Now there is a court. It does not need their permission. It does not need their buildings, their sheriffs, their approval, or their cooperation. It runs on yours. Your signature is what turns it on: you saying, publicly and on the record, that the king can, in fact, do wrong, and that you noticed.
