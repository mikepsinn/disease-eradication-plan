...
format:
  html:
    toc: true
    toc-depth: 3
image: /assets/og-images/knowledge/solution/war-on-disease-og.png
---
...
Your decentralized framework for drug assessment (dFDA) creates a competitive marketplace where thousands of treatments are tested simultaneously and the ones that work survive. Like evolution, except faster and with less dying.
