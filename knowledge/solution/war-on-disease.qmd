...
- {{< var traditional_large_trial_size >}}+ active trials launched (versus current 50/year)
- 100,000+ patients enrolled (versus current 5,000)
- A 50.0% reduction in trial costs demonstrated (from $41,000 to {{< var recovery_trial_cost_per_patient >}} per patient)
