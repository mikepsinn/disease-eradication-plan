...
format:
  html:
    toc: true
    toc-depth: 3
image: /assets/og-images/knowledge/solution/war-on-disease-og-academic.png
---

{{< include /knowledge/includes/setup-parameters.qmd >}}

![Designing the First War to Win](/assets/infographics/knowledge/solution/war-on-disease-infographic-academic.png)
