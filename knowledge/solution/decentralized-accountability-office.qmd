...
The honest price: zero additional dollars. The ledger itself is bought and paid for by the [Automated Revenue Service](automated-revenue-service.qmd), which needs it to collect taxes. Auditing is what a ledger does when you look at it. Charging separately for the audit would be like charging separately for the shadow.
