...
1.  **The Problem:** The world spends [{{< var global_military_spending_annual_2024 >}} a year](../references.qmd#global-military-spending-2-44t) on military forces to maintain a delicate balance of power.
...
2.  **Execution:** DIH subsidizes patient participation in the [dFDA](dfda.qmd)—clinical trials that are **[82x cheaper](../references.qmd#recovery-trial-82x-cost-reduction)** than current model
...
WHEREAS, humanity spends [{{< var global_military_spending_annual_2024 >}} annually](../references.qmd#sipri-2024-spending) on methods of killing itself;
