...
2.  **Execution:** DIH subsidizes patient participation in the [dFDA](dfda.qmd)—clinical trials that are **{{< var dfda_cost_effectiveness_multiplier >}}× cheaper** than current model
...
**For Economists**:
"The ROI is {{< var roi_all_direct_benefits >}}:1. This beats every other public health intervention on record."
...
- Pragmatic trials: {{< var recovery_trial_cost_per_patient >}} per patient ({{< var dfda_cost_effectiveness_multiplier >}}× cheaper)
