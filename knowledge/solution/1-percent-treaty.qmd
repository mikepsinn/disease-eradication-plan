---
title: The 1% Treaty
description: How to Redirect {{< var treaty_annual_funding >}} from War to Medicine - The complete guide to the 1% Treaty, the binding global accord that redirects {{< var treaty_annual_funding >}} annually from military spending to curing disease while maintaining global security.
published: true
tags:
  - solution
  - 1-percent-treaty
...
1.  **Funding:** Creates {{< var treaty_annual_funding >}}/year revenue stream for the DIH
2.  **Execution:** DIH subsidizes patient participation in the [dFDA](dfda.qmd)—clinical trials that are **{{< var trial_cost_reduction_factor >}}× cheaper** than current model
...
### The Revised ROI Equation: From Trade-off to Double Win

Most people think of the 1% Treaty as a sacrifice: "We give up some security to gain health benefits."

That's wrong. Here's the actual equation:

**Old Logic (False Trade-off):**
"We must sacrifice security (Cost) to gain health (Benefit)."

**True Logic (Double Win):**
"We reduce the risk of annihilation (Benefit 1) AND we gain cures for diseases (Benefit 2)."

This transforms the 1% Treaty into a **Pareto Improvement**—a change where at least one party is better off, and no one is worse off.

#### Why This Works

1. **Security Actually Improves**: By lowering the global "temperature" of militarization, the world becomes safer immediately, even before the first dollar is spent on research. Fewer deployed weapons = lower probability of accidental launch, miscalculation, or escalation.

2. **Health Massively Improves**: The {{< var treaty_annual_funding >}} annually funds the dFDA system that accelerates medical research {{< var research_acceleration_multiplier >}}×.

3. **No One Loses Strategic Position**: Since everyone reduces by 1% simultaneously, relative power balances remain identical. You still have 99% of your deterrence capability.

#### The Economic Reframe

- **Standard View**: "Spending" {{< var global_military_spending_annual_2024 >}} on defense to "get" security
- **Eisenhower's View**: "Wasting" {{< var global_military_spending_annual_2024 >}} on dead capital that generates no return
- **1% Treaty View**: "Stop wasting" 1% on destruction, "start creating" {{< var treaty_annual_funding >}} in productive assets

You're not trading security for health. You're trading **negative assets** (missiles that cost money and sit idle) for **productive assets** (medical research that compounds value).

The choice isn't "bombs or medicine." It's "dead capital or living capital."
...
**For Economists**:
"The ROI is {{< var dfda_roi_rd_plus_delay >}}:1. This beats every other public health intervention on record."
...
**Distribution**:
The {{< var treaty_annual_funding >}} flows into the DIH Treasury, where it is allocated directly by the people of Earth via the Wishocracy platform. There are no committees or central planners. While allocations are dynamic, initial priorities determined by the crowd are projected to focus on:
...
- Pivotal trials: {{< var traditional_phase3_cost_per_patient_fda_example_41k >}} per patient
...
- $110B total funding ($83B existing + {{< var treaty_annual_funding >}} from treaty)
- Pragmatic trials: {{< var recovery_trial_cost_per_patient >}} per patient ({{< var trial_cost_reduction_factor >}}× cheaper)
