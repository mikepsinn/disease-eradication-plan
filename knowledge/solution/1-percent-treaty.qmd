...
2.  **Execution:** **A network of Decentralized Institutes of Health** subsidizes patient participation in **a [decentralized FDA](dfda.qmd) [@dfda-spec-paper-2025; @dfda-impact-paper-2025]**, clinical trials that are **{{< var dfda_trial_cost_reduction_factor >}} cheaper** than the current model
3.  **Governance:** Global population via [Wishocracy](wishocracy.qmd) [@wishocracy-paper-2025], with transparent auditable rules and automated fund allocation
