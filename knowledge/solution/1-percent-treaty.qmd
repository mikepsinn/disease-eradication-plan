...
1.  **The Problem:** The world spends [$2.7 trillion a year](../references.qmd#sipri-2024-spending) on military forces to maintain a delicate balance of power.
...
2.  **The Elegant Part:** If EVERYONE reduces their military budget by exactly 1% at exactly the same time, everyone maintains exactly the same strategic position.
    ...
    -   Russia: Still has {{< var caregiver_cost_annual >}} nukes instead of 6,060
...
- $110B total funding ({{< var global_annual_human_cost_terror_attacks >}} existing + {{< var treaty_annual_funding >}} from treaty)
- [Pragmatic trials: {{< var recovery_trial_cost_per_patient >}} per patient](../references.qmd#recovery-cost-500) ([82x cheaper](../references.qmd#recovery-trial-82x-cost-reduction))
- 220M participants per year (44x acceleration)
- Still only using 18% of available willing participants

#### Year One Outcomes

- {{< var qalys_from_prevention_conservative >}} new treatments tested
