...
The {{< var dih_treasury_medical_research_pct >}} allocated to medical research is then distributed by the people of Earth via the Wishocracy platform. There are no committees or central planners. While allocations are dynamic, initial priorities determined by the crowd are projected to focus on:
