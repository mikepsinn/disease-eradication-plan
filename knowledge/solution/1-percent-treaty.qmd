...
The 1% Treaty is a legally-binding global accord with a single provision: every signatory nation redirects 1% of its annual military budget to [a decentralized institutes of health (DIH)](dih.qmd).
...
Every signatory nation contributes exactly 1% of their military budget to your decentralized institutes of health treasury (working title).
...
### Your Decentralized Institute of Health Treasury
...
|------------|------------|---------------|---------|
| **DIH Medical Research** | {{< var dih_treasury_medical_research_pct >}} | {{< var dih_treasury_to_medical_research_annual >}} | Patient subsidies, R&D, pandemic prep |
...
#### With 1% treaty + Decentralized Framework for Drug Assessment
...
**Article I**: Each signatory shall redirect exactly 1% of its annual military budget to a global pragmatic clinical trials fund, starting immediately or whenever their legislature gets around to it, whichever comes first.
