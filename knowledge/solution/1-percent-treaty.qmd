...
That {{< var treaty_annual_funding >}} pays sick people to try treatments instead of waiting for death while filling out paperwork.

This is called a [Pareto improvement](../references.qmd#pareto-improvement), which is economist-speak for "everybody wins and nobody loses." It's like finding out that eating less poison makes you both less poisoned AND wealthier because poison is expensive.
...
**The 1% Treaty doesn't ask you to spend {{< var treaty_annual_funding >}} curing diseases. It asks you to stop wasting {{< var treaty_annual_funding >}} on things that sit in holes making you poorer and less safe, and redirect those same papers to things that make you richer and less dead.**
...
**For Economists**:
"The ROI is {{< var treaty_complete_roi_all_benefits >}}:1. This beats every other public health intervention on record."
