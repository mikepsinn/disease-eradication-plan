...
2.  **Execution:** DIH subsidizes patient participation in the [dFDA](dfda.qmd)—clinical trials that are **[{{< var dfda_cost_effectiveness_multiplier >}}× cheaper](../references.qmd#recovery-trial-82x-cost-reduction)** than current model
...
![Global military spending by region showing the {{< var global_military_spending_annual_2024 >}} humans spend annually on weapons instead of cures](../../assets/global-military-spending-chart.png)
...
**For Economists**:
"[The ROI is {{< var roi_all_direct_benefits >}}:1](../economics/economics.qmd#the-complete-case-1-222-1-roi-all-direct-benefits). This beats every other public health intervention on record."
...
- [Pivotal trials: {{< var traditional_phase3_cost_per_patient_fda_example_41k >}} per patient](../references.qmd#trial-cost-41k)
...
- [Pragmatic trials: {{< var recovery_trial_cost_per_patient >}} per patient](../references.qmd#recovery-cost-500) ([{{< var dfda_cost_effectiveness_multiplier >}}× cheaper](../references.qmd#recovery-trial-82x-cost-reduction))
