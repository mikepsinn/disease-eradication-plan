...
tags:
  ...
  - national-security
  - mutual-survival
image: /assets/og-images/knowledge/solution/1-percent-treaty-og-academic.png
---
...
![The 1% Treaty Overview](../../assets/infographics/knowledge/solution/1-percent-treaty-infographic-academic.png)
...
2.  **Execution:** **A network of decentralized institutes of health (DIH)** subsidizes patient participation in **a decentralized framework for drug assessment ([dFDA](dfda.qmd))**, clinical trials that are **{{< var trial_cost_reduction_factor >}}× cheaper** than the current model
...
**For Economists**:
"The ROI is {{< var treaty_roi_trial_capacity_plus_efficacy_lag >}}:1. This beats every other public health intervention on record."
...
- Pragmatic trials: {{< var dfda_pragmatic_trial_cost_per_patient >}} per patient ({{< var trial_cost_reduction_factor >}}× cheaper)
