...
**Distribution**:
The {{< var treaty_annual_funding >}} flows into the DIH Treasury, where it is allocated using an **80/10/10 automatic split** before any funds reach discretionary spending:
