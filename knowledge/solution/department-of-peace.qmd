...
A Tomahawk cruise missile costs $2 million, carries GPS guidance accurate to within meters, and knows exactly where it is going. In 2026, that guidance put one into an elementary school in Minab, Iran, killing 165 schoolgirls and their teachers [@minab-school-strike-2026]. A second missile hit the same site while paramedics were treating the survivors [@minab-double-tap-2026]. The investigation found "outdated intelligence," which means: the technology to verify the target existed, nobody used it, and the children died because checking was less important than launching.

The disposal robot cannot make this mistake, because a school is not a weapon.
