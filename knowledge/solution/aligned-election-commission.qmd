...
The $8.4 billion currently spent on campaign finance and lobbying ($4.7B + $3.7B) is eliminated. Running the replacement costs perhaps {{< var aligned_election_commission_annual_opex >}} a year for score computation, public data pipelines, and fund routing, a generous figure for what is mostly arithmetic the NRA already does with interns. More importantly, the incentive for politicians to serve donors instead of citizens is eliminated. That second part is worth considerably more than $8.4 billion.
