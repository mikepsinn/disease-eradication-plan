...
lastInstructionalVoiceHash: 2f28c23e4d8b7bbe9434beca7d86d43ebf1fae215255b07d28d228175c5a2cd2
lastToneElevationWithHumorHash: d28d7de32bfdf6072dc9250a8032ea81090b69062936cc3234419ed314a57171
---
...
"Here's what happened to {{< var qalys_from_prevention_conservative >}} people who tried this:
...
2.  **The Ultimate Fact-Checker**: [The DIH](dih.qmd) automatically resolves these bets using the actual, aggregated, and anonymized patient data collected by the dFDA. If the market predicts a 22% rate of nausea, and the real-world data shows 40%, the market learns and adjusts, or bettors go broke.
...
Companies like [Medable](../references.qmd#dct-platform-funding-medable) ($521M raised), [Science 37](../references.qmd#dct-platform-funding-others) (~$100M raised), and others have already built decentralized clinical trial platforms. They're good at it. They have users. They have infrastructure.
...
The dFDA protocol just lets you run queries ACROSS systems without moving data. Like [TriNetX](../references.qmd#trinetx-federated-network) does with 300M+ patient records.
...
| :--- | :--- | :--- | :--- | :--- |
| Clinical Phase Timeline | **[9.1 years (avg)](../references.qmd#clinical-trial-phase-duration)** | **2-3 years** | ~7 years of waiting eliminated | [~{{< var qalys_from_prevention_conservative >}}/year](../references.qmd#beta-blocker-deaths) |
...
| Stupid Expense | What FDA Pays | dFDA Cost | Savings | What It Actually Is |
| :--- | :--- | :--- | :--- | :--- |
| 💾 Data Management | $198,014 | ${{< var dfda_large_trial_size >}} | 94.9% | Excel spreadsheets with fear |
| ✅ IRB Approval | $324,081 | $5,000 | 98.5% | Permission slips for adults |
| 📝 IRB Amendments | $6,347 | $0 | 100% | Permission to fix typos |
| 🔍 Source Data Verification | $1,486,250 | {{< var caregiver_value_per_hour_simple >}},000 | 98.3% | Checking if you lied about dying |
| 🤝 Patient Recruitment | $805,785 | $15,000 | 98.1% | Facebook ads for dying people |
| 🎯 Patient Retention | $76,879 | {{< var lobbyist_bond_investment_max_millions >}},000 | 74% | Bribes to keep dying people interested |
| 👨‍⚕️ Research Associates | $2,379,605 | ${{< var qalys_from_prevention_optimistic >}} | 93.7% | People who watch you take pills |
| 👩‍⚕️ Physicians | $1,966,621 | $100,000 | 94.9% | Doctors pretending to be scientists |
| 🏥 Clinical Procedures | $5,937,819 | ${{< var traditional_large_trial_size >}},000 | 83.2% | Poking you with expensive things |
| 🧪 Laboratory | $2,325,922 | ${{< var qalys_from_new_therapies >}} | 78.5% | Testing if your pee is still pee |
...
| 📎 All Other | {{< var caregiver_value_per_hour >}},096,703 | $100,000 | 99.4% | Nobody knows but it's expensive |
...
- Oxford pragmatic trials: [{{< var recovery_trial_cost_per_patient >}}](../references.qmd#recovery-cost-500)
...
**FDAi**: "Based on {{< var qalys_from_prevention_conservative >}} similar cases, here's what worked:
...
Based on {{< var qalys_from_prevention_conservative >}} humans who tried this:

- 📈 Depression: ⬇️ 60% reduction
- 😴 Sleep: ⬆️ 30% improvement
- 🍆 Sex drive: ⬇️ 90% reduction (sorry)
- 🎺 Spontaneous jazz hands: 15% chance
- 💀 Death: {{< var treaty_reduction_pct >}} (better than depression!)
...
Pharmaceutical companies realize they can't charge ${{< var dfda_large_trial_size >}} for pills that cost $1 to make when everyone can see the data. Some adapt. Some become museums.
...
::: {.content-visible when-format="html"}
<img src="../../assets/black-box-model-animation.gif" alt="Black box model animation showing how the dFDA works" style="max-width: 600px; width: 100%;" />
:::

The dFDA achieves [**82x More Efficiency**](../references.qmd#recovery-trial-82x-cost-reduction) through:

- **Cost per patient**: {{< var recovery_trial_cost_per_patient >}} vs the current $41,000
