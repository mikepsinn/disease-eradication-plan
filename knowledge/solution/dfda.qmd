...
This isn't because people don't want to help find cures. It's because the current system can't scale. Trials cost [{{< var traditional_phase3_cost_per_patient_fda_example_41k >}} per patient](../references.qmd#trial-cost-41k), require traveling to major medical centers, and have exclusion criteria that reject [85% of actual patients](../references.qmd#clinical-trial-exclusions).
...
- Normal clinical trials: [{{< var traditional_phase3_cost_per_patient_fda_example_41k >}}](../references.qmd#trial-cost-41k)
