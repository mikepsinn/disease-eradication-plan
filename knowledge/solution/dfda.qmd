...
~200 FDA bureaucrats [@fda-reviewer-count] decide what 8 billion people can try when dying. Here's the math on why that can't work:
...
**The decisions that actually need making:** 10,000 known diseases × 100 potential treatments × 800 million genetically distinct patient profiles = **800 billion decisions**.

At 1,600 decisions per day, the FDA would need **1,369,863 years** to evaluate everything. A decentralized system where 8 billion people each make one health decision per day processes the same load in **100 days**.
