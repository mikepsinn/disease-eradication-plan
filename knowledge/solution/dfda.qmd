...
description: Increasing trial capacity {{< var trial_capacity_multiplier >}}× by giving all patients the right to effortlessly participate in global decentralized clinical trials at 80× lower cost
published: true
tags:
  - overview
  - dfda
  - bureaucratic-murder
  - death-by-clipboard
image: /assets/og-images/knowledge/solution/dfda-og.png
---

{{< include /knowledge/includes/setup-parameters.qmd >}}

![Infographic](/assets/infographics/knowledge/solution/dfda-infographic.png)
...
Your decentralized framework for drug assessment achieves **{{< var trial_cost_reduction_factor >}}× More Efficiency** through:
