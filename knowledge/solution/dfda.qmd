...
Out of {{< var current_disease_patients_global >}} with chronic disease, only {{< var current_trial_slots_available >}} [participate in trials annually](../appendix/clinical-trial-participants.qmd). That's **{{< var current_clinical_trial_participation_rate >}}**.
