...
**The decisions that actually need making:** 10,000 known diseases × 100 potential treatments × 800 thousand genetically distinct patient profiles = **800 billion decisions**.

At 1,600 decisions per day, the FDA would need **1,369,863 years** to evaluate everything. A decentralized system where {{< var global_population_2024_nounit >}} people each make one health decision per day processes the same load in **100 days**.
