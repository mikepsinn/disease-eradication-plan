...
This isn't because people don't want to help find cures. It's because the current system can't scale. Trials cost {{< var traditional_phase3_cost_per_patient_fda_example_41k >}} per patient, require traveling to major medical centers, and have exclusion criteria that reject [85% of actual patients](../references.qmd#clinical-trial-exclusions).

**We're not facing a recruitment problem. We're facing a capacity problem.**

## The Solution: Amazon for Clinical Trials

The dFDA is a **two-sided marketplace** that connects companies with treatments to patients who need them. It's Amazon, but instead of buying stuff you don't need, you're getting paid to help find cures.
...
1. **Register treatment** on dFDA.gov (name, ingredients, condition, price)
...
**Patient receives:** [DIH](dih.qmd) subsidy (from 1% Treaty treasury)
...
**dFDA marketplace (unlimited):**
```
Research ideas → Register instantly → Patients decide by joining → $0 per trial → Unlimited trials simultaneously
```

**This is why 95% of rare diseases have no treatments.** Traditional funding can't afford to test everything. The dFDA marketplace can test EVERYTHING because:
...
**dFDA trial:** Pharma spends $0, tests everything including supplements, food, lifestyle, off-patent drugs

The [DIH](dih.qmd) treasury doesn't fund research directly. **It subsidizes participation, which unlocks a self-sustaining marketplace that funds ALL research.**
...
**How the dFDA gets funded:** The dFDA is one of many campaigns competing for funding from the [DIH](dih.qmd) treasury via [Wishocracy](wishocracy.qmd). It has no independent budget authority. If the dFDA gets captured or fails to deliver, the community can fund alternative implementations instead. This prevents the "new FDA" problem.
...
- Access to {{< var treaty_annual_funding >}} annual DIH funding pool
...
The dFDA achieves **{{< var trial_cost_reduction_factor >}}× More Efficiency** through:
