...
[Half of humanity would volunteer](.../../knowledge/references.qmd#patient-willingness-clinical-trials) if they could. We have **240 times more willing participants** than we're using.

This isn't because people don't want to help find cures. It's because the current system can't scale. Trials cost [$41,000 per patient](.../../knowledge/references.qmd#trial-cost-41k), require traveling to major medical centers, and have exclusion criteria that reject [85% of actual patients](.../../knowledge/references.qmd#clinical-trial-exclusions).
...
I know, I know. Without [17 years](.../../knowledge/references.qmd#research-to-practice-gap-17-years) of paperwork, how would we know if medicines are safe? We'd have to rely on primitive methods like "observing if people get better or die." It's a bold strategy, considering our current one leaves [95% of rare diseases](.../../knowledge/references.qmd#fda-untreated-diseases-95pct) with zero approved treatments and ensures [85% of patients are barred](.../../knowledge/references.qmd#clinical-trial-exclusions) from the trials that might save them. We've managed to perfect a system where only the healthy and compliant are allowed to test cures for the sick and desperate. It's genius, in a suicidal sort of way.
...
| :--- | :--- | :--- | :--- | :--- |
| Clinical Phase Timeline | **[9.1 years (avg)](.../../knowledge/references.qmd#clinical-trial-phase-duration)** | **2-3 years** | ~7 years of waiting eliminated | [~50,000/year](.../../knowledge/references.qmd#beta-blocker-deaths) |
| Cost per trial | [**$57 million**](.../../knowledge/references.qmd#clinical-trial-cost-breakdown) | **$2 million** | $55 million | Infinite ROI |
| Who can participate | **[15% of patients](.../../knowledge/references.qmd#clinical-trial-exclusions)** | **100% of patients** | 85% inclusion rate | Everyone |
| Rare diseases with treatments | **[5%](.../../knowledge/references.qmd#fda-untreated-diseases-95pct)** | **Eventually 100%** | Priceless | Millions |
...
| **TOTAL STUPIDITY** | [**$56,988,007**](.../../knowledge/references.qmd#clinical-trial-cost-breakdown) | **$2,025,000** | **95.7%** | **The price of bureaucracy** |
...
Here's the problem with having [~200 FDA bureaucrats](.../../knowledge/references.qmd#fda-reviewer-count) decide what 8 billion people can try when they're dying:
...
- Normal clinical trials: [$41,000](.../../knowledge/references.qmd#trial-cost-41k)
- Oxford pragmatic trials: [$500](.../../knowledge/references.qmd#recovery-cost-500)

That's not a typo. Five hundred dollars. The cost of a nice dinner in Manhattan to save a human life.

Results:

- Found that [steroids cut COVID deaths by 30%](.../../knowledge/references.qmd#recovery-trial-dexamethasone-results)
- [Saved over 1 million lives globally](.../../knowledge/references.qmd#recovery-trial-summary-quote)
- [Took 3 months](.../../knowledge/references.qmd#recovery-trial-100-days-to-cure) instead of 3 years
...
The dFDA achieves [**82x More Efficiency**](.../../knowledge/references.qmd#recovery-trial-82x-cost-reduction) through:

- **Cost per patient**: $500 vs the current $41,000
- **Time to results**: 2 years vs the current 17 years
- **Patient access**: Universal access vs [85% excluded](.../../knowledge/references.qmd#clinical-trial-patient-participation-rate) currently
