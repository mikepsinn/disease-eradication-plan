...
This framework is built on a simple, powerful, and slightly creepy idea. You can learn more, faster, by analyzing data from real patients in the real world. This is called Real-World Evidence (RWE). That's a fancy term for "watching what happens."
...
The evidence is clear: high-quality observational studies produce results comparable to RCTs.

You have the tools to get reliable answers from real-world data. You just refuse to use them.
