...
tags:
  ...
  - bureaucratic-murder
  - death-by-clipboard
image: /assets/og-images/knowledge/solution/dfda-og-academic.png
---

{{< include /knowledge/includes/setup-parameters.qmd >}}

![Infographic](/assets/infographics/knowledge/solution/dfda-infographic-academic.png)
...
This isn't because people don't want to help find cures. It's because the current system can't scale. Trials cost {{< var traditional_phase3_cost_per_patient >}} per patient, require traveling to major medical centers, and have exclusion criteria that reject [86.1% of actual patients](../references.qmd#antidepressant-trial-exclusion-rates).
...
- **Cost per patient**: {{< var recovery_trial_cost_per_patient >}} vs the current {{< var traditional_phase3_cost_per_patient >}}
