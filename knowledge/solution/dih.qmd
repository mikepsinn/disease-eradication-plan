...
Your Decentralized Institutes of Health won't be a platform. It won't be an organization. It won't even really be a thing. It's the rules by which the things talk to each other. It does one thing: make every actor's most selfish choice also be the most useful choice. Every dollar flows to maximum impact. Every researcher works on the biggest problem. Every patient joins the trial that matters most. Nothing gets wasted.
