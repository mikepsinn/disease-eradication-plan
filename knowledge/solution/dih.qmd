...
The NIH spends {{< var nih_annual_budget >}} a year. Scientists spend 50-67% of their time writing grant applications [@grant-writing-time-50pct] instead of doing research. This is not a conspiracy. It's just what happens when you design a system that rewards asking for money instead of producing results.
...
- Provides protocol infrastructure for trials.
...
|:-----------|:------|:-------|:--------|
| [VICTORY Incentive Alignment Bond investors](../economics/victory-bonds.qmd) | {{< var victory_bond_funding_pct >}} | {{< var victory_bond_annual_payout >}} | Repay the investors who funded the campaign |
...
![Flowchart illustrating the distribution of the $27.2B annual budget, from military diversion through investor/political payouts, into the research treasury, and finally allocated to specific campaign types via Wishocracy.](/assets/images/dih/dih-section-financial-flow-and-allocation-logic-bw-academic.jpg)
...
| **Cost per QALY** | {{< var standard_economic_qaly_value_usd >}} | $5,000-$15,000 | ~10x reduction (theoretical) |
| **Overhead percentage** | 50-67% [@grant-writing-time-50pct] | <10% | ~6x reduction in overhead |
| **Time to treatment** | 10-17 years [@drug-development-timeline-17-years] | 2-4 years | ~4x faster (theoretical) |
...
![A multiplicative stack diagram showing how four distinct efficiency improvements compound to create a theoretical 800x total improvement in QALY production.](/assets/images/dih/dih-section-compound-efficiency-multipliers-bw-academic.jpg)

#### What This Could Mean in Practice

A well-functioning decentralized institute of health (DIH), combined with your decentralized framework for drug assessment (dFDA) and operating on a 1% Treaty budget of {{< var treaty_annual_funding >}} annually, could theoretically produce more QALYs than the entire current global pragmatic clinical trials output. 
