...
![A framework for medical research funding that automates allocation and prioritizes patient choice.](/assets/infographics/knowledge/solution/dih-infographic-retro-academic.jpg)
...
| Resource allocation across fronts | [Wishocracy](wishocracy.qmd) + [Optimocracy](../appendix/optimocracy-paper.qmd) allocation |
...
2. **Allocate to maximum-impact uses** (via [Wishocracy](wishocracy.qmd) + [Optimocracy](../appendix/optimocracy-paper.qmd))
...
A DIH answers two questions:

1. **What should we fund?** (preferences)
2. **How do we maximize the chosen metric?** (optimization)

These are handled by two governance modules.

### Wishocracy: Aggregating Preferences

[Wishocracy](wishocracy.qmd) answers "what should we fund?" through pairwise comparisons. Millions of people make simple choices:

- "What's more important: Cancer research or Alzheimer's research?"
- "What's more important: Rare disease trials or infrastructure?"

An algorithm aggregates these preferences into funding allocations. No committees. No lobbying. Just distributed intelligence pointed at priorities.

### Optimocracy: Maximizing the Metric

[Optimocracy](../appendix/optimocracy-paper.qmd) answers "how do we maximize the chosen metric?" Once Wishocracy identifies that "reducing cancer deaths" is a priority, Optimocracy determines the optimal allocation:

- Which cancer research approaches have the highest expected ROI?
- How should funding split between basic research, clinical trials, and implementation?
- What's the cost-effectiveness threshold for continued funding?

Optimocracy uses evidence-based recommendations from:
...
The output is a recommended allocation. Humans (via Wishocracy voting) decide whether to accept it. But deviations are tracked publicly, creating accountability.

### Why Both Are Needed

| Question | Tool | Example |
|:---------|:-----|:--------|
| What do we value? | Wishocracy | "Prioritize rare diseases over common ones" |
| How do we achieve it? | Optimocracy | "Fund these 5 rare disease trials with these allocations" |

Wishocracy without Optimocracy: You know what you want but not how to get it.
Optimocracy without Wishocracy: You optimize but for metrics nobody agreed on.

Together: Democratic goal-setting + evidence-based execution.
...
|:------|:--------------|:--------------|:--------------|
| **Researchers** | Money, prestige | Bounties scale with impact | Higher-impact work = more money |
...
**Key insight:** Every incentive is ROI-weighted. Not just "do good" but "do the MOST good per dollar/hour."

**The core mechanism:** DIH makes the highest-ROI action the selfish choice for every actor.
...
2. **Outcome bounties:** Massive prizes for solving big problems (e.g., "$1 billion to the first team to reverse aging by 10 years").
3. **Results-based continuation:** Deliver results, get more funding. Don't deliver, get defunded.

In the NIH, you get rich by writing proposals. In DIH, you get rich by curing diseases.
...
[Incentive Alignment Bonds](incentive-alignment-bonds.qmd) solve this by making "support health spending" the career-optimal move:
...
- Allocates via Wishocracy + Optimocracy
...
| **Research treasury** | {{< var dih_treasury_medical_research_pct >}} | **{{< var dih_treasury_to_medical_research_annual >}}** | Allocated via Wishocracy |

### How Allocation Works

**1. Anyone Can Propose a Campaign**

Submit a proposal: "Fund Alzheimer's research at $X/year" or "Build trial infrastructure for $Y."

**2. Humanity Allocates via Wishocracy**

The global population uses [Wishocracy](wishocracy.qmd) to allocate funds across competing campaigns:

- "What's more important: Cancer research or aging reversal?"
- "What's more important: EHR integration or security audits?"

Millions of pairwise preferences aggregated into funding allocations.

**3. Optimocracy Recommends Specifics**

Within each priority area, [Optimocracy](../appendix/optimocracy-paper.qmd) recommends optimal allocations based on cost-effectiveness analysis.

**4. Campaigns Compete for Funding**

- **Patient subsidies:** Automatically funded (formulaic, {{< var dih_treasury_trial_subsidies_pct >}} of treasury)
- **Infrastructure campaigns:** Multiple providers compete (dFDA, data storage, integrations)
...
Campaigns that deliver impact get continued funding. Failures get defunded. It's venture capital for not dying.
...
1. **Hard to capture:** Nothing to bribe if there's no operational role
2. **Easy to fork:** If DIH gets corrupted, spin up a replacement
3. **Focused:** One job: coordinate fund flows toward maximum impact
4. **Adaptable:** Swap out components without redesigning the whole system

Code is very bad at embezzlement. You can bribe a committee; you cannot bribe an if-statement.
...
If dFDA gets captured by pharmaceutical interests, becomes inefficient, or stops delivering, the community can:

1. Reduce its Wishocracy priority
2. Fund competing implementations
3. Fork the protocol and start fresh

DIH doesn't depend on any single campaign. It coordinates competition between them.
...
![Defense in depth: decentralized control, AI monitoring, transparency, and recovery mechanisms interact to prevent theft.](/assets/images/governance/governance-section-security-architecture-bw-academic.jpg)
...
- Every vote
- Every outcome measurement
- Every campaign's performance

Corruption requires secrecy. DIH provides radical transparency. Every dollar is tracked on a ledger anyone can read.
...
![Uncorruptible DAO governance: token-holder voting flows through smart contracts to funding execution with no human intermediaries.](/assets/images/governance/governance-section-beyond-medical-research-a-template-for-uncorruptible-governance-bw-academic.jpg)
...
| Wishocracy | Preference aggregation | Determines priorities |
| Optimocracy | Allocation optimization | Recommends efficient splits |
...
> DIH is a coordination protocol that receives funds, allocates them to maximum-impact uses via Wishocracy and Optimocracy, verifies results, and pays proportional to outcomes, making the highest-ROI action the selfish choice for every actor in the system.
