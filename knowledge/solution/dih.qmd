...
tags:
  ...
  - funding-model
  - efficiency
image: /assets/og-images/knowledge/solution/dih-og-academic.jpg
---

{{< include /knowledge/includes/setup-parameters.qmd >}}

![A framework for medical research funding that automates allocation and prioritizes patient choice.](/assets/infographics/knowledge/solution/dih-infographic-academic.jpg)


![A decentralized institute of health: A new model for medical research](../../assets/icons/dih-icon-6-wide.png)

The NIH spends {{< var nih_annual_budget >}} a year. Scientists spend [50-67% of their time writing grant applications](../references.qmd#grant-writing-time-50pct) instead of doing research. This is not a conspiracy. It's just what happens when you design a system that rewards asking for money instead of producing results.
