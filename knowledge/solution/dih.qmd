...
A [1% treaty](1-percent-treaty.qmd) redirects **{{< var treaty_annual_funding >}}** a year from global military budgets into the 1% Treaty Fund. But not all of it reaches Wishocracy:

| Allocation | Share | Amount | Purpose |
|:-----------|:------|:-------|:--------|
| [VICTORY Bond investors](../economics/victory-bonds.qmd) | {{< var victory_bond_funding_pct >}} | {{< var victory_bond_annual_payout >}} | Repay the investors who funded the campaign |
| [Political incentives (IABs)](incentive-alignment-bonds.qmd) | {{< var iab_political_incentive_funding_pct >}} | {{< var iab_political_incentive_funding_annual >}} | Keep politicians aligned with curing diseases |
| **DIH research treasury** | {{< var dih_treasury_medical_research_pct >}} | **{{< var dih_treasury_to_medical_research_annual >}}** | Available for allocation via Wishocracy |
...
A well-functioning DIH, combined with your dFDA framework and operating on a 1% treaty budget of {{< var treaty_annual_funding >}} annually, could theoretically produce more QALYs than the entire current global pragmatic clinical trials output. 
