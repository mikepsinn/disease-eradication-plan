...
| :--- | :--- | :--- |
| **Direct Medical Costs** | Paying doctors to Google your symptoms in a room that costs {{< var medical_facility_hourly_room_cost >}}/hour | [$8.2 Trillion](../references.qmd#global-health-spending-gdp) |
...
- Value per healthy year: ${{< var qalys_from_prevention_optimistic >}} (less than a Tesla, apparently)
- Total DALYs lost annually: 2.55 billion years

Multiply these together:

$$ 2,550,000,000 \text{ years} \times \${{< var qalys_from_prevention_optimistic >}}/\text{year} = \$382.5 \text{ trillion} $$
...
| **TOTAL** | **[55 million](../references.qmd#who-daily-deaths)** | **{{< var qalys_from_prevention_optimistic >}}** | **1,370** |
