...
The {{< var nih_clinical_trials_spending_pct >}} allocation isn't a mystery. It's a business model. Basic research produces publications. Publications produce tenure. Tenure produces more grants. Individual researchers want cures. The system doesn't make it possible for them to succeed at it. Actual treatments are a byproduct that occasionally happens when someone forgets to optimize for papers and accidentally optimizes for results instead.
