...
- **NIH pragmatic trials funding:** Capped at $500K planning + $1M/year implementation [@pragmatic-trials-cost-advantage]. This is a tiny fraction of the {{< var nih_annual_budget >}} budget
...
Yet pragmatic trials remain severely underfunded [@pragmatic-trials-cost-advantage]. The ADAPTABLE trial proved they cost 30x less than traditional RCTs [@pragmatic-trials-cost-advantage] ({{< var adaptable_trial_total_cost >}} vs $420M).
...
The NIH isn't just inefficient. The current budget allocation blocks the shift to high-efficiency trial platforms. It **actively destroys** the equivalent of millions of lives annually compared to the optimal allocation.
...
The system produces millions of papers testing ideas in mice. It offers trial participation to only 5% of humans. Half would say yes if asked.
