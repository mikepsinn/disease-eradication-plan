...
The National Institutes of Health has an annual budget of approximately **{{< var nih_annual_budget >}}**. 55 million people die annually [@who-daily-deaths]. You would think those two facts would be related. They are not.

A 2023 JAMA study [@nih-phased-trial-spending-2010-2019] analyzed $247 billion in NIH spending (2010-2019) and found:

- **84.9% - Basic research** ($209.9B): Mice, molecules, mechanisms. "Experimental work without any particular application in view." They put the quiet part in the job description.
- **11.8% - Applied research (non-trial)** ($29.3B): Research with "practical aims" that does not practically aim at testing treatments in humans.
  - **CTSA infrastructure program:** ~$1B/year in buildings, overhead, salaries [@nih-ctsa]
  - **Observational studies:** Watching patients get sicker without testing treatments (All of Us [@nih-all-of-us-inefficiency]: $2.16B to observe disease happening. Heroic.)
...
- **3.3% - Phased clinical trials** ($8.1B): Actually testing if drugs work in humans [@nih-phased-trial-spending-2010-2019] (Phases 1-3)
  ...
  - Phase 2: $3.5B (43.2%)
  - Phase 3: $2.6B (32.1%). **NIH covers only 3.7-4.3% of Phase 3 costs**, then wanders off like a cat that lost interest.
  - Pragmatic trials [@pragmatic-trials-cost-advantage] (30x cheaper): Severely underfunded despite proven efficiency

**The NIH spends 96.7% of its budget on everything except the one thing that saves lives: testing treatments in humans.**
