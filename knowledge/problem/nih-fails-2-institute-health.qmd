...
Of $247 billion the NIH spent over a decade, exactly {{< var nih_clinical_trials_spending_pct >}} went to testing whether treatments actually work in humans [@nih-phased-trial-spending-2010-2019]. The other 96.7% went to everything else.
...
It's like spending 96.7% of your grocery budget on cookbooks and {{< var nih_clinical_trials_spending_pct >}} on food, then wondering why you're starving.
...
**Treatments found:** Multiple, including dexamethasone [@recovery-trial-summary-quote] (saved over {{< var recovery_trial_global_lives_saved >}})
...
- **FDA-approved drugs:** >{{< var fda_approved_products_count_nounit >}} known safe in humans
...
- **Papers published:** 2.5 million NIH-funded annually [@nih-annual-papers-published]
- **New treatments approved:** ~{{< var current_drug_approvals_per_year_nounit >}} annually [@global-new-drug-approvals-50-annually]
...
The UK RECOVERY trial already proved it. {{< var recovery_trial_cost_per_patient >}} per patient instead of {{< var traditional_phase3_cost_per_patient >}}. First life-saving result in under 100 days [@recovery-trial-100-days-to-cure]. Over {{< var recovery_trial_global_lives_saved >}} saved. The blueprint exists. It is not theoretical. It happened. In England. During a pandemic. While Americans were arguing about horse dewormer.
