...
The FBI, the Department of Energy, and the CIA (as of January 2025) have all assessed that a lab leak is the most likely origin of COVID-19 [@cia-lab-leak-assessment-2025]. A two-year congressional investigation concluded the same [@covid-select-final-report-2024]. This is not proven beyond doubt; four intelligence agencies still lean toward natural origin. But the question for this chapter is not "who is to blame?" It is: what does it cost when an institution allocates $600,000 to creating risks instead of testing cures?
...
The NIH's allocation problem is not just about COVID. It is the institution's default setting. The problem is not a shortage of ideas. It is a shortage of anyone bothering to test them.
...
You have already seen the numbers: $1.1 trillion over 50 years, zero diseases eradicated [@nih-eradicated-zero-diseases], a possible $16 trillion catastrophe from a single unsupervised grant. But lest you think the NIH's track record is uniquely bad in the context of COVID, it isn't. This is what the institution has always done.

The WHO eradicated smallpox for $300 million [@smallpox-eradication-roi]. Jonas Salk developed the polio vaccine in a university lab and gave it away for free, which is why nobody at the NIH talks about him at parties because he makes everyone look bad by comparison and also he's dead, which is the thing they were supposed to be fixing. Veterinarians have eradicated multiple animal diseases [@animal-diseases-eradicated-by-vets] on budgets the NIH would consider a rounding error.
