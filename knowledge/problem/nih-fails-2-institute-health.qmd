...
But independent trials comparing drugs head-to-head? Those threaten blockbuster profits by revealing which treatments actually work best. PhRMA, the pharmaceutical lobby, has consistently opposed comparative effectiveness research. When Congress created PCORI in 2010, industry successfully lobbied to prohibit it from making coverage recommendations based on cost-effectiveness [@pcori-cost-effectiveness-prohibition]. The message: don't fund research that might lower drug prices. They said the quiet part loud, and Congress nodded.
...
Basic research produces publications. Publications produce tenure. Tenure produces more grants. Nobody in this cycle needs anyone to get better. They need papers. Papers are the currency, and patients are the raw material.

The 3.3% allocation isn't a mystery. It's a business model.

## The Efficiency Gap: A Tale of Two Trials

The difference between efficient and inefficient trial design isn't theoretical. Humanity accidentally ran a controlled experiment on itself. Two countries. Same disease. Very different results.
...
This proves the problem isn't that curing disease is hard. The British cured disease for the price of a used car per patient. America spent the price of a luxury SUV per patient and cured nothing. The NIH doesn't have a capability problem. It has a shopping problem.
...
You are burning lives. Real ones. With families and everything.
...
You are operating at ~2% of your potential capacity to save lives. If your car ran at 2% efficiency, you'd walk. If your heart ran at 2% efficiency, you'd die. Your medical research system runs at 2% efficiency, and you gave it a bigger budget.
...
The system produces papers, not cures. It is, by its own metrics, a publishing house that occasionally dabbles in medicine:
...
Understanding disease and curing disease are completely different activities. One requires microscopes. The other requires giving people medicine and seeing if they stop dying. The NIH chose microscopes. Patients needed medicine.
...
What it actually produces is a free research and development department for pharmaceutical companies, funded by the people who then pay full price for the drugs.
...
The system optimizes for everything except patient outcomes. Patients don't control the money. Committees do. And committees, left to their own devices, optimize for the continued existence of committees.
...
Cows have better healthcare outcomes than humans. Let that comparison sit with you for a moment.
