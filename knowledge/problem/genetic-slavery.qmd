...
scores:
  ...
  voice: 6
  importance: 6
audience: "Anyone who has ever felt that humanity's choices are insane (bombs over cures, cat birthday cakes while children starve) and assumed it was because people are bad or stupid."
feel: "Relieved off the hook: the dysfunction is not your moral failing or anyone's evil, it is buggy 200,000-year-old firmware, and firmware can be patched by a system that uses greed and fear instead of scolding them."
do: "Forward this to the one friend who keeps insisting people are just selfish and nothing can change, the cynic who has given up; tell them the problem is hardware, not character, and there is a fix that runs on the greed itself. Then vote for the 1% Treaty at warondisease.org."
---
...
And here's the alarming part: this feels completely normal. It doesn't feel like a moral catastrophe. It feels like Tuesday. That's the gradient working. Your genes have made the irrational feel rational, because feeling bad about strangers wastes calories that could be spent on relatives.
...
You experience loss aversion, where losing $100 hurts roughly twice as much as gaining $100 feels good [@kahneman-loss-aversion], because in the ancestral environment, losing your food meant death, while gaining extra food meant a slightly better week. The imbalance was rational when the downside was starvation. Now it makes you hold losing stocks, stay in bad relationships, and refuse to change policies that are obviously failing, because change feels like loss, and loss activates the same neural circuits that once screamed "you're about to starve."
...
Nuclear weapons. You built enough to end civilization {{< var nuclear_winter_overkill_factor_nounit >}} times, because once wasn't enough.
...
Every single one of you is going to die. Gradually escalating suffering, then catastrophe. Not a warning. A weather report. But the chains are chemical, and chemistry is engineering.

You can feed everyone twice over, but you'd rather burn grain to keep prices high. You can cure diseases, but you'd rather sell treatments forever (cured customers don't come back; bad for quarterly earnings). You could be immortal space wizards. Instead you're cave-dwelling murderers with better tools. Because the current system makes irrationality profitable. Spectacularly profitable. Bombs are profitable. Missiles are profitable. Wars are extremely profitable for a small number of organisms who do not personally attend them. Disease is profitable too. Not curing it, treating it.

Insulin costs $300 a vial [@insulin-history-and-pricing] because dead diabetics don't buy insulin. But cured diabetics don't either. So you keep them barely alive. It's good business. There is a word for "good business that requires people to suffer." The word is "crime." On your planet, it's a quarterly earnings call.
...
At the systems level: brain-computer interfaces are routing around damaged circuits entirely. AI is designing custom compounds for individual neurochemistry instead of the pharmaceutical industry's ancient method of "try thousands of molecules and see what sticks." That's the difference between performing surgery with a rock and performing surgery with a laser.

None of these are finished. All of them are proof that the prison has doors.

The endgame isn't making humans obedient. It's making humans *free*. For the first time in 200,000 years, you could actually choose what you value instead of having a Pleistocene survival algorithm choose for you. Your Christians could finally love their neighbors without their neurochemistry fining them for it. Your economists could care about the long term, because their brains would stop treating next quarter as the heat death of the universe. Your voters could evaluate policy on evidence instead of vibes, because the amygdala would stop hijacking every decision that involves a stranger. Not because you became angels. Because you finally got the admin password to the machine that was preventing you from being anything other than sophisticated apes with car keys.
...
Wishes are not a resource allocation mechanism. Money is. So we're using money.
