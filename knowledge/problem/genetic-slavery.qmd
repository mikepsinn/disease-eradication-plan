...
Here's the unsettling part: almost every universal human behavior that seems irrational is perfectly rational, just for an environment that hasn't existed for 10,000 years. Evolutionary psychology can explain nearly every mystifying, self-destructive, and inexplicably universal thing your species does as neurological vestigial remains; circuits that were brilliant adaptations for the savanna and are catastrophic maladaptations for civilization.
...
But biotechnology doesn't just cure diseases. It gives you admin access to the reward system. The same precision therapies that could eliminate depression could, eventually, decouple your motivational architecture from the selfish gene's profit motive. Not deleting pleasure and pain (that was tried; it's called a lobotomy; it went poorly). Redirecting them. Imagine a murderer who derives the same dopamine rush from building houses for homeless families that he currently derives from violence. Not because someone lectured him about morality. Because his reward circuitry was reprogrammed to find construction as thrilling as destruction. The aggression is still there. It's just pointed at lumber instead of people. Imagine a Wall Street trader whose neurochemistry rewards her for funding clinical trials the same way it currently rewards her for extracting rent. She's still greedy. Greed is still the engine. The engine is just connected to a different set of wheels. Imagine a World of Warcraft addict who gets the same sense of progression, mastery, and tribal belonging from studying for medical school that he currently gets from grinding raid bosses. The addiction to achievement doesn't go away. The definition of achievement changes.
...
At the brain level: psychedelics like psilocybin are already, in clinical trials, dissolving default-mode network patterns that took decades to calcify, letting people renegotiate their relationship with fear, addiction, and depression in a single afternoon. Transcranial magnetic stimulation is already FDA-approved for depression and OCD; it uses magnets to activate or quiet specific brain regions through the skull, no surgery required. Focused ultrasound can reach deep brain structures that magnets can't, targeting addiction and trauma circuits with millimeter precision. Optogenetics can activate or silence specific neurons with light, like a switchboard operator for consciousness.

At the systems level: brain-computer interfaces are beginning to route around damaged circuits entirely. And AI-designed drugs are replacing the pharmaceutical industry's ancient method of "try thousands of molecules and see what sticks" with custom compounds engineered for individual neurochemistry. That's the difference between performing surgery with a rock and performing surgery with a laser.
