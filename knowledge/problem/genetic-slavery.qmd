...
That's why you spent {{< var global_military_spending_annual_2024 >}} on weapons while [cancer research got pocket change](../references.qmd#global-cancer-research-spending). 
...
- **Social proof**: Get [{{< var global_population_activism_threshold_pct >}} participation](../references.qmd#3-5-rule) so everyone else follows
