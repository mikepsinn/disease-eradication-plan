...
Your brain is {{< var qalys_from_faster_access >}} years old, living in a world that's 200 years old, making decisions that will kill you in 20 years.
...
For {{< var qalys_from_faster_access >}} years, calories were rare. Finding a beehive wasn't "prediabetes in a tree" - it was the difference between your children surviving winter or becoming the skinny corpses archaeologists find later.
...
- Each meal contains [twice your daily calorie needs](../references.qmd#food-abundance-stats)
...
Fun fact: [15-30% of our ancestors died from violence](../references.qmd#prehistoric-violence-rates). Not disease. Not starvation. Other humans smashing their heads with rocks over who gets the good berry bush.
...
- Humanity spends [$2.7 trillion annually on weapons](../references.qmd#sipri-2024-spending) we'll probably never use
...
- Countries with [{{< var dfda_large_trial_size >}} nuclear weapons](../references.qmd#world-warheads) are worried they don't have enough
...
For {{< var qalys_from_faster_access >}} years, this worked great:
...
- You care more about your neighbor's barking dog than {{< var dfda_large_trial_size >}} people dying of malaria (the dog is RIGHT THERE being loud, malaria is just a concept with numbers attached)
- Local corruption makes you angrier than trillion-dollar Pentagon waste (the local guy stole ${{< var dfda_large_trial_size >}} you can imagine, the Pentagon lost $2.5 trillion which is just syllables)
...
[Evolution prepared us for scarcity, predators, and violence](../references.qmd#evolutionary-mismatch). We got abundance, safety, and Netflix. Our bodies are experiencing the biological equivalent of "ERROR: SUCCESS NOT FOUND":
...
- ✅ Starvation (you throw away [40% of food](../references.qmd#food-waste-stats) because storing it is inconvenient)
...
- ❌ Antibiotic resistance ([10 million deaths annually by 2050](../references.qmd#amr-10m-2050) because you gave antibiotics to cows)
...
The ancient brain always wins. It has {{< var qalys_from_faster_access >}} years of practice.
...
That's why you spent [$2.7 trillion](../references.qmd#sipri-2024-spending) on weapons while [cancer research got pocket change](../references.qmd#global-cancer-research-spending). 
...
- You're [{{< var traditional_large_trial_size >}}x more likely to die from heart disease](../references.qmd#death-causes-vs-fear)
...
You can't fight {{< var qalys_from_faster_access >}} years of evolution. But you can hack it.
...
Your brain is a {{< var qalys_from_faster_access >}}-year-old piece of software running on hardware that hasn't been updated since you invented agriculture.
