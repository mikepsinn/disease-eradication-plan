...
That's what a [1% Treaty](../solution/1-percent-treaty.qmd) [@1-pct-treaty-impact-paper-2025] does. It redirects the papers. But redirecting papers into a system run by the same committees and lobbyists just creates a new pile for the same parasites to feed on. You need two more things.
