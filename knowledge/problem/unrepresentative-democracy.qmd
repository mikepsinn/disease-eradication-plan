...
The Founding Fathers were smart. They created checks and balances, separation of powers, and all sorts of safeguards against tyranny. They thought of everything except the voters.
...
64% of voters can't name or describe what the three branches of government do [@civic-literacy-survey-congress-function]. These same voters choose who runs those branches. Not you, of course. You're reading a book about international treaties. But the other ones.
...
Princeton University analyzed 1,779 policy decisions over 20 years. The correlation between what you want and what happens? **Zero. Percent.** [@princeton-oligarchy-study]

When economic elites want something? They get it 78% of the time [@princeton-oligarchy-study].

You have the same political influence as your houseplant. Actually less. Politicians at least pretend to care about the environment.

The institutions themselves tell the story. You have a "Department of Defense" that mainly attacks people. A "Department of Health" that has not yet produced any observable health. And a "Department of Justice" that, well, you can probably see where this is going.
...
Campaign contributions don't directly buy how politicians vote. Only 1 in 4 studies support that notion [@cost-of-political-influence]. The system is much more elegant than bribery.
...
Democracy doesn't allocate resources by who's dying. It allocates by who can afford the best lobbyist. Your disease needs a publicist.
...
Every democratic organization eventually becomes an oligarchy. This happened to every political party, every union, every non-profit, your homeowners association, and the PTA. The PTA one is especially funny because Sharon from the bake sale committee is running it exactly like a Medici.

Democracy doesn't prevent oligarchy. It gives oligarchy a nice suit and an election certificate.
...
Committees control which bills live or die, what gets funded, and who gets regulated.
Both parties assign fundraising quotas for each seat [@congressional-committee-price-list]: raise this much for the party's campaign committee (DCCC or NRCC), or lose your assignment.
Don't hit your number? Your bills die, your amendments get ignored, and your name goes on a "giant wall of shame" [@congressional-committee-price-list].
...
This is Public Choice Theory: bureaucrats, politicians, and regulators are **just as selfish** as everyone else. The only difference is that when a corporation is greedy, you can stop buying their product. When a bureaucracy is greedy, they can arrest you.
...
But markets? Markets turned feudal peasants into TikTok influencers. Markets put computers in your pockets more powerful than what sent men to the moon (you use them to look at pictures of cats, but still). Markets work.
...
The military-industrial complex distributes operations across 42 states [@lockheed-martin-political-influence-2022]. Cutting any program threatens local jobs. The Pentagon has never passed an audit [@pentagon-unaccounted-2-5t] but somehow knows it needs more money. Pharma employs 3 lobbyists for every member of Congress [@pharma-lobbying-stats]. The FDA gets 75% of its drug review budget from the companies it regulates [@fda-regulatory-capture-evidence]. For the full accounting, see [Cost of War](cost-of-war.qmd) and [FDA: Unsafe and Ineffective](fda-is-unsafe-and-ineffective.qmd).

The entire system maintains itself with beautiful efficiency. Cures are a one-time payment; treatments are recurring revenue. Approving a bad drug ends careers; delaying a good one ends lives (but not careers, and careers are what matter). Funding clinical trials is boring; creating new agencies provides photo ops. Everyone who matters wins. Everyone who's dying loses. The system works perfectly. The problem is what it's optimized for.
