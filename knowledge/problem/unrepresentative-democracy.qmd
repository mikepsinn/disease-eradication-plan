...
- [37% think the Earth is less than {{< var dfda_large_trial_size >}} years old](../references.qmd#young-earth-creationism-poll)
...
[Sugar subsidies cost Americans $3.5 billion per year](../references.qmd#sugar-subsidies-cost). That's {{< var vsl_epa_millions >}} per person.

Will you spend weeks fighting to save {{< var vsl_epa_millions >}}? No.
...
- Military contractors: [$999 billion concentrated benefit](../references.qmd#us-military-budget-999b) (37% of {{< var global_military_spending_post_treaty_annual_2024 >}} global spending)
- Taxpayers: $3,000 each in diffuse costs ($999B ÷ 333M Americans)
- Winner: Guess

<!-- -->

- Pharma companies: [{{< var recovery_trial_cost_per_patient >}} billion in concentrated profits](../references.qmd#pharma-profits-500b)
...
- Number of pharma executives who want high drug prices: {{< var traditional_large_trial_size >}}
- Money they contribute: $4.88 billion

{{< var traditional_large_trial_size >}} > 330,000,000 (when you multiply by money)
...
You provide 1/{{< var qalys_from_prevention_optimistic >}},000th of item #1.
...
They don't even read what they vote on. [The PATRIOT Act: 342 pages, voted on 45 minutes after release](../references.qmd#patriot-act-passage). [The Affordable Care Act: {{< var global_annual_conflict_deaths_state_violence >}} pages, "we have to pass it to see what's in it."](../references.qmd#affordable-care-act-passage)
...
|----------|-----------------|-------------------|------------------------|
| House Speaker | $31 million | {{< var lobbyist_bond_investment_max_millions >}} million | Controls entire agenda |
...
| Regular Committee | {{< var recovery_trial_cost_per_patient >}}K-1M | $875,000 | Still beats irrelevance |
| Basic Member | ${{< var qalys_from_prevention_optimistic >}}+ | Varies | Entry fee to play |
...
Instead of convincing 240 million voters to be smart (impossible), you convince {{< var traditional_large_trial_size >}} investors to be greedy (automatic).
...
- Evaluate {{< var dfda_large_trial_size >}} budget proposals
- Comprehend exponential growth
- Care about people {{< var dfda_large_trial_size >}} miles away
...
- Pharmaceutical companies donate {{< var dfda_upfront_build >}}
...
- [{{< var average_us_hourly_wage >}} trillion in national debt](../references.qmd#us-national-debt)
...
**Act 2**: Congress adds [{{< var caregiver_value_per_hour_simple >}} billion the Pentagon didn't ask for](../references.qmd#congress-unrequested-defense-spending).
