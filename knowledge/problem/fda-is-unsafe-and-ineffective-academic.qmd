...
Consider a scenario involving a magical genie tasked with fulfilling the FDA Congressional Mandate to:
...
In practice, a subtler approach was taken: make drugs so expensive ({{< var pharma_drug_development_cost_current >}}) and slow ({{< var treatment_acceleration_years_current >}} years) that patients die before the cure arrives. The regulatory barrier isn't just high - it's like setting the bar very high, then adding landmines, then putting the bar on top of Mount Everest.
...
However, a critical trade-off is often overlooked: The system also prevents millions from accessing life-saving treatments. The regulatory barrier doesn't just screen out bad drugs - it delays good ones for decades, making them impossible to test and approve in time to save lives.
...
The math is simple: If a patient dies in year 5 and the drug gets approved in year 10, the regulatory process effectively murdered the patient.

$$
t_{lag} = t_{total} - t_{safety} = 10.5 - 2.3 = 8.2 \text{ years}
$$

That's {{< var efficacy_lag_years >}} years sitting in regulatory purgatory *after* it is already known the drug won't kill the patient.

Humanity is two lifetimes from applying the scientific method to medicine. That's 0.0001% of human history - science was invented yesterday, cosmically speaking. The more clinical research researchers read, the more they realize they know nothing. Nearly every study ends with "more research is needed" (scientist-speak for "we have no idea what's happening, please give us more grant money"). This would be fine except people are dying while researchers figure it out.
...
In 1883, [doctors founded the Journal of the American Medical Association (JAMA)](../references.qmd#jama-founded-1893) and introduced a novel concept: they shared information. After 10,000 years the concept was introduced: "what if physicians told each other what works?"

**{{< var pre_1962_physician_count >}} physicians** across America (see [reference](../references.qmd#pre-1962-physician-trials)) tried treatments on real patients. They wrote down what happened. "This drug helped." "This drug killed the patient." "This drug did nothing but made them smell funny."
...
- **Patients Got Less Representative**: Excluded sick people, old people, people with other conditions, the people who actually need medicine
...
If one does not trust this method, one cannot trust any clinical research. Or science generally.
...
5. Pharmaceutical companies charge the surviving family $10,000 per pill

Beautiful system if you're a mortician or bankruptcy lawyer.

Humanity is at the very beginning of thousands or millions of years of systematic discovery. So this decline in lifespan growth is unlikely to result from diminishing returns - humanity hasn't run out of things to discover.
...
In the past: A genius scientist invents a cure, raises a few million, and tests safety. Simple.

Now: A genius scientist must convince one of three mega-corporations to spend a billion dollars on a 10% chance of success. Those corporations already sell inferior drugs for the same condition.
...
- 10% chance: Succeed, then cannibalize a company's own profitable drug
...
Which would a rational sociopath in a suit choose?
...
Consider: Is it more profitable to sell someone one pill that cures them, or sell them pills every month for the rest of their life?

If the answer is "cure them," one has failed capitalism.
...
The more expensive drug development becomes, the fewer companies can afford it. The fewer companies, the more monopolistic the industry. The more monopolistic, the more situations where curing a company's existing customers would be financial suicide.

This system has financial incentive for medical progress the way casinos have incentives to help gamblers win.

### Off-Patent Drugs: Cures Nobody Can Afford to Find

Roughly [10,000 known diseases](https://www.washingtonpost.com/news/fact-checker/wp/2016/11/17/are-there-really-10000-diseases-and-500-cures/) afflict humans. About 95% are rare. The 1962 law requires researchers to predict exactly what a drug will cure before testing it. If an off-patent drug cures something unexpected? Researchers just discovered something nobody can profit from.
...
When something costs more, patients get less of it. For people dying of diseases nobody can afford to cure, this isn't philosophy. It's math.
...
That's [more than the GDP of Greenland](../references.qmd#gdp-of-greenland). One could literally buy Greenland and turn it into a giant laboratory for less than it costs to approve one arthritis medication.

If today's FDA existed in 1897, aspirin would still be in Phase II trials.
...
- The patient dying of whatever the cure was for
...
Meanwhile, if one has Exploding Kidney Syndrome affecting 37 people worldwide, the system's message is: "Have you tried not having Exploding Kidney Syndrome?"

### The 166 Billion Treatments We're Ignoring

There are **[166 billion potential drug compounds](../references.qmd#166-billion-compounds)** that could be tested.

Number tested thoroughly: [About 2,000](../references.qmd#number-of-drugs-tested-thoroughly).

That's like having a library with 166 billion books but only reading the ones with pictures. There are more untested treatments than stars in the galaxy, but the system is too busy protecting itself to test them.

At the current rate of testing, humanity will have evaluated all possible treatments by the year 3,847,293.

Hopefully descendants enjoy the cure for cancer.
...
Following the 1962 increase in US regulations, a divergence is visible from Switzerland's growth in life expectancy, which did not introduce the same delays to availability.
...
Perhaps it's coincidence, but an increase in drug approvals is visible in the '80s. At the same time, the gap between Switzerland and the US gets smaller. Then US approvals go back down in the '90s, and the gap expands again.
...
### Why Bureaucrats Are Rewarded for Allowing Patients to Die
...
- Anyone who lives too far from a trial site (hope they're rich and urban)
...
Before a drug can be tested, researchers must specify EXACTLY what it will cure and EXACTLY how they will measure that cure.
...
Like requiring Columbus to file a detailed map of America before allowing him to sail west.
...
When a pharmaceutical company's economic survival depends on trial results, two problems arise:
...
**Provisional Approval:** Let terminally ill patients try experimental drugs
...
- **Slow:** {{< var treatment_acceleration_years_current >}} years from discovery to patient (the patient will be dead)
...
When TSA fails, travelers wait in line longer.
