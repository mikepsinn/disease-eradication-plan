...
Imagine a researcher met a magical genie. One wished for it to fulfill the FDA Congressional Mandate to:
...
Science is two lifetimes from applying the scientific method to medicine. That's 0.0001% of human history - humanity invented science yesterday, cosmically speaking. The more clinical research one reads, the more it becomes clear that little is known. Nearly every study ends with "more research is needed" (scientist-speak for "we have no idea what's happening, please give us more grant money"). This would be fine except people are dying while investigators figure it out.
...
5. Pharmaceutical companies charge a widow $10,000 per pill

Beautiful system if you're a mortician or bankruptcy lawyer.

Modernity is at the very beginning of thousands or millions of years of systematic discovery. So this decline in lifespan growth is unlikely to result from diminishing returns - investigators haven't run out of things to discover.
...
Which would be chosen if one were a rational sociopath in a suit?
...
Quick business question: Would a firm rather sell a patient one pill that cures them, or sell them pills every month for the rest of their life?
...
Roughly [10,000 known diseases](https://www.washingtonpost.com/news/fact-checker/wp/2016/11/17/are-there-really-10000-diseases-and-500-cures/) afflict humans. About 95% are rare. The 1962 law requires researchers to predict exactly what a drug will cure before testing it. If an off-patent drug cures something unexpected? In this instance, a discovery has been made that cannot be profited from.
...
That's like having a library with 166 billion books but only reading the ones with pictures. There are more untested treatments than stars in our galaxy, but the system is too busy protecting itself to test them.

At our current rate of testing, we'll have evaluated all possible treatments by the year 3,847,293.

One hopes that descendants enjoy the cure for cancer.
...
Before a drug can be tested, researchers must specify EXACTLY what it will cure and EXACTLY how one will measure that cure.
...
When TSA fails, one waits in line longer.
When the regulatory system fails, the patient dies waiting for approval.
