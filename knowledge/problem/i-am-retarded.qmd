...
scores:
  ...
  voice: 9
  importance: 9
audience: "Anyone certain they are right and the other side is the problem: the general reader, every tribe, fighting over politics while the disease machine runs."
feel: "Humbled and a little ashamed: I am as wrong as everyone I argue with, my anger has been aimed at the wrong people, and the real machine has been killing everyone I love while I argued."
do: "Drop the tribal certainty and forward this to the friend or relative you keep fighting politics with, the one you are sure is the dumb one, then both of you go vote at warondisease.org and put the energy you wasted on each other into the actual machine."
---
...
We discovered the scientific method a long time ago. It is easy to collect data on health and wealth. It is easy to look at what policies and budgets are predictive of increasing them. It is easy to find which countries spend the least and have above-average outcomes. This is called an efficient frontier and it has existed as a concept for decades. We did not do any of this. Instead we pick leaders the way we pick celebrities: for confidence and volume, not for any track record of turning resources into results. We routinely hand the biggest jobs to people who have already failed at smaller ones, then act surprised. We had 300 million alternatives and a working scientific method sitting right there, and reached for neither.

Even if we, for some reason, do not want to use the scientific method to figure out the best policies, and we just want some retarded human to make all the decisions, we would at least pick one who had demonstrated good judgment in resource allocation. We would find somebody who inherited nothing and used their brain to turn whatever they had into more. Instead we reliably reward the opposite: the kind of person who inherited advantages they did not earn, squandered them, and left everyone who trusted them worse off, and then we hand that kind of person the biggest job there is. That is the most retarded thing on the list and nobody on the list thinks the system that produces this is retarded, which is the whole problem.
