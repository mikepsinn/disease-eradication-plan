...
tags:
  ...
  - clinical-trials
  - misallocation
image: /assets/og-images/knowledge/problem/nih-spent-1-trillion-eradicating-0-diseases-og-academic.jpg
---

{{< include /knowledge/includes/setup-parameters.qmd >}}

![](/assets/infographics/knowledge/problem/nih-spent-1-trillion-eradicating-0-diseases-infographic-academic.jpg)
...
The National Institutes of Health has an annual budget of approximately **$51 billion**. [55 million people die annually](../references.qmd#who-daily-deaths) while this money gets allocated as follows:
...
- **11.8% - Applied research (non-trial)** ($29.3B): Research with practical aims, but not actually testing treatments in humans
  ...
  - **Observational studies:** Watching patients get sicker without testing treatments ([All of Us](../references.qmd#nih-all-of-us-inefficiency): $2.16B, zero treatments tested)
...
- **3.3% - Phased clinical trials** ($8.1B): [Actually testing if drugs work in humans](https://pmc.ncbi.nlm.nih.gov/articles/PMC10349341/) (Phases 1-3)
  ...
  - [Pragmatic trials](../references.qmd#pragmatic-trials-cost-advantage) (30x cheaper): Severely underfunded despite proven efficiency
...
Yet [pragmatic trials remain severely underfunded](../references.qmd#pragmatic-trials-cost-advantage) despite the ADAPTABLE trial proving they cost [30x less than traditional RCTs](../references.qmd#pragmatic-trials-cost-advantage) ({{< var adaptable_trial_total_cost >}} vs $420M).
