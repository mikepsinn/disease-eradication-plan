...
A [comprehensive quantitative analysis](../appendix/invisible-graveyard.qmd) using WHO mortality data and Monte Carlo modeling estimates the *total* cost of blocking patient access during the {{< var efficacy_lag_years >}}-year post-safety efficacy delay:

**{{< var dfda_efficacy_lag_elimination_deaths_averted >}} eventually avoidable deaths** from the efficacy lag alone.

This represents a humanitarian catastrophe larger than any war in modern history. See the [full sensitivity analysis](../appendix/invisible-graveyard.qmd) for confidence intervals and parameter uncertainty. 
...
[The Human Cost of Regulatory Latency](../appendix/invisible-graveyard.qmd)
:::
