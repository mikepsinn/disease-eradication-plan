...
description: How blocking patient access during 8+ years of efficacy testing made clinical trials 82× more expensive per patient while making drugs demonstrably more dangerous.
published: true
tags:
  - problem
  - fda
...
A [comprehensive quantitative analysis](../appendix/regulatory-mortality-analysis.qmd) using WHO mortality data and Monte Carlo modeling estimates the *total* cost of blocking patient access during the 8.2-year post-safety efficacy delay:
