...
For every 1 unit of harm the current system prevents, it creates {{< var type_ii_error_cost_ratio >}} units through delay. It is not a safety system. It is a filing system that produces corpses as a byproduct.
