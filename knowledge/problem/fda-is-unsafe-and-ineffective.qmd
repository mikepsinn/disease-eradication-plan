...
Meanwhile, approximately 6,400 veterans kill themselves every year [@veteran-suicide-2022], at twice the rate of civilians. Many of them have PTSD. A molecule that has existed for 112 years, been used therapeutically for 50, and produced a 67% remission rate in controlled trials is sitting in regulatory limbo because the people it helped could tell it was helping them. I looked for the word that describes letting thousands of people kill themselves while a known-effective treatment waits for someone to solve an unsolvable blinding problem, and the closest I found was "process."
