...
- {{< var dfda_efficacy_lag_elimination_deaths_averted >}} from {{< var efficacy_lag_years >}} efficacy lag
...
However, validating that large-scale real-world evidence produces better health outcomes requires further validation. This is why you need a decentralized framework for drug assessment.
...
A [comprehensive quantitative analysis](https://invisible-graveyard.warondisease.org) uses WHO mortality data and Monte Carlo modeling. It estimates the *total* cost of blocking patient access during the {{< var efficacy_lag_years >}} post-safety efficacy delay:
