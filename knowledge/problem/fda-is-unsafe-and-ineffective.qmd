...
![](/assets/infographics/knowledge/problem/fda-is-unsafe-and-ineffective-infographic-academic.png)
...
**Death toll range:** {{< var historical_progress_deaths_total >}}-{{< var disease_eradication_plus_acceleration_deaths_total >}} eventually avoidable deaths (PRIMARY estimate: {{< var disease_eradication_delay_deaths_total >}})
