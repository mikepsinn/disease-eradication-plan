...
1.  **The Oxford RECOVERY Trial:** Tested COVID treatments on 47,000 patients for **[{{< var recovery_trial_cost_per_patient >}} per patient](../references.qmd#recovery-cost-500)**. Found a life-saving treatment in 3 months.
...
**{{< var dfda_large_trial_size >}} Years of Dying at 30**
...
{{< var dfda_large_trial_size >}} years. Zero progress.
...
In 1883, [doctors founded the Journal of the American Medical Association (JAMA)](../references.qmd#jama-founded-1893) and did something novel: they shared information. After {{< var dfda_large_trial_size >}} years someone thought "what if we told each other what works?"
...
After {{< var dfda_large_trial_size >}} years of zero progress, human life expectancy suddenly increased by 4 years every decade. For 80 years.
...
5. Pharmaceutical companies charge your widow ${{< var dfda_large_trial_size >}} per pill
...
Patients with rare disease: {{< var dfda_large_trial_size >}}
...
Why? Math. If your disease only affects {{< var rare_disease_typical_patient_count >}} people, and it costs $2.6 billion to develop a drug, each patient would need to pay $5.2 million just to break even.
...
Number we've actually tested thoroughly: [About {{< var dfda_drug_approvals_per_year_high >}}](../references.qmd#number-of-drugs-tested-thoroughly).
...
- FDA response: "But their standards might be {{< var treaty_reduction_pct >}} different!"
