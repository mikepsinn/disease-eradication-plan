...
- 82× cost differential: Oxford trial ($15/patient) vs. standard Phase III ($1,230/patient)
...
**Model-Dependent Estimates** (quantitative analysis):

- {{< var historical_progress_deaths_total >}}-{{< var disease_eradication_plus_acceleration_deaths_total >}} death toll range (PRIMARY: {{< var disease_eradication_delay_deaths_total >}})
...
| **Cost per Drug** | {{< var pre_1962_drug_development_cost >}} | {{< var pharma_drug_development_cost_current >}} | {{< var drug_cost_increase_pre1962_to_current_multiplier >}}× increase |
| **New Approvals** | 46/year (1960) | 13/year (1963) | {{< var post_1962_drug_approval_reduction_pct >}} decline |
| **Life Expectancy Growth** | 4 years/decade | 2 years/decade | 50% reduction |
| **Trial Cost** | $15/patient (Oxford-style) | {{< var traditional_phase3_cost_per_patient >}}/patient | {{< var trial_cost_reduction_factor >}}× increase |
| **Time to Approval** | 2-3 years | {{< var fda_approval_timeline_avg_years >}} years | 5-8× slower |
...
- **95% of diseases are rare:** Development cost ({{< var pharma_drug_development_cost_current >}}) ÷ patient population (10,000) = $260,000/patient
...
**Death toll range:** {{< var historical_progress_deaths_total >}}-{{< var disease_eradication_plus_acceleration_deaths_total >}} preventable deaths (PRIMARY estimate: {{< var disease_eradication_delay_deaths_total >}})

**The conclusion holds across all scenarios:**

- **Conservative** ({{< var historical_progress_deaths_total >}}): Counts only delayed access to existing drugs
- **PRIMARY** ({{< var disease_eradication_delay_deaths_total >}}): Accounts for disease eradication timeline shift
- **Optimistic** ({{< var disease_eradication_plus_acceleration_deaths_total >}}): Includes innovation acceleration effects

Even the Conservative estimate represents a humanitarian catastrophe larger than any war in modern history. 
...
**Even if you think these estimates are off by a factor of 10**, the core problem remains: a system that costs 82× more per patient, takes 36× longer than proven alternatives, and produces less safety data from smaller, less representative populations.
