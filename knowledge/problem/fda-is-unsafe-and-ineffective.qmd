...
1.  **The Oxford RECOVERY Trial:** Tested COVID treatments on 47,000 patients for **[$500 per patient](.../../knowledge/references.qmd#recovery-cost-500)**. Found a life-saving treatment in 3 months.
2.  **The FDA System:** Averages **[$41,000 per patient](.../../knowledge/references.qmd#trial-cost-41k)** for clinical trials. Takes an average of **[9.1 years](.../../knowledge/references.qmd#drug-development-timeline-9-years)** to approve a new drug.
...
For over 99% of recorded human history, [the average human life expectancy was around 30 years](.../../knowledge/references.qmd#historical-life-expectancy-30-years).
...
In 1883, [some doctors founded the Journal of the American Medical Association (JAMA)](.../../knowledge/references.qmd#jama-founded-1893) and did something revolutionary: they shared information. Apparently after 10,000 years someone finally thought "what if we told each other what works?"

Here's how it worked:

[144,000 physicians](.../../knowledge/references.qmd#pre-1962-physician-trials) across America tried treatments on real patients. They wrote down what happened. "This drug helped." "This drug killed the patient." "This drug did nothing but make them smell funny."
...
Thalidomide was first marketed in Europe in [1957](https://en.wikipedia.org/wiki/Thalidomide) for morning sickness. While it was initially thought to be safe in pregnancy, [it resulted in thousands of horrific congenital disabilities](.../../knowledge/references.qmd#thalidomide-birth-defects).

Fortunately, [the existing FDA safety regulations prevented any birth defects in the US](.../../knowledge/references.qmd#thalidomide-no-us-birth-defects). Despite the effectiveness of the existing US regulatory framework in protecting Americans, newspaper stories such as the one below created a strong public outcry for increased regulation.
...
The new regulations immediately [reduced new drug approvals by 70%](.../../knowledge/references.qmd#post-1962-drug-approval-drop).
...
So Congress "fixed" this by [extending drug patent monopolies](.../../knowledge/references.qmd#drug-price-competition-act-1984) in 1984.
...
- **Average cost:** [$2.6 billion](.../../knowledge/references.qmd#drug-development-costs)
- **Average time:** [9.1 years from Phase 1](.../../knowledge/references.qmd#drug-development-timeline-9-years) (17 years total discovery-to-patient)
- **Success rate:** [12% make it through trials](.../../knowledge/references.qmd#drug-trial-success-rate-12-pct)

That's [$41,000 per person](.../../knowledge/references.qmd#trial-cost-41k) just to TEST if a pill works. Not the pill. Just to test it.
...
The total cost? **[$2.6 billion](.../../knowledge/references.qmd#drug-development-costs)** per new drug.

That's [more than the GDP of Greenland](.../../knowledge/references.qmd#gdp-of-greenland). We could literally buy Greenland and turn it into a giant laboratory for less than it costs to approve one arthritis medication.
...
**[17 years from discovery to patient](.../../knowledge/references.qmd#drug-development-timeline-17-years)** (while you die waiting).
...
[95% of diseases have ZERO approved treatments](.../../knowledge/references.qmd#fda-untreated-diseases-95pct).
...
There are **[166 billion potential drug compounds](.../../knowledge/references.qmd#166-billion-compounds)** we could test.

Number we've actually tested thoroughly: [About 2,000](.../../knowledge/references.qmd#number-of-drugs-tested-thoroughly).
...
Under the current system of research, it costs [$41k per subject](.../../knowledge/references.qmd#trial-cost-41k) in Phase III clinical trials. As a result, there is not a sufficient profit incentive for anyone to research the effects of any factor besides a molecule that can be patented.

![how much we know](.../../assets/how-much-we-know.png)

## The Actual Death Toll of "Drug Lag"

The FDA's economists have a term for people dying while waiting for a drug to be approved: "drug lag." It's a sterile, bureaucratic phrase for a massacre. Delays are estimated to cost **[21,000 to 120,000 American lives per decade](.../../knowledge/references.qmd#gieringer85)**.
...
The most infamous case is beta-blockers. While Europe used them to prevent heart attacks, the FDA waited. And waited. The decade-long delay in approving them for their most common use is estimated to have killed **[over 100,000 Americans](.../../knowledge/references.qmd#beta-blocker-deaths)**.
...
[Depression is the leading global cause of disability](.../../knowledge/references.qmd#depression-leading-cause-disability) and the strongest behavioral predictor of suicide. Existing antidepressant drugs [fail to achieve remission in about **two-thirds of patients**](.../../knowledge/references.qmd#antidepressant-failure-rate-stard), and pharmacologic innovation has stagnated. Closed-loop neuromodulation, implantable or wearable systems that sense neural activity and adjust stimulation in real time, has shown [**response rates of 60–80 %**](.../../knowledge/references.qmd#neuromodulation-trd-response-rates) in pilot trials for treatment-resistant depression and obsessive–compulsive disorder.
...
| Metric                                                              | Value               | Source                        |
| ------------------------------------------------------------------- | ------------------- | ----------------------------- |
| Global major-depressive-disorder prevalence                         | ~280 million people | [WHO 2023](.../../knowledge/references.qmd#depression-prevalence-280m)                      |
| Annual suicides                                                     | ~700 000            | [WHO 2023](.../../knowledge/references.qmd#suicide-deaths-vs-war-deaths)                      |
...
- [Retire to pharma job](.../../knowledge/references.qmd#fda-regulatory-capture-evidence)
...
FDA trials systematically [exclude](.../../knowledge/references.qmd#clinical-trial-exclusions):
...
- **Negative trial results published:** [37%](.../../knowledge/references.qmd#publication-bias-clinical-trials)
- **Positive trial results published:** [94%](.../../knowledge/references.qmd#publication-bias-clinical-trials)
- **Money wasted repeating failed experiments:** [~\$100 billion annually](.../../knowledge/references.qmd#wasted-spending-on-failed-experiments)
...
**[Japan's Regenerative Medicine Act](.../../knowledge/references.qmd#japans-regenerative-medicine-act):**
...
**[EU Compassionate Use](.../../knowledge/references.qmd#eu-compassionate-use-program):**
...
**[Right to Try (US)](.../../knowledge/references.qmd#right-to-try-act-2018):**

- Passed despite FDA opposition
- FDA response: Made it effectively impossible to use
- [Patients helped: <200 total](.../../knowledge/references.qmd#right-to-try-act-outcomes)
...
- **February 2020:** [FDA blocks all non-CDC tests](.../../knowledge/references.qmd#fda-covid-test-delay)
- **Late February:** [CDC tests contaminated, don't work](.../../knowledge/references.qmd#cdc-covid-test-contamination-2020)
- **March:** Private labs begging to test, FDA says no
- **Late March:** FDA finally allows other tests
- **Cost:** Unknown thousands of [preventable deaths](.../../knowledge/references.qmd#excess-deaths-fda-covid-response)
