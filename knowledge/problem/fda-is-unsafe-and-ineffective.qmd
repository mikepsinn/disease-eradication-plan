...
description: How FDA efficacy regulations made clinical trials 82× more expensive per patient while making drugs demonstrably less safe.
published: true
tags:
  - problem
  - fda
...
- 82× cost differential: Oxford trial ({{< var recovery_trial_cost_per_patient >}}) vs. standard Phase III ({{< var traditional_phase3_cost_per_patient >}})
...
| **Trial Cost** | {{< var recovery_trial_cost_per_patient >}} (pragmatic) | {{< var traditional_phase3_cost_per_patient >}} | {{< var trial_cost_reduction_factor >}}× increase |
...
- **[95% of diseases are rare](../references.qmd#n95-pct-diseases-no-treatment):** Development cost ({{< var pharma_drug_development_cost_current >}}) ÷ patient population (~10,000 patients) = $260,000/patient
...
When something costs more, you get less of it. For [95% of diseases](../references.qmd#n95-pct-diseases-no-treatment) with zero treatments, this isn't philosophy. It's math.
...
- **{{< var disease_eradication_delay_deaths_total >}} deaths** from eliminating the 8.2-year efficacy lag
