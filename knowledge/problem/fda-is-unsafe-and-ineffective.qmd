...
2.  **The FDA System:** Averages **[{{< var traditional_phase3_cost_per_patient_fda_example_41k >}} per patient](../references.qmd#trial-cost-41k)** for clinical trials. Takes **[9.1 years](../references.qmd#drug-development-timeline-9-years)** to approve a new drug.
...
That's [{{< var traditional_phase3_cost_per_patient_fda_example_41k >}} per person](../references.qmd#trial-cost-41k) just to TEST if a pill works. Not the pill. Just to test it.
...
**[{{< var treatment_acceleration_years_current >}} years from discovery to patient](../references.qmd#drug-development-timeline-17-years)** while you die waiting.
...
Under the current system of research, it costs [{{< var traditional_phase3_cost_per_patient_fda_example_41k >}} per subject](../references.qmd#trial-cost-41k) in Phase III clinical trials. As a result, there is insufficient profit incentive for anyone to research the effects of any factor besides molecules that can be patented.
