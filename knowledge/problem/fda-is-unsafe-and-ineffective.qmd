...
Even if those death estimates are off by a factor of 10, that's still tens of millions of deaths. And the inefficiency is independently verifiable: the system costs {{< var recovery_trial_cost_reduction_factor >}} more per patient and takes {{< var fda_to_oxford_recovery_trial_time_multiplier >}} longer than proven alternatives. Those numbers don't depend on mortality estimates at all.
