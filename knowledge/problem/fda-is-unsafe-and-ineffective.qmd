...
Even if these estimates are off by a factor of 10, the system still costs {{< var recovery_trial_cost_reduction_factor >}} more per patient and takes {{< var fda_to_oxford_recovery_trial_time_multiplier >}} longer than proven alternatives.
