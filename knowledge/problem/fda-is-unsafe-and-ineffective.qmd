...
2.  **The FDA System:** Averages **{{< var traditional_phase3_cost_per_patient >}} per patient** for clinical trials. Takes **[9.1 years](../references.qmd#drug-development-timeline-17-years)** to approve a new drug.
...
The FDA's economists have a term for people dying while waiting for drug approval: "drug lag." It's a sterile, bureaucratic phrase for a massacre. Early estimates suggested delays cost **[21,000 to 120,000 American lives per decade](../references.qmd#fda-drug-lag-deaths-estimate)**.
...
The most infamous case is beta-blockers. While Europe used them to prevent heart attacks, the FDA waited. And waited. The decade-long delay in approving them for their most common use killed an estimated **[over 100,000 Americans](../references.qmd#beta-blocker-drug-lag-deaths)**.
...
FDA trials systematically [exclude](../references.qmd#fda-trial-patient-exclusion-criteria):
...
- **{{< var disease_eradication_delay_dalys >}} DALYs** destroyed by paperwork
