...
Robot lab assistants perform experiments {{< var traditional_large_trial_size >}} times faster than humans. AlphaFold maps every protein like solving cosmic sudoku. Drug companies design, synthesize, and validate new treatments in weekends.
...
This is the same logic from [the Economic Case chapter](../economics/economics.qmd) - {{< var total_complete_benefits_annual >}} from the initial 1% treaty, scaled to 50% redirection over 25 years. Same principles. Bigger numbers.
...
**Wealth:** Peace dividend provides ${{< var qalys_from_prevention_conservative >}}/year universal basic income. Money barely matters in post-scarcity. Work is play. Play is work. Both optional.
...
While you read this, 200 people died of preventable diseases. ({{< var qalys_from_prevention_optimistic >}} per day = 104 per minute.)
