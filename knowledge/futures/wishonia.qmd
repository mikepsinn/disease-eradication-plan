...
If you'd like numbers instead of poetry: the [20-year model](../economics/gdp-trajectories.qmd) projects the Wishonia path producing {{< var wishonia_trajectory_gdp_vs_current_trajectory_multiplier_year_20 >}} the GDP of doing nothing. Per person, that's {{< var wishonia_trajectory_avg_income_year_20 >}} average income versus {{< var current_trajectory_avg_income_year_20 >}} on your current trajectory. Not the rich ones. The average ones. That's what "not being stupid" compounds to over 20 years. Over an average remaining lifespan, your cumulative earnings under the Wishonia path are {{< var wishonia_trajectory_lifetime_income_multiplier >}} what they'd be on the earth baseline. The average human gains {{< var wishonia_trajectory_lifetime_income_gain_per_capita >}} in additional lifetime income. On Wishonia, we find it remarkable that "stop wasting money on explosions" qualifies as a financial strategy. On your planet, it apparently does.
...
- **The IRS** (gone; the transaction tax is collected automatically by smart contract; no filing, no audits, no 80,000 employees)
...
- **Every welfare program** (gone; food stamps, housing vouchers, disability determination, Social Security Administration, Medicaid eligibility offices, all replaced by one UBI deposit; the entire bureaucracy of means-testing poverty is eliminated because the floor is universal)
...
Your species currently spends over a trillion dollars per year on the *process* of collecting taxes, determining who is poor enough to deserve help, allocating budgets, and arguing about all three. On Wishonia, three pieces of software handle it: the monetary algorithm (0% inflation, productivity dividend), the transaction tax smart contract (UBI floor), and Wishocracy (public goods allocation). They cost nothing to operate. They have no dining room. Nobody takes them to lunch.
