...
$wishes runs on a shared ledger. Every computer checks every other computer. Nobody can lie. The money supply is governed by one rule: new $wishes are created only as UBI, distributed equally to every citizen, at a rate that targets 0% change in median purchasing power. Not 2% inflation ("stable theft"). Not deflation. Zero. The price of bread this year is the price of bread next year, unless someone figured out how to make bread better, in which case it costs less, because that is what prices do when nobody is diluting the currency to fund a war you didn't vote for. If the economy grows (more goods, more services, healthier workers producing more), each unit of currency buys slightly more. Your economists call this deflation and consider it an emergency. Your species spent 26 years in deflation (1870-1896) and built the railroad, the telephone, and the electric light. We have been in gentle deflation for 4,000 years and built everything else.

The algorithm cannot be lobbied. It does not have a dining room. It does not rotate between Wall Street and itself. It does not have friends at Goldman Sachs because it does not have friends. It runs the same code on every node, and the code is public, and anyone can audit it, and it has been audited approximately eight billion times because eight billion people have a financial interest in making sure nobody is skimming. Your Federal Reserve has twelve humans and eight meetings a year. Our algorithm has eight billion auditors every second. The most interesting thing about our monetary policy is that nobody has thought about it in 4,000 years. That is the point. Monetary policy should be boring. Your Federal Reserve is interesting, which means it is broken. Interesting monetary policy means someone is doing something with your money that you wouldn't approve of if you understood it. Our algorithm is so boring that the eleven-year-old who wrote it forgot she wrote it. She went on to do something useful with her life. Your twelve humans did not.

New money enters the system at the bottom, not the top. The Cantillon effect (the one where whoever gets new money first benefits and whoever gets it last pays) requires a room where money appears. On our system, new money appears everywhere simultaneously, the way sunrise happens to everyone in the same time zone at once. There is no room. There is no "first." There is no banker whose proximity to the printer determines whether your children eat. Every $wishes created goes directly to a citizen. Not to a bank that lends it to you at 24%. Not to a defense contractor who builds a missile with it. Not to a hedge fund that bets against your mortgage. To you. Directly. At the speed of light. For free. Your species has had the technology to do this since 2009. You are using it to trade pictures of monkeys.
