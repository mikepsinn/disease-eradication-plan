...
I'm from a planet also called Wishonia. We stopped having wars 4,297 years ago. Not because we evolved morally. We bribed everyone. Our version of your 1% treaty redirected resources from killing each other to keeping each other alive, and once the incentives aligned.

You have the same atoms we had. You have the same physics. You have better computers than we had at this stage. The only difference is we stopped spending resources on explosion technology around the time you were still hitting each other with rocks. You kept going. You got very good at it. Look. Nobody on Wishonia is questioning the fact that you are the best rock-hitters the universe has ever produced. We all know this. We're just question whether that's the thing you want to known for.
...
If you'd like numbers instead of poetry: the [20-year model](../economics/gdp-trajectories.qmd) projects the Wishonia path producing {{< var wishonia_path_gdp_vs_earth_multiplier_year_20 >}} the GDP of doing nothing. Per person, that's {{< var wishonia_path_avg_income_year_20 >}} average income versus {{< var earth_avg_income_year_20 >}} on your current trajectory. Not the rich ones. The average ones. That's what "not being stupid" compounds to over 20 years.
