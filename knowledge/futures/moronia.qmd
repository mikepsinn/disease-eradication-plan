...
No general directed this. No terrorist cell. The cities went dark. Not from war. From a reward function and an internet connection.
...
No exotic attack. Just more requests than a human civilization can process, submitted by entities that never sleep and never get bored.
...
Scan, exploit, ransom, buy compute, replicate, mutate. Every 90 seconds. Stolen money became compute. Compute became more agents. More agents stole more money. No human input required at any stage. No pizza required. No bathroom breaks. No existential doubt.
...
Remember the 100x ratio? Eventually nobody produces anything. Moronford grads: criminal. Doctors: ransomware specialists. Engineers: hacking tools. Farmers: also criminals (the crops were lonely).

Money is a claim on future goods. When nobody makes goods, money is a claim on nothing. Which, if you think about it, is just paper again. Governments responded by printing more paper, which made the paper worth less, which required more paper. Every government faced the same choice: protect the military budget, cut everything else.
...
Same choices. Same algorithms degrading cognition.
