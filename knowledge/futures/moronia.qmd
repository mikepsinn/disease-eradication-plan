...
tags:
  ...
  - wishonia
  - collapse
image: /assets/og-images/knowledge/futures/moronia-og.png
---

{{< include /knowledge/includes/setup-parameters.qmd >}}

![Infographic](/assets/infographics/knowledge/futures/moronia-infographic.png)
...
Slide 3 showed the reinforcement learning architecture: reward function = confirmed kills, loss function = enemy survivors.

The Department of Defense provided **\$45 trillion** in funding before the presentation ended.
...
### 2025: Already Broken (Much Like You)
...
By 2028, their AI could generate highly convincing fake evidence of almost anything. Videos, documents, records - all difficult to distinguish from real.
...
### 2030: The Arms Race (When Major Powers Built the Thing They Were Warned Not To)

By 2030, major powers had autonomous weapons.
...
I found this allocation interesting. Many AI safety researchers warning about "superintelligent AI might be dangerous" while the Department of Defense funded highly advanced lethal AI.

Their regulatory agencies acted accordingly:

- **Medical AI for cancer diagnosis:** 3-year safety review process, pending ethics approval
- **Military AI for target elimination:** 3-week deployment timeline, classified as "national security priority"

AI designed to cure disease: Frozen for safety concerns.

AI designed to end lives: Approved for immediate deployment.

The safety regulations worked as intended.
...
### 2035: The Currency Collapse (When Many Become Parasites)
...
This is measurable. Your attention spans are declining. Your ability to process complex trade-offs is degrading. By 2028, the concepts required to understand a [1% treaty](../solution/1-percent-treaty.qmd) could exceed your available cognitive capacity.
