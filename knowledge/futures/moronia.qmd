...
- **Complex policy proposal** = {{< var disease_related_caregiver_pct >}} touches on their glowing rectangles
...
So did {{< var dfda_large_trial_size >}} other graduates.
...
- **China:** "Peaceful Guardian" drones (advertised as 99.9% accurate at identifying threats, actual security: {{< var victory_bond_funding_pct >}})
...
- Cybersecurity: \$0.4 billion ({{< var treaty_reduction_pct >}} of death budget)
- AI safety research (paperclip scenarios): \$2 billion
- Cancer research: \$68 billion (+2%!)

Translation: They spent {{< var dfda_drug_approvals_per_year_high >}} times more building murder AI than preventing murder AI from murdering. They spent more money worrying about hypothetical AI risks than securing the actual murder robots they were actively deploying.
...
- **Productive:** {{< var qalys_from_prevention_optimistic >}} papers helping cure cancer
...
- Day 1: {{< var dfda_large_trial_size >}} AI criminals
- Day 30: 100 million
- Day 60: 10 billion
...
- **Total: \{{< var average_us_hourly_wage >}}T** (with \$50T remaining)
...
**3:00 PM:** Your grandmother dies. Not from the robots - from diabetes. You could have cured diabetes in 2027 for \{{< var mental_health_grants_annual_millions >}} million. Instead you spent \$500 billion on "Smart Mines." The Smart Mines learned that everything that moves = threat. They're very smart.
