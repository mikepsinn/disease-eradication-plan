...
> Probability times value equals expected value. A plot of land with a 10% chance of \$100,000 in gold underneath it is worth \$10,000.
...
> The probability that you or someone you love will experience something like eternal suffering is not zero. You cannot prove it is zero. Anything times negative infinity is negative infinity. It is worth any finite cost to prevent.
...
> Jellyfish are biologically immortal. Drugs make humans feel very good. The probability that sufficient resources and effort could produce an indefinitely pleasant conscious existence is not zero. Anything times positive infinity is positive infinity. It is worth any finite cost to pursue.
...
+---------------------------------------+
|                                       |
|  EV(prevent hell)   = +infinity       |
|  EV(achieve heaven) = +infinity       |
|                                       |
|  total = two infinities of motivation |
|                                       |
|  this is why EOS exists               |
|  this is why you are the president    |
|                                       |
+---------------------------------------+
```

> Two infinities. Both point the same direction: fund the research, end the wars, fix the allocation. The math is the same math you use to price a plot of land. The stakes are somewhat higher than a plot of land.
>
> You are the president. Your 8 billion colleagues are waiting.
...
+---------------------------------------+
|                                       |
|  P(hell)   x infinity  =  infinity    |
|  P(heaven) x infinity  =  infinity    |
|                                       |
|  cost of trying:  finite              |
...
|  Alzheimer's                          |
|  ============                         |
|  subjective time: minutes -> years    |
|  no exit                              |
|  no way to disprove it won't be you   |
|                                       |
|  salvia divinorum:                    |
|  "crushed to death for millennia"     |
|                                       |
+---------------------------------------+
```
...
+---------------------------------------+
|                                       |
|  EVIDENCE THAT GOOD IS POSSIBLE       |
|                                       |
|  drugs        -> feel very good   [x] |
|  jellyfish    -> biological immortal  |
|                  (Turritopsis)    [x] |
|  time dilation -> extend pleasure [x] |
|                                       |
|  sufficient resources + effort        |
|  = indefinitely pleasant existence    |
|                                       |
+---------------------------------------+
```
...
|                                       |
|  since 1900: $170T spent murdering   |
|  310M of their own employers         |
|                                       |
|  any other employee:  terminated     |
|  these guys: $1T raise every year    |
|                                       |
+---------------------------------------+
```
...
|  $15 trillion / yr total cost         |
|                                       |
|  possible drug-disease combos: 9.5M   |
|  tested: 32,500  =  0.3%             |
|  queue at 15/yr: 443 years            |
|                                       |
|  Pentagon unaccounted: $2.46T         |
|  = 546 years of clinical trials       |
|    sitting in a black hole            |
|                                       |
+---------------------------------------+
```

> The defense industry is the biggest one, but it is not the only one. Today, 4 billion people are sick with chronic or infectious diseases. There are 550 million people whose entire job is taking care of them. The cost is roughly \$15 trillion a year. There are 9.5 million possible drug-disease combinations we could test. We have tested 32,500. That is 0.3% of the space. At the current rate of 15 new disease-treatment combinations approved per year, it will take 443 years to clear the existing queue. The \$2.46 trillion that the Pentagon cannot account for across 8 failed audits, all by itself, represents 546 years of clinical trials at current funding levels. This is Ignaz Semmelweis's unwashed hands, scaled to a civilization. The cure is not missing. The decision to fund the search is.
...
> The math works for the shareholders too. The same model that says the [1% treaty](../solution/1-percent-treaty.qmd) [@1-percent-treaty-paper-2025] [@1-pct-treaty-impact-paper-2025] makes the average person 89% richer by year 20 says the defense companies' own shareholders come out ahead in the redirected world. They are extracting value from a shrinking, destabilized economy. Redirect the lobbying toward the policies that grow the economy and their revenues grow with it. Their stock goes up. Their employees live longer. Their children inherit a healthier planet. The Ethyl Gasoline Corporation's shareholders would have been 20 to 60% richer if they had never put lead in the gas. We are not asking the defense contractors to be charitable. We are telling them what the math says.
...
|  Delaware C-corp  (Berkshire model)   |
|                                       |
|  you buy: non-voting economic share   |
|  floor:   NAV of defense portfolio    |
|  upside:  premium as campaigns win    |
|                                       |
|  minimum: $25,000                     |
...
>
> Your 8 billion colleagues are waiting.
...
| Earth wastes \$101 trillion/year on suboptimal policies | Derived in book | [The Political Dysfunction Tax](/knowledge/appendix/political-dysfunction-tax.qmd) |
...
| \$170 trillion spent on murder since 1900 | Derived in book | [Cost of War](/knowledge/problem/cost-of-war.qmd) |
...
| \$15 trillion annual disease burden | Derived | Direct + indirect costs; [Cost of Disease](/knowledge/problem/cost-of-disease.qmd) |
| 9.5 million possible drug-disease combinations | Derived | ~9,500 approved drugs x ~1,000 diseases; [Cost of Disease](/knowledge/problem/cost-of-disease.qmd) |
| 32,500 tested (0.3%) | Derived | ClinicalTrials.gov completed trials; [Cost of Disease](/knowledge/problem/cost-of-disease.qmd) |
| 443 years to clear queue at 15 approvals/year | Derived | 6,650 rare diseases / 15 FDA approvals/yr; [Cost of Disease](/knowledge/problem/cost-of-disease.qmd) |
| \$2.46 trillion Pentagon unaccounted = 546 trial years | Derived | DOD OIG audit findings; \$2.46T / \$4.5B per trial-year; [Cost of War](/knowledge/problem/cost-of-war.qmd); [Cost of Disease](/knowledge/problem/cost-of-disease.qmd) |
...
| US military spending 3% of current levels in 1939 | Historical data | \$29B (1939) vs. \$886B (2024), constant 2024 dollars. [Cost of War](/knowledge/problem/cost-of-war.qmd) |
