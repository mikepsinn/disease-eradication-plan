---
title: How Central Banks Fund Death
description: 'The War Machine''s ATM: An analysis of how every fiat currency in history has been devalued to fund unpopular wars, and how to bypass the system.'
published: true
tags:
  - central-banking
  - war-funding
...
Every dollar in a wallet is a death certificate with a president's face on it.

This sounds dramatic. But consider the relationship between money printing and murder.
...
- Populations are living it (how's that working out?)
...
## 1972: When Nixon Weaponized Money
...
- Gold standard: Dead
- Dollar backing: "Trust us"
- Inflation: To the moon
- Savings: Slowly murdered
...
2. Military contractors (also correct!)
3. The public (Wrong! Thanks for playing!)

## The Cantillon Effect: Why Populations Lose Wealth and Contractors Do Not
...
- The public doesn't get any (sad trombone)

**2. Banks Get Rich**

- Banks get new money first
- Buy assets while prices still low
- Rent goes up immediately
...
**4. The Public Gets Screwed**

- Inflation hits groceries
- Savings lose value
- Wages stay flat
- Citizens blame immigrants (they want this)

It's called the Cantillon Effect after Richard Cantillon, who figured this out in the 1700s. Humans have known about this scam for 300 years. People keep falling for it anyway, like finding out fire burns and immediately touching it again to make sure.

## The Federal Reserve: A Private Corporation That Controls the Economy
...
- Never been thoroughly audited
- More powerful than Congress

### What They Actually Do

1. **Print Money for Wars**
   - Iraq/Afghanistan: [$8 trillion printed](../references.qmd#total-military-and-war-costs-11-4t)
   - Ukraine: $113 billion and counting
   - Next war: Already funded in advance

2. **Bail Out Their Friends**
   - 2008: $700 billion to banks
   - 2020: $4 trillion to everyone (except the public)
   - 2023: $300 billion to failed banks again
   - Mortgages: Still not forgiven

3. **Destroy Purchasing Power**
   - Inflation "target": 2% (money half gone in 35 years)
   - Actual inflation: Way higher (check grocery bills)
   - Real inflation: Everything needed costs more
...
4. **Hide the Evidence**
   ...
   - The public will never know what they're really doing

## Every War Since 1972: Funded by Destroying Savings

Let's do the math on how much money has funded murder:

### Vietnam War Extension (1972-1975)

- Cost: $168 billion (inflation adjusted)
- Funded by: Money printing
- Public loss: 30% purchasing power

#### Gulf War (1991)

- Cost: $102 billion
- Funded by: Money printing
- Public loss: Gas prices doubled

#### Iraq War (2003-2011)

- Cost: $2 trillion
- Funded by: Money printing
- Public loss: House prices went insane

#### Afghanistan (2001-2021)

- Cost: $2.3 trillion
- Funded by: Money printing
- Public loss: Can't afford anything
...
## The $300 Billion Annual Bank Subsidy (Public Money)

Here's a game: The Fed pays banks interest on reserves.
...
## Why Society Cannot Reform the Fed (It's Terminal)
...
4. **Too Many Depend on the Scam**
   ...
   - Everyone important wins (the average citizen is not important)

#### The Only Solution: Bypass It Entirely

Humans can't fix the Fed. It's like trying to reform cancer. Somebody doesn't reform cancer. They cut it out or route around it.

## Why "Just Fund Medical Research More" Is False
...
Governments can print infinite dollars. They can't print more geniuses.
...
Researchers got a 50.0% raise! Too bad everything costs 50.0% more. The pie didn't grow. They just cut it with more decimal places.
...
Here's the trick usually overlooked:

**When the Fed prints $1 trillion for war:**

1. Military contractors get it first (Cantillon Effect)
...
Here's the strategic redirection: They're already printing trillions for war. The treaty asks them to point 1% of it at healing instead.
...
- The fund supports pragmatic clinical trials for 54 million patients
- People live
- Savings still devalued (but at least people get cured)
...
3. **The Money is Already Fake**
   ...
   - Public purchasing power dies either way (but citizens might live)
...
- They funded necessary military
- VICTORY [Incentive Alignment Bonds](../appendix/incentive-alignment-bonds-paper-academic.qmd) fund pragmatic clinical trials for necessary cures
- They saved democracy from fascism
- VICTORY [Incentive Alignment Bonds](../appendix/incentive-alignment-bonds-paper-academic.qmd) save humanity from disease
...
- Military contractors get richer
- Repeat until extinction

#### Option B: The 1% Redirect

- Fed still prints $8 trillion (they're addicted)
- 1% ($80 billion) goes to curing disease through pragmatic clinical trials
- Currency still becomes worthless (sorry)
- But millions fewer people die
- Maybe cancer gets cured before someone needs it
...
- Military contractors keep 99% (they stop complaining)
...
They created the money printer to fund death without asking permission. Society is using their own system against them - redirecting their death machine to create life. It's like convincing a dragon to breathe medicine instead of fire.

## Public Funds, Public Choice

Every dollar in a wallet was printed to fund something.
...
- Public health (unlikely)

With VICTORY Incentive Alignment Bonds, public money funds:
...
*P.S. - The Fed has entered the chat. They want the public to know that inflation is "transitory" and war is "necessary for stability." They also have a bridge to sell. It's in Brooklyn. Very nice. Trust them.*