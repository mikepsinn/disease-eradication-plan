...
- {{< var global_population_2024_nounit >}} brains (fixed quantity)
...
- Currently employed in military and defense industries: ~40 million (including active military, reserves, and defense contractors)
- Currently working in medical research: ~1 million
- The spending ratio: {{< var military_vs_medical_research_ratio >}}:1 for death over life
...
- Global medical research: {{< var global_med_research_spending >}}
- Global military spending: {{< var global_military_spending_annual_2024 >}}
- Ratio: {{< var military_vs_medical_research_ratio >}}:1 for death

#### Five Years Later (after "increasing medical research")

- Medical research up 50%! Victory!
- Military spending also up 50%
- Central banks printed 50% more money
- Real purchasing power: Exactly the same
- Ratio: Still {{< var military_vs_medical_research_ratio >}}:1 for death
...
- Military-industrial: 3% → 3.4% of GDP (direct spending; broader defense-adjacent industries add more)
- Healthcare spending: 7% → 18% of GDP (most of the growth is bureaucracy, not cures)
