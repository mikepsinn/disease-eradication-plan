...
I know that sounds dramatic. Let me show you why it isn't.
...
The pattern is so consistent it's basically a law of physics: Give politicians a money printer, they'll use it to fund wars the public would never agree to pay for with taxes. Humans invented money as a way to trade chickens more efficiently. Within a few centuries, they were using it to incinerate cities. Impressive trajectory.
...
Nixon went on TV and said, in slightly more presidential language, "Remember how dollars could be exchanged for gold? We're stopping that. Also, wage and price controls. Also, import taxes." He called it a "New Economic Policy." On your planet, whenever someone names a policy the opposite of what it does, something terrible is about to happen.
...
The Cantillon Effect, understood since the 1700s: whoever gets newly printed money first gets rich. Whoever gets it last gets inflation.

The Fed prints money. Banks and defense contractors get it first and buy things at today's prices. By the time it reaches your grocery store, prices have already risen. You don't notice you've been robbed because nobody broke into your house. They just made everything in it worth less.

Then you blame immigrants. Which is exactly what they want you to do.
...
The Federal Reserve isn't federal and has no reserves. It's like the Holy Roman Empire, which was neither holy, nor Roman, nor an empire. You have a naming problem on this planet.
...
3. **Destroy Your Purchasing Power**
   ...
   - They call it a "target" as though they're aiming for it on purpose. They are. That's the worst part.
...
Every time your government wants to bomb someone, it doesn't ask you. It just makes your savings worth a little less. Here's the receipt:
...
The Fed pays banks interest on money the banks keep parked at the Fed. Read that again. Banks give the Fed money. The Fed gives it back with interest. This costs taxpayers {{< var global_pharma_rd_spending_annual >}} per year. For doing nothing. On most planets, getting paid to do nothing is called "unemployment." On yours, it's called "monetary policy."
...
Because money isn't real. It's just numbers humans agreed to hallucinate together. Resources are real.
...
When a brilliant engineer designs missiles, that engineer is NOT designing medical devices. When a factory builds tanks, it's NOT building MRI machines. When a PhD researches better ways to kill people, they are NOT researching better ways to keep people alive. Every genius has exactly one brain. You're renting 40 million of them to build things that explode.
...
You can print infinite dollars. You cannot print geniuses. This is the most important sentence in this chapter and you will forget it by tomorrow.
...
Watch closely, because this is how they rob you in broad daylight while you applaud:
...
You got a 50.0% raise! Too bad everything costs 50.0% more. The pie didn't grow. They just gave you a bigger number on a smaller slice and expected you to say thank you. You did.
...
Absolute dollars increased 10x. Percentage of resources: actually decreased. You got richer and spent less of it on not dying. Like buying a bigger house and smaller fire extinguishers.
...
The money printers fund what they value. They value control, not cures. Nobody ever seized power with a stethoscope.
...
An MIT graduate with $200k in student debt chooses between Raytheon at $150k and an NIH postdoc at $55k. The student debt doesn't care about your feelings, so neither does the graduate. Another brain lost to the death machine. Multiply by forty million.
...
Here's the part where I stop complaining and offer you something useful. They're already printing trillions for war. The treaty asks them to point 1% of it at healing instead.
...
They created the money printer to fund death without asking permission. The treaty uses their own system against them. You're not fighting the dragon. You're just asking it to breathe in a slightly different direction. The dragon doesn't even notice. One percent is a rounding error to a dragon.
