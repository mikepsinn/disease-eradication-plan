...
The Federal Reserve is not federal and has no reserves. It's like the Holy Roman Empire (neither holy, nor Roman, nor an empire) or the Democratic People's Republic of Korea (zero for four). You have a naming problem on this planet.
...
- Never been fully audited (they audit you, though)
- More powerful than Congress (lower approval rating too, which is impressive)
...
3. **Destroy Your Purchasing Power**
   - Inflation "target": 2% per year (your money half gone in 35 years, by design)
   - Actual inflation: Way higher (check your grocery bill, then sit down)
   - Real inflation: Everything you need costs more, everything you own is worth less
   - They call it a "target." They are aiming at you. That's the target.

4. **Hide the Evidence**
   - No full audit allowed
   - Meeting minutes released after 5 years (very transparent, in the same way a glacier is very fast)
   - Real decisions made at dinner parties
   - You'll never know what they did until it's too late. That's the system working as intended.

## Every War Since 1972: Funded by Destroying Your Savings

Every time your government wants to bomb someone, it doesn't ask you. It just makes your savings worth a little less. You paid for every war. You were never consulted. Here's the receipt:
...
The Fed pays banks interest on money the banks keep parked at the Fed. Read that again slowly. Banks give the Fed money. The Fed gives it back, plus interest. This costs taxpayers {{< var global_pharma_rd_spending_annual >}} per year. For doing absolutely nothing. On most planets, getting paid to do nothing is called "unemployment." On yours, it's called "monetary policy." Same thing, better suits.
...
- Feed every hungry person on Earth (with change left over)
- Instead: banker bonuses. Obviously.
...
1. **Regulatory Capture**
   - Fed officials retire to Wall Street
   - Wall Street executives appointed to Fed board
   - Same people, different chairs, same lunch reservations
   - It's musical chairs, except nobody ever actually loses a chair

2. **Political Capture**
   - Politicians need the Fed to fund deficits
   - The Fed needs politicians for legal protection
   - It's a parasite with two heads, and both heads think they're the host
   - You are the host
...
3. **Systemic Lock-In**
   ...
   - This is called an ouroboros (a snake eating its own tail). Except this snake is eating your tail.

4. **Too Many Depend on the Scam**
   - Banks need free money
   - Government needs war funding
   - Contractors need contracts
   - Everyone important wins (you are not important)

#### The Only Solution: Bypass It Entirely

You cannot fix the Fed. You don't reform cancer. You don't negotiate with a tumor. You route around it.
...
The only solution: change the ratio. Take from war. Give to life.

## The 1% Treaty: Redirecting the Death Printer to Life

Here is the part where I stop cataloguing your failures and offer you something useful. They are already printing trillions for war. The treaty asks them to point 1% of it at healing instead. That is all. One percent. The rest can continue being terrible.
...
- Defeated fascism
- No hyperinflation
- Democracy saved (temporarily, but still)

#### The Difference

- War Bonds funded necessary defense
- VICTORY [Incentive Alignment Bonds](https://iab.warondisease.org) fund pragmatic clinical trials for necessary cures
- War Bonds saved democracy from fascism
- VICTORY [Incentive Alignment Bonds](https://iab.warondisease.org) save humanity from disease

Both use markets instead of money printing. Both align incentives with outcomes. Both actually work. The difference is that one required you to kill people and the other requires you to stop killing them.
...
It is not complicated. They are going to print money anyway. The treaty just asks them to print 1% for life instead of 100% for death. This should not be a controversial proposal. On most planets it would not be.
...
They created the money printer to fund death without asking permission. The treaty uses their own system against them. You are not fighting the dragon. You are asking it to breathe in a slightly different direction. The dragon does not even notice. One percent is a rounding error to a dragon. Dragons cannot count.
...
The Fed is not going away. The treaty is not ending central banking. It is building something better alongside it, the way you build a hospital next to a battlefield.
...
*P.S. The Fed has entered the chat. They want you to know that inflation is "transitory" and war is "necessary for stability." They also want you to know that everything is fine. Please do not read this chapter. Please go back to arguing about immigration. Thank you for your cooperation.*