...
image: /assets/og-images/knowledge/economics/eisenhower-curve-og-bw-academic.png
aliases:
...
scores:
  ...
  voice: 8
  importance: 9
audience: "A general reader who has absorbed the standard \"more military spending equals more strength\" assumption, and the defense hawk worried about China sitting next to them. Anyone who follows national-security debates and assumes the biggest budget wins."
feel: "Unsettled, then armed: the largest military budget in history is the weakness, not the strength, and the math is right there on the page. The China hawk's own goal (winning) now points at cutting the budget, and you can feel the argument land hard enough to repeat."
do: "Forward this to the most budget-hawkish person you know (the relative who says we need to outspend China, a congressional staffer on armed services, a defense reporter) and say \"the big budget is why we're losing\" then vote for the 1% treaty at warondisease.org."
---
{{< include /knowledge/includes/setup-parameters.qmd >}}

The United States is the country with the largest military budget in human history. It is also the country losing strategic ground, year after year, to a country that spends less than half as much on its military. These two facts are the same fact. 
...
- **Economy decreases.** Every dollar going to the military is a dollar not going to civilian production.
- **Pivot Speed decreases.** When the military is the high-status sector, the engineers and managers who would lead a wartime pivot go to the military in peacetime instead. Cost-plus procurement habits destroy the pivot reflex. A workforce that has spent forty years building one F-35 per month does not know how to build one B-24 per hour.
- **Competence decreases.** When the military becomes the prestige sector, talent flows there for status, lobbying access, and clearance value, not for productive competence. Over decades the meritocratic signal weakens. The country that picked Henry Ford in 1942 now picks people who can extract congressional earmarks.

So Wartime Power is a product of one term that grows with military spending and three terms that shrink with it. At low spending, the gain in Readiness wins, and more military spending produces more wartime power. At high spending, the losses in Economy, Pivot Speed, and Competence win, and more military spending produces *less* wartime power.

There is an optimal level of peacetime military spending. Beyond that level, more spending makes the country weaker, not stronger. This is a Laffer curve for military spending.
...
In 1939 the United States spent approximately {{< var us_military_spending_1939_annual_2024usd >}} per year on its military (constant dollars). By 1945 the United States was spending approximately {{< var us_military_spending_1945_peak_annual_2024usd >}} per year. The mobilization scaled military output by roughly **83x in five years**. The country won the war.
...
A country whose military industry has been selected for bribery competence is structurally less capable of winning a real war than a country whose military industry has been selected for production competence. The bribery-competent industry can extract money. It cannot, by the time a war starts, retool quickly enough to build the weapons the war actually needs. The country that wins is the country whose civilian economy still has production-competent firms that can be pivoted in eighteen months, the way Ford was. The country that loses is the country whose entire industrial talent pool has spent forty years optimizing earmark capture in a Crystal City office park.
...
The country is paying more for the military and getting less military capability, because the spending is destroying the underlying productive capacity that the military ultimately depends on.
...
Military needs are mostly **absolute**, not relative to economic size. They are determined by the threats the country faces, the cost of deterring those threats, and the infrastructure required to maintain that deterrent. They are not a function of how good the country's widget factories are. If the American economy doubles in real terms over the next twenty years, the number of nuclear weapons required to deter strategic adversaries does not double. The number was sufficient at the smaller economy and remains sufficient at the larger one. Tying military spending to a percentage of GDP smuggles in a hidden assumption that military spending is a normal good that should rise with prosperity. It is not. It is a threat-response variable whose appropriate level is set by the threats and the deterrence math, not by the size of the civilian economy that funds it.

The "% of GDP" framing also creates a ratchet. NATO's 2% target is the canonical example: it pegs the spending obligation to GDP, which means the obligation rises every year you do better at making widgets, regardless of whether the threats grew. The metric naturalizes growth in military spending without anyone having to justify it.
...
China is not winning strategic competition because it spends more on its military. China is winning because **it is not making the mistake the United States is making**. The Chinese economy compounds; the American economy is partly self-cannibalized by military overspending. Over 20-30 years, this difference becomes decisive. The country that spent less on its military ends up with more total power because the productive base that the military ultimately depends on is larger.
...
If the goal of American military policy is American strategic position, the current allocation is the worst possible allocation: it is the one that maximizes peacetime spending and minimizes the long-run economic base from which that spending is paid.
...
The American trajectory is a slower version of the same curve. The United States is not yet at Soviet-level military burden, but it has been on the same path for eighty years. Each decade the productive economy shrinks slightly relative to the military, the audit failures accumulate, the procurement costs balloon, and the strategic position erodes against rising competitors that have not made the same mistake.

The Soviet Union was the natural experiment. The Soviet Union proved the curve.

## What Optimal Looks Like

The model says the optimum is where additional military spending stops increasing wartime power and starts decreasing it. The honest way to turn that into a dollar figure is from first principles, not by benchmarking to what other countries spend or to last year's budget. List the threats that are both real and not already neutralized by something free. Size the minimum capability to defeat each one. Price it at efficient rates rather than cost-plus. Do that and most of the current budget evaporates, because the threat people fear most, an invasion of the homeland, is the one that costs almost nothing to defend against. Two oceans, weak neighbors, a nuclear deterrent, and the ability to mobilize an industrial economy already drive the probability of a successful invasion to approximately zero. You cannot buy down a risk that is already near zero. So the budget is set by the short list of threats that geography does not cover.

| Threat that actually requires spending | First-principles requirement | Annual cost |
|---|---|---:|
| Strategic nuclear attack | Survivable second strike: ~100-200 warheads on submarines nobody can find | {{< var us_defense_fp_nuclear_deterrent >}} |
| Air and missile attack on the homeland | Continental air defense, missile warning and interception (NORAD) | {{< var us_defense_fp_homeland_air_missile >}} |
| Maritime and coastal threats | Coast Guard | {{< var us_defense_fp_coast_guard >}} |
| Territorial defense and disaster response | National Guard, the citizen-soldier model | {{< var us_defense_fp_national_guard >}} |
| Cyberattack on critical infrastructure | Cyber defense, the one vector oceans do not stop | {{< var us_defense_fp_cyber >}} |
| A peer threat that has not yet emerged | Mobilization hedge: defense R&D, a warm industrial base, a professional cadre | {{< var us_defense_fp_mobilization_hedge >}} |
| **First-principles optimal homeland defense** | | **{{< var us_defense_first_principles_optimal >}}** |

That is the number the threats actually justify: **{{< var us_defense_first_principles_optimal >}}** per year, with an honest range of roughly $130 billion to $260 billion depending on how lean the homeland air and maritime posture is and how large a mobilization hedge you want. The single largest line is the hedge, not a standing army, because the lesson of 1939 is that you win the next real war with the capacity to build a military, not with the one you happened to be storing. The country that ranked 17th in the world, behind Portugal, mobilized and won in four years.

Current US military spending: **{{< var us_military_spending_2024_annual >}}**. The first-principles optimum therefore implies a cut of about **{{< var us_defense_first_principles_cut_pct >}}**. That sounds enormous. It is smaller than the {{< var post_ww2_military_cut_pct >}} the country cut in two years after WW2, after which it produced the largest sustained economic expansion in its history.

### Why the published numbers are higher (the convergence check)

Other honest estimates land above this one, and it is worth being clear about why: they are answering a different question. The restraint school inside the defense establishment (Barry Posen's 37 percent cut, the Cato Institute's 25 percent) trims to roughly $560-675 billion. Peer democracies scaled to US economy size, and China's allocation scaled the same way, land around $450-560 billion. None of these are homeland-defense numbers. Every one of them prices a reduced version of global hegemony: forward bases, allied defense, the ability to project force across two oceans. They are trimming the empire. The first-principles number skips the empire and prices only the defense of the United States, which is why it is lower. Whether the extra few hundred billion buys enough deterrence of other people's wars to be worth it is the question [the cost-benefit ledger of hegemony](../appendix/cost-benefit-of-hegemony.qmd) takes up, and the answer there is no. But even the most generous of these anchors implies a budget far below the current one, which is the only point the Eisenhower Curve needs.

The country that finishes this math is the country that reverts to something like the spending levels that won WW2, won the Cold War, and produced the longest economic expansion in American history. Those are the actually-defensible peacetime military budgets. Everything above them is the Eisenhower Curve in action: spending more, getting less, and watching China win.
