...
This is a **model-based scenario analysis**, not an empirical study. All quantitative estimates are derived from economic modeling with explicit assumptions. Large figures (e.g., billions of lives, quadrillions of dollars) represent **cumulative long-run counterfactual projections** that depend critically on "eventually avoidable" mortality assumptions documented in [Parameters and Calculations](../appendix/parameters-and-calculations.qmd). Interpret as scenario estimates, not predictions.
:::
...
**Cost per DALY (Conditional on Success):**

{{< var treaty_cost_per_daly_trial_capacity_plus_efficacy_lag_latex >}}

**Cost per DALY (Risk-Adjusted):**

{{< var treaty_expected_cost_per_daly_latex >}}

**Direct Funding Cost per DALY:**
...
{{< var peace_dividend_annual_societal_benefit >}} + {{< var dfda_benefit_rd_only_annual >}} saved per year.

{{< var dfda_benefit_rd_only_annual_latex >}}

* **Oxford RECOVERY** proved trials cost **{{< var recovery_trial_cost_reduction_factor >}}× less** by using existing hospital infrastructure instead of dedicated trial sites
* This single trial enrolled [47,000+](../references.qmd#recovery-trial-summary-quote) patients across [nearly 200](../references.qmd#recovery-trial-summary-quote) hospitals, found [dexamethasone (reducing deaths by one-third in ventilated patients)](../references.qmd#recovery-trial-dexamethasone-results), ruled out hydroxychloroquine, and identified effective treatments faster than traditional regulatory processes
...
The proposed system increases research throughput by {{< var dfda_trial_capacity_multiplier >}}× through elimination of infrastructure duplication and cost barriers.
...
**Technical note**: This uses "net present value," which is economist code for "future money is worth less than current money" ({{< var npv_discount_rate_standard >}} discount rate). For detailed analysis: [full NPV methodology here](../appendix/dfda-cost-benefit-analysis.qmd#calculation-framework---npv-methodology).
...
For detailed cost breakdown: [Platform Costs](../appendix/dfda-cost-benefit-analysis.qmd#dfda-framework-costs-rom-estimates-partnership-model).
...
This assumes gradual rollout (0% to 100% adoption over {{< var dfda_npv_adoption_ramp_years >}}). Full breakdown: [dFDA Cost-Benefit Analysis](../appendix/dfda-cost-benefit-analysis.qmd#dfda-framework-costs-rom-estimates-partnership-model).

### Returns

- **Money**: {{< var dfda_npv_net_benefit_rd_only >}} in R&D savings ({{< var npv_time_horizon_years >}})
- **Returns**: {{< var dfda_npv_net_benefit_rd_only >}} ÷ {{< var dfda_npv_total_cost >}} = **{{< var dfda_roi_rd_only >}}** ([full analysis](../appendix/dfda-cost-benefit-analysis.qmd))
...
See [complete analysis](../appendix/dfda-cost-benefit-analysis.qmd) and [detailed comparisons](../appendix/intervention-comparison-table.qmd).
