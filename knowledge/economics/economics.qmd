...
description: Redirecting {{< var treaty_reduction_pct >}} of global military spending ({{< var treaty_annual_funding >}}/year) to pragmatic clinical trials saves {{< var dfda_trial_capacity_plus_efficacy_lag_dalys >}} at {{< var treaty_cost_per_daly_trial_capacity_plus_efficacy_lag >}}/DALY ({{< var treaty_vs_bed_nets_multiplier >}}× better than bed nets) with ROI between {{< var dfda_roi_rd_only >}} and {{< var treaty_roi_trial_capacity_plus_efficacy_lag >}}. Cost-saving intervention comparable to smallpox eradication.
author:
  - name: Mike P. Sinn
    roles:
      - conceptualization
...
Approximately {{< var diseases_without_effective_treatment >}} diseases currently lack effective first treatments, while {{< var drug_disease_combinations_possible >}} plausible drug-disease combinations remain untested (<1% of therapeutic space explored). At the current research pace of {{< var new_disease_first_treatments_per_year >}} new disease treatments per year, systematically exploring this space would take ~{{< var status_quo_queue_clearance_years >}} (effectively never). Redirecting {{< var treaty_reduction_pct >}} of global military spending ({{< var treaty_annual_funding >}}/year) to pragmatic clinical trials scales trial capacity {{< var dfda_trial_capacity_multiplier >}}× (to ~{{< var dfda_first_treatments_per_year >}} diseases/year), reducing exploration time to ~{{< var dfda_queue_clearance_years >}} while eliminating the {{< var efficacy_lag_years >}}-year regulatory delay after safety verification. Combined, these effects advance treatment delivery by an average of {{< var dfda_trial_capacity_plus_efficacy_lag_years >}} ({{< var dfda_trial_capacity_treatment_acceleration_years >}} from discovery acceleration + {{< var efficacy_lag_years >}} from efficacy lag elimination). This one-time timeline shift saves {{< var dfda_trial_capacity_plus_efficacy_lag_lives_saved >}} over the acceleration period, valued at {{< var dfda_trial_capacity_plus_efficacy_lag_economic_value >}}. Under modeled assumptions, the intervention ranks among the most cost-effective health interventions analyzed: {{< var treaty_cost_per_daly_trial_capacity_plus_efficacy_lag >}}/DALY ({{< var treaty_vs_bed_nets_multiplier >}}× better than malaria bed nets) with ROI between {{< var dfda_roi_rd_only >}} (conservative, R&D savings only) and {{< var treaty_roi_trial_capacity_plus_efficacy_lag >}} (complete health benefits estimate). This qualifies as cost-saving: it reduces costs while improving outcomes.
...
$$
\text{Expected Leverage} = \frac{\$0.50/\text{DALY}}{\$3/\text{DALY}} \approx 5.4\times
$$

Even accounting for political risk, the treaty campaign remains 5× more cost-effective than direct funding. The treaty approach:
