...
| **Discovery Acceleration** | {{< var dfda_trial_capacity_cure_acceleration_years >}} average | From {{< var dfda_trial_capacity_multiplier >}}× trial capacity enabling parallel therapeutic space exploration |
| **Total Timeline Shift** | {{< var dfda_trial_capacity_plus_efficacy_lag_years >}} | Discovery acceleration ({{< var dfda_trial_capacity_cure_acceleration_years >}} yrs) + efficacy lag ({{< var efficacy_lag_years >}} yrs) |
...
Under the status quo, {{< var diseases_without_effective_treatment >}} diseases lack treatment. At {{< var new_disease_first_treatments_per_year >}} new treatments/year, the average disease waits {{< var status_quo_avg_years_to_cure >}} for a treatment. With dFDA's {{< var dfda_trial_capacity_multiplier >}}× trial capacity increase, treatments arrive **{{< var dfda_trial_capacity_cure_acceleration_years >}} earlier**.

{{< var dfda_trial_capacity_cure_acceleration_years_latex >}}

**Total Timeline Shift**: Combining treatment acceleration ({{< var dfda_trial_capacity_cure_acceleration_years >}}) with efficacy lag elimination ({{< var efficacy_lag_years >}}) yields a **{{< var dfda_trial_capacity_plus_efficacy_lag_years >}}-year total timeline shift** in when patients receive effective treatments.
...
- **Treatment acceleration ({{< var dfda_trial_capacity_cure_acceleration_years >}} on average)**: With {{< var dfda_trial_capacity_multiplier >}}× trial capacity, the average disease receives first effective treatment ~{{< var dfda_trial_capacity_cure_acceleration_years >}} earlier
...
**Note**: This NPV calculation covers only the efficacy lag component ({{< var efficacy_lag_years >}}). The cure acceleration component (~{{< var dfda_trial_capacity_cure_acceleration_years >}} on average) would add substantially more value, but is harder to model with NPV due to uncertainty in when each disease would be cured.
...
- **{{< var status_quo_avg_years_to_cure >}}** average wait for a randomly selected disease to receive its first treatment
...
- Average disease receives first treatment **{{< var dfda_trial_capacity_cure_acceleration_years >}} earlier**
