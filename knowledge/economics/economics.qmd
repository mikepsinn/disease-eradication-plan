...
The Oxford RECOVERY trial demonstrated an alternative: leverage existing hospital infrastructure, collect only incremental data beyond standard medical records, and integrate evidence generation into routine clinical care. Cost: {{< var recovery_trial_cost_per_patient >}} {{< var recovery_trial_cost_per_patient_cite >}} per patient. (Note: RECOVERY benefited from NHS/COVID conditions; typical pragmatic trials like ADAPTABLE cost {{< var adaptable_trial_cost_per_patient >}}/patient, and our dFDA projections use {{< var dfda_pragmatic_trial_cost_per_patient >}}/patient.) Same quality evidence. {{< var recovery_trial_cost_reduction_factor >}} lower cost.
