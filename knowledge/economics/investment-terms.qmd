...
The names matter because your investors will try to put the whole thing in one familiar box and then become confused when the box catches fire. Earth Optimization Services is the company. [Optimitron](../solution/optimocracy.qmd) is the product. [Wishocracy](../solution/wishocracy.qmd) is the vote. Money buys a return. It does not buy extra votes, board control over EOS, or a private steering wheel for Earth. The steering wheel is shared, which is the first design improvement.
