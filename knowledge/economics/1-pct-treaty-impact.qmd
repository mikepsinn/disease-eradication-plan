...
Military lobbyists currently get $1,813 back for every $1 spent [@lobbying-roi-calc] on political influence. The system offers VICTORY [Incentive Alignment Bond](../appendix/incentive-alignment-bonds-paper.qmd) holders **~{{< var victory_bond_annual_return_pct >}} annual returns** in perpetuity (allocating {{< var victory_bond_funding_pct >}} of the {{< var treaty_annual_funding >}} annual inflows to bond payouts).
