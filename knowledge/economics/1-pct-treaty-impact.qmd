...
![Comparison of treatment discovery throughput: The status quo acts as a bottleneck taking centuries to clear the disease queue, while the expanded capacity clears the backlog in decades.](/assets/images/1-pct-treaty-impact/1-pct-treaty-impact-section-timeline-shift-queue-model-bw-academic.png)
...
![Cost-effectiveness comparison showing 1% Treaty at $0.0018/DALY vs bed nets at $89/DALY - the treaty is 50,300 times more cost-effective](/assets/images/1-pct-treaty-impact/cost-effectiveness-comparison-of-global-health-interventions-chart.png)
...
![Safety timeline comparison: Traditional voluntary reporting delays adverse event detection by years (e.g., Vioxx), whereas automated EHR surveillance identifies safety signals in months.](/assets/images/1-pct-treaty-impact/1-pct-treaty-impact-section-safety-timeline-comparison-bw-academic.png)
...
![Economic multiplier analysis: Redirecting capital from low-multiplier military spending to high-multiplier health research generates net economic growth even before accounting for health benefits.](/assets/images/1-pct-treaty-impact/1-pct-treaty-impact-section-economic-multiplier-flow-bw-academic.png)
