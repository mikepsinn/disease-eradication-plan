...
- **Internet clicking ceremony** - Get 280M humans to click "yes I would prefer not to die" ({{< var treaty_campaign_budget_viral_referendum >}})
- **Professional briber conversion** - Show lobbyists that curing is more profitable than killing ({{< var treaty_campaign_budget_technology >}})
...
**Phase 1 milestone ({{< var treaty_campaign_budget_viral_referendum >}} release)**:
