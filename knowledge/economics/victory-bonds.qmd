...
- Institutional investors ({{< var value_of_statistical_life >}}+ each) - pension funds, endowments, people managing other people's papers
- Family offices ({{< var dfda_opex_regulatory >}}+ each) - rich families who hired someone to watch their paper piles
...
| Very skeptical (10% discount) | {{< var treaty_annual_funding >}} | 27x your money |
...
| 10+  | 10%+     | $270B+         | {{< var treaty_annual_funding >}}+             | {{< var global_annual_conflict_deaths_state_violence >}}%+      |
...
|------------|---------------|------------|------|------|
| **VICTORY Social Impact Bonds** | **271.8%** | **High** | **Forever** | **Requires politicians to not be stupid** |
...
```{python}
#| fig-alt: "Flowchart showing: Investors Give {{< var treaty_campaign_total_cost >}} → 1% Treaty Passes → Bondholders Get Returns + DIH Spends on Cures → Diseases Fall → Media Frenzy → Public Demands More → 2% Treaty → Higher Returns → Cycle Continues"
import graphviz
...
dot.node('Invest', 'Investors Give {{< var treaty_campaign_total_cost >}}')
dot.node('Treaty1', '1% Treaty Passes\n{{< var treaty_annual_funding >}}/year')
dot.node('Payout1', 'Bondholders Get {{< var victory_bond_annual_payout >}}/year\n(270% returns)')
...
- **Institutional investors**: {{< var value_of_statistical_life >}}+ per investor
- **Family offices**: {{< var dfda_opex_regulatory >}}+ per office
...
"Charities give you 0% returns and a tax deduction. VICTORY Social Impact Bonds give you 271.8% returns and generational wealth.
