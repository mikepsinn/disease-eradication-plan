...
::: {.callout-note}
## How This Relates to Incentive Alignment Bonds

VICTORY Bonds are the **investor-facing** half of our incentive system. They solve the capital problem: "How do we raise $1B to fund the campaign?"

[Incentive Alignment Bonds](../solution/incentive-alignment-bonds.qmd) are the **politician-facing** half. They solve the political problem: "How do we make politicians actually support and maintain the treaty?"

The {{< var treaty_annual_funding >}} annual treaty revenue is split three ways:

| Allocation | Share | Annual Amount |
|------------|-------|---------------|
| VICTORY Bond investors | {{< var victory_bond_funding_pct >}} | {{< var victory_bond_annual_payout >}} |
| [IAB political incentives](../solution/incentive-alignment-bonds.qmd) | {{< var iab_political_incentive_funding_pct >}} | {{< var iab_political_incentive_funding_annual >}} |
| DIH medical research | {{< var dih_treasury_medical_research_pct >}} | {{< var dih_treasury_to_medical_research_annual >}} |

VICTORY Bonds pay investors. IABs fund political incentives. The rest cures diseases. Everyone's self-interest aligns with not dying.
:::
...
- {{< var treaty_annual_funding >}} annually stops going to bombs and starts going to DIH treasury (automatic, no takebacks)
