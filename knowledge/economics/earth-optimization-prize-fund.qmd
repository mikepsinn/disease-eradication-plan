...
description: This paper explains how the shared PRIZE pool could compound while humanity tries to raise healthy life years and median income by {{< var destructive_economy_50pct_year >}}. It is a scale-capital thesis, not the first institutional ask.
published: true
tags:
  - economics
  - investment
...
Current global VC deployment is roughly $300 billion per year. If a meaningful share of {{< var global_retirement_assets >}} flows through the Prize Fund, deployment rises to roughly $4.7 trillion per year. That is a 15x expansion of the venture market.
...
Conventional retirement earns {{< var conventional_retirement_return >}} after fees. The Prize Fund models {{< var prize_pool_annual_return >}}.
...
|:---|:---|:---|:---|:---|
| **PRIZE deposit** | Pool goes to VOTE holders (your deposit is gone) | Pro-rata share of realized pool ({{< var prize_pool_horizon_multiple >}}) | No (success branch violates fiduciary duty) | Depositors who understand the conditional structure and want the coordination upside |
| **[IAB](../solution/incentive-alignment-bonds.qmd)** | {{< var victory_bond_annual_return_pct >}} perpetual revenue share | Money was spent on the campaign (principal at risk) | Yes (standard securities, Reg D/CF/A+) | Investors who want returns tied to treaty passage |
| **Conventional retirement** | {{< var conventional_retirement_horizon_multiple >}} after 15 years | Same (market risk only) | Yes (that's what it is) | People who want predictable market exposure |

**The retirement-compatible instrument is the IAB, not PRIZE.** [Incentive Alignment Bonds](../solution/incentive-alignment-bonds.qmd) [@iab-paper-2025] are straightforward revenue-share securities. An investor buys a bond, the money funds the campaign, and if the treaty passes, the investor receives a perpetual revenue share from treaty funding flows. This is a standard security with a clear risk/return profile. It can be offered under Reg D (accredited investors), Reg CF ($5M/year to anyone), or Reg A+ ($75M/year with SEC qualification). A 401(k) plan administrator can evaluate it like any other fixed-income-adjacent security.
