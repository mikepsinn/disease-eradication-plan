...
tags:
  ...
  - transcript
  - appendix
image: /assets/og-images/knowledge/economics/eos-pitch-og-bw-academic.jpg
scores:
  quality: 7
  value: 8
  timeliness: 7
...
> So there's an important lesson here. A lot of people attribute this problem to selfishness and greed, like the diffuse costs of everybody being retarded and the global economy losing tens or hundreds of trillions of dollars in potential GDP from everyone not being so retarded. If you do the math, even the shareholders of Ethyl Gasoline Corporation would have been {{< var ethyl_shareholder_counterfactual_wealth_gain >}} richer if they had used that money spent on making everyone retarded and manipulating the government to allow them to continue making everyone retarded, instead of on things that are useful to society such as biomedical research. In the long run, they had to do this transition anyway, and in the long run even they themselves would have been vastly richer for not doing this. But for the fact that people assumed that the people in charge were not retarded.
...
## 0.02% of Shares, 3 Board Seats at Exxon
```
 0.02% of Shares, 3 BOARD SEATS AT EXXON
  ...
  The stock went up.
```
> In 2021, Engine No. 1 won three board seats at ExxonMobil with 0.02% of its shares and redirected a $400 billion oil company toward carbon capture and lower-carbon energy. Vanguard and BlackRock, who hold roughly 60% of ExxonMobil, looked at the data and voted with them.
...
FOUR EARTHS, TWENTY YEARS
                                          ...
                                          optimal governance
                                        /   {{< var wishonia_trajectory_gdp_year_20 >}}
                                      /
                            treaty  /
                          /           {{< var treaty_trajectory_gdp_year_20 >}}
  today ---..........                 {{< var current_trajectory_gdp_year_20 >}}
  {{< var global_gdp_2025 >}}   fantasy 2.5%
               \
                 \  collapse            by {{< var destructive_economy_35pct_year >}}
                   \
...
>
> The gray dotted line is what your economists project. 2.5% growth, smooth and steady, reaching {{< var current_trajectory_gdp_year_20 >}} by year 20. This requires twenty consecutive years of nothing going wrong. Your species has never done this. Not once. It is the fantasy.
>
> The red line going down is what is actually happening. Your [destructive economy](gdp-trajectories.qmd) [@gdp-trajectories-paper-2025], military spending plus cybercrime, is already {{< var global_destructive_economy_pct_gdp >}} of GDP and growing faster than your productive economy. Every collapsed civilization in history, Soviet Union, Venezuela, Zimbabwe, Somalia, crossed the same threshold. The death spiral starts at 35% extractive burden. You hit that by {{< var destructive_economy_35pct_year >}}. That is not a prediction. That is the current trend line, extended, using the growth rates you already measured last year. The line goes to zero because that is what happens when stealing pays better than building: everyone rational switches to stealing, and then there is nothing left to steal.
>
> The blue line going up is the treaty. Redirect 1% of the weapons budget to clinical trials. It compounds at {{< var treaty_trajectory_cagr_year_20 >}} and reaches {{< var treaty_trajectory_gdp_year_20 >}} by year 20. The average person ends up {{< var treaty_vs_current_median_income_multiplier_year_20_nounit >}}x richer than on the fantasy baseline, and infinitely richer than on the collapse line, because infinity times zero is still zero and alive beats dead in most financial models.
>
> The gold line is what happens if you fix governance entirely. Full optimization. That one reaches {{< var wishonia_trajectory_gdp_year_20 >}}, which is {{< var wishonia_trajectory_vs_treaty_trajectory_gdp_multiplier_year_20 >}} the treaty line. "Stop being stupid" turns out to be the most aggressive growth strategy available to your species.
>
...
| Engine No. 1: 0.02% of shares, 3 board seats at \$400B ExxonMobil | Historical record | [Wall Street Journal, May 2021](https://www.wsj.com/articles/exxon-loses-board-seats-to-activist-hedge-fund-engine-no-1-11621368052) |
