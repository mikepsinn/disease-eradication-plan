...
> Nobody has to lose. Go down the list. The weapons companies keep ninety-nine percent of their budget, and their stock goes up, because a bigger economy buys more of everything, theirs included. Their shareholders get richer. Their own employees stop dying of the diseases nobody is funding. Patients get cured. Taxpayers stop paying for the hundredth apocalypse. Even the politicians who take the lobbying money get offered a better deal, because lobbying for policies that work pays more than lobbying for policies that don't. The only person who loses is the one who is handed a raise and says no.
...
THE LEGAL MECHANISM
  ...
  {{< var political_dysfunction_global_opportunity_cost_total >}} a year that could be curing it.

  Sitting on the waste is the breach. A legal argument, not a moral
  one, which is the only kind a board is contractually allowed to hear.
```
...
>
> What's it worth under a government better than this one? That gap is {{< var political_dysfunction_global_opportunity_cost_total >}} a year. That is the bill for running the policies in place instead of the ones that work.
>
...
MONEY DOESN'T BUY VOTES
  ...
  So here the civic votes are not for sale.
  One per human.
  Your money buys a share of the profit,
  not extra votes or control of EOS.
```
...
>
> So that is why I am here telling you to buy shares in defense companies and send love letters to their boards. It is not because I woke up one morning and thought "you know what sounds fun, hostile takeovers." It is because I followed the problem from my own sick body to a testing platform to a regulatory system to a resource allocation failure to the lobbying machine that maintains the failure, and the lobbying machine has a price tag, and the price tag is surprisingly small.
>
