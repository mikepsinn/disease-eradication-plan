...
![](/assets/infographics/knowledge/economics/campaign-budget-infographic-retro-academic.jpg)

> **Related:** [Financial Plan Overview](financial-plan.qmd) | [Fundraising Strategy](../appendix/fundraising-strategy.qmd)
...
**Funding structure**: 100% VICTORY [Incentive Alignment Bonds](https://iab.warondisease.org) (~$1B). Donations are optional/bonus. See [Fundraising Strategy: Capital Structure](../appendix/fundraising-strategy.qmd#capital-structure-campaign-vs-implementation) for detailed breakdown.
...
![A side-by-side cost comparison between traditional lobbying methods and the proposed AI-assisted model, highlighting the 80\% reduction in total expenditure.](/assets/images/campaign-budget/campaign-budget-section-why-var-treaty-campaign-total-cost-instead-of-5b-ai-assisted-lobbying-250m-25-bw-academic.jpg)
...
![A comparison of the $1 billion target budget against historical diplomatic costs, such as the Ottawa Treaty ($15M) and the Nuclear Ban Treaty ($10M), illustrating the massive scale difference.](/assets/images/campaign-budget/campaign-budget-section-the-minimum-viable-budget-bw-academic.jpg)
...
![A cost-efficiency breakdown comparing the $0.50 blended cost of digital verified voting against the $14.87 traditional petition average, alongside a component chart of referral, verification, and overhead expenses.](/assets/images/campaign-budget/campaign-budget-section-paying-humans-to-click-bw-academic.jpg)
...
**Target: {{< var treaty_campaign_voting_bloc_target >}} verified votes** ({{< var global_population_activism_threshold_pct >}} of global population = tipping point for social change)
...
![A breakdown of the project budget allocations for technology, marketing, and community organizing, alongside the tiered referral reward structure ranging from $0.10 to $0.50 per vote.](/assets/images/campaign-budget/campaign-budget-section-payment-structure-bw-academic.jpg)
...
**The Challenge**: Not all voters cost the same. Early adopters (believers, idealists) vote for minimal incentive. But to hit {{< var treaty_campaign_voting_bloc_target >}} votes ({{< var global_population_activism_threshold_pct >}} of global population), you need skeptics and the actively resistant.

![A visualization of the tiered cost-per-vote based on the Diffusion of Innovations curve, compared against the significantly higher costs of traditional petition gathering and digital advertising.](/assets/images/campaign-budget/campaign-budget-section-budget-viral-referendum-with-tiered-incentives-base-case-scenario-bw-academic.jpg)
...
- Traditional petition gathering: {{< var treaty_campaign_voting_bloc_target >}} $14.87 = $4.2B
- Digital advertising: {{< var treaty_campaign_voting_bloc_target >}} $10 avg = $2.8B
...
![A breakdown of the professional lobbying budget and process, illustrating the distribution of funds across regional targets, defense industry co-option, and AI-driven political influence strategies.](/assets/images/campaign-budget/campaign-budget-section-professional-legal-bribery-part-of-var-treaty-campaign-budget-lobbying-lobbying-budget-bw-academic.jpg)
...
![Breakdown of the $250M technology budget across the dFDA framework, Wishocracy platform, pilot programs, and cloud infrastructure.](/assets/images/campaign-budget/campaign-budget-section-technology-part-of-var-treaty-campaign-viral-referendum-base-case-referendum-budget-bw-academic.jpg)
...
![A breakdown of the $100 million AI-assisted legal budget across three categories, displaying the allocated amounts and their respective 95\% confidence intervals.](/assets/images/campaign-budget/campaign-budget-section-lawyers-ai-assisted-part-of-var-treaty-campaign-budget-lobbying-lobbying-budget-bw-academic.jpg)
...
![A horizontal bar chart showing the allocation of funds across defense, healthcare, tech, and endorsements, including the 95\% confidence intervals for each budget category.](/assets/images/campaign-budget/campaign-budget-section-co-opting-the-opposition-part-of-var-treaty-campaign-budget-lobbying-lobbying-budget-bw-academic.jpg)
...
![A comparison of operational budget allocations for Core Team, Infrastructure, and Contingency funds, showing both the baseline estimates and their respective confidence intervals.](/assets/images/campaign-budget/campaign-budget-section-operations-overhead-across-all-categories-bw-academic.jpg)
...
![A financial breakdown of the $100M post-victory transition budget, illustrating the primary allocations for treaty implementation and scaling preparation with their respective confidence intervals.](/assets/images/campaign-budget/campaign-budget-section-post-victory-transition-var-treaty-campaign-budget-reserve-bw-academic.jpg)
...
![A five-year project timeline visualizing the rapid scaling of budget, voter participation, and treaty adoption from the proof-of-concept phase to global implementation.](/assets/images/campaign-budget/campaign-budget-section-timeline-bw-academic.jpg)
...
- {{< var treaty_campaign_voting_bloc_target >}} total votes
...
![A comparison of AI-driven campaign ROI versus traditional advertising costs, alongside a stakeholder map showing how the incentive structure benefits lobbyists, industry, and the public.](/assets/images/campaign-budget/campaign-budget-section-why-this-works-bw-academic.jpg)

## Returns

![A visualization comparing a $1 investment against the massive scale of $27.2 billion in annual revenue and the 84.8 million-to-one societal value ratio.](/assets/images/campaign-budget/campaign-budget-section-returns-bw-academic.jpg)

**Per $1 invested**:

- {{< var treaty_annual_funding >}} annual treaty revenue (forever)
- {{< var treaty_roi_trial_capacity_plus_efficacy_lag >}} total societal value (lives saved, wealth created, suffering reduced)
...
![A transparency architecture diagram showing how blockchain data, multi-sig treasury movements, and independent audits converge into a public live dashboard for community oversight.](/assets/images/campaign-budget/campaign-budget-section-transparency-bw-academic.jpg)
...
{{< var treaty_campaign_total_cost >}} redirects {{< var treaty_annual_funding >}} annually from the explosion budget to the not-dying budget.

That's a 27:1 return just in redirected military spending.

But the real return:

- Bondholders: {{< var victory_bond_annual_payout >}}/year forever ({{< var victory_bond_annual_return_pct >}} annually)
- Society: {{< var treaty_roi_trial_capacity_plus_efficacy_lag >}} per dollar (cures, wealth, fewer dead people)
