...
**Funding structure**: 100% VICTORY Incentive Alignment Bonds (~$1B). Donations are optional/bonus. See [Fundraising Strategy: Capital Structure](../appendix/fundraising-strategy.qmd#capital-structure-campaign-vs-implementation) for detailed breakdown.
...
- VICTORY Incentive Alignment Bonds for key players ({{< var victory_bond_annual_return_pct >}} beats their current profits)
