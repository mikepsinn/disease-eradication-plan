...
- AI lawyers + human review: {{< var lobbyist_bond_investment_max_millions >}}M (robots draft, humans fix the stupid parts)
- AI-coded platforms: {{< var treaty_campaign_budget_partnerships >}} (GitHub but with more begging)
- Viral bribes: {{< var treaty_campaign_budget_partnerships >}} (humans recruit humans for pocket change)
- Strategic lobbying: {{< var treaty_campaign_budget_technology >}} (bribe only the humans who matter)
...
**The Clicking Platform**: {{< var treaty_campaign_budget_reserve >}}
...
**Viral Content**: {{< var sensitivity_dfda_opex_optimistic >}}
...
- Focus: US ({{< var dfda_upfront_build >}}), EU ({{< var treaty_campaign_budget_reserve >}}), G20 ({{< var sensitivity_dfda_opex_conservative >}})
- AI writes the laws, lawyers make them legal-sounding

**Buying Defense Lobbyists**: {{< var treaty_campaign_budget_reserve >}}
...
**Super PAC Papers**: {{< var sensitivity_dfda_opex_optimistic >}}
...
**Opposition Research**: {{< var lobbyist_bond_investment_max_millions >}}M
...
**dFDA Cloud Infrastructure**: {{< var dfda_upfront_build >}}
...
**Legal Work**: {{< var treaty_campaign_budget_reserve >}}
...
**Legal Defense**: {{< var lobbyist_bond_investment_max_millions >}}M
...
**Defense Industry Conversion**: {{< var dfda_upfront_build >}}
...
**Tech Partnerships**: {{< var lobbyist_bond_investment_max_millions >}}M
...
**Celebrity Endorsements**: {{< var value_of_statistical_life >}}
...
**Treaty Implementation**: {{< var sensitivity_dfda_opex_optimistic >}}
...
**Year 1** ({{< var treaty_campaign_budget_viral_referendum >}}): Proof it works
