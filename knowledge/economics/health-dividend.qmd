...
It saves {{< var dfda_gross_savings_annual >}}/year in clinical trial waste.
That's {{< var roi_dfda_savings_only >}}:1 returns.
...
The {{< var roi_dfda_savings_only >}}:1 ROI is the central estimate based on NPV analysis over 10 years. Even in worst-case scenarios (higher costs, lower adoption), the ROI remains exceptional at 66:1.
