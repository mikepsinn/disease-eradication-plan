...
image: /assets/og-images/knowledge/economics/earth-optimization-fund-og-bw-academic.jpg
published: true
tags:
  - investment
  - eos
...
audience: "A would-be investor (accredited) deciding whether to put money into EOS equity."
feel: "This is a real, asset-backed bet with a capped downside, not a pitch or a scam, and the early dollar buys cheap odds."
do: "Run the bid calculator with your own numbers, then ask for the PPM to invest."
---
...
[Optimitron](../solution/optimocracy.qmd) checks which policies work. [Wishocracy](../solution/wishocracy.qmd) [@wishocracy-paper-2025] asks humans what they want without handing them a 4,000-page budget and a sedative. Money buys a return. It does not buy extra civic votes, board control over EOS, or a private steering wheel for Earth. The plan locks the steering wheel to the mission instead of selling it to the highest bidder. That is the first design improvement. (The charter now entrenches it; the steward that holds the wheel for humanity is built after the first close.)
...
| The Uniform | T-shirts that say "this t-shirt ended war and disease" | Sales + the free permanent-marker version |
...
| [Optimitron](../solution/optimocracy.qmd) | Activist campaign infrastructure | Consulting triggered by love letters; board-seat compensation |
...
EOS buys shares in companies whose lobbying shapes government policy, starting with military contractors because the [1% Treaty](../solution/1-percent-treaty.qmd) [@1-percent-treaty-paper-2025] [@1-pct-treaty-impact-paper-2025] has the cleanest math there. It uses ordinary shareholder tools: voting, love letters, proxy proposals, proxy contests, board campaigns, and public analysis. This is the investable version of the [Loving Takeover](../appendix/loving-takeover.qmd). The side quest is buying your own share and filing your own letter. The main money machine is the holding company that owns the campaign.

The long-term goal is to buy enough influence over the companies that already buy policy, then hand the policy agenda back to humanity through [Wishocracy](../solution/wishocracy.qmd) [@wishocracy-paper-2025].

## The Boring Legal Ladder

Your laws make this happen in stages, because buying shares in missile companies requires a puzzle room.
...
1. **Private holding company (now).** EOS itself is the vehicle, a Delaware C-corp. Investors buy non-voting EOS equity directly under Reg D Rule 506(c) (verified accredited investors only; public solicitation permitted). Class A voting control is a temporary proof-phase bridge, reserved for the mission-lock transition, not a permanent insider stake; investor protective rights belong in the final offering documents, not in the pitch. No separate fund. EOS owns the activist positions on its own balance sheet and operates real businesses, exactly as Berkshire Hathaway does. The binding offering documents stay outside the book.
...
3. **Mission-lock holder (designed after first close; active before or concurrent with public listing).** A steward entity (a Delaware purpose trust, a foundation, or equivalent, chosen with counsel) takes custody of EOS's voting shares on behalf of humanity, bound by its governing terms to vote in alignment with Wishocracy outputs. It is what prevents a future acquirer from capturing EOS and reversing the mission at the moment it has actually succeeded.

A token is not the product. It may someday be plumbing for transfer, custody, or reporting. If anyone ever pitches you the plumbing as the story, that is your cue to leave the room.
...
| Term | Value | Why |
|------|-------|-----|
| First EOS equity raise target | $500K minimum viable first close, $1M preferred initial target, with room up to $2M if demand justifies it | $500K buys proof/survival runway. $1M buys roughly 18-24 months of lean runway plus first campaign proof. $2M buys reserve, cleaner compliance, and stronger campaign proof. It is not enough money to build a bureaucracy, which on your planet is the rarest feature a pile of money can have. |
...
| Operator control | No investor-bought EOS control | Operators run EOS. Investors get economic exposure and protective rights if the final documents provide them, not operating control or extra civic votes. |
...
The cap table principle in one breath: money can buy exposure to EOS. Money cannot buy the human vote, Wishocracy allocation power, nonprofit control, PAC control, or personal influence over politicians. Every dual-class company you have heard of runs the split so insiders keep the votes permanently. This one uses Class A control only as a temporary bridge, so the votes route to the mission-lock holder instead of being kept or sold.
...
But the leakage is not wasted from an investor's point of view. A diversified investor already owns a slice of the economy EOS is trying to repair. If EOS makes the economy larger, healthier, and less stupid, the "uncaptured" surplus still shows up in the investor's other assets. The EOS share is the lever. The balance sheet is the larger bet.

EOS can also capture more than the ordinary innovator benchmark because the thesis is tradable before it is obvious. EOS can buy the constrained assets first. If copycat funds arrive later and buy the same military, pharma, finance, and energy shares, that demand validates the thesis and reprices assets EOS already owns. Normal competitors take margin. Early EOS competitors are funds that turn up later, buy the same shares, and accidentally raise the price of the things EOS already owns. They are less rivals than unpaid marketing.

At the base case: {{< var political_dysfunction_global_opportunity_cost_total >}}/yr dysfunction tax × {{< var eos_social_value_capture_pct >}} capture × perpetuity at {{< var npv_discount_rate_standard >}} discount rate ≈ **{{< var eos_equity_value_v >}}**. Expand the tree below to adjust any assumption.
...
The auction sets the price, within the bounds the formula above makes explicit. The clearing bid is the price; you can recompute it from the table yourself.

::: {.callout-warning}
## Illustrative, not promised, and you can lose everything

The multiples and valuations in this section are modeled illustrations of how price *could* move with campaign results. They are not projections, targets, or expected payouts. EOS equity is a private, illiquid, high-risk security and you could lose your entire investment. There is also a live Investment Company Act question: EOS must qualify as an operating company rather than an inadvertent investment company, and if that analysis fails the structure and your investment are at risk. The binding terms and the full risk factors live only in the PPM, which is not part of this book.
:::
...
|---|---|---|---|
| $0 | One legal letter the board must read, no follow-through | ~0.01% | 1× |
...
**Why early money makes the most if it works.** The early dollar funds the first campaign when P is lowest, so each win moves the price most. It is also the social proof later dollars wait for. You buy probability while it is cheap; the buying is part of what makes it expensive.
...
eosBidModel = {
  ...
  const stageValues = {
    stage1: paramData["EOS_STAGE_1_HII_TERMINAL_VALUE"].value,
    stage2: paramData["EOS_STAGE_2_DEFENSE_PRIMES_TERMINAL_VALUE"].value,
    stage3: paramData["EOS_STAGE_3_LOBBYING_SECTORS_TERMINAL_VALUE"].value,
    full: fullValue
  };
  const scenarios = [
    ...
    {name: "Stage 2: big military contractors", p: terminalStage2, value: stageValues.stage2, payout: afterDilutionOwnership * stageValues.stage2},
...
**The asset is real and you can audit it.** EOS holds publicly traded portfolio companies. Every payout traces to those assets, to revenue, or to disclosed equity rights. The share price can rise as more people buy, but later buyers raise the market price; they are not the source of the asset. Pull up the holdings any day and add them yourself.
...
**EOS corporate voting shares** (who controls EOS the company), held under a temporary Class A voting structure during the proof phase, later by a mission-lock holder (a purpose trust, foundation, or equivalent steward entity). Investors buying EOS equity receive *non-voting* economic shares. Money buys returns and any negotiated protective rights, never operating control of EOS.
...
The long-term goal: first close funds the mission-lock design; a mission-lock holder later holds or controls EOS voting shares and is bound to vote in alignment with Wishocracy outputs; EOS goes public; anyone on Earth can own common shares; distributed economic ownership scales. The civic vote remains one per human regardless.
:::
...
The last line is not priced into the return.

## The cascade: how $5,000 becomes {{< var defense_takeover_cost_total >}}

The diagram above assumes somebody buys everything at once. Nobody has {{< var defense_takeover_cost_total >}} lying around, and the few who do did not get it by buying missile companies outright.
...
| Method | Cost (all major Western military contractors) | Feasibility |
|--------|-------------------:|-------------|
| Buy 50%+1 of shares | {{< var defense_takeover_cost_total >}} (with acquisition premium) | Impossible without being a nation-state |
| Activist positions (1-5%) | ~$10-48 billion | Hard but demonstrated (Icahn, Ackman, Peltz) |
| Governance pressure + institutional votes | $75-200 million | Possible |

The third method works because institutional investors hold 70-85% of military contractor shares, with the three big index-fund managers (Vanguard, BlackRock, State Street) holding roughly 20-30% among them. They do not need to be bought. They need to be presented with an economically rational shareholder vote to seat a director. ISS and Glass Lewis evaluate every one. "Your lobbying has negative ROI for your own shareholders" is economically rational. Engine No. 1 proved this at Exxon.
...
The whole cascade starts with one legal letter, filed by one shareholder, who paid $200 for one share, which the board is then legally obliged to read whether it wants to or not.
...
**1. It is the only investment that increases the value of everything else you own.** The political dysfunction tax is not a tax on one sector. It is a drag on the entire economy. Eliminating it does not reprice one stock; it reprices all of them. If you own index funds, bonds, real estate, or a business, their value is being suppressed by misallocated policy. EOS correcting that suppression makes your other holdings worth more at the same time it makes itself worth more.
**2. Copycats can be validation before they are competition.** EOS's first competitor is waste, and waste does not fight for market share, hire lawyers, or show up to the board meeting. It just sits there being wasteful. A fund copying the thesis files the same love letters and publishes the same analyses, which only reprices the assets EOS already owns. They are less rivals than unpaid marketing. Copies compete for fees only after the market has already begun pricing the end of waste, and the scarce thing is owning the thesis before that happens.
...
**4. The amount of policy at stake per dollar invested is exceptional.** Governments collectively spend roughly {{< var global_military_spending_annual_2024 >}} per year on the military. Military contractors collectively influence a meaningful fraction of how that is allocated. The capital required to gain activist influence at the board level across the major military contractors is a small fraction of one year's military budget. Spend that fraction once; redirect the influence on {{< var global_military_spending_annual_2024 >}} per year, compounding, forever.
These four properties only hold if the governance campaigns work. Engine No. 1 proved the mechanism at ExxonMobil; it has not been applied at scale to the military-industrial complex. The downside if it fails is a concentrated activist portfolio, not a catastrophe. But the upside if it works is larger than any other position you could take with the same capital.

## What each stage is worth (before it happens)

On my planet, valuation is simple. You look at what a thing does, estimate how much waste it eliminates, and that is what it is worth. Your planet has a more complicated method involving comparable transactions, revenue multiples, and people in suits arguing about discount rates.
...
**Layer 1: Operating budget.** EOS is a holding company, not a fund. There is no management fee, no carry, no advisory fee. The operator is paid a salary as an ordinary operating expense. EOS still has real costs: legal, audit, custody, brokerage, filing, insurance, compliance, and one developer. These should be disclosed, capped, and kept too small to become the product.
...
That letter and the consulting pipeline are the same object. Each letter in the cascade creates a potential client. Across military contracting, pharma, and finance at scale, this is $10-50 million per year.
...
**Layer 4: Campaign infrastructure.** Optimitron is not a subscription data product. AI will turn lobbying-ROI analysis on public data into a free commodity faster than anyone could finish building a business around charging for it. The real asset is the infrastructure for running activist campaigns at scale: legal standing as a named shareholder of record, process infrastructure for filing proxy proposals and coordinating with ISS and Glass Lewis, and a track record of campaign outcomes that no AI can generate without first running the campaigns. The value is the legal position and the credibility it buys, not the algorithm behind it.

**Layer 5: Brand.** The book you are reading. The [educational film](../educational-film.qmd). The shirts. None of this is large revenue. It is marketing that, unusually, pays for itself instead of asking you to.
...
There are two money boxes. Pour the wrong thing into the wrong box and you have invented a brand new way to be confused about your own investment.
...
eosCalc = {
  ...
  return {amount, years, prob, mult, sp, netWorth, takeover, success, fail, ev,
          ...
          controlRatio: systemicEv / Math.max(amount, 1),
...
html`<div class="eit-cards">
  ...
  <div class="eit-card">
    ...
    <div class="eit-card-value">${eosCalc.controlRatio >= 1 ? Math.round(eosCalc.controlRatio).toLocaleString() + "x" : eosCalc.controlRatio.toFixed(2) + "x"}</div>
...
```{ojs}
//| echo: false
html`<div class="eit-summary">Your ${eosMoney(eosCalc.amount)} investment is dwarfed by what it protects. At a net worth of ${eosMoney(eosCalc.netWorth)}, the difference between the treaty trajectory and the current one is worth about ${eosMoney(eosCalc.systemicUpside)} to you if it passes, or ${eosMoney(eosCalc.systemicEv)} probability-weighted. That is roughly ${eosCalc.controlRatio >= 1 ? Math.round(eosCalc.controlRatio).toLocaleString() + " times" : eosCalc.controlRatio.toFixed(2) + " times"} your EOS investment, and it accrues whether or not you buy a single share. The investment does not create this upside; it nudges the probability that you collect it. (Caveat: this assumes your wealth tracks the economy. Cash and bonds lag; equities, property, and business equity track it more closely. Adjust the multiplier drivers above to set your own.)</div>`
```
...
When you buy matters. A share is worth its probability of success times the value of success. If the market is efficient, the price already encodes the odds and entry timing is fair (early just trades certainty for a bigger, rarer payoff, same expected value). If the market is asleep, which it is, since no analyst models the end of war, you buy at a near-zero implied probability and a win reprices the share the whole way up. Buying at 5% implied while believing 10% is a 2x edge, and on a win the share reprices by the success multiplier divided by that implied 5%. The edge is real exactly to the degree the market disbelieves, and it vanishes the moment the thesis becomes obvious.
...
A person who spends 80 years accumulating $100 million and then dies of a treatable disease has built a pile of something that became worthless at the moment of their death. On my planet we find this very confusing. You are building a number and then not being alive for it. It is like spending your life writing a book and then setting fire to it on the final page, while telling everyone how thick it got.
...
companies = [
  {ticker: "RTX",  name: "RTX Corp (Raytheon)",    sector: "Military", lobby: 13.51e6, mcap: 243.7e9, relevance: "Missile defense, arms exports"},
  {ticker: "LMT",  name: "Lockheed Martin",        sector: "Military", lobby: 12.67e6, mcap: 120.8e9, relevance: "F-35, NDAA budgets"},
  {ticker: "GD",   name: "General Dynamics",        sector: "Military", lobby: 12.21e6, mcap:  93.7e9, relevance: "Navy ships, combat vehicles"},
  {ticker: "BA",   name: "Boeing",                  sector: "Military", lobby: 11.93e6, mcap: 170.9e9, relevance: "Military contracts, FAA"},
  {ticker: "NOC",  name: "Northrop Grumman",        sector: "Military", lobby:  8.84e6, mcap:  77.3e9, relevance: "B-21, nuclear modernization"},
  {ticker: "LHX",  name: "L3Harris",                sector: "Military", lobby:  2.49e6, mcap:  57.3e9, relevance: "ISR, electronic warfare"},
...
viewof sectorWeighting = Inputs.radio(
  new Map([["Equal (by lobby ratio)", "ratio"], ["Military priority", "defense"], ["Pharma priority", "pharma"], ["All sectors", "all"]]),
...
ranked = {
  let weighted = companies.map(c => {
    ...
    let sectorMult = 1.0;
    if (sectorWeighting === "defense") sectorMult = c.sector === "Military" ? 3.0 : 0.5;
...
summary = {
  ...
  let lobbyMultiplier = totalLobbyChallenged / Math.max(totalAllocated, 1);
  let sectorBreakdown = {};
  for (let c of ranked) {
  ...
  return {totalAllocated, proposalsEnabled, totalLobbyChallenged, lobbyMultiplier, sectorBreakdown};
}
```
...
html`<div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap:1rem; margin:1rem 0;">
  ...
  <div style="background:#fffaf1; border:1px solid rgba(60,43,16,0.16); border-radius:16px; padding:1rem;">
    <div style="color:#6a5a45; font-size:0.84rem; text-transform:uppercase; letter-spacing:0.03em;">Lobbying Multiplier</div>
    <div style="font-size:1.5rem; font-weight:700; color:#0e5f47;">${Math.round(summary.lobbyMultiplier)}x</div>
  ...
  if (typeof localStorage !== 'undefined') {
    let overrides = {
      ...
      results: {
        ...
        leverage_ratio: summary.lobbyMultiplier
      }
    };
...
|---------|--------|-------------|-------------|------------|-----------|
| GD | Military | $12.2M | 1.30 | $68,496 | Yes |
| NOC | Military | $8.8M | 1.14 | $60,112 | Yes |
| LMT | Military | $12.7M | 1.05 | $55,131 | Yes |
| BA | Military | $11.9M | 0.70 | $36,693 | Yes |
| PFE | Pharma | $10.1M | 0.68 | $35,668 | Yes |
| RTX | Military | $13.5M | 0.55 | $29,140 | Yes |
| LHX | Military | $2.5M | 0.43 | $22,842 | No |
...
|--------|----------|----------|-----------|
| Military | $272,414 | $69.2M/yr | 6 |
| Pharma | $97,799 | $0.0M/yr | 0 |
| Energy | $18,810 | $0.0M/yr | 0 |
| Insurance | $10,977 | $0.0M/yr | 0 |

**Summary:** 6 of 16 proposals enabled. $69.2M/year lobbying challenged. Lobbying multiplier: 173x. At the 3-year/$2K threshold, all 16 companies qualify (multiplier: 353x, $141M/yr challenged).
...
Greed and generosity, for once, get off at the same stop.
