...
description: 'The EOS money product: buy the companies that already buy policy, then point the machinery at health and wealth. Private fund first, public ETF later.'
published: true
tags:
  - investment
  - eos
...
Earth Optimization Services is a company because your planet requires a legal box before anyone can reduce the amount of preventable dying. The box is a holding company. It sells products, makes money, and uses the money to optimize Earth. The money product is the Earth Optimization Fund.
...
| Earth Optimization Fund | Buys company shares and uses shareholder rights to redirect lobbying toward higher long-term shareholder value | Target: flat disclosed operating budget, no carry |
...
The Fund buys shares in companies whose lobbying shapes government policy, starting with military contractors because the [1% Treaty](../solution/1-percent-treaty.qmd) [@1-percent-treaty-paper-2025] [@1-pct-treaty-impact-paper-2025] has the cleanest math there. It uses ordinary shareholder tools: voting, demand letters, proxy proposals, proxy contests, board campaigns, and public analysis. This is the investable version of the [Loving Takeover](../appendix/loving-takeover.qmd). The side quest is buying your own share and filing your own letter. The main money machine is the pooled fund.

The long-term goal is to buy enough influence over the companies that already buy policy, then hand the policy agenda back to humanity through [Wishocracy](../solution/wishocracy.qmd) [@wishocracy-paper-2025]. Fund investors buy fund returns. They do not buy EOS governance, extra votes, nonprofit control, PAC control, or a private steering wheel for Earth.
...
1. **Private activist fund.** Start with private capital. Buy concentrated public-company positions. Use shareholder rights in the open. File Form D if using Reg D. Keep the offering private under [Rule 506(b)](https://www.sec.gov/resources-small-businesses/exempt-offerings/private-placements-rule-506b), or use [Rule 506(c)](https://www.sec.gov/resources-small-businesses/exempt-offerings/general-solicitation-rule-506c) only if every purchaser is accredited and verified.
2. **Public active ETF.** If the strategy works and can survive public-fund rules, package it as an active ETF. A mutual fund is the familiar mental picture; the traded public version is an ETF. The SEC explains that mutual funds redeem at NAV through the fund, while ETF shares trade on exchanges during the day ([SEC guide](https://www.sec.gov/investor/pubs/inwsmf.htm)).
3. **Permanent control vehicle.** If ETF plumbing is too weak for control blocks or board campaigns, add a closed-end or permanent-capital vehicle later. Do not start with the expensive box unless the cheaper boxes fail.
...
| Term | Value | Why |
|------|-------|-----|
| First fund target | $500K to $2M | Enough to buy stock, test governance pressure, and keep operations alive. Not enough to build a bureaucracy, which is a feature. |
| Minimum investment | Offering-specific | The minimum belongs to the exemption and offering documents, not vibes. Early private capital likely uses standard private-fund minimums. |
...
| Advisory fee | Target: none or as low as legally workable | "Zero fees" is too sloppy. Funds have custody, audit, legal, brokerage, index, platform, and compliance costs even when the adviser waives its fee. |
| Lockup | 1 year | The interesting part takes longer, but you can leave. |
| Operator control | No investor-bought EOS control | Operators run the fund under the fund documents. Investors get economics and fund rights, not extra votes in EOS or Wishocracy. |
| Security type | Private fund interest first, ETF shares later | Money in, more money out. No voting coin, no bought board seat, no private political control. |

The cap table principle in one breath: money can buy exposure to the Fund. Money cannot buy the human vote, Wishocracy allocation power, nonprofit control, PAC control, or personal influence over politicians. Every dual-class company you have heard of runs the split so the founders can keep the votes. This one runs it so nobody can buy them.

## How private-phase pricing works

The private phase may price a claim on two things: the portfolio assets the Fund holds and the probability-weighted value of the governance campaign. The public ETF phase is simpler: shares trade around the value of the portfolio, with normal ETF premiums, discounts, costs, and disclosures.

The speculative early claim represents your fractional exposure to the probability-weighted value of optimizing Earth. The formula:
...
**Why the price must be clean.** If you mix product revenue into the Fund thesis, the investment becomes a bet on book sales and consulting contracts. That is a different bet. The Fund thesis is whether shareholder control can redirect policy and make the portfolio, and the rest of the economy, more valuable. Product revenue is how EOS pays its bills. It is not the bet Fund investors thought they were buying.
...
**Why this is not the scheme it resembles.** A price that rises with adoption and rewards the earliest believers is also the grammar of every Ponzi. The difference is one sentence long: the Fund holds publicly traded portfolio companies and any payout must be traceable to assets, revenue, or disclosed fund rights outside the circle. Later buyers can raise the market price. They do not become the source of the asset. That is the entire difference between a fund and a chain letter, and it is auditable.

**If the campaign fails.** P drops. Price drops. Investors still have exposure to the portfolio, but concentrated positions can underperform, governance campaigns can fail, and the opportunity cost can be painful. The honest downside is not "nothing bad happens." The honest downside is that you bought a real but concentrated activist strategy and it did not work.
...
**Layer 1: Fund management.** The target is a flat operating budget, not a growing percentage of assets. A private activist fund still has legal, audit, custody, brokerage, filing, insurance, and compliance costs. Boring costs are still costs. They should be disclosed, capped where possible, and kept too small to become the product.

Target no advisory fee. Target no performance fee. Target no carry. Do not say "zero fees" unless the document also says which unavoidable fund expenses still exist.

At $2 million in assets, a flat $150,000 operating budget would be 7.5% of the fund. Expensive for a fund, but this is a startup with two million dollars, not Bridgewater. At $20 million, it is 0.75%. At $200 million, it is 0.075%, which is less than many funds charge to track an index. The operator gets progressively less rich as the fund gets bigger. This is the opposite of every fund whose manager is paid to gather assets regardless of performance. Here, the incentive is to make the assets worth more.
...
**Earth Optimization Fund.** Your money buys exposure to the Fund, which buys company shares and uses shareholder rights to redirect lobbying. First this is a private activist fund interest. Later it should be an active ETF if the strategy can survive public-fund rules. This is the takeover arm.
...
The Fund buys the opposition. The bonds may later fund the campaign. Do not confuse the two.
