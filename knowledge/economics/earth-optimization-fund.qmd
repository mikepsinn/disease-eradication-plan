...
eosBidModel = {
  ...
  const scenarios = [
    ...
    {name: "Stage 2: defense primes", p: terminalStage2, value: stageValues.stage2, payout: afterDilutionOwnership * stageValues.stage2},
