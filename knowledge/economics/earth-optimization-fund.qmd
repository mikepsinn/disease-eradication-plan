...
image: /assets/og-images/knowledge/economics/earth-optimization-fund-og-bw-academic.png
published: true
tags:
  - investment
  - eos
...
| [Optimitron](../solution/optimocracy.qmd) | Activist campaign infrastructure | Consulting triggered by demand letters; board-seat compensation |
...
**2. Copycats can be validation before they are competition.** EOS's first competitor is waste, and waste does not fight for market share, hire lawyers, or show up to the board meeting. It just sits there being wasteful. A fund copying the thesis files the same demand letters and publishes the same analyses, which only reprices the assets EOS already owns. They are less rivals than unpaid marketing. Copies compete for fees only after the market has already begun pricing the end of waste, and the scarce thing is owning the thesis before that happens.
