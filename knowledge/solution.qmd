...
Once your 1% Treaty is ratified, that {{< var treaty_annual_funding >}} per year flows into a **[1% Treaty Fund](solution/dih.qmd)**. It's a rules-governed treasury designed to minimize discretion. The treaty fixes the top-level allocation. Patients direct trial-participation spending. Wishocracy governs the collective-choice layer. Administrative entities maintain the rails, but they do not get to improvise the formula.
