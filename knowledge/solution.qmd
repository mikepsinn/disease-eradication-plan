...
2. The Decentralized Institute of Health (spending it wisely, which is harder than it sounds)
...
Once you've got {{< var treaty_annual_funding >}} per year to spend, you need somewhere to put it. This is where the DIH comes in.
...
Wishocracy is how you let {{< var global_population_2024_billions >}} billion people control a budget without everyone killing each other in meetings.
...
Instead of waiting {{< var treatment_acceleration_years_current >}} years for FDA approval while you die, you join a trial on the dFDA platform. The trial costs {{< var recovery_trial_cost_per_patient >}} per patient instead of {{< var traditional_phase3_cost_per_patient_fda_example_41k >}} because it turns out you don't need {{< var treatment_acceleration_years_current >}} layers of paperwork to figure out if aspirin works.
...
- How the dFDA achieves {{< var dfda_cost_effectiveness_multiplier >}}× cost reduction
