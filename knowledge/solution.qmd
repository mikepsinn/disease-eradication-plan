...
- 54,000 clinical trials at ${{< var qalys_from_new_therapies >}} each (the cheap way)
- Or 27 million patients in trials at ${{< var traditional_large_trial_size >}} each
...
Instead of waiting seventeen years for FDA approval while you die, you join a trial on the dFDA platform. The trial costs {{< var recovery_trial_cost_per_patient >}} per patient instead of $41,000 because it turns out you don't need seventeen layers of paperwork to figure out if aspirin works.
...
- Costs $50/month
- Based on {{< var qalys_from_prevention_conservative >}} real patients like you
