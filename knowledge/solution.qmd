...
Instead of waiting {{< var drug_discovery_to_approval_years >}} for FDA approval while you die, you join a trial. The trial costs {{< var dfda_pragmatic_trial_cost_per_patient >}} per patient instead of {{< var traditional_phase3_cost_per_patient >}} because it turns out you don't need {{< var drug_discovery_to_approval_years >}} layers of paperwork to figure out if aspirin works.
