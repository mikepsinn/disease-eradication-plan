...
| DIH research | {{< var dih_treasury_medical_research_pct >}} | {{< var dih_treasury_to_medical_research_annual >}} | Actually cure diseases |
...
### A Decentralized Institute of Health

Once you've got {{< var treaty_annual_funding >}} per year to spend, you need somewhere to put it. This is where your DIH comes in.

Your DIH is like the NIH, except it works. Here's how:
...
Instead of waiting {{< var treatment_acceleration_years_current >}} years for FDA approval while you die, you join a trial on your dFDA platform. The trial costs {{< var recovery_trial_cost_per_patient >}} per patient instead of {{< var traditional_phase3_cost_per_patient_fda_example_41k >}} because it turns out you don't need {{< var treatment_acceleration_years_current >}} layers of paperwork to figure out if aspirin works.
...
New system: Patients pay researchers, subsidized by your DIH
...
[VICTORY Bonds](economics/victory-bonds.qmd) are a specific [Incentive Alignment Bond](solution/incentive-alignment-bonds.qmd) - a single instrument that aligns investors (10% returns), politicians (10% career incentives), and patients (80% cures) with the same outcome: expand treaty funding.
...
Your dFDA moves people from "currently sick" to either "dead" (whoops) or "cured" (success). Either way, the insurance company pays less.
...
- How to build your DIH so it can't be corrupted
- How Wishocracy prevents lobbyists from stealing all the money
- How your dFDA achieves {{< var trial_cost_reduction_factor >}}× cost reduction
