...
tags:
  ...
  - democracy
  - regulatory-capture
image: /assets/og-images/knowledge/problem-foundations.png
---
...
**War:** {{< var global_military_spending_annual_2024 >}} per year
...
- Bullets (many)
- AI combat robots (the future is here and it's disappointing)
...
Your personal lifetime contribution to the war budget is $74,259. You could have bought a really nice casket instead.
...
- $8.2 trillion on healthcare (treating symptoms because cures limit revenue)
...
Lobbying is basically paid influence, except we call it "free speech" so it sounds nicer. It's like how "alternative facts" sounds better than "falsehoods," or how "enhanced interrogation" sounds better than "torture."
...
The solution isn't to print more money for medical research. The solution is to change the ratio. Take money from the military budget, give it to the health budget. This is called "arithmetic," which is apparently a controversial field of mathematics.
...
- Why democracy ignores the public
