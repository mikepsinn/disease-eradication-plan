...
The **PRIZE pool** is escrowed and distributes when both global targets are met at year 15 (HALE reaches {{< var wishonia_projected_hale_year_15 >}}, median income reaches {{< var wishonia_trajectory_avg_income_year_15 >}}), proportional to VOTE holdings. Whoever recruited the most coalition gets the most prize money. Scoring disputes use the same challenge-window mechanism described above.
