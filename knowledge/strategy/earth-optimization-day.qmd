...
tags:
  ...
  - ratchet
audience: "An organizer or recruiter running the campaign who has to sign up partner orgs and pick the launch date"
feel: "Calm certainty that one coordinated date is the lever that turns scattered effort into a law nobody can route around"
do: "Lock the date and start signing partners up now so everything fires together on the first Earth Optimization Day"
---
...
Year 2 uses Year 1's data as the case. Redirect ratchets to 2%. Partners who watched from the sidelines commit. Year 5, at 10%, the military sector still retains {{< var defense_sector_retention_pct >}} of their pre-treaty budget and earns Victory Bond returns on the redirected portion. Nobody on the inside is worse off. Humanity is one tenth less irrational.
