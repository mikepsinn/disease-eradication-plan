...
description: The call script for getting people you love to vote for the 1% Treaty. One message to send. A twenty-two-question sequence to run when they call back. A set of rebuttals for the objections that come up. Plus the math that makes a five-minute phone call worth more per hour than anything else a human can do.
published: true
tags:
  - call-script
  - strategy
...
- **"This sounds like bribery."** Correct. You are describing lobbying. Same K Street firms, same campaign contributions, same revolving door, same wine. The only difference is what the money buys. Current lobbying buys missile contracts. This one buys clinical trials. If you are comfortable with the first and uncomfortable with the second, sit quietly and think about why. Also: this plan caps the lobbying portion at 20% and puts every contribution on a public ledger. No government budget in history has had a lower corruption rate.
