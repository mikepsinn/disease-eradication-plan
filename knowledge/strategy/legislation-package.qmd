...
format:
  html:
    toc: true
    toc-depth: 3
image: /assets/og-images/knowledge/strategy/legislation-package-og-academic.png
---

{{< include /knowledge/includes/setup-parameters.qmd >}}

![How to Write Laws That Actually Pass](/assets/infographics/knowledge/strategy/legislation-package-infographic-academic.png)
