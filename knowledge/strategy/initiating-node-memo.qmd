...
**Purpose:** Explain the smallest credible role an institution can play to launch the Earth Optimization Prize without becoming a single point of failure
...
| **[Optimocracy / OPG / OBG](../solution/optimocracy.qmd)** | Measures what improves health and income and recommends better policy/budget choices | Evidence and recommendation engine |
...
The current trajectory is not neutral. The destructive economy is already {{< var global_destructive_economy_pct_gdp >}} of GDP, reaches {{< var destructive_economy_pct_gdp_year_15 >}} by year 15 if current trends continue, reaches the failed-state danger zone in {{< var destructive_economy_years_to_25pct_gdp >}}, and reaches parity with the productive economy in {{< var destructive_economy_years_to_50pct_gdp >}}.

The modeled upside of changing course is similarly large. The Treaty path adds {{< var treaty_trajectory_lifetime_income_gain_per_capita >}} in lifetime income and {{< var treaty_hale_gain_year_15 >}} of healthy life by year 15. The fuller Wishonia path adds {{< var wishonia_trajectory_lifetime_income_gain_per_capita >}} and {{< var wishonia_hale_gain_year_15 >}}.
...
| Endorse the process for comparing plans | Declare `Earth Optimization Plan v1` correct |
...
| Entry set | The baseline `Earth Optimization Plan v1` plus any serious competing submissions |
...
If your institution is willing to host ambitious but bounded public infrastructure, the correct move is not to wait for perfect certainty. It is to run the 90-day pilot with explicit non-sovereign boundaries.
