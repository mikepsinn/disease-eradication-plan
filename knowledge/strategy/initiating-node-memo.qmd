...
| **[Optimitron repository](https://github.com/mikepsinn/optomitron)** | Open-source monorepo implementing the evidence engine, Wishocracy, policy and budget generators, data pipelines, storage, auth, and treasury packages | Public source, issues, and package structure |
