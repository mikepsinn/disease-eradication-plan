...
- [Andrew Trask](commissioners/andrew-trask.qmd), privacy-preserving AI, OpenMined. The optimal policy and medical evidence machines need data. The humans who have the data are often correct not to hand it to random centralized systems. Secure computation is how you let knowledge move without making private lives spill onto the floor.
