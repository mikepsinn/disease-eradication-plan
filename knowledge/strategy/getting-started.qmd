...
The wearable layer that compounds with celebrity reach is the [shirt seed program](../appendix/joke.qmd) [@joke-paper-2026] described in [The T-Shirt That Ended War and Disease](../appendix/joke.qmd). Same window (months 6-12), separate budget (foundation assurance contract, not nonprofit grant), and the celebrity wearing the shirt at a single televised event substitutes for thousands of seed wearers from earlier tiers.
