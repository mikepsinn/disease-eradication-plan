...
- The strategy requires 280 million people to support a [1% treaty](../solution/1-percent-treaty-foundations.qmd)
...
- "{{< var victory_bond_annual_return_pct >}} investment returns while saving humanity" (returns + altruism)
...
- **Anger**: "[FDA delays cost more lives than the drugs](../references.qmd#fda-drug-lag-deaths-estimate)"
- **Fear**: "You'll die of disease, not war"
- **Hope**: "You could cure this in 10 years"
- **Returns**: "{{< var victory_bond_annual_return_pct >}} annual returns forever"

### Personal Stake

- "Your tax dollars: $340 to war, $8 to cures"
- "Your mom dies while committees meet"
...
**"Support this. Buy bonds. Share this."**

## Platform-Specific Strategies

### Twitter/X

- Mortality tracker bots: "147 died while you scrolled"
- Spending comparisons: Daily updates
- Quote leaders stating priorities
- Then show their budget allocations
...
- Get 100 supporters → Free VICTORY Incentive Alignment Bond
- Reach influencer status → Speaking opportunities

### Influencer Incentives

- 1M views discussing treaty → $10K in bonds
- Convert followers to advocates → Bonus VICTORY Incentive Alignment Bond allocation
...
- "Defense CEO salary vs rare disease research funding"
...
### Provocative Points That Generate Engagement

- "[FDA delays cost more lives than terrorists](../references.qmd#fda-drug-lag-deaths-estimate)"
- "NIH is a [$48B](../references.qmd#nih-budget-fy2025) employment program, not a cure program"
- "Individual voices are ignored (Princeton proved it)"
...
- **Shared**: Told others
- **Committed**: Pledged support or bought bonds
...
This viral marketing campaign builds awareness and support during the first 18 months, preparing for the treaty push in months 19-36. See [The Roadmap](roadmap-foundations.qmd) for the complete 3-year plan.
...
- Public demand begins building

### Months 13-18: Critical Mass

- 280M supporters committed
- Media saturation
- Leaders see demand
