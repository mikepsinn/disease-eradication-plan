...
3. **Private investors/family offices**: "Here are bonds paying 271.8% vs current [10% market return](../references.qmd#investment-return-comparison)."
...
- Pay: {{< var lobbyist_salary_min_k >}}K-{{< var lobbyist_salary_max_millions >}}M annually
...
- Military budget only drops 1% ($27.2B of [{{< var global_military_spending_post_treaty_annual_2024 >}}](../references.qmd#sipri-2024-spending))
...
A significant portion of the campaign's $1.0B war chest is allocated for strategic partnerships to co-opt key industry players and defense lobbyists. For the full breakdown, see the [Campaign Budget](../economics/campaign-budget.qmd).

## Why This Works

### It's Literally Their Playbook

Defense contractors spend {{< var treaty_campaign_budget_partnerships >}} on lobbying and get $181B back (1,810:1 ROI). The approach uses the EXACT same strategy, just offering better returns.
