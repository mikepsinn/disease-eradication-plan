...
Historical analysis shows: Every peaceful movement that gets **[3.5% active support](.../../knowledge/references.qmd#3-5-rule)** succeeds.
...
- "Humanity has [13,000 nukes](.../../knowledge/references.qmd#world-warheads) but no cure for your kid's cancer" (rage-inducing)
...
- **Anger**: "[FDA delays kill more than the drugs](.../../knowledge/references.qmd#fda-drug-lag-deaths-estimate)"
...
**"The 1% Treaty: Redirect 1% of military spending to medical research. Fund trials that are [82x cheaper](.../../knowledge/references.qmd#recovery-trial-82x-cost-reduction). Cure major diseases in 10 years. Everyone wins."**
...
- "[Cost of one F-35](.../../knowledge/references.qmd#f35-cost-vs-rare-disease-research) = ~160 Oxford-style trials"
...
- "Days to approve weapons: 1 / Days to approve cancer cure: [6,205](.../../knowledge/references.qmd#research-to-practice-gap)"
...
- "Today's death toll: [150,000](.../../knowledge/references.qmd#who-daily-deaths)"
- "Total spent on war today: ~$7.4 billion"
- "Total spent on cures today: [$186 million](.../../knowledge/references.qmd#global-gov-med-research-spending)"
- "Ratio: Still insane"
...
- "[FDA has killed more Americans than terrorists](.../../knowledge/references.qmd#fda-drug-lag-deaths-estimate)"
- "NIH is a [$48B](.../../knowledge/references.qmd#nih-budget-fy2025) jobs program, not a cure program"
- "Your vote doesn't matter ([Princeton proved it](.../../knowledge/references.qmd#unrepresentative-democracy))"
...
→ "[Oxford RECOVERY trial](.../../knowledge/references.qmd#recovery-trial-summary-quote) already proved it works."
