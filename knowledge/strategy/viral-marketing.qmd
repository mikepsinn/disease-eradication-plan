...
Historical analysis shows: Every peaceful movement that gets **[{{< var global_population_activism_threshold_pct >}} active support](../references.qmd#3-5-rule)** succeeds.
...
**"The 1% Treaty: Redirect 1% of military spending to medical research. Fund trials that are [{{< var dfda_cost_effectiveness_multiplier >}}× cheaper](../references.qmd#recovery-trial-82x-cost-reduction). Cure major diseases in 10 years. Everyone wins."**
