...
The voting system uses an **end-to-end verifiable scheme** (like Helios [@helios-voting]):
...
Some people pass Layers 1 and 2. They have fake IDs, VPNs, and too much free time. Machine learning catches sophisticated fraud that basic checks miss:
...
- **280M+ verified participants** ({{< var global_population_activism_threshold_pct >}} global population)
- **<$0.75 per verified participant** (cheaper than any consumer acquisition)
- **Viral coefficient >1.0** (self-sustaining growth)
- **>99% fraud detection** with <1% false positives

Secondary metrics track geographic distribution, brand awareness, community engagement, and policymaker recognition.
