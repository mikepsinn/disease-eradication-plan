...
The internet is full of bots, fraudsters, and people who think it's funny to vote {{< var traditional_large_trial_size >}} times. This is a problem.
...
- **IP Geolocation**: If {{< var dfda_large_trial_size >}} votes come from one basement in Belarus, you notice.
...
| Social Media Challenges | {{< var social_media_participant_target_min >}}-{{< var social_media_participant_target_max >}}       | $0.10-0.30        | 1.5-3.0           | High viral potential, low marginal cost |
...
- **False Negative Rate**: <{{< var victory_bond_funding_pct >}} fraudulent accounts passing verification
...
{{< var treaty_campaign_budget_viral_referendum >}} for the campaign, as allocated in the [VICTORY Bonds Use of Funds](../economics/victory-bonds.qmd).
