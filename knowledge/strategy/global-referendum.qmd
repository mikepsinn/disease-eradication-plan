...
description: Humanity downloaded TikTok over 4 billion times to watch strangers twerk. Getting {{< var global_coordination_target_supporters_nounit >}} verified people to click 'yes' on not dying should be easier. Here's how, with math.
published: true
tags:
  - referendum
  - governance
...
They cannot ignore {{< var global_coordination_target_supporters_nounit >}} cryptographically verified humans saying "do this thing or we vote you out."

Not because they care about those humans. Because they can count.

But the politicians are the secondary audience. The primary audience is you. Right now every human who thinks "obviously we should spend less on murder and more on medicine" also thinks they are the only one. They are not the only one. They are almost everyone. The referendum is the moment {{< var global_coordination_target_supporters_nounit >}} humans look up and realize they are {{< var global_coordination_target_supporters_nounit >}} humans. That is not a petition. That is a species finding out what it actually wants.
...
Target: **{{< var global_coordination_target_pct >}} global participation** ({{< var global_coordination_target_supporters_nounit >}}+ verified votes). That is the canonical public coordination target in the prize model. The old Chenoweth-style {{< var global_population_activism_threshold_pct >}} threshold is useful as a historical lower bound for when movements become hard to ignore, not as the end-state goal here.
...
Your species downloaded TikTok over 4 billion times to watch strangers twerk. Getting {{< var global_coordination_target_supporters_nounit >}} to click "yes" on not dying should be easier. It isn't, because not dying is less entertaining than twerking, but it should be, and that gap between "should be" and "isn't" is the entire marketing problem.
...
The realistic target for {{< var global_coordination_target_pct >}} participation ({{< var global_coordination_target_supporters_nounit >}} verified humans) scales alongside the [current Earth Optimization manual](earth-optimization-protocol-v1.qmd#the-sequencing).
...
The {{< var global_population_activism_threshold_pct >}} Rule is a useful historical floor: when {{< var global_population_activism_threshold_pct >}} of a population actively participates in sustained, nonviolent action, the movement has historically won. That tells you when politicians start to worry. The prize is aiming higher. The canonical public target is {{< var global_coordination_target_pct >}} of humanity, described in prose as roughly 90% of likely voters globally, because the objective is not marginal plausibility. The objective is overwhelming, legible coordination.
