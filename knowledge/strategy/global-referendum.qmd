...
- Must hit **[3.5% global participation](.../../knowledge/references.qmd#3-5-rule)** (280M+ verified votes)
...
- Use an end-to-end verifiable scheme ([Helios](.../../knowledge/references.qmd#helios-voting) or similar) with individual ballot verification and public bulletin board
...
- **Government ID Integration**: Connect with existing national e-ID systems:
  - [Estonia e-Residency](.../../knowledge/references.qmd#estonia-eresidency-stats) (they have digital citizenship, it's actually cool)
  - [Indian Aadhaar system](.../../knowledge/references.qmd#indian-aadhaar-system) (1.3 billion people already enrolled)
  - [EU eIDAS network](.../../knowledge/references.qmd#eu-eidas-network) (European digital ID)
  - US State ID verification via [ID.me](.../../knowledge/references.qmd#id-me-verification) (same system military uses)
...
- **Proof-of-Uniqueness Partners**: Work with existing identity services:
  - [Worldcoin iris scanning](.../../knowledge/references.qmd#worldcoin-scale) (yes, the eyeball scanner)
  - [BrightID social verification](.../../knowledge/references.qmd#brightid-social-verification-network) (your friends vouch for you)
  - [Gitcoin Passport](.../../knowledge/references.qmd#gitcoin-passport) (reputation scoring for crypto people)
...
- **[GDPR Compliance](.../../knowledge/references.qmd#gdpr-biometric-data)**: Full EU data protection compliance (the strictest privacy law on Earth)
- **[CCPA/CPRA Compliance](.../../knowledge/references.qmd#ccpa-cpra-compliance)**: California privacy rights (because California regulates everything)
- **Biometric Privacy Laws**: [Illinois BIPA](.../../knowledge/references.qmd#illinois-bipa) compliance (they take biometric privacy seriously)
- **Children's Privacy**: [COPPA compliance](.../../knowledge/references.qmd#coppa-compliance) for under-13s (don't collect kids' data, this should be obvious)
