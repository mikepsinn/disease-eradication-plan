...
The realistic target for {{< var global_population_activism_threshold_pct >}} participation ({{< var treaty_campaign_voting_bloc_target_nounit >}} verified humans) scales alongside the [full campaign roadmap](roadmap.qmd).
