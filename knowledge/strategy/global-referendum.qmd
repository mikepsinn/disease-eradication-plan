...
- Use an end-to-end verifiable scheme (Helios [@helios-voting] or similar) with individual ballot verification and public bulletin board
...
![Architectural flow diagram illustrating the secure data lifecycle from the user frontend through backend processing to encrypted storage and the public bulletin board.](/assets/images/global-referendum/global-referendum-section-system-architecture-bw-academic.jpg)
