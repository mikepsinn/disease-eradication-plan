...
![Infographic](/assets/infographics/knowledge/strategy/nonprofit-coalition-strategy-infographic-academic.png)
...
**If you're a disease advocacy group:** You are currently fighting every other disease group for a tiny sliver of the NIH's budget. You are competing for crumbs. A 1% treaty doesn't just give you a bigger slice of the pie; it bakes a new, much larger pie. It increases clinical trials capacity by {{< var military_to_government_clinical_trials_spending_ratio >}} times and makes the testing process 82x more efficient. The bottleneck isn't ideas or molecules - it's running enough trials to find out what works. This solves that.
