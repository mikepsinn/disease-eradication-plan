...
![Humanity's spectacular failure at prioritizing not dying](/assets/infographics/knowledge/problem-infographic-retro-academic.jpg)
...
Every day, {{< var global_disease_deaths_daily >}} humans die from disease and aging. Many of those deaths are likely eventually avoidable with sufficient investment, but we are moving far too slowly.

![A scale comparison visualizing 150,000 daily deaths from aging and disease represented as fifty individual blocks of 3,000 deaths each to illustrate the '50 9/11s' ratio.](/assets/images/problem/problem-section-daily-numbers-bw-academic.jpg)
...
But the real bottleneck isn't research funding. It's testing which treatments actually work. Clinical trials determine whether medicines save lives or sit on shelves. On that front, governments worldwide spend {{< var global_government_clinical_trials_spending_annual >}} annually on clinical trials versus {{< var global_military_spending_annual_2024 >}} on weapons. That's a {{< var military_to_government_clinical_trials_spending_ratio >}} ratio, which in technical terms is called "having your priorities backwards."

![A comparison of global annual spending showing the massive disparity between military expenditures (2.72 trillion) and funding for disease research (67.5 billion) and clinical trials (4.5 billion).](/assets/images/problem/problem-section-where-the-money-goes-bw-academic.jpg)
...
![A comparison showing the scale of the Pentagon's 2.5 trillion loss against the cost of 37 years of medical research and 17 aircraft carrier strike groups.](/assets/images/problem/problem-section-on-the-pentagon-s-accounting-bw-academic.jpg)
...
![A comparison of US NIH RECOVER and UK RECOVERY trials highlighting the disparity in cost per patient (55,500 vs. 500) and patient enrollment counts, alongside a breakdown of NIH budget allocation.](/assets/images/problem/problem-section-on-medical-research-bw-academic.jpg)

Diseases cured: Zero.

Well, technically that's not fair. They cured... let me check my notes... no, it's zero.

Here's where it gets interesting. The NIH has a {{< var nih_annual_budget >}} annual budget. Of that, only {{< var nih_clinical_trials_spending_pct >}} goes to actual drug trials in humans. The other 97% goes to studying mice, building buildings, training researchers, and publishing papers nobody reads.
...
![Efficiency comparison between the US NIH RECOVER initiative and the UK RECOVERY trial.](/assets/images/problem/problem-section-research-efficiency-comparison-bw-academic.jpg)
...
![A comparison showing the massive disparity between the Oxford RECOVERY trial cost per patient (500) and the standard FDA process cost per patient (41,000), illustrating an 82x cost difference.](/assets/images/problem/problem-section-on-the-fda-bw-academic.jpg)

It takes {{< var drug_discovery_to_approval_years >}} and {{< var pharma_drug_development_cost_current >}} to get a drug from discovery to patient. {{< var drug_discovery_to_approval_years >}}. That's longer than it took to build the pyramids, and those involved moving rocks the size of houses without machinery (also the pharaohs didn't have to file quarterly progress reports in triplicate).

During the Oxford RECOVERY trial, they tested treatments on 40,000 patients for {{< var recovery_trial_cost_per_patient >}} per person. The FDA's process costs {{< var traditional_phase3_cost_per_patient >}} per patient. That's {{< var recovery_trial_cost_reduction_factor >}} times more expensive for the same result, except slower. It's like if you could get a haircut for $10 or $820, but the $820 haircut takes {{< var drug_discovery_to_approval_years >}} from discovery to patient and you might be bald by then anyway.
...
They say the road to hell is paved with good intentions. The FDA's road is paved with good intentions and also {{< var drug_discovery_to_approval_years >}} from discovery to patient.
...
![An infographic illustrating global military spending trade-offs, showing the scale of 2.72 trillion and the ratio of one submarine costing as much as 1,000 cancer research labs.](/assets/images/problem/problem-section-on-what-war-costs-bw-academic.jpg)
...
- {{< var global_symptomatic_disease_treatment_annual >}} on healthcare (treating symptoms because cures are bad for business)
- {{< var global_disease_economic_burden_annual >}} in economic losses (dead people are notoriously unproductive)
...
- 1 billion depressed humans (costing {{< var global_disease_productivity_loss_annual >}} in lost "wanting to exist")
...
![A visual comparison showing the high return on investment for concentrated lobbying groups versus the lack of policy influence for the general public.](/assets/images/problem/problem-section-on-democracy-bw-academic.jpg)
...
![The cyclical career path illustrating regulatory capture between industry and government.](/assets/images/problem/problem-section-the-regulatory-capture-cycle-bw-academic.jpg)

This is why the FDA's rules mysteriously benefit large pharmaceutical companies who can afford {{< var pharma_drug_development_cost_current >}} approval processes, and why Pentagon procurement mysteriously benefits military contractors who can afford $1,800 hammers.

## On the Fixed Pie

Here's something they don't teach in economics class: Money isn't real, but resources are.

![A visual comparison of resource allocation showing the salary gap between military and medical research roles alongside a GDP comparison between Switzerland and the United States.](/assets/images/problem/problem-section-on-the-fixed-pie-bw-academic.jpg)
...
Switzerland spends {{< var switzerland_defense_spending_pct >}} of GDP on military and has {{< var switzerland_gdp_per_capita_k >}} GDP per capita. America spends {{< var us_military_spending_pct_gdp >}} on military and has $76,000 GDP per capita. 
...
![A conceptual infographic illustrating the various forms of biological decay, from telomere shortening to joint wear, that contribute to the overall process of human entropy.](/assets/images/problem/problem-section-on-your-personal-situation-bw-academic.jpg)
...
- {{< var global_disease_deaths_daily >}} humans die daily from disease and aging, many of which are eventually avoidable
...
- {{< var military_to_government_clinical_trials_spending_ratio >}} weapons-to-clinical-trials spending ratio (the bottleneck isn't research. It's testing which medicines work.)
...
![A visual comparison of global resource allocation showing the 2.72 trillion spent on weapons versus the 67.5 billion spent on curing diseases, highlighting the 604:1 spending ratio.](/assets/images/problem/problem-section-what-this-means-bw-academic.jpg)
...
![A conceptual map linking institutional failures (such as NIH spending, FDA cost inflation, and regulatory capture) to their ultimate impact on individual health and societal waste.](/assets/images/problem/problem-section-what-s-next-bw-academic.jpg)


The following chapters will explain:

- Why the NIH spent $1 trillion curing nothing
- How the FDA makes medicine {{< var recovery_trial_cost_reduction_factor >}} more expensive than necessary  
