...
**Killing each other:** {{< var global_annual_military_spending_annual_2024 >}} per year
**Curing diseases:** {{< var global_med_research_spending >}} per year

That's a {{< var military_vs_medical_research_ratio >}}:1 ratio, which in technical terms is called "having your priorities backwards."
...
They say the road to hell is paved with good intentions. The FDA's road is paved with good intentions and also {{< var treatment_acceleration_years_current >}} years of paperwork.

### On What War Costs

Humanity spends {{< var global_annual_military_spending_annual_2024 >}} every year on war. That works out to {{< var global_military_spending_per_capita_annual >}} per human on Earth for death tools.
...
- {{< var global_annual_military_spending_annual_2024 >}} spent annually on weapons
- {{< var global_med_research_spending >}} spent annually on curing all diseases combined
- {{< var military_vs_medical_research_ratio >}}:1 murder-to-medicine spending ratio
...
- How the FDA makes medicine {{< var dfda_cost_effectiveness_multiplier >}}× more expensive than necessary  
