...
**Killing each other:** {{< var global_annual_human_cost_state_violence >}} per year
...
For comparison, imagine if you spent {{< var global_annual_human_cost_state_violence >}} on guns and $68 on food. Your neighbors would stage an intervention (or call the police, or possibly just move). But when humanity does it, you call it "defense spending" and give everyone medals.
...
When normal people lose {{< var lobbyist_bond_investment_max_millions >}}, they search the couch cushions. When the Pentagon loses $2,500,000,000,000, they ask for more money and Congress says yes.
...
When you want healthcare, you have approximately zero dollars to lobby with because you spent it all on healthcare (or you're dead, which significantly reduces your lobbying capacity - corpses have no political voice, despite making up the largest constituency).
...
They say every problem is an opportunity in disguise. In this case, the opportunity is disguised as {{< var global_daily_deaths_curable_diseases >}} corpses per day, which is admittedly not the most encouraging disguise, but you work with what you have.
