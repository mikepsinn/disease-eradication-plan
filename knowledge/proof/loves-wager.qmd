...
Any action that nudges that ratio nudges the wager. The [1% treaty](../solution/1-percent-treaty.qmd) [@1-percent-treaty-paper-2025] [@1-pct-treaty-impact-paper-2025] is the largest available lever. Buying a share of a defense contractor and turning its lobbying machine against itself is the smallest. Both move probability in the same direction. The mechanism is documented; this is not a rock you throw at the sky hoping it sticks.
