...
We have already proven we can read the blueprint (DNA), edit the code (CRISPR), and replace the parts (organ transplants). The only reason you are still aging and dying is because we, as a species, have decided to spend **{{< var military_vs_medical_research_ratio >}} more money** on weapons to break our machines than on research to fix them.
