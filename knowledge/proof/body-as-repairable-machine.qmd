...
tags:
  ...
  - proof
  - car-analogy
image: /assets/og-images/knowledge/proof/body-as-repairable-machine-og-academic.png
---

{{< include /knowledge/includes/setup-parameters.qmd >}}

![Infographic](/assets/infographics/knowledge/proof/body-as-repairable-machine-infographic-academic.png)
...
This isn't theoretical. [We've done it](../references.qmd#aging-reversal-mammals-yamanaka):
...
We have already proven we can read the blueprint (DNA), edit the code (CRISPR), and replace the parts (organ transplants). We know [how to test which medicines work](../problem/untapped-therapeutic-frontier.qmd): pragmatic trials cost [$500 per patient](../references.qmd#recovery-cost-500) instead of the traditional [$41,000](../references.qmd#trial-cost-41k). The bottleneck isn't knowledge - it's [clinical trials](../problem/untapped-therapeutic-frontier.qmd). We've tested [less than 1% of possible drug-disease combinations](../problem/untapped-therapeutic-frontier.qmd) using existing safe compounds.

The only reason you are still aging and dying is because humans, as a species, have decided to spend **{{< var military_to_government_clinical_trials_spending_ratio >}} times more money** on weapons to break our machines than on clinical trials to discover which medicines actually fix them.
