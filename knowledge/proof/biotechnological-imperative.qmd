...
The [first proof](../proof/loves-wager.qmd) was mathematical. The expected value of acting is infinite; the expected value of not acting is infinitely bad; any finite cost is worth paying. That proof speaks to your self-interest. It says: *you should act because it is the rational thing to do for you.*
...
"But we need defense." Fine. Nobody is suggesting zero. The [1% Treaty](../solution/1-percent-treaty.qmd) [@1-percent-treaty-paper-2025] [@1-pct-treaty-impact-paper-2025] asks for one percent. One. Your governments could spend 99% of their current military budgets on weapons and redirect {{< var treaty_annual_funding >}} per year to clinical trials and it would still be {{< var military_to_clinical_trials_spending_ratio >}} times more on the military than on all clinical trials combined. The question is not "defense or medicine." The question is "is a {{< var military_to_government_clinical_trials_spending_ratio_nounit >}}-to-1 ratio universalizable?" It is not.

## How this differs from Love's Wager

[Love's Wager](../proof/loves-wager.qmd) says: the expected value math makes acting the only rational choice *for you*. It is an argument from self-interest. If you are purely selfish and care about nothing except your own well-being, Love's Wager still applies. The infinities don't care about your motives.
...
|-------|------|------|--------|
| [Love's Wager](../proof/loves-wager.qmd) | Rational (math) | You *should* act. The expected value is infinite. | Self-interest |
...
The ratio is {{< var military_to_government_clinical_trials_spending_ratio >}}. You know this now. You know the test, and you know the ratio fails it. Every day the ratio persists, {{< var global_disease_deaths_daily_nounit >}} people die of diseases that clinical trials could address.

This is not a trolley problem. Nobody is asking you to push anyone off a bridge. The resources exist. The mechanism is proven. The math is infinite. The ethics are categorical. The only action required is reading [the rest of this book](../proof/loves-wager.qmd) and picking one of the ten things in it that sounds fun to you.
