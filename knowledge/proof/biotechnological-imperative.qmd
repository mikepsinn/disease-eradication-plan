...
This is not a trolley problem. Nobody is asking you to push anyone off a bridge. The resources exist. The mechanism is proven. The math is infinite. The ethics are categorical. The only action required is reading [the rest of this book](../proof/wishonias-wager.qmd) and picking one of the ten things in it that sounds fun to you.
