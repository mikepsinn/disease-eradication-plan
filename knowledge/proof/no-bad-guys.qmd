...
image: /assets/og-images/knowledge/proof/no-bad-guys-og-bw-academic.jpg
...
audience: "the general reader who suspects someone evil is behind it all"
feel: "the cold relief of seeing the trap clearly: no villain to hate, just a switch nobody flipped, which means it can be flipped"
do: "Forward this to the person you know who is closest to the war economy (a defense engineer, a contractor, a friend with military stock, the relative who says \"I protect America\") so someone shows them the column they were never shown, then vote at warondisease.org."
---
...
The powerful beneficiaries ARE shrinking the global pie and shortening their OWN lives. They would be richer and live longer in the optimized world. The book's own math says the typical person gains {{< var treaty_trajectory_lifetime_income_gain_per_capita >}} in extra lifetime wealth from the [1% Treaty](../solution/1-percent-treaty.qmd) [@1-percent-treaty-paper-2025] [@1-pct-treaty-impact-paper-2025] alone. A Lockheed executive would gain far more, because the gain scales with income.
