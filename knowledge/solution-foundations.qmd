...
1. A 1% treaty (redirecting money from the military budget)
...
"You can keep 99% of your military budget. But also, here are some bonds that pay {{< var victory_bond_annual_return_pct >}} returns. Your pension fund would like those returns. Your shareholders would like those returns. You would personally like those returns because you also have a body that's falling apart.
...
In this case, the slightly less stupid thing is redirecting 1% of the military budget to the not-dying budget.
