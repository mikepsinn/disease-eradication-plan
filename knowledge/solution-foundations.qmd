...
description: How to Build Systems That Work
published: true
tags:
  - solution
  - 1-percent-treaty
  ...
  - national-security
  - victory-bonds
image: /assets/og-images/knowledge/solution-foundations.png
---
...
1. A 1% treaty (redirecting money from the defense budget)
...
| Policy incentives | {{< var iab_political_incentive_funding_pct >}} | {{< var iab_political_incentive_funding_annual >}} | Keep stakeholders aligned via [IABs](solution/incentive-alignment-bonds-foundations.qmd) |
...
Once the 1% Treaty is ratified, that {{< var treaty_annual_funding >}} per year flows into a **1% Treaty Fund**. Now you need a system to spend it wisely. This is where a decentralized institutes of health (DIH) comes in.

A decentralized institutes of health is like the NIH, except it works differently. Here's how:

#### What the NIH does

- 200 people in a building decide what to fund
- They guess what might work
- They fund familiar networks
- Cures are scarce
...
Wishocracy is how you let {{< var global_population_2024 >}} billion people control a budget without everyone fighting in meetings.
...
Instead of waiting {{< var treatment_acceleration_years_current >}} years for FDA approval while waiting, you join a trial on this platform. The trial costs {{< var recovery_trial_cost_per_patient >}} per patient instead of {{< var traditional_phase3_cost_per_patient_fda_example_41k >}} because it turns out you don't need {{< var treatment_acceleration_years_current >}} layers of paperwork to figure out if aspirin works.
...
It's just facts. No marketing. No spin. No 40-page legal documents written by lawyers creating complexity.
...
It's democracy for funding pragmatic clinical trials, except instead of waiting years for people who make promises, you vote every day with your trial participation for treatments that might save your life.

##### On Why Defense Contractors Should Care

You'd think defense contractors would hate this. But here's what you tell them:

"You can keep 99% of your defense budget. But also, here are some bonds that pay {{< var victory_bond_annual_return_pct >}} returns. Your pension fund would like those returns. Your shareholders would like those returns. You would personally like those returns because you also have a body that's falling apart.

Plus, conflict is getting bad PR. Curing cancer is excellent PR. Your ESG score goes up. Your stock price goes up. You still make weapons with the other 99%, you just also cure diseases with 1%.
...
Consider: The goal isn't 1%. The goal is 100%.
...
No. Because unlike every other treaty, this one has a [scaling engine built in](solution/incentive-alignment-bonds-foundations.qmd#sec-why-ten-pct-scaling-engine).

The 10% going to [Incentive Alignment Bonds](solution/incentive-alignment-bonds-foundations.qmd) doesn't just help pass the 1% treaty - it creates a perpetual policy machine that pushes for expansion. When 1% passes, $2.7B/year flows to people whose entire financial interest is getting the treaty to 2%. When 2% passes, $5.4B/year flows to people pushing for 5%.

The momentum for expansion *accelerates* with each success:

| Treaty Level | IAB Policy Funding | What It Buys |
|:-------------|:---------------------|:-------------|
| 1% | $2.7B/year | Passage pressure |
| 5% | $13.5B/year | Overwhelming outreach |
| 10% | $27B/year | Defense industry pivot |
| 50%+ | $135B+/year | War becomes economically obsolete |

This is why the [80/10/10 split](solution/incentive-alignment-bonds-foundations.qmd) exists. The 80% cures diseases. The 10% to investors pays back the people who funded the initial campaign. The 10% to policy incentives ensures the campaign never stops.

[VICTORY Incentive Alignment Bonds](economics/victory-bonds-foundations.qmd) are a specific [Incentive Alignment Bond](solution/incentive-alignment-bonds-foundations.qmd) - a single instrument that aligns investors (10% returns), policymakers (10% career incentives), and patients (80% cures) with the same outcome: expand treaty funding.
...
**Policymakers:** Public support + success
...
Notice that everyone's selfish reason for participating happens to save humanity. Incentivize people to do good by making good profitable.
...
This is the template for improving governance with systems that actually work. Not anarcho-capitalism or libertarian fantasy. Just pragmatic recognition that markets coordinate better than committees when you design them right.
...
- How Wishocracy prevents special interests from stealing all the money
...
In this case, the slightly less stupid thing is redirecting 1% of the defense budget to the not-dying budget.
