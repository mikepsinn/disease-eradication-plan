...
tags:
  ...
  - blowback
  - trade-protection
image: /assets/og-images/knowledge/appendix/cost-benefit-of-hegemony-og-bw-academic.jpg
scores:
  quality: 8
  value: 9
  timeliness: 10
  ...
  voice: 9
  importance: 9
audience: "A skeptic who believes the $886 billion buys real security and that cutting it is naive or dangerous."
feel: "Quietly stunned that the ledger is this lopsided, and that nobody made them do the subtraction before."
do: "Accept that the spending runs a net loss, and see redirecting 1% of it to clinical trials as the uncontroversial part."
---
...
It is also roughly 2-23% of the military budget that supposedly maintains it. You are spending $874 billion to earn $20-200 billion. Accountants call this a "negative return on investment." Your species calls it "national security."
...
Nobody publishes this ledger because the ledger is negative and publishing it would raise questions that military budgets are not designed to survive.
...
When someone pays for a service and gets a worse outcome than the person who does not pay, the non-payer is not a free rider. The payer is a victim.
...
How low is "skip the empire entirely"? Priced from first principles, the defense of the United States (a survivable nuclear second strike, homeland air and missile defense, the Coast Guard, the National Guard, cyber defense of infrastructure, and a mobilization hedge for a peer threat that has not yet emerged) comes to about {{< var us_defense_first_principles_optimal >}} per year, against current spending of {{< var us_military_spending_2024_annual >}}. That is a cut of roughly {{< var us_defense_first_principles_cut_pct >}}, derived threat by threat in [The Eisenhower Curve](../economics/eisenhower-curve.qmd). Posen and Cato land higher because they are still buying a trimmed hegemony. The homeland itself, defended at efficient prices, is cheap, because two oceans and a nuclear deterrent do most of the work for free.
...
A [1% treaty](../solution/1-percent-treaty.qmd) [@1-percent-treaty-paper-2025] [@1-pct-treaty-impact-paper-2025] asks for {{< var treaty_annual_funding >}} from this budget. Not 50%. Not 25%. One percent. Redirected to clinical trials so that humans might figure out which of the 9.5 million untested treatment combinations actually work.

That is the modest version. The immodest version is the overspend itself. At {{< var dfda_pragmatic_trial_cost_per_patient >}} a patient instead of the {{< var traditional_phase3_cost_per_patient >}} a traditional trial charges, one year of it would fund pragmatic trials for {{< var us_military_overspend_patients_fundable_nounit >}} people, about {{< var us_military_overspend_trial_capacity_multiplier >}} the {{< var current_trial_slots_available_nounit >}} who are in a trial today. (This is the same calculation as the treaty's {{< var dfda_trial_capacity_multiplier >}}, just scaled to the overspend: patients you can fund, against patients enrolled now.) That number sounds impossible only if you think the limit is a shortage of patients. It is not. Aging is a condition everyone has, and there are billions of people whose chronic diseases nobody has been paid to treat optimally. The limit was always the price of a trial, and pragmatic trials remove it.
...
- $r$ = interest rate reduction (range: 0.1-0.3 percentage points, midpoint 0.2)
