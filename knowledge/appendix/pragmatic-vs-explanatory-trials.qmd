...
tags:
  ...
  - trial-design
image: /assets/og-images/knowledge/appendix/pragmatic-vs-explanatory-trials-og-academic.jpg
---

{{< include /knowledge/includes/setup-parameters.qmd >}}

![](/assets/infographics/knowledge/appendix/pragmatic-vs-explanatory-trials-infographic-academic.jpg)
...
- **Systematic Review**: Median cost of {{< var pmc_pragmatic_trial_median_cost_per_patient >}}/patient across 64 trials [@pmc-pragmatic-trial-cost]
- **RECOVERY Trial Example**: Cost savings of ~80X compared to traditional trials
...
- [Up to 50.0% of research sites enroll one or no patients](../references.qmd#clinical-trial-enrollment-timelines)
