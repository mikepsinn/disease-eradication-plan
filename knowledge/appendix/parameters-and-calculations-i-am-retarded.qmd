...
This appendix documents all 8 parameters used in the analysis, organized by type:

- External sources (peer-reviewed): 4
- Calculated values: 2
- Core definitions: 2

### Quick Navigation

[Calculated Values](#sec-calculated) (2 parameters) • [External Data Sources](#sec-external) (4 parameters) • [Core Definitions](#sec-definitions) (2 parameters)
