...
## A first-of-its-kind *Caremark* derivative theory argues that defense industry lobbying is mathematically negative-ROI for the shareholders it claims to represent.

**[CITY, DATE]**: [PLAINTIFF NAME], a shareholder of [COMPANY] ([TICKER]), today filed a shareholder demand letter with the company's Board of Directors alleging that the company's annual lobbying expenditure of approximately $[X] million produces negative return on investment for its own shareholders.
...
"The math is straightforward," said [PLAINTIFF NAME]. "[COMPANY] is paying lobbyists to keep small the economy that funds [COMPANY]'s contracts. The Board has, on information and belief, never conducted an ROI analysis of this expenditure that accounts for its macroeconomic effect on the company's future revenue. Under *Caremark*, that analysis is not optional."
...
- **Cost to file:** approximately $3,000 in share purchases plus counsel time.
- **Damages theory:** lobbying expenditure suppresses GDP growth that funds the company's addressable market. Each [COMPANY] shareholder loses approximately {{< var treaty_trajectory_lifetime_income_gain_per_capita >}} in lifetime income compared to the alternative.
- **Proposed settlement:** redirect lobbying objective at zero incremental cost.
- **Legal basis:** *In re Caremark Int'l Inc. Derivative Litig.*, 698 A.2d 959 (Del. Ch. 1996); *Marchand v. Barnhill*, 212 A.3d 805 (Del. 2019); *Garfield v. Allen*, C.A. No. 2022-0837-JTL (Del. Ch. 2024); *Stone v. Ritter*, 911 A.2d 362 (Del. 2006).

### About the 1% Treaty Campaign

The International Campaign to End War and Disease is advocating for a global agreement under which each nation redirects 1% of its military budget to pragmatic clinical trials. The compressed disease eradication timeline (from {{< var status_quo_queue_clearance_years_nounit >}} years to {{< var dfda_queue_clearance_years_nounit >}} years) would recover approximately {{< var dfda_trial_capacity_plus_efficacy_lag_dalys >}} of healthy life-years across humanity. Full impact analysis at [warondisease.org](https://warondisease.org).
