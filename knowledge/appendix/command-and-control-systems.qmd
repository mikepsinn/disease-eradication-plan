---
title: The Ledger
description: "The feedback path and memory of the machine: a transparent record of every person, dollar, and vote, so the control loop can see what is happening and adjust. The cloud-database schema below is one implementation."
published: true
tags:
  - operations
  - systems
...
audience: "The operator setting up the DIH back office: the person who will actually build the database that tracks every person, dollar, and vote."
feel: "That the whole machine is buildable today with off-the-shelf tools, and that radical transparency is the design, not a slogan."
do: "Open a cloud database and build the tables in the order given, starting with the Personnel Roster."
---
{{< include /knowledge/includes/setup-parameters.qmd >}}
Every control loop in the [Theory of Operation](../solution/theory-of-operation.qmd) needs somewhere for the measurements to live and a wire to carry them back to the controller. This is that somewhere: the **ledger**, the machine's feedback path and its memory. It is the transparent record of every person, dollar, and vote, so the loop can tell what is actually happening and correct it. The cloud-database schema below is one way to build it; the principle is what matters: record what the machine did, measure the result, keep it where the controller and everyone else can see. Radical transparency is not a virtue here. It is the sensor cable.

*The ledger for your decentralized institutes of health (DIH) (Or: How to Track {{< var global_population_2024_nounit >}} People Without Being Creepy)*
...
![A database where the people table connects to everything else, because organizations are made of people. Military-grade insight.](/assets/images/command-and-control-systems/command-and-control-systems-section-the-architecture-hub-spoke-model-bw-academic.jpg)
...
![The person table has lines to the division table, the project table, and the bond table. This is called a database.](/assets/images/command-and-control-systems/command-and-control-systems-section-fields-that-matter-bw-academic.jpg)
...
![When someone does something in a campaign, you write down who and what. Revolutionary data architecture.](/assets/images/command-and-control-systems/command-and-control-systems-section-what-you-track-bw-academic.jpg)
...
![A job has applicants. Applicants become employees or don't. This required entity-relationship modeling.](/assets/images/command-and-control-systems/command-and-control-systems-section-the-hiring-pipeline-bw-academic.jpg)
...
![Divisions have people, leaders, goals, and work. We connected these with lines.](/assets/images/command-and-control-systems/command-and-control-systems-section-your-command-structure-bw-academic.jpg)
...
![Tasks have people who do them and campaigns they belong to. The database knows which is which.](/assets/images/command-and-control-systems/command-and-control-systems-section-project-management-for-revolutionaries-bw-academic.jpg)
...
![Someone pays someone for something. We write down who, how much, and why. Accountants call this double-entry bookkeeping.](/assets/images/command-and-control-systems/command-and-control-systems-section-the-money-trail-bw-academic.jpg)
...
![Big goals connect to people who do small tasks. The database remembers which people do which tasks for which goals.](/assets/images/command-and-control-systems/command-and-control-systems-section-strategic-initiative-tracking-bw-academic.jpg)
...
![You write a message, schedule it, and send it to people. This process needed a flowchart.](/assets/images/command-and-control-systems/command-and-control-systems-section-message-management-bw-academic.jpg)
...
![Images and videos belong to campaigns. The database tracks which image belongs to which campaign. Database architecture at its finest.](/assets/images/command-and-control-systems/command-and-control-systems-section-creative-arsenal-bw-academic.jpg)
...
![People invest in bonds. Bonds fund engagements. The database tracks who invested in what. This is called a foreign key.](/assets/images/command-and-control-systems/command-and-control-systems-section-investment-tracking-bw-academic.jpg)
...
![The democracy theater table connects to people and campaigns. Every political gesture requires proper database normalization.](/assets/images/command-and-control-systems/command-and-control-systems-section-democracy-theater-bw-academic.jpg)
...
![Step 1: Contact diplomat. Step 2: Lobby diplomat. Step 3: They say yes or no. This workflow required boxes and arrows.](/assets/images/command-and-control-systems/command-and-control-systems-section-diplomatic-scorecard-bw-academic.jpg)
...
- `Notes` (Long Text) - "Senator owns weapons manufacturer stock"
...
![Build the people table first, then build the tables that reference people. We made a flowchart about doing things in order.](/assets/images/command-and-control-systems/command-and-control-systems-section-database-construction-roadmap-bw-academic.jpg)

## The Privacy Paradox

![Some data needs privacy (votes, health). Some needs transparency (money, politics). We put them on a chart to show they're different.](/assets/images/command-and-control-systems/command-and-control-systems-section-the-privacy-paradox-bw-academic.jpg)
...
![Everyone uses the same database to coordinate not dying. Transparency, accountability, and cloud storage defeat mortality.](/assets/images/command-and-control-systems/command-and-control-systems-section-the-result-bw-academic.jpg)
