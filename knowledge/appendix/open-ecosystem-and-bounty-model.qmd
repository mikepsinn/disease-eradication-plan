...
Build the foundation (core API and data standards), pay bounties for critical features nobody wants to build first, and let everyone else build everything else for free. You build the foundation. Strangers build everything on top of it. For free. Because some of them are dying.
