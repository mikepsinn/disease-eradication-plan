...
![A comparison between the grant model, which funds proposals and promises, and the bounty model, which issues payment only after functional code is delivered.](/assets/images/open-ecosystem-and-bounty-model/open-ecosystem-and-bounty-model-section-bounties-and-prizes-paying-for-results-not-promises-bw-academic.jpg)
