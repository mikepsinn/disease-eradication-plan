...
Full methodology details, LaTeX equations, sensitivity analyses, and Monte Carlo distributions are available at [https://dfda-spec.warondisease.org/knowledge/appendix/parameters-and-calculations.html](https://dfda-spec.warondisease.org/knowledge/appendix/parameters-and-calculations.html).
:::
...
This appendix documents all 13 parameters used in the analysis, organized by type:
...
[Calculated Values](#sec-calculated) (3 parameters) • [External Data Sources](#sec-external) (8 parameters) • [Core Definitions](#sec-definitions) (2 parameters)
