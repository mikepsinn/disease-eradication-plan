...
image: /assets/og-images/knowledge/appendix/humanity-manager-employment-agreement-og-bw-academic.jpg
published: true
tags:
  - eos
  - humanity-manager
...
scores:
  ...
  voice: 9
  importance: 6
audience: "everyone (reader who accepted the president role)"
feel: "the job is real but easy (one day a year); the structure protects you from corruption; amused by the recursive company; the diseases are grading you"
do: "do the five duties on August 6; sign the mandatory disclosure; print the certificate"
---

{{< include ../includes/setup-parameters.qmd >}}

Congratulations, you are the president of the largest company on planet earth!
...
- **Send a [love letter](love-letter.qmd)** to the board of a company currently lobbying your government to spend your money on mass murder instead of on curing you. Owning a single [share](lawsuit.qmd#execution-sequence) makes you a shareholder they are obliged to read; buy one, or have a friend gift you one, if you want the extra teeth. The share is optional. The love letter is not.
- **Remind your employees** it is the big day. You have several billion; two is a fine place to start.
- And the main event: **sneak into all your friends' bedrooms and write "this t-shirt ended war and disease" on all of their t-shirts.** The funniest joke in the universe, played once a year, by everyone, at once.

That is the whole job. One day. Read the employee manual whenever you like before then, and if you want a hand finding the one move only you can make, a call with Mike is yours, early birds first, since he cannot reach all eight billion of you at once. Spend the other 364 days however you please. You run the planet now.
...
**8. Uniform.** The [official uniform](joke.qmd) is a shirt that reads "this t-shirt ended war and disease." A permanent marker and any other shirt is a perfectly acceptable substitute. Wearing it is how the other Managers find you.

**9. Compensation.** And now, compensation! The job pays a planet with less suffering and fewer funerals on it, and it pays on commission. Sell Earth the **Light package** (the [1% Treaty](../solution/1-percent-treaty.qmd)) and your commission is roughly {{< var treaty_trajectory_lifetime_income_gain_per_capita >}} in extra lifetime income. Upsell to the **Deluxe** ([full optimization](../futures/wishonia.qmd)) and it is {{< var wishonia_trajectory_lifetime_income_gain_per_capita >}}, plus the healthy years to spend it in, all itemized for your exact situation in [Your Personal Benefits](../call-to-action/your-personal-benefits.qmd). The commission pays every President on Earth the moment any one of you closes the sale, an arrangement other companies call a broken incentive and we call the product. [Referral bonuses](../strategy/earth-optimization-prize.qmd) for every Manager you bring aboard are separate, and stack. You are not paid in control, because being paid in control was the entire problem.
...
**Pass condition:** Question 1 is yes. Everything else, you now know, which was the actual point of the exam.
...
<div class="hma-cert">
  <div class="hma-cert-inner">
    ...
    <div class="hma-cert-body">
      ...
      and is qualified to manage humanity.
    </div>
    <div class="hma-cert-date">Date: ________________</div>
    <div class="hma-cert-sig">
      <div class="hma-cert-sigline">___________________________</div>
      <div class="hma-cert-signame">Wishonia</div>
      <div class="hma-cert-sigtitle">Instructor</div>
    </div>
  </div>
</div>
...
.hma-cert-date { font-size: 0.95rem; margin-top: 1rem; }
.hma-cert-sig { margin-top: 1.4rem; }
.hma-cert-sigline { letter-spacing: 0.04em; }
.hma-cert-signame { font-weight: 700; margin-top: 0.3rem; }
.hma-cert-sigtitle {
  font-size: 0.85rem;
