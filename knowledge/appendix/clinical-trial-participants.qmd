...
Here's a fun fact: humanity spends [{{< var global_clinical_trials_spending_annual >}} a year on clinical trials](../references.qmd#industry-clinical-trial-spending-estimate), but **nobody tracks how many people actually participate**.
...
And we'd only be using **3.6% of available capacity** (43.4M ÷ 1.2 billion willing participants).
