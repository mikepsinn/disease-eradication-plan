...
tags:
  ...
  - assurance-contracts
  - metaculus
image: /assets/og-images/knowledge/appendix/investor-risk-analysis-og-academic.png
---
{{< include /knowledge/includes/setup-parameters.qmd >}}

![Infographic](/assets/infographics/knowledge/appendix/investor-risk-analysis-infographic-academic.png)
...
- **This Initiative's Risk Profile:** This initiative is a political effort to realign global resources towards critical public goods. The primary risk is **Political Risk**. Will a 1% treaty be ratified? This is not trying to create a new market; this is investing to **redirect a massive, pre-existing cash flow** ([$2.72 trillion in annual military spending](../references.qmd#sipri2024)). The "market" is already validated and capitalized.
