...
- Funding technology development and operational scaling for a dFDA.
...
To maximize the effectiveness of the [dFDA Infrastructure](../solution/dfda.qmd), we recommend HHS sponsor an **FDA-X Prize** (\$500 million) to incentivize creation of an open-source decentralized framework for drug assessment protocol enabling perpetual, patient-driven clinical trials.
