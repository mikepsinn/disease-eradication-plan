...
description: How to navigate election law, securities regulations, and international coordination without going to prison.
published: true
tags:
  - legal-compliance
  - election-law
  ...
  - international-law
  - regulatory
image: /assets/og-images/knowledge/appendix/legal-compliance-framework-og-retro-academic.jpg
---
{{< include /knowledge/includes/setup-parameters.qmd >}}

![](/assets/infographics/knowledge/appendix/legal-compliance-framework-infographic-retro-academic.jpg)


A [1% treaty](../solution/1-percent-treaty.qmd) initiative faces three critical legal challenges: **foreign national election funding restrictions**, **securities law compliance for [VICTORY Incentive Alignment Bonds](../economics/victory-bonds.qmd)**, and **international coordination of legal structures**. This document provides a detailed compliance strategy.
...
- **FEC Definition:** "Foreign national" includes foreign governments, foreign political parties, foreign corporations, and foreign individuals [@fec-foreign-nationals]
- **Penalties:** Criminal prosecution and civil penalties up to \$100,000+ per violation [@feca-violation-penalties]
...
![Visualizing the 'Domestic-Only' compliance structure, demonstrating the strict legal and technical firewall required between US political operations and international treaty coordination to comply with FECA.](/assets/images/legal-compliance-framework/legal-compliance-framework-section-domestic-only-firewall-structure-bw-academic.jpg)
...
- **Howey Test:** Investment of money + common enterprise + expectation of profits + from efforts of others = security (Howey Test Securities Definition [@howey-test-securities])
...
The compliance strategy is designed to achieve the goal of mass participation while navigating global securities laws, leveraging the SEC's more innovation-friendly guidance as of August 2025 [@sec-innovation-guidance-2025]. It separates the initial, non-financial airdrop from the subsequent distribution of valuable governance tokens.
...
This phase occurs only _after_ a 1% treaty is successfully ratified and the [1% Treaty Fund](../solution/dih.qmd) is funded. This is the point at which a security is distributed, and it will be handled in a fully compliant manner.
...
- **Legal Rationale & Safe Harbor:** This conversion event will be structured to fall within the SEC's "safe harbor" provisions [@peirce-token-safe-harbor] for networks that have become sufficiently decentralized. By the time of conversion, the primary "work of the promoters" (getting the treaty passed) is complete. The VICTORY Incentive Alignment Bond's function is now primarily for utility, governing the active, funded 1% Treaty Fund, which strengthens the case for a more favorable regulatory treatment.

**Fundraising from Accredited Investors (Reg D / Reg S)**

The initial "activation energy" from sophisticated investors (VCs, funds, etc.) will still be raised via a traditional private placement for VICTORY [Incentive Alignment Bonds](https://iab.warondisease.org) and tokens, conducted in full compliance with Regulation D [@sec-reg-d] (for U.S. accredited investors) and Regulation S [@sec-reg-s] (for non-U.S. investors). This ensures the core financing is secure while the mass distribution is handled via the safer "Points-then-Conversion" model.


![Timeline of the Two-Phase 'Points-then-Conversion' model, illustrating how the asset transitions from a non-security utility point to a governance token only after the network is decentralized and funded.](/assets/images/legal-compliance-framework/legal-compliance-framework-section-token-conversion-timeline-bw-academic.jpg)
...
![Global jurisdictional map assigning specific functional roles (Treaty, Token, Tech, Elections) to the optimal legal entities and countries.](/assets/images/legal-compliance-framework/legal-compliance-framework-section-jurisdictional-entity-map-bw-academic.jpg)
...
- **Spending Limits:** Comply with controlled expenditure limits (UK Electoral Commission Spending Limits [@uk-electoral-spending-limits]) (\$500K+ requires registration) [@uk-electoral-registration-threshold-500k]
...
- **Foreign Interference:** Comply with Bill C-76 foreign influence restrictions [@canada-bill-c-76]
- **Spending Limits:** Pre-election and election period spending caps
- **Disclosure Requirements:** Real-time reporting of expenditures over \$500 [@canada-expenditure-reporting-500]
...
- Submit VICTORY Incentive Alignment Bond structure for regulatory review
...
- Successful securities law exemption for VICTORY Incentive Alignment Bonds
...
- International coordination achieves alignment without legal coordination
...
Building on the compliance requirements outlined above, this framework uses a sophisticated multi-entity structure that separates charitable, political, and investment activities while keeping everything aligned.

```{python}
#| fig-alt: "Three main entities: For-Profit Entity (accepts investments, funds development of a decentralized framework for drug assessment), 501(c)(3) Public Charity (accepts tax-deductible donations, focuses on education), 501(c)(4) Social Welfare Org (accepts non-deductible donations, focuses on advocacy). Funding sources connect to each entity. Education informs Advocacy, which creates mandate for For-Profit."
import graphviz
...
dot = graphviz.Digraph(comment='Multi-Entity Legal Structure', format='png')
dot.attr(rankdir='TD', size='12,14')
setup_graphviz_style(dot)

with dot.subgraph(name='cluster_initiative') as initiative:
    initiative.attr(label='1% treaty Initiative', style='dashed')
...
dot.node('D', 'Decentralized Drug Assessment Framework\nInfrastructure & Operations')
...
dot.edge('A', 'Investors', label='Sells VICTORY Incentive Alignment Bonds')
...
png_path = render_graphviz_with_watermark(dot, 'multi-entity-legal-structure')
display(IPImage(str(png_path)))
```

#### 1. The 501(c)(3) Public Charity: "The Educator and Mobilizer"

**Primary Purpose:** Conduct a non-binding global public opinion survey/engagement initiative to demonstrate {{< var global_population_activism_threshold_pct >}} support ({{< var treaty_campaign_voting_bloc_target >}}+ verified participants) and build broad public understanding through non-partisan research and education.

#### Permitted Activities

- Conducting a non-binding global public opinion survey on War and Disease
- Publishing white papers, economic models, and planning documents (like this book)
- Developing and maintaining public-facing website, engagement platform, and educational materials
- Hosting forums, webinars, and workshops
- Conducting non-partisan analysis and research
- Hiring staff for research, communications, educational programs, and engagement operations

**Funding:** Tax-deductible donations from individuals and foundations.

**Limitations:** Strictly prohibited from substantial lobbying or partisan political activity. The survey must be non-binding and educational, demonstrating public will without telling politicians what to do.
...
**Primary Purpose:** Issue and manage private investment instruments (e.g., 'Project VICTORY Tokens/Bonds') to fund initial development and operations for a decentralized framework for drug assessment (dFDA), providing investor returns. This entity's work is distinct from, but aims to enable, the future issuance of **government-issued VICTORY Incentive Alignment Bonds** which will ultimately fund the 1% Treaty Fund following a 1% treaty's ratification.

#### Permitted Activities

- Issuing private investment securities and managing investor relations to fund pre-treaty initiative development.
- Funding technology development and operational scaling for a decentralized framework for drug assessment.
- Upon ratification of a 1% treaty, this entity may transition to managing operational infrastructure for the 1% Treaty Fund and facilitating the mechanisms for investor payouts related to the government-issued VICTORY Incentive Alignment Bonds.
...
**Legal compliance is achievable through strict entity separation, jurisdiction-specific expertise, and conservative interpretation of regulations.** Build strict firewalls between international strategy and domestic political activities while maintaining coherence through public commitments rather than private coordination.
