...
The initial "activation energy" from sophisticated investors (VCs, funds, etc.) will still be raised via a traditional private placement for VICTORY [Incentive Alignment Bonds](incentive-alignment-bonds-paper.qmd) and tokens, conducted in full compliance with Regulation D [@sec-reg-d] (for U.S. accredited investors) and Regulation S [@sec-reg-s] (for non-U.S. investors). This ensures the core financing is secure while the mass distribution is handled via the safer "Points-then-Conversion" model.
