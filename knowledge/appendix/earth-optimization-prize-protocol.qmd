...
1. **Yes or no on the [1% Treaty](../solution/1-percent-treaty.qmd) [@1-percent-treaty-paper-2025] [@1-pct-treaty-impact-paper-2025].** "Should 1% of military spending be redirected to clinical trials?" Binary, concrete, the specific political demand that politicians can act on. Public-facingly, this produces the VOTE point/game score; formally, it produces the VOTE claim eligibility and the scoreboard headcount (political pressure). The [1% Treaty](../solution/1-percent-treaty.qmd) is also the thing that [IABs](../solution/incentive-alignment-bonds.qmd) [@iab-paper-2025] fund the lobbying campaign for, so the voter count directly feeds the financial instrument's value.
