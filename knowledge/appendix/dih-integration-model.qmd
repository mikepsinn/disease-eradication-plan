...
description: How your DIH functions as an insurance-like layer that seamlessly integrates with existing healthcare infrastructure
published: true
tags:
  - dih
  - integration
  - insurance-model
  - healthcare-system
image: /assets/og-images/knowledge/appendix/dih-integration-model-og-retro-academic.jpg
audience: "A skeptic (or operator) who fears this replaces the healthcare system and can't actually plug into hospitals, doctors, and pharmacies."
feel: "Reassured that this slots into the system everyone already uses, costs a $30 copay, and asks nobody to tear anything down."
do: "Accept that the insurance-layer model fits existing care, and carry that into the chapter that sent you here."
---
...
dot.node('B', 'Decentralized Institutes of Health')
...
dot.node('J', 'Drug Assessment Database')
...
## Why This Works Better Than Direct Payments
...
![Getting experimental cancer treatment used to take six months and a lawyer. Now it takes six clicks. The lawyers are very upset.](/assets/images/dih-integration-model/dih-integration-model-section-real-world-example-workflow-bw-academic.jpg)
...
![Everyone makes money when patients get better faster. You had to draw a diagram to explain why this might be worth doing.](/assets/images/dih-integration-model/dih-integration-model-section-who-gets-what-bw-academic.jpg)
...
**Traditional trial cost per patient:** $6,800-13,600/month [@trial-costs-fda-study]
...
![Your healthcare system is like a sandwich. This adds a new layer so the sandwich can learn which ingredients make people less dead.](/assets/images/dih-integration-model/dih-integration-model-section-integration-strategy-bw-academic.jpg)
