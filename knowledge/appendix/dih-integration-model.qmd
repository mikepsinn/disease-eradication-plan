...
dot.node('H', 'Patient Copay {{< var lobbyist_bond_investment_max_millions >}}-50')
...
- Pays {{< var recovery_trial_cost_per_patient >}}/month for branded drug
...
6. Sarah pays {{< var average_us_hourly_wage >}} copay
...
- **Patient copay: {{< var lobbyist_bond_investment_max_millions >}}-50/month**
- Data collection: {{< var vsl_epa_millions >}}/month (automated)
...
1. **Affordable access** to experimental treatments ({{< var lobbyist_bond_investment_max_millions >}}-50 copay)
...
- 10 health systems
- 5 disease areas
- {{< var dfda_large_trial_size >}} patients
