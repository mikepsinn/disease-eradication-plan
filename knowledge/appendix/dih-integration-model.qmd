...
![](/assets/infographics/knowledge/appendix/dih-integration-model-infographic-retro-academic.jpg)
...
![Step-by-step workflow of the patient journey within the DIH integration, demonstrating the streamlined enrollment and treatment process compared to traditional friction points.](/assets/images/dih-integration-model/dih-integration-model-section-real-world-example-workflow-bw-academic.jpg)
...
![A stakeholder map illustrating how doctors, pharmacies, hospitals, and insurers each benefit from clinical trial participation and outcomes.](/assets/images/dih-integration-model/dih-integration-model-section-who-gets-what-bw-academic.jpg)
...
![A diagram showing the DIH 'experimental treatment insurance layer' as a complementary addition that wraps around existing healthcare infrastructure to enable clinical trial participation.](/assets/images/dih-integration-model/dih-integration-model-section-integration-strategy-bw-academic.jpg)
