...
description: 'Op-ed template, social media kit (tweet thread, LinkedIn post, video script), interview Q&A with the most likely reporter questions, and the T+60d follow-up press release. Everything the plaintiff needs to handle the media side of the filing without freelancing each piece.'
image: /assets/og-images/knowledge/appendix/plaintiff-media-kit-og-bw-academic.png
aliases:
...
If you are a shareholder of any major military contractor, you can do exactly what I did. One share. Two hundred dollars. The template is at [warondisease.org/lawsuit](https://warondisease.org/lawsuit). There are eight pre-filled demand letters ready to print. The Board has to respond to whoever sent the letter, regardless of who sent it.
...
**5.** You can do this too. 1 share = ~$200. Template + 8 pre-filled letters at warondisease.org/lawsuit. One share starts the same 60-day clock a million shares would. RT this to the next shareholder. We love the board. We are also not going away.
...
No. We love them and we do not want them and everyone they have ever loved to be slowly tortured and brutally murdered by horrible diseases. The lawsuit is the only mechanism we have to put the math in front of them in a form they are legally required to read. We are asking them to redirect the existing lobbying budget so that none of us has to die of a disease we could cure if we funded the trial.
...
The company's revenue is denominated in a fraction of US federal spending. US federal spending is denominated in a fraction of US GDP. The campaign's published model, built on SIPRI, WHO, NIH, and OpenSecrets data and anchored to peer-reviewed instrumental-variables estimates of military spending's growth effect, projects global GDP at year 15 of approximately {{< var treaty_trajectory_gdp_vs_current_trajectory_multiplier_year_15 >}} the current trajectory, through reduced disease burden and accelerated productivity. Every derivation is public. So the 1% they're "protecting" through lobbying is dominated by the gain they'd get from operating in that larger economy.
...
The lawsuit theory applies to every major military prime. Pre-filled demand letters exist for all 8 (Lockheed, RTX, Boeing, GD, Northrop, L3Harris, HII, Leidos). [COMPANY] is the first/early defendant because of [pick: largest, most prominent CEO, largest lobbying spend, state of incorporation].
...
> [CITY, DATE]: [COMPANY]'s Board of Directors has agreed to commission an independent ROI analysis of the company's federal lobbying expenditure, in response to a shareholder demand letter filed sixty days ago. [PLAINTIFF NAME] welcomed the response: "This is the right move. The Board has chosen to let their own grandchildren live longer. I hope every military contractor board does the same." The analysis is scheduled for [TIMELINE] and will be published on the company's investor relations website. The same demand letter template has now been filed against [N] other military contractors.
