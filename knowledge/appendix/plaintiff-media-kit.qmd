...
The full love letter, supporting calculations, and underlying treaty proposal are available at [warondisease.org/lawsuit](https://warondisease.org/lawsuit). The campaign's broader analysis of why the 1% redirection benefits every party, including [COMPANY]'s own executives and board members, is at [warondisease.org/where-am-i-wrong](https://warondisease.org/where-am-i-wrong).
...
**Headline:** I sued the board of a military contractor because I love them.
...
Last week I mailed a shareholder love letter to the Board of [COMPANY]. I own one share. I paid $[X] for it.

They are going to die of something preventable. So am I. The Board of [COMPANY] signs off every year on a lobbying budget that keeps the ratio of military spending to clinical-trial spending at {{< var military_to_government_clinical_trials_spending_ratio >}} to 1. That ratio is why the cures do not exist yet. The Board has never asked whether this is good for the people who own the shares. The lawsuit asks them to.

The mechanism is small. [COMPANY] spends approximately $[X] million a year on federal lobbying. The lobbying is pointed at maintaining the ratio of US military spending to government clinical-trial spending, currently {{< var military_to_government_clinical_trials_spending_ratio >}} to 1. The trials that would tell us which compounds cure pancreatic cancer, Alzheimer's, ALS, and cardiovascular disease are not being funded because the funding ratio is what it is because the lobby tells Congress to keep it that way.
...
The math is in the love letter, sourced entirely from SIPRI, the WHO, the NIH, OpenSecrets, and [COMPANY]'s own SEC filings. The legal theory is *Caremark*, *Marchand*, *Stone v. Ritter*. A board that knowingly continues an expenditure shown to be negative-ROI for its own shareholders is in conscious disregard of a known risk. The love letter creates the record.
...
If you are a shareholder of any major military contractor, you can do exactly what I did. One share. Two hundred dollars. The template is at [warondisease.org/lawsuit](https://warondisease.org/lawsuit). There are eight pre-filled love letters ready to print. The Board has to respond to whoever sent the letter, regardless of who sent it.
...
**1.** Today I sued the board of [COMPANY]. I love them and I do not want them and everyone they have ever loved to be slowly tortured and brutally murdered by horrible diseases. The lawsuit is the only legal mechanism to make them read the math showing their lobbying is killing them, their families, and their shareholders. 🧵
...
Reshare the op-ed link: "Today I filed a shareholder love letter against the Board of [COMPANY] under *Caremark*. The company's $[X]M annual lobbying budget loses money for its own shareholders. The math: [op-ed link]."

### Video script (optional, 60-90 seconds vertical for TikTok/Reels/Shorts)

If you want to shoot one: open with "Today I sued a military contractor for $200" on camera holding the share, hit the {{< var military_to_government_clinical_trials_spending_ratio >}}:1 ratio + the {{< var status_quo_queue_clearance_years_nounit >}}→{{< var dfda_queue_clearance_years_nounit >}} years compression + the {{< var treaty_trajectory_gdp_vs_current_trajectory_multiplier_year_15 >}} GDP point, close with "1 share, ~$200, template at warondisease.org/lawsuit."
...
I'm not suing for damages. I'm asking the Board of [COMPANY] to check whether their $[X] million annual lobbying budget actually helps the company, once you account for what the lobbying does to the economy that funds the company's contracts. The settlement is that they point the same lobbyists at the 1% treaty instead of at keeping military budgets high. No extra cost to the company.
