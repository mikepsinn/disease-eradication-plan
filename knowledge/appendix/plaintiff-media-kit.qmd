...
As far as anyone can tell, this is the first lawsuit in legal history where the defendants are radically better off losing than winning. Settle and the Board members are two to three times wealthier and ten to twenty years longer-lived. Fight and win and they stay on the trajectory that will, in expected value, kill them and their families a decade or two earlier than the math says they could have lived. That is not metaphor. That is the actuarial table.
