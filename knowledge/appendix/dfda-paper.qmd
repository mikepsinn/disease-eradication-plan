...
- Cost: Average Phase III trial costs $19M and takes 3+ years [@phase-3-cost-per-trial-range]
...
| **Stage 2: Causal Confirmation** | Pragmatic randomized trials | ~$500/patient | Causation proof | Validated effect sizes |
...
The Oxford RECOVERY trial demonstrated this model's effectiveness: 49,000 patients enrolled across 186 hospitals, 12 treatments evaluated, first life-saving result (dexamethasone) in 100 days, over 1 million lives saved globally [@recovery-trial-1m-lives-saved].
...
2. **Stage 2: Causal confirmation**: Pragmatic randomized trials following the RECOVERY/ADAPTABLE model confirm top signals at ~$500/patient (80× cheaper than traditional trials) while eliminating confounding
...
- Confirms top signals through embedded pragmatic trials at 80× lower cost than traditional methods
