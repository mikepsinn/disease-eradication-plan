...
If that model is approximately correct, the Company's lobbying is suppressing the long-term growth of its own addressable market and is delaying the development of the treatments that would otherwise extend the lives of every Board member and every shareholder. Each shareholder loses approximately {{< var treaty_trajectory_lifetime_income_gain_per_capita >}} in lifetime income, plus an actuarially significant number of healthy life-years.
