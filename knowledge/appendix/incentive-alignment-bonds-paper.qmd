...
abstract: |
  ...
  alternatives. The mechanism requires no legislative change: existing PAC infrastructure, impact bonds, and
  prediction markets can deploy it today. Analysis of a proposed 1% Treaty redirecting {{< var treaty_annual_funding >}}
  annually from military spending to medical research shows expected returns exceeding 100:1 for early
  investors. The 90:1 capital asymmetry ({{< var global_household_wealth_usd >}} in household wealth vs.
  {{< var concentrated_interest_sector_market_cap_usd >}} for concentrated interests) means diffuse
  beneficiaries can outspend incumbent lobbies once coordination problems are solved. IABs solve that
  coordination problem by turning political change into an investable asset class.
aliases:
  - /iab.html
author:
  - name: Mike P. Sinn
...
format:
  ...
  pdf:
    ...
    geometry: margin=1in
    fontsize: 11pt
image: /assets/og-images/knowledge/appendix/incentive-alignment-bonds-paper-og-academic.jpg
---
{{< include /knowledge/includes/setup-parameters.qmd >}}

![](/assets/infographics/knowledge/appendix/incentive-alignment-bonds-paper-infographic-academic.jpg)
...
**Comments welcome.** If you have expertise in mechanism design, political economy, campaign finance, or public choice theory, your feedback would be greatly valued. Please contact [mike@warondisease.org](mailto:mike@warondisease.org).
...
**Seeking peer review and contributions.** If you have expertise in mechanism design, political economy, campaign finance, or public choice theory, your feedback and potential co-authorship would be greatly valued. Please annotate via the sidebar or contact [mike@warondisease.org](mailto:mike@warondisease.org).
...
Government spending correlates with lobbying intensity, not marginal societal value. Programs with benefit-cost ratios exceeding 100:1 (vaccines, e-governance) receive single-digit billions while programs with negative net returns (military beyond deterrence, fossil fuel subsidies) receive hundreds of billions. This paper introduces Incentive Alignment Bonds (IABs), financial instruments that realign politician incentives with net societal value optimization. IABs create a capital pool that rewards politicians (via campaign support and post-office career opportunities) for funding high-NSV programs over low-NSV alternatives.

The mechanism requires no legislative change: existing PAC infrastructure, impact bonds, and prediction markets can deploy it today. Analysis of a proposed 1% Treaty redirecting {{< var treaty_annual_funding >}} annually from military spending to medical research shows expected returns exceeding 100:1 for early investors. The 90:1 capital asymmetry ({{< var global_household_wealth_usd >}} in household wealth vs. {{< var concentrated_interest_sector_market_cap_usd >}} for concentrated interests) means diffuse beneficiaries can outspend incumbent lobbies once coordination problems are solved. IABs solve that coordination problem by turning political change into an investable asset class.

For economists: We formalize political incentive alignment as a mechanism design problem, prove conditions for Nash equilibrium, and provide numerical calibration showing feasibility with realistic parameters. We analyze legal constraints under U.S. anti-bribery law, demonstrate extensions to climate and nuclear risk, and show the mechanism's benefit-cost ratio exceeds {{< var iab_mechanism_benefit_cost_ratio >}}.
...
Mancur Olson's seminal work *The Logic of Collective Action* [-@olson1965] established that groups with concentrated interests (small groups with huge per-person stakes, like military contractors) systematically outcompete groups with diffuse interests (millions of people with small individual stakes, like citizens who'd benefit from cures) in political competition. Why? A small group facing large per-member stakes will invest more in lobbying than a large group facing small per-member stakes. This holds even when total welfare losses exceed total welfare gains. The beneficiaries of inefficient policies (military contractors, pharmaceutical incumbents, fossil fuel producers) are concentrated. The beneficiaries of efficient policies (citizens who would benefit from cures, climate stability, reduced existential risk) are diffuse.
...
- **{{< var global_household_wealth_usd >}} vs. {{< var concentrated_interest_sector_market_cap_usd >}} capital asymmetry** ensures diffuse beneficiaries (citizens who'd benefit from cures) can outspend concentrated opposition (military contractors) by 90:1 (Section 2.3)
...
- **Concentrated interests:** Small groups with huge per-person stakes (military contractors losing billions)
...
- **ROI (Return on Investment):** Profit divided by cost. A 200% ROI means you get $3 back for every $1 invested (your original $1 plus $2 profit)
- **Capital asymmetry:** Unequal distribution of wealth ({{< var global_household_wealth_usd >}} households vs. {{< var concentrated_interest_sector_market_cap_usd >}} military contractors)
...
- **NSV (Net Societal Value):** Total benefit minus total cost to society
- **DALYs:** Disability-Adjusted Life Years. This is a measure of disease burden combining mortality and quality of life
- **VSL (Value of Statistical Life):** How much society values preventing one death (EPA uses ~{{< var value_of_statistical_life >}})
...
- **Defense:** The top five military contractors spent $1.1 billion on lobbying over two decades while receiving $2.02 trillion in Pentagon contracts, an implied maximum ROI of approximately **181,000%** assuming full attribution [@responsiblestatecraft2021].
...
**Illustrative calculation:** If a campaign costs {{< var iab_bootstrap_campaign_cost >}} and has a 20% chance of passing a treaty that redirects {{< var treaty_annual_funding >}}/year (with 10% to investors), the expected annual value is:
...
| Parameter | Base Case | 95% CI Range | ROI Impact |
|:----------|:----------|:-------------|:-----------|
| Success probability | 20% | 10%–40% | 36%–2,076% |
| Campaign cost | {{< var iab_bootstrap_campaign_cost >}} | $50M–$200M (95% CI) | Scales inversely |
| Investor share | 10% | 10%–15% | Scales linearly |
| Treaty size | {{< var treaty_annual_funding >}}/year | 1×–2× base | Scales linearly |

Even under conservative assumptions (10% success probability, upper CI bound on campaign cost, 10% investor share, {{< var treaty_annual_funding >}} treaty), expected first-year ROI remains positive at 36%. This is significantly higher than traditional asset classes. The calculation demonstrates that the mechanism is economically rational for risk-tolerant capital across a wide parameter range, not dependent on optimistic assumptions.
...
- **Concentrated interests** (military contractors, fossil fuel companies, pharmaceutical incumbents): Combined market capitalization ~{{< var concentrated_interest_sector_market_cap_usd >}}[^capital-estimate]
...
"Why Previous Approaches Failed" reviews the relevant literature on mechanism design, public choice, Social Impact Bonds, and campaign finance. "The Math" presents the formal model, defining the politician's utility function and proving incentive compatibility. "How IABs Work in Practice" details the three-layer architecture and its legal basis. "What Could Go Wrong" analyzes potential failure modes and limitations. "Where IABs Fit" discusses the broader governance stack. "Beyond Health" extends the mechanism to climate, nuclear risk, and pandemic preparedness. The Conclusion summarizes contributions and open questions.

## Why Previous Approaches Failed {#sec-literature}

**The short version:** Economists have known about the collective action problem for 60 years. They've proposed solutions. None have worked at scale because they either (a) require politicians to be altruistic, (b) target the wrong actors, or (c) lack teeth. IABs are different because they make self-interest and public interest point the same direction.
...
1. **Investor pressure for expansion:** Investors receiving 10% of {{< var treaty_annual_funding >}} want 10% of double that (if the treaty expands to 2%), creating a constituency that lobbies for treaty growth
...
The IAB mechanism transforms the incentive landscape. The concentrated costs (military contractor opposition) remain, but they are now outweighed by concentrated benefits (score increases, electoral support, career advancement). Supporting the treaty becomes the utility-maximizing choice.
...
**Calibration exercise.** Consider a senator facing concentrated opposition of $c_i = \$2\text{M}$ from military contractors. Under the IAB mechanism with political incentive funding of {{< var iab_political_incentive_funding_annual >}} annually:
...
**The short version:** Three interlocking systems make it work. (1) A nonprofit publishes "Public Good Scores" for every politician based on their voting record on high-NSV policies. (2) PACs and Super PACs commit to supporting high-scorers with campaign spending. (3) A network of post-government employers preferentially hires high-scorers. All three are legal. Together, they make funding high-NSV programs the career-maximizing choice.
...
**The short version:** Three main risks: (1) Politicians game the scoring system without improving NSV outcomes. (2) Wealthy funders capture the process and redirect it to low-NSV pet causes. (3) Concentrated interests kill the mechanism before it reaches scale. We address each with specific countermeasures, but none are foolproof. Pilot testing is essential.
...
**The short version:** IABs solve one problem: getting high-NSV policies adopted. They don't solve "how do we measure NSV?" or "how should funds be allocated within high-NSV domains?" This section shows how IABs fit into a larger governance stack that addresses the full pipeline from priority-setting to implementation.
...
- Example: IAB treaty redirects {{< var treaty_annual_funding >}} to pragmatic clinical trials. Wishocracy determines allocation across cancer, Alzheimer's, rare diseases, etc.
...
- Why their project creates the greatest marginal net societal value per dollar
...
2. **Layer 1 (IABs):** Politicians pass treaty redirecting {{< var treaty_annual_funding >}} to pragmatic clinical trials based on Layer 0 democratic domain ranking
...
**The short version:** The same mechanism works for any problem where politicians control outcomes, outcomes can be measured, and diffuse benefits face concentrated opposition. Climate change, nuclear disarmament, and pandemic preparedness all fit. Once the architecture exists for health, extending it is straightforward.
...
If IABs successfully redirect even 1% of military spending ({{< var treaty_annual_funding >}} globally), military contractors will face real losses. They will deploy their existing lobbying infrastructure to ban, restrict, or capture the mechanism. Potential regulatory attacks include:
...
The bootstrap problem, raising $200M-$500M for initial proof-of-concept before concentrated interests mobilize counter-lobbying, appears daunting until we consider two factors: **(1) the massive ROI potential** and **(2) the capital asymmetry** favoring diffuse beneficiaries.

**ROI makes bootstrap funding rational for risk-tolerant capital:**

As shown, a {{< var treaty_campaign_budget_reserve >}} campaign with 20% success probability passing a {{< var treaty_annual_funding >}}/year treaty ({{< var victory_bond_funding_pct >}} to investors) yields:
...
The bootstrap phase requires \$200M-$500M for initial proof-of-concept, which is small relative to the aggregate capital available to diffuse beneficiaries:

- **Concentrated opposition** (military contractors, fossil fuel companies): {{< var concentrated_interest_sector_market_cap_usd >}} market cap, spending \$100M-$1B/year on lobbying
...
The 90:1 capital advantage means that **even if concentrated interests attempt counter-lobbying, they face a resource constraint.** If military contractors allocate \$500M to kill IABs, diffuse beneficiaries can deploy \$5B in response, and still represent only 0.001% of available household wealth. The political change ROI (100-10,000x) that military contractors exploit becomes accessible to millions of retail investors.
