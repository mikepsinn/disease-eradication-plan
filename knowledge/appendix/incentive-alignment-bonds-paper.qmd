...
This paper introduces Incentive Alignment Bonds (IABs), a novel class of financial instruments defined by three primitive properties: (1) investor alignment with public good production, (2) politician alignment with public good production, and (3) funding from government programs with lower marginal social value than the target use. Drawing on mechanism design theory, public choice economics, and campaign finance research, we formalize a three-layer architecture (scoring, electoral support, and post-office benefits) that makes supporting public-good policies incentive-compatible for rational political actors. Unlike Social Impact Bonds, which reward service providers for program outcomes, IABs target politicians directly at the policy level where large-scale budget decisions are made. We prove conditions under which supporting public goods becomes a Nash equilibrium for utility-maximizing politicians, provide explicit functional forms and numerical calibration demonstrating mechanism feasibility with realistic parameters, analyze legal constraints under U.S. anti-bribery law, and provide a comparative welfare criterion ($NSV_{source} < NSV_{target}$) for identifying appropriate funding sources, implying a natural ranking of expenditures by marginal social value. Critically, we show why *specified reallocation*, rather than budget addition, is a mechanism design requirement: under soft budget constraints, nominal spending increases are diluted by deficit expansion and inflation, leaving real resource allocation unchanged. IABs restore alignment between politician incentives and general welfare by redirecting resources from lower-value to higher-value uses. We demonstrate that the bootstrap problem (raising initial capital before concentrated interests mobilize regulatory opposition) is solvable due to (a) asymmetric ROI potential (380%+ expected returns) making initial funding economically rational and (b) capital asymmetry favoring diffuse beneficiaries (\$454 trillion household wealth vs. \$5 trillion concentrated interests), ensuring scalability once proof-of-concept succeeds. Welfare accounting shows the mechanism itself has a benefit-cost ratio exceeding 300:1 even accounting for overhead costs and failure risk. We illustrate the mechanism with a hypothetical global health treaty and discuss applications to climate change, nuclear disarmament, and pandemic preparedness. We conclude with a discussion of limitations, the role of Wishocracy (Layer 2) in preventing allocation capture, and directions for empirical research.
...
Yet government spending patterns have not shifted. The U.S. spends $16 on military operations for every $1 on diplomacy and humanitarian aid. Programs with benefit-cost ratios exceeding 100:1 receive single-digit billions while programs with negative net social value receive hundreds of billions. **The marginal value of producing another ranking is approximately zero.** What is needed is not more information, but a mechanism to make existing information consequential in the political utility function.

This paper argues that politicians maximize reelection probability, post-office career prospects, and status, not aggregate social welfare. **The problem is not that decision-makers don't know which programs produce value, it's that they don't know which programs produce value. They don't care, because caring doesn't appear in their utility function.**
...
A fundamental but underappreciated fact: **the collective capital available to diffuse beneficiaries vastly exceeds the resources of concentrated interests.** The problem is not lack of resources but lack of coordination.

Consider the global capital distribution:

- **Concentrated interests** (defense contractors, fossil fuel companies, pharmaceutical incumbents): Combined market capitalization ~\$5 trillion
...
**The key insight:** IABs don't create new lobbying; they systematize and scale the existing capture methodology so that humanity at large becomes the most powerful special interest. The political change ROI (100-10,000x) that currently accrues only to concentrated industries becomes accessible to everyone who benefits from public goods.
...
3. **What prevents IAB funders from controlling the scoring process?** Layer 0 (NSV rankings) already exists independently via Copenhagen Consensus, GiveWell, IMF, academic literature. IABs don't create rankings; they make existing rankings consequential. Layer 2 (Wishocracy) then democratizes allocation *within* domains approved via Layer 0 rankings.

**The division of labor:**
- **Layer 0 (Existing NSV rankings):** Determine *which domains* have high BCRs (medical research 100:1, vaccines 101:1, vs. fossil fuel subsidies -5:1)
- **Layer 1 (IABs):** Make politicians care about Layer 0 rankings via score-dependent incentives
- **Layer 2 (Wishocracy):** Citizens allocate *within approved domains* (30% cancer, 20% Alzheimer's, etc.) without committee capture
- **Layer 3 (Domain marketplaces):** Market mechanisms determine *specific projects* (which trials, which researchers)

**Residual governance requirements for Layer 0 (NSV Ranking Infrastructure):**
- **Multiple competing scoring organizations:** Copenhagen Consensus, GiveWell, IMF, CBO, academic literature—not a monopoly
- **Academic peer review:** BCR methodologies published in peer-reviewed journals, subject to replication
- **Transparent methodology:** All scoring criteria, data sources, and calculations publicly available
- **Sunset provisions:** Periodic re-validation of domain rankings (but Wishocracy handles allocation flexibility within domains)

**The key innovation:** We don't need to solve "whose conception of public good governs allocation" at Layer 1 because **Layer 2 democratizes that decision**. IABs solve the *adoption* problem (getting politicians to vote for reallocation). Wishocracy solves the *allocation* problem (ensuring redirected resources flow to highest-value uses). This is why the four-layer stack is necessary—each layer addresses a distinct failure mode.

IABs are not a panacea for democratic legitimacy. They are a mechanism to overcome the Olsonian collective action failure at the *adoption* stage. Democratic legitimacy of *allocation* is addressed by Wishocracy (Layer 2), which makes IABs compatible with democratic governance by ensuring that once resources are redirected, their allocation reflects aggregated citizen preferences rather than committee capture or funder control.
...
**Layer 0: NSV Ranking Infrastructure**

**Problem addressed:** What should we fund?

**Solution:** Authoritative, continuously-updated rankings of government programs by marginal Net Social Value.

**Current implementation:** This layer already exists but is ignored. Organizations produce rigorous benefit-cost analyses:
...
**The problem:** These rankings exist but don't influence allocation because they don't appear in politician utility functions. **The marginal value of producing another ranking is approximately zero.**
...
**This is what the current paper specifies:** The three-layer legal architecture (scoring, electoral, post-office) that operationalizes this mechanism.
...
**Example cascade:**
1. **Layer 0:** Copenhagen Consensus ranks medical research BCR at 100:1
2. **Layer 1 (IABs):** Politicians pass treaty redirecting $24B to health research
3. **Layer 2 (Wishocracy):** Citizens allocate 30% to cancer, 20% to Alzheimer's, 15% to infectious disease, etc.
...
1. **Layer 0 already exists** and is being ignored
2. **Layer 1 (IABs) is the binding constraint**; without it, nothing else happens
...
IABs are not a panacea. They solve the *adoption* problem but not the complete resource allocation problem. The four-layer stack addresses limitations systematically:

**Problems IABs alone do not solve:**

- **What counts as "public good"?** → **Solved by Layer 0:** Existing NSV rankings (Copenhagen Consensus, GiveWell, IMF) provide authoritative BCR analyses
...
2. **Capture of Layer 0 scoring organizations:** If Copenhagen Consensus, GiveWell, etc. become corrupted, the entire stack fails (mitigated by multiple competing orgs and academic peer review)
3. **Constitutional/legal barriers:** Some jurisdictions may prohibit IAB mechanisms via campaign finance or securities regulation
4. **Transition risk:** Bootstrap phase (12-24 months before proof-of-concept) vulnerable to regulatory counter-attack
...
| Better NSV rankings (Layer 0 only) | \$10M-$50M | ~\$0 (ignored) | 0:1 |
| Futarchy infrastructure | \$500M-$1B | Uncertain | Unknown |
| Charter cities | \$1B+ | Limited scale | 1:1 to 5:1 |

**Key insight:** IABs' welfare accounting is favorable precisely because they solve the *adoption* problem. Better information (Layer 0) costs little but achieves nothing. Better allocation mechanisms (futarchy, Wishocracy) are valuable only if adopted—which requires IABs first. The mechanism's overhead is justified by making all other governance improvements politically feasible.
...
2. **Capture of scoring process:** If NSV rankings become corrupted, redirected resources may not improve welfare (estimated probability: 10-25% over 20 years)
...
Even accounting for these risks (expected cost: ~\$100M/year), the net welfare impact remains strongly positive (BCR > 200:1).
