...
**The marginal value of producing another ranking is zero.** We don't need more information. We need a mechanism to make existing information consequential in the political utility function (the mathematical representation of what politicians actually care about: reelection, money, status).
...
- **\$454 trillion vs. \$5 trillion capital asymmetry** ensures diffuse beneficiaries (citizens who'd benefit from cures) can outspend concentrated opposition (defense contractors) by 90:1 (Section 2.3)
...
**Finance & ROI:**
- **ROI (Return on Investment):** Profit divided by cost (380% ROI means you get $4.80 back for every $1 invested)
- **Capital asymmetry:** Unequal distribution of wealth ($454 trillion households vs. $5 trillion defense contractors)
...
This paper introduces **Incentive Alignment Bonds (IABs)**, a mechanism design approach (designing rules so people's selfish choices create good outcomes) to reversing this dynamic. Rather than attempting to change politicians' preferences (good luck with that) or waiting for philosopher-kings (Plato has been dead for 2,400 years and we're still waiting), IABs simply change what rational self-interest points at.
...
A large literature suggests the net social value of military spending beyond minimum deterrence is strongly negative: the \$2.4 trillion in direct expenditure produces \$10+ trillion in societal costs (see @tbl-military-cost for illustrative order-of-magnitude estimates). If these estimates are approximately correct, redirecting even 1% to medical research, which has positive externalities and high multipliers, would be welfare-improving on net.
...
4. **A Welfare-Improvement Criterion**: We formalize how to identify appropriate IAB funding sources using comparative net social value analysis ($NSV_{source} < NSV_{target}$) and show why *specified reallocation*, rather than budget addition, is enough, and likely needed, for achieving real resource shifts. Under soft budget constraints, nominal spending increases are diluted by deficit expansion and inflation while Olsonian programs retain their share of real resources. This comparative criterion implies a natural ranking of expenditures; IABs draw from the lowest-ranked programs first, ensuring reallocation is welfare-improving under standard utilitarian assumptions.
...
**In plain English:** We've designed a way to make politicians support cures instead of bombs, not by appealing to their better nature (good luck with that), but by making it personally profitable. Same selfish politicians, better outcomes.
...
First-year expected ROI: 380%, with the revenue stream continuing in perpetuity. Even with high risk and long timelines, the asymmetric upside makes initial funding economically rational, not philanthropic. This changes the bootstrap calculus: **early investors are not donors making grants; they are rational actors making high-risk, high-return investments.**
