...
| [Optimocracy](optimocracy-paper.qmd) (algorithmic governance) | **Moderate (private); Challenging (gov't)** | **Near-term (1-2 years private); Medium-term (5-15 years gov't)** | $10M-$100M (private DAO); $500M+ (gov't adoption) | Goodhart's Law, oracle capture | Removes discretion for routine allocation |
...
**Key insight:** Optimocracy and IABs can develop in parallel. Private Optimocracy doesn't require government adoption, so it can demonstrate proof-of-concept while IABs work on the political adoption problem.
