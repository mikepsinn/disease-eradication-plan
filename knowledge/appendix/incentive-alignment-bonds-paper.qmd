...
As shown, a {{< var treaty_campaign_total_cost >}} campaign with 20% success probability passing a {{< var treaty_annual_funding >}}/year treaty ({{< var victory_bond_funding_pct >}} to investors) yields:

$$
E[V] = 0.20 \times \$2.72\text{B/year} = \$544\text{M/year}
$$

Expected first-year ROI: 54.4% ($544M ÷ $1B), with the revenue stream continuing in perpetuity. Upon treaty passage, the conditional annual ROI is 272%. Even with high risk and long timelines, the asymmetric upside makes initial funding economically rational, not philanthropic. This changes the bootstrap calculus: **early investors are not donors making grants; they are rational actors making high-risk, high-return investments.**
...
**Empirical precedent:** Cryptocurrencies raised \$30B+ in ICOs (2017-2018) with far weaker value propositions than 272% conditional ROI backed by lobbying economics. Green bonds reached \$500B outstanding by 2023. If IABs can be structured as retail-accessible securities, the capital mobilization problem is not "can we raise {{< var treaty_campaign_total_cost >}}?" but "can we structure the offering legally?"
...
1. Phase 1 (\$200M-$500M) is raised from high-risk capital (impact funds, crypto whales, patient billionaires)
2. Rapid deployment achieves measurable traction (one scoring cycle, measurable electoral impact)
3. Momentum builds (even partial progress increases bond value through demonstrated efficacy)
4. Retail offering opens to millions of diffuse beneficiaries for the remaining campaign funding
