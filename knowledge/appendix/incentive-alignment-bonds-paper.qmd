...
jel:
  ...
  - H41
  - P16
bibliography: iab-references.bib
format:
  html:
    toc: true
    toc-depth: 3
...
1. **Measurability**: Voting records are public, verifiable, and ungameable (they literally write down who voted for what; it's very hard to fake this)
2. **Attribution**: Each politician's vote is directly attributable
3. **No oracle problem**: No need for contested measurement of downstream outcomes (we don't have to hire a wizard to decide if the cure "worked")
