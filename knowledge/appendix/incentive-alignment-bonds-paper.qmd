...
abstract: |
  ...
  {{< var wishonia_path_gdp_vs_earth_multiplier_year_20 >}} the Earth baseline after 20 years, raises
  average income to {{< var wishonia_path_avg_income_year_20 >}} versus
  {{< var earth_avg_income_year_20 >}} on the status-quo path, reaches
  {{< var wishonia_path_gdp_year_20 >}} in total output, and recovers roughly
...
**Scale note.** The prize here is not marginal. Under the project's best-case governance ceiling, the recoverable upside is {{< var political_dysfunction_global_opportunity_cost_total >}} per year. The 20-year Optimal-Governance Path reaches {{< var wishonia_path_gdp_vs_earth_multiplier_year_20 >}} the Earth baseline, raises average income to {{< var wishonia_path_avg_income_year_20 >}} versus {{< var earth_avg_income_year_20 >}} on the status-quo path, and reaches {{< var wishonia_path_gdp_year_20 >}} in total output. This paper focuses on the adoption mechanism that could make movement toward that ceiling politically profitable; the full derivation lives in [The Political Dysfunction Tax](political-dysfunction-tax.qmd).
