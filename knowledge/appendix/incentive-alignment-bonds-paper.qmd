...
@tbl-ranking presents a synthesized ranking of these categories, drawing from multiplier estimates and benefit-cost analyses. While precise values vary by methodology (e.g., discount rates, valuation of statistical life), the relative ordering at the extremes is robust: "Target" programs consistently exhibit high multipliers and positive externalities, while "Source" programs exhibit low multipliers and negative externalities.

| Expenditure Category | Est. Economic Multiplier | Benefit-Cost Ratio (BCR) | Implied NSV (per $1) | Source / Notes |
|:---------------------|:-------------------------|:-------------------------|:---------------------|:---------------|
| **1. Medical Research** | 2.46 | 3.9:1 – 100:1+ | **+$2.90 – $100+** | [@kpmg2018], [@murphy2006]; high variance, high upside |
| **2. Early Childhood Ed.** | 1.6 | 2.5:1 – 10.8:1 | **+$1.50 – $9.80** | [@heckman2010], [@reynolds2011]; high certainty |
| **3. Infrastructure** | 0.5 – 2.5 (avg 1.5) | 1.5:1 | **+$0.50** | [@cbo2015]; varies significantly by project quality |
| **4. General Military** | 0.6 – 0.8 | < 1:1 (Fiscal) | **-$0.30** | [@barro2011]; fiscal impact only (excludes conflict cost) |
| **5. Fossil Fuel Subsidies**| 0.4 – 0.7 | Social Cost > 4x Spending | **-$4.40** | [@batini2021], [@imf2023]; includes climate externalities |

: Representative Ranking of Government Expenditures by Marginal Social Value {#tbl-ranking}
