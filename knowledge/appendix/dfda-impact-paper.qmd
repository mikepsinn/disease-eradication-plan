...
- **Platform Cost Scenarios (Derived from ROM Estimates):**
  ...
  - **Annual Operational Cost Scenarios:**
    - **Scenario 1: Core framework Only:** ~{{< var dfda_npv_annual_opex >}} (from [Annual Operational Costs](#annual-operational-costs)).
    - **Scenario 2: Lean Ecosystem (Core framework + Medium Broader Initiatives):**
      - Core framework Ops (midpoint from [Annual Operational Costs](#annual-operational-costs)): ~{{< var dfda_npv_annual_opex >}}
      - Medium Broader Initiative Annual Costs (from [Scenario-Based ROM Estimates](#scenario-based-rom-estimates-for-broader-initiative-costs)): ~{{< var dih_npv_annual_opex_initiatives >}}
      - **Total Lean Ecosystem Annual Cost:** ~{{< var dfda_npv_annual_opex_total >}}.
...
- $C_0$ = {{< var dfda_upfront_build >}} is the upfront cost (Core framework Build)
- $n = 5$ years is the amortization period
- $C_{\text{op}}$ = {{< var dfda_upfront_build >}}/year is the annual operational cost (Lean Ecosystem)
...
- **Upfront Cost** (Core framework Build from [Upfront (Capital) Expenditure](#upfront-build-costs)): {{< var dfda_upfront_build >}}
  ...
  Amortized over 5 years = {{< var dfda_upfront_build >}} / 5 = ~$8 Million/year
...
- **Total Annualized Cost**: ~$8M + {{< var dfda_upfront_build >}} = ~$48 Million/year (or $0.048B/year)
