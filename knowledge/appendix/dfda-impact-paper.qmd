...
**The bottleneck:** {{< var diseases_without_effective_treatment >}} diseases currently lack effective treatments. At the current discovery rate of {{< var new_disease_first_treatments_per_year >}} new treatments per year, systematically testing all {{< var drug_disease_combinations_possible >}} plausible drug-disease combinations would take ~{{< var status_quo_queue_clearance_years >}}. Most will never be tested.
