...
2. **Model Inputs**
   ...
   - **Cost Reduction**: {{< var dfda_trial_cost_reduction_pct >}} reduction ({{< var dfda_trial_cost_reduction_factor >}}) based on pragmatic trial evidence. Confidence interval reflects uncertainty across trial types.
   - **Increased Throughput**: {{< var dfda_trial_capacity_multiplier >}} more trials and potentially many more candidates tested in parallel.
   - **Faster to Market**: {{< var dfda_trial_capacity_treatment_acceleration_years >}} shaved off a typical {{< var treatment_acceleration_years_current >}} development cycle, yielding earlier revenue generation and extended effective patent life for sponsors.
...
**10-Year NPV (R&D Operational Savings)**: The dFDA platform reduces trial costs by {{< var dfda_trial_cost_reduction_pct >}} ({{< var dfda_trial_cost_reduction_factor >}} cost reduction). We discount 10 years of future operational savings to present value (~{{< var dfda_npv_net_benefit_rd_only >}}) for ROI analysis. This is standard business practice for evaluating ongoing cost efficiencies.
