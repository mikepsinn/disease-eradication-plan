...
Below is a conceptual, high-level analysis of the costs, benefits, and return on investment (ROI) for a global decentralized framework for drug assessment. This future-state platform would continuously rank treatments using the entirety of clinical and real-world data (RWD), and would enable anyone, potentially over a billion people worldwide, to participate in large-scale, continuous, decentralized pragmatic clinical trials.
