...
The military-industrial complex spends {{< var defense_lobbying_annual >}} yearly on lobbyists. You can't beat them with moral arguments (they're immune; moral arguments have a $0 budget and no K Street address). Beat them at their own game. Raise {{< var treaty_campaign_total_cost >}} through [VICTORY Incentive Alignment Bonds](../solution/incentive-alignment-bonds.qmd). Allocate {{< var treaty_campaign_budget_lobbying >}} for [lobbying](../economics/campaign-budget.qmd#ai-assisted-lobbying-250m-25). That overwhelms the defense industry's {{< var defense_lobbying_annual >}} spend. Go to the same K Street firms. Outbid them. Lobbyists work for the highest bidder. They always have. This is the one area where your species' mercenary instincts are genuinely helpful.
...
Scale that up globally and the [20-year model](../economics/gdp-trajectories.qmd) projects the Treaty Path producing {{< var treaty_path_gdp_vs_earth_multiplier_year_20 >}} the GDP of doing nothing, and the Wishonia Path producing {{< var wishonia_path_gdp_vs_earth_multiplier_year_20 >}}. Not murdering people is good for the economy. This should not be a surprising finding, but on your planet, it is.
