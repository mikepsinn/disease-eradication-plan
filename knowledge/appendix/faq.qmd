...
image: /assets/og-images/knowledge/appendix/faq-og.png
---

{{< include /knowledge/includes/setup-parameters.qmd >}}

![Infographic](/assets/infographics/knowledge/appendix/faq-infographic.png)
...
**The cures** may be achievable because Oxford proved the model works, we're removing the FDA bottleneck, trials cost {{< var trial_cost_reduction_factor >}}× less, and the timeline matches historical eradication efforts.
