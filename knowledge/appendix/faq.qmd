...
4.  A dFDA is decentralized markets, not central planning.
...
**Science works through experimentation.** A dFDA lets us experiment {{< var trial_cost_reduction_factor >}}× faster and cheaper.
...
**Response**: That's old tech. The DIH will be built on modern, energy-efficient **[Proof-of-Stake (PoS) systems, which use over 99.9% less energy](../references.qmd#pos-energy-efficiency)** than the early Proof-of-Work blockchains. This commitment to global health includes planetary health.
