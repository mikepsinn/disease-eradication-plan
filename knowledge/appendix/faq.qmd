...
Scale that up globally and the [20-year model](../economics/gdp-trajectories.qmd) projects the [Minimum Sustainable Trajectory (1% Treaty)](../solution/1-percent-treaty.qmd) [@1-pct-treaty-impact-paper-2025] producing {{< var treaty_trajectory_gdp_vs_current_trajectory_multiplier_year_20 >}} the GDP of doing nothing, and the [Wishonian](../futures/wishonia.qmd) [Optimal Governance Trajectory](../economics/gdp-trajectories.qmd) producing {{< var wishonia_trajectory_gdp_vs_current_trajectory_multiplier_year_20 >}}. Not murdering people is good for the economy. This should not be a surprising finding, but on your planet, it is.
