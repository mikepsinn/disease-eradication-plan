...
**Response**: Money isn't the only constraint. You can't print more physicists. (You've tried. It takes 25 years and a PhD program.) Cutting 1% from military budgets doesn't just move dollars. It frees actual human brains from building weapons to curing Alzheimer's. Right now your smartest people are optimizing missile trajectories. Those same brains could optimize drug molecules. The brains don't care. They just go where the funding is.
...
**Response**: It already happened. The Oxford RECOVERY trial tested 7 treatments in 6 months, saved 1 million lives at {{< var recovery_trial_cost_per_patient >}} per patient. The FDA's version costs {{< var traditional_phase3_cost_per_patient >}} per patient for the same information. It used existing hospital systems. Hospitals, it turns out, already contain sick people. This was apparently news.

The remaining obstacle is political will, and political will follows money the way rivers follow gravity. The military-industrial complex spends {{< var defense_lobbying_annual >}} yearly on lobbyists. You can't beat them with moral arguments. (They're immune.) Beat them at their own game. Raise {{< var treaty_campaign_total_cost >}} through [VICTORY Bonds](../solution/incentive-alignment-bonds.qmd). Allocate {{< var treaty_campaign_budget_lobbying >}} for [lobbying](../economics/campaign-budget.qmd#ai-assisted-lobbying-250m-25). That overwhelms the defense industry's {{< var defense_lobbying_annual >}} spend. Go to the same K-Street firms. Outbid them. Lobbyists work for the highest bidder.
