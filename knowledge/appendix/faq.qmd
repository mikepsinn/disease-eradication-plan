...
Pharma currently pays {{< var pharma_drug_development_cost_current >}} per drug. 90% fail. This is called "drug development." There is a word for spending billions with a 10% success rate. The word is "gambling."
...
![How voters get politicians to do things: instruct them, then replace them if they don't. It's the same system you use with batteries.](/assets/images/faq/faq-section-what-about-national-sovereignty-bw-academic.jpg)

Sovereignty means "we decide what happens to us." The treaty leaves each country to decide. Countries that don't want to may decide not to. Countries that do want to may decide to. Sovereignty remains intact throughout. That is how deciding works. I checked with your dictionaries. They agree with me.
...
The plan does not require you to implement it. It requires one billionaire out of 2,800 to fund the bonds. One lobbying firm out of thousands to pivot. One country out of 195 to sign first. {{< var three_point_five_percent_of_global_population >}} to click a button. Isaac Newton did not personally cause apples to fall. He described why they fall. The description was useful regardless of Newton's personal apple-dropping capabilities.
...
3. Do politicians respond to money? (The military industry spends {{< var defense_lobbying_annual >}} on lobbying and gets nearly $1T back.)
...
The answer to each is yes. Five yeses do not sum to impossible. The conclusion is not hope. It is arithmetic. 
...
This needs {{< var three_point_five_percent_of_global_population_nounit >}} people. You tell 10, they each tell 10. Six degrees of sharing reaches millions. Humans regularly spend longer than 17 minutes choosing what to watch on Netflix, then pick a show about murder. Choosing not to be murdered by disease is also available, but the interface is less intuitive.
...
The military-industrial complex spends {{< var defense_lobbying_annual >}} yearly on lobbyists. You can't beat them with moral arguments (they're immune; moral arguments have a $0 budget and no K Street address). Beat them at their own game. Raise {{< var treaty_campaign_total_cost >}} through [VICTORY Incentive Alignment Bonds](../solution/incentive-alignment-bonds.qmd) [@iab-paper-2025]. Allocate {{< var treaty_campaign_budget_lobbying >}} for [lobbying](../economics/campaign-budget.qmd#ai-assisted-lobbying-250m-25). That overwhelms the military industry's {{< var defense_lobbying_annual >}} spend. Go to the same K Street firms. Outbid them. Lobbyists work for the highest bidder. They always have. This is the one area where your species' mercenary instincts are genuinely helpful.

Once {{< var three_point_five_percent_of_global_population_nounit >}} voters demand it and the money is behind it, refusal becomes career suicide. Politicians are extremely good at not committing career suicide. It's their primary skill. Several have no other skills.
...
- Spending {{< var global_military_spending_annual_2024 >}} on weapons while sitting on {{< var global_warhead_count_nounit >}} nuclear warheads. That's enough for {{< var nuclear_winter_overkill_factor_nounit >}} extinction events. You only need one. The other {{< var nuclear_winter_spare_apocalypses_nounit >}} are for what, exactly?
...
Your decentralized framework will run {{< var dfda_trial_cost_reduction_factor >}} more trials for the same budget. Even if 90% fail, you get over 4x more cures than today. Failure at scale beats success at a standstill. A 90% failure rate is normal for the first 200 years of any medical system. Then the failure rate dropped because we had data. You don't have data because you're afraid of failure. You're afraid of failure because you don't have data. This is a circle. I keep finding circles in your systems. None of them are the good kind.
...
- Military spending: {{< var switzerland_defense_spending_pct >}} of GDP
...
Current lobbying buys murder contracts: $1 trillion in military spending. New lobbying buys medicine contracts: clinical trials. Same K Street. Different product. If you're comfortable with the first one and uncomfortable with the second one, I encourage you to sit quietly and think about why.
