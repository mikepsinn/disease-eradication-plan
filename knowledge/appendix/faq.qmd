...
**Response**: 1% is a rounding error. You're not destroying jobs. You're redirecting money into real ones. Engineers building guidance systems can build medical imaging devices. Same skills, fewer explosions, more job satisfaction surveys where nobody ticks "my work kills people."
...
**Response**: It already happened. The Oxford RECOVERY trial tested 7 treatments in 6 months and saved 1 million lives using existing hospital systems. Hospitals, it turns out, already contain sick people. This was apparently news.
