...
**Current system**: Pharma pays {{< var pharma_drug_development_cost_current >}} per drug. 90% fail. Only blockbusters profit. The business model is "spend billions gambling, hope one pill pays for the nine that didn't work."
...
Raise {{< var treaty_campaign_total_cost >}} through [VICTORY Bonds](../solution/incentive-alignment-bonds.qmd). Allocate {{< var treaty_campaign_budget_lobbying >}} for [lobbying](../economics/campaign-budget.qmd#ai-assisted-lobbying-250m-25). That overwhelms the defense industry's {{< var defense_lobbying_annual >}} spend. Go to the same K-Street firms defense contractors use. Outbid them for their top talent. Lobbyists work for the highest bidder. Become the highest bidder.

Politicians suddenly hear more about curing cancer and less about threats from countries they can't find on maps.

This isn't fantasy. It's capitalism. Once {{< var treaty_campaign_voting_bloc_target_nounit >}} voters demand it and the money is behind it, refusal becomes career suicide. Politicians are very good at not committing career suicide.
