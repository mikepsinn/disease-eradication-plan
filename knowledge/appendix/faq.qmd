...
Scale that up globally and the [20-year model](../economics/gdp-trajectories.qmd) projects the Treaty Path producing {{< var treaty_trajectory_gdp_vs_current_trajectory_multiplier_year_20 >}} the GDP of doing nothing, and the Wishonia Path producing {{< var wishonia_trajectory_gdp_vs_current_trajectory_multiplier_year_20 >}}. Not murdering people is good for the economy. This should not be a surprising finding, but on your planet, it is.
