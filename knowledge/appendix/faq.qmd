...
**Response**: The [decentralized framework for drug assessment](../solution/dfda.qmd) model achieves [80× lower cost per patient](../references.qmd#recovery-trial-82x-cost-reduction). Pragmatic trials cost {{< var recovery_trial_cost_per_patient >}} [per patient](../references.qmd#recovery-cost-500) versus {{< var traditional_phase3_cost_per_patient_fda_example_41k >}} in [traditional trials](../references.qmd#trial-cost-41k).
