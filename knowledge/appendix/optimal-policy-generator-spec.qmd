...
abstract: |
  ...
  **real after-tax median income growth** (economic welfare) and **median healthy life years**
  ...
  For any jurisdiction, four outputs: ENACT (evidence-supported policies you lack). REPLACE
  ...
  enacted each policy, only whether it worked. Projected welfare gains under framework assumptions:
  5-15% of GDP for typical US states (90% CI: 2-25%), pending retrospective validation.
aliases:
...
![A conceptual diagram of the Optimal Policy Generator (OPG) framework illustrating the flow from evidence and welfare metrics to the four primary policy outputs: Enact, Replace, Repeal, and Maintain.](/assets/images/optimal-policy-generator-spec/optimal-policy-generator-spec-section-abstract-unnumbered-bw-academic.jpg)

**Important limitation**: Until retrospective validation is performed (see @sec-opg-validation-framework), OPG should be treated as a theoretically-motivated heuristic for policy prioritization, not a validated predictive tool. The quasi-experimental methods provide evidence *consistent with* causation under assumptions that are often untestable.
...
![A conceptual diagram illustrating the two pillars of the welfare function: Economic Welfare (income growth) and Health Welfare (healthy life years).](/assets/images/optimal-policy-generator-spec/optimal-policy-generator-spec-section-the-two-welfare-metrics-sec-two-metrics-bw-academic.jpg)
...
![A flowchart illustrating the transition from policy interventions to terminal metrics through proximate and intermediate outcomes, highlighting specific conversion factors and the compounding of uncertainty across the chain.](/assets/images/optimal-policy-generator-spec/optimal-policy-generator-spec-section-outcome-translation-method-bw-academic.jpg)
...
![A conceptual visualization showing how diverse policy data from thousands of jurisdictions over centuries flows into a central system for systematic harvesting and analysis.](/assets/images/optimal-policy-generator-spec/optimal-policy-generator-spec-section-the-evidence-base-centurie-bw-academic.jpg)
...
![A comparison chart showing the exponential growth in available policy-years across different geographic levels, ranging from 3,500 for US states to millions for cities worldwide.](/assets/images/optimal-policy-generator-spec/optimal-policy-generator-spec-section-scale-of-available-natural-experiments-bw-academic.jpg)

### The OPG Pipeline

![A five-stage data pipeline illustrating the transformation of policy data into ranked recommendations through ingestion, alignment, quasi-experimental analysis, and impact scoring.](/assets/images/optimal-policy-generator-spec/optimal-policy-generator-spec-section-the-opg-pipeline-bw-academic.jpg)
...
![A diagram illustrating how four historical barriers (fragmented data, computational limits, older methodologies, and incentive gaps) converge into the OPG three-step workflow of aggregation, causal inference, and output.](/assets/images/optimal-policy-generator-spec/optimal-policy-generator-spec-section-why-this-hasn-t-been-done-before-bw-academic.jpg)
...
![A conceptual framework illustrating the eight data components (ranging from statistical effect estimates to jurisdictional adjustments) that converge to form a comprehensive policy analysis profile.](/assets/images/optimal-policy-generator-spec/optimal-policy-generator-spec-section-what-policy-analysts-see-bw-academic.jpg)
...
![A comparative visualization showing the shift from a single generic national average to a localized dashboard of specific tax rates, health outcomes, and economic impacts for a specific jurisdiction.](/assets/images/optimal-policy-generator-spec/optimal-policy-generator-spec-section-why-generic-policy-scores-are-not-enough-bw-academic.jpg)
...
![A conceptual diagram showing how political and psychological barriers like lobbying intensity, status quo bias, and salience heuristics filter evidence, leading to welfare losses in the policy adoption process.](/assets/images/optimal-policy-generator-spec/optimal-policy-generator-spec-section-why-policy-ranking-fails-today-bw-academic.jpg)

### Scale of Available Evidence

The evidence base comprises millions of policy-years of natural experiments across all jurisdictional levels (see @sec-evidence-base for detailed counts). Even with imperfect causal inference, systematically analyzing this data should improve on the current system of lobbying-driven, ideology-filtered policy adoption. How much improvement is an empirical question requiring validation (see @sec-opg-validation-framework).

![A conceptual comparison between the current ideology-driven policy system and a proposed evidence-based framework leveraging data from millions of policy-years across multiple jurisdictional levels.](/assets/images/optimal-policy-generator-spec/optimal-policy-generator-spec-section-scale-of-available-evidence-bw-academic.jpg)
...
![A workflow diagram showing the translation of evidence into a Policy Impact Score (PIS) and the subsequent categorization into four policy recommendation types: enact, replace, repeal, or maintain.](/assets/images/optimal-policy-generator-spec/optimal-policy-generator-spec-section-contributions-bw-academic.jpg)
...
![A comparison of major policy evaluation frameworks across key functional dimensions, highlighting the systematic gaps in jurisdiction-specific recommendations and evaluation of existing policy stocks.](/assets/images/optimal-policy-generator-spec/optimal-policy-generator-spec-section-existing-policy-evaluation-frameworks-bw-academic.jpg)
...
![A comparative overview of the OPG framework's unique contributions, contrasting its jurisdiction-specific, comprehensive policy review process against traditional evaluation methods.](/assets/images/optimal-policy-generator-spec/optimal-policy-generator-spec-section-this-framework-s-contribution-bw-academic.jpg)
...
![A Venn diagram illustrating the Policy Gap as the symmetric difference between a jurisdiction's current policy bundle and its welfare-optimal bundle, identifying specific areas for policy enactment and repeal.](/assets/images/optimal-policy-generator-spec/optimal-policy-generator-spec-section-the-policy-optimization-problem-bw-academic.jpg)
...
**Worked example (policy interaction):**

Seat belt law + Speed limit reduction:

- Seat belt alone: +0.15 years healthy life
- Speed limit alone: +0.06 years healthy life
- Additive prediction: +0.21 years
- Observed when both present: +0.18 years (interaction term: -0.03 years)

The interaction term is negative because both policies target the same outcome (crash fatalities), creating partial overlap in benefits. OPG reports both the additive prediction and interaction-adjusted estimate when interaction data is available.
...
![An entity-relationship diagram illustrating the core tables and relational schema of the OPG system's policy-outcome data structure.](/assets/images/optimal-policy-generator-spec/optimal-policy-generator-spec-section-policy-outcome-data-structure-bw-academic.jpg)
...
![A conceptual mapping of quasi-experimental research designs supported by the OPG system, illustrating how different methods align with specific data structures.](/assets/images/optimal-policy-generator-spec/optimal-policy-generator-spec-section-analysis-methods-sec-analysis-methods-bw-academic.jpg)
...
![A time-series line chart illustrating the synthetic control method, showing the treated jurisdiction and synthetic control units tracking together pre-treatment and diverging after the intervention.](/assets/images/optimal-policy-generator-spec/optimal-policy-generator-spec-section-synthetic-control-method-bw-academic.jpg)
...
![A line chart illustrating the Difference-in-Differences framework, showing the parallel trajectories of treatment and control groups and the divergence used to calculate the treatment effect.](/assets/images/optimal-policy-generator-spec/optimal-policy-generator-spec-section-difference-in-differences-did-bw-academic.jpg)
...
![A scatter plot illustrating a regression discontinuity design, showing a jump in the outcome variable at a sharp vertical threshold line with regression curves on either side.](/assets/images/optimal-policy-generator-spec/optimal-policy-generator-spec-section-regression-discontinuity-design-rdd-bw-academic.jpg)
...
![A coefficient plot representing an event study with pre-treatment estimates near zero and post-treatment estimates showing the dynamic evolution of treatment effects.](/assets/images/optimal-policy-generator-spec/optimal-policy-generator-spec-section-event-study-interrupted-time-series-bw-academic.jpg)
...
![A conceptual diagram showing the mapping process where individual Bradford Hill criteria are processed through saturation functions to yield normalized scores between 0 and 1.](/assets/images/optimal-policy-generator-spec/optimal-policy-generator-spec-section-bradford-hill-criteria-sco-bw-academic.jpg)
...
![A horizontal bar chart illustrating the nine criteria weights for the Causal Confidence Score, ranking them from highest impact to lowest impact.](/assets/images/optimal-policy-generator-spec/optimal-policy-generator-spec-section-causal-confidence-score-ccs-calculation-bw-academic.jpg)
...
| **Suboptimal strength** | Continuous policy set below evidence-supported level | Tobacco tax at $1.41 vs. optimal ~$2.50 |
...
|--------|-------------------|----------------------|
| Demographics ($D$) | 0.15 | Mahalanobis distance on age/income/education |
| Existing policies ($P$) | 0.10 | Policy bundle cosine distance |
...
Texas tobacco tax recommendation:

- Evidence base: Primarily northeast/west coast states (higher income, lower smoking rates)
- Texas demographics: Lower median income, higher baseline smoking
- Context adjustment: 0.85 (effect likely 15% smaller in Texas context)
- CI widening: 1.075× (modest extrapolation)

$$
\text{Expected Effect}_{\text{Texas}} = 0.30 \times 0.85 = 0.25 \text{ healthy years}
$$
...
|-----------------|----------|-------------|---------|
| `constitutional` | **Hard** | Requires constitutional amendment | Takings Clause limits on land use regulations |
| `federal_preemption` | **Hard** | Federal law prevents state/local action | Federal minimum wage floor |
| `treaty_obligation` | **Hard** | International agreement constrains policy | WTO rules on tariffs |
| `autonomy_concern` | **Soft** | Restricts individual freedom/choice | Mandatory helmet laws |
| `political_feasibility` | **Soft** | Strong organized opposition | Industry lobbying |
| `implementation_cost` | **Soft** | High fixed costs to implement | New regulatory agency needed |
...
![A visual breakdown of the three criteria used to select peer jurisdictions: matching characteristics, policy adoption, and documented positive outcomes.](/assets/images/optimal-policy-generator-spec/optimal-policy-generator-spec-section-similar-jurisdictions-sec-similar-jurisdictions-bw-academic.jpg)
...
![A circular flowchart illustrating the four-step learning loop: OPG recommendation, jurisdictional implementation, outcome reporting, and continuous improvement of future guidance.](/assets/images/optimal-policy-generator-spec/optimal-policy-generator-spec-section-recommended-tracking-for-opg-feedback-bw-academic.jpg)
...
![A hierarchical visualization comparing the volume of data generation and risk potential across federal, state, and county levels.](/assets/images/optimal-policy-generator-spec/optimal-policy-generator-spec-section-the-subsidiarity-principle-for-evidence-generation-bw-academic.jpg)
...
![A flowchart illustrating the logic for calculating the combined Policy Impact Score (PIS) by aggregating standardized effect sizes, causal confidence scores, and quality adjustments for both income and health metrics.](/assets/images/optimal-policy-generator-spec/optimal-policy-generator-spec-section-jurisdiction-level-pis-calculation-bw-academic.jpg)
...
|--------|---------------|---------------|-----|-------|
| Tobacco tax +$1 | **-0.02 pp/yr** | +0.25 years | 0.85 | A |
| Primary seat belt | +0.02 pp/yr | +0.15 years | 0.81 | A |

This prevents hiding tradeoffs. For example, the tobacco tax has a negative income effect (direct tax burden) but positive health effect (reduced smoking). The two-metric format makes this tradeoff explicit.
:::
...
![A conceptual diagram showing the relationship between a treatment and outcome, distinguishing between controlled confounders and the potential bias introduced by uncontrolled factors.](/assets/images/optimal-policy-generator-spec/optimal-policy-generator-spec-section-confounder-adjustment-bw-academic.jpg)
...
![A decision tree illustrating the evidence grading logic based on PIS, heterogeneity, and jurisdiction count, including adjustment modifiers.](/assets/images/optimal-policy-generator-spec/optimal-policy-generator-spec-section-evidence-grading-sec-evidence-grading-bw-academic.jpg)
...
![A four-step workflow illustrating the parallel trends testing procedure, including the statistical significance check and subsequent sensitivity reporting.](/assets/images/optimal-policy-generator-spec/optimal-policy-generator-spec-section-parallel-trends-testing-did-bw-academic.jpg)

### Pre-Treatment Fit (Synthetic Control)

![A workflow diagram outlining the four steps for validating synthetic control fit, including RMSE calculation, placebo comparison, and the conditional logic for flagging poor fits.](/assets/images/optimal-policy-generator-spec/optimal-policy-generator-spec-section-pre-treatment-fit-synthetic-control-bw-academic.jpg)
...
![A strategic roadmap showing the progression of policy adoption from immediate quick wins to bundled implementations and reaching critical mass thresholds.](/assets/images/optimal-policy-generator-spec/optimal-policy-generator-spec-section-sequencing-guidance-bw-academic.jpg)
...
![A visualization showing how a single policy can result in diverse outcomes across different jurisdictions based on factors like culture, implementation quality, and timing.](/assets/images/optimal-policy-generator-spec/optimal-policy-generator-spec-section-heterogeneous-effects-bw-academic.jpg)
...
![A dynamic impact chart illustrating the progression from short-run immediate effects to long-run sustained effects, accounting for policy drift and adaptation over time.](/assets/images/optimal-policy-generator-spec/optimal-policy-generator-spec-section-time-varying-effects-bw-academic.jpg)

### Publication Bias

![A diagram illustrating the 'file drawer problem' where null results are filtered out of the publication pipeline and how mitigation strategies like funnel plot corrections restore balance.](/assets/images/optimal-policy-generator-spec/optimal-policy-generator-spec-section-publication-bias-bw-academic.jpg)
...
![A flowchart illustrating the four-step retrospective validation methodology, from initial data computation through policy identification to final performance assessment.](/assets/images/optimal-policy-generator-spec/optimal-policy-generator-spec-section-proposed-validation-study-bw-academic.jpg)
...
![A workflow illustrating the four-step pre-registration cycle from methodology commitment to outcome comparison to ensure an auditable record.](/assets/images/optimal-policy-generator-spec/optimal-policy-generator-spec-section-prospective-pre-registration-bw-academic.jpg)
...
![A circular flowchart depicting the six-step learning loop where OPG recommendations lead to jurisdictional adoption and data reporting, which then feeds back into OPG's meta-analysis to refine future policy guidance.](/assets/images/optimal-policy-generator-spec/optimal-policy-generator-spec-section-continuous-improvement-via-adoption-feedback-bw-academic.jpg)
...
![A conceptual framework illustrating how advanced methodological components like causal discovery, text-as-data, and machine learning integrate into a comprehensive policy evaluation pipeline.](/assets/images/optimal-policy-generator-spec/optimal-policy-generator-spec-section-methodological-improvements-bw-academic.jpg)
...
![A strategic framework illustrating the four validation priorities for OPG predictions, highlighting the hierarchy of methods from retrospective studies to expert reviews.](/assets/images/optimal-policy-generator-spec/optimal-policy-generator-spec-section-validation-priorities-bw-academic.jpg)
...
![A data infrastructure pipeline illustrating the flow from legislative data collection and NLP processing to standardized outcome harmonization and researcher API access.](/assets/images/optimal-policy-generator-spec/optimal-policy-generator-spec-section-data-infrastructure-bw-academic.jpg)
...
![A circular process diagram showing the iterative loop between policy dashboards, uncertainty communication, scenario modeling, and feedback mechanisms.](/assets/images/optimal-policy-generator-spec/optimal-policy-generator-spec-section-integration-with-decision-making-bw-academic.jpg)
...
| Tobacco tax ($1.41→$2.50) | Suboptimal | **-0.02 pp/yr** | +0.25 years | **REPLACE** | A |
...
| Metric | Expected Effect | 95% CI |
|--------|-----------------|--------|
| **Income** | **-0.02 pp/year** | [-0.04, +0.01] |
| **Health** | **+0.25 years** | [+0.18, +0.32] |

- **Current level**: $1.41/pack (illustrative; below median $1.91)
- **Recommended level**: $2.50/pack (illustrative target)
- **Evidence grade**: A
- **Priority**: High
- **Blocking factors**: Political (anti-tax sentiment)
...
This recommendation illustrates how the two-metric framework surfaces genuine tradeoffs:

- **Income effect is negative**: The tax directly reduces disposable income for smokers. Productivity gains (fewer sick days) partially offset this, but the net income effect is small and negative.
- **Health effect is strongly positive**: Reduced smoking leads to longer healthy life expectancy.
- **Combined welfare is positive**: At equal weighting (α=0.5), the health gain outweighs the income cost.

![A two-axis tradeoff visualization plotting income impact against health gains, illustrating the optimal policy point between the extremes of infinite and zero tobacco taxes.](/assets/images/optimal-policy-generator-spec/optimal-policy-generator-spec-section-tradeoff-demonstration-bw-academic.jpg)

This demonstrates why the two-metric framework prevents corner solutions:

- An **infinite tobacco tax** would maximize health but devastate income → not optimal
- A **zero tobacco tax** would preserve income but harm health → not optimal
- The **evidence-supported level** balances both dimensions

The recommendation shows where evidence places the optimum, while making the tradeoff explicit for democratic deliberation. Jurisdictions that weight income more heavily may choose a lower tax; those prioritizing health may choose higher.
:::
...
| **REPLACE** | Tobacco tax: $1.41→$2.50 | **-0.02 pp/yr** | +0.25 years | A |
| **REPLACE** | Speed limit: 85→70 mph | +0.01 pp/yr | +0.06 years | B |
| **MAINTAIN** | DUI threshold, GDL | N/A | N/A | A |
| | **Total from changes** | **+0.02 pp/yr** | **+0.54 years** | |

**Note**: The tobacco tax shows a negative income effect but positive health effect, demonstrating the two-metric framework's ability to surface genuine tradeoffs. MAINTAIN items confirm evidence alignment and require no action. REPEAL section empty for Texas; no harmful policies identified with strong evidence.
...
- **+0.02 pp/year** net change to median income growth (modest positive after tradeoffs)
- **+0.54 years** added to median healthy life expectancy

**Critical observation**: The total income effect (+0.02 pp/yr) is much smaller than the total health effect (+0.54 years in relative terms) because the tobacco tax creates a genuine tradeoff. This is a feature, not a bug: it surfaces real policy tensions rather than hiding them behind combined scores.

![A comparison chart showing the disparate impacts of policy recommendations on income growth versus healthy life expectancy, highlighting the tradeoff between economic and health outcomes.](/assets/images/optimal-policy-generator-spec/optimal-policy-generator-spec-section-interpretation-bw-academic.jpg)

The two-metric format makes tradeoffs explicit and enables direct interpretation without complex conversion factors. Policymakers can see that the tobacco tax recommendation prioritizes health over income, and adjust their weighting (α) accordingly if they disagree with equal weighting.
