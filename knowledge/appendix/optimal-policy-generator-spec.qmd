...
| Carbon tax | Renewable subsidy | Substitutable | Both reduce emissions; combined effect < sum |
...
|-----------------|----------|-------------|---------|
| `constitutional` | **Hard** | Requires constitutional amendment | 2nd Amendment limits on gun regulations |
...
2. **Politicians know their context.** An elected official in Texas understands local political dynamics better than any algorithm. OPG provides the evidence; filtering is left to policymaker discretion.
...
| Federal mandates | ACA Medicaid expansion | Compliance driven by federal law, not state preference |
