...
The [Earth Optimization Prize](/knowledge/strategy/earth-optimization-prize.html) [@earth-optimization-prize-paper-2025] has two targets by {{< var destructive_economy_50pct_year >}}: global HALE reaching {{< var treaty_projected_hale_year_15 >}} and median income reaching {{< var treaty_trajectory_avg_income_year_15 >}}. Every person who learns about the 1% Treaty and registers a vote earns you an Earth Optimization Point. Targets met, the prize pool goes to Earth Optimization Points holders. Targets missed, depositors still beat their retirement accounts.
