...
We love you. We do not want you to die of pancreatic cancer, ovarian cancer, glioblastoma, Alzheimer's, ALS, Parkinson's, or cardiovascular disease. We do not want your spouses, children, or parents to die of those things. We do not want our own families to die of them either. We are in the same actuarial position you are. I am going to die. So is my mother. So is everyone I have ever loved. So are you. We are in the same situation. This letter is a letter from one mortal human to another.
...
We do not want that for you. The Company's current lobbying is making it more likely. Every human in this picture has a roughly 100% lifetime probability of dying from a disease that would have had a treatment if anyone had funded the trial. The current {{< var military_to_government_clinical_trials_spending_ratio >}}-to-1 ratio of military spending to clinical-trial spending is increasing that probability for every one of us, including you. It is also making every one of us, including you, radically poorer than we would otherwise be.
...
We are not asking you to do something. We are asking you to *stop* doing something. Specifically, stop signing the lobbying line item that is shortening your own life. The same budget that currently funds the most effective political-influence operation on Earth, pointed at maintaining the {{< var military_to_government_clinical_trials_spending_ratio >}}-to-1 ratio that is killing all of us, just needs to be pointed at the 1% treaty instead. Same lobbyists. Same congressional relationships. Same dinners with senators. Different ask.
...
One more thing: as far as we are aware, this is the first lawsuit in legal history in which the defendants are radically better off losing than winning. The proposed settlement costs you $0 in incremental Company spending. It increases your personal expected net worth by approximately 200-300% via the GDP growth it unlocks. It increases your probability of being alive in 20 years and your spouse's probability of being alive in 20 years. It expands the Company's long-term addressable market by approximately {{< var treaty_trajectory_gdp_vs_current_trajectory_multiplier_year_15 >}}. There is no version of this case where winning makes you better off than settling. We have looked.

Stated plainly: winning this case is your death sentence. If you defeat us in court, the lobbying continues. If the lobbying continues, the disease eradication queue stays {{< var status_quo_queue_clearance_years_nounit >}} years long. The diseases that will kill you, your spouse, your children, your shareholders, and us stay in that queue. A legal victory in this case is, in actuarial terms, the death sentence the lobbying is signing on your behalf and ours. We are filing the lawsuit because we do not want you to sign it. We do not want to die either.

The same math applies to every human who participates in the case from the bench, the jury box, or the defense table, and to every member of their families. The judge who dismisses this case is dismissing the lawsuit that would have extended the judge's life expectancy, the judge's spouse's life expectancy, the lives of the judge's children, and the lives of the judge's grandchildren. The defense counsel who wins a motion to dismiss is winning a motion that will, in expected value, kill them, their spouse, their children, and their parents a decade or two earlier than the alternative. The same is true for every juror and for every member of every juror's family.

Counted up: each named party and each officer of the court carries with them an extended family of roughly 10-20 humans whose life expectancies and probabilities of dying from currently-untreated diseases are altered by this ruling. Across the plaintiff, the defendants, the judge, the jury, and counsel on both sides, that is on the order of 100-300 humans whose probability of dying of a preventable disease changes based on what this court decides. We love all of them. We do not want any of them to die of diseases the math says we could have cured. The case is, structurally, a request that every human reading it choose to live longer and let the people they love live longer.
...
To the judge specifically: if after all of that you are still inclined to rule for the defendant on procedural grounds, we are asking you to do one thing before signing the order. Take a sheet of paper and write down, in your own handwriting, the name of the human you love most in the world. Look at that name. Under the math in this filing, that is the human whose actuarial life expectancy your order shortens. We are not asking you to rule against the law. We are asking you to read the math, write the name, and then decide. The law belongs to you and the bar. The name belongs to you alone. We are asking you not to write it.
...
The Company's lobbying expenditure maintains an economic regime in which each shareholder earns approximately {{< var treaty_trajectory_lifetime_income_gain_per_capita >}} less over their lifetime than they would under the alternative. Each shareholder's spouse earns approximately {{< var treaty_trajectory_lifetime_income_gain_per_capita >}} less. Each shareholder's children inherit a smaller, sicker economy than the one their parents could have left them.
...
- The global agreement that would absorb the redirected military spending is documented in the [1% Treaty](../solution/1-percent-treaty.qmd) and the [Earth Optimization Prize](../strategy/earth-optimization-prize.qmd) [@earth-optimization-prize-paper-2025].
