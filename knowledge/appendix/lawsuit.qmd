...
6. Has the Board compared the current lobbying objective against lobbying for the 1% treaty, pragmatic clinical trials, or another policy selected by an open policy-return analysis? If not, why is the current objective presumed optimal?
...
The Company redirects its annual lobbying objective from maintaining current military spending levels to the highest-ranked policy identified by the independent analysis. If the 1% treaty wins, lobby for the 1% treaty. If pragmatic clinical trials win, lobby for pragmatic clinical trials. If another policy beats both on long-term shareholder value and general welfare, publish the analysis and lobby for the winner.
