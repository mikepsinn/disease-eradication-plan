...
6. Has the Board compared the current lobbying objective against lobbying for the 1% treaty, pragmatic clinical trials, or another policy selected by an open policy-return analysis (the [political dysfunction tax](political-dysfunction-tax.qmd) analysis catalogs the quantified candidates)? If not, why is the current objective presumed optimal?
