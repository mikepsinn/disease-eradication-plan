...
It is also the first lawsuit you can file for $200. One share of any major defense contractor is legally sufficient under DGCL § 327. The full demand letter, the share-purchase instructions, the brokerage walkthrough, the pre-filled defendant fact sheets, and the post-response decision tree are all linked from this page.

**The selfish version.** If you do not care about the disease eradication argument and only care about money, the share you bought to file the lawsuit also goes up in price. As the campaign scales, demand for defense contractor shares mechanically exceeds the available float (see [The Loving Takeover](loving-takeover.qmd) for the math), and prices spike for the same reason GameStop spiked in 2021. The lawsuit is the catalyst that activates the price action. Heads you make money on the share, tails you hold a normal defense position. The downside is foregone index-fund return on $200.
...
The cost is one share (~$200) plus 43 hours of work. The expected return on the dollars alone exceeds every retail investment vehicle available. The expected return on the years is the rest of your life and the rest of the lives of everyone you love.
...
2. Buy 1 share of any major defense contractor. The eight with [pre-filled fact sheets](pre-filled-demand-letters.qmd) are RTX, LMT, BA, GD, NOC, LHX, HII, and LDOS. Others (BAH, CACI, SAIC, BAE, Thales) work too; you just look up the corporate-secretary address yourself.
