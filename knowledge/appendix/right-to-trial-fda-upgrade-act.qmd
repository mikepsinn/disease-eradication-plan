...
![](/assets/infographics/knowledge/appendix/right-to-trial-fda-upgrade-act-infographic-retro-academic.jpg)
...
![A conceptual architecture diagram showing how decentralized health data silos integrate into a global protocol to enable anonymous causal inference and a unified learning health ecosystem.](/assets/images/right-to-trial-fda-upgrade-act/right-to-trial-fda-upgrade-act-section-sec-102-purpose-bw-academic.jpg)
...
![Comparison of the current clinical trial inefficiencies versus the demonstrated cost and speed advantages of decentralized, adaptive models.](/assets/images/right-to-trial-fda-upgrade-act/right-to-trial-fda-upgrade-act-section-findings-comparison-bw-academic.jpg)
...
![System architecture of the FDA.gov v2 Decentralized Health Protocol showing the flow of multiomic data from individuals and EHRs through a zero-knowledge backend to federal and international health agencies.](/assets/images/right-to-trial-fda-upgrade-act/right-to-trial-fda-upgrade-act-section-sec-104-definitions-bw-academic.jpg)
...
![A flowchart showing the regulatory process for qualifying non-animal test methods, from initial rulemaking to the acceptance of data as primary safety evidence in place of animal studies.](/assets/images/right-to-trial-fda-upgrade-act/right-to-trial-fda-upgrade-act-section-sec-201-accelerated-adopt-bw-academic.jpg)
...
![A conceptual diagram illustrating the four key pillars of clinical trial modernization: decentralized trials, adaptive designs, real-world evidence integration, and regulatory training.](/assets/images/right-to-trial-fda-upgrade-act/right-to-trial-fda-upgrade-act-section-sec-202-guidance-on-decen-bw-academic.jpg)
...
![A diagram illustrating the three pillars of modern drug development: integration of patient experience data, concurrent global regulatory review, and the alignment of international data standards.](/assets/images/right-to-trial-fda-upgrade-act/right-to-trial-fda-upgrade-act-section-sec-203-patient-focused-d-bw-academic.jpg)
...
![Architectural diagram of the FDA.gov v2 Decentralized Health Protocol showing the flow between the open API, AI-governance pull-request triage, blockchain ledger components, and multi-stakeholder oversight.](/assets/images/right-to-trial-fda-upgrade-act/right-to-trial-fda-upgrade-act-section-sec-204-fda-gov-v2-decent-bw-academic.jpg)
...
![A flowchart mapping the FDA-X Prize lifecycle, showing the progression from competition establishment to the demonstration of 80X cost reduction and final system integration.](/assets/images/right-to-trial-fda-upgrade-act/right-to-trial-fda-upgrade-act-section-sec-205-fda-x-prize-bw-academic.jpg)
...
![A flowchart illustrating the universal eligibility pathway, showing the decision logic between sponsor-led enrollment with PRV incentives and the 60-day NIH micro-study fallback mechanism.](/assets/images/right-to-trial-fda-upgrade-act/right-to-trial-fda-upgrade-act-section-sec-301-universal-eligibi-bw-academic.jpg)
...
![Process flow and system architecture for patient protections, including the e-consent comprehension loop, blockchain record storage, and the real-time safety monitoring data stream.](/assets/images/right-to-trial-fda-upgrade-act/right-to-trial-fda-upgrade-act-section-sec-302-patient-protections-consent-and-liability-bw-academic.jpg)
...
![System architecture diagram illustrating the flow of funds and data between the Treasury, the NIH optimization algorithm, the FDA v2 Protocol portal, trial sponsors, and patients.](/assets/images/right-to-trial-fda-upgrade-act/right-to-trial-fda-upgrade-act-section-sec-303-fair-access-and-discount-algorithms-bw-academic.jpg)
...
![A process flow diagram showing the interaction between trial sponsors, the FDA v2 protocol, and patients regarding cost calculations, NIH discounts, and the conditional refund of data deposits.](/assets/images/right-to-trial-fda-upgrade-act/right-to-trial-fda-upgrade-act-section-sec-304-patient-cost-cont-bw-academic.jpg)
...
![Architecture of the shared public health infrastructure showing the blockchain ledger as the central hub for multi-state licensure, DSCSA compliance, and global health agency coordination.](/assets/images/right-to-trial-fda-upgrade-act/right-to-trial-fda-upgrade-act-section-sec-401-coordination-with-existing-law-bw-academic.jpg)
...
![A chronological timeline illustrating the four-year implementation phases from the initial 180-day interim rules to the 48-month GAO report.](/assets/images/right-to-trial-fda-upgrade-act/right-to-trial-fda-upgrade-act-section-sec-403-implementation-timeline-bw-academic.jpg)
...
![A roadmap illustrating the transition of protocol governance from United States government oversight to an international multi-stakeholder body and eventually to a decentralized, on-chain governance model.](/assets/images/right-to-trial-fda-upgrade-act/right-to-trial-fda-upgrade-act-section-sec-404-strategy-for-glob-bw-academic.jpg)
...
![Workflow diagram of the mandatory FDA impact analysis process, illustrating the path from regulatory proposal to publication, including AI-driven modeling, public comment phases, and independent oversight audits.](/assets/images/right-to-trial-fda-upgrade-act/right-to-trial-fda-upgrade-act-section-sec-406-transparency-in-r-bw-academic.jpg)
