---
title: Recruitment & Outreach Plan
...
Note: This is how you build a list of humans willing to fight death before you have the weapons to fight with. This is Phase 0, the part where you demonstrate organization while building the plane mid-flight. Think of it as a Kickstarter for not dying, except instead of a shitty smartwatch, backers get to potentially live forever.
...
Right now your outreach says "Donate" and "Buy VICTORY Incentive Alignment Bonds", two things that are not yet feasible because:
...
These are the bleeding hearts who cry at pharmaceutical commercials. They have feelings, they want to help, and they'll delete $20 they can't afford because a child has cancer somewhere.
...
```
Title: "Reserve Your VICTORY [Incentive Alignment Bonds](incentive-alignment-bonds-paper-foundations.qmd) (Before We Run Out)"
...
- Area of Interest:
  ...
  □ Outreach (I have opinions online)
...
*Optimizing Strategic Messaging*

Here's how you fix your website's misaligned messaging:
...
### Step 2: Install the New Outreach Strategy
...
These are optimistic projections, but effective ones.
...
1. **New signups:** Categorize by interest level
...
**Week 4:** "Projected milestones" (first victories)
...
- Strategic projections that sound impressive
- Quotes from famous people taken out of context
- Progress bars that always go up
- Testimonials from early supporters (drafted for the movement)
...
- [ ] I want updates (send me updates)
...
- Engage stakeholders (look, we have public support!)
...
3. **Update your website calls-to-action** (stop the bleeding)
4. **Start collecting humans** (they're everywhere)
5. **Send weekly communications** (keep the dream alive)
