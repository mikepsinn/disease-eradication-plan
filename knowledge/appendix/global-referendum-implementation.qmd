...
- **Voting protocol**: Use an end-to-end verifiable scheme (like Helios) with individual ballot verification and public bulletin board.
  -   Reference: [Helios (Adida et al.)](.../../knowledge/references.qmd#helios-voting)

- **Identity / Sybil resistance**: Multi-factor: email/phone OTP; device/browser fingerprinting; optional liveness/biometrics; integration with national e-ID where available (e.g., models informed by [Estonia's experience](.../../knowledge/references.qmd#estonia-internet-voting)); proof-of-uniqueness partners.
