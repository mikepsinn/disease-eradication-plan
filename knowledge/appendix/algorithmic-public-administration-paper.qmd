...
1. *Structural dividend*: all fiscal cash the protocol directly captures by default: eliminated agency operating costs, reclaimed direct spending waste, and recovered tax gap. This is visible money, deposited to citizens first rather than buried in a lower rate or a larger bureaucracy.
...
The UBI has three funding layers. The **structural dividend** is the fiscal cash the protocol directly captures by default: eliminated agency operating costs, reclaimed direct spending waste, and recovered tax gap. The **productivity dividend** is the monetary distribution described above. The **democratic supplement** is whatever additional share of the ordinary discretionary budget citizens allocate to direct cash transfers through wishocratic preference. This section is about the distribution mechanism: one account, one formula, one daily deposit.
...
Note what is *not* in this table: the $1 trillion in welfare benefits. UBI replaces the *distribution mechanism*, not the transfer itself. People still receive money; they receive it through an algorithm instead of through 89 separate bureaucracies. Healthcare works similarly. Every citizen gets a health credit funded from the ordinary wishocratic budget, but the broader {{< var us_gov_waste_healthcare_inefficiency >}} healthcare waste estimated in the US Efficiency Audit is treated below as lower system cost, not as a fiscal windfall that can simply be deposited as cash.
