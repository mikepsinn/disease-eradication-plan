...
3. **Evidence engine (Optimocracy).** Cross-jurisdictional causal inference [@optimocracy-paper-2025] compares policy outcomes across thousands of jurisdictions and identifies which policies actually make people richer and less dead (median income, healthy life years). Eliminates the CBO's scoring function.
