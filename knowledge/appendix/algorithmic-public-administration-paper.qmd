...
1. *Structural dividend* (Section 11): budgetary savings from eliminating administrative intermediaries. This is money that was being spent on agencies and is now available.
...
3. *Democratic supplement* (Section 6): whatever share of the broader discretionary budget citizens choose to direct to cash transfers versus other public goods.

The citizen sees one deposit, but the sources are distinct: structural savings, monetary issuance, and democratic choice.
...
This is a pragmatic choice, not a theoretical one. An economically purer design would allow natural deflation and skip the monetary UBI entirely. The structural dividend (Section 11.4) would still exist. But the productivity dividend distributed as cash is the single most powerful adoption incentive the protocol has. Theoretical purity that never gets adopted helps nobody.
...
Section 4 describes the protocol's final-consumption settlement tax. This section describes what it replaces, and why the replacement is overdue.
...
The UBI has three funding layers. The **structural dividend** is protocol savings from eliminating intermediaries (Section 11.4). The **productivity dividend** is the monetary distribution described in Section 4. The **democratic supplement** is whatever share of the broader discretionary budget citizens allocate to direct cash transfers through wishocratic preference (Section 6). This section is about the distribution mechanism: one account, one formula, one daily deposit.
...
- **Lobbying-purchased waste (~$1-2T/year)**: Money that was being extracted from taxpayers and delivered to specific industries. When the intermediary disappears, the extraction stops. This manifests as lower taxes (the settlement tax rate can be lower because less revenue is wasted) and reallocation to higher-value uses through the existing discretionary budget.
...
The directly allocable savings (administrative overhead + tax evasion recovery) total approximately $820B/year. The primary destination is UBI: deposited daily to every verified citizen. No application. No means test. No intermediary. At $820B divided by 330 million Americans, that is approximately $2,500 per person per year, or $10,000 for a family of four, from this stream alone (before the productivity dividend and democratic supplement described in Sections 4 and 6).
...
Wishocracy governs the broader discretionary budget (the existing $6.8T in federal spending), not the protocol savings. The protocol savings flow to citizens. The discretionary budget is where citizens express preferences on cancer research vs. infrastructure vs. education vs. defense, while citizen rule votes govern legal changes that are not reducible to budget lines.
