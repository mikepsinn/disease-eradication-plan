...
Maximum workable UBI does not mean pretending one flat check can replace civilization. It means cashing out everything that is fundamentally a transfer and making the residual exception layer brutally rule-bound. Catastrophic health risk remains pooled through a universal catastrophic voucher or publicly financed catastrophic plan. Child education remains a per-child voucher or credit rather than adult cash. Everything else that is basically a transfer becomes cash.
