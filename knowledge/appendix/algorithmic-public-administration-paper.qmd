...
Operationally, that decomposes into ex-ante citizen welfare subject to hard budget and incentive constraints:
...
The exception rule is ex-ante insurance, not ex-post rescue theater. A category belongs in the public catastrophic layer only if citizens, before knowing who will get sick, would rationally choose to pool that risk rather than take the same dollars as equal cash. Operationally, that means five constraints:
