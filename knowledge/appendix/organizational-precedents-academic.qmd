...
description: An analysis of the organizational structures and staffing models of key precedents, The Global Fund, the ICBL, and MakerDAO, to inform a decentralized institutes of health team structure.
published: true
tags:
...
This document analyzes the organizational structures of three successful entities that serve as precedents for a decentralized institutes of health (DIH). By understanding how they are staffed and organized, the organization can provide a credible, real-world justification for the [Hiring Plan](../operations/careers/hiring-plan-academic.qmd).
...
**Relevance to DIH:** The Global Fund's structure provides a proven blueprint for the team required to manage a **1% Treaty Fund (Phase 3)**. A decentralized institutes of health's CFO, CCO, Treasury Operations, and Program Officer roles are directly analogous to the core functions of The Global Fund's Secretariat.
...
**Relevance to DIH:** The ICBL's lean, decentralized structure is the model for **a decentralized institutes of health's political campaign (Phases 1 & 2)**. A decentralized institutes of health's Head of Political Strategy, Elections Compliance Lead, and Regional Campaign Directors are the modern, more heavily capitalized version of the ICBL's core coordination team. The entity is, in effect, running a professionalized, well-funded ICBL.
...
**Relevance to DIH:** MakerDAO provides the blueprint for how a decentralized institutes of health will operate in its **mature, fully decentralized state (post-Phase 3)**. A decentralized institutes of health's Head of Governance / DAO Facilitator role is directly modeled on MakerDAO's successful Governance Core Unit. The long-term vision is for the core functions of a decentralized institutes of health to be managed by a similar network of independent, specialized teams funded by the 1% Treaty Fund itself.