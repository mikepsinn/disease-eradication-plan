...
description: "Political dysfunction costs society trillions annually: {{< var us_gov_waste_total >}} in documented US waste and {{< var political_dysfunction_global_opportunity_cost_total >}} in global opportunity costs. Optimocracy proposes algorithmic governance: a system that analyzes historical data to recommend policies that maximize health and wealth, while using a SuperPAC to incentivize politicians to follow the evidence rather than lobbyists. This approach maintains democratic structures while making the ignorance of data politically expensive."
abstract: |
  Politicians allocate trillions annually. What gets you reelected is often not what benefits voters.
  This misalignment costs {{< var us_gov_waste_total >}} in documented US waste alone.
...
We estimate this tax through forensic accounting of documented policy failures. The methodology and sources are detailed in [The Political Dysfunction Tax](political-dysfunction-tax.qmd). Key findings:
...
**Note on interpretation:** These estimates are not additive; many inefficiencies interact and overlap. However, even conservative aggregation suggests the Political Dysfunction Tax amounts to {{< var us_gov_waste_pct_gdp >}} of US GDP in documented waste.
...
The US government waste estimate of {{< var us_gov_waste_total >}} ({{< var us_gov_waste_pct_gdp >}} of GDP) is derived from the [Federal Resource Allocation Efficiency Audit](federal-efficiency-audit.qmd), which enumerates specific, measurable policy failures across defense, healthcare, justice, regulatory, and subsidy subsystems.

![A breakdown of documented US government waste by subsystem, showing healthcare, housing, military, regulatory, tax compliance, and other categories.](/assets/images/optimocracy-paper/optimocracy-paper-section-alternative-estimation-bottom-up-policy-cost-accounting-bw-academic.jpg)
...
The Political Dysfunction Tax ({{< var us_gov_waste_total >}} in US waste, {{< var political_dysfunction_global_opportunity_cost_total >}} in global opportunity costs) arises from both **misallocation** (wrong spending levels) and **bad policy** (welfare-reducing regulations). Addressing both requires both frameworks working together.
