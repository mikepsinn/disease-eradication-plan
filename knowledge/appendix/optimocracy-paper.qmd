...
abstract: |
  ...
  alignment with evidence. Politicians still decide; the scoreboard just records what they decided and what
  it cost. Acting on the scoreboard is a separate problem, and this paper surveys the available mechanisms
  rather than assuming one. At system
...
The execution system publishes recommendations and tracks politician alignment. The alignment score is the input any [adoption mechanism](#sec-adoption-mechanisms) acts on, and the layer is indifferent to which one does. Outcome measurement validates the system over time.
