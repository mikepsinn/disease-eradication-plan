...
abstract: |
  ...
  The structural advantage: bribing 1,000 committee chairs is easier than corrupting multiple independent data sources. The mechanism makes representing voters the winning strategy.
aliases:
  - /optimocracy.html
author:
  - name: Mike P. Sinn
...
**The index fund analogy:** Index funds outperform 90%+ of active managers by following systematic rules instead of discretionary stock-picking [@spiva2023]. Optimocracy applies the same logic to governance: follow evidence-based recommendations, outperform captured allocation.

**Capture resistance:** Currently, lobbyists have thousands of doors to knock on (committee earmarks, agency decisions, regulatory rulings). Each is cheap to capture. Optimocracy collapses these to one hard target: the data sources measuring health and wealth. Bribing 1,000 cheap doors is easier than bribing one expensive vault with five independent locks. Corruption doesn't disappear; it just gets prohibitively expensive.
...
**The key insight:** Health and wealth aren't contested values requiring democratic selection. They're what everyone already wants. The hard problem isn't "what should we optimize?" but "who measures it honestly?" That's an oracle design problem, addressed through multi-source verification.

### Precedents That Work

**Index funds:** Over 15-year periods, 90%+ of active managers underperform benchmark indices after fees [@spiva2023]. Rule-based allocation outperforms discretionary management. Optimocracy applies this logic to governance.
...
Politicians face 2-6 year horizons; welfare-improving investments often take 15-30 years to pay off. The algorithm weights long-term outcomes appropriately because it doesn't face reelection. Automatic stabilizers (unemployment insurance, progressive taxation) already demonstrate this logic for fiscal policy.
