---
title: 'Optimocracy: Apply Causal Inference to Historical Policy Data to Maximize Human Welfare'
description: "Suboptimal public policy costs society trillions annually: {{< var us_gov_waste_total >}} in documented US waste and {{< var political_dysfunction_global_opportunity_cost_total >}} in global opportunity costs. Optimocracy proposes algorithmic governance: a system that analyzes historical data to recommend policies that maximize health and wealth, while incentivizing politicians to follow the evidence rather than lobbyists. This approach maintains democratic structures while making suboptimal policy politically expensive."
abstract: |
  ...
  politician alignment, (5) Fund accordingly via SuperPAC algorithmically funding the campaigns of the most humanity aligned policymakers.
aliases:
  - /optimocracy.html
author:
  - name: Mike P. Sinn
