...
The US government waste estimate of {{< var us_gov_waste_total >}} ({{< var us_gov_waste_pct_gdp >}} of GDP) is derived from the [United States Efficiency Audit](us-efficiency-audit.qmd), which enumerates specific, measurable policy failures across defense, healthcare, justice, regulatory, and subsidy subsystems.
