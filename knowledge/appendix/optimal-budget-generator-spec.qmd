...
abstract: |
  Imagine a world where every public dollar flows toward what actually improves human lives. Not toward
  historical inertia. Not toward whoever organized first. Toward what the evidence says will reduce
  suffering and expand flourishing. We are not living in that world. The gap between what we spend and
  what the evidence says we should spend represents 20-40% of everything humanity produces (tens of
  trillions of dollars annually), decade after decade. That gap is not an abstraction. It is children who
  die of diseases we know how to prevent. It is cures delayed by decades because our systems were designed
  before we had the data to know better. It is the difference between the world we have inherited and the
  world we could build. The Optimal Budget Generator makes this gap visible. For any jurisdiction, it asks:
  What do the healthiest, wealthiest societies spend? Where does evidence show diminishing returns? What
  is the marginal life saved, the marginal year of suffering prevented, per dollar? The output is a map
  of misallocation, where outdated systems are starving what works and feeding what doesn't. The potential
  is not incremental improvement. It is the unlocking of human flourishing on a scale we have never seen.
aliases:
...
The OBG framework relates to the mechanism design literature on optimal public good provision [@myerson1981]. In a setting where spending categories are public goods with heterogeneous returns:
