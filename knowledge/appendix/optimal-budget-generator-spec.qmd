...
subtitle: Generating Integrated Budget Recommendations Using Diminishing Returns Modeling and Cost-Effectiveness Analysis
...
abstract: |
  20-40% of public spending is misallocated relative to outcome-maximizing benchmarks. This represents $8-16 trillion
  annually in potential welfare gains. Budget processes respond to lobbying intensity and historical
  precedent rather than comparative effectiveness evidence.

  The Optimal Budget Generator combines two evidence sources for each spending category.
  Diminishing returns modeling: where does spending hit saturation? Cost-effectiveness analysis:
  what's the marginal impact per dollar? Where methods agree, confidence is high. Where they
  diverge, uncertainty is quantified.

  Each category gets an optimal spending level with a Budget Impact Score (study quality × statistical
  precision × temporal recency) measuring confidence. Output: gap analysis showing which categories
  are over- or underfunded relative to evidence-based benchmarks.
aliases:
...
![A conceptual diagram of the Optimal Budget Generator (OBG) framework showing how three evidence sources (benchmarking, returns modeling, and threshold analysis) integrate to create a gap analysis between current and evidence-based optimal funding levels.](/assets/images/optimal-budget-generator-spec/optimal-budget-generator-spec-section-abstract-unnumbered-bw-academic.jpg)
...
The result is a gap analysis showing which categories are underfunded relative to evidence-based optimal levels, enabling systematic reallocation from overinvestment to underinvestment. Applied to the US federal budget, the framework identifies pragmatic clinical trials as the most severely underinvested category (9,900% below optimal with {{< var dfda_roi_rd_only >}} benefit-cost ratio), followed by vaccinations, basic research, and early childhood education.
...
![A mockup of a budget analyst dashboard integrating OSL estimates, diminishing returns curves, peer spending comparisons, and evidence quality scores.](/assets/images/optimal-budget-generator-spec/optimal-budget-generator-spec-section-what-budget-analysts-see-bw-academic.jpg)
...
![Architecture of the Optimocracy Framework showing the parallel inputs of budget (OBG) and policy (OPG) generators feeding into the Constitutional Layer.](/assets/images/optimal-budget-generator-spec/optimal-budget-generator-spec-section-system-overview-bw-academic.jpg)

The OPG framework (see [Optimal Policy Generator Specification](https://opg.warondisease.org)) answers: "Which policy reforms beyond budget allocation would most improve welfare?"

### Implementation Mechanism

OBG generates evidence-based budget recommendations. [Incentive Alignment Bonds](../appendix/incentive-alignment-bonds-paper.qmd) provide the political implementation mechanism: independent electoral support and post-office career opportunities flow to politicians in proportion to how closely their voting records correlate with OBG recommendations. No money flows directly to politicians. Instead, independent actors (PACs, foundations, think tanks) commit ex-ante to favor high-scorers on public metrics derived from OBG gap analysis.

![A flow diagram illustrating the indirect incentive mechanism where OBG gap analysis informs independent actor support for politicians based on their voting alignment.](/assets/images/optimal-budget-generator-spec/optimal-budget-generator-spec-section-implementation-mechanism-bw-academic.jpg)
...
![A comparison between the political drivers of current budget allocation (such as lobbying and historical inertia) and the resulting gap between low-return and high-return public investments.](/assets/images/optimal-budget-generator-spec/optimal-budget-generator-spec-section-why-budget-allocation-fails-today-bw-academic.jpg)
...
![Conceptual comparison between Recommended Daily Allowances (RDA) in nutrition and Optimal Spending Levels (OSL) in public finance.](/assets/images/optimal-budget-generator-spec/optimal-budget-generator-spec-section-introduction-bw-academic.jpg)

### What This Framework Provides

![A conceptual diagram showing the five core components of the budget framework, illustrating how evidence-based targets and gap analysis inform priority ranking and uncertainty assessment.](/assets/images/optimal-budget-generator-spec/optimal-budget-generator-spec-section-what-this-framework-provides-bw-academic.jpg)
...
![A comparison matrix of budget analysis frameworks showing the focus of CBO Scoring, Performance-Based Budgeting, and Zero-Based Budgeting relative to the evidence-based targets of the OBG framework.](/assets/images/optimal-budget-generator-spec/optimal-budget-generator-spec-section-budget-analysis-frameworks-bw-academic.jpg)
...
![A comparison showing how Outcome-Based Governance (OBG) builds upon traditional evidence synthesis and cost-effectiveness analysis by shifting from intervention evaluation to budget-level optimization.](/assets/images/optimal-budget-generator-spec/optimal-budget-generator-spec-section-evidence-based-policy-movement-bw-academic.jpg)
...
![A conceptual overview of the OBG framework illustrating the triangulation of estimation methods, the identification of optimal spending targets, and the categorization of recommendations based on evidence strength via the Budget Impact Score.](/assets/images/optimal-budget-generator-spec/optimal-budget-generator-spec-section-how-obg-differs-bw-academic.jpg)
...
![A conceptual diagram illustrating the social planner's optimization process, showing how evidence-weighted inputs lead to optimal spending levels and resource allocation within the OBG framework.](/assets/images/optimal-budget-generator-spec/optimal-budget-generator-spec-section-theoretical-framework-bw-academic.jpg)
...
![Breakdown of the Budget Impact Score (BIS) components, showing how quality, precision, and recency weights combine to quantify confidence.](/assets/images/optimal-budget-generator-spec/optimal-budget-generator-spec-section-theoretical-framework-bw-academic.jpg)
...
![An entity-relationship diagram illustrating the data structure of the OBG framework, connecting spending categories to reference data, optimal estimates, and gap analysis.](/assets/images/optimal-budget-generator-spec/optimal-budget-generator-spec-section-spending-category-data-structure-bw-academic.jpg)
...
![A graph showing a downward-sloping marginal return curve intersecting with a horizontal line representing the opportunity cost (r) to identify the Optimal Spending Level (OSL).](/assets/images/optimal-budget-generator-spec/optimal-budget-generator-spec-section-the-core-concept-bw-academic.jpg)
...
![Theoretical diminishing returns curve illustrating the 'knee' point where marginal welfare gains begin to flatten relative to spending increases.](/assets/images/optimal-budget-generator-spec/optimal-budget-generator-spec-section-diminishing-returns-modeling-bw-academic.jpg)
...
![A comparison of return on investment across different public sectors and a cost-efficiency breakdown between pragmatic and traditional clinical trials.](/assets/images/optimal-budget-generator-spec/optimal-budget-generator-spec-section-the-highest-return-public-investment-bw-academic.jpg)

Pragmatic clinical trials represent perhaps the single highest-return category of public investment identified in the literature. While vaccinations return {{< var childhood_vaccination_roi >}} and early childhood education returns 4:1, pragmatic trials demonstrate benefit-cost ratios of **{{< var dfda_roi_rd_only >}}** [@dfda-impact-paper-2025].

The UK's RECOVERY trial demonstrated this dramatically during COVID-19: it cost approximately {{< var recovery_trial_cost_per_patient >}} per patient versus {{< var traditional_phase3_cost_per_patient >}} for traditional Phase 3 trials, a {{< var recovery_trial_cost_reduction_factor >}} cost reduction [@recovery-trial-summary-quote]. This single trial identified dexamethasone as a life-saving treatment, preventing an estimated 1 million deaths globally.
...
1. **Unmet medical need**: Approximately {{< var global_annual_daly_burden >}} DALYs annually from conditions lacking adequate treatment
2. **Cost per DALY averted**: Pragmatic trials cost {{< var adaptable_trial_cost_per_patient >}} per patient (ADAPTABLE trial) vs. {{< var traditional_phase3_cost_per_patient >}} traditional
...
![A conceptual line graph showing returns versus spending for pragmatic trials, highlighting the 'knee' of the curve at $50-100B and the current position at $500M within the increasing returns phase.](/assets/images/optimal-budget-generator-spec/optimal-budget-generator-spec-section-diminishing-returns-analysis-bw-academic.jpg)
...
| Opportunity cost | {{< var dfda_roi_rd_only >}} foregone returns |
...
This exceeds vaccinations (25.7), basic research (31.5), and even military reallocation (222.5 in absolute terms, but negative direction).

**Recommendation**: Pragmatic clinical trials represent the single most underinvested category in the federal budget. The 1% Treaty proposal to redirect {{< var treaty_annual_funding >}} from military spending to health research, with pragmatic trials as the primary mechanism, would capture returns far higher than current allocation achieves.
...
![A sequential flowchart illustrating the four-step process of aggregating intervention-level data into a category-level Optimal Service Level (OSL).](/assets/images/optimal-budget-generator-spec/optimal-budget-generator-spec-section-building-up-from-intervention-level-data-bw-academic.jpg)
...
![A diagram illustrating the hierarchy of causal evidence, showing how different levels of evidence quality determine the Budget Impact Score and overall confidence levels.](/assets/images/optimal-budget-generator-spec/optimal-budget-generator-spec-section-budget-impact-score-bis-bw-academic.jpg)
...
![A conceptual framework illustrating the four essential robustness checks for OSL estimates: outlier analysis, methodological consistency, temporal stability, and parameter sensitivity.](/assets/images/optimal-budget-generator-spec/optimal-budget-generator-spec-section-robustness-checks-bw-academic.jpg)
...
![A conceptual comparison of four pilot design strategies: randomized scale-up, stepped-wedge rollout, natural experiment exploitation, and administrative data linkage.](/assets/images/optimal-budget-generator-spec/optimal-budget-generator-spec-section-recommended-pilot-designs-bw-academic.jpg)
...
![A circular diagram illustrating the continuous four-step learning feedback loop used to refine budget priorities based on statistical outcomes and updated data.](/assets/images/optimal-budget-generator-spec/optimal-budget-generator-spec-section-learning-feedback-loop-bw-academic.jpg)
...
| **CBO Budget Analyses** | Federal | [cbo.gov](https://www.cbo.gov) | Fiscal impact scoring [@cbo2015] |
...
![A line graph illustrating diminishing returns with a curve flattening out, featuring shaded confidence intervals and a dashed line representing the risks of extrapolation beyond historical data points.](/assets/images/optimal-budget-generator-spec/optimal-budget-generator-spec-section-diminishing-returns-uncertainty-bw-academic.jpg)

### Implementation Capacity

Higher spending may not translate to outcomes if implementation capacity is lacking.

![A flow diagram illustrating how spending is successfully converted to outcomes by passing through the filters of implementation assessment and gradual phasing.](/assets/images/optimal-budget-generator-spec/optimal-budget-generator-spec-section-implementation-capacity-bw-academic.jpg)
...
![A flowchart outlining the three-step methodology for retrospective validation, showing the sequence from historical OSL calculation to the comparative analysis of jurisdiction outcomes.](/assets/images/optimal-budget-generator-spec/optimal-budget-generator-spec-section-retrospective-validation-bw-academic.jpg)
...
![A flowchart illustrating the prospective validation process, from public pre-registration of predictions to the comparative analysis of outcome trajectories between jurisdictions.](/assets/images/optimal-budget-generator-spec/optimal-budget-generator-spec-section-prospective-validation-bw-academic.jpg)
...
The framework's current evidence base consists of the underlying studies cited throughout (e.g., @jackson2016 for education, @vaccine-roi-44-to-1 for vaccinations), not direct validation of OBG itself.
...
![A comparison chart showing the projected OSL range across pessimistic, base case, and optimistic scenarios based on varying return estimates.](/assets/images/optimal-budget-generator-spec/optimal-budget-generator-spec-section-scenario-analysis-bw-academic.jpg)
...
![The five-phase Optimal Budget Generator (OBG) analysis pipeline, detailing the process from data ingestion to gap analysis reporting.](/assets/images/optimal-budget-generator-spec/optimal-budget-generator-spec-section-appendix-b-analysis-workflow-bw-academic.jpg)
...
![A conceptual framework illustrating the Optimal Budget Generator process, showing how evidence and benchmarking result in OSL and BIS outputs to identify spending gaps.](/assets/images/optimal-budget-generator-spec/optimal-budget-generator-spec-section-core-concepts-bw-academic.jpg)
...
| Non-defense discretionary | 915 | 1,350 | +435 | +48% | 0.65 | ++ | ++ | 283 |
...
1. **Extreme underinvestment in pragmatic trials**: At 9,900% below OSL with {{< var dfda_roi_rd_only >}} BCR, this represents the single largest misallocation in the federal budget
2. **Severe overinvestment**: Military spending is ~85% above evidence-optimal levels
3. **Severe underinvestment**: Vaccinations, basic research, health research far below evidence-optimal levels
4. **Negative-return spending**: Agricultural subsidies should be eliminated entirely
5. **Reallocation potential**: ~$400B could be reallocated from low/negative return to high-return categories, with pragmatic trials as the primary target

**Estimated welfare gain from OSL alignment**: Moving from current allocation to OSL targets would increase the combined welfare metric (real after-tax median income growth + median healthy life years) by an estimated 3-5% of GDP equivalent ($750B-$1.25T annually), based on the differential returns between over- and under-invested categories. Pragmatic clinical trials alone account for approximately $30-50B of this potential gain due to their extreme BCR and impact on both metrics.
