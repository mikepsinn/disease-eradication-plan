...
1. **Extreme underinvestment in pragmatic trials**: At 9,900% below OSL with {{< var dfda_roi_rd_only >}}:1 BCR, this appears to be the single largest misallocation in the federal budget (see Section 6 for full derivation)
