...
format:
  ...
  pdf:
    ...
    fontsize: 11pt
---
![The Optimal Budget Generator (OBG) answers: 'How should we allocate the budget to maximize welfare?' Unlike isolated spending targets, OBG generates integrated budget recommendations that account for tradeoffs between categories. The Budget Impact Score (BIS) measures confidence in each category's target.](/assets/infographics/knowledge/appendix/optimal-budget-generator-spec-infographic-academic.jpg)
