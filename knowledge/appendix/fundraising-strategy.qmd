...
tags:
  ...
  - victory-bonds
  - whale-targeting
image: /assets/og-images/knowledge/appendix/fundraising-strategy-og-academic.png
---
{{< include /knowledge/includes/setup-parameters.qmd >}}

![Infographic](/assets/infographics/knowledge/appendix/fundraising-strategy-infographic-academic.png)
...
The capital required for a [1% treaty](../solution/1-percent-treaty.qmd) is not for ongoing operations. It's "activation energy", the one-time push to overcome political inertia and unlock **{{< var treaty_annual_funding >}} annually** for global health.^[[Value captured by 1% treaty](../references.qmd#value-captured-by-1pct-treaty)]
...
**Global Referendum** (~{{< var treaty_campaign_budget_referendum >}}) - Get 208M people to vote for the treaty:
...
- New model: Spend $150M lobbying for treaty → Keep $2.67T military budget (99%) + earn {{< var victory_bond_annual_return_pct >}} on $27B health budget
...
**Funding source: 100% VICTORY [Incentive Alignment Bonds](incentive-alignment-bonds-paper.qmd) ({{< var treaty_campaign_total_cost >}} total)**
