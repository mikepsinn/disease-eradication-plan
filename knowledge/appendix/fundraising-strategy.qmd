...
**The campaign** ($1B) is NOT building a dFDA - it's getting people to vote for the treaty and lobbying governments to sign it. A dFDA platform gets built AFTER the treaty passes using the $27B/year revenue.
...
- Your decentralized institutes of health treasury infrastructure 
...
- They get NEW income stream: {{< var treaty_annual_funding >}} × {{< var victory_bond_funding_pct >}} = {{< var victory_bond_annual_payout >}}/year to VICTORY bondholders
...
- **Returns**: VICTORY bondholders get {{< var victory_bond_annual_payout >}}/year ({{< var victory_bond_funding_pct >}} of {{< var treaty_annual_funding >}})
...
- VICTORY bondholders: {{< var victory_bond_annual_payout >}}/year ({{< var victory_bond_funding_pct >}})
