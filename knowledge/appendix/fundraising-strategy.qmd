...
The capital required for a [1% treaty](../solution/1-percent-treaty.qmd) is not for ongoing operations. It's "activation energy", the one-time push to overcome political inertia and unlock **[{{< var treaty_annual_funding >}} annually](../references.qmd#value-captured-by-1pct-treaty)** for global health.
