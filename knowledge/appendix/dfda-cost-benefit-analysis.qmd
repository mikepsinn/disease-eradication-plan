...
description: Analysis and Return on Investment - How to slash per-patient trial costs by up to 80×, generate approximately $50 billion in annual gross R&D savings, and deliver ROI ranging from {{< var dfda_roi_rd_only >}} (R&D only) to {{< var dfda_roi_rd_plus_delay >}} (with post-safety efficacy lag elimination).
published: true
tags:
  - dfda
  - roi
...
- **{{< var dfda_roi_rd_only >}} Return on Investment (R&D Only)**: A modest annual operational cost of ~{{< var dfda_upfront_build >}} generates ~{{< var dfda_rd_gross_savings_annual >}} in industry-wide savings, yielding an NPV of ~[\$249B over 10 years](#final-roi-and-net-benefit). **[Comprehensive ROI](#roi-with-regulatory-delay-avoidance)** including post-safety efficacy lag elimination: **{{< var dfda_roi_rd_plus_delay >}}** (conservative) to **{{< var dfda_roi_rd_plus_delay_plus_innovation >}}** (full impact).
- **[Eliminates Post-Safety Efficacy Lag](#regulatory-delay-avoidance)**: By providing post-Phase I access via trial participation, the dFDA eliminates the {{< var efficacy_lag_years >}}-year Phase II/III [efficacy lag](regulatory-mortality-analysis.qmd) **while preserving rigorous Phase I safety testing**, saving **{{< var dfda_avoided_regulatory_delay_dalys_annual >}} [DALYs/year](#regulatory-delay-avoidance)** (valued at **{{< var dfda_avoided_regulatory_delay_cost_annual >}}/year**).
- **[Two QALY Estimates](#regulatory-delay-avoidance)**: Conservative bottom-up estimate of **{{< var dfda_qalys_rd_plus_delay_annual >}} [QALYs/year](#appendix-detailed-qaly-calculation-model)** from specific mechanisms; comprehensive top-down estimate of **{{< var dfda_qalys_rd_plus_delay_annual >}}/year** including [post-safety efficacy lag elimination](#regulatory-delay-avoidance).
...
**The dFDA's primary health benefit comes from eliminating the "efficacy lag"**, the {{< var efficacy_lag_years >}}-year Phase II/III delay between Phase I safety verification and final approval. **Critical: This does NOT eliminate safety testing.** Phase I safety testing (2.3 years) is preserved.
...
This eliminates approximately **{{< var dfda_regulatory_delay_avoidance_fraction >}} of post-safety efficacy lag** (the Phase II/III portion, while preserving Phase I safety testing).

#### Quantified Benefits

The dFDA's post-safety efficacy lag elimination creates:
...
- **Comprehensive Annual QALYs**: {{< var dfda_qalys_rd_plus_delay_annual >}} (post-safety efficacy lag elimination + prevention benefits)
