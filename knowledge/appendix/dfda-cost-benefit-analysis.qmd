...
- **Return on Investment (R&D Only)**: {{< var dfda_roi_rd_only >}}:1. A modest annual operational cost of ~{{< var dfda_upfront_build >}} generates ~{{< var dfda_benefit_rd_only_annual >}} in industry-wide savings, yielding an NPV of ~{{< var dfda_npv_net_benefit_rd_only >}} [over 10 years](#final-roi-and-net-benefit). **[Comprehensive ROI](#roi-with-regulatory-delay-avoidance)** including all core benefits (R&D savings, regulatory delay elimination, and peace dividend): **{{< var treaty_roi_trial_capacity_plus_efficacy_lag >}}:1** (PRIMARY recommended estimate).
...
**Why 10 years?** Standard business analysis horizon. The benefits continue beyond 10 years, but we use this conservative timeframe to calculate NPV and ROI (~{{< var dfda_roi_rd_only >}}:1).
...
- **Annual Framework Operational Cost**: {{< var dfda_annual_opex >}}
- **Simple ROI (Gross/Opex)**: {{< var dfda_roi_simple >}}:1
- **NPV-Adjusted ROI (10-year)**: {{< var dfda_roi_rd_only >}}:1 ← CANONICAL FIGURE
...
- **Funding Coverage (Captured Dividend / OpEx)**: {{< var dividend_coverage_factor >}}×
...
- **Time Horizon**: {{< var npv_time_horizon_years >}} years
- **Adoption Ramp**: {{< var dfda_npv_adoption_ramp_years >}} years to 100%

**NPV Analysis Results:**

- **NPV of Total Costs** ({{< var npv_time_horizon_years >}} years): {{< var dfda_npv_total_cost >}}
- **NPV of Total Savings** ({{< var npv_time_horizon_years >}} years): {{< var dfda_npv_benefit_rd_only >}}
- **Net Benefit** (NPV Savings - NPV Costs): {{< var dfda_npv_net_benefit_rd_only >}}
- **NPV-Adjusted ROI** (NPV Savings / NPV Costs): {{< var dfda_roi_rd_only >}}:1
...
- **Cost-Effectiveness**: A decentralized framework for drug assessment achieves cost-effectiveness through dual pathways:
  ...
  2. **Health Gains**: {{< var dfda_trial_capacity_plus_efficacy_lag_dalys >}} DALYs averted from the full timeline shift (~{{< var dfda_trial_capacity_plus_efficacy_lag_years >}} years from {{< var dfda_trial_capacity_multiplier >}}× trial capacity + efficacy lag elimination)
...
| ---------------------------------------------------- | -------------------------- | -------------------------- | ----------------------------- | ------------------------------- | --------------------------- | --------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Base Case: Core framework Ops Only**                | **50.0%** ($50.0B Savings)     | **$0.01875B ($18.75M)**    | **-$49.981B**                 | **{{< var dfda_trial_capacity_plus_efficacy_lag_dalys >}}**                     | Cost-Saving + Health Gain   | **Dominant**                            | Ops cost from the ['Annual Operational Costs'](#annual-operational-costs-illustrative-at-target-scale-of-5m-mau-50tb-ingest-month) ROM midpoint. DALYs from full timeline shift (trial capacity + efficacy lag elimination).                                                              |
| Core framework + Medium Broader Initiative            | 50.0% ($50.0B Savings)         | $0.04005B ($40.05M)        | -$49.96B                      | {{< var dfda_trial_capacity_plus_efficacy_lag_dalys >}}                         | Cost-Saving + Health Gain   | Dominant                                | Ops from ['Annual Operational Costs'](#annual-operational-costs-illustrative-at-target-scale-of-5m-mau-50tb-ingest-month) + ['Scenario Based ROM Estimates for Broader Initiative Costs'](#scenario-based-rom-estimates-for-broader-initiative-costs) (Medium), aligns with ROI calc. |
| Total Ecosystem (Low-Medium Cost)                    | 50.0% ($50.0B Savings)         | $0.5B              | -$49.5B                       | {{< var dfda_trial_capacity_plus_efficacy_lag_dalys >}}                         | Cost-Saving + Health Gain   | Dominant                                | Illustrative total ecosystem cost.                                                                                                                                                                                                                                                    |
| Total Ecosystem (High Cost, e.g. w/ Part. Comp.)     | 50.0% ($50.0B Savings)         | $5B                        | -$45B                         | {{< var dfda_trial_capacity_plus_efficacy_lag_dalys >}}                         | Cost-Saving + Health Gain   | Dominant                                | Illustrative high total ecosystem cost (as prior base).                                                                                                                                                                                                                               |
| Conservative R&D Savings & Health Gains              | 30% ($30.0B Savings)           | $0.5B              | -$29.5B                       | {{< var dfda_trial_capacity_plus_efficacy_lag_dalys >}}                         | Cost-Saving + Health Gain   | Dominant                                | Using Low-Med Ecosystem Cost & conservative health impact.                                                                                                                                                                                                                        |
| Optimistic R&D Savings & Health Gains                | 70% ($70B Savings)         | $0.5B              | -$69.5B                       | {{< var dfda_trial_capacity_plus_efficacy_lag_dalys >}}                       | Cost-Saving + Health Gain   | Dominant                                | Using Low-Med Ecosystem Cost & optimistic health impact.                                                                                                                                                                                                                          |
| **Transformative R&D Savings (RECOVERY Trial-like)** | **95%** ($95.0B Savings)     | **$0.5B**          | **-$94.5B**                   | **{{< var dfda_trial_capacity_plus_efficacy_lag_dalys >}}**                   | Cost-Saving + Health Gain   | **Dominant**                            | Using Low-Med Ecosystem Cost & optimistic health impact.                                                                                                                                                                                                                          |
| Platform Breaks Even (R&D Savings = Ops Cost)        | e.g., 0.5% ($0.5B Savings) | $0.5B              | $0                            | {{< var dfda_trial_capacity_plus_efficacy_lag_dalys >}}                         | Cost-Neutral + Health Gain  | Dominant (Cost-Neutral, Health Gaining) | Using Low-Med Ecosystem Cost & base health impact.                                                                                                                                                                                                                            |
