...
description: Analysis and Return on Investment - How to slash per-patient trial costs by up to {{< var dfda_trial_cost_reduction_factor >}}, generate approximately {{< var dfda_benefit_rd_only_annual >}} in annual gross R&D savings, and deliver ROI of {{< var dfda_roi_rd_only >}}:1.
published: true
tags:
  - dfda
  - roi
...
- **Return on Investment**: {{< var dfda_roi_rd_only >}}:1. A 10-year NPV cost of {{< var dfda_npv_total_cost >}} generates {{< var dfda_npv_net_benefit_rd_only >}} in NPV R&D savings [over 10 years](#final-roi-and-net-benefit).
...
- **Return on Investment (ROI):** A dFDA Infrastructure has an extremely high ROI. Based on total 10-year NPV costs of {{< var dfda_npv_total_cost >}} against **{{< var dfda_npv_net_benefit_rd_only >}} in NPV R&D savings** (**{{< var dfda_trial_cost_reduction_pct >}} cost reduction**, [see Market Size and Impact](#market-size-and-impact)), Monte Carlo analysis yields an ROI of **{{< var dfda_roi_rd_only >}}:1** ([see ROI Uncertainty Analysis](#roi-uncertainty-analysis-monte-carlo)). A modest investment in global software infrastructure generates vast savings across the entire pharmaceutical R&D industry.
...
**Central ROI Estimate: {{< var dfda_roi_rd_only >}}:1**
...
- **ROI (10-year NPV)**: {{< var dfda_roi_rd_only >}}:1
...
**ROI Estimate**: {{< var dfda_roi_rd_only >}}:1 (10-year NPV, accounting for time value of money and 5-year adoption ramp).
...
1. **Exceptional ROI**: The framework generates a {{< var dfda_roi_rd_only >}}:1 return on investment ({{< var dfda_npv_net_benefit_rd_only >}} NPV benefit from {{< var dfda_npv_total_cost >}} NPV cost)
