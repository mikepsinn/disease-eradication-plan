...
- Decentralized trial costs drop closer to the [Oxford RECOVERY model](#decentralized-trial-costs-modeled-on-oxford-recovery): from [\$40,000 - \$120,000 per patient](../references.qmd#clinical-trial-cost-per-patient) to roughly **{{< var dfda_pragmatic_trial_cost_per_patient >}} per patient**.
