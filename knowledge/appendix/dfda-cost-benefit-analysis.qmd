...
- **[Eliminates Post-Safety Efficacy Lag](#regulatory-delay-avoidance)**: By providing post-Phase I access via trial participation, the dFDA eliminates the {{< var efficacy_lag_years >}}-year Phase II/III [efficacy lag](regulatory-mortality-analysis.qmd) **while preserving rigorous Phase I safety testing**, achieving a one-time timeline shift saving **{{< var dfda_qalys_rd_plus_delay_annual >}} QALYs average per year during the shift** (valued at **{{< var dfda_qalys_rd_plus_delay_monetized >}} total economic value**).
...
- **Total DALYs**: {{< var disease_eradication_delay_dalys >}}B Disability-Adjusted Life Years lost
- **Average Impact per Year During Shift**: ~{{< var disease_eradication_delay_annual_dalys >}} DALYs/year average during the 8.2-year timeline shift
...
The dFDA's post-safety efficacy lag elimination achieves a one-time 8.2-year timeline acceleration:

- **Total QALYs Saved**: {{< var disease_eradication_delay_dalys >}}B × {{< var dfda_regulatory_delay_avoidance_fraction >}} = {{< var dfda_qalys_rd_plus_delay_annual >}}M QALYs average per year during the shift
- **Total Economic Value**: {{< var dfda_qalys_rd_plus_delay_monetized >}} (total one-time benefit from timeline shift)
- **Lives Saved**: {{< var dfda_lives_saved_annual >}}M (total over the 8.2-year period)
