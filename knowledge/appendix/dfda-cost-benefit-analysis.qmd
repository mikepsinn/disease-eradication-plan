...
![](/assets/infographics/knowledge/appendix/dfda-cost-benefit-analysis-infographic-academic.png)
...
- **Total Deaths**: {{< var disease_eradication_delay_deaths_total >}} eventually avoidable deaths over {{< var efficacy_lag_years >}}-year efficacy lag (1962-2024)
