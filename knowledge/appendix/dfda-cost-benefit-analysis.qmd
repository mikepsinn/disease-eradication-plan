...
| **Bounty & Prize Program (Act SEC. 204(i))** | $1M (Prizes) / ~$0           | {{< var dfda_opex_platform_maintenance >}} (Bounties) / {{< var dfda_opex_community >}}          | {{< var treaty_campaign_budget_reserve >}} (Major Bounties) / $10M  | Success of organic ecosystem growth vs. need to incentivize critical plugin/tool development via bounties. |
