...
- **Fewer Dead People:** The platform generates [{{< var global_dfda_qalys_gained_annual >}} extra life-years annually](#appendix-detailed-qaly-calculation-model) through faster access, better prevention data, and drugs for diseases companies currently ignore.
...
> - **Upfront full platform build:** [\$37.5–\{{< var dfda_upfront_build_max >}}](#upfront-capital-expenditure-initial-build-illustrative-30-months)
...
- The lower end (~\{{< var treaty_campaign_budget_reserve >}}) covers building a solid platform and achieving initial scale, similar to companies like Science 37 or Thread.
- The upper end (~\{{< var recovery_trial_cost_per_patient >}}M+) reflects the multi-year investment for a market-leading, feature-rich global platform with extensive third-party tools, analogous to Medable's trajectory.
