...
- **Daily QALYs Lost:**
  - The analysis ([Appendix: Detailed QALY Calculation Model](#appendix-detailed-qaly-calculation-model)) projects a baseline of **{{< var global_dfda_qalys_gained_annual >}} Quality-Adjusted Life Years (QALYs) gained per year** from the dFDA's impact.
