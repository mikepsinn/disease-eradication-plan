...
- **Return on Investment (ROI):** A dFDA Infrastructure has an extremely high ROI. Based on Core framework operational costs (ROM estimate {{< var dfda_upfront_build >}} per year including medium broader initiative costs) against **{{< var dfda_benefit_rd_only_annual >}} in annual R and D savings** (**{{< var dfda_trial_cost_reduction_pct >}} reduction scenario**, [see Market Size and Impact](#market-size-and-impact)), the NPV analysis yields ROI estimates ranging from **66:1 to 2,577:1** depending on total ecosystem costs ([see Full Range ROI Sensitivity Analysis](#full-range-roi-sensitivity-analysis)), with a central estimate of approximately **{{< var dfda_roi_rd_only >}}:1** over 10 years. A modest investment in global software infrastructure generates vast savings across the entire pharmaceutical R&D industry.
...
- Net Annual Savings: {{< var dfda_benefit_rd_only_annual >}}/year (from {{< var dfda_trial_cost_reduction_pct >}} R&D cost reduction).
