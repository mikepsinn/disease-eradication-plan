...
| Total Ecosystem (Low-Medium Cost)                    | 50.0% ($50.0B Savings)         | $0.5B ({{< var recovery_trial_cost_per_patient >}}M)              | -$49.5B                       | {{< var disease_eradication_delay_dalys >}}                         | Cost-Saving + Health Gain   | Dominant                                | Illustrative total ecosystem cost.                                                                                                                                                                                                                                                    |
...
| Conservative R&D Savings & Health Gains              | 30% ($30.0B Savings)           | $0.5B ({{< var recovery_trial_cost_per_patient >}}M)              | -$29.5B                       | {{< var disease_eradication_delay_dalys >}}                         | Cost-Saving + Health Gain   | Dominant                                | Using Low-Med Ecosystem Cost & conservative health impact.                                                                                                                                                                                                                        |
| Optimistic R&D Savings & Health Gains                | 70% ($70B Savings)         | $0.5B ({{< var recovery_trial_cost_per_patient >}}M)              | -$69.5B                       | {{< var disease_eradication_delay_dalys >}}                       | Cost-Saving + Health Gain   | Dominant                                | Using Low-Med Ecosystem Cost & optimistic health impact.                                                                                                                                                                                                                          |
| **Transformative R&D Savings (RECOVERY Trial-like)** | **95%** ($95.0B Savings)     | **$0.5B ({{< var recovery_trial_cost_per_patient >}}M)**          | **-$94.5B**                   | **{{< var disease_eradication_delay_dalys >}}**                   | Cost-Saving + Health Gain   | **Dominant**                            | Using Low-Med Ecosystem Cost & optimistic health impact.                                                                                                                                                                                                                          |
| Platform Breaks Even (R&D Savings = Ops Cost)        | e.g., 0.5% ($0.5B Savings) | $0.5B ({{< var recovery_trial_cost_per_patient >}}M)              | $0                            | {{< var disease_eradication_delay_dalys >}}                         | Cost-Neutral + Health Gain  | Dominant (Cost-Neutral, Health Gaining) | Using Low-Med Ecosystem Cost & base health impact.                                                                                                                                                                                                                            |
