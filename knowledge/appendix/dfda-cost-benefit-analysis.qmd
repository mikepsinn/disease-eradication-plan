...
- **Saves ~[{{< var dfda_gross_savings_annual >}} Annually](#gross-r-d-savings-from-dfda-implementation)**: Reduces global clinical trial costs (~[{{< var global_clinical_trials_spending_annual >}}/year market](../references.qmd#clinical-trial-spending-dfda-baseline)) by a baseline of **[50.0%](#gross-r-and-d-savings-from-dfda-implementation)**, with up to **[95%](#gross-r-and-d-savings-from-dfda-implementation)** savings in optimal scenarios.
- **[463:1 Return on Investment](#final-roi-and-net-benefit)**: A modest annual operational cost of ~[{{< var dfda_upfront_build >}}](#simplified-roi-scenario) generates ~{{< var dfda_gross_savings_annual >}} in industry-wide savings, yielding an NPV of ~[\$249B over 10 years](#final-roi-and-net-benefit).
...
- **QALY Framework:** [Standard willingness-to-pay is **$100,000–{{< var standard_economic_qaly_value_usd >}} per QALY gained**](../references.qmd#qaly-value).
- **Example Calculation:** If faster access saves 10,000 QALYs/year, annual benefit = 10,000 × [{{< var standard_economic_qaly_value_usd >}}](../references.qmd#qaly-value) = **$1.5B**. If 10,000 lives are saved, benefit = 10,000 × [{{< var value_of_statistical_life >}}](../references.qmd#vsl-value-statistical-life) = **$100B**.
