...
- **[Two QALY Estimates](#regulatory-delay-avoidance)**: Conservative bottom-up estimate of **{{< var global_dfda_qalys_gained_annual >}} [QALYs/year](#appendix-detailed-qaly-calculation-model)** from specific mechanisms; comprehensive top-down estimate of **{{< var global_dfda_qalys_with_regulatory_avoidance >}}/year** including [regulatory delay avoidance](#regulatory-delay-avoidance).
...
- **Fewer Dead People:** The platform generates {{< var global_dfda_qalys_gained_annual >}} extra life-years annually through faster access, better prevention data, and drugs for diseases companies currently ignore.
...
- **Comprehensive Annual QALYs**: {{< var global_dfda_qalys_with_regulatory_avoidance >}} (regulatory delay avoidance + prevention benefits)

This represents the **top-down comprehensive estimate** of dFDA health benefits, compared to the **{{< var global_dfda_qalys_gained_annual >}} conservative bottom-up estimate** from specific mechanism modeling.
...
- **Daily QALYs Lost:**
  - The analysis ([Regulatory Mortality Analysis](regulatory-mortality-analysis.qmd)) projects a baseline of **{{< var global_dfda_qalys_gained_annual >}} Quality-Adjusted Life Years (QALYs) gained per year** from eliminating the regulatory efficacy lag.
...
| :--------------------------------------- | :----------------------: | :------------------: | :-----------------: | :------------------------: | :------------------------: | :------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Conservative**                         |           30%            |     {{< var sensitivity_dfda_savings_conservative >}}     |       {{< var qalys_total_conservative >}}       |      **\$82 Million**      |          **521**           | Assumes lower efficiency gains and moderate health impact, using [conservative QALY model](#summary-of-total-annual-qaly-gains).                  |
| **Base Case**                            |         **50%**          |   **\$50 Billion**   |     **{{< var global_dfda_qalys_gained_annual >}}**     |     **\$137 Million**      |         **2,301**          | **The central estimate used in this analysis, based on the [median QALY model](#summary-of-total-annual-qaly-gains).**                            |
| **Optimistic**                           |           70%            |     \$70 Billion     |      {{< var qalys_total_optimistic >}}      |     **\$192 Million**      |         **{{< var dfda_large_trial_size >}}**         | Assumes high efficiency and significant improvements in health outcomes, using [optimistic QALY model](#summary-of-total-annual-qaly-gains).      |
| **Transformative (RECOVERY Trial-like)** |         **95%**          |   **\$95 Billion**   |    **{{< var qalys_total_optimistic >}}**    |     **\$260 Million**      |         **{{< var dfda_large_trial_size >}}**         | Reflects exceptional, RECOVERY-like efficiency and broad health benefits, using [new optimistic QALY model](#summary-of-total-annual-qaly-gains). |
...
qaly_gains_annual_baseline = GLOBAL_DFDA_QALYS_GAINED_ANNUAL  # {{< var global_dfda_qalys_gained_annual >}} QALYs
value_per_qaly = STANDARD_ECONOMIC_QALY_VALUE_USD  # ${{< var qalys_from_prevention_optimistic >}} per QALY
...
2. **Massive Health Benefits**: {{< var global_dfda_qalys_gained_annual >}} QALYs gained annually, worth $126 billion in monetized value
...
- **US Willingness-to-Pay Threshold**: Typically $100,000–${{< var qalys_from_prevention_optimistic >}} per QALY for interventions that _add_ costs. Dominant interventions are favorable regardless of this threshold.
...
- **Sources for Context:**
  ...
  - [Value per QALY](../references.qmd#qaly-value): "ICER's health benefit price benchmark (HBPB) will continue to be reported using the standard range from $100,000 to ${{< var qalys_from_prevention_optimistic >}} per QALY..."
...
- **Conservative Scenario:** {{< var qalys_total_conservative >}} QALYs/year
- **Base Case Scenario:** {{< var global_dfda_qalys_gained_annual >}} QALYs/year
- **Optimistic/Transformative Scenario:** {{< var qalys_total_optimistic >}} QALYs/year
...
| ---------------------------------------------------- | -------------------------- | -------------------------- | ----------------------------- | ------------------------------- | --------------------------- | --------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Base Case: Core Platform Ops Only**                | **50.0%** ($50.0B Savings)     | **$0.01875B ($18.75M)**    | **-$49.981B**                 | **{{< var global_dfda_qalys_gained_annual >}}**                     | **-$59,501**                | **Dominant**                            | Ops cost from the ['Annual Operational Costs'](#annual-operational-costs-illustrative-at-target-scale-of-5m-mau-50tb-ingest-month) ROM midpoint. QALYs from [new base model](#appendix-detailed-qaly-calculation-model).                                                              |
| Core Platform + Medium Broader Initiative            | 50.0% ($50.0B Savings)         | $0.04005B ($40.05M)        | -$49.96B                      | {{< var global_dfda_qalys_gained_annual >}}                         | -$59,476                    | Dominant                                | Ops from ['Annual Operational Costs'](#annual-operational-costs-illustrative-at-target-scale-of-5m-mau-50tb-ingest-month) + ['Scenario Based ROM Estimates for Broader Initiative Costs'](#scenario-based-rom-estimates-for-broader-initiative-costs) (Medium), aligns with ROI calc. |
| Total Ecosystem (Low-Medium Cost)                    | 50.0% ($50.0B Savings)         | $0.5B ({{< var recovery_trial_cost_per_patient >}}M)              | -$49.5B                       | {{< var global_dfda_qalys_gained_annual >}}                         | -$58,929                    | Dominant                                | Illustrative total ecosystem cost.                                                                                                                                                                                                                                                    |
| Total Ecosystem (High Cost, e.g. w/ Part. Comp.)     | 50.0% ($50.0B Savings)         | $5B                        | -$45B                         | {{< var global_dfda_qalys_gained_annual >}}                         | -$53,571                    | Dominant                                | Illustrative high total ecosystem cost (as prior base).                                                                                                                                                                                                                               |
| Conservative R&D Savings & QALYs                     | 30% ({{< var global_education_for_all_cost >}} Savings)         | $0.5B ({{< var recovery_trial_cost_per_patient >}}M)              | -$29.5B                       | {{< var qalys_total_conservative >}}                         | -$155,263                   | Dominant                                | Using Low-Med Ecosystem Cost & [Conservative QALY model](#summary-of-total-annual-qaly-gains).                                                                                                                                                                                        |
| Optimistic R&D Savings & QALYs                       | 70% ($70B Savings)         | $0.5B ({{< var recovery_trial_cost_per_patient >}}M)              | -$69.5B                       | {{< var qalys_total_optimistic >}}                       | -$19,041                    | Dominant                                | Using Low-Med Ecosystem Cost & [Optimistic QALY model](#summary-of-total-annual-qaly-gains).                                                                                                                                                                                          |
| **Transformative R&D Savings (RECOVERY Trial-like)** | **95%** ({{< var sensitivity_dfda_savings_optimistic >}} Savings)     | **$0.5B ({{< var recovery_trial_cost_per_patient >}}M)**          | **-$94.5B**                   | **{{< var qalys_total_optimistic >}}**                   | **-{{< var caregiver_value_per_hour_simple >}},890**                | **Dominant**                            | Using Low-Med Ecosystem Cost & [Optimistic QALY model](#summary-of-total-annual-qaly-gains).                                                                                                                                                                                          |
| Platform Breaks Even (R&D Savings = Ops Cost)        | e.g., {{< var trial_cost_reduction_pct >}} ($0.5B Savings) | $0.5B ({{< var recovery_trial_cost_per_patient >}}M)              | $0                            | {{< var global_dfda_qalys_gained_annual >}}                         | $0                          | Dominant (Cost-Neutral, Health Gaining) | Using Low-Med Ecosystem Cost & Base QALYs.                                                                                                                                                                                                                                            |
...
| :---------------------------- | :----------------------------------------------------------: | :------------------------------------------------------ | :------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **dFDA Infrastructure**             |                     **4,744 - 194,667**                      | **-$260,000 to -$19,000**<a href="#ref_dfda_icer">²</a> | **Dominant**                     | [This analysis's Sensitivity Analysis](#sensitivity-analysis-overall-dfda-platform-cost-effectiveness). Based on $18.75M-$40.05M annual costs generating {{< var global_dfda_qalys_gained_annual >}}-3.65M QALYs annually.                                                                              |
...
| **Hypertension Screening**    |                         **30 - 50**                          | **~{{< var lobbyist_bond_investment_max >}},000 - $33,000**                                  | Highly Cost-Effective            | Recent US studies show pharmacist-led hypertension management has ICERs under ${{< var qalys_from_prevention_conservative >}}/QALY, with most interventions falling in the $20,000-$33,000 range. ([JAMA Netw Open, 2023](../references.qmd#jama-hypertension-pharmacist-led))            |
