...
> **Section Summary**
>
> - **Upfront core platform build:** [\$37.5–\{{< var dfda_upfront_build_max >}}](#upfront-capital-expenditure-initial-build-illustrative-30-months)
...
1. **Core Engineering & Development Effort:**
   ...
   - **Estimated ROM:** [\$35 - {{< var dfda_upfront_build >}}](#upfront-capital-expenditure-initial-build-illustrative-30-months)
...
> **Total Estimated Upfront Cost (ROM): [\$37.5 - \{{< var dfda_upfront_build_max >}}](#upfront-capital-expenditure-initial-build-illustrative-30-months)**
...
- **Other DCT Platform Companies:** [Other companies in the space](../references.qmd#dct-platform-funding-others), such as **Science 37** (~{{< var dfda_upfront_build >}} raised), **Thread** (up to \{{< var treaty_campaign_budget_reserve >}} raised), and **uMotif** (~\$25.5M raised), show that you can achieve significant traction and platform development with investments in the tens of millions.
...
- The lower end (~\{{< var treaty_campaign_budget_reserve >}}) aligns with the capital needed to build a robust platform and achieve initial scale, similar to companies like Science 37 or Thread.
- The upper end (~\{{< var recovery_trial_cost_per_patient >}}M+) reflects the multi-year investment needed to build a market-leading, feature-rich global platform with a vast ecosystem, analogous to the trajectory of Medable.
...
- **Average Cost Range Per User (at 5M MAU):**
  - Based on the total annual operational cost range of **[\$11M - \$26.5M](#annual-operational-costs-illustrative-at-target-scale-of-5m-mau-50tb-ingest-month)**, the average cost per user is:
    $$
    \frac{\$11,000,000 \text{ to } \$26,{{< var qalys_from_new_therapies >}}}{{{< var current_trial_slots_available >}} \text{ users}} = \mathbf{\$2.20 \text{ to } \$5.30 \text{ per user per year}}
    $$
...
_(Note: The underlying cloud infrastructure cost (\{{< var dfda_opex_regulatory >}}-\{{< var dfda_opex_platform_maintenance >}}/year) is a top-down ROM estimate. A more granular, bottom-up analysis based on projected per-user storage, data transfer, and compute would provide further support for these figures and is a key area for future refinement of this model.)_
...
| :------------------------------------------- | :--------------------------- | :----------------------------- | :---------------------------- | :--------------------------------------------------------------------------------------------------------- |
| **Global Data Integration**                  | {{< var dfda_opex_community >}} / ~$0                    | $125M / {{< var value_of_statistical_life >}}                   | $1.5B / $150M                 | Success of AI/automation, standards adoption, #systems, vendor cooperation.                                |
| **Bounty & Prize Program (Act SEC. 204(i))** | $1M (Prizes) / ~$0           | {{< var dfda_opex_platform_maintenance >}} (Bounties) / {{< var dfda_opex_community >}}          | {{< var treaty_campaign_budget_reserve >}} (Major Bounties) / {{< var value_of_statistical_life >}}  | Success of organic ecosystem growth vs. need to incentivize critical plugin/tool development via bounties. |
| **Legal/Regulatory Harmonization**           | $1.5M / ~$0                  | {{< var sensitivity_dfda_opex_conservative >}} / $3M                     | {{< var average_us_hourly_wage >}}0M / {{< var sensitivity_dfda_opex_optimistic >}}                  | Effectiveness of AI legal tools, political will, complexity of global law.                                 |
| **Global Rollout & Adoption**                | ~$0 / ~$0                    | $12M / $3M                     | $125M / {{< var sensitivity_dfda_opex_optimistic >}}                  | Need for training/support beyond platform status, user interface complexity.                               |
...
- **Initial Core Platform Build (~2.5 years): [~\$37.5 - \{{< var dfda_upfront_build_max >}}](#upfront-capital-expenditure-initial-build-illustrative-30-months)**
...
- **Clinical Trial Phase Breakdown**:
  ...
  - Phase II: \{{< var vsl_epa_millions >}} - \$50 million/trial (depending on disease area).
...
- **Oxford RECOVERY**: Achieved [**~\{{< var recovery_trial_cost_per_patient >}} per patient**](recovery-trial.qmd). Key strategies included:
...
- **Extrapolation to New System**:
  ...
  - Up to **~80-100x+ cost reduction** cited for RECOVERY vs. typical Phase III trials is an aspirational benchmark, derived by comparing per-patient costs of [~\{{< var recovery_trial_cost_per_patient >}}-\${{< var traditional_large_trial_size >}}](#decentralized-trial-costs-modeled-on-oxford-recovery) against traditional costs of [~\$40,000 - \$120,000+](#market-size-and-impact).

  The cost reduction factor can be formalized as:

  $$
  \text{Reduction Factor} = \frac{c_t}{c_d} = \frac{\$40,000 - \$120,000}{\{{< var recovery_trial_cost_per_patient >}} - \${{< var traditional_large_trial_size >}}} \approx 40 - 240\times
  $$
  ...
  $$
  \alpha = 1 - \frac{c_d}{c_t} = 1 - \frac{\{{< var recovery_trial_cost_per_patient >}} - \${{< var traditional_large_trial_size >}}}{\$40,000 - \$120,000} \approx 97.5\% - 99.2\%
  $$
...
1. **By Reducing Per-Patient Costs**
   ...
   - $c_d$ is the decentralized cost per patient (\{{< var recovery_trial_cost_per_patient >}} - \${{< var traditional_large_trial_size >}})

   For a trial with $x = 5,000$ participants, the savings range from:

   - Minimum savings: $(\$40,000 - \${{< var traditional_large_trial_size >}}) \times 5,000 = \$195$ million
   - Maximum savings: $(\$120,000 - \{{< var recovery_trial_cost_per_patient >}}) \times 5,000 = \$597.5$ million
...
- [Chronic diseases account for ~90% of U.S. healthcare spending](../references.qmd#us-chronic-disease-spending) (~\{{< var global_annual_war_indirect_costs_total >}}/year).
...
- **Value of a Statistical Life (VSL):** [U.S. agencies use ~{{< var value_of_statistical_life >}} per life saved](../references.qmd#vsl-value-statistical-life).
- **QALY Framework:** [Standard willingness-to-pay is **$100,000–${{< var qalys_from_prevention_optimistic >}} per QALY gained**](../references.qmd#qaly-value).
- **Example Calculation:** If faster access saves {{< var dfda_large_trial_size >}} QALYs/year, annual benefit = 10,000 × [${{< var qalys_from_prevention_optimistic >}}](../references.qmd#qaly-value) = **\$1.5B**. If 10,000 lives are saved, benefit = 10,000 × [{{< var value_of_statistical_life >}}](../references.qmd#vsl-value-statistical-life) = **\{{< var global_clinical_trial_market_annual >}}**.
...
- **Range Used in Sensitivity Analysis**:
  - **Conservative**: $\alpha = 0.30$
    $$
    S_{\text{annual}} = 0.30 \times \$100.0\text{B} = \{{< var average_us_hourly_wage >}}\text{B} \text{ annually}
    $$
...
- **Platform Cost Scenarios (Derived from ROM Estimates):**
  - **Upfront Cost (Core Platform Build):** [~{{< var dfda_upfront_build >}}](#upfront-capital-expenditure-initial-build-illustrative-30-months) (representative figure from [Upfront (Capital) Expenditure](#upfront-capital-expenditure-initial-build-illustrative-30-months)).
...
- **Upfront Costs:**
  - Core Platform Build (High end from [Upfront (Capital) Expenditure](#upfront-capital-expenditure-initial-build-illustrative-30-months)): [~\{{< var dfda_upfront_build_max >}}](#upfront-capital-expenditure-initial-build-illustrative-30-months)
  ...
  - _Total Highest Upfront Cost:_ {{< var global_cost_per_conflict_death_millions >}}M + $2.231B = **~\$2.277 Billion**
...
- **Daily QALYs Lost:**
  - The analysis ([Appendix: Detailed QALY Calculation Model](#appendix-detailed-qaly-calculation-model)) projects a baseline of **[{{< var global_dfda_qalys_gained_annual >}} Quality-Adjusted Life Years (QALYs) gained per year](#appendix-detailed-qaly-calculation-model)** from the dFDA's impact.
  - The daily opportunity cost in lost health is therefore:
    $$
    \frac{{{< var global_dfda_qalys_gained_annual >}}\ \text{QALYs}}{365\ \text{days}} \approx \mathbf{2,301\ \text{QALYs lost per day}}
    $$
...
- **Daily Financial Value Lost:**
  ...
  - The daily financial loss from this inefficiency is:
    $$
    \frac{\${{< var qalys_from_prevention_conservative >}},000,000}{365\ \text{days}} \approx \mathbf{\$137\ \text{million lost per day}}
    $$
...
| :--------------------------------------- | :----------------------: | :------------------: | :-----------------: | :------------------------: | :------------------------: | :------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Conservative**                         |           30%            |     \{{< var average_us_hourly_wage >}} Billion     |       {{< var qalys_total_conservative >}}       |      **\$82 Million**      |          **521**           | Assumes lower efficiency gains and moderate health impact, using [conservative QALY model](#summary-of-total-annual-qaly-gains).                  |
| **Base Case**                            |         **50%**          |   **\$50 Billion**   |     [**{{< var global_dfda_qalys_gained_annual >}}**](#appendix-detailed-qaly-calculation-model)     |     **\$137 Million**      |         **2,301**          | **The central estimate used in this analysis, based on the [median QALY model](#summary-of-total-annual-qaly-gains).**                            |
...
- For $t=1$ to 5:
  - $t=1$: $S(1) = 10$. Discount factor: $\frac{1}{1.08}\approx 0.9259$. Contribution: {{< var vsl_epa_millions >}} \times 0.9259=9.26$.
  - $t=2$: $S(2) = 20$. Discount factor: $\frac{1}{1.08^2}\approx 0.8573$. Contribution: {{< var lobbyist_bond_investment_max_millions >}} \times 0.8573=17.15$.
...
global_clinical_trial_market = GLOBAL_CLINICAL_TRIAL_MARKET_ANNUAL  # {{< var global_clinical_trial_market_annual >}}
...
gross_rd_savings = DFDA_GROSS_SAVINGS_ANNUAL  # Pre-calculated: {{< var sensitivity_peace_dividend_conservative >}}
...
print("The simple ROI ({{< var dfda_roi_simple >}}:1) is useful for comparison but doesn't discount future cash flows.")
```
...
2. **Annual Operational Cost**: The platform could be cheaper or more expensive to run than the estimated $40M. You model a range from {{< var lobbyist_bond_investment_max_millions >}}M to $80M.
...
Rd = GLOBAL_CLINICAL_TRIAL_MARKET_ANNUAL  # {{< var global_clinical_trial_market_annual >}} annual global R&D spend on clinical trials
...
- **US Willingness-to-Pay Threshold**: Typically [$100,000–${{< var qalys_from_prevention_optimistic >}} per QALY](../references.qmd#qaly-value) for interventions that _add_ costs. Dominant interventions are favorable regardless of this threshold.
...
- **Base Case Scenario:** [{{< var global_dfda_qalys_gained_annual >}} QALYs/year](#appendix-detailed-qaly-calculation-model)
...
| ---------------------------------------------------- | -------------------------- | -------------------------- | ----------------------------- | ------------------------------- | --------------------------- | --------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Base Case: Core Platform Ops Only**                | **50.0%** ($50.0B Savings)     | **$0.01875B ($18.75M)**    | **-$49.981B**                 | [**{{< var global_dfda_qalys_gained_annual >}}**](#appendix-detailed-qaly-calculation-model)                     | **-$59,501**                | **Dominant**                            | Ops cost from the ['Annual Operational Costs'](#annual-operational-costs-illustrative-at-target-scale-of-5m-mau-50tb-ingest-month) ROM midpoint. QALYs from [new base model](#appendix-detailed-qaly-calculation-model).                                                              |
| Core Platform + Medium Broader Initiative            | 50.0% ($50.0B Savings)         | $0.04005B ($40.05M)        | -$49.96B                      | [{{< var global_dfda_qalys_gained_annual >}}](#appendix-detailed-qaly-calculation-model)                         | -$59,476                    | Dominant                                | Ops from ['Annual Operational Costs'](#annual-operational-costs-illustrative-at-target-scale-of-5m-mau-50tb-ingest-month) + ['Scenario Based ROM Estimates for Broader Initiative Costs'](#scenario-based-rom-estimates-for-broader-initiative-costs) (Medium), aligns with ROI calc. |
| Total Ecosystem (Low-Medium Cost)                    | 50.0% ($50.0B Savings)         | $0.5B ({{< var recovery_trial_cost_per_patient >}}M)              | -$49.5B                       | [{{< var global_dfda_qalys_gained_annual >}}](#appendix-detailed-qaly-calculation-model)                         | -$58,929                    | Dominant                                | Illustrative total ecosystem cost.                                                                                                                                                                                                                                                    |
| Total Ecosystem (High Cost, e.g. w/ Part. Comp.)     | 50.0% ($50.0B Savings)         | $5B                        | -$45B                         | [{{< var global_dfda_qalys_gained_annual >}}](#appendix-detailed-qaly-calculation-model)                         | -$53,571                    | Dominant                                | Illustrative high total ecosystem cost (as prior base).                                                                                                                                                                                                                               |
...
| Platform Breaks Even (R&D Savings = Ops Cost)        | e.g., {{< var trial_cost_reduction_pct >}} ($0.5B Savings) | $0.5B ({{< var recovery_trial_cost_per_patient >}}M)              | $0                            | [{{< var global_dfda_qalys_gained_annual >}}](#appendix-detailed-qaly-calculation-model)                         | $0                          | Dominant (Cost-Neutral, Health Gaining) | Using Low-Med Ecosystem Cost & Base QALYs.                                                                                                                                                                                                                                            |
...
| **Clean Water Programs**      |                       **100 - {{< var traditional_large_trial_size >}}**                        | **~$1,000 - ${{< var dfda_large_trial_size >}}**                                   | Highly Cost-Effective            | WHO estimates household water treatment costs {{< var lobbyist_bond_investment_max_millions >}}-{{< var recovery_trial_cost_per_patient >}}/DALY averted. Community water supply improvements cost $200-${{< var dfda_drug_approvals_per_year_high >}}/DALY. ([WHO, 2004](../references.qmd#who-clean-water-daly-costs))                                              |
| **Hypertension Screening**    |                         **30 - 50**                          | **~{{< var lobbyist_bond_investment_max_millions >}},000 - $33,000**                                  | Highly Cost-Effective            | Recent US studies show pharmacist-led hypertension management has ICERs under ${{< var qalys_from_prevention_conservative >}}/QALY, with most interventions falling in the $20,000-$33,000 range. ([JAMA Netw Open, 2023](../references.qmd#jama-hypertension-pharmacist-led))            |
...
To provide context for the dFDA's estimated costs, it is useful to compare them to other significant U.S. government investments in health and technology. The dFDA's projected "Lean Ecosystem" cost of approximately **[{{< var dfda_upfront_build >}} per year](#simplified-roi-scenario)** (covering core platform operations plus medium-scope broader initiatives) is modest in comparison to other major federal projects.
...
| **dFDA Infrastructure (Lean Ecosystem)**   | **~{{< var dfda_upfront_build >}} / year**                                                                           | **1x (Baseline)**                        | [This analysis](#simplified-roi-scenario)                                  |
| **Cancer Moonshot Initiative**       | **[~\$257 Million / year](https://www.cancer.gov/about-nci/budget)** ($1.8B over 7 years)          | **~6.4x**                                | [21st Century Cures Act](../references.qmd#21st-century-cures-act-2016)          |
| **NIH "All of Us" Research Program** | \*\*[~\{{< var recovery_trial_cost_per_patient >}} Million / year](https://www.nih.gov/about-nih/what-we-do/budget) (FY23 Approx. Budget) | **~12.5x**                               | [NIH Budget](https://www.nih.gov/about-nih/what-we-do/budget)              |
