...
description: Analysis and Return on Investment - How to slash per-patient trial costs by up to {{< var dfda_trial_cost_reduction_factor >}}, generate approximately {{< var dfda_benefit_rd_only_annual >}} in annual gross R&D savings, and deliver ROI of {{< var dfda_roi_rd_only >}}.
published: true
tags:
  - dfda
  - roi
