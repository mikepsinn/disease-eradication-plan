...
- **Extrapolation to New System**:
  ...
  - Up to **~{{< var dfda_trial_cost_reduction_factor >}}× cost reduction** is achievable by comparing pragmatic trial costs ({{< var dfda_pragmatic_trial_cost_per_patient >}}) against traditional costs of [~\$40,000 - \$120,000+](#market-size-and-impact).
...
1. **Cost of Current Drug Development**:
   ...
   - Oxford RECOVERY trial press releases and scientific papers indicating {{< var recovery_trial_cost_per_patient >}}/patient cost, informing pragmatic trial cost estimates of {{< var dfda_pragmatic_trial_cost_per_patient >}}/patient.
...
dfda_rd_cost_reduction_pct = DFDA_TRIAL_COST_REDUCTION_PCT  # 50%
dfda_annual_operational_cost = DFDA_ANNUAL_OPEX  # $0.040B ({{< var dfda_upfront_build >}})

# Baseline QALYs generated annually

daly_gains_timeline_shift = DFDA_EFFICACY_LAG_ELIMINATION_DALYS  # {{< var dfda_efficacy_lag_elimination_dalys >}} DALYs averted
...
gross_rd_savings = DFDA_BENEFIT_RD_ONLY_ANNUAL  # Pre-calculated: {{< var dfda_benefit_rd_only_annual >}}
...
monetized_daly_value = DFDA_EFFICACY_LAG_ELIMINATION_ECONOMIC_VALUE  # {{< var dfda_efficacy_lag_elimination_economic_value >}}
...
alpha = DFDA_TRIAL_COST_REDUCTION_PCT  # 0.50 (50% reduction)
...
| Total Ecosystem (Low-Medium Cost)                    | 50.0% ($50.0B Savings)         | $0.5B              | -$49.5B                       | {{< var dfda_efficacy_lag_elimination_dalys >}}                         | Cost-Saving + Health Gain   | Dominant                                | Illustrative total ecosystem cost.                                                                                                                                                                                                                                                    |
...
| Conservative R&D Savings & Health Gains              | 30% ($30.0B Savings)           | $0.5B              | -$29.5B                       | {{< var dfda_efficacy_lag_elimination_dalys >}}                         | Cost-Saving + Health Gain   | Dominant                                | Using Low-Med Ecosystem Cost & conservative health impact.                                                                                                                                                                                                                        |
| Optimistic R&D Savings & Health Gains                | 70% ($70B Savings)         | $0.5B              | -$69.5B                       | {{< var dfda_efficacy_lag_elimination_dalys >}}                       | Cost-Saving + Health Gain   | Dominant                                | Using Low-Med Ecosystem Cost & optimistic health impact.                                                                                                                                                                                                                          |
| **Transformative R&D Savings (RECOVERY Trial-like)** | **95%** ($95.0B Savings)     | **$0.5B**          | **-$94.5B**                   | **{{< var dfda_efficacy_lag_elimination_dalys >}}**                   | Cost-Saving + Health Gain   | **Dominant**                            | Using Low-Med Ecosystem Cost & optimistic health impact.                                                                                                                                                                                                                          |
| Platform Breaks Even (R&D Savings = Ops Cost)        | e.g., 0.5% ($0.5B Savings) | $0.5B              | $0                            | {{< var dfda_efficacy_lag_elimination_dalys >}}                         | Cost-Neutral + Health Gain  | Dominant (Cost-Neutral, Health Gaining) | Using Low-Med Ecosystem Cost & base health impact.                                                                                                                                                                                                                            |
