...
- **Causal inference engine**: [`packages/optimizer`](https://github.com/mikepsinn/optimitron/tree/main/packages/optimizer) (`@optimitron/optimizer`) implements temporal alignment, correlations, Bradford Hill scoring, Predictor Impact Score, response curves, and outcome ranking
- **Data adapters and generated datasets**: [`packages/data`](https://github.com/mikepsinn/optimitron/tree/main/packages/data) (`@optimitron/data`) includes local-first importers for Apple Health, Fitbit, Oura, MyFitnessPal, Withings, Google Fit, Cronometer, Strava, generic CSV, public-data fetchers, and the static dFDA medical-data snapshot
