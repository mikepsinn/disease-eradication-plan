...
![A timeline diagram showing a predictor measurement at time t-p, followed by a time delay delta, leading to an outcome window of length tau where measurements are averaged.](/assets/images/dfda-spec-paper/dfda-spec-paper-section-predictor-based-pairing-no-filling-value-bw-academic.jpg)
