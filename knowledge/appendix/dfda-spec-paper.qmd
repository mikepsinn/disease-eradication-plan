...
2. **Stage 2: Causal confirmation**: Pragmatic randomized trials following the embedded trial model (validated across 108+ studies) confirm top signals at ~{{< var dfda_pragmatic_trial_cost_per_patient >}}/patient ({{< var dfda_trial_cost_reduction_factor >}} cheaper than traditional trials) while eliminating confounding
