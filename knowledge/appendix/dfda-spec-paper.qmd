...
![Treatment Rankings Example - Patients see all treatments ranked by real-world effectiveness for their condition](../../assets/dfda-comparative-effectiveness-ranking-search.png){#fig-treatment-rankings}
...
- **Stage 1** (this methodology) generates treatment rankings from millions of real-world observations at ~$0.10/patient
...
![Effect sizes from observational studies vs. randomized trials show strong concordance for mortality outcomes](../../assets/observational-vs-randomized-effect-sizes.png){#fig-rwe-validation-mortality}

![Across multiple clinical domains, observational and randomized effect sizes track closely](../../assets/observational-vs-randomized-trial-effect-sizes.png){#fig-rwe-validation-domains}
...
![Outcome Labels show quantitative effect sizes, sample sizes, and confidence intervals for each treatment - like "nutrition facts for drugs"](../../assets/dfda-outcome-labels.png){#fig-outcome-labels}
