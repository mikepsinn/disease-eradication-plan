...
abstract: |
  ...
  Stage 2 ({{< var recovery_trial_cost_per_patient >}}/patient): confirm top signals through pragmatic
  trials embedded in routine care. These are {{< var dfda_trial_cost_reduction_factor >}} cheaper than traditional
  Phase III because they use existing clinical infrastructure, not specialized trial sites.
