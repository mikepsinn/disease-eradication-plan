...
The infrastructure for a decentralized framework for drug assessment (a dFDA) won't cost billions to build. Because the core team isn't building most of it.
...
This is how WordPress, Linux, and every successful platform works. The goal is to build the rails, not every train.
...
While an open platform mostly builds itself, sometimes specific features are needed that nobody's building yet.
...
The system doesn't reward papers for proposals. It rewards papers for code that works.
...
**Bounties:** "Build this specific thing. If it works, payment is sent. If it doesn't, it isn't."

One wastes less money. It's obvious which.
...
The framework needs enough users (patients, researchers, clinicians) and developers to create network effects.
...
The core team must maintain and communicate a clear vision (detailed in [Canonical Roadmap](../strategy/roadmap-academic.qmd)).
...
If these four conditions are met, a decentralized framework for drug assessment can foster a thriving global network of tools that delivers medical innovation at a fraction of the cost of centralized, top-down development.

WordPress proved this works for websites.
Linux proved it works for operating systems.
The framework will prove it works for curing disease.

Or it won't, and everyone continues dying from preventable things. The choice belongs to society.