...
Elixir sulfanilamide caused over 100 deaths [@fda-the-sulfanilamide-disaster] in 1937.

Congress reacted [@wikipedia-elixir-sulfanilamide] by requiring all new drugs to include:
...
These requirements evolved into the Phase 1 Safety Trial [@phase-1-safety-trial]. This was reasonable - testing if a compound kills people before giving it to patients makes sense.
...
Thalidomide was first marketed in Europe in 1957 [@wikipedia-thalidomide] for morning sickness. While it was initially thought to be safe in pregnancy, it resulted in thousands of horrific congenital disabilities [@thalidomide-birth-defects].
...
Since 1962, the cost of bringing a new treatment to market went from **{{< var pre_1962_drug_development_cost_2024_usd >}} to over $1 billion** [@parliament-4207] (inflation-adjusted).
...
A three-way fixed-effects analysis [@three-way-fixed-effects-analysis] of 66 diseases in 27 countries suggests that if no new drugs had been launched after 1981, years of life lost would have been 2.16 times higher. It estimates pharmaceutical expenditure per life-year saved was $2,837 [@three-way-fixed-effects-analysis].
