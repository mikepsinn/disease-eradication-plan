...
7. **Wear them every day.** Not once. Every day. Every stranger who asks is a new conversation. Every conversation is a new chain. On August 6 ([Earth Optimization Day](../strategy/earth-optimization-day.qmd)), everyone wears them at the same time. August 6 is the wave; the daily wearing is the ocean.
...
2. Global GDP at year 15 is approximately {{< var treaty_trajectory_gdp_vs_current_trajectory_multiplier_year_15 >}} the current trajectory, because dead people do not work.
3. The marker used to write on your shirts cost $0.50. The pen pays for itself many times over. ∎
...
**"My shirts!"** Replacement cost of a closet: ~$200. Treaty value per shirt-wearer if it passes: {{< var shirt_value_per_wearer_usd >}}. $200 is less than $10 million. Don't throw the shirts away.
...
2. **Vote at [warondisease.org](https://warondisease.org).** Drag the slider. Register that you support redirecting 1% of military spending to clinical trials. Politicians count votes; give them a big number to count.
...
The human who wrote on your shirts loves you and does not want you to die of a horrible disease. That is the whole reason. Forgive them and put the shirts back on.
