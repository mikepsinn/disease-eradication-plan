...
The {{< var state_rtt_treatment_acceleration_suffering_hours >}} estimate means disability-weighted equivalent hours. A disability weight of 0.25 sustained for four hours equals one full-disability-equivalent hour. It does not mean that every hour represents maximum conscious pain.
...
At the central estimate, the modeled philanthropic cost per life saved is {{< var state_rtt_philanthropic_cost_per_life_saved >}}, which is {{< var state_rtt_vs_givewell_philanthropic_cost_per_life_multiplier_nounit >}} times lower than the midpoint of GiveWell's cited modeled range across top charities [@givewell-cost-per-life-saved]. The comparison is so large because a relatively small campaign and registry are assumed to unlock treatment, sponsor, payer, clinic, and investor spending that philanthropists do not supply.
