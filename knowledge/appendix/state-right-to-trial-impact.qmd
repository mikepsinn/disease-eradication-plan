...
At the central estimate, the modeled cost per life saved is {{< var state_rtt_implementation_cost_per_life_saved >}}, which is {{< var state_rtt_vs_givewell_cost_per_life_multiplier_nounit >}} times lower than the midpoint of GiveWell's cited modeled range across top charities [@givewell-cost-per-life-saved]. The comparison is so large because a relatively small campaign and registry are assumed to unlock treatment, sponsor, payer, clinic, and investor spending that the launch budget never has to supply.
