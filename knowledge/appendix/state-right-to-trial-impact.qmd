...
[Universal Right to Try with Evidence](../solution/dfda.qmd) [@right-to-trial-paper-2025] would create licensed centers where patients can pay for treatment-related care while eligible participants enroll in standardized, pooled pragmatic trials. Patient and payer revenue can cover treatment delivery, trial-site services, and permitted study costs. Treatments abandoned because nobody can profitably finance conventional Phase 2 and Phase 3 trials become testable.
...
Medicare already uses the analogous payment principle in Coverage with Evidence Development: specified services may be covered only within an approved study while additional evidence is collected, then CMS can reconsider coverage using the resulting evidence [@cms-coverage-evidence-development-2024]. Universal Right to Try with Evidence is access with evidence development, financed primarily by patients and participating centers rather than Medicare. The [Continuous Evidence Generation Protocol](dfda-spec-paper.qmd#stage-2-pragmatic-trial-confirmation) [@dfda-spec-paper-2025] provides the fuller technical design.
...
At the central estimate, Universal Right to Try with Evidence's modeled philanthropic cost per life saved is {{< var state_rtt_philanthropic_cost_per_life_saved >}}, which is {{< var state_rtt_vs_givewell_philanthropic_cost_per_life_multiplier_nounit >}} times lower than the midpoint of GiveWell's cited modeled range across top charities [@givewell-cost-per-life-saved]. This is not because legislation cures people by itself. It is because a relatively small campaign and shared registry are modeled to unlock treatment, sponsor, payer, clinic, and investor spending that philanthropists do not have to supply.
