...
description: 'For roughly $90 per global human, humanity can buy a controlling stake in every major defense contractor on Earth, redirect their lobbying budgets toward the 1% treaty, and end the political opposition to disease eradication. The takeover is loving because the people being bought out are made richer and longer-lived by it. The math is on this page.'
abstract: |
...
The only thing the takeover is hostile to is a budget line item: the {{< var defense_lobbying_annual >}}/year of lobbying that currently funds the political opposition to the [1% treaty](../solution/1-percent-treaty.qmd). The humans associated with that line item are not adversaries. The line item is.
