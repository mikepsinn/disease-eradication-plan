...
tags:
  ...
  - accessibility
published: true
lastInstructionalVoiceHash: c8da422ee067ed10b9653b02797d78f52d2b697d1ca1f317f5c2f41d776022dd
---
...
| ------------------------------------ | ---------------------------------------------------- | --------------------------------------------------------------------------- | -------------------------------------------------------------- |
| **Naloxone (Narcan)**                | Reverses opioid overdoses                            | ~{{< var qalys_from_prevention_conservative >}}                                                                     | Opioid overdoses (over 100,000 annually in the U.S.)           |
| **Low-Dose Aspirin**                 | Prevents heart attacks and strokes                   | ~{{< var dfda_large_trial_size >}}                                                                     | Cardiovascular disease, especially secondary prevention        |
...
| **Ivermectin (for parasites)**       | Treats river blindness, scabies, etc.                | ~250,000 (WHO: prevents {{< var qalys_from_faster_access >}} deaths annually from river blindness alone) | Parasitic infections, especially in low-income regions         |
| **Albuterol Inhalers**               | Treats asthma and COPD emergencies                   | ~{{< var dfda_large_trial_size >}}                                                                     | Preventable asthma/COPD deaths globally                        |
...
| **Epinephrine (EpiPen)**             | Treats anaphylaxis                                   | ~{{< var dfda_drug_approvals_per_year_high >}}                                                                      | Preventable anaphylaxis deaths                                 |
| **Antibiotics (e.g., Azithromycin)** | Treats bacterial STIs, infections                    | ~{{< var dfda_large_trial_size >}}                                                                     | Complications from untreated infections, including infertility |
| **Ondansetron (Zofran)**             | Treats nausea in chemotherapy/pregnancy              | ~{{< var traditional_large_trial_size >}}                                                                      | Deaths from dehydration/malnutrition in high-risk patients     |
