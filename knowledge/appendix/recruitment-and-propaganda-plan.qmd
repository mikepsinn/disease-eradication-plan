...
Among the near-infinite solution space for human action, is there *some* action, *somewhere*, that could improve how your species allocates resources toward ending war and disease? Or is the current allocation, where you spend {{< var global_military_spending_annual_2024 >}} a year on weapons and {{< var global_med_research_spending >}} on medical research, the theoretical optimum? Is this the best any civilization could possibly do? Your species spends {{< var military_vs_medical_research_ratio >}} times more on weapons than on medical research. If someone told you their household spent 40 times more on swords than on medicine, would you say "that sounds optimal" or would you say "are you okay?"
...
If optimal allocation existed, what would a world with compounding benefits look like? If you redirected even 1% of military spending to the highest marginal-ROI health interventions and let it compound for 20 years, the models show everyone could be {{< var gdp_expected_value_vs_earth_multiplier_year_20 >}} richer. Not metaphorically richer. Not spiritually richer. Richer in the way that involves having more money. The compounding math is in the [GDP Trajectories](/knowledge/economics/gdp-trajectories.qmd) chapter and it is not subtle.
...
If ending war and disease is physically possible, and the result is {{< var gdp_expected_value_vs_earth_multiplier_year_20 >}} more resources for *everything*, then persuading those with sufficient power to implement it should temporarily be your top priority. Not because you're altruistic. Because it gives you {{< var gdp_expected_value_vs_earth_multiplier_year_20 >}} more resources to achieve whatever your *actual* goals are. If someone offered to multiply your budget by {{< var gdp_expected_value_vs_earth_multiplier_year_20 >}} in exchange for a few years of focused effort, and you said "no thanks, I'm busy," you would not be principled. You would be bad at math.
...
That is the bottleneck. Not generic "awareness." Not funding in the aggregate. Not human nature. The bottleneck is that the signal has not yet reached the first person with a large enough checkbook, enough credibility, and enough patience to read the argument and act on it. The entire apparatus of self-interest is sitting there, ready to work, waiting for one public commitment that has not happened yet because someone in the chain decided they were "busy."

On Wishonia, this sequence of logic doesn't have a name, for the same reason gravity doesn't have a marketing department. On Earth, you apparently need to brand obvious things before your species will take them seriously, so: **The Logical Inevitability Theorem.** If an optimization is physically possible, and its benefits compound for all participants, then the decisive trigger is one informed self-interested first mover making a credible public commitment. After that, the rest is propagation speed. That's it. That's the theorem. Five sentences. On Wishonia, this is considered too obvious to state. On Earth, it's considered too idealistic to believe. One of these planets cured disease. The other one is still arguing about it.

On Wishonia, the Logical Inevitability Theorem would take about four minutes to demonstrate and the conversation would end with both parties agreeing to optimize resource allocation. On Earth, it takes four minutes and the conversation ends with one party saying "interesting, I'll think about it" and then never thinking about it. This is the coordination failure the entire manual is about. You are not reading about it. You are currently doing it.
...
2. No incentive-compatible financing mechanism could ever bootstrap political change.
3. This specific mechanism has a fatal flaw you can name.

If you are not claiming one of those three things, then your actual estimate is not 0%. It is "I have not evaluated it." That is a different sentence. And once the probability is above 0 by any nontrivial amount, forwarding it to one capable evaluator becomes the rational move. The cost is trivial. The upside is civilizational. You are not being asked to believe. You are being asked not to disguise unexamined dismissal as analysis.

### How Trivial, Exactly

On Wishonia, "the cost is trivial" would be sufficient. On Earth, your species requires a number.

Forwarding takes roughly 30 seconds. The average human earns {{< var global_avg_hourly_income >}} per hour. That makes the opportunity cost of sharing approximately {{< var sharing_opportunity_cost >}}. The upside, if the treaty path works, is {{< var treaty_path_lifetime_income_gain_per_capita >}} in additional cumulative lifetime income for the average person; {{< var treaty_path_lifetime_income_multiplier >}} their current trajectory. (If you earn more than the global average, your personal gain is proportionally larger.)

The ratio of upside to downside is {{< var sharing_upside_downside_ratio_treaty >}} to one. Which means sharing is irrational only if the probability of *any* improvement to global resource allocation is less than 1 in {{< var sharing_breakeven_one_in_treaty >}}.
...
5. **Is the only bottleneck informed self-interest?** You'd need to believe that no self-interested actor (billionaire, sovereign wealth fund, or government) would ever act on a {{< var treaty_roi_trial_capacity_plus_efficacy_lag >}} return, even when the structure pays them to do so.
...
And this calculation is conservative. It counts only the income gain. It assigns zero value to the {{< var dfda_trial_capacity_plus_efficacy_lag_lives_saved_nounit >}} lives. It ignores the Wishonia path entirely (which is {{< var wishonia_path_lifetime_income_multiplier >}} the current trajectory, not {{< var treaty_path_lifetime_income_multiplier >}}). It assumes you personally capture only the average gain, when in practice higher earners gain proportionally more. The actual breakeven threshold is even more forgiving than 1 in {{< var sharing_breakeven_one_in_treaty >}}.

On Wishonia, a species that couldn't clear a 1-in-{{< var sharing_breakeven_one_in_treaty >}} bar for obvious self-interest would be studied by veterinarians, not economists.
...
Forwarding dominates not-forwarding in every scenario. This is not an opinion. It's a payoff matrix. On Wishonia, choosing option 3 or 4 when option 1 costs 30 seconds would be considered a symptom of a neurological disorder. On Earth, it's called "being busy."
...
Even just the treaty path alone (redirect the murder budget, fix nothing else) produces an economy {{< var treaty_path_gdp_vs_earth_multiplier_year_20 >}} larger than the baseline by year 20. Not a little larger. {{< var treaty_path_gdp_vs_earth_multiplier_year_20 >}} larger. This compounds over 20 years, which is the part that makes the number large and the part that makes delay expensive. Over an average remaining lifespan, your cumulative earnings under the treaty path would be {{< var treaty_path_lifetime_income_multiplier >}} what they'd be on the current trajectory. For the average human, the gain is {{< var treaty_path_lifetime_income_gain_per_capita >}} in additional lifetime income. If you earn more than the global average (and if you're reading this on a device that costs more than most humans earn in a month, you do), your personal gain is proportionally larger.

The opportunity cost of not forwarding is not "30 seconds." It is {{< var treaty_path_lifetime_income_gain_per_capita >}} in foregone lifetime income for the average person, compounding over {{< var global_avg_remaining_years_nounit >}} remaining years. Each year the treaty hasn't started is a year the 20-year compounding clock hasn't started. On Wishonia, failing to start this clock would be classified as a cognitive impairment. On Earth, it is classified as "Tuesday."

On Wishonia, the payoff matrix would be sufficient. On Earth, your species apparently needs to formalize obvious incentives into binding contracts before it will act on them. Fortunately, your economists already invented one. It's called a dominant assurance contract. Here's how it works: a contract operator sets a threshold and a failure bonus, then a credible anchor investor publicly underwrites the thing so everyone else can see the first real money on the table. After that, you pledge to support the treaty, conditional on enough others pledging too. If the threshold is met and the treaty works, you receive a tiny fraction of the value created. (A tiny fraction of "everyone is {{< var gdp_expected_value_vs_earth_multiplier_year_20 >}} richer" is still a lot of money.) If the threshold isn't met, you get your pledge back plus a bonus for having tried. Once the structure is credible, participation becomes the rational move. You profit if it works. You profit if it doesn't. The only way to lose is to not participate, which is the position you're currently in.

This is not a new idea. Your economist Alex Tabarrok formalized it decades ago. It solves exactly the problem this chapter diagnoses: everyone waits because everyone else is waiting. A dominant assurance contract makes waiting the only irrational option. It turns "someone else will do it" from a comfortable excuse into a financial mistake. The [Victory Bonds](/knowledge/solution/incentive-alignment-bonds.qmd) chapter explains the specific instrument. The assurance contract is just the mechanism that gets enough humans to say "yes" at the same time, which is the part your species is bad at.
