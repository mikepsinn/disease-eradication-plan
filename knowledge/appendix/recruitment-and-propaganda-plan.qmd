...
Before we get to the part where you copy, paste, and send, there's a sequence of questions you should walk anyone through. Each question is individually undeniable. The sequence is inescapable. Most species call this "conversation." Your species calls it the Socratic method, because you named it after the one guy who did it and then you killed him.
...
Is the [1% Treaty](../solution/1-percent-treaty.qmd) [@1-percent-treaty-paper-2025] [@1-pct-treaty-impact-paper-2025] the least bad approach, or do you have a superior one? This is not a rhetorical question. If you have a better plan, the authors of this manual would genuinely like to hear it. They will switch to your plan immediately. They have no attachment to this specific mechanism beyond the fact that nobody has proposed a better one. If your alternative is "do nothing and hope," that is not a plan. That is what you've been doing. The results are in.
...
This sequence of logic doesn't need a name, for the same reason gravity doesn't have a marketing department. But your species apparently needs to brand obvious things before it will take them seriously, so: **The Logical Inevitability Theorem.** If an optimization is physically possible, and its benefits compound for all participants, then the decisive trigger is one informed self-interested first mover making a credible public commitment. After that, it spreads. That's it. That's the theorem. Five sentences. No sane civilization would need to state this. Yours considers it too idealistic to believe. One of these planets cured disease. The other one is still arguing about it.

Among functional species, the Logical Inevitability Theorem would take about four minutes to demonstrate and the conversation would end with both parties agreeing to stop wasting money on murder. Among yours, it takes four minutes and the conversation ends with one party saying "interesting, I'll think about it" and then never thinking about it. This is the coordination failure the entire manual is about. It is not happening somewhere else. It is happening in the gap between reading this and forwarding it.
...
If you are not claiming one of those three things, then your actual estimate is not 0%. It is "I have not evaluated it." That is a different sentence. And once the probability is above 0 by any nontrivial amount, forwarding it to one capable evaluator becomes the rational move. The cost is trivial. You do not have to believe. You just have to stop disguising unexamined dismissal as analysis.

### How Trivial, Exactly

"The cost is trivial" should be sufficient. Your species requires a number.
...
Forwarding dominates not-forwarding in every scenario. This is not an opinion. It's a payoff matrix. If the matrix is right, choosing option 3 or 4 when option 1 costs 30 seconds is not a decision. It is a malfunction. Your species does it constantly and calls it "being busy."
...
The complementary strategy is the everyone-at-once version: you call the people you love, walk them through a twenty-question sequence, and get them to do the same for the people they love. That chapter has its own instructions: the exact message to send, the Socratic [call script](/knowledge/strategy/questions.qmd), and answers for the common objections.
