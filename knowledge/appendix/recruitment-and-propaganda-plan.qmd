...
The complementary strategy is the everyone-at-once version: you call the people you love, walk them through a twenty-two-question sequence, and get them to do the same for the people they love. That chapter has its own playbook, including the exact message to send, the Socratic call script, and answers for the common objections. See [The Most Important Secret in the World](/knowledge/strategy/call-script.qmd).
