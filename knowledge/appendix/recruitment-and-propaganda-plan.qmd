...
These are the bleeding hearts who cry at pharmaceutical commercials. They have feelings, they want to help, and they'll donate {{< var lobbyist_bond_investment_max_millions >}} they can't afford because a child has cancer somewhere.
...
- Investment Range:
  □ Under {{< var caregiver_value_per_hour_simple >}}K (testing the waters)
  □ {{< var caregiver_value_per_hour_simple >}}K-$100K (serious but cautious)
  □ $100K-{{< var recovery_trial_cost_per_patient >}}K (true believer)
  □ {{< var recovery_trial_cost_per_patient >}}K+ (either genius or insane)
...
- **{{< var traditional_large_trial_size >}}+ qualified investors** (your pile of promised papers)
- **100+ organizations** (your infrastructure)
- **{{< var treaty_campaign_total_cost >}} in "intended" investments** (IOUs for the revolution)
