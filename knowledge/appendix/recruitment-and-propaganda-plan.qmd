...
Send weekly "Battlefield Reports" containing made-up statistics, out-of-context celebrity quotes, progress bars that always go up, and testimonials from "supporters" (you wrote them). Subject lines like "We're 72% closer to ending death" and "Last chance (until next week's last chance)."
...
Add privacy checkboxes nobody reads ("I agree to terms" in War and Peace legalese, "I understand risks" when you don't, and "I want updates" a.k.a. spam me daddy). Your privacy policy says you protect data (until you don't), never sell information (you give it away), and use industry standards (from 1995).
