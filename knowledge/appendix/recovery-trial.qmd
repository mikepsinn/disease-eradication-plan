...
**Cost:** Total trial cost was £2.1M (~$2.7M). Funded jointly by UKRI and NIHR as part of a £20M rapid research response. ([UKRI Impact Report](https://www.ukri.org/who-we-are/how-we-are-doing/research-outcomes-and-impact/mrc/recovery-trial-identifies-covid-19-treatments/))

**Impact:** Dexamethasone alone saved ~22,000 lives in the UK and 1 million globally by March 2021. Three groundbreaking results within 100 days. Four proven treatments total (dexamethasone, tocilizumab, Ronapreve, baricitinib). ([UKRI](https://www.ukri.org/who-we-are/how-we-are-doing/research-outcomes-and-impact/mrc/recovery-trial-identifies-covid-19-treatments/), [Nuffield](https://www.ndph.ox.ac.uk/news/recovery-trial-celebrates-two-year-anniversary-of-life-saving-dexamethasone-result))

**Scale:** 40,000+ participants across 185 sites. World's largest COVID treatment trial. ([UKRI](https://www.ukri.org/who-we-are/how-we-are-doing/research-outcomes-and-impact/mrc/recovery-trial-identifies-covid-19-treatments/))

**Cost per patient:** Simple division gives ~£43 (~$55). Authoritative sources cite ~{{< var recovery_trial_cost_per_patient >}} ([Manhattan Institute](https://manhattan.institute/article/slow-costly-clinical-trials-drag-down-biomedical-breakthroughs)). A systematic review of 64 pragmatic trials found a median of {{< var pmc_pragmatic_trial_median_cost_per_patient >}}/patient [@pmc-pragmatic-trial-cost]. Either way: nearly {{< var recovery_trial_cost_reduction_factor >}} cheaper than traditional trials at {{< var traditional_phase3_cost_per_patient >}} ([NCBI](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7295430/)).
