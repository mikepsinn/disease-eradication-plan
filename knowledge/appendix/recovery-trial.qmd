...
{{< var recovery_trial_cost_per_patient >}} per patient ([Manhattan Institute](https://manhattan.institute/article/slow-costly-clinical-trials-drag-down-biomedical-breakthroughs)) vs the U.S. average of {{< var traditional_phase3_cost_per_patient >}} per patient ([NCBI](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7295430/)).

![A side-by-side comparison of clinical trial costs and timelines, highlighting the 82x cost efficiency and the 100-day breakthrough that saved a million lives.](/assets/images/recovery-trial/recovery-trial-section-the-result-bw-academic.jpg)
