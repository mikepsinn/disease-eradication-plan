...
The Oxford RECOVERY trial isn't theory, it's proof. In 2020, while traditional trials [@trial-cost-41k] cost {{< var traditional_phase3_cost_per_patient >}}, Oxford spent {{< var recovery_trial_cost_per_patient >}} and saved over 1 million lives globally [@recovery-trial-1m-lives-saved]. This {{< var recovery_trial_cost_reduction_factor >}} efficiency gain demonstrates that decentralized, pragmatic trials aren't just possible, they're already superior to traditional U.S. regulatory approaches.
...
{{< var recovery_trial_cost_per_patient >}} vs the U.S. average of {{< var traditional_phase3_cost_per_patient >}} ([NCBI](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7295430/)).

![A comparison bar chart illustrating the 82x cost efficiency gap between the $500 per-patient trial cost and the $41,000 U.S. average.](/assets/images/recovery-trial/recovery-trial-section-the-result-bw-academic.jpg)
...
**{{< var recovery_trial_cost_per_patient >}} vs the U.S. Average of {{< var traditional_phase3_cost_per_patient >}}**

The UK spent {{< var recovery_trial_cost_per_patient >}} testing COVID treatments. Saved a million lives.
...
The U.S. equivalent often costs {{< var traditional_phase3_cost_per_patient >}}, with a significant portion dedicated to extensive regulatory paperwork.
