...
tags:
  ...
  - historical-proof
  - oxford
image: /assets/og-images/knowledge/appendix/recovery-trial-og-academic.jpg
---

{{< include /knowledge/includes/setup-parameters.qmd >}}

![](/assets/infographics/knowledge/appendix/recovery-trial-infographic-academic.jpg)


The Oxford RECOVERY trial isn't theory, it's proof. In 2020, while the FDA spent [$41,000 per patient](../references.qmd#trial-cost-41k) on traditional trials, Oxford spent {{< var recovery_trial_cost_per_patient >}} per patient and [saved over 1 million lives globally](../references.qmd#recovery-trial-1m-lives-saved). This {{< var recovery_trial_cost_reduction_factor >}}× efficiency gain demonstrates that decentralized, pragmatic trials aren't just possible, they're already superior to centralized FDA approaches.
...
{{< var recovery_trial_cost_per_patient >}} per patient ([Manhattan Institute](https://manhattan.institute/article/slow-costly-clinical-trials-drag-down-biomedical-breakthroughs)) vs FDA's $41,000 per patient ([NCBI](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7295430/)).
