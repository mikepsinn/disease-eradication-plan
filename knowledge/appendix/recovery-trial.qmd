...
The Oxford RECOVERY trial isn't theory, it's proof. In 2020, while the FDA spent [$41,000 per patient](../references.qmd#trial-cost-41k) on traditional trials, Oxford spent [{{< var recovery_trial_cost_per_patient >}} per patient](../references.qmd#recovery-cost-500) and [saved over 1 million lives globally](../references.qmd#recovery-trial-1m-lives-saved). This 82x efficiency gain demonstrates that decentralized, pragmatic trials aren't just possible, they're already superior to centralized FDA approaches.
...
| Global Lives Saved (by March 2021) | {{< var traditional_large_trial_size >}},000+                                                                                                                        | [UKRI Impact Report](https://www.ukri.org/who-we-are/how-we-are-doing/research-outcomes-and-impact/mrc/recovery-trial-identifies-covid-19-treatments/)                                  |
...
5. **Scale Is Achievable:** 49,000 patients enrolled [faster than most FDA trials enroll {{< var traditional_large_trial_size >}}](../references.qmd#clinical-trial-enrollment-timelines)
...
**{{< var recovery_trial_cost_per_patient >}} vs FDA's $41,000 Per Patient**
