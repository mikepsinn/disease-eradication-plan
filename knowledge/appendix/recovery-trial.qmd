...
lastInstructionalVoiceHash: d6dece047683ffc0c97ce95dbc99f3b4e335830ba7bc978acb6024ed3538fd68
lastNonprofitComplianceHash: b9983ed6413180d084f32647186fc2a0b05f89ed58b504a41d77bfcdf852b2a2
---
...
The Oxford RECOVERY trial isn't theory, it's proof. In 2020, while the FDA spent [$41,000 per patient](../references.qmd#trial-cost-41k) on traditional trials, Oxford spent [$500 per patient](../references.qmd#recovery-cost-500) and [saved over 1 million lives globally](../references.qmd#recovery-trial-1m-lives-saved). This {{< var dfda_cost_effectiveness_multiplier >}}× efficiency gain demonstrates that decentralized, pragmatic trials aren't just possible, they're already superior to centralized FDA approaches.
...
That's an {{< var dfda_cost_effectiveness_multiplier >}}× efficiency gain achieved by doing the obvious things in obvious ways.
...
4. **Cost Is A Choice:** The {{< var dfda_cost_effectiveness_multiplier >}}× cost difference isn't about capability, it's about bureaucracy
...
The lesson is clear: We already know how to run trials {{< var dfda_cost_effectiveness_multiplier >}}× more efficiently. The Oxford RECOVERY trial proved it works. The only question is whether we'll choose to implement this model globally or continue wasting $41,000 per patient while people die waiting for cures.
...
### Oxford Already Achieved {{< var dfda_cost_effectiveness_multiplier >}}× Cost Reduction
...
- Efficiency gain: ~{{< var dfda_cost_effectiveness_multiplier >}}× (Oxford showed {{< var dfda_cost_effectiveness_multiplier >}}× reduction possible)
