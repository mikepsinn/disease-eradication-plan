---
title: 'Wishocracy: Scalable Preference Aggregation for Public Goods Allocation Using Collective Intelligence'
description: Wishocracy is a governance mechanism that employs Randomized Aggregated Pairwise Preference Allocation (RAPPA) to eliminate the principal-agent problem in democratic resource allocation. By decomposing n-dimensional preference spaces into tractable pairwise comparisons and aggregating collective intelligence, the mechanism enables direct citizen control over public budgets while approximating utilitarian welfare.
aliases:
  - /wishocracy.html
author:
  - name: Mike P. Sinn
