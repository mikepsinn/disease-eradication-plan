...
The problem is also computational. Modern government budgets allocate resources across thousands of line items. Humans cannot reliably compare more than 7±2 options simultaneously [@cognitive-limit-seven-items]. Asking a citizen to rank the federal budget is like asking them to rank every dish on a menu with 4,000 items. Pairwise comparisons ("Would you rather have more cancer research or more fighter jets?") keep each decision manageable.
