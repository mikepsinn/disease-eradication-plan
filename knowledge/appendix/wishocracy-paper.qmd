...
![A flowchart depicting the Wishocracy feedback loop, starting from individual pairwise comparisons to the generation of preference weights, Citizen Alignment Scores, and the resulting incentive alignment for elected officials via bonds.](/assets/images/wishocracy-paper/wishocracy-paper-section-abstract-bw-academic.jpg)
...
![A comparison of governance models: representative, direct, technocratic, and RAPPA, illustrating how they trade off between democratic legitimacy, cognitive load, and preference intensity.](/assets/images/wishocracy-paper/wishocracy-paper-section-introduction-the-preference-aggregation-problem-bw-academic.jpg)
...
![A hierarchical diagram of the Analytic Hierarchy Process showing the decomposition from a primary goal to criteria and alternatives, paired with a workflow of the pairwise comparison and consistency check process.](/assets/images/wishocracy-paper/wishocracy-paper-section-the-analytic-hierarchy-process-bw-academic.jpg)
...
![A comparison of preference intensity signals, contrasting a high-intensity 90/10 allocation with a low-intensity 55/45 split to demonstrate how trade-off judgments capture welfare priorities.](/assets/images/wishocracy-paper/wishocracy-paper-section-the-preference-intensity-problem-bw-academic.jpg)
...
![A comparative matrix positioning RAPPA against Liquid Democracy, Futarchy, Conviction Voting, and Participatory Budgeting across dimensions of cognitive load, preference elicitation, and scalability.](/assets/images/wishocracy-paper/wishocracy-paper-section-related-work-and-positioning-in-the-literature-bw-academic.jpg)
...
![A flowchart detailing the five-step RAPPA mechanism, illustrating the progression from problem cataloging and pairwise preference collection to mathematical aggregation and final budget allocation.](/assets/images/wishocracy-paper/wishocracy-paper-section-core-mechanism-bw-academic.jpg)
...
![A diagram illustrating the multi-step process of pairwise budget comparisons, showing specific allocation ratios and the resulting transitive hierarchy used to calculate citizen alignment scores.](/assets/images/wishocracy-paper/wishocracy-paper-section-scenario-federal-budget-preferences-bw-academic.jpg)
...
![A comparison of scaling complexity across voting mechanisms, illustrating the growth of participant effort relative to the number of items for Plurality, RCV, QV, and RAPPA.](/assets/images/wishocracy-paper/wishocracy-paper-section-formal-properties-bw-academic.jpg)
...
![Process flow of the RAPPA mechanism showing the transformation of individual pairwise preferences into a global priority vector through ratio conversion, matrix aggregation, and synthesis.](/assets/images/wishocracy-paper/wishocracy-paper-section-formal-model-bw-academic.jpg)
...
![Scalability benchmarks for RAPPA across municipal, city, and national scales, illustrating the relationship between participant volume, policy priorities, and computational overhead.](/assets/images/wishocracy-paper/wishocracy-paper-section-computational-complexity-and-scalability-bw-academic.jpg)
...
![The flatline of democracy: Public support (0% to 100%) has near-zero impact on the probability of policy adoption (flat at ~30%), whereas elite support strongly correlates with adoption. Data from @gilens2014.](../../assets/images/bill-public-support-vs-chance-of-adoption-what-actually-happens.png)
...
![A comparative diagram showing the divergent utility pathways in representative democracy versus the direct alignment and technical implementation layer in Wishocracy.](/assets/images/wishocracy-paper/wishocracy-paper-section-principal-agent-cost-elimination-bw-academic.jpg)
...
![A comparative bar chart showing the growth of municipal services and citizen participation in Porto Alegre between 1989 and 1999.](/assets/images/wishocracy-paper/wishocracy-paper-section-porto-alegre-participatory-budgeting-bw-academic.jpg)
...
![A flowchart showing the vTaiwan process of moving from pairwise citizen comparisons to consensus clusters and final policy resolution.](/assets/images/wishocracy-paper/wishocracy-paper-section-taiwan-s-digital-democracy-experiments-bw-academic.jpg)
...
![A bar chart comparing external Benefit-Cost Ratio (BCR) estimates for various federal budget categories, illustrating the significant variance in expert-calculated social returns on investment.](/assets/images/wishocracy-paper/wishocracy-paper-section-category-selection-and-validation-methodology-bw-academic.jpg)
...
![A comparison showing the reduction in required pairwise comparisons from 45 to 21 when 3 out of 10 categories are filtered, representing a 53% decrease in cognitive load.](/assets/images/wishocracy-paper/wishocracy-paper-section-zero-funding-filter-optimization-bw-academic.jpg)
...
![A hierarchical diagram illustrating the hybrid budget structure, showing the flow from mandatory high-level category allocations to optional sub-category drill-downs and the final aggregation logic.](/assets/images/wishocracy-paper/wishocracy-paper-section-hierarchical-category-structure-bw-academic.jpg)
...
![A procedural flowchart illustrating the framing mitigation cycle, from identifying bias sources to adversarial review, parallel survey validation, and public documentation.](/assets/images/wishocracy-paper/wishocracy-paper-section-framing-bias-and-mitigation-bw-academic.jpg)
...
![A visualization of the Sybil dilution effect showing how fake identities are distributed across a large number of random comparison pairs, reducing their aggregate impact on any single outcome.](/assets/images/wishocracy-paper/wishocracy-paper-section-manipulation-and-sybil-attacks-bw-academic.jpg)
...
![A flowchart illustrating the Wishocracy division of labor, showing citizens setting outcome preferences while experts and service providers manage technical implementation and causal analysis.](/assets/images/wishocracy-paper/wishocracy-paper-section-complexity-of-real-policy-trade-offs-bw-academic.jpg)
...
![A diagram illustrating the flow of citizen preferences through an auditable algorithm to recommendations, highlighting the oversight role of elected officials and the resulting bidirectional accountability.](/assets/images/wishocracy-paper/wishocracy-paper-section-legitimacy-and-accountability-bw-academic.jpg)
...
![A technical mapping of RAPPA's failure modes: low participation, comparison sparsity, and coordinated attacks, alongside their multi-layered mitigation strategies and statistical thresholds.](/assets/images/wishocracy-paper/wishocracy-paper-section-failure-modes-and-robustness-bw-academic.jpg)
...
![A bar chart comparing federal spending allocations, illustrating the massive scale of the $886 billion military budget against the NIH, fossil fuel subsidies, and drug war enforcement.](/assets/images/wishocracy-paper/wishocracy-paper-section-implementation-pathway-from-information-to-incentive-alignment-bw-academic.jpg)
...
![A bar chart comparing the benefit-cost ratios (BCR) of high-impact interventions like e-government procurement (125:1) and vaccinations (101:1) against low-value spending such as military expansion (0.7:1).](/assets/images/wishocracy-paper/wishocracy-paper-section-why-information-alone-fails-politicians-respond-to-incentives-bw-academic.jpg)
...
![A comparison chart illustrating the 'Preference Gap' between current federal budget allocations and citizen preferences, highlighting specific disparities in medical research and military spending.](/assets/images/wishocracy-paper/wishocracy-paper-section-phase-1-informational-preference-gap-documentation-bw-academic.jpg)
...
![A flow diagram illustrating the data pipeline from congressional voting records and RAPPA preferences through the mapping process to the final calculation of Citizen Alignment Scores.](/assets/images/wishocracy-paper/wishocracy-paper-section-phase-2-accountability-scoring-politician-alignment-ratings-bw-academic.jpg)
...
![A visualization of the capital asymmetry between global household wealth ($454T) and concentrated interests (<$5T), illustrating how the three-layer incentive alignment mechanism redirects these resources toward aligned politicians.](/assets/images/wishocracy-paper/wishocracy-paper-section-phase-3-incentive-alignment-integration-with-incentive-alignment-bonds-bw-academic.jpg)
...
Politicians currently face incentives that reward serving concentrated interests (military contractors, pharmaceutical incumbents, fossil fuel producers) at the expense of diffuse beneficiaries (citizens who would benefit from cures, climate stability, reduced existential risk). IABs flip this calculus by making the diffuse beneficiaries' preferences financially consequential.

**Capital Asymmetry:** Diffuse beneficiaries collectively control far more capital than concentrated interests. Global household wealth exceeds {{< var global_household_wealth_usd >}}; the combined market capitalization of industries benefiting from misallocation (defense contractors, fossil fuels, etc.) is under {{< var concentrated_interest_sector_market_cap_usd >}}. The problem is coordination, not resources. IABs solve the coordination problem by creating a vehicle for diffuse beneficiaries to pool resources and direct them toward aligned politicians.
...
![A comparison of the financial stakes between municipal and federal implementation, illustrating the massive scale difference from $10 million to $500 billion.](/assets/images/wishocracy-paper/wishocracy-paper-section-why-federal-first-beats-municipal-pilots-bw-academic.jpg)
...
![A system diagram showing the interaction between citizen preferences, federal budget data, and the resulting RAPPA outputs like Gap Reports and Incentive Alignment Bonds.](/assets/images/wishocracy-paper/wishocracy-paper-section-why-federal-scale-priorities-bw-academic.jpg)
...
![A summary of the four pillars of Preference Aggregation Quality, detailing the specific statistical thresholds required for successful data validation.](/assets/images/wishocracy-paper/wishocracy-paper-section-preference-aggregation-quality-bw-academic.jpg)
...
![A data dashboard visualizing the correlation between PAC contributions and alignment scores, alongside win rate gradients and declining preference gap trends.](/assets/images/wishocracy-paper/wishocracy-paper-section-incentive-alignment-impact-bw-academic.jpg)
...
![A conceptual diagram illustrating how Wishocracy and Incentive Alignment Bonds function as a complete system, mapping RAPPA to 'what to optimize' and IABs to 'incentive to optimize'.](/assets/images/wishocracy-paper/wishocracy-paper-section-connection-to-incentive-alignment-bonds-bw-academic.jpg)
...
![A conceptual diagram of the hybrid governance architecture showing the flow from citizen preference aggregation via Wishocracy into algorithmic metric optimization via Optimocracy.](/assets/images/wishocracy-paper/wishocracy-paper-section-connection-to-optimocracy-bw-academic.jpg)

- **Optimocracy** is *algorithmic*: a pre-agreed metric is optimized automatically, with minimal human discretion. The output is an allocation that executes regardless of political preferences.
...
For detailed treatment of algorithmic governance, including smart contract specifications and oracle design, see the companion paper: [Optimocracy: Algorithmic Governance Through Metric-Bound Resource Allocation](https://optimocracy.warondisease.org).
...
![A structural diagram of the Wishocracy mechanism showing the flow of citizen pairwise preferences through aggregation into alignment scores and incentive bonds to influence representative behavior.](/assets/images/wishocracy-paper/wishocracy-paper-section-conclusion-bw-academic.jpg)
...
![A conceptual diagram illustrating the two-layer Wishocracy architecture, showing the separation between democratic outcome prioritization (Layer 1) and technocratic implementation strategy (Layer 2).](/assets/images/wishocracy-paper/wishocracy-paper-section-appendix-a-the-service-provider-layer-bw-academic.jpg)
