...
<!-- TODO: Fix broken link - This document outlines the foundational "Phase 0" required to launch the War on Disease initiative. The high-level plans detailed in the [Canonical Roadmap](./roadmap.md) and [Fundraising and Budget Plan](../economic-models/fundraising-and-budget-plan.md) depend on the successful execution of this initial, targeted pre-seed phase. -->
...
- **Victory Corporation (SPV):**
- **Purpose:** The operational engine of the initiative. This entity raises venture capital, hires the core "activation team," manages strategy, develops technology, executes the campaign, and takes a 20% management fee on treaty inflows to fund investor returns and political incentives.
- **Entity Type:** A Special Purpose Vehicle (SPV), likely a Delaware C-Corp, designed to issue [VICTORY Incentive Alignment Bonds](../solution/incentive-alignment-bonds.qmd) and generate returns for its investors upon the successful launch and capitalization of your decentralized institutes of health and the treaty.
- **Accountability:** Owned 100% by the Non-Profit Foundation (see below). Accountable to its investors and board of directors. All initial hires will be employees of this entity.
...
- **Accountability:** Provides legal and ethical guardrails, serves as a potential recipient for philanthropic grants, and holds oversight powers to ensure your decentralized institutes of health operate as intended.
...
### The Core "Activation Team"

The pre-seed funds will be used to hire a small, world-class team to build the foundation for the larger operation. These individuals will work for the **For-Profit Management Co.** The three immediate, critical hires are outlined in the [Hiring Plan](careers/hiring-plan.qmd):

1.  **Capital Markets Lead:**

    - **Mandate:** Structure the VICTORY Incentive Alignment Bonds, build the comprehensive financial model and data room, and lead the subsequent seed and Series A fundraising efforts.
