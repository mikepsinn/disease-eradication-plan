...
- **Determine Market Rate:** Each role has a fair market salary (e.g., Senior Engineer: ${{< var qalys_from_faster_access >}}/year).
...
- **Calculating Ownership:** A contributor's ownership of the team pool is their share of the total value.
  - _Example:_ The engineer's $4.6M in Success Grants represents `$4,600,000 / ${{< var traditional_large_trial_size >}},000,000 = 0.46%` of the team's token pool.
