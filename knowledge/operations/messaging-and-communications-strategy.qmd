...
- **Funding:** If a {{< var dfda_opex_community >}} grant is secured, and the improved messaging framework was deemed responsible for strengthening the proposal (e.g., a 25% contribution), the attributable value is {{< var recovery_trial_cost_per_patient >}},000.
...
- **Cost Savings:** The average Cost Per Acquisition (CPA) for a clinical trial participant can range from **{{< var recovery_trial_cost_per_patient >}} to over $7,500**. A modest 15-20% reduction in CPA through better messaging translates into substantial savings.
...
- **Assumed Outcomes (over 12 months):**
  ...
  3. **Future Trial Efficiencies (Projected):** The community built during the referendum campaign is projected to reduce future CPA for a {{< var traditional_large_trial_size >}}-participant trial by 15% (from $1,000 to $850) and accelerate recruitment by one month.

- **Calculated Financial Value:**
  1. **Funding Contribution:** 20% \* ${{< var traditional_large_trial_size >}},000 = **${{< var qalys_from_faster_access >}}**
  2. **Projected Recruitment Savings:** {{< var traditional_large_trial_size >}} participants \* $150 savings/participant = **${{< var qalys_from_prevention_optimistic >}}**
  3. **Projected Acceleration Value:** Using a conservative delay cost of {{< var lobbyist_bond_investment_max_millions >}},000/day, saving 30 days is worth **$600,000**.

- **Total Financial Value (Immediate + Projected):** ${{< var qalys_from_faster_access >}} + ${{< var qalys_from_prevention_optimistic >}} + $600,000 = **$950,000**
