...
<!-- TODO: Fix broken link - This new model is made possible by dramatic cost reductions. Evidence from successful, large-scale studies like the UK's [RECOVERY trial](../../reference/recovery-trial-case-study.md) shows this approach can cut per-patient trial costs by over **95%** (from ~$43,000 down to ~{{< var recovery_trial_cost_per_patient >}}), enabling more research for more people. -->
...
- Less than {{< var qalys_from_prevention_conservative >}}
- {{< var qalys_from_prevention_conservative >}} - 99,999
- 100,000 - 199,999
- {{< var qalys_from_faster_access >}} or more
- Prefer not to say
...
**Your Impact:** Every ${{< var traditional_large_trial_size >}} donated funds 1,000+ verified survey responses, helping us reach the 3.5% tipping point needed for systemic change. Research shows that when 3.5% of a population actively supports a cause, it has never failed to achieve major societal advancement.
