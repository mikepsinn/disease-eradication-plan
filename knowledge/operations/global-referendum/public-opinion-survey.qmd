...
description: Survey measuring public support for redirecting military spending to health innovation and modernizing pragmatic clinical trials systems.
published: true
tags:
  - survey
  - global-values
...
<!-- TODO: Fix broken link - The "1% treaty" proposes that all signatory nations redirect 1% of their annual military budget to a global fund. Proponents argue that accelerating medical progress is a critical component of national and global security. This fund would subsidize patient participation in decentralized clinical trials, aiming to dramatically accelerate the development of new cures. ([Read the full security rationale here.](./national-security-argument.md)) -->

**1. Do you support or oppose your country signing a 1% treaty?**
...
- **Military / War:** \$**\_\_**
- **A 1% Treaty Fund (to fund efficient pragmatic clinical trials):** \$**\_\_**

### Section 2: Principles for Research Reform

The following questions are about the core principles of this initiative. The central proposal is to allow treatment after initial human safety testing while qualified evidence systems record what happens, as outlined in the [Right to Trial and FDA Upgrade Act](../../appendix/right-to-trial-fda-upgrade-act.qmd).

One compatible evidence platform could work like this:
...
2.  Patients could find protocols and participate locally or remotely when a protocol permits it.
3.  Deidentified aggregate results would be made public to accelerate new discoveries.

<!-- TODO: Fix broken link - This new model is made possible by dramatic cost reductions. Evidence from successful, large-scale studies like the UK's [RECOVERY trial](../../reference/recovery-trial-case-study.md) shows this approach can cut per-patient trial costs by over **95%** (from ~$43,000 down to ~$500), enabling more research for more people. -->
...
- Technical development of a decentralized FDA and a network of decentralized institutes of health (DIH)
- Research and analysis to support our policy proposals and initiatives

**Your Impact:** Every $1,000 donated funds 1,000+ verified survey responses, helping us reach the {{< var global_population_activism_threshold_pct >}} tipping point needed to pass the treaty. Research shows that when {{< var global_population_activism_threshold_pct >}} of a population actively supports a policy, it has historically passed.
