...
- Technical development of a decentralized framework for drug assessment (dFDA) and a network of decentralized institutes of health (DIH)
- Research and analysis to support our policy proposals and initiatives

**Your Impact:** Every $1,000 donated funds 1,000+ verified survey responses, helping us reach the {{< var global_population_activism_threshold_pct >}} tipping point needed for systemic change. Research shows that when {{< var global_population_activism_threshold_pct >}} of a population actively supports a cause, it has historically succeeded in achieving major societal advancement.
