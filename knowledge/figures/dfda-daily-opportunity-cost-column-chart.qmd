...
# Daily DALYs foregone (TOTAL DALYs / lag years / 365)
qalys_lost = [
    float(HISTORICAL_PROGRESS_DALYS) / EFFICACY_LAG_YEARS / 365,  # Historical rate
    float(DISEASE_ERADICATION_DELAY_DALYS) / EFFICACY_LAG_YEARS / 365,  # PRIMARY
    float(DISEASE_ERADICATION_PLUS_ACCELERATION_DALYS_TOTAL) / EFFICACY_LAG_YEARS / 365  # Optimistic
]
