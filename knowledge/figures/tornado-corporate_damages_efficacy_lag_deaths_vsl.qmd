...
drivers = ['PHARMA_LIFE_YEARS_SAVED_ANNUAL', 'VALUE_OF_STATISTICAL_LIFE', 'AVG_LIFE_EXTENSION_PER_BENEFICIARY', 'EFFICACY_LAG_YEARS']
driver_labels = ['Annual Life-Years Saved by Pharmaceuticals', 'Value of Statistical Life', 'Average Life Extension per Beneficiary', 'Regulatory Delay for Efficacy Testing Post-Safety Verification']
impacts_low = [-473550000000000.0, -508058333333333.3, 508058333333333.4, -247833333333333.5]
impacts_high = [622516666666666.6, 508058333333333.1, -338705555555555.6, 247833333333333.12]
...
output_path = get_figure_output_path('tornado-corporate_damages_efficacy_lag_deaths_vsl.png')
