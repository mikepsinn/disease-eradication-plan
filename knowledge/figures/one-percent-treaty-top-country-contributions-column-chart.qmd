...
```{python}
#| label: fig-treaty-contributions
#| fig-cap: "Projected annual contributions to a 1% Treaty Fund from top military spenders, based on a 1% reallocation of their military budgets."
# --- Imports ---
...
# --- Style Imports ---
# This assumes _chart_style.py is in ../figures/
...
ax.set_title(
    "Top Annual Contributions to a 1% treaty Fund",
...
output_path = get_figure_output_path('one-percent-treaty-top-country-contributions-column-chart.png')
