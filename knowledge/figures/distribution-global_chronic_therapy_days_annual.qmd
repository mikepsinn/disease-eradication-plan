```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Annual Days of Chronic Disease Therapy"
...
output_path = get_figure_output_path('distribution-global_chronic_therapy_days_annual.png')
