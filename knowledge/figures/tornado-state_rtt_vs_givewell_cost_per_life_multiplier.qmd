...
drivers = ['STATE_RTT_IMPLEMENTATION_COST_TOTAL', 'NEW_DISEASE_FIRST_TREATMENTS_PER_YEAR', 'STATE_RTT_TREATMENT_DISCOVERY_MULTIPLIER', 'RARE_DISEASES_COUNT_GLOBAL', 'EVENTUALLY_AVOIDABLE_DEATH_PCT', 'GLOBAL_DISEASE_DEATHS_DAILY']
driver_labels = ['Universal Right to Try with Evidence Implementation Cost', 'Diseases Getting First Treatment Per Year', 'Universal Right to Try with Evidence Treatment Discovery Multiplier', 'Total Number of Rare Diseases Globally', 'Eventually Avoidable Death Percentage', 'Global Daily Deaths from Disease and Aging']
...
output_path = get_figure_output_path('tornado-state_rtt_vs_givewell_cost_per_life_multiplier.png')
