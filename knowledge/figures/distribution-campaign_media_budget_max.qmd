```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Maximum Mass Media Campaign Budget"
...
output_path = get_figure_output_path('distribution-campaign_media_budget_max.png')
