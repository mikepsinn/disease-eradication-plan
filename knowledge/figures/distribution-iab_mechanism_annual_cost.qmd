```{python}
#| echo: false
#| fig-cap: "Probability Distribution: IAB Mechanism Annual Cost (High Estimate)"
...
output_path = get_figure_output_path('distribution-iab_mechanism_annual_cost.png')
