```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Incremental Implementation Probability from One Prize Instance"
...
output_path = get_figure_output_path('distribution-host_prize_instance_delta_implementation_probability.png')
