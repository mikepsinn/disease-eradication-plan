```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Thalidomide Cases Worldwide"
...
output_path = project_root / 'knowledge' / 'figures' / 'distribution-thalidomide_cases_worldwide.png'
