...
metrics = {
    'ROI Ratio': float(DFDA_ROI_RD_PLUS_DELAY),  # Recommended: R&D + regulatory delay elimination
    'Annual R&D Savings (Billions)': float(DFDA_RD_GROSS_SAVINGS_ANNUAL) / 1_000_000_000,
    'Annual QALYs Generated': float(GLOBAL_DFDA_QALYS_GAINED_ANNUAL),
...
roi_data = pd.DataFrame({
    ...
    'ROI Ratio': [
        ...
        float(DFDA_ROI_RD_PLUS_DELAY),  # Recommended: full health benefits
...
fig.add_annotation(
    ...
    text=f"10-Year ROI: {float(DFDA_ROI_RD_PLUS_DELAY):.0f}:1<br>NPV: ${net_benefit[10]/1000:.1f}B",
    showarrow=True,
    arrowhead=2,
    bgcolor="lightblue",
    bordercolor="blue",
...
- **QALY Impact**: {{< var global_dfda_qalys_gained_annual >}} annual QALYs from eliminating 7.2-year regulatory efficacy lag
