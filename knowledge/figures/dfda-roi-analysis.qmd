...
metrics = {
    ...
    'Total DALYs from Timeline Shift (Billions)': float(DISEASE_ERADICATION_DELAY_DALYS) / 1_000_000_000,
    'Daily Opportunity Cost (Millions)': float(DFDA_RD_GROSS_SAVINGS_ANNUAL) / 365 / 1_000_000,
    'Cost per DALY ($)': float(TREATY_DFDA_COST_PER_DALY_TIMELINE_SHIFT),
...
- **QALY Impact**: {{< var disease_eradication_delay_dalys >}}B DALYs from eliminating regulatory efficacy lag (based on Regulatory Mortality Analysis methodology)
