```{python}
#| echo: false
#| fig-cap: "Probability Distribution: War-Redirect Aging Lag After Disease Control"
...
output_path = get_figure_output_path('distribution-war_trial_redirect_aging_lag_after_disease_control_years.png')
