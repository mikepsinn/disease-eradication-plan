**Sensitivity Indices for Wishonia Path Lifetime Income Gain (Per Capita)**
...
|:----------------|------------------------:|:---------------|
| Wishonia Path Cumulative Lifetime Income (Per Capita) (USD) | 1.0006 | Strong driver |
| Earth Cumulative Lifetime Income (Per Capita) (USD) | -0.0008 | Minimal effect |
