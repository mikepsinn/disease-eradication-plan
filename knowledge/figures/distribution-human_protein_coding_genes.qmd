```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Human Protein-Coding Genes"
...
output_path = get_figure_output_path('distribution-human_protein_coding_genes.png')
