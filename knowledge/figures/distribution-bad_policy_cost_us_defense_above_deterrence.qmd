```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Defense Above Deterrence"
...
output_path = get_figure_output_path('distribution-bad_policy_cost_us_defense_above_deterrence.png')
