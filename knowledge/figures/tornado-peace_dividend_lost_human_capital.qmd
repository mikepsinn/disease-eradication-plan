...
drivers = ['GLOBAL_ANNUAL_LOST_HUMAN_CAPITAL_CONFLICT']
driver_labels = ['Annual Lost Productivity from Conflict Casualties']
impacts_low = [-900000000.0]
impacts_high = [1200000000.0]
...
output_path = get_figure_output_path('tornado-peace_dividend_lost_human_capital.png')
