```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Military Primes Tradeable Float"
...
output_path = get_figure_output_path('distribution-defense_primes_tradeable_float.png')
