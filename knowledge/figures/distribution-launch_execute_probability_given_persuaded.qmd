```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Execution Rate Given Persuasion"
...
output_path = get_figure_output_path('distribution-launch_execute_probability_given_persuaded.png')
