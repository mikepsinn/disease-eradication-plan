```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Annual Global Nonprofit Spending on Clinical Trials"
...
output_path = get_figure_output_path('distribution-global_nonprofit_clinical_trials_spending_annual.png')
