```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Phase 1 Campaign Budget"
...
output_path = get_figure_output_path('distribution-campaign_phase1_budget.png')
