...
drivers = ['PHARMA_DRUG_DEVELOPMENT_COST_CURRENT']
impacts_low = [-5.670103092783505]
impacts_high = [7.216494845360826]
...
output_path = project_root / 'knowledge' / 'figures' / 'tornado-drug_cost_increase_1980s_to_current_multiplier.png'
