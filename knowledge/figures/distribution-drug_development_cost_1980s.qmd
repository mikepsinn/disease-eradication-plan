```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Drug Development Cost (1980s)"
...
output_path = project_root / 'knowledge' / 'figures' / 'distribution-drug_development_cost_1980s.png'
