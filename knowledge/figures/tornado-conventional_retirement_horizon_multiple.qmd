...
drivers = ['CONVENTIONAL_RETIREMENT_RETURN']
driver_labels = ['Conventional Retirement Return (After Fees)']
impacts_low = [-0.4929128271519905]
impacts_high = [0.6003281076349127]
...
output_path = get_figure_output_path('tornado-conventional_retirement_horizon_multiple.png')
