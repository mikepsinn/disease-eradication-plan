...
drivers = ['GLOBAL_LIFE_EXPECTANCY_2024', 'GLOBAL_POPULATION_2024']
driver_labels = ['Global Life Expectancy (2024)', 'Global Population in 2024']
impacts_low = [-92908.3087129856, 34327.15794445365]
impacts_high = [97611.79184158007, -32652.662434968166]
...
output_path = get_figure_output_path('tornado-current_trajectory_cumulative_lifetime_income.png')
