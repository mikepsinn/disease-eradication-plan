```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Annual Global Spending on Symptomatic Disease Treatment"
...
output_path = project_root / 'knowledge' / 'figures' / 'distribution-global_symptomatic_disease_treatment_annual.png'
