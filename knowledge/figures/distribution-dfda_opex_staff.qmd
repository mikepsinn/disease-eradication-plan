```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Decentralized Framework for Drug Assessment Staff Costs"
...
output_path = get_figure_output_path('distribution-dfda_opex_staff.png')
