...
drivers = ['STATE_RTT_TREATMENT_DISCOVERY_MULTIPLIER', 'STATE_RTT_IMPLEMENTATION_COST_TOTAL', 'NEW_DISEASE_FIRST_TREATMENTS_PER_YEAR', 'EVENTUALLY_AVOIDABLE_DALY_PCT', 'RARE_DISEASES_COUNT_GLOBAL', 'GLOBAL_ANNUAL_DALY_BURDEN']
driver_labels = ['Universal Right to Try with Evidence Treatment Discovery Multiplier', 'Universal Right to Try with Evidence Implementation Cost', 'Diseases Getting First Treatment Per Year', 'Eventually Avoidable DALY Percentage', 'Total Number of Rare Diseases Globally', 'Global Annual DALY Burden']
...
output_path = get_figure_output_path('tornado-state_rtt_implementation_cost_per_daly.png')
