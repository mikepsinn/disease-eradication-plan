```{python}
#| echo: false
#| fig-cap: "Probability Distribution: dFDA Pragmatic Trial Cost per Patient"
...
output_path = get_figure_output_path('distribution-dfda_pragmatic_trial_cost_per_patient.png')
