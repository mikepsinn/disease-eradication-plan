...
drivers = ['THALIDOMIDE_CASES_WORLDWIDE', 'THALIDOMIDE_US_POPULATION_SHARE_1960', 'THALIDOMIDE_MORTALITY_RATE']
driver_labels = ['Thalidomide Cases Worldwide', 'US Population Share 1960', 'Thalidomide Mortality Rate']
impacts_low = [-180.0, -45.0, 45.0]
impacts_high = [180.0, 45.0, -44.99999999999994]
...
output_path = get_figure_output_path('tornado-thalidomide_survivors_per_event.png')
