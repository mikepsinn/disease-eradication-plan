```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Safe Compounds Available for Testing"
...
output_path = get_figure_output_path('distribution-safe_compounds_count.png')
