```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Pharma Drug Development Cost (Current System)"
...
output_path = project_root / 'knowledge' / 'figures' / 'distribution-pharma_drug_development_cost_current.png'
