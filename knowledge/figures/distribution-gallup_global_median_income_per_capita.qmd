```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Gallup Global Median Per-Capita Income (2013, PPP)"
...
output_path = get_figure_output_path('distribution-gallup_global_median_income_per_capita.png')
