...
baseline = 12.114893617021277

# Tornado data from sensitivity analysis

drivers = ['STATE_RTT_IMPLEMENTATION_COST_TOTAL', 'NIH_ANNUAL_BUDGET']
driver_labels = ['Universal Right to Try with Evidence Implementation Cost', 'NIH Annual Budget']
impacts_low = [-7.45531914893617, 0.5384397163120553]
impacts_high = [25.161702127659577, -0.7268936170212772]
...
output_path = get_figure_output_path('tornado-state_rtt_nih_budget_equivalent_hours.png')
