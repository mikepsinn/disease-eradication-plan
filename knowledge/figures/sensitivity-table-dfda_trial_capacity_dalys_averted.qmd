...
|:----------------|------------------------:|:---------------|
| Treatment Timeline Acceleration from Pragmatic Trial Capacity (years) | 0.9358 | Strong driver |
| Eventually Avoidable DALY Percentage (percentage) | 0.3057 | Moderate driver |
| Global Annual DALY Burden (DALYs/year) | 0.1306 | Weak driver |
