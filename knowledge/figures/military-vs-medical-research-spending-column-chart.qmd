...
# Data - Work in billions to prevent matplotlib from expanding the canvas to trillions
...
# Note: Use \$ to escape dollar sign, preventing matplotlib mathtext parsing

ax.text(x_positions[0], military_99_visual * 0.6,
        f'\${military_total_trillions:.1f}T', ha='center', va='center',
        color=COLOR_WHITE, fontsize=56, fontweight='bold')
ax.text(x_positions[0], military_99_visual * 0.35,
        'Global Military Spending', ha='center', va='center',
        color=COLOR_WHITE, fontsize=28, fontweight='bold', linespacing=1.1)

# Label above small bar (as it was originally)

ax.text(x_positions[1], cure_spending + (military_total * 0.025),
        f'\${cure_spending:.0f}B\nCuring Disease', ha='center', va='bottom',
        color=COLOR_BLACK, fontsize=32, fontweight='bold', linespacing=1.1)
