...
```{python}
#| echo: false
# Scale constant for converting raw USD to billions

BILLION = 1_000_000_000

dividends_data = {
    'Type': ['Captured\nDividend', 'Total Societal\nDividend'],
    'Amount ($B)': [float(TREATY_ANNUAL_FUNDING) / BILLION, float(PEACE_DIVIDEND_ANNUAL_SOCIETAL_BENEFIT) / BILLION]
}
...
ax.set_ylim(0, (float(PEACE_DIVIDEND_ANNUAL_SOCIETAL_BENEFIT) / BILLION) * 1.12)
