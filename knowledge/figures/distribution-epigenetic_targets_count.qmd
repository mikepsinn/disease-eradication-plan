```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Epigenetic Drug Targets"
...
output_path = get_figure_output_path('distribution-epigenetic_targets_count.png')
