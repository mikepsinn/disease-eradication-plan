...
|:----------------|------------------------:|:---------------|
| Mature Market Annual Penetration Rate (percentage) | 0.9498 | Strong driver |
| US Patients with Poorly Treated Diseases (patients) | 0.2412 | Weak driver |
| Patient Willingness to Participate in Clinical Trials (percentage) | 0.0813 | Minimal effect |
