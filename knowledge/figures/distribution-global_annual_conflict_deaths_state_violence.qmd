```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Annual Deaths from State Violence"
...
output_path = project_root / 'knowledge' / 'figures' / 'distribution-global_annual_conflict_deaths_state_violence.png'
