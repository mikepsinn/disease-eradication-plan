...
drivers = ['BAD_POLICY_COST_US_HOUSING_ZONING', 'BAD_POLICY_COST_US_HEALTHCARE_INEFFICIENCY', 'BAD_POLICY_COST_US_FAILED_WARS', 'BAD_POLICY_COST_US_TAX_COMPLIANCE', 'BAD_POLICY_COST_US_TARIFFS', 'BAD_POLICY_COST_US_DRUG_WAR', 'BAD_POLICY_COST_US_AGRICULTURAL_SUBSIDIES', 'BAD_POLICY_COST_US_FOSSIL_FUEL_EXPLICIT']
impacts_low = [-400000000000.0, -200000000000.0, -100000000000.0, -96000000000.0, -70000000000.0, -30000000000.0, -25000000000.0, -20000000000.0]
impacts_high = [600000000000.0, 300000000000.0, 200000000000.0, 104000000000.0, 90000000000.0, 60000000000.0, 45000000000.0, 30000000000.0]
...
output_path = get_figure_output_path('tornado-bad_policy_cost_us_tier1_total.png')
