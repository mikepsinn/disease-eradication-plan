```{python}
#| echo: false
#| fig-cap: "Probability Distribution: IAB Political Incentive Funding Percentage"
...
output_path = get_figure_output_path('distribution-iab_political_incentive_funding_pct.png')
