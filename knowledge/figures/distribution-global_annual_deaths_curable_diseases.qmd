```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Annual Deaths from All Diseases and Aging Globally"
...
output_path = get_figure_output_path('distribution-global_annual_deaths_curable_diseases.png')
