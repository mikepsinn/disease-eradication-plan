...
drivers = ['CURRENT_TRIAL_SLOTS_AVAILABLE', 'CURRENT_DISEASE_PATIENTS_GLOBAL']
driver_labels = ['Annual Global Clinical Trial Participants', 'Global Population with Chronic Diseases']
impacts_low = [-0.00016666666666666663, 0.00015833333333333335]
impacts_high = [0.00016666666666666663, -0.00011309523809523809]
...
output_path = get_figure_output_path('tornado-current_patient_participation_rate.png')
