...
drivers = ['EFFICACY_LAG_YEARS', 'REGULATORY_DELAY_MEAN_AGE_OF_DEATH', 'GLOBAL_LIFE_EXPECTANCY_REMAINING_AT_AGE_60', 'GLOBAL_DISEASE_DEATHS_DAILY']
driver_labels = ['Regulatory Delay for Efficacy Testing Post-Safety Verification', 'Mean Age of Preventable Death from Post-Safety Efficacy Delay', 'Remaining Life Expectancy at Age 60 (Global)', 'Global Daily Deaths from Disease and Aging']
impacts_low = [-1927121532.5305977, 1247557641.5592556, -582193550.1525946, -395059905.545701]
impacts_high = [1927121554.2238579, -1247557619.8659954, 415852554.41750526, 395059927.2389631]
...
output_path = get_figure_output_path('tornado-dfda_efficacy_lag_elimination_yll.png')
