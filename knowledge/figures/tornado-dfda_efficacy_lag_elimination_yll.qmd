...
drivers = ['EFFICACY_LAG_YEARS', 'REGULATORY_DELAY_MEAN_AGE_OF_DEATH', 'GLOBAL_LIFE_EXPECTANCY_2024', 'GLOBAL_DISEASE_DEATHS_DAILY']
driver_labels = ['Regulatory Delay for Efficacy Testing Post-Safety Verification', 'Mean Age of Preventable Death from Post-Safety Efficacy Delay', 'Global Life Expectancy (2024)', 'Global Daily Deaths from Disease and Aging']
impacts_low = [-1724266634.369482, 1247557640.4175053, -831705077.4368706, -353474652.3303642]
impacts_high = [1724266653.7792416, -1247557621.0077457, 831705096.8466301, 353474671.7401247]
