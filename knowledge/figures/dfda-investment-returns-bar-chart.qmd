...
conservative_value = format_as_trillions(HISTORICAL_PROGRESS_ECONOMIC_LOSS_TOTAL)
primary_value = format_as_trillions(DISEASE_ERADICATION_DELAY_ECONOMIC_LOSS)
optimistic_value = format_as_trillions(DISEASE_ERADICATION_PLUS_ACCELERATION_ECONOMIC_LOSS_TOTAL)
...
conservative_label = format_as_trillions(HISTORICAL_PROGRESS_ECONOMIC_LOSS_TOTAL)
...
primary_label = format_as_trillions(DISEASE_ERADICATION_DELAY_ECONOMIC_LOSS)
...
optimistic_label = format_as_trillions(DISEASE_ERADICATION_PLUS_ACCELERATION_ECONOMIC_LOSS_TOTAL)
