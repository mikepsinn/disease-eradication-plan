...
global_clinical_trial_market = float(GLOBAL_CLINICAL_TRIAL_MARKET_ANNUAL) / BILLION  # Convert raw USD to billions
dfda_rd_cost_reduction_pct = TRIAL_COST_REDUCTION_PCT
dfda_annual_operational_cost = float(DFDA_NPV_ANNUAL_OPEX_TOTAL) / BILLION  # Convert raw USD to billions

# Baseline QALYs generated annually

qaly_gains_annual_baseline = DFDA_QALYS_RD_PLUS_DELAY_ANNUAL
...
monetized_qaly_value = (qaly_gains_annual_baseline * value_per_qaly) / BILLION  # Convert raw USD to billions
