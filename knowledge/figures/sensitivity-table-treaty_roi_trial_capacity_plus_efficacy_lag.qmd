**Sensitivity Indices for Treaty ROI - Full Timeline Shift (PRIMARY)**
...
|:----------------|------------------------:|:---------------|
| Treaty Campaign Total Cost | -0.7911 | Strong driver |
| dFDA Trial Capacity Plus Efficacy Lag Economic Value | 0.3424 | Moderate driver |
