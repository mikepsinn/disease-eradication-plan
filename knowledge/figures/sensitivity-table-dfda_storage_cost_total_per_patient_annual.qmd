**Sensitivity Indices for Total Infrastructure Cost per Patient (Annual)**
...
|:----------------|------------------------:|:---------------|
| Total Infrastructure Cost per Patient (Monthly) (USD/patient/month) | 1.0000 | Strong driver |
