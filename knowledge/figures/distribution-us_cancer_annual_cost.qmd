```{python}
#| echo: false
#| fig-cap: "Probability Distribution: US Cancer Annual Cost"
...
output_path = project_root / 'knowledge' / 'figures' / 'distribution-us_cancer_annual_cost.png'
