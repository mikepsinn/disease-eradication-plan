...
dct_companies = pd.DataFrame({
    'Company': ['Medable', 'Science 37', 'Thread', 'uMotif', 'Decentralized Framework (Target)'],
...
colors = ['darkgreen' if x == 'Medable' else 'lightgreen' if x == 'Decentralized Framework (Target)' else 'gray'
