```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Occupational Licensing Cost"
...
output_path = get_figure_output_path('distribution-bad_policy_cost_us_occupational_licensing.png')
