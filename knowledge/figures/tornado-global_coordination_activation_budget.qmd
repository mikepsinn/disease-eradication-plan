...
drivers = ['GLOBAL_COORDINATION_ACTIVATION_REWARD_PER_VERIFIED_PARTICIPANT', 'GLOBAL_COORDINATION_VERIFICATION_AND_PAYMENT_COST_PER_PARTICIPANT', 'GLOBAL_COORDINATION_PLATFORM_AND_OPERATIONS_COST', 'GLOBAL_POPULATION_2024']
driver_labels = ['Activation Reward per Verified Participant', 'Verification and Payment Cost per Participant', 'Global Coordination Platform and Operations Cost', 'Global Population in 2024']
impacts_low = [-12000000000.0, -2000000000.0, -2000000000.0, -650000000.0]
impacts_high = [20000000000.0, 6000000000.0, 4000000000.0, 650000000.0]
...
output_path = get_figure_output_path('tornado-global_coordination_activation_budget.png')
