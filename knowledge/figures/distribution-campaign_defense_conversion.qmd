```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Defense Industry Conversion Program"
...
output_path = project_root / 'knowledge' / 'figures' / 'distribution-campaign_defense_conversion.png'
