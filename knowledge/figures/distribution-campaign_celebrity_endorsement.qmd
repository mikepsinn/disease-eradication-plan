```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Celebrity and Influencer Endorsements"
...
output_path = get_figure_output_path('distribution-campaign_celebrity_endorsement.png')
