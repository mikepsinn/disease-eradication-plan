```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Universal Security Administration All-In Annual Cost per Citizen"
...
output_path = get_figure_output_path('distribution-universal_security_admin_all_in_cost_per_citizen_annual.png')
