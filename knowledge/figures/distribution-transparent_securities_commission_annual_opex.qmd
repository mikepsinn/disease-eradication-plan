```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Transparent Securities Commission Annual Operating Cost"
...
output_path = get_figure_output_path('distribution-transparent_securities_commission_annual_opex.png')
