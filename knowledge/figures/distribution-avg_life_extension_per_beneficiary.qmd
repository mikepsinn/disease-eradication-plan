```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Average Life Extension per Beneficiary"
...
output_path = get_figure_output_path('distribution-avg_life_extension_per_beneficiary.png')
