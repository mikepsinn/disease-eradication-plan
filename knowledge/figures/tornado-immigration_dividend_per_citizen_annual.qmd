...
drivers = ['IMMIGRATION_PRICED_ENTRY_ANNUAL_VOLUME', 'US_SMUGGLER_FEE_AVG', 'US_POPULATION_2024']
driver_labels = ['Priced-Entry Annual Volume', 'Average Smuggler Fee per US Border Crossing', 'US Population in 2024']
impacts_low = [-20.70746268656717, -17.53432835820894, 4.698055178652169]
impacts_high = [62.12238805970151, 42.167164179104475, -4.559877085162441]
...
output_path = get_figure_output_path('tornado-immigration_dividend_per_citizen_annual.png')
