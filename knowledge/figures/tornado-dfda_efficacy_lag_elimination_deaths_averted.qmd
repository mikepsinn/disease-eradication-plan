...
drivers = ['EFFICACY_LAG_YEARS', 'GLOBAL_DISEASE_DEATHS_DAILY']
driver_labels = ['Regulatory Delay for Efficacy Testing Post-Safety Verification', 'Global Daily Deaths from Disease and Aging']
impacts_low = [-101427449.65143305, -20792627.178543746]
impacts_high = [101427449.65143299, 20792627.178543806]
...
output_path = get_figure_output_path('tornado-dfda_efficacy_lag_elimination_deaths_averted.png')
