...
drivers = ['PHARMA_LIFE_YEARS_SAVED_ANNUAL', 'AVG_LIFE_EXTENSION_PER_BENEFICIARY', 'EFFICACY_LAG_YEARS']
driver_labels = ['Annual Life-Years Saved by Pharmaceuticals', 'Average Life Extension per Beneficiary', 'Regulatory Delay for Efficacy Testing Post-Safety Verification']
impacts_low = [-47354999.99999999, 50805833.33333334, -24783333.333333343]
impacts_high = [62251666.66666666, -33870555.55555555, 24783333.33333333]
...
output_path = get_figure_output_path('tornado-existing_drugs_efficacy_lag_deaths_total.png')
