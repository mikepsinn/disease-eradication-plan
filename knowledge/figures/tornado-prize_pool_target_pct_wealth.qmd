...
drivers = ['VENTURE_GROSS_RETURN', 'POLITICAL_DYSFUNCTION_GLOBAL_MIGRATION_OPPORTUNITY_COST', 'POLITICAL_DYSFUNCTION_GLOBAL_HEALTH_OPPORTUNITY_COST', 'SCALE_COMPRESSION_FACTOR', 'ALLOCATION_DECISION_SPREAD', 'HOME_BIAS_ALPHA', 'POLITICAL_DYSFUNCTION_GLOBAL_SCIENCE_OPPORTUNITY_COST', 'POLITICAL_DYSFUNCTION_GLOBAL_LEAD_OPPORTUNITY_COST']
driver_labels = ['Venture Capital Gross Return', 'Global Migration Opportunity Cost', 'Global Health Opportunity Cost', 'Scale Compression Factor', 'Allocation Decision Return Spread', 'Home Bias Return Drag', 'Global Science Opportunity Cost', 'Global Lead Poisoning Cost']
impacts_low = [0.013716205847454716, 0.0, -0.00278715168639309, 0.007664177328507351, 0.0021149022863259613, 0.0013296158384665697, -0.00039816452662758475, -0.00039816452662758475]
impacts_high = [-0.009352348878891761, 0.02249629575445849, 0.009157784112434428, -0.0034872108084019193, -0.0024920237709499943, -0.0017156729851562115, 0.0011944935798827508, 0.0003981645266275813]
...
output_path = get_figure_output_path('tornado-prize_pool_target_pct_wealth.png')
