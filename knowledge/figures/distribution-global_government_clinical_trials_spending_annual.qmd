```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Annual Global Government Spending on Clinical Trials"
...
output_path = get_figure_output_path('distribution-global_government_clinical_trials_spending_annual.png')
