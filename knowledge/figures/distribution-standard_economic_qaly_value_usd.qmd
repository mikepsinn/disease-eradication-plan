```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Standard Economic Value per QALY"
...
output_path = project_root / 'knowledge' / 'figures' / 'distribution-standard_economic_qaly_value_usd.png'
