```{python}
#| echo: false
#| fig-cap: "Probability Distribution: P(Success | Treaty Campaign Funded)"
...
output_path = get_figure_output_path('distribution-mechanism_treaty_campaign_p_success.png')
