```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Defense Takeover Total Cost"
...
output_path = get_figure_output_path('distribution-defense_takeover_cost_total.png')
