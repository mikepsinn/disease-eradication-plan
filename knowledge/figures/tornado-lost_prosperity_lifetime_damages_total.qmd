...
drivers = ['WAR_COUNTERFACTUAL_ANNUAL_GROWTH_BOOST', 'GLOBAL_LIFE_EXPECTANCY_2024', 'GLOBAL_GDP_PER_CAPITA_1900', 'GLOBAL_POPULATION_2024']
driver_labels = ['Peace Growth Boost (8 Channels, Overlap-Corrected)', 'Global Life Expectancy (2024)', 'Global GDP per Capita in 1900', 'Global Population in 2024']
impacts_low = [-1.4340454108177323e+17, -5108171563830240.0, -910018110049248.0, -133621968326304.0]
impacts_high = [4.414734683461773e+17, 5108171563830240.0, 779761127978272.0, 130429587193792.0]
...
output_path = get_figure_output_path('tornado-lost_prosperity_lifetime_damages_total.png')
