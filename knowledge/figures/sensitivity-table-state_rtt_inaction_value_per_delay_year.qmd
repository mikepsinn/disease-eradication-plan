**Sensitivity Indices for Economic Value Forfeited per Year of Delay**
...
|:----------------|------------------------:|:---------------|
| Global DALYs Forfeited per Year of Delay (DALYs/year) | 0.9728 | Strong driver |
| Standard Economic Value per QALY (USD/QALY) | 0.1460 | Weak driver |
