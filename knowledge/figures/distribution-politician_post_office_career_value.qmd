```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Post-Office Career Value (per politician)"
...
output_path = get_figure_output_path('distribution-politician_post_office_career_value.png')
