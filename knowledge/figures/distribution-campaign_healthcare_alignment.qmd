```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Healthcare Industry Alignment and Partnerships"
...
output_path = get_figure_output_path('distribution-campaign_healthcare_alignment.png')
