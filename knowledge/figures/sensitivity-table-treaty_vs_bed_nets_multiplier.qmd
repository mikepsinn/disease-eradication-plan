...
|:----------------|------------------------:|:---------------|
| Bed Nets Cost per DALY (USD/DALY) | -0.8686 | Strong driver |
| Cost per DALY Averted (Elimination of Efficacy Lag Plus Earlier Treatment Discovery from Increased Trial Throughput) (USD/DALY) | -0.0847 | Minimal effect |
