...
from dih_models.plotting.chart_style import (
    ...
    PATTERN_DIAGONAL, PATTERN_HORIZONTAL, PATTERN_CROSS, get_figure_output_path,
    get_serif_font)
...
for i, (wedge, label, size) in enumerate(zip(wedges, labels, sizes)):
    ...
    if i == 0:
        ax.text(x, y, label, ha='center', va='center',
                ...
                fontname=CLASSY_FONT, linespacing=1.4)
...
output_path = get_figure_output_path('clinical-trial-spending-by-phase-pie-chart.png')
