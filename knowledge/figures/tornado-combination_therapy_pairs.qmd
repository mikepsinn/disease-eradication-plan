...
drivers = ['SAFE_COMPOUNDS_COUNT']
driver_labels = ['Safe Compounds Available for Testing']
impacts_low = [-20623750.0]
impacts_high = [26873750.0]
...
output_path = get_figure_output_path('tornado-combination_therapy_pairs.png')
