```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Peace Dividend Conflict Elasticity"
...
output_path = get_figure_output_path('distribution-peace_dividend_conflict_elasticity.png')
