...
drivers = ['THALIDOMIDE_CASES_WORLDWIDE', 'THALIDOMIDE_US_POPULATION_SHARE_1960']
driver_labels = ['Thalidomide Cases Worldwide', 'US Population Share 1960']
impacts_low = [-300.0, -75.0]
impacts_high = [300.0, 75.0]
...
output_path = get_figure_output_path('tornado-thalidomide_us_cases_prevented.png')
