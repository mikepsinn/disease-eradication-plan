```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Annual Global Spending on Clinical Trials"
...
output_path = project_root / 'knowledge' / 'figures' / 'distribution-global_clinical_trials_spending_annual.png'
