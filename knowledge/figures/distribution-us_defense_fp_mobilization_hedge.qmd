```{python}
#| echo: false
#| fig-cap: "Probability Distribution: First-Principles Defense: Mobilization Hedge"
...
output_path = get_figure_output_path('distribution-us_defense_fp_mobilization_hedge.png')
