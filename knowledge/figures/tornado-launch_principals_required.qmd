...
drivers = ['LAUNCH_AVG_PRINCIPAL_COMMITMENT_USD', 'LAUNCH_REDUNDANCY_FACTOR', 'TREATY_CAMPAIGN_BUDGET_LOBBYING', 'TREATY_CAMPAIGN_VIRAL_REFERENDUM_BASE_CASE', 'TREATY_CAMPAIGN_BUDGET_RESERVE']
driver_labels = ['Average Commitment per Lead Principal', 'Launch Redundancy Factor', 'Political Lobbying Campaign: Direct Lobbying, Super Pacs, Opposition Research, Staff, Legal/Compliance', 'Viral Referendum Budget', 'Reserve Fund / Contingency Buffer']
impacts_low = [9.0, -1.0, -1.0, 0.0, 0.0]
impacts_high = [-2.0, 2.0, 2.0, 1.0, 0.0]
...
output_path = get_figure_output_path('tornado-launch_principals_required.png')
