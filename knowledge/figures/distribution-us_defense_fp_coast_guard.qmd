```{python}
#| echo: false
#| fig-cap: "Probability Distribution: First-Principles Defense: Coast Guard"
...
output_path = get_figure_output_path('distribution-us_defense_fp_coast_guard.png')
