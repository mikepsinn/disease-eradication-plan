```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Thalidomide Disability Weight"
...
output_path = project_root / 'knowledge' / 'figures' / 'distribution-thalidomide_disability_weight.png'
