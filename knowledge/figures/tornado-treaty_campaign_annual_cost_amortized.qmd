...
drivers = ['TREATY_CAMPAIGN_BUDGET_LOBBYING', 'TREATY_CAMPAIGN_DURATION_YEARS', 'TREATY_CAMPAIGN_VIRAL_REFERENDUM_BASE_CASE', 'TREATY_CAMPAIGN_BUDGET_RESERVE']
driver_labels = ['Political Lobbying Campaign: Direct Lobbying, Super Pacs, Opposition Research, Staff, Legal/Compliance', 'Treaty Campaign Duration', 'Viral Referendum Budget', 'Reserve Fund / Contingency Buffer']
impacts_low = [-81250000.0, 83333333.33333331, -25000000.0, -20000000.0]
impacts_high = [162500000.0, -50000000.0, 40000000.0, 12500000.0]
...
output_path = get_figure_output_path('tornado-treaty_campaign_annual_cost_amortized.png')
