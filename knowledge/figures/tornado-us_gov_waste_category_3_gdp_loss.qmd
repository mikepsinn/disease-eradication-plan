...
drivers = ['US_GOV_WASTE_HOUSING_ZONING', 'US_GOV_WASTE_TARIFFS']
driver_labels = ['Housing/Zoning Restrictions Cost', 'Tariff Cost (GDP Loss)']
impacts_low = [-900000000000.0, -70000000000.0]
impacts_high = [600000000000.0, 90000000000.0]
...
output_path = get_figure_output_path('tornado-us_gov_waste_category_3_gdp_loss.png')
