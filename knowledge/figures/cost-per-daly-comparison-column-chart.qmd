...
interventions = {
    ...
    '1% Treaty + dFDA\n(Expected Value,\n10% Success)': {
        'cost_per_daly': float(TREATY_EXPECTED_COST_PER_DALY_CONSERVATIVE),  # $1.27
...
callout_text = ('DALY = Disability-Adjusted Life Year\nOne DALY = one year of healthy life lost\n\nLower cost per DALY = more cost-effective\n\nEven accounting for political risk (10% success),\nthe 1% Treaty is 40-80x more cost-effective\nthan malaria bed nets ($1.27 vs $75 per DALY)\n\nConditional on success: 400-800x better')
