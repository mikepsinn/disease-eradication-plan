```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Decentralized Framework for Drug Assessment Regulatory Coordination Costs"
...
output_path = get_figure_output_path('distribution-dfda_opex_regulatory.png')
