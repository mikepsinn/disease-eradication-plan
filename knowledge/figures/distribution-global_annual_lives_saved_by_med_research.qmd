```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Annual Lives Saved by Medical Research Globally"
...
output_path = project_root / 'knowledge' / 'figures' / 'distribution-global_annual_lives_saved_by_med_research.png'
