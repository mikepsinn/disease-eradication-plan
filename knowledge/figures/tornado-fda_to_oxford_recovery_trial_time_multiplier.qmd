...
drivers = ['EFFICACY_LAG_YEARS']
driver_labels = ['Regulatory Delay for Efficacy Testing Post-Safety Verification']
impacts_low = [-8.0]
impacts_high = [8.0]
...
output_path = get_figure_output_path('tornado-fda_to_oxford_recovery_trial_time_multiplier.png')
