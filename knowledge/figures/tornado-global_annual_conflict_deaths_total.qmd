...
drivers = ['GLOBAL_ANNUAL_CONFLICT_DEATHS_ACTIVE_COMBAT', 'GLOBAL_ANNUAL_CONFLICT_DEATHS_TERROR_ATTACKS', 'GLOBAL_ANNUAL_CONFLICT_DEATHS_STATE_VIOLENCE']
driver_labels = ['Annual Deaths from Active Combat Worldwide', 'Annual Deaths from Terror Attacks Globally', 'Annual Deaths from State Violence']
impacts_low = [-53600.0, -2300.0, -1200.0]
impacts_high = [66400.0, 3700.0, 2300.0]
...
output_path = get_figure_output_path('tornado-global_annual_conflict_deaths_total.png')
