...
drivers = ['VENTURE_GROSS_RETURN', 'SCALE_COMPRESSION_FACTOR', 'CONVENTIONAL_RETIREMENT_RETURN', 'ALLOCATION_DECISION_SPREAD', 'GLOBAL_SAVINGS_RATE_PCT', 'HOME_BIAS_ALPHA', 'GLOBAL_POPULATION_2024']
driver_labels = ['Venture Capital Gross Return', 'Scale Compression Factor', 'Conventional Retirement Return (After Fees)', 'Allocation Decision Return Spread', 'Global Gross Savings Rate', 'Home Bias Return Drag', 'Global Population in 2024']
impacts_low = [1230875714689.145, 687773998994.1465, -345828001975.48145, 189788771919.1853, -200489504590.58325, 119318116368.03662, 0.0]
impacts_high = [-839268471059.3124, -312938078051.66016, 421190641746.2466, -223631197592.417, 200489504590.583, -153962417541.93872, 0.0]
...
output_path = get_figure_output_path('tornado-prize_pool_retirement_equivalent_principal.png')
