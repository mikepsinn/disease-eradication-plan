...
drivers = ['DFDA_PRAGMATIC_TRIAL_COST_PER_PATIENT', 'SAFE_COMPOUNDS_COUNT', 'CURRENT_TRIAL_SLOTS_AVAILABLE', 'CURRENT_TRIALS_PER_YEAR', 'TRIAL_RELEVANT_DISEASES_COUNT', 'DFDA_OPEX_PLATFORM_MAINTENANCE', 'DFDA_OPEX_STAFF', 'DFDA_OPEX_INFRASTRUCTURE', 'DFDA_OPEX_REGULATORY', 'DFDA_OPEX_COMMUNITY']
driver_labels = ['dFDA Pragmatic Trial Cost per Patient', 'Safe Compounds Available for Testing', 'Annual Global Clinical Trial Participants', 'Current Global Clinical Trials per Year', 'Trial-Relevant Diseases', 'Decentralized Framework for Drug Assessment Maintenance Costs', 'Decentralized Framework for Drug Assessment Staff Costs', 'Decentralized Framework for Drug Assessment Infrastructure Costs', 'Decentralized Framework for Drug Assessment Regulatory Coordination Costs', 'Decentralized Framework for Drug Assessment Community Support Costs']
impacts_low = [-209.52062057034433, -61.56523801551424, -49.25219041241141, 58.48697611473855, -46.78958089179082, -0.05384301598593311, -0.032308783933046925, -0.032308783933046925, -0.021540180872761994, -0.010770586274077232]
impacts_high = [521.5351024052682, 61.56523801551427, 49.25219041241141, -38.99131740982568, 46.78958089179085, 0.07542188233833258, 0.053867811296100854, 0.04309226458997273, 0.03231771024434238, 0.01077157808643392]
...
output_path = get_figure_output_path('tornado-dfda_known_safe_exploration_years.png')
