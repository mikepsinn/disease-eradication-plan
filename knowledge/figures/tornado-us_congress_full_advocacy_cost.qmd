...
baseline = 5350000000.0

# Tornado data from sensitivity analysis

drivers = ['POLITICIAN_POST_OFFICE_CAREER_VALUE']
driver_labels = ['Post-Office Career Value (per politician)']
impacts_low = [-2675000000.0]
impacts_high = [5350000000.0]
...
output_path = get_figure_output_path('tornado-us_congress_full_advocacy_cost.png')
