...
drivers = ['CHAIN_IMPLEMENTER_ORBIT_SIZE', 'CHAIN_INITIAL_AUDIENCE', 'CHAIN_DISMISS_PROBABILITY', 'CHAIN_EFFECTIVE_R']
driver_labels = ['Implementer Orbit Size', 'Initial Audience', 'Dismissal Rate', 'Effective R']
impacts_low = [0.5610763652713117, 0.4662339248180641, -0.029834848454155204, 0.014928807622735758]
impacts_high = [-0.030778258717869322, -0.030778298442164436, 0.3213160224331727, -0.030606530415382045]
...
output_path = get_figure_output_path('tornado-chain_p_no_implementer_engages.png')
