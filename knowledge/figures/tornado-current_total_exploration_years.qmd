...
drivers = ['CURRENT_TRIALS_PER_YEAR', 'TRIAL_RELEVANT_DISEASES_COUNT', 'SAFE_COMPOUNDS_COUNT', 'HUMAN_PROTEIN_CODING_GENES', 'EPIGENETIC_TARGETS_COUNT', 'CELL_THERAPY_APPROACHES']
driver_labels = ['Current Global Clinical Trials per Year', 'Trial-Relevant Diseases', 'Safe Compounds Available for Testing', 'Human Protein-Coding Genes', 'Epigenetic Drug Targets', 'Cell Therapy Approaches']
impacts_low = [3901.51515151515, -3121.212121212122, -757.575757575758, -606.060606060606, -151.51515151515196, -60.606060606060055]
impacts_high = [-2601.0101010101007, 3121.212121212122, 757.575757575758, 606.060606060606, 151.51515151515196, 90.90909090909008]
...
output_path = get_figure_output_path('tornado-current_total_exploration_years.png')
