...
drivers = ['GLOBAL_SAVINGS_RATE_PCT']
driver_labels = ['Global Gross Savings Rate']
impacts_low = [-3450000000000.004]
impacts_high = [3449999999999.996]
...
output_path = get_figure_output_path('tornado-global_annual_savings.png')
