```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Average Years of Life Lost per War Death"
...
output_path = get_figure_output_path('distribution-war_avg_years_life_lost_per_death.png')
