```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Approved Drug-Disease Pairings"
...
output_path = get_figure_output_path('distribution-approved_drug_disease_pairings.png')
