...
drivers = ['GLOBAL_COORDINATION_ACTIVATION_REWARD_PER_VERIFIED_PARTICIPANT', 'GLOBAL_COORDINATION_VERIFICATION_AND_PAYMENT_COST_PER_PARTICIPANT']
driver_labels = ['Activation Reward per Verified Participant', 'Verification and Payment Cost per Participant']
impacts_low = [-3.0, -0.5]
impacts_high = [5.0, 1.5]
...
output_path = get_figure_output_path('tornado-global_coordination_activation_cost_per_participant.png')
