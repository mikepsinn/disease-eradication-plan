```{python}
#| echo: false
#| fig-cap: "Probability Distribution: dFDA Trial Cost Reduction Percentage"
...
output_path = project_root / 'knowledge' / 'figures' / 'distribution-trial_cost_reduction_pct.png'
