```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Decentralized Framework for Drug Assessment Trial Cost Reduction Percentage"
...
output_path = get_figure_output_path('distribution-trial_cost_reduction_pct.png')
