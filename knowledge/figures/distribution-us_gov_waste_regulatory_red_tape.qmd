```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Regulatory Red Tape Waste"
...
output_path = get_figure_output_path('distribution-us_gov_waste_regulatory_red_tape.png')
