```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Thalidomide Survivor Lifespan"
...
output_path = project_root / 'knowledge' / 'figures' / 'distribution-thalidomide_survivor_lifespan.png'
