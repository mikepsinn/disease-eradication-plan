```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Global Fossil Fuel Subsidies"
...
output_path = get_figure_output_path('distribution-political_dysfunction_global_fossil_fuel_subsidies.png')
