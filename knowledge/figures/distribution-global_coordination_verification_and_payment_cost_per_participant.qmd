```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Verification and Payment Cost per Participant"
...
output_path = get_figure_output_path('distribution-global_coordination_verification_and_payment_cost_per_participant.png')
