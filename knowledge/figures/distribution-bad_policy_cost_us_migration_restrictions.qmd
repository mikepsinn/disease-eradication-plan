```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Migration Restrictions Cost (US Share)"
...
output_path = get_figure_output_path('distribution-bad_policy_cost_us_migration_restrictions.png')
