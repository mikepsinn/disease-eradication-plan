```{python}
#| echo: false
#| fig-cap: "Probability Distribution: First-Principles Defense: National Guard"
...
output_path = get_figure_output_path('distribution-us_defense_fp_national_guard.png')
