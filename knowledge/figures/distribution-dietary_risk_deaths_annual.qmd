```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Deaths per Year from Dietary Risks"
...
output_path = get_figure_output_path('distribution-dietary_risk_deaths_annual.png')
