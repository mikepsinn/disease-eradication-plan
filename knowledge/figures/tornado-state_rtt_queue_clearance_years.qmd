...
drivers = ['STATE_RTT_MATURE_ANNUAL_PENETRATION_PCT', 'STATE_RTT_PATIENTS_PER_TREATMENT_EVALUATION', 'PHARMA_SUCCESS_RATE_CURRENT_PCT', 'RARE_DISEASES_COUNT_GLOBAL', 'STATE_RTT_US_PATIENTS_RARE_UNTREATED', 'NEW_DISEASE_FIRST_TREATMENTS_PER_YEAR', 'PATIENT_WILLINGNESS_TRIAL_PARTICIPATION_PCT', 'STATE_RTT_US_PATIENTS_COMMON_POORLY_TREATED']
driver_labels = ['Mature Market Annual Penetration Rate', 'Patients per Treatment-Condition Evaluation', 'Pharma Drug Success Rate (Current System)', 'Total Number of Rare Diseases Globally', 'US Rare Disease Patients', 'Diseases Getting First Treatment Per Year', 'Patient Willingness to Participate in Clinical Trials', 'US Patients with Poorly Treated Common Diseases']
impacts_low = [152.92535444064595, -53.07597552657566, 39.309445772703995, -11.557177615571774, 12.761728521983486, 7.530607754827344, 7.766423357664237, 0.0]
impacts_high = [-50.198488923037516, 96.90724332201358, -23.473645726964435, 34.67153284671532, -17.32471749638293, -12.484605448920135, -7.011354420113548, 0.0]
