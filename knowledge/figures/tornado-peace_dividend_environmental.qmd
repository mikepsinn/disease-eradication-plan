...
drivers = ['GLOBAL_ANNUAL_ENVIRONMENTAL_DAMAGE_CONFLICT']
driver_labels = ['Annual Environmental Damage and Restoration Costs from Conflict']
impacts_low = [-300000000.0]
impacts_high = [400000000.0]
...
output_path = get_figure_output_path('tornado-peace_dividend_environmental.png')
