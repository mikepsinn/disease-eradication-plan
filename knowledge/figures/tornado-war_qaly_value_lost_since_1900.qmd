...
drivers = ['WAR_AVG_YEARS_LIFE_LOST_PER_DEATH', 'WAR_DEATHS_SINCE_1900', 'STANDARD_ECONOMIC_QALY_VALUE_USD']
driver_labels = ['Average Years of Life Lost per War Death', 'Total War and Conflict Deaths Since 1900', 'Standard Economic Value per QALY']
impacts_low = [-325500000000000.0, -445500000000000.0, -251100000000000.0]
impacts_high = [372000000000000.0, 121500000000000.0, 251100000000000.0]
...
output_path = get_figure_output_path('tornado-war_qaly_value_lost_since_1900.png')
