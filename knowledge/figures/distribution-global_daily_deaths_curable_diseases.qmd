```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Daily Deaths from Curable Diseases Globally"
...
output_path = project_root / 'knowledge' / 'figures' / 'distribution-global_daily_deaths_curable_diseases.png'
