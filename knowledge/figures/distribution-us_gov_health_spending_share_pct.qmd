```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Government Share of US Health Spending"
...
output_path = get_figure_output_path('distribution-us_gov_health_spending_share_pct.png')
