**Sensitivity Indices for Drug Treatment Administration Savings per Citizen per Year**
...
|:----------------|------------------------:|:---------------|
| Drug War Cost (USD) | 0.9995 | Strong driver |
| US Population in 2024 (people) | -0.0254 | Minimal effect |
