```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Life Extension from Treaty Research Acceleration"
...
output_path = get_figure_output_path('distribution-life_extension_years.png')
