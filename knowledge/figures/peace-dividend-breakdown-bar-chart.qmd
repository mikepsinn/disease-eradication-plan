...
savings_data = {
    ...
    'Savings ($B)': [
        float(GLOBAL_MILITARY_SPENDING_ANNUAL_2024) * TREATY_REDUCTION_PCT / BILLION,
        float(GLOBAL_ANNUAL_LOST_ECONOMIC_GROWTH_MILITARY_SPENDING) * TREATY_REDUCTION_PCT / BILLION,
        float(GLOBAL_ANNUAL_INFRASTRUCTURE_DESTRUCTION_CONFLICT) * TREATY_REDUCTION_PCT / BILLION,
        float(GLOBAL_ANNUAL_HUMAN_LIFE_LOSSES_CONFLICT) * TREATY_REDUCTION_PCT / BILLION,
        float(GLOBAL_ANNUAL_TRADE_DISRUPTION_CONFLICT) * TREATY_REDUCTION_PCT / BILLION,
        float(GLOBAL_ANNUAL_LOST_HUMAN_CAPITAL_CONFLICT) * TREATY_REDUCTION_PCT / BILLION,
        float(GLOBAL_ANNUAL_VETERAN_HEALTHCARE_COSTS) * TREATY_REDUCTION_PCT / BILLION,
        float(GLOBAL_ANNUAL_REFUGEE_SUPPORT_COSTS) * TREATY_REDUCTION_PCT / BILLION,
        float(GLOBAL_ANNUAL_ENVIRONMENTAL_DAMAGE_CONFLICT) * TREATY_REDUCTION_PCT / BILLION,
        float(GLOBAL_ANNUAL_PSYCHOLOGICAL_IMPACT_COSTS_CONFLICT) * TREATY_REDUCTION_PCT / BILLION
    ]
}
