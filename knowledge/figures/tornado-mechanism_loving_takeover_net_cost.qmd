...
baseline = 14446836000.0

# Tornado data from sensitivity analysis

drivers = ['MECHANISM_OPPORTUNITY_COST_RATE', 'DEFENSE_TAKEOVER_ACQUISITION_PREMIUM']
driver_labels = ['Mechanism Opportunity Cost Rate', 'Acquisition Premium Multiplier']
impacts_low = [-14446836000.0, -2407806000.0]
impacts_high = [21670254000.0, 9631224000.0]
...
output_path = get_figure_output_path('tornado-mechanism_loving_takeover_net_cost.png')
