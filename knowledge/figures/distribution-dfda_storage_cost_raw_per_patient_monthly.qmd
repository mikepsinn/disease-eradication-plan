```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Raw Storage Cost per Patient (Monthly)"
...
output_path = get_figure_output_path('distribution-dfda_storage_cost_raw_per_patient_monthly.png')
