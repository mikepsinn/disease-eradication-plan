```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Global Annual Productivity Loss from Disease"
...
output_path = project_root / 'knowledge' / 'figures' / 'distribution-global_disease_productivity_loss_annual.png'
