```{python}
#| echo: false
#| fig-cap: "Probability Distribution: RECOVERY Trial Global Lives Saved"
...
output_path = get_figure_output_path('distribution-recovery_trial_global_lives_saved.png')
