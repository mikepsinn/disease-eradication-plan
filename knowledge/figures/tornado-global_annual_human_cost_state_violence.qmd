...
drivers = ['GLOBAL_ANNUAL_CONFLICT_DEATHS_STATE_VIOLENCE', 'VALUE_OF_STATISTICAL_LIFE']
driver_labels = ['Annual Deaths from State Violence', 'Value of Statistical Life']
impacts_low = [-12000000000.0, -13500000000.0]
impacts_high = [23000000000.0, 13500000000.0]
...
output_path = get_figure_output_path('tornado-global_annual_human_cost_state_violence.png')
