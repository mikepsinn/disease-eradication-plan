```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Treaty Ratchet Terminal Redirect Share"
...
output_path = get_figure_output_path('distribution-treaty_ratchet_terminal_share.png')
