...
drivers = ['US_GOV_WASTE_REGULATORY_RED_TAPE', 'US_GOV_WASTE_TAX_COMPLIANCE']
driver_labels = ['Regulatory Red Tape Waste', 'Tax Compliance Waste']
impacts_low = [-290000000000.0, -96000000000.0]
impacts_high = [420000000000.0, 104000000000.0]
...
output_path = get_figure_output_path('tornado-us_gov_waste_category_2_compliance.png')
