```{python}
#| echo: false
#| fig-cap: "Probability Distribution: War-Redirect Medical Toolchain Bootstrap Years"
...
output_path = get_figure_output_path('distribution-war_trial_redirect_toolchain_bootstrap_years.png')
