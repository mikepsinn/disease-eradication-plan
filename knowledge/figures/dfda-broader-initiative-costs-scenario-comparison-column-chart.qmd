...
from dih_models.plotting.chart_style import (
    ...
    COLOR_BLACK, COLOR_WHITE, PATTERN_DIAGONAL, PATTERN_HORIZONTAL, PATTERN_DOTS, get_figure_output_path)
...
ax.set_title(
    'Costs for a Decentralized Drug Assessment Framework\nUpfront Investment by Scenario',
...
fig.text(
    0.5, 0.02,
    'Total Initiative Cost (excluding Core framework): Best Case $4.5M | Medium Case $213M | Worst Case $1.98B',
    ha='center', fontsize=16, style='italic', color=COLOR_BLACK
)

# --- Save figure ---

output_path = get_figure_output_path('dfda-broader-initiative-costs-scenario-comparison-column-chart.png')
...
add_png_metadata(
    output_path,
    title="Costs for a Decentralized Drug Assessment Framework by Scenario",
