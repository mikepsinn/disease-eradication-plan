...
drivers = ['TREATY_CAMPAIGN_BUDGET_LOBBYING', 'TREATY_CAMPAIGN_VIRAL_REFERENDUM_BASE_CASE', 'TREATY_CAMPAIGN_BUDGET_RESERVE']
driver_labels = ['Political Lobbying Campaign: Direct Lobbying, Super Pacs, Opposition Research, Staff, Legal/Compliance', 'Viral Referendum Budget', 'Reserve Fund / Contingency Buffer']
impacts_low = [1.309629629629629, 0.30222222222222195, 0.2365217391304344]
impacts_high = [-1.0715151515151518, -0.37517241379310384, -0.1295238095238096]
...
output_path = get_figure_output_path('tornado-victory_bond_annual_return_pct.png')
