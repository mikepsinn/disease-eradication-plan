```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Contingency Fund for Unexpected Costs"
...
output_path = project_root / 'knowledge' / 'figures' / 'distribution-campaign_contingency.png'
