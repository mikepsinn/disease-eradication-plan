```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Drug War Cost"
...
output_path = get_figure_output_path('distribution-bad_policy_cost_us_drug_war.png')
