...
drivers = ['GLOBAL_ANNUAL_TRADE_DISRUPTION_SHIPPING_CONFLICT', 'GLOBAL_ANNUAL_TRADE_DISRUPTION_SUPPLY_CHAIN_CONFLICT', 'GLOBAL_ANNUAL_TRADE_DISRUPTION_ENERGY_PRICE_CONFLICT', 'GLOBAL_ANNUAL_TRADE_DISRUPTION_CURRENCY_CONFLICT']
driver_labels = ['Annual Trade Disruption Costs from Shipping Disruptions', 'Annual Trade Disruption Costs from Supply Chain Disruptions', 'Annual Trade Disruption Costs from Energy Price Volatility', 'Annual Trade Disruption Costs from Currency Instability']
impacts_low = [-74100000000.0, -55800000000.0, -37700000000.0, -17400000000.0]
impacts_high = [98900000000.0, 75200000000.0, 50300000000.0, 22600000000.0]
...
output_path = get_figure_output_path('tornado-global_annual_trade_disruption_conflict.png')
