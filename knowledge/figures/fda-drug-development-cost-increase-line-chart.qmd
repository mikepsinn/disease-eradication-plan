...
from dih_models.plotting.chart_style import (
    ...
    COLOR_BLACK, COLOR_WHITE, get_figure_output_path, get_data_folder)
...
df_costs['Cost'] = df_costs['Cost to Develop 1 New Drug (Inflation Adjusted to 2020 USD)'].replace(r'[\$,]', '', regex=True)
...
efficacy_year = 1962  # Historical reference year (no parameter exists for this)
...
output_path = get_figure_output_path('fda-drug-development-cost-increase-line-chart.png')
