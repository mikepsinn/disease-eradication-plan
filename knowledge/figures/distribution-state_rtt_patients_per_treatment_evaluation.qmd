```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Patients per Treatment-Condition Evaluation"
...
output_path = get_figure_output_path('distribution-state_rtt_patients_per_treatment_evaluation.png')
