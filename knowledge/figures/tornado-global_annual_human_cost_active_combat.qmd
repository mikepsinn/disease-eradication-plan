...
drivers = ['VALUE_OF_STATISTICAL_LIFE', 'GLOBAL_ANNUAL_CONFLICT_DEATHS_ACTIVE_COMBAT']
driver_labels = ['Value of Statistical Life', 'Annual Deaths from Active Combat Worldwide']
impacts_low = [-1168000000000.0, -536000000000.0]
impacts_high = [1168000000000.0, 664000000000.0]
...
output_path = get_figure_output_path('tornado-global_annual_human_cost_active_combat.png')
