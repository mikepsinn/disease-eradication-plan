```{python}
#| echo: false
#| fig-cap: "Probability Distribution: EOS Stage 3 Lobbying-Sectors Terminal Value"
...
output_path = get_figure_output_path('distribution-eos_stage_3_lobbying_sectors_terminal_value.png')
