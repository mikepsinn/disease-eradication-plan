...
drivers = ['REGULATORY_DELAY_MEAN_AGE_OF_DEATH', 'EFFICACY_LAG_YEARS', 'GLOBAL_LIFE_EXPECTANCY_2024', 'GLOBAL_DISEASE_DEATHS_DAILY']
impacts_low = [1247557629.0, -862133325.0, -831705086.0, -353474659.0]
impacts_high = [-1247557629.0, 862133325.0, 831705086.0, 353474659.0]
...
output_path = project_root / 'knowledge' / 'figures' / 'tornado-disease_eradication_delay_yll.png'
