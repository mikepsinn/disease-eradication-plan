```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Wishonia Path Probability (Year 20 EV Model)"
...
output_path = get_figure_output_path('distribution-wishonia_path_success_probability_year_20.png')
