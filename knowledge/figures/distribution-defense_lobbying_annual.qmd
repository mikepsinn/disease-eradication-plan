```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Annual Defense Industry Lobbying Spending"
...
output_path = get_figure_output_path('distribution-defense_lobbying_annual.png')
