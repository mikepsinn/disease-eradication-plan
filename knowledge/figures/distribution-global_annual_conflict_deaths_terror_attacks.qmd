```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Annual Deaths from Terror Attacks Globally"
...
output_path = project_root / 'knowledge' / 'figures' / 'distribution-global_annual_conflict_deaths_terror_attacks.png'
