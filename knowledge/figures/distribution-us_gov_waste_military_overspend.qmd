```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Military Overspend"
...
output_path = get_figure_output_path('distribution-us_gov_waste_military_overspend.png')
