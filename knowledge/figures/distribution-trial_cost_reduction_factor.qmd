```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Cost Reduction Factor Demonstrated by Recovery Trial"
...
output_path = project_root / 'knowledge' / 'figures' / 'distribution-trial_cost_reduction_factor.png'
