...
drivers = ['SE_BOT_OBSERVER_MULTIPLIER', 'SE_BOT_OBSERVER_BELIEF_CHANGE_RATE', 'SE_BOT_LLM_COST_PER_POST_USD', 'SE_BOT_PLATFORM_OVERHEAD_PER_POST_USD', 'SE_BOT_TARGET_BELIEF_CHANGE_RATE']
driver_labels = ['Observer Multiplier', 'Observer Belief Change Rate', 'SE Bot LLM Cost Per Post', 'SE Bot Platform Overhead Per Post', 'Target Belief Change Rate']
impacts_low = [0.2, 0.2, -0.03333333333333333, -0.012499999999999997, 0.011764705882352941]
impacts_high = [-0.058823529411764705, -0.053763440860215055, 0.2, 0.15000000000000002, -0.026666666666666665]
...
output_path = get_figure_output_path('tornado-se_bot_cost_per_belief_change_usd.png')
