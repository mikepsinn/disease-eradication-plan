...
output_path = get_figure_output_path('conservative-baseline-lifetime-wealth-by-scenario-column-chart.png')
...
**Realistic estimates** using the Disease Eradication Model ({{< var trial_capacity_multiplier >}}× cumulative trial capacity, ALL diseases tackled):
