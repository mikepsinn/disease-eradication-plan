```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Annual Global Clinical Trial Participants"
...
output_path = project_root / 'knowledge' / 'figures' / 'distribution-current_trial_slots_available.png'
