```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Global Annual DALY Burden"
...
output_path = get_figure_output_path('distribution-global_annual_daly_burden.png')
