```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Current Global Clinical Trials per Year"
...
output_path = project_root / 'knowledge' / 'figures' / 'distribution-current_trials_per_year.png'
