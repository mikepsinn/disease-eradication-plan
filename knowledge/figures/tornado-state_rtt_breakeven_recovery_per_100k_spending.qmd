...
baseline = 0.1578048780487805

# Tornado data from sensitivity analysis

drivers = ['STATE_RTT_REGISTRY_ANNUAL_COST', 'STATE_RTT_CAMPAIGN_COST_PER_STATE', 'US_CHRONIC_DISEASE_SPENDING_ANNUAL', 'STATE_RTT_PHILANTHROPIC_FUNDING_YEARS']
driver_labels = ['National Outcome Registry Annual Operating Cost', 'Campaign Cost per State (Universal Right to Try + Data Amendment)', 'US Annual Chronic Disease Spending', 'Philanthropic Registry Funding Horizon']
impacts_low = [-0.07317073170731707, -0.023902439024390237, 0.03825572801182556, 0.03585365853658534]
impacts_high = [0.24390243902439027, 0.08365853658536584, -0.028404878048780474, -0.01792682926829267]
...
output_path = get_figure_output_path('tornado-state_rtt_breakeven_recovery_per_100k_spending.png')
