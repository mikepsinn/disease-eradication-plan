```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Patient Willingness to Participate in Clinical Trials"
...
output_path = get_figure_output_path('distribution-patient_willingness_trial_participation_pct.png')
