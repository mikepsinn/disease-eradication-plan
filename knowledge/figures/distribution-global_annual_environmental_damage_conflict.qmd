```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Annual Environmental Damage and Restoration Costs from Conflict"
...
output_path = project_root / 'knowledge' / 'figures' / 'distribution-global_annual_environmental_damage_conflict.png'
