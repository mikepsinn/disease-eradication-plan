...
drivers = ['GLOBAL_ANNUAL_PSYCHOLOGICAL_IMPACT_COSTS_CONFLICT']
driver_labels = ['Annual PTSD and Mental Health Costs from Conflict']
impacts_low = [-700000000.0]
impacts_high = [930000000.0]
...
output_path = get_figure_output_path('tornado-peace_dividend_ptsd.png')
