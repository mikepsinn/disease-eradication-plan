...
drivers = ['IMMIGRATION_PRICED_ENTRY_ANNUAL_VOLUME', 'US_SMUGGLER_FEE_AVG']
driver_labels = ['Priced-Entry Annual Volume', 'Average Smuggler Fee per US Border Crossing']
impacts_low = [-6937000000.0, -5874000000.0]
impacts_high = [20811000000.0, 14126000000.0]
...
output_path = get_figure_output_path('tornado-immigration_entry_revenue_annual.png')
