...
drivers = ['WISHONIA_TRAJECTORY_SUCCESS_PROBABILITY_YEAR_20']
driver_labels = ['Wishonia Trajectory Probability (Year 20 EV Model)']
impacts_low = [0.30000000000000004]
impacts_high = [-0.07999999999999996]
...
output_path = get_figure_output_path('tornado-moronia_trajectory_probability_year_20.png')
