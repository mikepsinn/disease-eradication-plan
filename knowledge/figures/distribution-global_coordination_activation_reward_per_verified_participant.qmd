```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Activation Reward per Verified Participant"
...
output_path = get_figure_output_path('distribution-global_coordination_activation_reward_per_verified_participant.png')
