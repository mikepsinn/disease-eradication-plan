...
drivers = ['VALUE_OF_STATISTICAL_LIFE', 'WAR_DEATHS_SINCE_1900', 'PHARMA_LIFE_YEARS_SAVED_ANNUAL', 'AVG_LIFE_EXTENSION_PER_BENEFICIARY', 'EFFICACY_LAG_YEARS', 'WAR_PROPERTY_DESTRUCTION_SINCE_1900', 'WAR_ENVIRONMENTAL_DESTRUCTION_SINCE_1900', 'WAR_TRIAL_REDIRECT_1900_FREEZE_BASELINE_ANNUAL']
driver_labels = ['Value of Statistical Life', 'Total War and Conflict Deaths Since 1900', 'Annual Life-Years Saved by Pharmaceuticals', 'Average Life Extension per Beneficiary', 'Regulatory Delay for Efficacy Testing Post-Safety Verification', 'Cumulative Property Destruction from War Since 1900', 'Cumulative Environmental Destruction from War Since 1900', '1900 Military Spending Freeze Baseline']
impacts_low = [-3.5580583333333336e+16, -1.1e+16, -4735500000000000.0, 5080583333333328.0, -2478333333333344.0, -150000000000000.0, -30000000000000.0, 18496118640064.0]
impacts_high = [3.5580583333333344e+16, 3000000000000000.0, 6225166666666656.0, -3387055555555568.0, 2478333333333328.0, 150000000000000.0, 50000000000000.0, -24705068900448.0]
...
output_path = get_figure_output_path('tornado-corporate_damages_state_farm_ceiling_exposure_total.png')
