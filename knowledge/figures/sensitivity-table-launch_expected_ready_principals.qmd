**Sensitivity Indices for Expected Ready Launch Principals**
...
|:----------------|------------------------:|:---------------|
| High-Alignment Lead Principals (people) | 0.7754 | Strong driver |
| Ready Probability per High-Alignment Principal (rate) | 0.4925 | Moderate driver |
