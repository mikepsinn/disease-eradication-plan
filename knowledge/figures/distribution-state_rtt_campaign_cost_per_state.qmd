```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Campaign Cost per State (Universal Right to Try + Data Amendment)"
...
output_path = get_figure_output_path('distribution-state_rtt_campaign_cost_per_state.png')
