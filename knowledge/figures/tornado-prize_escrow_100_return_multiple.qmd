...
drivers = ['PRIZE_ESCROW_YIELD_RATE']
driver_labels = ['Prize Escrow Annual Yield Rate']
impacts_low = [-0.5209607628106037]
impacts_high = [1.0932409347869032]
...
output_path = get_figure_output_path('tornado-prize_escrow_100_return_multiple.png')
