...
drivers = ['GLOBAL_LIFE_EXPECTANCY_2024']
driver_labels = ['Global Life Expectancy (2024)']
impacts_low = [2.0]
impacts_high = [-2.0]
...
output_path = get_figure_output_path('tornado-best_practice_life_expectancy_gain.png')
