```{python}
#| echo: false
#| fig-cap: "Probability Distribution: US Total Lobbying (2024)"
...
output_path = get_figure_output_path('distribution-us_total_lobbying_annual.png')
