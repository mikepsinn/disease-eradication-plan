```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Incarceration Excess Costs"
...
output_path = get_figure_output_path('distribution-bad_policy_cost_us_incarceration_excess.png')
