...
drivers = ['THALIDOMIDE_CASES_WORLDWIDE', 'THALIDOMIDE_DISABILITY_WEIGHT', 'THALIDOMIDE_SURVIVOR_LIFESPAN', 'THALIDOMIDE_US_POPULATION_SHARE_1960', 'THALIDOMIDE_MORTALITY_RATE']
driver_labels = ['Thalidomide Cases Worldwide', 'Thalidomide Disability Weight', 'Thalidomide Survivor Lifespan', 'US Population Share 1960', 'Thalidomide Mortality Rate']
impacts_low = [-4320.0, -2592.0, -2160.0, -1080.0, 1080.0]
impacts_high = [4320.0, 2592.0, 2160.0, 1080.0, -1079.9999999999982]
...
output_path = get_figure_output_path('tornado-thalidomide_yld_per_event.png')
