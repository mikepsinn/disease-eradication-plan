...
drivers = ['THALIDOMIDE_CASES_WORLDWIDE', 'THALIDOMIDE_DISABILITY_WEIGHT', 'THALIDOMIDE_SURVIVOR_LIFESPAN', 'THALIDOMIDE_MORTALITY_RATE', 'THALIDOMIDE_US_POPULATION_SHARE_1960']
impacts_low = [-4320.0, -2592.0, -2160.0, 1080.0, -1080.0]
impacts_high = [4320.0, 2592.0, 2160.0, -1080.0, 1080.0]
...
output_path = project_root / 'knowledge' / 'figures' / 'tornado-thalidomide_yld_per_event.png'
