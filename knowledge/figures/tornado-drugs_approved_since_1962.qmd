...
drivers = ['CURRENT_DRUG_APPROVALS_PER_YEAR']
driver_labels = ['Average Annual New Drug Approvals Globally']
impacts_low = [-310.0]
impacts_high = [620.0]
...
output_path = get_figure_output_path('tornado-drugs_approved_since_1962.png')
