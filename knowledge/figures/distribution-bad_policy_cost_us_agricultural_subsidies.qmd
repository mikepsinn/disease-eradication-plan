```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Agricultural Subsidies Deadweight Loss"
...
output_path = get_figure_output_path('distribution-bad_policy_cost_us_agricultural_subsidies.png')
