...
drivers = ['CURRENT_TRIAL_SLOTS_AVAILABLE', 'CURRENT_DISEASE_PATIENTS_GLOBAL', 'PATIENT_WILLINGNESS_TRIAL_PARTICIPATION_PCT']
driver_labels = ['Annual Global Clinical Trial Participants', 'Global Population with Chronic Diseases', 'Patient Willingness to Participate in Clinical Trials']
impacts_low = [150.90526315789464, -94.31578947368428, -60.631578947368496]
impacts_high = [-98.41647597254013, 94.31578947368416, 65.68421052631572]
...
output_path = get_figure_output_path('tornado-dfda_max_trial_capacity_multiplier_physical.png')
