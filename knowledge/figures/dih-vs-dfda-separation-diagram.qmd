```{python}
#| label: fig-dih-vs-dfda-separation
#| echo: false
...
# Your decentralized FDA cluster (Technical Platform)

with dot.subgraph(name='cluster_dfda') as dfda:
    dfda.attr(label='Your decentralized FDA:\nTechnical Protocol', style='solid', penwidth='3')
...
dot.node('Capture', 'If a framework gets captured:\nFund an alternative',
