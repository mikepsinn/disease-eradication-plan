...
drivers = ['POLITICAL_DYSFUNCTION_GLOBAL_MIGRATION_OPPORTUNITY_COST', 'POLITICAL_DYSFUNCTION_GLOBAL_HEALTH_OPPORTUNITY_COST', 'PRIZE_ESCROW_YIELD_RATE', 'GLOBAL_SAVINGS_RATE_PCT', 'POLITICAL_DYSFUNCTION_GLOBAL_SCIENCE_OPPORTUNITY_COST', 'POLITICAL_DYSFUNCTION_GLOBAL_LEAD_OPPORTUNITY_COST']
driver_labels = ['Global Migration Opportunity Cost', 'Global Health Opportunity Cost', 'Prize Escrow Annual Yield Rate', 'Global Gross Savings Rate', 'Global Science Opportunity Cost', 'Global Lead Poisoning Cost']
impacts_low = [0.0, -0.020895073318177804, 0.024149873692670243, 0.01884287861728534, -0.0029850104740253847, -0.0029850104740253847]
impacts_high = [0.16865309178243498, 0.06865524090258415, -0.03094322093383757, -0.015074302893828245, 0.008955031422076182, 0.0029850104740253847]
...
output_path = get_figure_output_path('tornado-prize_pool_target_pct_savings.png')
