...
drivers = ['SE_BOT_LLM_COST_PER_POST_USD', 'SE_BOT_PLATFORM_OVERHEAD_PER_POST_USD']
driver_labels = ['SE Bot LLM Cost Per Post', 'SE Bot Platform Overhead Per Post']
impacts_low = [-0.004, -0.0014999999999999996]
impacts_high = [0.024, 0.018000000000000002]
...
output_path = get_figure_output_path('tornado-se_bot_cost_per_post_usd.png')
