...
drivers = ['DFDA_PRAGMATIC_TRIAL_COST_PER_PATIENT', 'WAR_MEDICAL_TOOLCHAIN_PRIZE_BUDGET', 'GLOBAL_POPULATION_2024']
driver_labels = ['Pragmatic Trial Cost per Patient', 'War Medical Toolchain Prize Budget', 'Global Population in 2024']
impacts_low = [173.11597660714878, 2.0182992465016127, 0.5175126273081041]
impacts_high = [-13.932992465016149, -4.036598493003233, -0.49226810890283446]
...
units_label = "patient-slots/person"
if units_label:
...
output_path = get_figure_output_path('tornado-war_trial_redirect_patient_slots_per_living_human.png')
