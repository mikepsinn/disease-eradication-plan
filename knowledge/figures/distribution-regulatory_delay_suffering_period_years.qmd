```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Pre-Death Suffering Period During Post-Safety Efficacy Delay"
...
output_path = project_root / 'knowledge' / 'figures' / 'distribution-regulatory_delay_suffering_period_years.png'
