```{python}
#| echo: false
#| fig-cap: "Probability Distribution: P(Success | Loving Takeover Funded)"
...
output_path = get_figure_output_path('distribution-mechanism_loving_takeover_p_success.png')
