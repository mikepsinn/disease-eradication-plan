...
driver_labels = ['Annual Global Spending on Clinical Trials', 'Pragmatic Trial Cost per Patient', 'Phase 3 Cost per Patient', 'DIH Broader Initiatives Upfront Cost', 'DIH Broader Initiatives Annual OPEX', 'Pragmatic Trial Platform Core Framework Annual OPEX', 'Pragmatic Trial Platform Maintenance Costs', 'Pragmatic Trial Platform Staff Costs', 'Pragmatic Trial Platform Infrastructure Costs', 'Pragmatic Trial Platform Core Framework Build Cost', 'Pragmatic Trial Platform Regulatory Coordination Costs', 'Pragmatic Trial Platform Community Support Costs']
