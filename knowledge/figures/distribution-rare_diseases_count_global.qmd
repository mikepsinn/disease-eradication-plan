```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Total Number of Rare Diseases Globally"
...
output_path = get_figure_output_path('distribution-rare_diseases_count_global.png')
