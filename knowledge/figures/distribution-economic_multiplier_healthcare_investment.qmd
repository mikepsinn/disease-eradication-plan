```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Economic Multiplier for Healthcare Investment"
...
output_path = get_figure_output_path('distribution-economic_multiplier_healthcare_investment.png')
