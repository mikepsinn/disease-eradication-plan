```{python}
#| echo: false
#| fig-cap: "Probability Distribution: SE Bot Platform Overhead Per Post"
...
output_path = get_figure_output_path('distribution-se_bot_platform_overhead_per_post_usd.png')
