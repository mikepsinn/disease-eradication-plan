...
drivers = ['LAUNCH_REACH_PROBABILITY_HIGH_ALIGNMENT', 'LAUNCH_PERSUADE_PROBABILITY_GIVEN_REACHED', 'LAUNCH_EXECUTE_PROBABILITY_GIVEN_PERSUADED']
driver_labels = ['Reach Probability for High-Alignment Principals', 'Persuasion Rate Given Reach', 'Execution Rate Given Persuasion']
impacts_low = [-0.117, -0.11375, -0.10500000000000001]
impacts_high = [0.1365, 0.08124999999999999, 0.07500000000000001]
...
output_path = get_figure_output_path('tornado-launch_p_ready_per_high_alignment_principal.png')
