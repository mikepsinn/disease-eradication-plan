...
drivers = ['REGULATORY_DELAY_SUFFERING_PERIOD_YEARS', 'EFFICACY_LAG_YEARS', 'CHRONIC_DISEASE_DISABILITY_WEIGHT', 'GLOBAL_DISEASE_DEATHS_DAILY']
driver_labels = ['Pre-Death Suffering Period During Post-Safety Efficacy Delay', 'Regulatory Delay for Efficacy Testing Post-Safety Verification', 'Disability Weight for Untreated Chronic Conditions', 'Global Daily Deaths from Disease and Aging']
impacts_low = [-291096779.3007746, -212997643.0691713, -174658067.1009295, -43664515.87610376]
impacts_high = [436645171.94825697, 212997645.46684742, 174658069.49860585, 43664518.27377999]
...
output_path = get_figure_output_path('tornado-dfda_efficacy_lag_elimination_yld.png')
