```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Standard Time Horizon for NPV Analysis"
...
output_path = project_root / 'knowledge' / 'figures' / 'distribution-npv_time_horizon_years.png'
