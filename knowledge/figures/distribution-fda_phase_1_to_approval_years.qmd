```{python}
#| echo: false
#| fig-cap: "Probability Distribution: FDA Phase 1 to Approval Timeline"
...
output_path = project_root / 'knowledge' / 'figures' / 'distribution-fda_phase_1_to_approval_years.png'
