...
drivers = ['CURRENT_DISEASE_PATIENTS_GLOBAL', 'PATIENT_WILLINGNESS_TRIAL_PARTICIPATION_PCT']
driver_labels = ['Global Population with Chronic Diseases', 'Patient Willingness to Participate in Clinical Trials']
impacts_low = [-179200000.0, -115200000.0]
impacts_high = [179200000.0, 124800000.0]
...
output_path = get_figure_output_path('tornado-willing_trial_participants_global.png')
