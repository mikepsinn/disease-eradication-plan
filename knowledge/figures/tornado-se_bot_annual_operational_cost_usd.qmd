...
drivers = ['SE_BOT_RELEVANT_POSTS_PER_DAY_GLOBAL', 'SE_BOT_LLM_COST_PER_POST_USD', 'SE_BOT_PLATFORM_OVERHEAD_PER_POST_USD']
driver_labels = ['Relevant Posts Per Day (Global)', 'SE Bot LLM Cost Per Post', 'SE Bot Platform Overhead Per Post']
impacts_low = [-277400.0, -146000.0, -54749.99999999997]
impacts_high = [2628000.0, 876000.0, 657000.0000000001]
...
output_path = get_figure_output_path('tornado-se_bot_annual_operational_cost_usd.png')
