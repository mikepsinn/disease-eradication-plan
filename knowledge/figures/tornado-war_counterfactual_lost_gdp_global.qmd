...
drivers = ['WAR_COUNTERFACTUAL_ANNUAL_GROWTH_BOOST', 'GLOBAL_GDP_PER_CAPITA_1900', 'GLOBAL_POPULATION_2024']
driver_labels = ['Peace Growth Boost (8 Channels, Overlap-Corrected)', 'Global GDP per Capita in 1900', 'Global Population in 2024']
impacts_low = [-1815247355465484.0, -11519216582902.0, -1691417320586.0]
impacts_high = [5588271751217434.0, 9870394025041.5, 1651007432833.0]
...
output_path = get_figure_output_path('tornado-war_counterfactual_lost_gdp_global.png')
