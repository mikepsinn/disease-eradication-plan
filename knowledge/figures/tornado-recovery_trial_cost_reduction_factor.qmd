...
drivers = ['TRADITIONAL_PHASE3_COST_PER_PATIENT', 'RECOVERY_TRIAL_COST_PER_PATIENT']
driver_labels = ['Phase 3 Cost per Patient', 'Recovery Trial Cost per Patient']
impacts_low = [-42.0, 20.5]
impacts_high = [158.0, -65.6]
...
output_path = get_figure_output_path('tornado-recovery_trial_cost_reduction_factor.png')
