...
drivers = ['TRIAL_RELEVANT_DISEASES_COUNT', 'HUMAN_PROTEIN_CODING_GENES']
driver_labels = ['Trial-Relevant Diseases', 'Human Protein-Coding Genes']
impacts_low = [-4000000.0, -1000000.0]
impacts_high = [4000000.0, 1000000.0]
...
output_path = get_figure_output_path('tornado-gene_therapy_disease_combinations.png')
