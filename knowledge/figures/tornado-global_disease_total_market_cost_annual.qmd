...
drivers = ['GLOBAL_DISEASE_DIRECT_MEDICAL_COST_ANNUAL', 'GLOBAL_DISEASE_PRODUCTIVITY_LOSS_ANNUAL']
driver_labels = ['Global Annual Direct Medical Costs of Disease', 'Global Annual Productivity Loss from Disease']
impacts_low = [-2900000000000.0, -1500000000000.0]
impacts_high = [4100000000000.0, 2000000000000.0]
...
output_path = get_figure_output_path('tornado-global_disease_total_market_cost_annual.png')
