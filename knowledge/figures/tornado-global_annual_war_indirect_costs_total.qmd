...
drivers = ['GLOBAL_ANNUAL_LOST_ECONOMIC_GROWTH_MILITARY_SPENDING', 'GLOBAL_ANNUAL_LOST_HUMAN_CAPITAL_CONFLICT', 'GLOBAL_ANNUAL_PSYCHOLOGICAL_IMPACT_COSTS_CONFLICT', 'GLOBAL_ANNUAL_VETERAN_HEALTHCARE_COSTS', 'GLOBAL_ANNUAL_REFUGEE_SUPPORT_COSTS', 'GLOBAL_ANNUAL_ENVIRONMENTAL_DAMAGE_CONFLICT']
driver_labels = ['Annual Lost Economic Growth from Military Spending Opportunity Cost', 'Annual Lost Productivity from Conflict Casualties', 'Annual PTSD and Mental Health Costs from Conflict', 'Annual Veteran Healthcare Costs', 'Annual Refugee Support Costs', 'Annual Environmental Damage and Restoration Costs from Conflict']
impacts_low = [-818000000000.0, -90000000000.0, -70000000000.0, -60100000000.0, -45000000000.0, -30000000000.0]
impacts_high = [1082000000000.0, 120000000000.0, 93000000000.0, 79900000000.0, 60000000000.0, 40000000000.0]
...
output_path = get_figure_output_path('tornado-global_annual_war_indirect_costs_total.png')
