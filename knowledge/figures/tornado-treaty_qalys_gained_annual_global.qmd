...
drivers = ['GLOBAL_ANNUAL_CONFLICT_DEATHS_ACTIVE_COMBAT', 'STANDARD_QALYS_PER_LIFE_SAVED', 'GLOBAL_ANNUAL_CONFLICT_DEATHS_TERROR_ATTACKS', 'GLOBAL_ANNUAL_CONFLICT_DEATHS_STATE_VIOLENCE']
driver_labels = ['Annual Deaths from Active Combat Worldwide', 'Standard QALYs per Life Saved', 'Annual Deaths from Terror Attacks Globally', 'Annual Deaths from State Violence']
impacts_low = [-18760.0, -17122.0, -805.0, -420.0]
impacts_high = [23240.0, 17122.0, 1295.0, 805.0]
...
output_path = get_figure_output_path('tornado-treaty_qalys_gained_annual_global.png')
