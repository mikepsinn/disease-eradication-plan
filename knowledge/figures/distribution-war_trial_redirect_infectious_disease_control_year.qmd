```{python}
#| echo: false
#| fig-cap: "Probability Distribution: War-Redirect Infectious Disease Control Year"
...
output_path = get_figure_output_path('distribution-war_trial_redirect_infectious_disease_control_year.png')
