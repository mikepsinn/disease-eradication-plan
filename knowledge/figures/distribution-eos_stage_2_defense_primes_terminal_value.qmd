```{python}
#| echo: false
#| fig-cap: "Probability Distribution: EOS Stage 2 Defense-Primes Terminal Value"
...
output_path = get_figure_output_path('distribution-eos_stage_2_defense_primes_terminal_value.png')
