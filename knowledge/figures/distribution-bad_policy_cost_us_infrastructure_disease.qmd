```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Infrastructure Cost Disease"
...
output_path = get_figure_output_path('distribution-bad_policy_cost_us_infrastructure_disease.png')
