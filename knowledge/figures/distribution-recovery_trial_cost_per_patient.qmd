```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Recovery Trial Cost per Patient"
...
output_path = project_root / 'knowledge' / 'figures' / 'distribution-recovery_trial_cost_per_patient.png'
