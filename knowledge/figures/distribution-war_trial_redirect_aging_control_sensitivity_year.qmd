```{python}
#| echo: false
#| fig-cap: "Probability Distribution: War-Redirect Biological Aging Control Year (Sensitivity)"
...
output_path = get_figure_output_path('distribution-war_trial_redirect_aging_control_sensitivity_year.png')
