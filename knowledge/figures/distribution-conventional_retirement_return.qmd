```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Conventional Retirement Return (After Fees)"
...
output_path = get_figure_output_path('distribution-conventional_retirement_return.png')
