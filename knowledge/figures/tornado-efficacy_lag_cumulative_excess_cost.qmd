...
drivers = ['CURRENT_DRUG_APPROVALS_PER_YEAR', 'PHARMA_PHASE_2_3_COST_BARRIER']
driver_labels = ['Average Annual New Drug Approvals Globally', 'Pharma Phase 2/3 Cost Barrier Per Drug']
impacts_low = [-483600000000.0, -620000000000.0]
impacts_high = [967200000000.0, 620000000000.0]
...
output_path = get_figure_output_path('tornado-efficacy_lag_cumulative_excess_cost.png')
