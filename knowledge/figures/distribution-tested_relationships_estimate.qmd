```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Tested Drug-Disease Relationships"
...
output_path = get_figure_output_path('distribution-tested_relationships_estimate.png')
