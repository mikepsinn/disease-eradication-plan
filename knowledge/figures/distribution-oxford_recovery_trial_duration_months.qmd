```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Oxford RECOVERY Trial Duration"
...
output_path = project_root / 'knowledge' / 'figures' / 'distribution-oxford_recovery_trial_duration_months.png'
