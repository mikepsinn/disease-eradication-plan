...
drivers = ['US_POLITICAL_EFFORT_MULTIPLIER', 'POLITICIAN_POST_OFFICE_CAREER_VALUE', 'US_TOTAL_FEDERAL_CAMPAIGN_SPENDING_2024', 'US_TOTAL_LOBBYING_ANNUAL']
driver_labels = ['Political Effort Multiplier (US)', 'Post-Office Career Value (per politician)', 'US Federal Campaign Spending (2024)', 'US Total Lobbying (2024)']
impacts_low = [-8640000000.0, -2675000000.0, -1400000000.0, -924000000.0]
impacts_high = [14400000000.0, 5350000000.0, 1400000000.0, 924000000.0]
...
output_path = get_figure_output_path('tornado-us_political_reform_investment_total.png')
