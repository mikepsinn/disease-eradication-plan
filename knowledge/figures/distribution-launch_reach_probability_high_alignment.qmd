```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Reach Probability for High-Alignment Principals"
...
output_path = get_figure_output_path('distribution-launch_reach_probability_high_alignment.png')
