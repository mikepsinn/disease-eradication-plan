...
drivers = ['STATE_RTT_TREATMENT_DISCOVERY_MULTIPLIER', 'STATE_RTT_PHILANTHROPIC_COST_TOTAL', 'NEW_DISEASE_FIRST_TREATMENTS_PER_YEAR', 'EVENTUALLY_AVOIDABLE_DEATH_PCT', 'RARE_DISEASES_COUNT_GLOBAL', 'GLOBAL_DISEASE_DEATHS_DAILY']
driver_labels = ['Universal Right to Try with Evidence Treatment Discovery Multiplier', 'Universal Right to Try with Evidence Philanthropic Cost', 'Diseases Getting First Treatment Per Year', 'Eventually Avoidable Death Percentage', 'Total Number of Rare Diseases Globally', 'Global Daily Deaths from Disease and Aging']
...
output_path = get_figure_output_path('tornado-state_rtt_philanthropic_cost_per_life_saved.png')
