...
driver_labels = ['Universal State Right to Trial Treatment Discovery Multiplier', 'Universal State Right to Trial Philanthropic Cost', 'Diseases Getting First Treatment Per Year', 'Eventually Avoidable Death Percentage', 'Total Number of Rare Diseases Globally', 'Global Daily Deaths from Disease and Aging']
