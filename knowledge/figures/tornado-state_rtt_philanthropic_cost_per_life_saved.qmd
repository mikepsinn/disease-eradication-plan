...
driver_labels = ['Universal Right to Try with Evidence Treatment Discovery Multiplier', 'Universal Right to Try with Evidence Launch Cost', 'Diseases Getting First Treatment Per Year', 'Eventually Avoidable Death Percentage', 'Total Number of Rare Diseases Globally', 'Global Daily Deaths from Disease and Aging']
