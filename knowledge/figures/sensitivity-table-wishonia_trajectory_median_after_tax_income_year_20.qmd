...
|:----------------|------------------------:|:---------------|
| Wishonia Trajectory Average Income at Year 20 (USD) | 1.0801 | Strong driver |
| Global Median-to-Mean Income Ratio (ratio) | -0.0909 | Minimal effect |
| Median Income Relief from Full Disease Cure (rate) | -0.0051 | Minimal effect |
