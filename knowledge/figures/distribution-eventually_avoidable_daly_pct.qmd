```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Eventually Avoidable DALY Percentage"
...
output_path = get_figure_output_path('distribution-eventually_avoidable_daly_pct.png')
