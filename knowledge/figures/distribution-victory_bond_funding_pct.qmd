```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Percentage of Captured Dividend Funding Victory Bonds"
...
output_path = project_root / 'knowledge' / 'figures' / 'distribution-victory_bond_funding_pct.png'
