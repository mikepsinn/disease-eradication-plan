```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Percentage of Captured Dividend Funding VICTORY Incentive Alignment Bonds"
...
output_path = get_figure_output_path('distribution-victory_bond_funding_pct.png')
