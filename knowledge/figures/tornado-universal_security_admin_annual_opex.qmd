...
drivers = ['UNIVERSAL_SECURITY_ADMIN_ALL_IN_COST_PER_CITIZEN_ANNUAL', 'US_POPULATION_2024']
driver_labels = ['Universal Security Administration All-In Annual Cost per Citizen', 'US Population in 2024']
impacts_low = [-67000000.0, -1500000.0]
impacts_high = [234500000.0, 1500000.0]
...
output_path = get_figure_output_path('tornado-universal_security_admin_annual_opex.png')
