...
drivers = ['SAFE_COMPOUNDS_COUNT', 'CURRENT_TRIALS_PER_YEAR', 'TRIAL_RELEVANT_DISEASES_COUNT']
driver_labels = ['Safe Compounds Available for Testing', 'Current Global Clinical Trials per Year', 'Trial-Relevant Diseases']
impacts_low = [-6249621.212121213, 3418200.757575758, -2734560.6060606074]
impacts_high = [8143560.6060606055, -2278800.5050505064, 2734560.6060606055]
...
output_path = get_figure_output_path('tornado-current_combination_exploration_years.png')
