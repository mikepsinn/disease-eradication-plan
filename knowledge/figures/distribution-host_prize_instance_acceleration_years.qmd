```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Implementation Acceleration from One Prize Instance"
...
output_path = get_figure_output_path('distribution-host_prize_instance_acceleration_years.png')
