```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Universal Right to Try with Evidence Implementation Cost"
...
output_path = get_figure_output_path('distribution-state_rtt_implementation_cost_total.png')
