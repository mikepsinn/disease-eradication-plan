...
drivers = ['DFDA_PRAGMATIC_TRIAL_COST_PER_PATIENT', 'WAR_MEDICAL_TOOLCHAIN_PRIZE_BUDGET']
driver_labels = ['Pragmatic Trial Cost per Patient', 'War Medical Toolchain Prize Budget']
impacts_low = [1384927812857.1904, 16146393972.012909]
impacts_high = [-111463939720.12918, -32292787944.02585]
...
output_path = get_figure_output_path('tornado-war_trial_redirect_patient_slots_funded.png')
