```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Tariff Cost (GDP Loss)"
...
output_path = get_figure_output_path('distribution-bad_policy_cost_us_tariffs.png')
