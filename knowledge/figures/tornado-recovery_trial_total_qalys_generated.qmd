...
drivers = ['RECOVERY_TRIAL_GLOBAL_LIVES_SAVED', 'QALYS_PER_COVID_DEATH_AVERTED']
driver_labels = ['RECOVERY Trial Global Lives Saved', 'QALYs per COVID Death Averted']
impacts_low = [-2500000.0, -2000000.0]
impacts_high = [5000000.0, 5000000.0]
...
output_path = get_figure_output_path('tornado-recovery_trial_total_qalys_generated.png')
