...
drivers = ['POLITICAL_DYSFUNCTION_GLOBAL_MIGRATION_OPPORTUNITY_COST', 'POLITICAL_DYSFUNCTION_GLOBAL_HEALTH_OPPORTUNITY_COST', 'POLITICAL_DYSFUNCTION_GLOBAL_SCIENCE_OPPORTUNITY_COST', 'POLITICAL_DYSFUNCTION_GLOBAL_LEAD_OPPORTUNITY_COST']
driver_labels = ['Global Migration Opportunity Cost', 'Global Health Opportunity Cost', 'Global Science Opportunity Cost', 'Global Lead Poisoning Cost']
impacts_low = [-0.4521739130434783, -0.12173913043478268, -0.017391304347826098, -0.017391304347826098]
impacts_high = [0.9826086956521738, 0.3999999999999999, 0.05217391304347818, 0.017391304347826098]
...
output_path = get_figure_output_path('tornado-political_dysfunction_global_opportunity_cost_pct_gdp.png')
