```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Decentralized Framework for Drug Assessment Maintenance Costs"
...
output_path = get_figure_output_path('distribution-dfda_opex_platform_maintenance.png')
