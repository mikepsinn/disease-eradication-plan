```{python}
#| echo: false
#| fig-cap: "Probability Distribution: dFDA Platform Maintenance Costs"
...
output_path = project_root / 'knowledge' / 'figures' / 'distribution-dfda_opex_platform_maintenance.png'
