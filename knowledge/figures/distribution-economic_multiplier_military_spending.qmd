```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Economic Multiplier for Military Spending"
...
output_path = get_figure_output_path('distribution-economic_multiplier_military_spending.png')
