...
programs = [
    'Decentralized Drug Assessment Framework (Lean Ecosystem)',
    'Cancer Moonshot Initiative',
    'NIH "All of Us" Research Program',
    'National Cancer Institute (NCI)'
]
costs = [
    float(DFDA_NPV_ANNUAL_OPEX_TOTAL) / 1_000_000,  # Convert USD to millions (annual operating cost)
    257,  # Cancer Moonshot (no parameter exists)
    500,  # All of Us (no parameter exists)
    7200  # NCI (no parameter exists)
]  # in millions
...
# Highlight the decentralized framework with solid fill
...
ax.set_title(
    'Decentralized Drug Assessment Framework Cost vs. Other Federal Health Programs',
...
# Invert y-axis so the decentralized framework is at top
...
add_png_metadata(
    output_path,
    title="Cost of a Decentralized Drug Assessment Framework vs. Other Federal Health Programs",
    description="A decentralized drug assessment framework at $40M/year is 180x less than NCI and 12.5x less than the 'All of Us' research program."
)
