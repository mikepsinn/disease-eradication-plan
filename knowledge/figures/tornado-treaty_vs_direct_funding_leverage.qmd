...
driver_labels = ['dFDA Pragmatic Trial Cost per Patient', 'Political Lobbying Campaign: Direct Lobbying, Super Pacs, Opposition Research, Staff, Legal/Compliance', 'Diseases Getting First Treatment Per Year', 'Total Number of Rare Diseases Globally', 'Viral Referendum Budget', 'Annual Global Clinical Trial Participants', 'Reserve Fund / Contingency Buffer', 'Decentralized Framework for Drug Assessment Maintenance Costs', 'Decentralized Framework for Drug Assessment Staff Costs', 'Decentralized Framework for Drug Assessment Infrastructure Costs', 'Decentralized Framework for Drug Assessment Regulatory Coordination Costs', 'Decentralized Framework for Drug Assessment Community Support Costs', 'Eventually Avoidable DALY Percentage', 'Regulatory Delay for Efficacy Testing Post-Safety Verification', 'Global Annual DALY Burden']
