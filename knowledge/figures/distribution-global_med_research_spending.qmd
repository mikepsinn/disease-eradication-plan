```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Global Government Medical Research Spending"
...
output_path = project_root / 'knowledge' / 'figures' / 'distribution-global_med_research_spending.png'
