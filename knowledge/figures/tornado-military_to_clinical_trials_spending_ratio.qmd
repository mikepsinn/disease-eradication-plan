...
drivers = ['GLOBAL_CLINICAL_TRIALS_SPENDING_ANNUAL']
driver_labels = ['Annual Global Spending on Clinical Trials']
impacts_low = [9.066666666666663]
impacts_high = [-9.06666666666667]
...
output_path = get_figure_output_path('tornado-military_to_clinical_trials_spending_ratio.png')
