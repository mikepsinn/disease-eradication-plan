...
drivers = ['CHAIN_DISMISS_PROBABILITY']
driver_labels = ['Dismissal Rate']
impacts_low = [0.09999999999999998]
impacts_high = [-0.06999999999999995]
...
output_path = get_figure_output_path('tornado-chain_engage_probability.png')
