...
drivers = ['DFDA_PRAGMATIC_TRIAL_COST_PER_PATIENT', 'TRADITIONAL_PHASE3_COST_PER_PATIENT']
driver_labels = ['dFDA Pragmatic Trial Cost per Patient', 'Phase 3 Cost per Patient']
impacts_low = [0.020292682926829286, -0.023791463414634118]
impacts_high = [-0.05051219512195115, 0.014916869918699227]
...
output_path = get_figure_output_path('tornado-dfda_trial_cost_reduction_pct.png')
