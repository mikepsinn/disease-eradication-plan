...
drivers = ['PHARMA_LIFE_YEARS_SAVED_ANNUAL', 'AVG_LIFE_EXTENSION_PER_BENEFICIARY', 'EFFICACY_LAG_YEARS', 'STANDARD_ECONOMIC_QALY_VALUE_USD', 'REGULATORY_DELAY_MEAN_AGE_OF_DEATH', 'GLOBAL_LIFE_EXPECTANCY_REMAINING_AT_AGE_60']
driver_labels = ['Annual Life-Years Saved by Pharmaceuticals', 'Average Life Extension per Beneficiary', 'Regulatory Delay for Efficacy Testing Post-Safety Verification', 'Standard Economic Value per QALY', 'Mean Age of Preventable Death from Post-Safety Efficacy Delay', 'Remaining Life Expectancy at Age 60 (Global)']
impacts_low = [-134961750000000.0, 144796625000000.0, -70632500000000.06, -57918650000000.03, 45725250000000.0, -21338450000000.0]
impacts_high = [177417249999999.94, -96531083333333.38, 70632499999999.94, 57918650000000.0, -45725250000000.03, 15241749999999.938]
...
output_path = get_figure_output_path('tornado-existing_drugs_efficacy_lag_economic_loss.png')
