...
# Cocaine (UN estimates), VICTORY [Incentive Alignment Bonds](https://iab.warondisease.org) (../solution/incentive-alignment-bonds.qmd)
...
# White bars with black outline for comparison items, solid black for VICTORY [Incentive Alignment Bonds](https://iab.warondisease.org) (emphasis)
...
for i, (bar, ret) in enumerate(zip(bars, returns)):
    ...
    if i == len(returns) - 1:  # VICTORY [Incentive Alignment Bonds](https://iab.warondisease.org) - white text on black bar
