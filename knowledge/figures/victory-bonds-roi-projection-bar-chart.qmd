...
# Cocaine (UN estimates), VICTORY Incentive Alignment Bonds (../economics/victory-bonds.qmd)
...
# White bars with black outline for comparison items, solid black for VICTORY Incentive Alignment Bonds (emphasis)
...
for i, (bar, ret) in enumerate(zip(bars, returns)):
    ...
    if i == len(returns) - 1:  # VICTORY Incentive Alignment Bonds - white text on black bar
