```{python}
#| echo: false
#| fig-cap: "Probability Distribution: DIH Broader Initiatives Upfront Cost"
...
output_path = project_root / 'knowledge' / 'figures' / 'distribution-dih_npv_upfront_cost_initiatives.png'
