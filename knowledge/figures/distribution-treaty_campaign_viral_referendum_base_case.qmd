```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Viral Referendum Budget"
...
output_path = get_figure_output_path('distribution-treaty_campaign_viral_referendum_base_case.png')
