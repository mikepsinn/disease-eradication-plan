```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Average Annual New Drug Approvals Globally"
...
output_path = get_figure_output_path('distribution-current_drug_approvals_per_year.png')
