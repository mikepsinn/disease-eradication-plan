...
drivers = ['PRIZE_POOL_PARTICIPATION_RATE', 'VENTURE_GROSS_RETURN', 'SCALE_COMPRESSION_FACTOR', 'ALLOCATION_DECISION_SPREAD', 'HOME_BIAS_ALPHA']
driver_labels = ['PRIZE Pool Participation Rate', 'Venture Capital Gross Return', 'Scale Compression Factor', 'Allocation Decision Return Spread', 'Home Bias Return Drag']
impacts_low = [-30370638779999.535, -13684428983657.793, -9312747847984.676, -3211548308677.047, -2093028392935.5156]
impacts_high = [303706387799995.4, 29344271237642.977, 7080371485809.906, 4773906710121.711, 3147933694969.9297]
