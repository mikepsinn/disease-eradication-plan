...
drivers = ['GLOBAL_GOVERNMENT_CLINICAL_TRIALS_SPENDING_ANNUAL', 'GLOBAL_CLINICAL_TRIALS_SPENDING_ANNUAL']
driver_labels = ['Annual Global Government Spending on Clinical Trials', 'Annual Global Spending on Clinical Trials']
impacts_low = [6.666666666666666, -2.222222222222223]
impacts_high = [-3.333333333333334, 3.333333333333332]
...
output_path = get_figure_output_path('tornado-industry_vs_government_clinical_trials_spending_ratio.png')
