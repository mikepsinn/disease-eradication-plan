```{python}
#| echo: false
#| fig-cap: "Probability Distribution: GDP Growth Effect per National IQ Point"
...
output_path = get_figure_output_path('distribution-national_iq_gdp_growth_effect_per_point.png')
