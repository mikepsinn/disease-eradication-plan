...
baseline = 341.1513859275053

# Tornado data from sensitivity analysis

drivers = ['WAR_MEDICAL_TOOLCHAIN_PRIZE_BUDGET']
driver_labels = ['War Medical Toolchain Prize Budget']
impacts_low = [-255.863539445629]
impacts_high = [511.727078891258]
...
output_path = get_figure_output_path('tornado-war_medical_toolchain_prize_overpay_multiple.png')
