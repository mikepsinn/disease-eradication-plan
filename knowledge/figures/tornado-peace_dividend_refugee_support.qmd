...
drivers = ['GLOBAL_ANNUAL_REFUGEE_SUPPORT_COSTS']
driver_labels = ['Annual Refugee Support Costs']
impacts_low = [-450000000.0]
impacts_high = [600000000.0]
...
output_path = get_figure_output_path('tornado-peace_dividend_refugee_support.png')
