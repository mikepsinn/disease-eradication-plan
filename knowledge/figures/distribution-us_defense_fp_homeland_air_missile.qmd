```{python}
#| echo: false
#| fig-cap: "Probability Distribution: First-Principles Defense: Homeland Air & Missile Defense"
...
output_path = get_figure_output_path('distribution-us_defense_fp_homeland_air_missile.png')
