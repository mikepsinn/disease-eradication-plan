```{python}
#| echo: false
#| fig-cap: "Probability Distribution: First-Principles Defense: Nuclear Second Strike"
...
output_path = get_figure_output_path('distribution-us_defense_fp_nuclear_deterrent.png')
