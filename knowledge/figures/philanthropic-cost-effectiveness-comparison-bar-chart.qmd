...
#   - Peace: TREATY_QALYS_GAINED_ANNUAL_GLOBAL (85,610)
#   - dFDA: GLOBAL_DFDA_QALYS_GAINED_ANNUAL (74.15M)
#   - Total: TREATY_TOTAL_QALYS_GAINED_ANNUAL (74.23M)
# Peace dividend contribution and dFDA contribution sum to the total benefit
# But we'll show them as proportional contributions to the total -$5.87M

peace_qalys = float(TREATY_QALYS_GAINED_ANNUAL_GLOBAL)
dfda_qalys = float(GLOBAL_DFDA_QALYS_GAINED_ANNUAL)
