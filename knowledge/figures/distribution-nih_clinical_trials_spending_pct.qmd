```{python}
#| echo: false
#| fig-cap: "Probability Distribution: NIH Clinical Trials Spending Percentage"
...
output_path = get_figure_output_path('distribution-nih_clinical_trials_spending_pct.png')
