...
driver_labels = ['Diseases Getting First Treatment Per Year', 'Total Number of Rare Diseases Globally', 'dFDA Pragmatic Trial Cost per Patient', 'Annual Global Clinical Trial Participants', 'Decentralized Framework for Drug Assessment Maintenance Costs', 'Decentralized Framework for Drug Assessment Staff Costs', 'Decentralized Framework for Drug Assessment Infrastructure Costs', 'Decentralized Framework for Drug Assessment Regulatory Coordination Costs', 'Decentralized Framework for Drug Assessment Community Support Costs']
impacts_low = [178.1960932704113, -29.09323971761816, 16.133087783916523, 3.7924186617556757, 0.004145912230910653, 0.002487776362841032, 0.002487776362841032, 0.0016585939272033556, 0.0008293351430950224]
impacts_high = [-101.82633901166359, 87.27971915285454, -40.15820288520567, -3.7924186617556757, -0.00580748494004979, -0.004147821469786095, -0.003318104373420283, -0.002488463688820275, -0.0008294115126545876]
...
output_path = get_figure_output_path('tornado-dfda_trial_capacity_treatment_acceleration_years.png')
