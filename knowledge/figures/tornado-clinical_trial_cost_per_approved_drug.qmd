...
drivers = ['GLOBAL_CLINICAL_TRIALS_SPENDING_ANNUAL', 'CURRENT_DRUG_APPROVALS_PER_YEAR']
driver_labels = ['Annual Global Spending on Clinical Trials', 'Average Annual New Drug Approvals Globally']
impacts_low = [-200000000.0, 133333333.33333325]
impacts_high = [300000000.0, -200000000.0]
...
output_path = get_figure_output_path('tornado-clinical_trial_cost_per_approved_drug.png')
