```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Decentralized Census Bureau Annual Operating Cost"
...
output_path = get_figure_output_path('distribution-decentralized_census_bureau_annual_opex.png')
