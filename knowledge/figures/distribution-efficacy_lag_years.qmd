```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Regulatory Delay for Efficacy Testing Post-Safety Verification"
...
output_path = project_root / 'knowledge' / 'figures' / 'distribution-efficacy_lag_years.png'
