```{python}
#| echo: false
#| fig-cap: "Probability Distribution: GiveWell Midpoint of Modeled Cost per Life Saved Range"
...
output_path = get_figure_output_path('distribution-givewell_cost_per_life_avg.png')
