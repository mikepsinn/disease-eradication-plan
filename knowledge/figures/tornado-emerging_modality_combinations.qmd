...
drivers = ['TRIAL_RELEVANT_DISEASES_COUNT', 'HUMAN_PROTEIN_CODING_GENES', 'EPIGENETIC_TARGETS_COUNT', 'CELL_THERAPY_APPROACHES']
driver_labels = ['Trial-Relevant Diseases', 'Human Protein-Coding Genes', 'Epigenetic Drug Targets', 'Cell Therapy Approaches']
impacts_low = [-8400000.0, -2000000.0, -500000.0, -200000.0]
impacts_high = [8400000.0, 2000000.0, 500000.0, 300000.0]
...
output_path = get_figure_output_path('tornado-emerging_modality_combinations.png')
