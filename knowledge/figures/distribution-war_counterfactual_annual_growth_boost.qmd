```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Peace Growth Boost (8 Channels, Overlap-Corrected)"
...
output_path = get_figure_output_path('distribution-war_counterfactual_annual_growth_boost.png')
