...
drivers = ['US_GOV_WASTE_HEALTHCARE_INEFFICIENCY']
driver_labels = ['Healthcare System Inefficiency']
impacts_low = [-200000000000.0]
impacts_high = [300000000000.0]
...
output_path = get_figure_output_path('tornado-us_gov_waste_category_4_system.png')
