```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Annual PTSD and Mental Health Costs from Conflict"
...
output_path = project_root / 'knowledge' / 'figures' / 'distribution-global_annual_psychological_impact_costs_conflict.png'
