```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Diseases Getting First Treatment Per Year"
...
output_path = get_figure_output_path('distribution-new_disease_first_treatments_per_year.png')
