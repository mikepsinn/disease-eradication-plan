...
drivers = ['GLOBAL_CLINICAL_TRIALS_SPENDING_ANNUAL', 'TRIAL_COST_REDUCTION_PCT']
impacts_low = [-11500000000.0, -8300000000.0]
impacts_high = [13500000000.0, 12450000000.0]
...
output_path = get_figure_output_path('tornado-dfda_rd_gross_savings_annual.png')
