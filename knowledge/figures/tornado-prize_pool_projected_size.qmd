...
drivers = ['PRIZE_SAVINGS_SHARE', 'PRIZE_ESCROW_YIELD_RATE', 'GLOBAL_SAVINGS_RATE_PCT']
driver_labels = ['PRIZE Share of Global Savings', 'Prize Escrow Annual Yield Rate', 'Global Gross Savings Rate']
impacts_low = [-19430417583019.34, -2775543696980.043, -2233381331381.535]
impacts_high = [314906767724796.25, 5191762141012.332, 2233381331381.5312]
...
output_path = get_figure_output_path('tornado-prize_pool_projected_size.png')
