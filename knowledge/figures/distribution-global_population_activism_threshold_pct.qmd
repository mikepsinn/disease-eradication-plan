```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Critical Mass Threshold for Social Change"
...
output_path = project_root / 'knowledge' / 'figures' / 'distribution-global_population_activism_threshold_pct.png'
