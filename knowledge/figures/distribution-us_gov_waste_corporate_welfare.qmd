```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Corporate Welfare Waste"
...
output_path = get_figure_output_path('distribution-us_gov_waste_corporate_welfare.png')
