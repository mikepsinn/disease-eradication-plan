```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Shirt Cascade Probability Given Seed"
...
output_path = get_figure_output_path('distribution-shirt_cascade_probability_given_seed.png')
