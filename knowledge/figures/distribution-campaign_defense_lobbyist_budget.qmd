```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Budget for Co-Opting Defense Industry Lobbyists"
...
output_path = get_figure_output_path('distribution-campaign_defense_lobbyist_budget.png')
