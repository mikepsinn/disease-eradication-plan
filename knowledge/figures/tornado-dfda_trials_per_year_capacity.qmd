...
drivers = ['RECOVERY_TRIAL_COST_PER_PATIENT', 'CURRENT_TRIAL_SLOTS_AVAILABLE', 'CURRENT_TRIALS_PER_YEAR', 'GLOBAL_MILITARY_SPENDING_ANNUAL_2024', 'DFDA_OPEX_PLATFORM_MAINTENANCE', 'DFDA_OPEX_STAFF', 'DFDA_OPEX_INFRASTRUCTURE', 'DFDA_OPEX_REGULATORY', 'DFDA_OPEX_COMMUNITY']
impacts_low = [36357.0, 22622.0, -16967.0, -8504.0, 17.0, 10.0, 10.0, 7.0, 3.0]
impacts_high = [-24239.0, -14754.0, 16967.0, 8503.0, -24.0, -18.0, -14.0, -11.0, -4.0]
...
output_path = project_root / 'knowledge' / 'figures' / 'tornado-dfda_trials_per_year_capacity.png'
