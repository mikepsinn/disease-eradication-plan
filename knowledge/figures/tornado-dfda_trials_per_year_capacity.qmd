...
drivers = ['RECOVERY_TRIAL_COST_PER_PATIENT', 'CURRENT_TRIAL_SLOTS_AVAILABLE', 'CURRENT_TRIALS_PER_YEAR', 'DFDA_OPEX_PLATFORM_MAINTENANCE', 'DFDA_OPEX_STAFF', 'DFDA_OPEX_INFRASTRUCTURE', 'DFDA_OPEX_REGULATORY', 'DFDA_OPEX_COMMUNITY']
impacts_low = [32335.0, 20120.0, -15090.0, 17.0, 10.0, 10.0, 7.0, 3.0]
impacts_high = [-21557.0, -13122.0, 15090.0, -24.0, -17.0, -14.0, -10.0, -4.0]
