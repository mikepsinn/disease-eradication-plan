```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Moderate-High Estimate of Political Success Probability"
...
output_path = project_root / 'knowledge' / 'figures' / 'distribution-political_success_probability_moderate_high.png'
