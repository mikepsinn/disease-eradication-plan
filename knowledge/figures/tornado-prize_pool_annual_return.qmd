...
drivers = ['VENTURE_GROSS_RETURN', 'SCALE_COMPRESSION_FACTOR', 'ALLOCATION_DECISION_SPREAD', 'HOME_BIAS_ALPHA']
driver_labels = ['Venture Capital Gross Return', 'Scale Compression Factor', 'Allocation Decision Return Spread', 'Home Bias Return Drag']
impacts_low = [-0.04000000000000001, -0.025000000000000022, -0.007800000000000001, -0.0050000000000000044]
impacts_high = [0.04999999999999999, 0.014999999999999986, 0.010399999999999993, 0.0069999999999999785]
...
output_path = get_figure_output_path('tornado-prize_pool_annual_return.png')
