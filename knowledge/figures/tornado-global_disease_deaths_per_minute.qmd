...
drivers = ['GLOBAL_DISEASE_DEATHS_DAILY']
driver_labels = ['Global Daily Deaths from Disease and Aging']
impacts_low = [-5.208333333333343]
impacts_high = [5.208333333333329]
...
output_path = get_figure_output_path('tornado-global_disease_deaths_per_minute.png')
