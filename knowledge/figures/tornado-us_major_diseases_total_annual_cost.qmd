...
drivers = ['US_HEART_DISEASE_ANNUAL_COST', 'US_ALZHEIMERS_ANNUAL_COST', 'US_DIABETES_ANNUAL_COST', 'US_CANCER_ANNUAL_COST']
driver_labels = ['US Heart Disease Annual Cost', "US Alzheimer's Annual Cost", 'US Diabetes Annual Cost', 'US Cancer Annual Cost']
impacts_low = [-54000000000.0, -53000000000.0, -49000000000.0, -31000000000.0]
impacts_high = [54000000000.0, 53000000000.0, 49000000000.0, 31000000000.0]
...
output_path = get_figure_output_path('tornado-us_major_diseases_total_annual_cost.png')
