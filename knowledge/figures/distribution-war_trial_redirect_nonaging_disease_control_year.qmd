```{python}
#| echo: false
#| fig-cap: "Probability Distribution: War-Redirect Major Non-Aging Disease Control Year"
...
output_path = get_figure_output_path('distribution-war_trial_redirect_nonaging_disease_control_year.png')
