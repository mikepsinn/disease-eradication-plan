```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Annual Refugee Support Costs"
...
output_path = project_root / 'knowledge' / 'figures' / 'distribution-global_annual_refugee_support_costs.png'
