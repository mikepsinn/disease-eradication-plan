```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Mean Age of Preventable Death from Post-Safety Efficacy Delay"
...
output_path = project_root / 'knowledge' / 'figures' / 'distribution-regulatory_delay_mean_age_of_death.png'
