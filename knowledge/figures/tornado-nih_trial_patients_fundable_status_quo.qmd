...
drivers = ['TRADITIONAL_PHASE3_COST_PER_PATIENT', 'NIH_CLINICAL_TRIALS_SPENDING_PCT', 'NIH_ANNUAL_BUDGET']
driver_labels = ['Phase 3 Cost per Patient', 'NIH Clinical Trials Spending Percentage', 'NIH Annual Budget']
impacts_low = [39720.73170731707, -14902.439024390245, -1609.7560975609813]
impacts_high = [-24904.26829268293, 19487.80487804878, 2414.6341463414574]
...
output_path = get_figure_output_path('tornado-nih_trial_patients_fundable_status_quo.png')
