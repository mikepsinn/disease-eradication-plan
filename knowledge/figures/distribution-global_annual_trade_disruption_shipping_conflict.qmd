```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Annual Trade Disruption Costs from Shipping Disruptions"
...
output_path = project_root / 'knowledge' / 'figures' / 'distribution-global_annual_trade_disruption_shipping_conflict.png'
