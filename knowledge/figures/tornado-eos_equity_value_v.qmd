...
drivers = ['EOS_SOCIAL_VALUE_CAPTURE_PCT', 'POLITICAL_DYSFUNCTION_GLOBAL_MIGRATION_OPPORTUNITY_COST', 'POLITICAL_DYSFUNCTION_GLOBAL_HEALTH_OPPORTUNITY_COST', 'POLITICAL_DYSFUNCTION_GLOBAL_SCIENCE_OPPORTUNITY_COST', 'POLITICAL_DYSFUNCTION_GLOBAL_LEAD_OPPORTUNITY_COST']
driver_labels = ['EOS Social Value Capture Rate', 'Global Migration Opportunity Cost', 'Global Health Opportunity Cost', 'Global Science Opportunity Cost', 'Global Lead Poisoning Cost']
impacts_low = [-57233333333333.336, -38133333333333.34, -10266666666666.672, -1466666666666.6719, -1466666666666.6719]
impacts_high = [94266666666666.67, 82866666666666.67, 33733333333333.33, 4400000000000.0, 1466666666666.6719]
...
output_path = get_figure_output_path('tornado-eos_equity_value_v.png')
