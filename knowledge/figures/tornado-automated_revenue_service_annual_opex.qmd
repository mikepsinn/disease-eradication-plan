...
drivers = ['AUTOMATED_REVENUE_SERVICE_ALL_IN_COST_PER_TRANSACTION']
driver_labels = ['All-In Cost per Settlement Transaction']
impacts_low = [-100000000.0]
impacts_high = [350000000.0]
...
output_path = get_figure_output_path('tornado-automated_revenue_service_annual_opex.png')
