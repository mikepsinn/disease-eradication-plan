```{python}
#| echo: false
#| fig-cap: "Probability Distribution: FDA-Approved Unique Active Ingredients"
...
output_path = get_figure_output_path('distribution-fda_approved_unique_active_ingredients.png')
