```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Stage 1 Observational Analysis Cost per Patient"
...
output_path = get_figure_output_path('distribution-dfda_observational_cost_per_patient.png')
