...
baseline = 0.002862106229508197

# Tornado data from sensitivity analysis

drivers = ['DEFENSE_TAKEOVER_ACQUISITION_PREMIUM']
driver_labels = ['Acquisition Premium Multiplier']
impacts_low = [-0.00047701770491803295]
impacts_high = [0.001908070819672131]
...
output_path = get_figure_output_path('tornado-defense_takeover_pct_investable_assets.png')
