...
drivers = ['VOTE_PARTICIPATION_RATE', 'VENTURE_GROSS_RETURN', 'SCALE_COMPRESSION_FACTOR', 'ALLOCATION_DECISION_SPREAD', 'HOME_BIAS_ALPHA', 'GLOBAL_POPULATION_2024']
driver_labels = ['Expected Vote Participation Rate', 'Venture Capital Gross Return', 'Scale Compression Factor', 'Allocation Decision Return Spread', 'Home Bias Return Drag', 'Global Population in 2024']
impacts_low = [2904296.0581966774, -130862.02580000623, -89056.33187963488, -30711.527541993593, -20015.298839547264, 8274.347744150087]
impacts_high = [-184399.74972677312, 280614.6156605202, 67708.4704927177, 45652.113348158426, 30103.19107211684, -7870.721024923201]
...
output_path = get_figure_output_path('tornado-vote_token_potential_value.png')
