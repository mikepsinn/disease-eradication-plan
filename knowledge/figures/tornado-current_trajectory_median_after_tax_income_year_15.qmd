...
drivers = ['GALLUP_GLOBAL_MEDIAN_INCOME_PER_CAPITA', 'GLOBAL_MEDIAN_SHARE_EROSION_RATE_ANNUAL', 'GLOBAL_POPULATION_2024']
driver_labels = ['Gallup Global Median Per-Capita Income (2013, PPP)', 'Median Share Erosion Rate (Annual)', 'Global Population in 2024']
impacts_low = [-589.0318811317347, 215.5035781204424, -69.35375374615614]
impacts_high = [741.0401085205685, -307.4389601447647, 69.35375374615569]
...
output_path = get_figure_output_path('tornado-current_trajectory_median_after_tax_income_year_15.png')
