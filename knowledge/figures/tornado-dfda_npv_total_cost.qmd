...
drivers = ['DIH_NPV_UPFRONT_COST_INITIATIVES', 'DIH_NPV_ANNUAL_OPEX_INITIATIVES', 'DFDA_NPV_ANNUAL_OPEX', 'DFDA_NPV_UPFRONT_COST']
driver_labels = ['DIH Broader Initiatives Upfront Cost', 'DIH Broader Initiatives Annual OPEX', 'Decentralized Framework for Drug Assessment Core framework Annual OPEX', 'Decentralized Framework for Drug Assessment Core framework Build Cost']
impacts_low = [-79750000.0, -60564440.14110839, -67815112.55236793, -15000000.0]
impacts_high = [120250000.0, 92979210.9208566, 64403031.417657495, 25000000.0]
...
output_path = get_figure_output_path('tornado-dfda_npv_total_cost.png')
