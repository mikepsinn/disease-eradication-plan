```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Global-to-US Political Cost Ratio"
...
output_path = get_figure_output_path('distribution-global_to_us_political_cost_ratio.png')
