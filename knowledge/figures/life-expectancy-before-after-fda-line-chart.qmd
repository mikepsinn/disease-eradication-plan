...
output_path = get_figure_output_path('life-expectancy-before-after-fda-line-chart.png')
...
The trendlines tell the story: before 1962, life expectancy gains averaged 3.6 years per decade. After the efficacy requirement was added, gains dropped to 1.5 years per decade - a 58% reduction. The lighter 1938 line shows FDA creation, but the real impact came with the 1962 efficacy mandate. The flatter post-1962 trendline provides clear evidence of diminishing returns.
