...
drivers = ['VOTE_PARTICIPATION_RATE', 'GLOBAL_POPULATION_2024']
driver_labels = ['Expected Vote Participation Rate', 'Global Population in 2024']
impacts_low = [-2160000000.0, -60000000.0]
impacts_high = [3200000000.0, 60000000.0]
...
output_path = get_figure_output_path('tornado-vote_expected_participants.png')
