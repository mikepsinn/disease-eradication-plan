...
drivers = ['VALLEY_OF_DEATH_ATTRITION_PCT', 'CURRENT_DRUG_APPROVALS_PER_YEAR']
driver_labels = ['Valley of Death Attrition Rate', 'Average Annual New Drug Approvals Globally']
impacts_low = [-7.5, -2.0]
impacts_high = [7.5000000000000036, 4.0]
...
output_path = get_figure_output_path('tornado-additional_drugs_from_cost_elimination.png')
