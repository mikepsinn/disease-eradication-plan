```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Mature Market Annual Penetration Rate"
...
output_path = get_figure_output_path('distribution-state_rtt_mature_annual_penetration_pct.png')
