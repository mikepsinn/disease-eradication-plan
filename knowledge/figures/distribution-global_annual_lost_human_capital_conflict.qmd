```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Annual Lost Productivity from Conflict Casualties"
...
output_path = project_root / 'knowledge' / 'figures' / 'distribution-global_annual_lost_human_capital_conflict.png'
