...
- **dFDA Cost-Benefit**: `{python} roi_dfda_savings_only_formatted` ROI from `{python} dfda_annual_opex_formatted` platform saving `{python} dfda_rd_gross_savings_annual_formatted` in trial costs
- **Conservative Case**: Peace dividend + dFDA R&D savings = {{< var combined_peace_health_dividends_annual_for_roi_calc >}} annually, 463:1 ROI
