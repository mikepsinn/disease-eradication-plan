...
economic_impacts = pd.DataFrame({
    'Source': [
        ...
        'R&D Savings (Decentralized Trials, 82x cost reduction)',
        'Earlier Drug Access (7-year acceleration)',
        'Trial Capacity Expansion (25.7x capacity)',
        'Rare Disease Treatments',
        'Drug Price Reduction',
        'Prevention Economic Viability',
        'Mental Health Treatment Gap',
        'Combined Conservative (Peace + R&D Savings)',
...
fig.update_layout(
    title="Value Buildup to $1.2 Trillion in Annual Value (Complete Case)",
...
- **1% treaty Analysis**: {{< var peace_dividend_annual_societal_benefit >}} annual peace dividend from 1% military spending reduction ($11.36T total war costs × 1%)
- **Decentralized Trials Cost-Benefit**: `{python} roi_dfda_savings_only_formatted` ROI from a `{python} dfda_annual_opex_formatted` decentralized trial framework saving `{python} dfda_rd_gross_savings_annual_formatted` in trial costs
- **Conservative Case**: Peace dividend + R&D savings from decentralized trials = {{< var combined_peace_health_dividends_annual_for_roi_calc >}} annually, {{< var dfda_roi_rd_only >}} ROI
- **Complete Case**: All 8 benefit categories = $1,238.6B annually, 1,239:1 ROI

### Eight Benefit Categories (Complete Case)

1. **Peace Dividend**: {{< var peace_dividend_annual_societal_benefit >}} from 1% military spending reduction
2. **R&D Savings**: $50B from {{< var recovery_trial_cost_reduction_factor >}} cheaper pragmatic clinical trials
3. **Earlier Drug Access**: {{< var global_pharma_rd_spending_annual >}} from 7-year acceleration to market
4. **Trial Capacity Expansion**: $100B from {{< var dfda_trial_capacity_multiplier >}}× trial capacity
...
All calculations based on peer-reviewed sources and industry reports as of 2024-2025. See [1% treaty impact analysis](../economics/1-pct-treaty-impact.qmd) for detailed methodology.
