...
drivers = ['POLITICAL_DYSFUNCTION_GLOBAL_MIGRATION_OPPORTUNITY_COST', 'POLITICAL_DYSFUNCTION_GLOBAL_HEALTH_OPPORTUNITY_COST', 'POLITICAL_DYSFUNCTION_GLOBAL_SCIENCE_OPPORTUNITY_COST', 'GLOBAL_POPULATION_2024', 'POLITICAL_DYSFUNCTION_GLOBAL_LEAD_OPPORTUNITY_COST']
driver_labels = ['Global Migration Opportunity Cost', 'Global Health Opportunity Cost', 'Global Science Opportunity Cost', 'Global Population in 2024', 'Global Lead Poisoning Cost']
impacts_low = [-26000.0, -7000.0, -1000.0, 1294.8717948717967, -1000.0]
impacts_high = [56500.0, 23000.0, 3000.0, -1231.7073170731674, 1000.0]
...
output_path = get_figure_output_path('tornado-political_dysfunction_tax_per_household_of_four_annual.png')
