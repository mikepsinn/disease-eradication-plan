...
drivers = ['VALUE_OF_STATISTICAL_LIFE']
driver_labels = ['Value of Statistical Life']
impacts_low = [-1500000000000000.0]
impacts_high = [1500000000000000.0]
...
output_path = get_figure_output_path('tornado-corporate_damages_drugs_never_developed_vsl.png')
