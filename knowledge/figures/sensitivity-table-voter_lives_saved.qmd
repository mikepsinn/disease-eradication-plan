...
|:----------------|------------------------:|:---------------|
| Total Lives Saved from Elimination of Efficacy Lag Plus Earlier Treatment Discovery from Higher Trial Throughput (deaths) | 1.2606 | Strong driver |
| Target Voting Bloc Size for Campaign (of people) | 0.2759 | Weak driver |
