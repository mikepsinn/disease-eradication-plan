...
drivers = ['GLOBAL_ANNUAL_LOST_ECONOMIC_GROWTH_MILITARY_SPENDING']
driver_labels = ['Annual Lost Economic Growth from Military Spending Opportunity Cost']
impacts_low = [-8180000000.0]
impacts_high = [10820000000.0]
...
output_path = get_figure_output_path('tornado-peace_dividend_lost_economic_growth.png')
