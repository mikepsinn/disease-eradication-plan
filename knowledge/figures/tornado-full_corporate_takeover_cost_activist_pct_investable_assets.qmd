...
baseline = 0.002898032786885246

# Tornado data from sensitivity analysis

drivers = ['INFLUENCE_ACTIVIST_STAKE_FRACTION', 'GOV_CONTROLLING_SECTORS_TOP5_MARKET_CAP']
driver_labels = ['Activist Stake Fraction', 'Government-Controlling Sectors Top-5 Market Cap']
impacts_low = [-0.0023184262295081965, -0.0002803278688524591]
impacts_high = [0.002898032786885246, 0.00021147540983606572]
...
output_path = get_figure_output_path('tornado-full_corporate_takeover_cost_activist_pct_investable_assets.png')
