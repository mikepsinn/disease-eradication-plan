```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Cost Reduction When Effectively Treated"
...
output_path = get_figure_output_path('distribution-state_rtt_treated_cost_reduction_pct.png')
