...
# Explicitly convert to native Python float and scale to billions for chart

military_total = float(GLOBAL_MILITARY_SPENDING_ANNUAL_2024) / 1e9  # Convert from dollars to billions
cure_spending = float(GLOBAL_MED_RESEARCH_SPENDING) / 1e9  # Convert from dollars to billions
