...
# Explicitly convert to native Python float to avoid Parameter repr in labels

military_total = float.__new__(float, GLOBAL_MILITARY_SPENDING_ANNUAL_2024)
cure_spending = float.__new__(float, GLOBAL_MED_RESEARCH_SPENDING)
