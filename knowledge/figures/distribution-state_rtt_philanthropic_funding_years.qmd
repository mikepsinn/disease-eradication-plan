```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Philanthropic Registry Funding Horizon"
...
output_path = get_figure_output_path('distribution-state_rtt_philanthropic_funding_years.png')
