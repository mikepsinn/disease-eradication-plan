```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Annual Veteran Healthcare Costs"
...
output_path = project_root / 'knowledge' / 'figures' / 'distribution-global_annual_veteran_healthcare_costs.png'
