...
drivers = ['VALUE_OF_STATISTICAL_LIFE', 'WAR_DEATHS_SINCE_1900']
driver_labels = ['Value of Statistical Life', 'Total War and Conflict Deaths Since 1900']
impacts_low = [-1550000000000000.0, -1100000000000000.0]
impacts_high = [1550000000000000.0, 300000000000000.0]
...
output_path = get_figure_output_path('tornado-corporate_damages_war_deaths_vsl.png')
