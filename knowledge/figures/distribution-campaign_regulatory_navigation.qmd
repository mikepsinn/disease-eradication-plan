```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Regulatory Compliance and Navigation"
...
output_path = get_figure_output_path('distribution-campaign_regulatory_navigation.png')
