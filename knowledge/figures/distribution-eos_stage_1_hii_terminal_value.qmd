```{python}
#| echo: false
#| fig-cap: "Probability Distribution: EOS Stage 1 HII Terminal Value"
...
output_path = get_figure_output_path('distribution-eos_stage_1_hii_terminal_value.png')
