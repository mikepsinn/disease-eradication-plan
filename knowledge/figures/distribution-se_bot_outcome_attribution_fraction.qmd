```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Special Education Outcome Attribution Fraction"
...
output_path = get_figure_output_path('distribution-se_bot_outcome_attribution_fraction.png')
