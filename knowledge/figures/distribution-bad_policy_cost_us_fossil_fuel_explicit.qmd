```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Fossil Fuel Explicit Subsidies"
...
output_path = get_figure_output_path('distribution-bad_policy_cost_us_fossil_fuel_explicit.png')
