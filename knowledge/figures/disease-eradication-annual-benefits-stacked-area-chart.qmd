...
from dih_models.plotting.chart_style import (
    ...
    PATTERN_CROSS, get_project_root, get_figure_output_path)
...
ax.fill_between(years, cumulative_caregiver/1000000, cumulative_gdp/1000000,
                label='Economic Growth (Military→Research)', color=COLOR_WHITE,
                edgecolor=COLOR_BLACK, linewidth=1, hatch='\\\\\\\\')
...
ax.axvline(x=80, color=COLOR_BLACK, linewidth=2, linestyle='--', alpha=0.7, zorder=10)
ax.text(80, ax.get_ylim()[1] * 0.95, 'You Would Die Here\n(Without Treaty)',
        ha='center', va='top', fontsize=16, weight='bold', color=COLOR_BLACK,
        bbox=dict(boxstyle='round,pad=0.4', facecolor=COLOR_WHITE,
                 edgecolor=COLOR_BLACK, linewidth=2))

ax.axvline(x=100, color=COLOR_BLACK, linewidth=1.5, linestyle=':', alpha=0.5)
ax.text(100, ax.get_ylim()[1] * 0.85, 'Age 100',
        ha='center', va='top', fontsize=14, style='italic', color=COLOR_BLACK)

ax.axvline(x=120, color=COLOR_BLACK, linewidth=1.5, linestyle=':', alpha=0.5)
...
ax.annotate(f'Total: ${final_value/1000000:.1f}M',
            ...
            fontsize=22, weight='bold', color=COLOR_BLACK,
...
ax.legend(loc='upper left', fontsize=14, frameon=True, edgecolor=COLOR_BLACK,
          facecolor=COLOR_WHITE, framealpha=0.95, ncol=1)
...
output_path = get_figure_output_path('disease-eradication-annual-benefits-stacked-area-chart.png')
