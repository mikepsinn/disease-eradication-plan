```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Annual DALY Gain per Patient on an Eventually-Effective Treatment"
...
output_path = get_figure_output_path('distribution-state_rtt_effective_treatment_daly_gain.png')
