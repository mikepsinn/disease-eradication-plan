...
drivers = ['TREATMENT_DISABILITY_REDUCTION', 'EFFICACY_LAG_YEARS', 'GLOBAL_CHRONIC_THERAPY_DAYS_ANNUAL']
driver_labels = ['Treatment Disability Reduction', 'Regulatory Delay for Efficacy Testing Post-Safety Verification', 'Annual Days of Chronic Disease Therapy']
impacts_low = [-805172602.7397261, -490958904.1095891, -440328767.1232877]
impacts_high = [805172602.7397258, 490958904.10958886, 345972602.7397258]
...
output_path = get_figure_output_path('tornado-efficacy_lag_treatment_delay_yld_annual.png')
