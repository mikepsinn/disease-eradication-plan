...
drivers = ['RARE_DISEASES_COUNT_GLOBAL']
driver_labels = ['Total Number of Rare Diseases Globally']
impacts_low = [-950.0]
impacts_high = [2850.0]
...
output_path = get_figure_output_path('tornado-diseases_without_effective_treatment.png')
