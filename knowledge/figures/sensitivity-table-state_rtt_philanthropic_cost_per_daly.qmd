**Sensitivity Indices for Universal State Right to Trial Philanthropic Cost per DALY**
...
|:----------------|------------------------:|:---------------|
| Universal State Right to Trial Philanthropic Cost (USD) | 0.5604 | Strong driver |
| DALYs Averted from Universal State Right to Trial (DALYs) | -0.4511 | Moderate driver |
