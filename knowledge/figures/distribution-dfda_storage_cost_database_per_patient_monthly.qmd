```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Database Cost per Patient (Monthly)"
...
output_path = get_figure_output_path('distribution-dfda_storage_cost_database_per_patient_monthly.png')
