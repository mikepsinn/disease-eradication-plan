```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Healthcare System Inefficiency"
...
output_path = get_figure_output_path('distribution-bad_policy_cost_us_healthcare_inefficiency.png')
