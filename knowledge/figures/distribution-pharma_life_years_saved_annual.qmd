```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Annual Life-Years Saved by Pharmaceuticals"
...
output_path = get_figure_output_path('distribution-pharma_life_years_saved_annual.png')
