...
drivers = ['THALIDOMIDE_CASES_WORLDWIDE', 'THALIDOMIDE_MORTALITY_RATE', 'THALIDOMIDE_US_POPULATION_SHARE_1960']
driver_labels = ['Thalidomide Cases Worldwide', 'Thalidomide Mortality Rate', 'US Population Share 1960']
impacts_low = [-9600.0, -3600.0, -2400.0]
impacts_high = [9600.0, 3600.0, 2400.0]
...
output_path = get_figure_output_path('tornado-thalidomide_yll_per_event.png')
