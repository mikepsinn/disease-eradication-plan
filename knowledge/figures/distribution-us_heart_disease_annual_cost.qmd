```{python}
#| echo: false
#| fig-cap: "Probability Distribution: US Heart Disease Annual Cost"
...
output_path = project_root / 'knowledge' / 'figures' / 'distribution-us_heart_disease_annual_cost.png'
