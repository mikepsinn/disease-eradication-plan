```{python}
#| echo: false
#| fig-cap: "Probability Distribution: US Patients with Poorly Treated Common Diseases"
...
output_path = get_figure_output_path('distribution-state_rtt_us_patients_common_poorly_treated.png')
