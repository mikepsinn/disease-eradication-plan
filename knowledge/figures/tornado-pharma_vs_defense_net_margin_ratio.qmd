...
baseline = 3.7154308617234473

# Tornado data from sensitivity analysis

drivers = ['DEFENSE_NET_PROFIT_MARGIN', 'PHARMA_NET_PROFIT_MARGIN']
driver_labels = ['Aerospace/Defense Net Profit Margin', 'Pharmaceutical Net Profit Margin']
impacts_low = [0.9195691382765525, -0.7094188376753512]
impacts_high = [-0.625430861723447, 0.6933867735470938]
...
output_path = get_figure_output_path('tornado-pharma_vs_defense_net_margin_ratio.png')
