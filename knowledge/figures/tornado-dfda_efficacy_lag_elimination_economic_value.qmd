...
drivers = ['EFFICACY_LAG_YEARS', 'STANDARD_ECONOMIC_QALY_VALUE_USD', 'REGULATORY_DELAY_MEAN_AGE_OF_DEATH', 'GLOBAL_LIFE_EXPECTANCY_REMAINING_AT_AGE_60', 'GLOBAL_DISEASE_DEATHS_DAILY', 'REGULATORY_DELAY_SUFFERING_PERIOD_YEARS', 'CHRONIC_DISEASE_DISABILITY_WEIGHT']
driver_labels = ['Regulatory Delay for Efficacy Testing Post-Safety Verification', 'Standard Economic Value per QALY', 'Mean Age of Preventable Death from Post-Safety Efficacy Delay', 'Remaining Life Expectancy at Age 60 (Global)', 'Global Daily Deaths from Disease and Aging', 'Pre-Death Suffering Period During Post-Safety Efficacy Delay', 'Disability Weight for Untreated Chronic Conditions']
impacts_low = [-321017876339965.4, -263234658273543.75, 187133646413714.0, -87329032343063.5, -65808663213270.75, -43664515268121.75, -26198708438145.0]
impacts_high = [321017879953605.75, 263234661887184.25, -187133642800073.5, 62377883342451.5, 65808666826911.25, 65496777419233.0, 26198712051785.25]
...
output_path = get_figure_output_path('tornado-dfda_efficacy_lag_elimination_economic_value.png')
