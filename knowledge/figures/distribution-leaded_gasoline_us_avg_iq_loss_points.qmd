```{python}
#| echo: false
#| fig-cap: "Probability Distribution: US Average IQ Loss from Leaded Gasoline"
...
output_path = get_figure_output_path('distribution-leaded_gasoline_us_avg_iq_loss_points.png')
