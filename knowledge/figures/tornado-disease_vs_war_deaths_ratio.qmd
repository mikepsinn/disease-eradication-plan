...
drivers = ['GLOBAL_ANNUAL_CONFLICT_DEATHS_ACTIVE_COMBAT', 'GLOBAL_ANNUAL_DEATHS_CURABLE_DISEASES', 'GLOBAL_ANNUAL_CONFLICT_DEATHS_TERROR_ATTACKS', 'GLOBAL_ANNUAL_CONFLICT_DEATHS_STATE_VIOLENCE']
driver_labels = ['Annual Deaths from Active Combat Worldwide', 'Annual Deaths from All Diseases and Aging Globally', 'Annual Deaths from Terror Attacks Globally', 'Annual Deaths from State Violence']
impacts_low = [63.10120594367129, -20.441537203597704, 2.134423818617506, 1.1085796675739346]
impacts_high = [-48.008034641504054, 20.441537203597733, -3.350666790923981, -2.0946573157189903]
...
output_path = get_figure_output_path('tornado-disease_vs_war_deaths_ratio.png')
