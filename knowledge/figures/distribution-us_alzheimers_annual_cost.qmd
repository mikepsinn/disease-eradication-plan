```{python}
#| echo: false
#| fig-cap: "Probability Distribution: US Alzheimer's Annual Cost"
...
output_path = project_root / 'knowledge' / 'figures' / 'distribution-us_alzheimers_annual_cost.png'
