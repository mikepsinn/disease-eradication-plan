```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Median Income Relief from Full Disease Cure"
...
output_path = get_figure_output_path('distribution-median_health_burden_relief_share.png')
