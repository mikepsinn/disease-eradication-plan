...
drivers = ['WAR_TRIAL_REDIRECT_1900_FREEZE_BASELINE_ANNUAL']
driver_labels = ['1900 Military Spending Freeze Baseline']
impacts_low = [1849611864005.9375]
impacts_high = [-2470506890043.547]
...
output_path = get_figure_output_path('tornado-war_trial_redirect_excess_military_spending_above_1900_freeze.png')
