```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Phase 2/3 Share of Clinical Trial Costs"
...
output_path = get_figure_output_path('distribution-phase_2_3_clinical_trial_cost_pct.png')
