**Sensitivity Indices for Universal State Right to Trial Cost in FDA Budget Hours**
...
|:----------------|------------------------:|:---------------|
| Universal State Right to Trial Philanthropic Cost (USD) | 1.0000 | Strong driver |
