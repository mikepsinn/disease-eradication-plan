```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Acquisition Premium Multiplier"
...
output_path = get_figure_output_path('distribution-defense_takeover_acquisition_premium.png')
