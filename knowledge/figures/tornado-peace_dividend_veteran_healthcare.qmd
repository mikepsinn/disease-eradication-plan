...
drivers = ['GLOBAL_ANNUAL_VETERAN_HEALTHCARE_COSTS']
driver_labels = ['Annual Veteran Healthcare Costs']
impacts_low = [-601000000.0]
impacts_high = [799000000.0]
...
output_path = get_figure_output_path('tornado-peace_dividend_veteran_healthcare.png')
