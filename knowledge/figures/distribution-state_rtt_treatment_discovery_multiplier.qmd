```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Universal Right to Try with Evidence Treatment Discovery Multiplier"
...
output_path = get_figure_output_path('distribution-state_rtt_treatment_discovery_multiplier.png')
