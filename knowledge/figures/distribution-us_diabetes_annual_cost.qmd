```{python}
#| echo: false
#| fig-cap: "Probability Distribution: US Diabetes Annual Cost"
...
output_path = project_root / 'knowledge' / 'figures' / 'distribution-us_diabetes_annual_cost.png'
