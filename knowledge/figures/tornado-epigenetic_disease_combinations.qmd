...
drivers = ['EPIGENETIC_TARGETS_COUNT', 'TRIAL_RELEVANT_DISEASES_COUNT']
driver_labels = ['Epigenetic Drug Targets', 'Trial-Relevant Diseases']
impacts_low = [-500000.0, -300000.0]
impacts_high = [500000.0, 300000.0]
...
output_path = get_figure_output_path('tornado-epigenetic_disease_combinations.png')
