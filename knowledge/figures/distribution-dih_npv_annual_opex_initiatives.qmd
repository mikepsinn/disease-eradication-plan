```{python}
#| echo: false
#| fig-cap: "Probability Distribution: DIH Broader Initiatives Annual OPEX"
...
output_path = project_root / 'knowledge' / 'figures' / 'distribution-dih_npv_annual_opex_initiatives.png'
