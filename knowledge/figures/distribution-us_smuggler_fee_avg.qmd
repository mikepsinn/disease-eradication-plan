```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Average Smuggler Fee per US Border Crossing"
...
output_path = get_figure_output_path('distribution-us_smuggler_fee_avg.png')
