```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Reserve Fund / Contingency Buffer"
...
output_path = project_root / 'knowledge' / 'figures' / 'distribution-treaty_campaign_budget_reserve.png'
