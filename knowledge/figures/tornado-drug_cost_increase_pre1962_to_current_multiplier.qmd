...
drivers = ['PRE_1962_DRUG_DEVELOPMENT_COST', 'PHARMA_DRUG_DEVELOPMENT_COST_CURRENT']
impacts_low = [208.0, -22.0]
impacts_high = [0.0, 28.0]
...
output_path = project_root / 'knowledge' / 'figures' / 'tornado-drug_cost_increase_pre1962_to_current_multiplier.png'
