...
drivers = ['US_DEFENSE_FP_MOBILIZATION_HEDGE', 'US_DEFENSE_FP_NUCLEAR_DETERRENT', 'US_DEFENSE_FP_HOMELAND_AIR_MISSILE', 'US_DEFENSE_FP_NATIONAL_GUARD', 'US_DEFENSE_FP_CYBER', 'US_DEFENSE_FP_COAST_GUARD']
driver_labels = ['First-Principles Defense: Mobilization Hedge', 'First-Principles Defense: Nuclear Second Strike', 'First-Principles Defense: Homeland Air & Missile Defense', 'First-Principles Defense: National Guard', 'First-Principles Defense: Cyber Defense', 'First-Principles Defense: Coast Guard']
impacts_low = [0.02257336343115124, 0.011286681715575675, 0.011286681715575675, 0.006772009029345383, 0.0056433408577878375, 0.0022573363431150906]
impacts_high = [-0.04514672686230248, -0.02257336343115124, -0.0169300225733634, -0.011286681715575564, -0.011286681715575564, -0.0022573363431150906]
...
output_path = get_figure_output_path('tornado-us_defense_first_principles_cut_pct.png')
