...
from dih_models.parameters import (
    TREATY_ROI_TRIAL_CAPACITY_PLUS_EFFICACY_LAG,  # PRIMARY: R&D + efficacy lag elimination
...
base_roi = float(TREATY_ROI_TRIAL_CAPACITY_PLUS_EFFICACY_LAG)  # PRIMARY: R&D + efficacy lag elimination
cost_reduction_factor = cost_reduction_samples / (float(DFDA_TRIAL_COST_REDUCTION_PCT) / 100)
