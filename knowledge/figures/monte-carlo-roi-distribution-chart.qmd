...
ax1.text(0.02, 0.98, f"95% CI: [{cp['p5']:.1f}:1, {cp['p95']:.1f}:1]", 
         transform=ax1.transAxes, fontsize=16, weight='bold',
         verticalalignment='top', bbox=dict(boxstyle='round,pad=0.5', facecolor=COLOR_WHITE, edgecolor=COLOR_BLACK))
clean_spines(ax1)
...
ax2.text(0.02, 0.98, f"95% CI: [{ep['p5']:.1f}:1, {ep['p95']:.1f}:1]", 
         transform=ax2.transAxes, fontsize=16, weight='bold', color=COLOR_WHITE,
         verticalalignment='top', bbox=dict(boxstyle='round,pad=0.5', facecolor=COLOR_BLACK, edgecolor=COLOR_WHITE))
clean_spines(ax2)
