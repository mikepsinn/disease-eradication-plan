...
drivers = ['INFLUENCE_ACTIVIST_STAKE_FRACTION', 'DEFENSE_TAKEOVER_ACQUISITION_PREMIUM', 'GOV_CONTROLLING_SECTORS_TOP5_MARKET_CAP', 'GLOBAL_POPULATION_2024']
driver_labels = ['Activist Stake Fraction', 'Acquisition Premium Multiplier', 'Government-Controlling Sectors Top-5 Market Cap', 'Global Population in 2024']
impacts_low = [-83.54999999999998, -18.18629999999999, -10.6875, 5.475776923076921]
impacts_high = [104.4375, 72.74520000000001, 8.0625, -5.208665853658516]
...
output_path = get_figure_output_path('tornado-full_influence_cost_per_human.png')
