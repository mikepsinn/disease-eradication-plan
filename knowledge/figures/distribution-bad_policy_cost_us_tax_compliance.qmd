```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Tax Compliance Cost"
...
output_path = get_figure_output_path('distribution-bad_policy_cost_us_tax_compliance.png')
