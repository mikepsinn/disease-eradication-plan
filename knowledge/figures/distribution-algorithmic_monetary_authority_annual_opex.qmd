```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Algorithmic Monetary Authority Annual Operating Cost"
...
output_path = get_figure_output_path('distribution-algorithmic_monetary_authority_annual_opex.png')
