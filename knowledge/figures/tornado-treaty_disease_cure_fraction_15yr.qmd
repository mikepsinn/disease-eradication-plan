...
driver_labels = ['dFDA Pragmatic Trial Cost per Patient', 'Diseases Getting First Treatment Per Year', 'Total Number of Rare Diseases Globally', 'Annual Global Clinical Trial Participants', 'Decentralized Framework for Drug Assessment Maintenance Costs', 'Decentralized Framework for Drug Assessment Staff Costs', 'Decentralized Framework for Drug Assessment Infrastructure Costs', 'Decentralized Framework for Drug Assessment Regulatory Coordination Costs', 'Decentralized Framework for Drug Assessment Community Support Costs', 'Global Population with Chronic Diseases', 'Patient Willingness to Participate in Clinical Trials']
impacts_low = [0.5828901470150364, -0.19465126472631633, 0.06951830883082727, 0.11122929412932381, 9.584325666023297e-05, 5.750595399617309e-05, 5.750595399617309e-05, 3.833730266405988e-05, 1.9168651332113207e-05, 0.0, 0.0]
impacts_high = [-0.28794483517728653, 0.4171098529849636, -0.12513295589548906, -0.07254084399738486, -0.00013418055932418183, -9.584325666006643e-05, -7.667460532800874e-05, -5.7505953996062065e-05, -1.9168651331946673e-05, 0.0, 0.0]
...
output_path = get_figure_output_path('tornado-treaty_disease_cure_fraction_15yr.png')
