...
# Data - using parameters where available
...
# TODO: Create annual benefit parameters for water fluoridation and smoking cessation

values = [0.8, 12.0, childhood_vacc_benefit, total_benefit]
