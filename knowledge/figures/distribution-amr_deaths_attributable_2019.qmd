```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Deaths Directly Attributable to AMR (2019)"
...
output_path = get_figure_output_path('distribution-amr_deaths_attributable_2019.png')
