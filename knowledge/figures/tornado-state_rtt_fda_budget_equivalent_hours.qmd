...
baseline = 80.69877714566412

# Tornado data from sensitivity analysis

drivers = ['STATE_RTT_IMPLEMENTATION_COST_TOTAL']
driver_labels = ['Universal Right to Try with Evidence Implementation Cost']
impacts_low = [-49.66078593579331]
impacts_high = [167.60515253330243]
...
output_path = get_figure_output_path('tornado-state_rtt_fda_budget_equivalent_hours.png')
