...
# 1% Treaty & dFDA Initiative breakdown
# Convert Parameter objects to billions for chart display

peace_dividend_components = {
    'Peace Dividend': float(PEACE_DIVIDEND_ANNUAL_SOCIETAL_BENEFIT) / 1e9,
    'dFDA R&D\nSavings': float(DFDA_RD_GROSS_SAVINGS_ANNUAL) / 1e9,
    'Disease\nReduction': 10.9,
    'GDP\nGrowth': 27.2
}
...
# Plot stacked bar for the 1% Treaty & dFDA Initiative
...
ax.set_title('Annual Net Societal Benefits:\nCurrent Health Programs vs the 1% Treaty & dFDA Initiative',
