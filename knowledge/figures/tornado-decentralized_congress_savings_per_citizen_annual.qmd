...
drivers = ['US_GOV_WASTE_TARIFFS', 'US_GOV_WASTE_AGRICULTURAL_SUBSIDIES', 'US_GOV_WASTE_CORPORATE_WELFARE', 'US_GOV_WASTE_FOSSIL_FUEL_SUBSIDIES', 'US_POPULATION_2024']
driver_labels = ['Tariff Cost (GDP Loss)', 'Agricultural Subsidies Deadweight Loss', 'Corporate Welfare Waste', 'Fossil Fuel Subsidies (Explicit)', 'US Population in 2024']
impacts_low = [-208.95522388059703, -74.62686567164178, -92.53731343283584, -59.70149253731347, 21.076436001809043]
impacts_high = [268.6567164179105, 134.32835820895525, 116.41791044776119, 89.55223880597009, -20.4565408252854]
...
output_path = get_figure_output_path('tornado-decentralized_congress_savings_per_citizen_annual.png')
