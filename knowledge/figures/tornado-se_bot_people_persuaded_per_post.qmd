...
drivers = ['SE_BOT_OBSERVER_MULTIPLIER', 'SE_BOT_OBSERVER_BELIEF_CHANGE_RATE', 'SE_BOT_TARGET_BELIEF_CHANGE_RATE']
driver_labels = ['Observer Multiplier', 'Observer Belief Change Rate', 'Target Belief Change Rate']
impacts_low = [-0.09000000000000001, -0.09000000000000001, -0.018000000000000002]
impacts_high = [0.9, 0.5, 0.08]
...
output_path = get_figure_output_path('tornado-se_bot_people_persuaded_per_post.png')
