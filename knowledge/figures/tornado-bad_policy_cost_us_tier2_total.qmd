...
drivers = ['BAD_POLICY_COST_US_MIGRATION_RESTRICTIONS', 'BAD_POLICY_COST_US_FOSSIL_FUEL_EXTERNALITIES', 'BAD_POLICY_COST_US_DEFENSE_ABOVE_DETERRENCE', 'BAD_POLICY_COST_US_OCCUPATIONAL_LICENSING', 'BAD_POLICY_COST_US_INCARCERATION_EXCESS', 'BAD_POLICY_COST_US_INFRASTRUCTURE_DISEASE']
impacts_low = [-300000000000.0, -300000000000.0, -150000000000.0, -100000000000.0, -50000000000.0, -50000000000.0]
impacts_high = [1500000000000.0, 400000000000.0, 200000000000.0, 200000000000.0, 100000000000.0, 100000000000.0]
...
output_path = get_figure_output_path('tornado-bad_policy_cost_us_tier2_total.png')
