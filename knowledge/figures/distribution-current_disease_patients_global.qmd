```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Global Population with Chronic Diseases"
...
output_path = project_root / 'knowledge' / 'figures' / 'distribution-current_disease_patients_global.png'
