```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Aligned Election Commission Annual Operating Cost"
...
output_path = get_figure_output_path('distribution-aligned_election_commission_annual_opex.png')
