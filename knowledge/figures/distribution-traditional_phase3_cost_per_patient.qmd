```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Phase 3 Cost per Patient"
...
output_path = get_figure_output_path('distribution-traditional_phase3_cost_per_patient.png')
