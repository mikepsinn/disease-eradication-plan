...
|:----------------|------------------------:|:---------------|
| Shirt Seed Program Total Cost (USD) | -0.3062 | Moderate driver |
| Total Economic Benefit from Elimination of Efficacy Lag Plus Earlier Treatment Discovery from Higher Trial Throughput (USD) | -0.0676 | Minimal effect |
