...
drivers = ['THALIDOMIDE_CASES_WORLDWIDE', 'THALIDOMIDE_US_POPULATION_SHARE_1960', 'THALIDOMIDE_DISABILITY_WEIGHT', 'THALIDOMIDE_MORTALITY_RATE', 'THALIDOMIDE_SURVIVOR_LIFESPAN']
driver_labels = ['Thalidomide Cases Worldwide', 'US Population Share 1960', 'Thalidomide Disability Weight', 'Thalidomide Mortality Rate', 'Thalidomide Survivor Lifespan']
impacts_low = [-863040.0, -215760.0, -160704.0, -156240.0, -133920.0]
impacts_high = [863040.0, 215760.0, 160704.0, 156240.0, 133920.0]
...
output_path = get_figure_output_path('tornado-type_i_error_benefit_dalys.png')
