...
driver_labels = ['Global Life Expectancy (2024)', 'Global Healthy Life Expectancy (HALE)']
impacts_low = [-2.0, 1.5]
impacts_high = [2.0, -1.5]
...
output_path = get_figure_output_path('tornado-global_hale_gap.png')
