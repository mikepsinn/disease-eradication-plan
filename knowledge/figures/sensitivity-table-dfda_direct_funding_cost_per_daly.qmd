...
|:----------------|------------------------:|:---------------|
| Total DALYs from Elimination of Efficacy Lag Plus Earlier Treatment Discovery from Higher Trial Throughput (DALYs) | -0.5182 | Strong driver |
| dFDA Direct Funding NPV (Exploration Period) (USD) | 0.4583 | Moderate driver |
