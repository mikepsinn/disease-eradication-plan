...
drivers = ['CELL_THERAPY_APPROACHES', 'TRIAL_RELEVANT_DISEASES_COUNT']
driver_labels = ['Cell Therapy Approaches', 'Trial-Relevant Diseases']
impacts_low = [-200000.0, -100000.0]
impacts_high = [300000.0, 100000.0]
...
output_path = get_figure_output_path('tornado-cell_therapy_disease_combinations.png')
