...
drivers = ['GLOBAL_DAILY_DEATHS_CURABLE_DISEASES']
impacts_low = [-10950000.0]
impacts_high = [10950000.0]
...
output_path = project_root / 'knowledge' / 'figures' / 'tornado-global_annual_deaths_curable_diseases.png'
