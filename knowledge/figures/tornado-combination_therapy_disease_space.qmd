...
drivers = ['SAFE_COMPOUNDS_COUNT', 'TRIAL_RELEVANT_DISEASES_COUNT']
driver_labels = ['Safe Compounds Available for Testing', 'Trial-Relevant Diseases']
impacts_low = [-20623750000.0, -9024050000.0]
impacts_high = [26873750000.0, 9024050000.0]
...
output_path = get_figure_output_path('tornado-combination_therapy_disease_space.png')
