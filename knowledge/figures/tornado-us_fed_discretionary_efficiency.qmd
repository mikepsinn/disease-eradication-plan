...
drivers = ['US_GOV_WASTE_MILITARY_OVERSPEND', 'US_GOV_WASTE_DRUG_WAR', 'US_GOV_WASTE_AGRICULTURAL_SUBSIDIES', 'US_GOV_WASTE_CORPORATE_WELFARE', 'US_GOV_WASTE_FOSSIL_FUEL_SUBSIDIES']
driver_labels = ['Military Overspend', 'Drug War Cost', 'Agricultural Subsidies Deadweight Loss', 'Corporate Welfare Waste', 'Fossil Fuel Subsidies (Explicit)']
impacts_low = [0.0676470588235294, 0.01764705882352946, 0.014705882352941235, 0.018235294117647127, 0.01176470588235301]
impacts_high = [-0.07941176470588229, -0.03529411764705881, -0.026470588235294135, -0.022941176470588243, -0.01764705882352935]
