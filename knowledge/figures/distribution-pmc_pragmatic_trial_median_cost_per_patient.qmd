```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Pragmatic Trial Median Cost per Patient (PMC Review)"
...
output_path = get_figure_output_path('distribution-pmc_pragmatic_trial_median_cost_per_patient.png')
