```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Viral Marketing Content Creation Budget"
...
output_path = get_figure_output_path('distribution-campaign_viral_content_budget.png')
