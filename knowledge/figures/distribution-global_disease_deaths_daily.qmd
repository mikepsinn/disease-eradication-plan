```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Global Daily Deaths from Disease and Aging"
...
output_path = project_root / 'knowledge' / 'figures' / 'distribution-global_disease_deaths_daily.png'
