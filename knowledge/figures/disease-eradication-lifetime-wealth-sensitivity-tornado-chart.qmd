...
ax.set_xlabel(f'Your Lifetime Wealth (Base Case: ${base_value/1000000:.1f}M)', fontsize=22, weight='bold')
ax.set_title('What Matters Most for Your Lifetime Wealth?\nHow Different Factors Change Your $4.3M Gain\nfrom a 1% treaty',
...
output_path = get_figure_output_path('disease-eradication-lifetime-wealth-sensitivity-tornado-chart.png')
...
*Uses Disease Eradication Model (20-year scenario, 72yr life extension). Base case: Age 30, $50K income, 1% treaty, 3% discount rate.*