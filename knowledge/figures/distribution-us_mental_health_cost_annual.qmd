```{python}
#| echo: false
#| fig-cap: "Probability Distribution: US Mental Health Costs"
...
output_path = project_root / 'knowledge' / 'figures' / 'distribution-us_mental_health_cost_annual.png'
