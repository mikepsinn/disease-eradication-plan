```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Compute/API Cost per Patient (Monthly)"
...
output_path = get_figure_output_path('distribution-dfda_storage_cost_compute_per_patient_monthly.png')
