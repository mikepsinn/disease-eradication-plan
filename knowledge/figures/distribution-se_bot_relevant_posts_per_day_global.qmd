```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Relevant Posts Per Day (Global)"
...
output_path = get_figure_output_path('distribution-se_bot_relevant_posts_per_day_global.png')
