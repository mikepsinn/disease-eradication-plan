```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Annual Trade Disruption Costs from Currency Instability"
...
output_path = project_root / 'knowledge' / 'figures' / 'distribution-global_annual_trade_disruption_currency_conflict.png'
