...
baseline = 21.41732283464567

# Tornado data from sensitivity analysis

drivers = ['DEFENSE_LOBBYING_ANNUAL']
driver_labels = ['Annual Defense Industry Lobbying Spending']
impacts_low = [5.782677165354329]
impacts_high = [-4.41732283464567]
...
output_path = get_figure_output_path('tornado-iab_vs_defense_lobby_ratio_at_1pct.png')
