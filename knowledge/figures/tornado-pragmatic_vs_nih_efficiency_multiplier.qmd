...
drivers = ['NIH_STANDARD_RESEARCH_COST_PER_QALY', 'RECOVERY_TRIAL_GLOBAL_LIVES_SAVED', 'QALYS_PER_COVID_DEATH_AVERTED', 'RECOVERY_TRIAL_TOTAL_COST']
driver_labels = ['NIH Standard Research Cost per QALY', 'RECOVERY Trial Global Lives Saved', 'QALYs per COVID Death Averted', 'RECOVERY Trial Total Cost']
impacts_low = [-7500.0, -6250.0, -5000.0, 4166.666666666668]
impacts_high = [12500.0, 12500.0, 12500.0, -2500.0]
...
output_path = get_figure_output_path('tornado-pragmatic_vs_nih_efficiency_multiplier.png')
