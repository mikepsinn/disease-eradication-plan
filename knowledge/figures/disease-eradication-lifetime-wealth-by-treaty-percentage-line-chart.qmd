...
ax.set_title('How the Treaty Percentage Affects Your Lifetime Wealth\n(From 0.1% to 5% of Military Budget\nRedirected to Medical Research)',
...
ax.legend(bbox_to_anchor=(0.5, 0.5), loc='center', fontsize=14, frameon=True, edgecolor=COLOR_BLACK,
...
output_path = get_figure_output_path('disease-eradication-lifetime-wealth-by-treaty-percentage-line-chart.png')
