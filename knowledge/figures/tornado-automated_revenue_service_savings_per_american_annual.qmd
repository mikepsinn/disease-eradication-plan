...
drivers = ['US_GOV_WASTE_TAX_COMPLIANCE', 'US_POPULATION_2024', 'AUTOMATED_REVENUE_SERVICE_ALL_IN_COST_PER_TRANSACTION']
driver_labels = ['Tax Compliance Waste', 'US Population in 2024', 'All-In Cost per Settlement Transaction']
impacts_low = [-286.56716417910434, 25.24513794663062, 0.29850746268652983]
impacts_high = [310.4477611940299, -24.50263388937651, -1.044776119402968]
...
output_path = get_figure_output_path('tornado-automated_revenue_service_savings_per_american_annual.png')
