...
drivers = ['STATE_RTT_CAMPAIGN_COST_PER_STATE']
driver_labels = ['Campaign Cost per State (Universal Right to Try + Data Amendment)']
impacts_low = [-9800000.0]
impacts_high = [34300000.0]
...
output_path = get_figure_output_path('tornado-state_rtt_campaign_total_cost.png')
