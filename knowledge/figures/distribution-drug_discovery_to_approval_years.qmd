```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Drug Discovery to Approval Timeline"
...
output_path = get_figure_output_path('distribution-drug_discovery_to_approval_years.png')
