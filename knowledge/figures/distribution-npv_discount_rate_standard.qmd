```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Standard Discount Rate for NPV Analysis"
...
output_path = project_root / 'knowledge' / 'figures' / 'distribution-npv_discount_rate_standard.png'
