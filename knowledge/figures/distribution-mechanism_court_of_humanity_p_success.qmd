```{python}
#| echo: false
#| fig-cap: "Probability Distribution: P(Success | Court of Humanity Funded)"
...
output_path = get_figure_output_path('distribution-mechanism_court_of_humanity_p_success.png')
