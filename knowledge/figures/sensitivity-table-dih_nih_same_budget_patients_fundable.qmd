**Sensitivity Indices for DIH Same-Budget Trial Patients Fundable**
...
|:----------------|------------------------:|:---------------|
| Pragmatic Trial Cost per Patient (USD/patient) | -0.6452 | Strong driver |
| NIH Clinical Trials Spending Percentage (percentage) | 0.2793 | Weak driver |
