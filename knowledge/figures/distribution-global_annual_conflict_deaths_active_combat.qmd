```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Annual Deaths from Active Combat Worldwide"
...
output_path = project_root / 'knowledge' / 'figures' / 'distribution-global_annual_conflict_deaths_active_combat.png'
