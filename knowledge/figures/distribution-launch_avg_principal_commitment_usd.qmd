```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Average Commitment per Lead Principal"
...
output_path = get_figure_output_path('distribution-launch_avg_principal_commitment_usd.png')
