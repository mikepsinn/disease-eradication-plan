...
drivers = ['WISHONIA_PATH_SUCCESS_PROBABILITY_YEAR_20']
driver_labels = ['Wishonia Path Probability (Year 20 EV Model)']
...
output_path = get_figure_output_path('tornado-moronia_path_probability_year_20.png')
