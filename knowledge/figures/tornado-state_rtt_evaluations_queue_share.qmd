...
drivers = ['STATE_RTT_US_PATIENTS_COMMON_POORLY_TREATED', 'STATE_RTT_US_PATIENTS_RARE_UNTREATED']
driver_labels = ['US Patients with Poorly Treated Common Diseases', 'US Rare Disease Patients']
impacts_low = [0.15000000000000002, -0.17142857142857143]
impacts_high = [-0.17142857142857143, 0.06666666666666665]
...
output_path = get_figure_output_path('tornado-state_rtt_evaluations_queue_share.png')
