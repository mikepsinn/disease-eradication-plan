```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Global Lead Poisoning Cost"
...
output_path = get_figure_output_path('distribution-political_dysfunction_global_lead_opportunity_cost.png')
