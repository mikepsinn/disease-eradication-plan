...
drivers = ['LAUNCH_HIGH_ALIGNMENT_PRINCIPALS_COUNT', 'LAUNCH_REACH_PROBABILITY_HIGH_ALIGNMENT', 'LAUNCH_PERSUADE_PROBABILITY_GIVEN_REACHED', 'LAUNCH_EXECUTE_PROBABILITY_GIVEN_PERSUADED']
driver_labels = ['High-Alignment Lead Principals', 'Reach Probability for High-Alignment Principals', 'Persuasion Rate Given Reach', 'Execution Rate Given Persuasion']
impacts_low = [-4.290000000000001, -3.5100000000000007, -3.4125000000000005, -3.150000000000001]
impacts_high = [13.649999999999999, 4.095, 2.437499999999999, 2.250000000000001]
...
output_path = get_figure_output_path('tornado-launch_expected_ready_principals.png')
