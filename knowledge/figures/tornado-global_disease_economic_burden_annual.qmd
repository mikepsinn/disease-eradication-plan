...
drivers = ['EVENTUALLY_AVOIDABLE_DALY_PCT', 'STANDARD_ECONOMIC_QALY_VALUE_USD', 'GLOBAL_ANNUAL_DALY_BURDEN']
driver_labels = ['Eventually Avoidable DALY Percentage', 'Standard Economic Value per QALY', 'Global Annual DALY Burden']
impacts_low = [-184152130131680.88, -80030426026336.19, -20841256777691.688]
impacts_high = [23207869868319.125, 80030426026336.12, 20841256777691.688]
