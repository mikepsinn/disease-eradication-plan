```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Decentralized Framework for Drug Assessment Core framework Annual OPEX"
...
output_path = get_figure_output_path('distribution-dfda_npv_annual_opex.png')
