```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Pharma Phase 2/3 Cost Barrier Per Drug"
...
output_path = get_figure_output_path('distribution-pharma_phase_2_3_cost_barrier.png')
