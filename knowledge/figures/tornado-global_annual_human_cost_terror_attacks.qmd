...
drivers = ['VALUE_OF_STATISTICAL_LIFE', 'GLOBAL_ANNUAL_CONFLICT_DEATHS_TERROR_ATTACKS']
driver_labels = ['Value of Statistical Life', 'Annual Deaths from Terror Attacks Globally']
impacts_low = [-41500000000.0, -23000000000.0]
impacts_high = [41500000000.0, 37000000000.0]
...
output_path = get_figure_output_path('tornado-global_annual_human_cost_terror_attacks.png')
