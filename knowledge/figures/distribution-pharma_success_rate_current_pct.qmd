```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Pharma Drug Success Rate (Current System)"
...
output_path = get_figure_output_path('distribution-pharma_success_rate_current_pct.png')
