```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Housing/Zoning Restrictions Cost"
...
output_path = get_figure_output_path('distribution-bad_policy_cost_us_housing_zoning.png')
