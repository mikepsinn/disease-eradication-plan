```{python}
#| echo: false
#| fig-cap: "Probability Distribution: National Outcome Registry Annual Operating Cost"
...
output_path = get_figure_output_path('distribution-state_rtt_registry_annual_cost.png')
