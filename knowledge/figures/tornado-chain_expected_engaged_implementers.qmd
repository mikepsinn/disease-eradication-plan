...
drivers = ['CHAIN_INITIAL_AUDIENCE', 'CHAIN_IMPLEMENTER_ORBIT_SIZE', 'CHAIN_DISMISS_PROBABILITY', 'CHAIN_EFFECTIVE_R']
driver_labels = ['Initial Audience', 'Implementer Orbit Size', 'Dismissal Rate', 'Effective R']
impacts_low = [-2.7798519014942533, -2.9544624851010157, 3.478910443764937, -0.395007907755355]
impacts_high = [29.536028578578858, 13.513693995484504, -2.435237310635455, 5.1778401462158]
...
output_path = get_figure_output_path('tornado-chain_expected_engaged_implementers.png')
