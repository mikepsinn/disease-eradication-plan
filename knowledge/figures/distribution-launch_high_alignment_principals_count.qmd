```{python}
#| echo: false
#| fig-cap: "Probability Distribution: High-Alignment Lead Principals"
...
output_path = get_figure_output_path('distribution-launch_high_alignment_principals_count.png')
