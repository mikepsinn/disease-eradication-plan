...
drivers = ['LEADED_GASOLINE_US_AVG_IQ_LOSS_POINTS', 'NATIONAL_IQ_GDP_GROWTH_EFFECT_PER_POINT']
driver_labels = ['US Average IQ Loss from Leaded Gasoline', 'GDP Growth Effect per National IQ Point']
impacts_low = [-0.10391439605185893, -0.15297307425167883]
impacts_high = [0.37177419906172493, 0.1743257552271027]
...
output_path = get_figure_output_path('tornado-ethyl_shareholder_counterfactual_wealth_gain.png')
