...
#| fig-cap: "Incentive Alignment Bond Architecture. A 1% treaty redirects funds from lower-value programs to public goods, investor returns, and a political incentive fund. The political fund operates through three legally distinct channels to make supporting the treaty the career-maximizing choice for politicians."
import graphviz
...
# Top: Funding source - be specific about what's being redirected
dot.node('Source', node_label('Military Spending\n($2.7 Trillion/year)'), shape='box')
...
dot.node('PublicGood', node_label('Public Good\n(e.g., Curing Diseases)\n$21.6B (80%)'), shape='box')
