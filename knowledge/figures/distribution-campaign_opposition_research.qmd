```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Opposition Research and Rapid Response"
...
output_path = get_figure_output_path('distribution-campaign_opposition_research.png')
