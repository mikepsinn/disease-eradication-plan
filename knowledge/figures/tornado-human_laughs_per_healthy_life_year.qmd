...
drivers = ['HUMAN_LAUGHS_PER_DAY_AVERAGE']
driver_labels = ['Human Laughs per Day (Average Adult)']
impacts_low = [-4380.0]
impacts_high = [12045.0]
...
output_path = get_figure_output_path('tornado-human_laughs_per_healthy_life_year.png')
