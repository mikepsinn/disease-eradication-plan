```{python}
#| echo: false
#| fig-cap: "Probability Distribution: NIH Standard Research Cost per QALY"
...
output_path = get_figure_output_path('distribution-nih_standard_research_cost_per_qaly.png')
