...
drivers = ['RECOVERY_TRIAL_GLOBAL_LIVES_SAVED', 'QALYS_PER_COVID_DEATH_AVERTED', 'RECOVERY_TRIAL_TOTAL_COST']
driver_labels = ['RECOVERY Trial Global Lives Saved', 'QALYs per COVID Death Averted', 'RECOVERY Trial Total Cost']
impacts_low = [4.0, 2.666666666666667, -1.0]
impacts_high = [-2.0, -2.0, 1.0]
...
output_path = get_figure_output_path('tornado-pragmatic_trial_cost_per_qaly.png')
