...
drivers = ['SHIRT_SEED_WEARERS_THRESHOLD', 'SHIRT_SEED_COST_PER_WEARER_USD']
driver_labels = ['Shirt Seed Wearers Threshold', 'Shirt Seed Cost per Wearer']
impacts_low = [-45000000.0, -40000000.0]
impacts_high = [200000000.0, 150000000.0]
...
output_path = get_figure_output_path('tornado-mechanism_shirt_cascade_net_cost.png')
