...
drivers = ['SE_BOT_RELEVANT_POSTS_PER_DAY_GLOBAL', 'SE_BOT_OBSERVER_MULTIPLIER', 'SE_BOT_OBSERVER_BELIEF_CHANGE_RATE', 'SE_BOT_TARGET_BELIEF_CHANGE_RATE']
driver_labels = ['Relevant Posts Per Day (Global)', 'Observer Multiplier', 'Observer Belief Change Rate', 'Target Belief Change Rate']
impacts_low = [-4161000.0, -3285000.0, -3285000.0, -656999.9999999995]
impacts_high = [39420000.0, 32850000.0, 18250000.0, 2920000.0]
...
output_path = get_figure_output_path('tornado-se_bot_annual_belief_changes.png')
