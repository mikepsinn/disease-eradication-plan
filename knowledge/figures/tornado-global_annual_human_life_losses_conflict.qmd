...
drivers = ['VALUE_OF_STATISTICAL_LIFE', 'GLOBAL_ANNUAL_CONFLICT_DEATHS_ACTIVE_COMBAT', 'GLOBAL_ANNUAL_CONFLICT_DEATHS_TERROR_ATTACKS', 'GLOBAL_ANNUAL_CONFLICT_DEATHS_STATE_VIOLENCE']
driver_labels = ['Value of Statistical Life', 'Annual Deaths from Active Combat Worldwide', 'Annual Deaths from Terror Attacks Globally', 'Annual Deaths from State Violence']
impacts_low = [-1223000000000.0, -536000000000.0, -23000000000.0, -12000000000.0]
impacts_high = [1223000000000.0, 664000000000.0, 37000000000.0, 23000000000.0]
...
output_path = get_figure_output_path('tornado-global_annual_human_life_losses_conflict.png')
