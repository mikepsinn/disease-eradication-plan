...
drivers = ['GLOBAL_CLINICAL_TRIALS_SPENDING_ANNUAL', 'GLOBAL_GOVERNMENT_CLINICAL_TRIALS_SPENDING_ANNUAL']
driver_labels = ['Annual Global Spending on Clinical Trials', 'Annual Global Government Spending on Clinical Trials']
impacts_low = [-10000000000.0, 1500000000.0]
impacts_high = [15000000000.0, -1500000000.0]
...
output_path = get_figure_output_path('tornado-global_industry_clinical_trials_spending_annual.png')
