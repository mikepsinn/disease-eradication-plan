...
baseline = 0.00015868852459016393

# Tornado data from sensitivity analysis

drivers = ['INFLUENCE_ACTIVIST_STAKE_FRACTION']
driver_labels = ['Activist Stake Fraction']
impacts_low = [-0.00012695081967213114]
impacts_high = [0.00015868852459016393]
...
output_path = get_figure_output_path('tornado-defense_takeover_cost_activist_pct_investable_assets.png')
