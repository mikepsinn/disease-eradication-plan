...
# Disease costs breakdown (from parameters.py)

disease_medical = float(GLOBAL_DISEASE_DIRECT_MEDICAL_COST_ANNUAL) / 1e9
disease_productivity = float(GLOBAL_DISEASE_PRODUCTIVITY_LOSS_ANNUAL) / 1e9
disease_lives = float(GLOBAL_DISEASE_HUMAN_LIFE_VALUE_LOSS_ANNUAL) / 1e9
disease_total = float(GLOBAL_DISEASE_ECONOMIC_BURDEN_ANNUAL) / 1e9
...
output_path = get_figure_output_path('war-vs-disease-total-costs-vs-curing-spending-column-chart.png')
