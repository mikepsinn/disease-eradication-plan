```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Standard QALYs per Life Saved"
...
output_path = project_root / 'knowledge' / 'figures' / 'distribution-standard_qalys_per_life_saved.png'
