**Sensitivity Indices for Suffering Hours Eliminated from Full Timeline Shift**
...
|:----------------|------------------------:|:---------------|
| dFDA Trial Capacity Plus Efficacy Lag DALYs | 1.3181 | Strong driver |
| Global Yld Proportion Of DALYs | 0.4150 | Moderate driver |
