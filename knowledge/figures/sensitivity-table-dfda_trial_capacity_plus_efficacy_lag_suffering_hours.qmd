...
|:----------------|------------------------:|:---------------|
| Total DALYs from Elimination of Efficacy Lag Plus Earlier Treatment Discovery from Higher Trial Throughput (DALYs) | 1.3101 | Strong driver |
| YLD Proportion of Total DALYs (proportion) | 0.3975 | Moderate driver |
