...
drivers = ['DIH_NPV_UPFRONT_COST_INITIATIVES', 'DFDA_NPV_UPFRONT_COST']
driver_labels = ['DIH Broader Initiatives Upfront Cost', 'Decentralized Framework for Drug Assessment Core framework Build Cost']
impacts_low = [-79750000.0, -15000000.0]
impacts_high = [120250000.0, 25000000.0]
...
output_path = get_figure_output_path('tornado-dfda_npv_upfront_cost_total.png')
