```{python}
#| echo: false
#| fig-cap: "Probability Distribution: All-In Cost per Settlement Transaction"
...
output_path = get_figure_output_path('distribution-automated_revenue_service_all_in_cost_per_transaction.png')
