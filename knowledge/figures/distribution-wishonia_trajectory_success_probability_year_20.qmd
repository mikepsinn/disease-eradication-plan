```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Wishonia Trajectory Probability (Year 20 EV Model)"
...
output_path = get_figure_output_path('distribution-wishonia_trajectory_success_probability_year_20.png')
