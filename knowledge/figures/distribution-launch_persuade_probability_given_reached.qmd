```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Persuasion Rate Given Reach"
...
output_path = get_figure_output_path('distribution-launch_persuade_probability_given_reached.png')
