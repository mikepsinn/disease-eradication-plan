...
drivers = ['GLOBAL_TO_US_POLITICAL_COST_RATIO', 'US_POLITICAL_EFFORT_MULTIPLIER', 'POLITICIAN_POST_OFFICE_CAREER_VALUE', 'US_TOTAL_FEDERAL_CAMPAIGN_SPENDING_2024', 'US_TOTAL_LOBBYING_ANNUAL']
driver_labels = ['Global-to-US Political Cost Ratio', 'Political Effort Multiplier (US)', 'Post-Office Career Value (per politician)', 'US Federal Campaign Spending (2024)', 'US Total Lobbying (2024)']
impacts_low = [-51020000000.0, -43200000000.0, -13375000000.0, -7000000000.0, -4620000000.0]
impacts_high = [76530000000.0, 72000000000.0, 26750000000.0, 7000000000.0, 4620000000.0]
...
output_path = get_figure_output_path('tornado-global_political_reform_investment.png')
