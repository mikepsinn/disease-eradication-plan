```{python}
#| echo: false
#| fig-cap: "Probability Distribution: Deaths from 9/11 Terrorist Attacks"
...
output_path = get_figure_output_path('distribution-terrorism_deaths_911.png')
