...
- Maximum raise limits ([{{< var dfda_opex_regulatory >}} Reg CF](../references.qmd#sec-reg-cf-raise-limit), [$75M Reg A+](../references.qmd#sec-reg-a))
...
#### Budget: {{< var treaty_campaign_budget_partnerships >}} for lawyers
