...
For complete breakdown of financial mechanics and returns, see [Investment Vehicle](../economics/victory-bonds.qmd) chapter. This section covers legal compliance.
...
Conclusion: VICTORY [Incentive Alignment Bonds](https://iab.warondisease.org) are super definitely a security. Time to comply!

### The Two-Phase "Points-then-Conversion" Model

The compliance strategy separates the initial, non-financial airdrop from the subsequent distribution of valuable governance tokens, leveraging the SEC's more innovation-friendly guidance as of August 2025 [@sec-innovation-guidance-2025].
...
- **Pure Utility:** Their sole purpose is to serve as a cryptographically verifiable receipt of participation
- **No "Investment of Money":** Points are earned through an action (voting), not purchased
- **Legal Rationale:** This structure fails the Howey Test. As a non-tradable token with no promised expectation of profit, it has a strong argument for not being a security

#### Phase 2: VICTORY Token Conversion (Post-Treaty)

This phase occurs only _after_ a 1% treaty is successfully ratified and the [1% Treaty Fund](../solution/dih.qmd) is funded.

- **Mechanism:** Holders of VOTE points have the option to convert their points into real VICTORY governance tokens through a compliant portal
- **Legal Rationale:** This conversion will be structured to fall within the SEC's "safe harbor" provisions [@peirce-token-safe-harbor] for sufficiently decentralized networks. By conversion time, the primary "work of the promoters" (getting the treaty passed) is complete

### How to Structure It

**Phase 1: Rich People Only (Reg D)**

- Unlimited accredited investors ($1M net worth or $200K income) [@sec-accredited-investor-definition]
- Plus up to 35 sophisticated non-accredited [@sec-investor-limit-private-offering]
- No public advertising under 506(b) (except this book, which is "education")
- File Form D [@sec-form-d-filing] within 15 days
...
- Maximum raise limits ($5M Reg CF [@sec-reg-cf-raise-limit], $75M Reg A+ [@sec-reg-a])
...
![Phased capital raising timeline showing the progression from accredited investors (Reg D) to public crowd sales (Reg CF/A+) and secondary market liquidity.](/assets/images/legal-framework/legal-framework-section-securities-compliance-phases-bw-academic.jpg)
...
Government requires proof you're not laundering cartel money to fund healthcare. The irony that governments themselves launder tax money into military contractor pockets is apparently lost on regulators.
...
**The Law:** Foreign nationals can't spend money on US elections [@fec-foreign-nationals]
...
![The legal firewall separating US political operations from international funds to prevent violations of federal election law.](/assets/images/legal-framework/legal-framework-section-election-law-firewall-bw-academic.jpg)
...
- Spending limits (£20,000 nationally) [@uk-electoral-spending-limits]
- Quarterly reports
...
- Foreign funding restrictions [@canada-bill-c-76]
- Real-time expense reporting [@canada-expenditure-reporting-500]
