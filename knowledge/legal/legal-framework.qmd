...
For complete details on the Howey Test, the two-phase "points-then-conversion" model, Reg D/CF/A+ structuring, required disclosures, and KYC/AML requirements, see [Securities Law](securities-law.qmd).
