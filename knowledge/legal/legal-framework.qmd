...
The Engine issues [VICTORY Bonds](../solution/incentive-alignment-bonds.qmd) ({{< var victory_bond_annual_return_pct >}} target returns), uses {{< var treaty_campaign_total_cost >}} to fund lobbying and campaigns, and manages treaty inflows to pay bondholders in perpetuity. It is, in short, the part that makes rich people richer for making sick people better. On Wishonia, this arrangement would be considered bizarre. On Earth, it's the only arrangement that produces results.
...
The Foundation watches the Victory Corporation to make sure it doesn't drift toward maximizing shareholder value, which is corporate for "forgetting why you exist." This happens to every for-profit entity eventually. It's like entropy but for mission statements. The only defense is a nonprofit owner with a locked charter and a very long memory.
...
Bribing politicians is illegal unless you call it "lobbying" or "campaign contributions." Then it's protected speech. Your First Amendment protects the right to petition your government, which your Supreme Court interpreted as "spend unlimited money telling politicians what to do" [@citizens-united-ruling], which is a reading of the text that the text's authors would find creative in the way that a teacher finds a student's excuse creative when the dog allegedly ate the homework.
...
The 1% Treaty is a formal international agreement. Like the ones your species already signs about postal rates and fish, except this one redirects military spending to clinical trials. Apparently more controversial than fish, which tells you everything about your species' priorities.
