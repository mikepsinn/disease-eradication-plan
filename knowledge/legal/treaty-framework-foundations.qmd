...
description: How to use international law to lock the world's governments into a permanent, escalating commitment to funding life instead of death
format:
  html:
    toc: true
    toc-depth: 3
...
A 1% treaty is a mousetrap baited with political benefits. Once countries sign, they're locked into a system that grows stronger over time. Every success makes expansion inevitable. Every cure makes war harder to justify.

It uses international law's greatest strength - its rigidity - as a weapon against the status quo. Countries can't easily back out. Politicians can't quietly kill it. The public can enforce it directly.
