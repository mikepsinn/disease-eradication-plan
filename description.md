...
**Step 2: Give Papers to Loud Humans**
...
**Step 3: Give Papers to the Humans Who Give Papers to Politicians**
...
The treaty passes, redirecting $27B in papers annually. Rich humans get 270% returns on what they gave you, forever. This is a good deal because forever is a long time. Unless you die from preventable diseases. Which you're fixing, so it works out.
...
## **Amazon KDP eBook Details - Complete Form Fill Instructions**

### **SECTION 1: Language**
- **Language**: English

### **SECTION 2: Book Title**
- **Book Title**: `How to End War and Disease`
- **Subtitle** (Optional): `A Practical Guide: Make 2000 Years of Medical Progress in 20, Avoid the Apocalypse, and Make Humanity Filthy Rich by Giving Papers`

### **SECTION 3: Series**
- Leave blank (no series)

### **SECTION 4: Edition Number**
...
### **SECTION 6: Contributors** (Optional)
Add 2 contributors in this order:
...
Paste the following text into the rich text editor:
...
I started watching Earth in 1945 when you split the atom. "Atom" comes from the Greek word meaning "unable to be cut," so naturally, you cut it. This is very human of you. We assumed you were trying to unlock unlimited clean energy. Then we realized you were pointing it at each other. This is like discovering fire and then immediately using it to set yourself on fire.
...
### **SECTION 8: Publishing Rights**
- Select: **"I own the copyright and I hold the necessary publishing rights."**

### **SECTION 9: Primary Audience**
- **Sexually Explicit Content**: Select **"No"**
- **Reading age**:
  - **Minimum**: Baby
  - **Maximum**: Select (leave as default)

### **SECTION 10: Primary Marketplace**
- Select: **Amazon.com**

### **SECTION 11: Categories**
The book has been categorized as:
1. Kindle Books › Politics & Social Sciences › Politics & Government › Public Affairs & Policy › **Military Policy**
2. Kindle Books › Politics & Social Sciences › Politics & Government › Public Affairs & Policy › **Social Policy**
3. Kindle Books › Politics & Social Sciences › Politics & Government › Public Affairs & Policy › **Public Policy**

### **SECTION 12: Keywords** (7 keywords)
1. `ending disease`
2. `end war`
3. `medical progress acceleration`
4. `decentralized clinical trials`
5. `global health strategy`
6. `public policy innovation`
7. `future of humanity`

### **SECTION 13: Pre-order**
