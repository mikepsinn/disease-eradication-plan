...
> The Earth Optimization Prize is a standing prize for changing the future your species is currently drifting into. The destructive economy is already 11.5% of GDP and reaches 48.8% by year 15 if current trends continue. The model projects the failed-state danger zone in 8 years and parity between destructive and productive activity in 15 years. The Treaty path produces 12x lifetime income and 6.55 years additional healthy years by year 15. The fuller Wishonia path produces 39.8x and 15.7 years. PRIZE deposits provide committed capital, VOTE claims pay for recruitment, and the public scoreboard makes coalition size visible. A credible institution can initiate the network by hosting the first contest and scoreboard without becoming the mechanism's sovereign. The [Earth Optimization Plan v1](https://manual.warondisease.org) is the terrible starting benchmark. The prize exists to discover and cause the implementation of whatever beats it: the Earth Optimization Plan v2.
