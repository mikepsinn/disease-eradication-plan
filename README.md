...
This is happening whether you participate or not. The math is public. The incentives are structural. Someone in the chain will do exactly what you're deciding not to. The only variable you control is how long it takes. Each year of delay is a year the compounding hasn't started, which costs the average human $14.9M in lifetime income they will never recover. You're not deciding whether to act. You're deciding how many people die and how much poorer everyone stays while you hesitate.
