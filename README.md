...
> The Earth Optimization Prize rewards humanity for working together to raise global healthy life years and global median income within 15 years. The status quo is already spending 604 more on weapons than on testing which medicines work, while the destructive economy rises from 11.5% of GDP now toward 48.8% by year 15. PRIZE is the depositor-side failure claim: funds stay in one pool until year 15, then return pro rata to depositors if the targets are missed. VOTE is the success-side recruitment claim: each verified recruit earns one claim, and if both year-15 objectives are met, the same realized pool routes to VOTE claimants instead. The objectives are global HALE of 79 years and global median income of $504K by year 15. The first institutional ask is $30B to make mass participation credible; a stronger visible-pool benchmark is $1.8T; the long-run capital ceiling is $774T. Humans are the contestants. The [Earth Optimization Protocol v1](https://manual.warondisease.org) is only the current least-terrible instruction manual and cheat code for trying to win.
