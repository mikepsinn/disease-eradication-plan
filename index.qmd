...
**Step 1: Get Many Papers ([$1 Billion](knowledge/economics/campaign-budget.qmd))**
...
**Step 2: Give Papers to Loud Humans ([$200 Million](knowledge/economics/campaign-budget.qmd))**
...
**Step 3: Give Papers to the Humans Who Give Papers to Politicians ([$250 Million](knowledge/economics/campaign-budget.qmd))**
...
**Step 4: Give Papers to the Politicians' Friends ([$300 Million](knowledge/economics/campaign-budget.qmd))**
...
The treaty passes, redirecting [$27 billion in papers annually](knowledge/solution/1-percent-treaty.qmd). Rich humans get [$271.80 for every $100](knowledge/economics/victory-bonds.qmd) they gave you, forever. This is a good deal because forever is a long time. Unless you die from preventable diseases. Which you're fixing, so it works out.
...
1. The rich humans want [271.8% returns](knowledge/economics/victory-bonds.qmd) (they're very greedy)
...
Rich humans give you [$1 billion](knowledge/economics/campaign-budget.qmd) in papers because you promise them [270% more papers annually](knowledge/economics/victory-bonds.qmd), which is better returns than selling organs but requires less refrigeration. They calculate that being dead significantly reduces their yacht-purchasing capacity.

##### Step 2: The Internet Clicking Ceremony

You use [$200 million](knowledge/economics/campaign-budget.qmd) of those papers to convince [280 million regular people](knowledge/strategy/global-referendum.qmd) to click "yes" on a website that asks: "Would you like all nations to redirect 1% of military spending to cure diseases?"
...
You give [$250 million](knowledge/economics/campaign-budget.qmd) in papers to the humans whose job is "convincing politicians that killing is profitable." You show them the math: [270% returns](knowledge/economics/victory-bonds.qmd) vs their current 8% death-machine dividends.
...
You spend [$250 million](knowledge/economics/campaign-budget.qmd) in papers on Super PACs, which are like regular PACs but with capes. You explain to politicians that [280 million voters](knowledge/strategy/global-referendum.qmd) have discovered they enjoy being alive.
...
The treaty passes. Every nation moves 1% of their explosion budget to their not-explosion budget. This creates [$27 billion annually](knowledge/solution/1-percent-treaty.qmd) for fixing meat robots.
...
[Humans haven't cured a single disease](knowledge/problem/nih-spent-1-trillion-eradicating-0-diseases.qmd) in [50 years](./dih-economic-models/references.qmd#smallpox-eradicated).
...
Meanwhile, humans spend [$67.5B on medical research](knowledge/appendix/global-government-medical-research-spending.qmd).
...
**Redirect [$27.2B/year](knowledge/solution/1-percent-treaty.qmd) from the War on Humanity to the War on Disease**
...
You'd still have [$2.7T](knowledge/problem/cost-of-war.qmd) left for war and bombs and stuff.
[\$2.69 trillion is enough to murder every man, woman, and child on Earth 20 times](knowledge/appendix/nuclear-weapon-cost-and-casualties.qmd) which should be more than sufficient.
...
[The dFDA](knowledge/solution/dfda.qmd) achieves [**82x cost reduction**](knowledge/appendix/recovery-trial.qmd) through decentralized pragmatic trials.
...
- **Oxford Already Did It**: [The RECOVERY trial](knowledge/appendix/recovery-trial.qmd) tested 6 treatments on 40,000 patients across 176 hospitals for $0K/patient (vs FDA's $41K), proving 82x cost reduction at scale. Not in theory. In reality. With actual dying people who became not-dying people.
...
- [271.8% returns](knowledge/economics/victory-bonds.qmd) (beats Grandma's bonds by 67x)
- Not dying from preventable meat failures (this is the big one)
- Also no Nazis (as a bonus)

This raises the [$1.0B](knowledge/economics/campaign-budget.qmd) needed to fuel the rest of the bribery machine, which in your economy is somehow both "a lot" and "what Jeff Bezos finds in his couch."
...
- **[VICTORY Bonds: 271.8%](knowledge/economics/victory-bonds.qmd) (and legal)**
...
How does money multiply like rabbits? The treaty unlocks [$27.2B annually](knowledge/solution/1-percent-treaty.qmd) from the murder budget.
...
- VICTORY Bonds: $20M (worth $54M/year at [271.8% returns](knowledge/economics/victory-bonds.qmd))
...
Politicians are simple organisms with one evolutionary drive: reelection. You exploit this with [$800M](knowledge/economics/campaign-budget.qmd) in Super PAC papers.

The conversation goes:

- You: "[280 million voters](knowledge/strategy/global-referendum.qmd) want to not die"
...
The [$27.2B/year](knowledge/solution/1-percent-treaty.qmd) money volcano erupts, showering everyone with papers that represent value:

- Investors: Swimming in [271.8% returns](knowledge/economics/victory-bonds.qmd) like Scrooge McDuck but legal
...
**Defense Contractors**: "You keep 99% of your murder budget AND get [271.8% returns](knowledge/economics/victory-bonds.qmd) on the 1%. It's like finding papers in the pocket of pants you're currently wearing. Except the papers multiply. While you're wearing the pants. It's financially inexplicable but legally binding."
...
**Politicians**: "[280 million voters](knowledge/strategy/global-referendum.qmd) want this. Your opponent supports it. You can either agree or explain why you prefer bombs to grandma's cancer treatment. Your choice."

**Billionaires**: "Your index fund makes 10% more papers. This makes [271.8% more papers](knowledge/economics/victory-bonds.qmd). It's like compound interest discovered steroids then did cocaine."
...
- [**$50.0B in annual R&D cost savings**](knowledge/appendix/dfda-cost-benefit-analysis.qmd): 82x reduction in clinical trial costs (you were spending 82 times too much, which is like discovering you've been paying $82 for toast when toast costs $1, except the toast is immortality)
...
- **Operating costs**: [$290M/year](knowledge/appendix/1-percent-treaty-cost-effectiveness.qmd) (less than a single fighter jet)
- **Lives saved**: [25,000/year](knowledge/appendix/1-percent-treaty-cost-effectiveness.qmd) ($875,000 \text{ QALYs} \div 35 \text{ QALYs/life}$)
- **Per life saved**: Society makes [$167,771](knowledge/appendix/1-percent-treaty-cost-effectiveness.qmd) profit
...
- Early investors make [271.8% returns](knowledge/economics/victory-bonds.qmd) (which beats everything except insider trading)
- Healthcare becomes free through trial participation
- [**You personally get $4.3M in lifetime wealth and 72 extra years of life**](knowledge/call-to-action/your-personal-benefits.qmd) (yes, you specifically)
