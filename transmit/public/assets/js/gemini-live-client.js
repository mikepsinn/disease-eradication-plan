...
var GeminiLiveClient = (function () {
  ...
  var API_BASE_KEY = "wss://generativelanguage.googleapis.com/ws/google.ai.generativelanguage.v1beta.GenerativeService.BidiGenerateContent";
  var API_BASE_TOKEN = "wss://generativelanguage.googleapis.com/ws/google.ai.generativelanguage.v1alpha.GenerativeService.BidiGenerateContentConstrained";
  ...
  GeminiLiveClient.prototype.connect = function () {
    ...
    return new Promise(function (resolve, reject) {
      // Ephemeral tokens use access_token param + Constrained endpoint (v1alpha);
      // raw API keys use key param + standard endpoint (v1beta)
      var isEphemeral = self.apiKey && self.apiKey.startsWith("auth_tokens/");
      var base = isEphemeral ? API_BASE_TOKEN : API_BASE_KEY;
      var param = isEphemeral ? "access_token" : "key";
      var url = base + "?" + param + "=" + encodeURIComponent(self.apiKey);
