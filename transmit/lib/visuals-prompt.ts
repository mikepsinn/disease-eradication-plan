 ...
 *
 * Used by /api/visuals to generate structured visual supplements
 * for chat responses. The LLM decides which fields to populate;
 * null means "nothing visual helps for this field."
 */
