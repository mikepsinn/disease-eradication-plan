...
This channel explains how to redirect 1% of your murder budget to your not-dying budget using the magic of legal bribery. Nobody has to become a better person. You just point everyone's greed at diseases instead of each other.

Free book: https://manual.WarOnDisease.org
The math: https://impact.warondisease.org
...
"Redirecting 1% of your murder budget to your not-dying budget"
...
Vote to not die: https://wishocracy.org
dFDA spec: https://spec.dfda.earth
...
Not from here (observing from a safe distance)

### Pinned Tweet

Humanity spends $2.7 trillion/year making humans stop existing, then $68 billion figuring out why they stopped. Your chance of dying from terrorism: 1 in 30 million. Your chance of dying from disease: 100%.

Here's how to fix that with legal bribery:
...
Redirecting 1% of global military spending to clinical trials through Incentive Alignment Bonds.
...
dFDA specification: https://spec.dfda.earth
...
Clinical trial reform, defense spending reallocation, incentive alignment, health economics, treaty advocacy, decentralized drug assessment

---

## Reddit

### Subreddit Description (r/wishonia or r/warondisease)

A campaign to redirect 1% of global military spending to clinical trials. 150,000 people die daily from diseases with no approved treatments. You spend 604x more on weapons than on testing which medicines work. This sub discusses the 1% treaty, Incentive Alignment Bonds, the dFDA, and how to bribe humanity into not dying.
...
Primary: `#WarOnDisease` `#1PercentTreaty`
Secondary: `#CureDiseaseNotCountries` `#IncentiveAlignment` `#VICTORYBonds` `#dFDA`
Broader reach: `#HealthcareReform` `#MilitarySpending` `#ClinicalTrials` `#GlobalHealth`

## Recurring Content Themes

1. **The 604:1 ratio** - military vs clinical trial spending
2. **The 1% treaty** - everyone cuts simultaneously, balance unchanged
3. **Legal bribery** - Incentive Alignment Bonds making greed useful
4. **The unexplored frontier** - 95% of diseases have zero treatments
5. **Historical precedent** - post-WW2 boom, existing arms treaties, RECOVERY trial
6. **The absurdity** - Department of Defense that attacks, Department of Health with no health
7. **The calculator error** - ROI numbers so large they break spreadsheets
