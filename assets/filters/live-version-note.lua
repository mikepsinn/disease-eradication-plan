...
function Pandoc(doc)
  ...
  local note = nil
  -- Keep the version note on archival outputs only. The live HTML site is the
  -- primary reading surface, so injecting a "maintained interactive version"
  -- banner there is redundant.
