...
## Evidence of Latent Public Support
...
| **1. Pilot district (1-2 mo)**   | 10-20 k pledges in one swing district | ≤ \$0.50 CPA        | ≤ \$10 k                        |
| **2. Nationwide scale (6-9 mo)** | 1 M pledges                           | \$0.30-\$0.40 CPA     | \$300-\$400 k                   |
| **3. Policy channel**            | Bill text + briefings (A4LI, caucus)  | —                   | parallel                        |
| **4. Must-pass vehicle**         | Fold into 2027 FDA User-Fee Act       | —                   | coalition                       |
...
| FDA inertia                           | Frame as **Phase IV modernization** rather than gutting FDA.                |
| Pharma incumbents                     | Seek endorsements from small-biotech and generics eager for cheaper trials. |

---

## Bottom-Line Feasibility Analysis
...
| Legislative path          | ✅ (2027 UFA or RTT-2.0)            | historical use of must-pass riders    |
| Execution risk            | ⚠️ needs milestones & single owner | see digital CPA cases                 |

**Conclusion:** With disciplined list-building (≤ \$0.50 CPA) and a must-pass legislative vehicle, an FDA-Upgrade / Right-to-Trial Act is realistically winnable.  The immediate next step—building a pledge engine and proving we can hit 10 k-plus verifiable constituents per target district—has clear precedent and modest cost.
...
3. **The 3.5 % rule is real.**
   Harvard's Erica Chenoweth shows that *active* engagement at that scale (≈ 12 M Americans) has been historically sufficient for transformative change every single time it's been reached.
