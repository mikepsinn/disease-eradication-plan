...
- `redirect-worker/` - a Worker that 301s ~29 legacy subdomains
  (`iab.warondisease.org`, `wager.warondisease.org`, `impact.dih.earth`, ...)
...
3. **dih.earth (optional).** `impact.dih.earth` and `models.dih.earth` are in
