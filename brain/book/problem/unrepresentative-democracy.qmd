...
lastStructureCheckHash: adace58b131682f72d3b28ebcc53eaefad11d9230ab556e4175a0d41229fae8e
...
<!-- TODO: STRUCTURE (DUPLICATION) - The section 'Regulatory Capture: How the Foxes Bought the Henhouse' (starting on line 350) is a significant duplication of the preceding section 'Regulatory Capture: How Industries Write Their Own Rules'. The first section is more comprehensive and should be the authoritative source. Recommend deleting this entire duplicated block (from line 350 to the end of the file). -->
...
The best investment in America isn't stocks or real estate. It's buying politicians. As detailed earlier, the return on investment for lobbying is astronomical, with studies showing returns as high as **1,813%**.
...
## Regulatory Capture: How the Foxes Bought the Henhouse
