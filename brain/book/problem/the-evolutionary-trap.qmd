...
Richard Dawkins said it best: ["We are survival machines—robot vehicles blindly programmed to preserve the selfish molecules known as genes."](../references.md#selfish-gene-dawkins)
...
- Each meal contains [3,800 available calories](../references.md#food-abundance-stats) (twice what you need)
...
Here's a fun fact: [15-30% of our ancestors died from violence](../references.md#prehistoric-violence-rates). Not disease. Not starvation. Other humans bashing their heads in with rocks.
...
- We spend [$2.7 trillion on weapons](../references.md#sipri-2024-spending) we'll probably never use
...
[Dunbar's number](../references.md#dunbar-number) says humans can maintain stable relationships with about 150 people. That's it. That's your monkeysphere.
...
[Evolution prepared us for scarcity, predators, and violence](../references.md#evolutionary-mismatch). We got abundance, safety, and Netflix. Our bodies are confused:

| What Evolution Prepared For | What We Got | Result |
|-------------------------|------------|--------|
| Starvation | Unlimited calories | [42.4% obesity rate](../references.md#obesity-epidemic-stats) |
...
- ❌ Nuclear weapons (enough to end civilization [67 times](../references.md#world-warheads))
- ❌ Climate change (whoops)
- ❌ Antibiotic resistance ([10 million annual deaths by 2050](../references.md#amr-10m-2050))
...
That's why we spent [$2.7 trillion](../references.md#sipri-2024-spending) on weapons while [cancer research got pocket change](../references.md#global-gov-med-research-spending).
...
- [More people die from falling out of bed than terrorism](../references.md#death-causes-vs-fear)
...
- **Social proof**: Get [3.5% participation](../references.md#3-5-rule) so everyone else follows
