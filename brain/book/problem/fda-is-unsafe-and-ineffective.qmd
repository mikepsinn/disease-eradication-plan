...
FDA trials cost **$41,000 per patient** ([source](../references.qmd#fda-trial-costs)).

That's **148X more expensive**.

The RECOVERY trial found dexamethasone saves lives. Time from start to result: 3 months.
...
We're not making this up. These are their own numbers.

## How We Got Here: The 1962 Disaster

This wasn't always the case. Before 1962, the U.S. had a decentralized, peer-reviewed system for testing drug efficacy run by the 144,000 physicians of the American Medical Association. The result was a stunningly linear 4-year increase in life expectancy, every single year.

Then came the Kefauver Harris Amendment of 1962. In response to the Thalidomide disaster (which happened in Europe, not the US), Congress centralized efficacy trials under the FDA.
...
That's more Americans than died in Vietnam and Korea combined. From one drug delay.
...
Companies are literally allowed to hide when drugs don't work. It's like casinos only having to report when people win.
...
The CDC's tests literally didn't work. You can't ensure quality of nothing.
