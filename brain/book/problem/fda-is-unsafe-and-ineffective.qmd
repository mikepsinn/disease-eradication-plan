...
In practice, we've seen a less absolutist interpretation of the mandate. So instead of rejecting all new treatments, we have simply exponentially increased the regulatory barrier.
...
![](../../figures/trial-access-disparity-chart.png){fig-alt="Column chart showing 5M enrolled, 1.2B willing to participate, 2.4B with uncured diseases - 240x unused capacity"}

Out of 2.4 billion people living with chronic disease, [only 5 million participate in trials annually](../appendix/clinical-trial-participants.qmd). That's **0.2%**.

The problem isn't that people don't want to help find cures. [Half of humanity is willing to participate](../references.qmd#patient-willingness-clinical-trials). We're turning away **99.6% of willing participants** because the system physically cannot scale beyond a few million people per year.

This isn't an access problem. It's a capacity problem. The FDA's system is so expensive ([$41,000 per patient](../references.qmd#trial-cost-41k) for pivotal trials) and so centralized (trials only at major medical centers) that it can only serve a tiny fraction of the people who need and want experimental treatments.
