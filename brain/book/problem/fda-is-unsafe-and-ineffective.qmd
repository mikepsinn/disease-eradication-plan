...
<!-- TODO: STRUCTURE (OTHER) - The math here is incorrect by a factor of 1,000. 50,000 lives/year over 10 years is 500,000 deaths, not 500. This is an embarrassing error that undermines the argument. -->
...
<!-- TODO: STRUCTURE (CONTRADICTION) - This repeats the 'per year' vs 'per decade' error. If the rate of '4 years per decade' was cut in half, the new rate is '2 years per decade,' not '2 years per year.' -->
