...
## The `{python} TRIAL_COST_REDUCTION_FACTOR`x Inefficiency Tax
...
The FDA's system is **`{python} TRIAL_COST_REDUCTION_FACTOR`x more expensive** and **36x slower**. This isn't a small difference. It's the difference between a functional system and a system designed to fail.
