...
Your DNA is [3 billion letters of code](../../../dih-economic-models/references.qmd#human-genome-and-genetic-editing). Not "like" code. It *is* code. We've learned to read it (the Human Genome Project) and we're learning to edit it (CRISPR). We are mechanics who have finally gotten our hands on the service manual.

Every day, your body proves it's a machine by running a maintenance routine that would make a German car engineer weep:

- You replace [330 billion cells daily](../../../dih-economic-models/references.qmd#cellular-turnover-rates).
- You repair [10,000 DNA damage events in every cell, every day](../../../dih-economic-models/references.qmd#cellular-turnover-rates).
- You rebuild your entire [skeleton every 10 years](../../../dih-economic-models/references.qmd#cellular-turnover-rates).
...
- **Lab-grown organs**: We've grown [bladders, windpipes, and blood vessels in labs](../../../dih-economic-models/references.qmd#regenerative-medicine-milestones) and installed them in humans. They work.
- **3D-printed body parts**: We print custom [titanium skulls, jaws, and ribs](../../../dih-economic-models/references.qmd#regenerative-medicine-milestones). A kid in Michigan has a [3D-printed windpipe](../../../dih-economic-models/references.qmd#regenerative-medicine-milestones) keeping him alive.
- **Regenerative medicine**: We can [regrow skin for burn victims, cartilage for damaged joints](../../../dih-economic-models/references.qmd#regenerative-medicine-milestones), and we're working on teeth.
...
In 2006, [Shinya Yamanaka figured out how to turn adult cells back into stem cells](../../../dih-economic-models/references.qmd#yamanaka-factors-cellular-reprogramming). Any cell. From anywhere in your body. Back to factory settings.
...
We [won a Nobel Prize](../../../dih-economic-models/references.qmd#yamanaka-factors-cellular-reprogramming) for figuring this out. We're just getting started using it.

### Exhibit C: We're Debugging Your Code

Gene therapy is literally debugging human software:

- **[Luxturna](../../../dih-economic-models/references.qmd#landmark-gene-therapies)** (2017): Fixes blindness caused by mutated RPE65 gene. One injection. Sight restored.
- **[Zolgensma](../../../dih-economic-models/references.qmd#landmark-gene-therapies)** (2019): Fixes spinal muscular atrophy. Babies who would die before age 2 now walk.
- **[CAR-T therapy](../../../dih-economic-models/references.qmd#landmark-gene-therapies)** (2017): Reprograms your immune system to hunt cancer. Complete remission in "incurable" cases.
...
- **Hydra**: Freshwater polyps that are [biologically immortal](../../../dih-economic-models/references.qmd#biological-immortality-in-nature).
- **Planarian worms**: Cut one in half, get two worms. [Both younger than the original](../../../dih-economic-models/references.qmd#biological-immortality-in-nature).
- **Axolotls**: [Regrow entire limbs, parts of their brain, heart tissue](../../../dih-economic-models/references.qmd#biological-immortality-in-nature). No scarring.
- **Naked mole rats**: [Live 10x longer than similar-sized mammals. Don't get cancer](../../../dih-economic-models/references.qmd#biological-immortality-in-nature).
- **Bowhead whales**: [Live 200+ years](../../../dih-economic-models/references.qmd#biological-immortality-in-nature) with no signs of age-related disease.
...
[David Sinclair's lab at Harvard made old mice young again](../../../dih-economic-models/references.qmd#reversal-of-aging-in-mice-sinclair):
...
Scientists identified [nine "hallmarks of aging."](../../../dih-economic-models/references.qmd#hallmarks-of-aging) Every one is a mechanical problem with a mechanical solution:
...
The [Manhattan Project cost $28 billion (adjusted for inflation)](../../../dih-economic-models/references.qmd#manhattan-project-cost-30b) and took 3 years. Result: Nuclear weapons.

Humans spend [$68 billion per year globally](../../../dih-economic-models/references.qmd#global-gov-med-research-spending) on all medical research combined. For everything. Cancer, Alzheimer's, heart disease, aging, rare diseases - everything.
