...
- Continuing to spend `{python} format_billions(MILITARY_SPENDING)` on weapons while sitting on 13,000 nuclear warheads, enough to cause an extinction-level event 130 times over.
