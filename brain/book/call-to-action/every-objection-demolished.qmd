...
- 10% of `{python} format_billions(CAPTURED_DIVIDEND)` yearly inflows
...
**Objection**: "You create a `{python} format_billions(CAPTURED_DIVIDEND)` fund, politicians will redirect it to their friends."
