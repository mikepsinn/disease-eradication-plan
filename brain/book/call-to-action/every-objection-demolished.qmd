...
- We're capturing value from a $109T disease burden. The economic benefits work out to over $7.5 million per person globally over a 50-year period (`{python} format_billions(TOTAL_COMPLETE_BENEFITS)` annual benefit ÷ 8B people = $152K/person/year)
...
Here's how you do it: you raise a [`{python} format_billions(CAMPAIGN_TOTAL_COST)` war chest through VICTORY Bonds](../economics/victory-bonds.qmd), then allocate [$250 million specifically for lobbying](../economics/campaign-budget.qmd#ai-assisted-lobbying-250m-25) - enough to completely overwhelm the defense industry's $300 million annual spend. Then, you go to the same K-Street lobbying firms the defense contractors use, and you outbid them for their top talent.
...
- Need `{python} format_billions(CAMPAIGN_TOTAL_COST)` bonds to fund campaign
