...
This is the same economic logic from [the Economic Case chapter](../economics.qmd)—which showed `{python} format_billions(TOTAL_COMPLETE_BENEFITS)` annual benefits from the initial 1% treaty—but scaled up to a 50% redirection over 25 years. Same principles, bigger numbers.
