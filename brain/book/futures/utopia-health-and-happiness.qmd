---
title: 🌈 Wishonia
description: The World After We Choose Life Over Death - A tour of humanity's future when we decide that curing disease is more fun than causing it
published: true
tags:
  - utopia
  - future
...
So the kingdom of England was invented when some guy just said, hey guys, god told me there's this thing called England and I'm in charge and you're all my serfs now.

And everyone was like, ok, I guess he knows what he's talking about.

So you can also create kingdoms.

## How to Create Wishonia

**Step 1:** Declare that Wishonia exists and you are a citizen.

**Step 2:** State the basic principles:

- All humans deserve Super-Intelligence, Super-Longevity, and Super-Wellbeing
- Curing people should be more profitable than killing them
- We redirect military spending to health research

**Step 3:** Sign the [1% Treaty](../solution/1-percent-treaty.qmd) and get others to sign it.

That's it. That's how you start a movement.

### 2026: The First Year

The [1% Treaty](../solution/1-percent-treaty.qmd) becomes Wishonia's founding document.
The [global referendum](../strategy/global-referendum.qmd) gets 500 million signatures in six months.

Defense contractors initially resist until they see the [VICTORY Bonds](../economics/victory-bonds.qmd) returns: `{python} format_percentage(VICTORY_BOND_ANNUAL_RETURN_PCT)` annual yield.
Lockheed Martin starts making MRI machines instead of missiles.
Even Congress understands `{python} format_percentage(VICTORY_BOND_ANNUAL_RETURN_PCT)` returns.

### 2028: The 2% Revelation

Here's the funny thing about not dying: it's addictive.

Once people saw what `{python} format_billions(TREATY_ANNUAL_FUNDING)` in redirected military spending could do - [15 new treatments in the first year](../references.qmd#recovery-trial) - they wanted more.
...
![Robot lab scientist conducting research](../../../assets/robot-lab-scientist.png)

![Rate of medical progress with AI scientists: exponential acceleration](../../../assets/rate-of-medical-progress-with-ai-scientists.jpg)

![The value of automating research: why AI changes everything](../../../assets/value-of-automating-research.jpg)
...
Global military spending: $2.565 trillion (down from $2.7 trillion via the 5% treaty)
Global health research spending: $203 billion (up from $68 billion, fueled by the $135B redirected from military budgets)
...
**7:00 AM:** Breakfast is whatever you want. The [Outcome Labels](../solution/dfda.qmd#outcome-labels) on everything tell you exactly how each food affects YOUR body. Turns out, for your genetics, dark chocolate improves cognitive function by 23%. You adjust your IQ to 80 for watching morning news, then back to 200 for work. Science is remarkable. And adjustable.
...
Let's talk money, because even in utopia, economics matters. This wasn't based on utopian hope but a pragmatic understanding of incentives. As the DIH's budget grew from `{python} format_billions(TREATY_ANNUAL_FUNDING)` to over a trillion, the world's economic gravity shifted. The best scientists and biggest investors saw far greater returns in curing Alzheimer's than in building a better fighter jet. Peace became, for the first time in history, ridiculously profitable.
...
This is the same economic logic from [the Economic Case chapter](../economics.qmd)—which showed `{python} format_billions(TOTAL_COMPLETE_BENEFITS_ANNUAL)` annual benefits from the initial 1% treaty—but scaled up to a 50% redirection over 25 years. Same principles, bigger numbers.
