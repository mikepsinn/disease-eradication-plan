...
Defense contractors initially resist until they see the [VICTORY Bonds](../economics/victory-bonds.qmd) returns: 271.8% annual yield.
Lockheed Martin starts making MRI machines instead of missiles.
Even Congress understands 271.8% returns.

### 2028: The 2% Revelation

Here's the funny thing about not dying: it's addictive.

Once people saw what $27.2B in redirected military spending could do - [15 new treatments in the first year](../references.qmd#recovery-trial) - they wanted more.
...
This is the same economic logic from [the Economic Case chapter](../economics.qmd)—which showed $1.2T annual benefits from the initial 1% treaty, but scaled up to a 50% redirection over 25 years. Same principles, bigger numbers.
...
*P.P.S. - If you choose Genie, there's a party in 2050. You're invited. You'll still be alive. Bring potato salad.*
