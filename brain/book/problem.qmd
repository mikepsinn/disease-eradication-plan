...
[Every single day, 150,000 humans stop being alive](./problem/the-daily-massacre.qmd). That's fifty September 11th attacks. Every. Single. Day.

But instead of treating this like the emergency it is, we've decided the real threat is that someone, somewhere, might have slightly different colored skin or worship a slightly different imaginary friend. So naturally, we spend [$2.7 trillion annually](./problem/cost-of-war.qmd) on elaborate machines designed to make the dying happen faster.
...
That's right. Zero. Zilch. Nada. The big goose egg.
...
The Oxford RECOVERY trial proved we could test treatments for $500 per patient. The FDA demands $41,000. That's not a rounding error. That's systemic sabotage with a government seal of approval.

## The War Budget: Humanity's Death Wish Retirement Fund

We spend [$2.7 trillion every year](./problem/cost-of-war.qmd) on things specifically designed to make humans stop breathing. This includes:
...
While we're burning money on bombs, disease is running a [$109.1 trillion annual tab](./problem/cost-of-disease.qmd). That's:
...
[We spend 40 times more on killing than curing](./problem/the-119-trillion-death-toilet.qmd). Let that sink in.
...
Every regulatory agency is run by the industry it's supposed to regulate. [It's not a bug; it's a feature](./problem/regulatory-capture.qmd).
...
The bad news? We probably won't, because there's something good on Netflix and choosing is hard.

But just in case you're tired of living in a world where we're all marching toward preventable death while arguing about which flag to wave, [there's a solution](../solution.qmd). It's absurdly simple. It's mathematically proven. It's economically profitable.
