...
# Part I: The Problem
*Understanding the Problem You're Going to Fix*

---

## Overview: A Guided Tour of How Humanity Chose Death

*In Which We Examine Why Everyone You Love Is Dying While We Build Skynet*
...
Every single day, 150,000 humans stop existing because of diseases we could probably cure if anyone was paying attention. 

I tried to imagine what 150,000 people looks like. It's like if you took everyone in a decent-sized stadium and deleted them. Then did it again tomorrow. And the day after that. Forever.
...
When one thing kills 3,000 people, it's a tragedy and we start wars. When diseases kill 50 times that every day, it's called "natural causes," which is Latin for "we couldn't be bothered."

If aliens were studying us, they'd probably conclude we can't count past 3,000.
...
For comparison, imagine if you spent $2,700 on guns and $68 on food. Your neighbors would stage an intervention. But when humanity does it, we call it "defense spending" and give everyone medals.
...
They say a trillion is just a number. But it's the number of dollars we lost that could have funded medical research for thirty-seven years. Give or take a few hospitals.
...
To be clear, they've learned lots of interesting things about how diseases work. They just haven't gotten around to the part where people stop dying from them. It's like spending fifty years studying how cars work without ever actually driving anywhere.

The NIH tests about 5,000 treatment combinations per year. There are 166 billion possible combinations. At this rate, they'll be done by the year 33,200,000. Mark your calendars.
...
It takes seventeen years and $2.6 billion to get a drug through FDA approval. Seventeen years. That's longer than it took to build the pyramids, and those involved moving rocks the size of houses without machinery.

During the Oxford RECOVERY trial, they tested treatments on 40,000 patients for $500 per person. The FDA's process costs $41,000 per patient. That's 82 times more expensive for the same result, except slower.
...
![](../../figures/trial-access-disparity-chart.png){fig-alt="Column chart showing unused capacity: 5M who get access, 1.2B willing to participate, 2.4B with uncured diseases"}

Out of 2.4 billion people suffering from chronic disease right now, only [5 million get to participate in clinical trials annually](appendix/clinical-trial-participants.qmd). That's 0.2%. The other 99.8% get to suffer and wait.

Half of humanity would volunteer if asked. We're turning away 99.6% of willing participants.
...
When you want healthcare, you have approximately zero dollars to lobby with because you spent it all on healthcare.
...
Medical research funding has increased 10X in dollars but decreased as a percentage of GDP. This is because we're printing money for weapons faster than we're printing money for cures.
...
Now that you understand the problem—which is to say, now that you're appropriately horrified—you can learn how to fix it.
