...
lastStructureCheckHash: f2e5cdea9e3e55e9216de18f1e1879026fd24f6cf899195d68a49be786e0a1b3
---
...
Deploy the $1B raised according to the [Campaign Budget](campaign-budget.qmd):
...
"This is political arbitrage - high risk, high reward.

If the treaty fails:

- Your investment is lost (spent on the campaign)
- This is venture-level political risk
- You're betting $1B can redirect $27B/year

Even partial success still pays well:

- 50% treaty adoption = 130% annual returns
- US + EU alone = $13B/year
- Still beats every traditional investment

The upside justifies the risk:

- Full success: 270% perpetual returns
- Partial success: 130%+ returns
- Total failure: You lose, but at least you tried to fix the system"
