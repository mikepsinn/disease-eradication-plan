...
Create a funding mechanism that raises `{python} format_billions(TREATY_CAMPAIGN_TOTAL_COST)` to finance the [1% Treaty](../appendix/1-percent-treaty.qmd) campaign through perpetual revenue-sharing bonds.
