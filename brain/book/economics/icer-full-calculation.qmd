...
**Bottom Line**: The 1% Treaty + dFDA Infrastructure is a **dominant health intervention** that saves society **$5.87 million per life saved** (ICER = -$167,771 per QALY).
...
1. **Countries redirect $27B/year** from military budgets to DIH treasury
2. **DIH treasury allocates**:
...
4. The intervention is dominant even with costs included
...
- **1% Treaty + dFDA**: Society SAVES $5.87 million per life saved. This is a dominant intervention that generates wealth while saving lives. The stacked bar shows contributions from both the peace dividend (1% less conflict) and dFDA R&D savings.
...
- **1% Treaty + dFDA**: Generates $147.1B in annual economic benefits ($97.1B peace dividend + $50B dFDA R&D savings). This is nearly 10× larger than childhood vaccinations, one of the most successful interventions in history.
