...
- VICTORY bonds: 40-`{python} format_percentage(VICTORY_BOND_ANNUAL_RETURN_PCT)` returns (better than weapons)
...
| VICTORY Bonds | 40-`{python} format_percentage(VICTORY_BOND_ANNUAL_RETURN_PCT)` | "Saved humanity" |
...
|--|--------------|--------------|
| You Invest | 40-`{python} format_percentage(VICTORY_BOND_ANNUAL_RETURN_PCT)` returns | 40-`{python} format_percentage(VICTORY_BOND_ANNUAL_RETURN_PCT)` returns |
...
- Get 40-`{python} format_percentage(VICTORY_BOND_ANNUAL_RETURN_PCT)` returns forever
