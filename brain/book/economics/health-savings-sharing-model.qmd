...
Here's the simple fix: When a company cures a disease, they get `{python} format_percentage(TRIAL_COST_REDUCTION_PCT)` of the healthcare costs that would have been spent treating it.
