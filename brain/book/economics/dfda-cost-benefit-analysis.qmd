...
- **Oxford RECOVERY**: Achieved [**~\$500 per patient**](../reference/recovery-trial.qmd). Key strategies included:
...
2. **Volume of Trials & Speed**
   ...
   - Crowdsourced funding mechanisms, like those established by the [Decentralized Institutes of Health (DIH)](../strategy/1-percent-treaty/decentralized-institutes-of-health.qmd), can further reduce patient costs and direct resources to high-value research.
...
- **Source/Rationale**:
  ...
  - The UK RECOVERY trial, a prime example of efficient trial design akin to dFDA principles, achieved cost reductions of ~80-98% per patient compared to traditional trials (<!-- [RECOVERY trial](../reference/recovery-trial.qmd) -->, citing Manhattan Institute and NCBI).
...
*(Optional: A note could be added here that specific programs *built upon* the dFDA Infrastructure, if they incur additional marginal costs, would then be evaluated for their own cost-effectiveness. However, they would benefit from the already cost-saving nature of the underlying dFDA infrastructure.)*
...
- **Parameters:**
  ...
  - $T_{\text{accel}}$: Average years of acceleration per drug.
    - **Rationale:** The dFDA model, inspired by hyper-efficient trials like the [RECOVERY trial](./../reference/recovery-trial.qmd), can drastically cut development timelines from years to months.
    - **Source:** The [RECOVERY trial](./../reference/recovery-trial.qmd) demonstrated unprecedented speed in generating clinical results.
    - **Quote:** "Days to First Major Result: <100" — [The Conversation, via dFDA Wiki](../reference/recovery-trial.qmd)
