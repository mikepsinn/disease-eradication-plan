...
- **Public-Facing Target (The "Hook"):** For marketing and high-level communications, we will lead with a simple, audacious, and mathematically defensible target:
  ...
  This message is designed to be memorable, signal the massive scale of the opportunity, and is credibly backed by our [Investment Thesis](/brain/book/economics/victory-bond-investment-thesis.qmd) and [Dynamic Cash Flow Model](/brain/book/economics/dih-treasury-cash-flow-model.qmd).
