...
**Why Delaware:** Established corporate law. [More corporations than humans live there](../references.qmd#delaware-corporate-population). Citizens United means corporations have political speech rights.
...
**The Beauty:** Same structure used by most sophisticated social movements (ACLU, NRA, Planned Parenthood). Each entity only does what's perfectly legal in its jurisdiction. Combined, they do what's impossible with single structure.
...
**US Political Operations:** Completely separate entities for US election activities. Only Americans fund, only Americans control. This isn't optional - [foreign nationals cannot fund US elections](../references.qmd#fec-foreign-nationals), and violating this means federal prison, not fines.
...
**Tech-Forward Development:** Platform built where digital governance actually works (Estonia with [e-Residency](../references.qmd#estonia-eresidency-stats), Singapore, etc.). Pick jurisdictions where government understands the internet exists.

The beauty: When one regulator attacks, others provide safe harbor. When one government restricts, others enable. It's regulatory arbitrage for good instead of evil. Don't marry specific jurisdictions - regulatory environments change. Marry the strategy of geographic diversification.
...
- [Plus up to 35 sophisticated non-accredited](../references.qmd#sec-investor-limit-private-offering)
