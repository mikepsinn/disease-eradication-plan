...
A detailed breakdown of the `{python} format_billions(CAMPAIGN_TOTAL_COST)` Use of Funds is available in the [Campaign Budget](../economics/campaign-budget.qmd) chapter. Be specific. Vague use of funds = SEC investigation.
