...
- Defense contractors lose [`{python} format_billions(MILITARY_SPENDING)`/year](../references.qmd#sipri-2024-spending)
...
- Keep spending `{python} format_billions(TOTAL_WAR_COST)` on War on Humanity (never win)
