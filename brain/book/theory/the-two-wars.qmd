...
```
[1]: ../references.qmd#sipri-2024-spending
[2]: ../references.qmd#war-deaths-indirect-14m-annually

### War on Disease (Current)
```python
annual_spending = 68_000_000_000 # [1]
annual_deaths = 55_000_000 # [2]
victory_condition = None  # No end state (pharma wants recurring revenue)
years_to_victory = float('inf')  # Never
```
[1]: ../references.qmd#global-gov-med-research-spending
[2]: ../references.qmd#who-daily-deaths
...
The [1% Treaty](../solution/1-percent-treaty.qmd) + DIH + [dFDA](../solution/dfda.qmd) creates the **first War on Disease designed for victory**.
