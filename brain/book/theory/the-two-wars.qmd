...
lastLatexCheckHash: 79916d980bcb59927bcdcc28b797dc469372339946c6dbfa8cb3f18edd5c068f
---
...
- [13,000 nuclear weapons](../references.qmd#world-warheads) (can [destroy Earth 20 times](../appendix/nuclear-weapon-cost-and-casualties.qmd))
...
**Cost**: `{python} format_billions(TREATY_ANNUAL_FUNDING)`/year (1% of military budget)
...
- Defense contractors lose [`{python} format_billions(GLOBAL_MILITARY_SPENDING_ANNUAL_2024)`/year](../references.qmd#sipri-2024-spending)
...
- Keep spending `{python} format_billions(GLOBAL_ANNUAL_WAR_TOTAL_COST)` on War on Humanity (never win)
