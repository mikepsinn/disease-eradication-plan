...
People with VICTORY instruments in the DIH use **Random Aggregated Pairwise Preference Allocation (RAPPA)** to vote on which solutions to fund.
...
For the DIH, this function is performed by the **Decentralized FDA (dFDA)** protocol.
