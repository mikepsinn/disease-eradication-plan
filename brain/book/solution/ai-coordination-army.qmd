...
Humans evolved to coordinate hunting parties of 20 people. We're now trying to coordinate millions. Our brains literally can't do it, we max out at [150 relationships (Dunbar's number)](../dih-economic-models/references.qmd#dunbar-number-150).
...
```{python}
#| echo: false
#| fig-cap: "AI Coordination Architecture - Three-layer hierarchy from global network to individual task agents"
