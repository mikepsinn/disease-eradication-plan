...
<!-- TODO: STRUCTURE (DUPLICATION) - The outline shows this entire 'Spillover Victory' section is also in the 'Aligning Incentives' chapter. This is gross duplication that looks like a copy-paste error. RECOMMEND: Keep the full section here, as it fits the high-level strategy. In 'Aligning Incentives', replace it with a brief summary and a cross-reference to this chapter. -->
