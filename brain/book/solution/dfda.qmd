...
![A diagram showing how causal clues can be inferred from data.](../../../assets/causal-clues-1024x652.png)
...
We can then apply [Hill’s criteria for causation](http://www.drabruzzi.com/hills_criteria_of_causation.htm) to quantify the likelihood of a causal relationship.

#### Meta-Analyses Support Real-World Evidence

Modern statistical methods make a difference. A [meta-analysis in the New England Journal of Medicine](https://www.nejm.org/doi/full/10.1056/NEJM200006223422506) found that:
