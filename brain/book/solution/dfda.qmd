...
The dFDA achieves [**`{python} TRIAL_COST_REDUCTION_FACTOR`x More Efficiency**](../references.qmd#recovery-trial-`{python} TRIAL_COST_REDUCTION_FACTOR`x-cost-reduction) through:
