...
Right now, you still need money to keep the lights on and fund the $100M global referendum campaign. Your agents help with this:
...
The key: Coordination prevents waste. Instead of 500 cancer nonprofits all applying to the Gates Foundation for the same thing, your agents coordinate: "Org A applied for X, Org B apply for Y." This is how you raise the $100M for the referendum while cutting fundraising costs 50%.

Once the treaty passes? Your agents shift to allocating the $27B from Wishocracy instead of begging foundations. But until then, we still live in the old world where money doesn't magically appear.
