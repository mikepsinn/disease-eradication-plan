...
Once the treaty passes? Your agents shift to allocating the `{python} format_billions(CAPTURED_DIVIDEND)` from Wishocracy instead of begging foundations. But until then, we still live in the old world where money doesn't magically appear.
