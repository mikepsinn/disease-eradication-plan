...
**For Economists**:
"[The ROI is `{python} format_roi(ROI_ALL_DIRECT_BENEFITS)`](../economics.qmd#the-complete-case-1-222-1-roi-all-direct-benefits). It's the single greatest economic opportunity in human history."
