...
[The 1% Treaty](../solution/1-percent-treaty.qmd) is based on kindergarten logic so simple that world leaders might actually understand it:
...
- UK: $686 million ([Brexit cost more per day](../references.qmd#daily-cost-of-brexit))
...
So does medical research. [More, actually](../references.qmd#job-creation-military-vs-medical-research).
And the workers don't get PTSD.
