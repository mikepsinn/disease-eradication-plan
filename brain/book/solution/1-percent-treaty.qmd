...
1.  **The Problem:** The world spends [$2.7 trillion a year](../../../dih-economic-models/references.qmd#global-military-spending-2-44t) on military forces to maintain a delicate balance of power.
...
2.  **Execution:** DIH subsidizes patient participation in the [dFDA](dfda.qmd)—clinical trials that are **[80x cheaper](../../../dih-economic-models/references.qmd#recovery-trial-82x-cost-reduction)** than current model
...
![Global military spending by region showing the $2.7 trillion humans spend annually on weapons instead of cures](../../../assets/global-military-spending-chart.png)
...
Sometimes they work (we haven't had World War III yet). Sometimes they don't (we've had [about 200 other wars](../../../dih-economic-models/references.qmd#wars-since-1945)). But they're the only tool we have for getting countries to do anything together besides kill each other.
...
- USA: $8.86 billion (won't even notice, [they've failed to account for over $2.46 trillion](../../../dih-economic-models/references.qmd#pentagon-unaccounted-money))
- China: $2.96 billion ([what they spend on military parades](../../../dih-economic-models/references.qmd#china-military-parade-cost))
...
{{< include ../../../dih-economic-models/figures/one-percent-treaty-top-country-contributions-column-chart.qmd >}}
...
1. **Pandemics**: [COVID killed more Americans than World War II, Korea, and Vietnam combined](../../../dih-economic-models/references.qmd#covid-deaths-vs-us-war-deaths)
2. **Cancer**: [Kills 10 million globally per year](../../../dih-economic-models/references.qmd#cancer-deaths-10m-annually)
3. **Heart Disease**: [18 million annual deaths](../../../dih-economic-models/references.qmd#death-causes-vs-fear)
...
6. **Mental Health Crisis**: [More people kill themselves than die in wars](../../../dih-economic-models/references.qmd#suicide-deaths-vs-war-deaths)
...
2. **Terrorists**: [Kill fewer people than furniture accidents](../../../dih-economic-models/references.qmd#furniture-accidents-vs-terrorism-deaths)
...
**For Economists**:
"[The ROI is 1,239:1](../../../dih-economic-models/economics/economics.qmd#the-complete-case-1-222-1-roi-all-direct-benefits). This beats every other public health intervention on record."
...
Right now, [only 5 million people participate in trials annually](../../../dih-economic-models/appendix/clinical-trial-participants.qmd) out of 2.4 billion with chronic disease. The 1% Treaty changes this:

#### Current System

- [Pivotal trials: $41,000 per patient](../../../dih-economic-models/references.qmd#trial-cost-41k)
...
- [Pragmatic trials: $500 per patient](../../../dih-economic-models/references.qmd#recovery-cost-500) ([82x cheaper](../../../dih-economic-models/references.qmd#recovery-trial-82x-cost-reduction))
...
WHEREAS, humanity spends [$2.7 trillion annually](../../../dih-economic-models/references.qmd#sipri-2024-spending) on methods of killing itself;

WHEREAS, this seems somewhat counterproductive;

WHEREAS, [diseases kill more people than all wars combined](../../../dih-economic-models/references.qmd#pandemics-vs-wars) and don't even have the decency to be quick about it;
