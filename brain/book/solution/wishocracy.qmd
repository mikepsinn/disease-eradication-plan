...
Congratulations! You've passed the [1% Treaty](../solution/1-percent-treaty.qmd) and now you've got `{python} format_billions(TREATY_ANNUAL_FUNDING)`/year to allocate.

How do you avoid parasitic special interests from stealing it or bureacracy from wasting it all?

**Wishocracy** is a system of resource allocation that replaces committees with code and representatives with mathematics. It's how you let 8 billion people collectively decide how to spend $27 billion without it turning into a bureaucratic nightmare.

---

## The Magic: The Pairwise Smackdown

The core of Wishocracy is a voting method so simple, even a congressman could do it. It's called Aggregated Pairwise Preference Allocation, but we'll call it the **Pairwise Smackdown**.
...
Instead of asking, "Rank these 10,000 problems," we ask:
...
Once the Pairwise Smackdown tells us that "Curing Alzheimer's" is a top priority, Wishocracy translates that priority into action.
