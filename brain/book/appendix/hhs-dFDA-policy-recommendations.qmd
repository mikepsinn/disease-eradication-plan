---
title: 📋 HHS Policy Recommendations
description: For Disease Eradication - Proposes a decentralized FDA system that increases trial capacity, reduces costs, and accelerates patient access without legislative changes.
published: true
tags:
  - clinical-trials
  - decentralized-fda
  ...
  - cost-efficiency
lastFactCheckHash: 93e194b274dcab5da56d340a67b0013bd080b93ee2fc8a416c8261e03214d43d
lastInstructionalVoiceHash: 4d34b2f77135e0e444066de65a994b14de14e83c3cf6ffd08aad805655c538f2
---
...
5. **Use Medicare and Medicaid for Trial Access:** Use existing laws that let beneficiaries join qualifying clinical trials ([CMS Medicare Policy](https://www.cms.gov/medicare/coverage/approved-facilities-trials-registries/clinical-policies), [Medicaid Clinical Trial Coverage Act](https://www.medicaid.gov/federal-policy-guidance/downloads/smd21005.pdf)).
...
7. **Expand Adaptive and Pragmatic Trials:** Use NIH funding and Medicare/Medicaid reimbursements to sponsor adaptive trials that can grow and generate real-world data cheaply.
8. **Government Co-Funding and Outcome-Based Payment Models:** Use milestone-based payments and alternative payment models through CMMI to get private companies involved.
...
- **Prize Structure:**
  ...
  - $150M distributed among teams running perpetual trials that work at scale.
  - $100M in milestone prizes for critical technological breakthroughs.

- **Key Requirements:**
  - Open-source codebase.
  - Easy patient onboarding and participation.
...
- **Works Long-Term:** Aligning government and private-sector incentives makes this self-sustaining.

# Evidence of Congressional and Executive Branch Support

Here's a list of laws, executive actions, and precedents showing long-standing support for modernizing the FDA without needing new legislation:

1. **[FDA Modernization Act of 1997 (FDAMA)](../references.qmd#fdama-1997)**
...
2. **[FDA Amendments Act (FDAAA) of 2007](../references.qmd#fdaaa-2007)**
...
3. **[FDA Safety and Innovation Act (FDASIA) of 2012](../references.qmd#fdasia-2012)**
...
4. **[21st Century Cures Act (2016)](../references.qmd#21st-century-cures-act-2016)**
...
5. **[Right to Try Act (2018)](../references.qmd#right-to-try-act-2018)**
...
6. **[Medicare Clinical Trial Coverage Provisions (Social Security Act Amendments)](../references.qmd#medicare-clinical-trial-coverage-provisions)**
...
7. **[NIH All of Us Research Program](../references.qmd#nih-all-of-us-program)**
...
8. **[U.S. Digital Service (USDS) and 18F Initiatives](../references.qmd#usds-18f-initiatives)**
...
9. **[Executive Orders on Regulatory Reform](../references.qmd#executive-orders-regulatory-reform)**
...
10. **[Trump Administration's Department of Government Efficiency](../references.qmd#wikipedia-doge)**
...
- **De-Risking Radical Ideas:** The prize model encourages moonshot thinking that traditional funding mechanisms avoid, accelerating major breakthroughs in clinical trial methodologies.
...
- 50.0% reduction in per-patient costs
