...
- **Scale:** [\`{python} format_billions(CAPTURED_DIVIDEND)` annually](peace-dividend-calculations.qmd) could fund more climate action than most environmental organizations' combined budgets
...
- **Democratic Governance:** [\`{python} format_billions(CAPTURED_DIVIDEND)` treasury](../economics/victory-bonds.qmd) controlled by global citizens, not corrupt governments
...
- **Scale:** \`{python} format_billions(CAPTURED_DIVIDEND)` annually = 40% increase in [global health research funding](../references.qmd#global-gov-med-research-spending)
...
A: Keep your mission. Change your method. Environmental groups can do environmental work with \`{python} format_billions(CAPTURED_DIVIDEND)` in funding instead of \$27M.
