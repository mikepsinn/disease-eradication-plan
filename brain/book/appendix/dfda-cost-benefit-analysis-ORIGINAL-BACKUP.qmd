...
- **Saves ~[\$50 Billion Annually](#gross-r-d-savings-from-dfda-implementation)**: Reduces global clinical trial costs (~[\$100B/year market](../references.qmd#clinical-trial-spending)) by a baseline of **[50%](#gross-r-and-d-savings-from-dfda-implementation)**, with up to **[95%](#gross-r-and-d-savings-from-dfda-implementation)** savings in optimal scenarios.
