...
lastToneElevationWithHumorHash: 1cbb6011d9d0b1d89300252f896d61f2ca5a942a8ab52ea0e7a387fb2f8bc017
lastInstructionalVoiceHash: 534fe8bf798fedc6b0a77c2e143163fd8452854b30427a140571bafba795ee8d
---
...
This document outlines how you apply mechanisms similar to those used for DOGE to establish the dFDA, acknowledging the significant legal and funding challenges inherent in such an approach.
...
2. **Repurposing Existing Infrastructure & Expertise:**
   ...
   - Instead of creating a new agency from scratch, the EO could designate an existing entity or component within HHS (e.g., parts of FDA's digital health center, [ONC](../references.qmd#onc-healthit), or using infrastructure/teams from the [_All of Us_ Research Program](../references.qmd#nih-all-of-us-program)) as the core dFDA Infrastructure operator, potentially renaming it.
   - This uses existing budgets, personnel slots, and infrastructure, mirroring the USDS transformation into the U.S. DOGE Service.
...
- **The dFDA offers a Method, Not a New Goal:** The dFDA Infrastructure represents a potentially notable _method_ for achieving the existing, congressionally mandated goals of these Institutes – finding effective treatments – but doing so faster, cheaper, and at a larger scale.
...
- **The Deal:** Each Institute keeps focusing on its disease (cancer, heart disease, aging) but they all use the same cheap, fast platform for running trials. Same money, better results.
...
- Reallocating 50.0% of savings from automated trial oversight to FDA operations.
...
- **Global, real-time data sharing** gives everyone, patients, researchers, governments, access to what actually works.
