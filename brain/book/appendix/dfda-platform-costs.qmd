...
- **Other DCT Platform Companies:** [Other companies in the space](../references.qmd#dct-platform-funding-others), such as **Science 37** (~`{python} format_millions(DFDA_ANNUAL_OPEX)` raised), **Thread** (up to \$50M raised), and **uMotif** (~\$25.5M raised), show that significant traction and platform development can be achieved with investments in the tens of millions.
