...
- **Other DCT Platform Companies:** [Other companies in the space](../references.qmd#dct-platform-funding-others), such as **Science 37** (~$40M raised), **Thread** (up to \$50M raised), and **uMotif** (~\$25.5M raised), show that significant traction and platform development can be achieved with investments in the tens of millions.
...
The **5M MAU** target is an illustrative milestone used for these initial ROM estimates, not the ultimate goal for the platform, which is to support hundreds of millions or billions of users. At this initial scale, we can analyze the cost on a per-user basis.
