...
**Response:** Our financing follows two simple rules, not the usual Wall Street bullshit. We're not making money by gambling on stocks or crypto. We're making money by taking a tiny slice of the [`{python} format_billions(TOTAL_ENDGAME_BENEFITS)` humanity wastes on violence every year](../references.qmd#global-violence-costs).
