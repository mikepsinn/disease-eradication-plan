...
**Response:** Our financing follows two simple rules, not the usual Wall Street bullshit. We're not making money by gambling on stocks or crypto. We're making money by taking a tiny slice of the [$16.5 trillion humanity wastes on violence every year](../references.qmd#global-violence-costs).

The model targets a **270%/year return** for investors, compared to the best hedge funds, while guaranteeing at least 50% of income for the mission. Even in a partial success scenario (e.g., US/EU/UK adoption), the model provides a **year-one cash payout of 2.6X the initial investment**.
