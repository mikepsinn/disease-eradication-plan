...
- **For Scientists & Research Institutions:** Joining means access to a new, `{python} format_billions(CAPTURED_DIVIDEND)`+ annual pool of research funding, an amount that can double or triple the research budgets of entire nations.
