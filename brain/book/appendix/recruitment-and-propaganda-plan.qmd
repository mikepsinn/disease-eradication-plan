...
These are the capitalists who smell `{python} format_percentage(VICTORY_BOND_ANNUAL_RETURN_PCT)` returns and start salivating. They have money, they want more money, and they're willing to bet on humanity not going extinct to get it.
...
- Test "`{python} format_percentage(VICTORY_BOND_ANNUAL_RETURN_PCT)` Returns" vs "Save Humanity" (money wins)
