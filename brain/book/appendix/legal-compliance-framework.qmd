...
```{python}
#| echo: false
#| fig-cap: "Multi-Entity Legal Structure - Three entities with separate funding sources and purposes"
...
**Primary Purpose:** Run the global referendum/survey to demonstrate 3.5% support (280M+ verified participants) and build broad public understanding through non-partisan research and education.

#### Permitted Activities

- Running the non-binding global referendum/survey on War and Disease
- Publishing white papers, economic models, and strategic documents (like this book)
- Developing and maintaining public-facing website, referendum platform, and educational materials
- Hosting forums, webinars, and workshops
- Conducting non-partisan analysis and research
- Hiring staff for research, communications, educational programs, and referendum operations

**Funding:** Tax-deductible donations from individuals and foundations.

**Limitations:** Strictly prohibited from substantial lobbying or partisan political activity. The referendum must be non-binding and educational, demonstrating public will without telling politicians what to do.
