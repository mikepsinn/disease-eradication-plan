...
captured_dividend = CAPTURED_DIVIDEND
societal_dividend = SOCIETAL_DIVIDEND
...
2. **Two-Tier Benefits**:
   ...
   - **Societal Dividend**: `{python} format_billions(SOCIETAL_DIVIDEND)` annually (total economic benefits)
