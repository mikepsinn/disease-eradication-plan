...
- **Range Used in Sensitivity Analysis**:
  - Conservative: 30% (saving $30B annually from a [$100B addressable spend](../references.qmd#clinical-trial-spending))
  - Base Case: **50% (saving $50B annually)** from a [$100B addressable spend](../references.qmd#clinical-trial-spending)
  - Optimistic: 70% (saving $70B annually) from a [$100B addressable spend](../references.qmd#clinical-trial-spending)
  - Transformative (RECOVERY Trial-like): 95% (saving $95B annually) from a [$100B addressable spend](../references.qmd#clinical-trial-spending)
