...
- **Source/Rationale**:
  - [Decentralized Clinical Trials (DCTs) have demonstrated potential for significant cost reductions](../references.qmd#dct-cost-reductions-evidence) (20-50% or more) through reduced site management, travel, and streamlined data collection.
...
- **Range Used in Sensitivity Analysis**:
  ...
  - Base Case: **50% (saving `{python} format_billions(DFDA_GROSS_SAVINGS)` annually)** from a [`{python} format_billions(GLOBAL_TRIAL_MARKET)` addressable spend](../references.qmd#clinical-trial-spending-dfda-baseline)
