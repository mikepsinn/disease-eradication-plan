...
The Decentralized Institutes of Health (DIH) initiative rebuilds the global medical research system from scratch. The current system is slow, expensive, and fails to address 95% of human diseases. By redirecting just 1% of global military spending, we create a self-sustaining, decentralized, and radically efficient system for curing disease.

This proposal requests a \$900,000 seed grant to fund the 501(c)(3) charitable activities within "Phase 0" of the DIH roadmap. The primary 501(c)(3) activity is running a global, non-binding educational referendum/survey to demonstrate that 3.5% of the world's population (280M+ people) support redirecting 1% of military spending to cure disease. This phase establishes the educational and research infrastructure, recruits a core team for the nonprofit, and builds the referendum platform and public technology systems. This grant does not fund lobbying or for-profit activities—it creates the charitable engine that runs the DIH mission. The key deliverable is a fully operational, legally compliant 501(c)(3) organization with 1M+ verified referendum participants, ready for exponential growth and self-sustaining fundraising within 12-18 months.
...
* **Deliverable 3.1:** **✅ (501(c)(3) Fundable):** Development and deployment of initial dFDA and Wishocracy platform infrastructure as open-source public health research tools, including comprehensive technical architecture.
...
| **Educational Technology** | \$150,000    | Website, referendum platform, initial dFDA/Wishocracy development (open-source public health research tools), and educational materials.        |
