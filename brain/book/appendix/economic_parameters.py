...
COST_PER_LIFE_SAVED = ICER_PER_QALY * STANDARD_QALYS_PER_LIFE_SAVED  # -$6.19M per life
...
COMPLETE_BENEFITS_ROI = TOTAL_COMPLETE_BENEFITS_ANNUAL / TREATY_CAMPAIGN_TOTAL_COST  # 1,222:1
...
ENDGAME_ROI = TOTAL_ENDGAME_BENEFITS_ANNUAL / (TREATY_CAMPAIGN_TOTAL_COST * 0.64)  # 25,781:1 (using $640M annual opex)
