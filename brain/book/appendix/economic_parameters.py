...
VICTORY_BOND_UPFRONT_RAISE = TREATY_CAMPAIGN_TOTAL_COST  # $1B
...
DIH_TREASURY_TO_MEDICAL_RESEARCH_ANNUAL = DIH_TREASURY_MILITARY_REDIRECT - DIH_TREASURY_TO_VICTORY_BONDS  # $24.3B/year
...
SENSITIVITY_DFDA_SAVINGS_CENTRAL = DFDA_GROSS_SAVINGS_ANNUAL  # $50B
SENSITIVITY_TOTAL_BENEFITS_CENTRAL = TREATY_TOTAL_ANNUAL_BENEFITS  # $164B
SENSITIVITY_CAMPAIGN_COST_CENTRAL = TREATY_CAMPAIGN_ANNUAL_COST_AMORTIZED  # $250M/year
SENSITIVITY_DFDA_OPEX_CENTRAL = DFDA_ANNUAL_OPEX  # $40M/year
SENSITIVITY_TOTAL_COSTS_CENTRAL = TREATY_TOTAL_ANNUAL_COSTS  # $290M/year
SENSITIVITY_PEACE_QALYS_CENTRAL = TREATY_QALYS_GAINED_ANNUAL_GLOBAL  # 35,000 QALYs
SENSITIVITY_DFDA_QALYS_CENTRAL = GLOBAL_DFDA_QALYS_GAINED_ANNUAL  # 840,000 QALYs
SENSITIVITY_TOTAL_QALYS_CENTRAL = TREATY_TOTAL_QALYS_GAINED_ANNUAL  # 875,000 QALYs
SENSITIVITY_NET_BENEFIT_CENTRAL = TREATY_NET_ANNUAL_BENEFIT  # $163.7B
SENSITIVITY_ICER_CENTRAL = -187097  # -$187,097 per QALY
SENSITIVITY_COST_PER_LIFE_CENTRAL = -6.55  # -$6.55M per life (in millions)
SENSITIVITY_LIVES_SAVED_CENTRAL = SENSITIVITY_TOTAL_QALYS_CENTRAL / STANDARD_QALYS_PER_LIFE_SAVED # 25,000
...
ICER_CONSERVATIVE_ALL_COSTS = SENSITIVITY_ICER_CENTRAL  # -$187,097 (counts all costs) - FIXED: was pointing to CONSERVATIVE instead of CENTRAL
...
COST_PER_LIFE_CONSERVATIVE_ALL_COSTS = SENSITIVITY_COST_PER_LIFE_CENTRAL  # -$6.55M (This is correct - uses CENTRAL value)
