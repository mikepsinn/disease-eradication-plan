...
2. **Model Inputs**
   ...
   - **Upfront Cost (Core Platform Build):** Based on the ROM estimate of **~\$37.5 - \$46 Million** detailed in [Upfront (Capital) Expenditure](#upfront-capital-expenditure-initial-build-illustrative-30-months). For ROI calculations, a representative figure (e.g., $40M) will be used.
