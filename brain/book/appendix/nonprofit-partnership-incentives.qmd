...
- **The Vision:** The **[Decentralized Institutes of Health (DIH)](../solution/dih.qmd)** is designed as a "coalition of coalitions." The main `{python} format_billions(CAPTURED_DIVIDEND)`+ treasury will allocate multi-billion dollar budgets to specialized sub-DAOs (e.g., Decentralized Institute of Mental Health, Decentralized Institute on Aging).
