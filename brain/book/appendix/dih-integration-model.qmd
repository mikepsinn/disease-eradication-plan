...
```{python}
#| echo: false
#| fig-cap: "DIH Money Flow - How treaty funds flow through to patient coverage and data generation"
#| fig-alt: "Flow diagram: 1% Treaty Funds → DIH Treasury → Trial Coverage Pool → Covers Patient Costs (Medications, Testing, Travel/Time). Patient Copay feeds into costs. Data Generated → dFDA Database → Better Treatment Rankings"
