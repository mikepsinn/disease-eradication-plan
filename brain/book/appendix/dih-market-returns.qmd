...
- `{python} format_billions(CAPTURED_DIVIDEND)` annual budget (1% of military)
...
- = **`{python} format_billions(CAPTURED_DIVIDEND)` additional value created annually**
...
DIH: 280 million people allocating `{python} format_billions(CAPTURED_DIVIDEND)` based on results and skin in the game.
