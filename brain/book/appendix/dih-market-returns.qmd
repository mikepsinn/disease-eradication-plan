...
- `{python} format_billions(TREATY_ANNUAL_FUNDING)` annual budget (1% of military)
...
- = **`{python} format_billions(TREATY_ANNUAL_FUNDING)` additional value created annually**
...
DIH: 280 million people allocating `{python} format_billions(TREATY_ANNUAL_FUNDING)` based on results and skin in the game.
