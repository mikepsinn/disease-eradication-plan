...
- **Greed**: "`{python} format_percentage(VICTORY_BOND_ANNUAL_RETURN_PCT)` annual returns forever"
...
- "`{python} format_percentage(VICTORY_BOND_ANNUAL_RETURN_PCT)` returns is compelling content"
