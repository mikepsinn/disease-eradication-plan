...
Historical analysis shows: Every peaceful movement that gets **[3.5% active support](../dih-economic-models/references.qmd#3-5-rule)** succeeds.
...
- "Humanity has [13,000 nukes](../dih-economic-models/references.qmd#world-warheads) but no cure for your kid's cancer" (rage-inducing)
...
- **Anger**: "[FDA delays kill more than the drugs](../dih-economic-models/references.qmd#fda-drug-lag-deaths-estimate)"
...
**"The 1% Treaty: Redirect 1% of military spending to medical research. Fund trials that are [82x cheaper](../dih-economic-models/references.qmd#recovery-trial-82x-cost-reduction). Cure major diseases in 10 years. Everyone wins."**
...
- "[Cost of one F-35](../dih-economic-models/references.qmd#f35-cost-vs-rare-disease-research) = ~160 Oxford-style trials"
...
- "Days to approve weapons: 1 / Days to approve cancer cure: [6,205](../dih-economic-models/references.qmd#research-to-practice-gap)"
...
- "Today's death toll: [150,000](../dih-economic-models/references.qmd#who-daily-deaths)"
- "Total spent on war today: ~$7.4 billion"
- "Total spent on cures today: [$186 million](../dih-economic-models/references.qmd#global-gov-med-research-spending)"
- "Ratio: Still insane"
...
- "[FDA has killed more Americans than terrorists](../dih-economic-models/references.qmd#fda-drug-lag-deaths-estimate)"
- "NIH is a [$48B](../dih-economic-models/references.qmd#nih-budget-fy2025) jobs program, not a cure program"
- "Your vote doesn't matter ([Princeton proved it](../dih-economic-models/references.qmd#unrepresentative-democracy))"
...
→ "[Oxford RECOVERY trial](../dih-economic-models/references.qmd#recovery-trial-summary-quote) already proved it works."
