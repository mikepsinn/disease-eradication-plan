...
- "1% of defense budget ($8.5B) automatically redirected to DIH"
...
- Treaty obligations supersede annual budget fights
- Withdrawal requires 2/3 Senate vote (nearly impossible)
- Automatic escalator clause: If others go to 2%, we match
- Emergency suspension only for actual war (not "conflicts")
...
The beautiful part: Once it passes, it's essentially permanent. Repealing it means admitting they're choosing bombs over cures. Political suicide.
...
The beautiful part: Once passed, they're nearly impossible to repeal. The constituency for cures grows every day. Every person treated becomes a voter for expansion. Every cure makes the next bill easier to pass.
...
Ready to draft? Use these resources:
- [Model legislation templates](../reference/model-legislation.qmd)
- [Lobbying playbook](./lobbying-strategy.qmd)
- [Coalition building guide](./coalition-building.qmd)
:::
