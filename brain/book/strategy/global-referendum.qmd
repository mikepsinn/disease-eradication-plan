...
Implement a privacy-preserving, globally verifiable referendum to assess public support for the [1% Treaty](../solution/1-percent-treaty.qmd) and [DIH](../solution/dih.qmd). Outputs must be auditable and persuasive to policymakers while achieving the **[3.5% global participation threshold](../references.qmd#3-5-rule)** (280M+ verified votes).
...
- **Government ID Integration**: Connect with national e-ID systems where available
  ...
  - [Indian Aadhaar system](../references.qmd#indian-aadhaar-system) (with privacy protections)
