...
tags: [fundraising, strategy, activation-energy, victory-bonds, whale-targeting]
...
The capital required for the [1% Treaty](../solution/1-percent-treaty.qmd) is not for ongoing operations, it is a one-time "activation energy" to overcome political inertia and unlock **[$27+ billion annually](../references.qmd#value-captured-by-1pct-treaty)** for global health.
...
> **"The model targets returns superior to the world's most elite hedge funds (~270% annualized). The financial model is governed by a simple principle: investor payouts never exceed [50% of income](../economics/health-savings-sharing-model.qmd), guaranteeing the mission is always protected."**
...
"The initiative builds the world's largest decentralized health treasury ($27B annually) using proven DAO models from MakerDAO/Uniswap. Early VICTORY bond holders will govern allocation of this treasury across global health research.
...
"The 1% Treaty redirects 1% of global military spending ($27B annually) into health research using Oxford RECOVERY trial methods (80X lower cost). Early investors get governance control over allocation.
