...
- 40-`{python} format_percentage(VICTORY_BOND_ANNUAL_RETURN_PCT)` returns is compelling
...
- **Economic**: "40-`{python} format_percentage(VICTORY_BOND_ANNUAL_RETURN_PCT)` returns"
