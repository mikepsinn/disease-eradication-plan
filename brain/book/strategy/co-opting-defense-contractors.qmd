...
- Military budget only drops 1% (`{python} format_billions(TREATY_ANNUAL_FUNDING)` of [`{python} format_billions(MILITARY_SPENDING)`](../references.qmd#sipri-2024-spending))
