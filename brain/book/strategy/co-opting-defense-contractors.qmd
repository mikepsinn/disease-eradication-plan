...
A significant portion of the campaign's `{python} format_billions(CAMPAIGN_TOTAL_COST)` war chest is allocated for strategic partnerships to co-opt key industry players and defense lobbyists. For the full breakdown, see the [Campaign Budget](../economics/campaign-budget.qmd).
