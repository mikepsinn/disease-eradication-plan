...
ax.text(0, war_indirect_total * 0.9, f'${war_indirect_total/1000:.0f}T', ha='center', va='center',
...
bar2 = ax.bar(1, war_direct, color=COLOR_RED, edgecolor=COLOR_WHITE,
               linewidth=4, width=0.75)
ax.text(1, war_direct * 0.5, f'${war_direct/1000:.0f}T', ha='center', va='center',
...
# Styling with better labels - black text
ax.set_xticks([0, 1, 2])
ax.set_xticklabels(['WAR\'S HIDDEN\nDAMAGE', 'WAR DIRECT\nSPENDING', 'CURING ALL\nDISEASES'],
                   fontsize=36, weight='bold')

ax.set_ylabel('Annual Global Spending (Trillions USD)', fontsize=38, weight='bold', color=COLOR_BLACK)
