...
ax.set_ylabel('BILLIONS PER YEAR', fontsize=24, color=COLOR_BLACK, fontweight='bold')
...
# Title
plt.title('HUMANITY\'S INSANE SPENDING PRIORITIES',
...
# Save the figure
plt.savefig('brain/charts/investment-ratio-1750-to-1.png',
