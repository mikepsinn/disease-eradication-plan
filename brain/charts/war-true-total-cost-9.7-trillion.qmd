...
plt.title('THE REAL COST OF WAR (THEY HIDE $7 TRILLION)',
          fontsize=26, color=COLOR_BLACK, pad=20, fontweight='bold')

# Add watermark
add_watermark(fig)

# Save the figure
plt.savefig('brain/charts/war-true-total-cost-9.7-trillion.png',
