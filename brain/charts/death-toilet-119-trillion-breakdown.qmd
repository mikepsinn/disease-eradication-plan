...
# Save the figure
plt.savefig('brain/charts/death-toilet-119-trillion-breakdown.png',
            dpi=300, bbox_inches='tight', facecolor='white')
plt.tight_layout()
plt.show()

# Print the breakdown
print("\n🚽 THE $119 TRILLION DEATH TOILET BREAKDOWN:\n")
print("Components:")
print(f"├─ War (Real Cost):     $9.7T   (8%)")
print(f"├─ Disease Burden:      $109T   (92%)")
print(f"└─ TOTAL:              $119T   (100%)")

print("\n📊 WHAT THIS MEANS:")
print(f"• Humanity wastes $119 TRILLION annually on death")
print(f"• That's ${119_000_000_000_000/8_000_000_000:,.0f} per human per year")
print(f"• That's ${119_000_000_000_000/365:,.0f} billion per day")
...
print(f"• That's ${119_000_000_000_000/365/24/3600:,.0f} million per second")

print("\n🔬 MEANWHILE:")
print(f"• Investment in cures: $68 billion (0.06% of problem)")
print(f"• Ratio: {119_000/68:.0f}:1 death spending vs cure spending")

print("\n💡 THE SOLUTION:")
print(f"• Just 1% of death toilet = $1.19 trillion for cures")
print(f"• That's a 17X increase in cure funding")
print(f"• Enough to cure most diseases in a decade")
```