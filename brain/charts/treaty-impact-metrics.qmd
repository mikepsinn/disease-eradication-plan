...
# Create chart - all BLUE (showing positive impact/solution)
fig, ax = plt.subplots(figsize=(20, 10))
bars = ax.bar(metrics, values, color=COLOR_BLUE,
...
plt.savefig('assets/charts/treaty-impact-metrics.png', dpi=150, bbox_inches=None, facecolor=COLOR_WHITE)
plt.show()
```
