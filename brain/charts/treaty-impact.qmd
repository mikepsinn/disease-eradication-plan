...
labels = ['Still for\nDefense\n99%', 'To Cure\nDisease\n1%']
sizes = [99, 1]
colors_treaty = [COLOR_BLACK, COLOR_BLUE]  # Black for defense (neutral), blue for solution
explode = (0, 0.15)
...
wedges, texts, autotexts = ax.pie(
    ...
    autopct='',
    startangle=90,
    textprops={'fontsize': 28, 'weight': 'bold', 'color': COLOR_BLACK},
    wedgeprops={'edgecolor': COLOR_WHITE, 'linewidth': 3}
)

# Remove title - let context provide it
# ax.set_title('Military Budget After Treaty', fontsize=36, pad=20, weight='bold', color=COLOR_BLACK)

# Add branding
add_watermark(fig)

#plt.tight_layout()  # Disabled - using rcParams margins instead
plt.savefig('assets/charts/treaty-impact.png', dpi=150, bbox_inches=None, facecolor=COLOR_WHITE)
plt.show()
```
