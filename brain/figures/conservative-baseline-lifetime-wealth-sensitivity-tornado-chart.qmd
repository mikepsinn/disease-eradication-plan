...
This conservative baseline uses the antibiotic precedent (ONE technology, ONE disease category) and likely understates benefits by 5-10x. See [Disease Eradication Model](disease-eradication-lifetime-wealth-sensitivity-tornado-chart.qmd) for realistic estimates accounting for cumulative research acceleration ($2.2M-$16M ranges).
