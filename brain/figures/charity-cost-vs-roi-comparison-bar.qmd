...
# Note: Using r-string (raw string) to prevent any escape sequence interpretation
calc_text = r'''Full Calculation (see brain/book/economics/icer-full-calculation.qmd for complete methodology):
