...
calc_text = '''Calculation for 1% Treaty + dFDA:
Annual Benefits: $97.1B (peace dividend from 1% conflict reduction) + $50B (dFDA R&D savings) = $147.1B
Annual Costs: $290M (campaign + operations)
Net Benefit: $146.8B/year

Health Impact: 35,000 QALYs (from 1,000 lives saved via peace) + 840,000 QALYs (from dFDA) = 875,000 QALYs/year
ICER = ($290M - $147.1B) / 875k QALYs = -$167,771 per QALY × 35 QALYs/life = -$5.87M per life

Sources: GiveWell 2024 Top Charities, dFDA Cost-Benefit Analysis, Cost of War Analysis. Error bars show uncertainty ranges.'''

fig.text(0.5, -0.02, calc_text,
         ha='center', va='top', fontsize=7, color=COLOR_BLACK, style='italic',
         bbox=dict(boxstyle='round,pad=0.8', facecolor='#f5f5f5', edgecolor=COLOR_BLACK, linewidth=1))

# Add watermark
add_watermark(fig)

# Adjust layout to accommodate bottom text box and top titles
