---
title: Disease Eradication Model - Lifetime Wealth Sensitivity Analysis - Tornado Chart
description: Tornado chart showing which parameters have the largest impact on personal lifetime wealth from the 1% Treaty under Disease Eradication Model (72yr life extension)
---
```{python}
#| echo: false
import sys
