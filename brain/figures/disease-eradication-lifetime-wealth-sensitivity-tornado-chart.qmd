...
*Uses Disease Eradication Model (20-year scenario, 72yr life extension). Base case: Age 30, $50K income, 1% treaty, 3% discount rate. See [Disease Eradication Model](../book/appendix/disease-eradication-personal-lifetime-wealth-calculations.qmd#sensitivity-analysis) for detailed interpretation.*