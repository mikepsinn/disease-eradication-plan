...
# WORST CASE SCENARIO (Conservative) from brain/book/economics/dfda-cost-benefit-analysis.qmd
...
plt.savefig(output_dir / 'dfda-investment-returns-bar-chart.png', dpi=200, bbox_inches=None, facecolor=COLOR_WHITE)
