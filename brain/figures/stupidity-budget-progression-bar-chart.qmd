...
# Plot cure bars
ax2.bar(1, cure_values[0], color=COLOR_BLACK, edgecolor=COLOR_WHITE, linewidth=3, width=0.8)
ax2.bar(2, cure_values[1], color=COLOR_BLACK, edgecolor=COLOR_WHITE, linewidth=3, width=0.8)
...
# Plot war total
ax3.bar(0, war_total, color=COLOR_BLACK, edgecolor=COLOR_WHITE, linewidth=3, width=0.8)
...
ax3.bar(2, cure_values[0], color=COLOR_BLACK, edgecolor=COLOR_WHITE, linewidth=3, width=0.8)
ax3.bar(3, cure_values[1], color=COLOR_BLACK, edgecolor=COLOR_WHITE, linewidth=3, width=0.8)
...
plt.savefig(output_dir / 'stupidity-budget-progression-bar-chart.png', dpi=200, bbox_inches=None, facecolor=COLOR_WHITE)
plt.show()
```
