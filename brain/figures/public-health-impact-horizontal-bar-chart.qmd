...
ax.text(peace_dividend/2, y_pos, f'${peace_dividend:.1f}B\nPeace Dividend\nfrom 1% Less Conflict',
        ha='center', va='center', fontsize=10, color=COLOR_BLACK, weight='bold',
        bbox=dict(boxstyle='round,pad=0.4', facecolor=COLOR_WHITE, edgecolor=COLOR_BLACK, linewidth=1))
# dFDA label
...
# Clean spines - remove bottom axis too since all values are labeled
...
plt.savefig(output_dir / 'public-health-impact-horizontal-bar-chart.png', dpi=200, bbox_inches=None, facecolor=COLOR_WHITE)
