...
- **dFDA Cost-Benefit**: `{python} format_roi(ROI_DFDA_SAVINGS_ONLY)` ROI from `{python} format_millions(DFDA_ANNUAL_OPEX)` platform saving `{python} format_billions(DFDA_GROSS_SAVINGS_ANNUAL)` in trial costs
