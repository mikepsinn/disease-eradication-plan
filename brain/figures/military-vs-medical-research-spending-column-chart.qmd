...
arrow1_end_x = annotation_x - 0.3  # Adjusted to point to the right
arrow1_end_y = annotation_y + 200
...
arrow2_end_x = x_positions[1]
arrow2_end_y = cure_spending + 834  # Moved arrow up by 1/3 of its length
...
plt.savefig(output_dir / 'military-vs-medical-research-spending-column-chart.png', dpi=300, bbox_inches='tight', facecolor=COLOR_WHITE)
plt.show()
