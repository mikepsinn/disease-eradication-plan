...
for i, (name, roi, cat) in enumerate(zip(names, rois, categories)):
    ...
    ax.text(x_pos[i], roi + 10,
            f'${roi}',
            ha='center', va='bottom',
            fontsize=18, color=COLOR_BLACK, weight='bold')
...
# Y-axis formatting - balance top and bottom margins
ax.set_ylim(-15, max(rois) * 1.15)

# Title
ax.set_title('Return on Investment Comparison: Health Interventions',
            fontsize=20, color=COLOR_BLACK, weight='bold', pad=10, y=0.96)
