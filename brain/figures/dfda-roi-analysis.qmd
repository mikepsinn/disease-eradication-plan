...
- **ROI Calculation**: `{python} roi_dfda_savings_only_formatted` based on `{python} dfda_annual_opex_formatted` annual cost generating `{python} dfda_gross_savings_annual_formatted` savings
