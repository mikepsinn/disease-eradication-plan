...
description: Line chart showing how personal lifetime wealth scales with different treaty percentages under Disease Eradication Model (72yr life extension)
---
```{python}
#| echo: false
import sys
