---
title: Disease Eradication Model - Cumulative Wealth Over Lifetime (Stacked Area Chart)
description: Shows how personal wealth accumulates over a 122-year lifetime under Disease Eradication Model (72yr life extension)
---
```{python}
#| echo: false
import sys
...
ax.fill_between(years, cumulative_caregiver/1000000, cumulative_gdp/1000000,
                label='Economic Multiplier (Military→Research)', color=COLOR_WHITE,
                edgecolor=COLOR_BLACK, linewidth=1, hatch='\\\\\\\\')
...
ax.text(80, ax.get_ylim()[1] * 0.95, 'Baseline Death Age\n(Without Treaty)',
...
ax.set_ylabel('Cumulative Lifetime Wealth (NPV, Millions)', fontsize=24, weight='bold')
ax.set_title('Disease Eradication Model - Cumulative Wealth Over Lifetime\n(Age 30, $50K Income, 1% Treaty, 72 Years Life Extension)',
