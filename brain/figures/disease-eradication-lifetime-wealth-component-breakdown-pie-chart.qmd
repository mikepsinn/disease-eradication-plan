...
*Uses Disease Eradication Model (20-year scenario, 72yr life extension). Base case: Age 30, $50K income, 1% treaty. Each slice shows component amount and percentage of $4.3M total. See [Disease Eradication Model](../book/appendix/disease-eradication-personal-lifetime-wealth-calculations.qmd#component-breakdown) for component analysis.*