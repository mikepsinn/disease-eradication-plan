...
# Add explanatory callout - position to far right, above the column labels
callout_text = ('The 1% Treaty redirects military\nspending to fund DIH + dFDA at\nzero net cost to society.\n\nResult: $147B in annual benefits\n(peace dividend + R&D savings)\nwith negative cost = infinite ROI.\n\nThis is a "dominant intervention" -\nit saves money while saving lives.\n\nOther health interventions\n(shown for comparison) are\ninvisible at this scale.')
ax.text(0.82, 0.55, callout_text,
