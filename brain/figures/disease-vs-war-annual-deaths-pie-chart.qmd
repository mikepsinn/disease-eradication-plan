...
sizes = [55, 14]
labels = ['Disease\n55M', 'War\n14M']
colors = [COLOR_BLACK, COLOR_BLACK]  # Both are problems - use solid black
explode = (0.05, 0.05)
...
plt.savefig(output_dir / 'disease-vs-war-annual-deaths-pie-chart.png', dpi=200, bbox_inches=None, facecolor=COLOR_WHITE)
plt.show()
```
