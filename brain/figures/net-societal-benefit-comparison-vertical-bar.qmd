...
for i, (name, value) in enumerate(zip(intervention_names, intervention_values)):
    ...
    ax.text(i, value + 2, f'${value:.1f}B',
            ha='center', va='bottom', fontsize=12, color=COLOR_BLACK, weight='bold')

# Plot stacked bar for 1% Treaty + dFDA
bottom_offset = 0
hatches = ['', '///', '...', '|||']
...
ax.annotate('dFDA R&D Savings\n$50.0B',
           ...
           xytext=(treaty_x_pos - 1.5, segment_positions[1]),
...
# Disease Reduction (3rd segment from bottom) - offset slightly to avoid overlap
ax.annotate('Disease Reduction\n$10.9B',
           xy=(treaty_x_pos - 0.375, segment_positions[2]),
           xytext=(treaty_x_pos - 1.5, segment_positions[2] + 8),
           ha='right', va='center', fontsize=11,
           color=COLOR_BLACK, weight='bold',
           bbox=dict(boxstyle='round,pad=0.5', facecolor=COLOR_WHITE,
                     edgecolor=COLOR_BLACK, linewidth=1.5),
...
# GDP Growth (top segment) - offset slightly to avoid overlap
ax.annotate('GDP Growth\n$27.2B',
           xy=(treaty_x_pos - 0.375, segment_positions[3]),
           xytext=(treaty_x_pos - 1.5, segment_positions[3] + 16),
           ha='right', va='center', fontsize=11,
           color=COLOR_BLACK, weight='bold',
           bbox=dict(boxstyle='round,pad=0.5', facecolor=COLOR_WHITE,
                     edgecolor=COLOR_BLACK, linewidth=1.5),
...
ax.set_xticklabels(all_labels, fontsize=11, weight='bold')
...
plt.savefig(output_dir / 'net-societal-benefit-comparison-vertical-bar.png',
