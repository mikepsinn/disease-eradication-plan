...
# Column 2: Cure Research Spending (BLUE - solution)
ax.bar(1, cure_total, color=COLOR_BLUE, edgecolor=COLOR_WHITE, linewidth=3, width=0.8)
...
plt.savefig(output_dir / 'disease-vs-curing-costs-column-chart.png', dpi=150, bbox_inches='tight', facecolor=COLOR_WHITE)
plt.show()
```