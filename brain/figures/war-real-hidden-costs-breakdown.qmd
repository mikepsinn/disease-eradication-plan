...
# BLACK for admitted, RED for all hidden costs
colors_pie = [COLOR_BLACK, COLOR_BLACK, COLOR_BLACK, COLOR_BLACK, COLOR_BLACK, COLOR_BLACK]
...
wedges, texts, autotexts = ax.pie(values, labels=categories, colors=colors_pie,
                                    ...
                                    wedgeprops={'edgecolor': COLOR_WHITE, 'linewidth': 4})

# Make percentage text white and bold
for autotext in autotexts:
    autotext.set_color(COLOR_WHITE)
...
plt.savefig(output_dir / 'war-real-hidden-costs-breakdown.png', dpi=300, bbox_inches=None, facecolor=COLOR_WHITE)
plt.show()
```