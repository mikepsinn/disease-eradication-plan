...
ax.plot(years, cure_investment * 1000, color=COLOR_BLUE, linewidth=6, label='Cure Investment (×1000 for visibility)')
...
# Save the figure
plt.savefig('brain/figures/death-spiral-projection-2050.png',
            dpi=300, bbox_inches='tight', facecolor='white')
plt.tight_layout()
plt.show()

# Print projections
print("\n📈 THE DEATH SPIRAL PROJECTIONS:\n")
print("Year 2024 (Today):")
print(f"  • Death costs: $119 trillion")
print(f"  • Cure investment: $68 billion")
print(f"  • Ratio: 1,750:1\n")

print("Year 2030:")
print(f"  • Death costs: ${119 * 1.03**6:.0f} trillion")
print(f"  • Cure investment: ${68 * 1.02**6:.0f} billion")
print(f"  • Ratio: {(119 * 1.03**6) / (0.068 * 1.02**6):,.0f}:1\n")

print("Year 2040:")
print(f"  • Death costs: ${119 * 1.03**16:.0f} trillion")
print(f"  • Cure investment: ${68 * 1.02**16:.0f} billion")
print(f"  • Ratio: {(119 * 1.03**16) / (0.068 * 1.02**16):,.0f}:1\n")

print("Year 2050 (If Nothing Changes):")
print(f"  • Death costs: ${119 * 1.03**26:.0f} trillion")
print(f"  • Cure investment: ${68 * 1.02**26:.0f} billion")
print(f"  • Ratio: {(119 * 1.03**26) / (0.068 * 1.02**26):,.0f}:1")
print(f"  • Result: Economic collapse, species extinction")
```