...
savings_data = {
    ...
    'Savings ($B)': [
        MILITARY_SPENDING * TREATY_REDUCTION_PCT,
        LOST_ECONOMIC_GROWTH * TREATY_REDUCTION_PCT,
        INFRASTRUCTURE_DESTRUCTION * TREATY_REDUCTION_PCT,
        HUMAN_LIFE_LOSSES * TREATY_REDUCTION_PCT,
        TRADE_DISRUPTION * TREATY_REDUCTION_PCT,
        LOST_HUMAN_CAPITAL * TREATY_REDUCTION_PCT,
        VETERAN_HEALTHCARE * TREATY_REDUCTION_PCT,
        REFUGEE_SUPPORT * TREATY_REDUCTION_PCT,
        ENVIRONMENTAL_DAMAGE * TREATY_REDUCTION_PCT,
        PSYCHOLOGICAL_IMPACT * TREATY_REDUCTION_PCT
    ]
}
