...
- Per-patient costs vary by therapeutic area:
  ...
  - [Average across areas: $41,117](../book/references.qmd#trial-costs-fda-study)

### Pragmatic Trials (RECOVERY Example)

- [Cost savings of 68-78% compared to traditional trials](../book/references.qmd#pmc-trial-economics)
...
- [9 days: Concept to first patient enrollment](../book/references.qmd#recovery-trial-dexamethasone-results)
- [10 weeks: First life-saving treatment identified](../book/references.qmd#landray-recovery-trial-quote)
- [3 hours: Results to policy implementation](../book/references.qmd#landray-recovery-trial-quote)
- [47,000+ participants across 6 countries](../book/references.qmd#recovery-trial-summary-quote)
- [200+ hospital sites](../book/references.qmd#recovery-trial-summary-quote)
- [10 major results obtained](../book/references.qmd#recovery-trial-summary-quote)
- [4 effective COVID-19 treatments identified](../book/references.qmd#recovery-trial-summary-quote)
...
- [80% of trials fail to meet enrollment timelines](../book/references.qmd#clinical-trial-enrollment-timelines)
- [Up to 50% of research sites enroll one or no patients](../book/references.qmd#clinical-trial-enrollment-timelines)

## Clinical Impact

### RECOVERY Trial

- [Dexamethasone findings](../book/references.qmd#recovery-trial-dexamethasone-results):
  - 35% reduction in mortality for ventilated patients
  - [Estimated 1 million lives saved globally](../book/references.qmd#recovery-trial-summary-quote)
