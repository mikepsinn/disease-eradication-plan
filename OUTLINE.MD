...
**Stats:** 54,510 words | 14,770 lines
...
**Stats:** 27,188 words | 2,635 lines
...
**Stats:** 11,698 words | 1,259 lines
...
**Stats:** 13,387 words | 1,893 lines

  - Abstract
  - System Overview: From Methodology to Product {#system-overview}
    - What Patients See
    - What Companies See
...
**Stats:** 19,120 words | 1,703 lines
...
**Stats:** 19,616 words | 1,989 lines
...
**Stats:** 13,311 words | 1,957 lines
...
**Stats:** 3,365 words | 597 lines

  - The Model Components
    - Disease-by-Disease Eradication (CDC Burden Data)
      - Why these max potentials?
    - Aging Reversal Bonus
    - Healthcare Savings
    - Productivity Gains
    - GDP Boost
    - Extended Earnings
  ...
  - Conservative Baselines (For Skeptics)
    ...
    - Unified Model with Uncertainty
  ...
  - Mathematical Framework
    ...
    - Component Formulas
      - Peace Dividend
      - Economic Multiplier (Military→Research)
      - Healthcare Savings
      - Extended Earnings
  ...
  - Life Extension Input Distribution
...
**Title:** Governance
**Description:** How the People Who Pay Get to Vote - The governance model for the DIH is Wishocracy, a decentralized protocol for creating a global, semi-autonomous 'to-do list for humanity' governed by the people wh...
**Stats:** 1,144 words | 160 lines
...
*21 QMD files in knowledge/ not in any Quarto config:*
...
- **Description:** Quantifying the gap between current global governance and theoretical maximum welfare, estimating a ...
- **Words:** 5,447
