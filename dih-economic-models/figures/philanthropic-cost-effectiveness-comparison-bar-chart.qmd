...
from dih_economic_models.figures._chart_style import setup_chart_style, add_watermark, clean_spines, add_png_metadata
from dih_economic_models.figures._chart_style import COLOR_BLACK, COLOR_WHITE
...
# Calculation details removed - see brain/book/appendix/icer-full-calculation.qmd for complete methodology
# calc_text = '''Full Calculation (see brain/book/appendix/icer-full-calculation.qmd for complete methodology):
#
...
#   - Total: 925,610 QALYs/year
#
# ICER Calculation:
#   Net Benefit = $290M - $163.55B = -$163.26B/year (society saves money)
#   ICER = -$163.26B / 925,610 QALYs = -$176,371 per QALY
#   Per Life = -$176,371 x 35 QALYs/life = -$6.17M per life saved
#
...
output_path = output_dir / 'philanthropic-cost-effectiveness-comparison-bar-chart.png'
