...
peace_dividend_components = {
    'Peace Dividend': PEACE_DIVIDEND_ANNUAL_SOCIETAL_BENEFIT,
    'dFDA R&D\nSavings': DFDA_GROSS_SAVINGS_ANNUAL,
    'Disease\nReduction': 10.9,
    'GDP\nGrowth': 27.2
}
...
for idx, (name, value) in enumerate(peace_dividend_components.items()):
    ...
    if idx == 0:
        ax.text(treaty_x_pos, bottom_offset + value/2,
                f'${PEACE_DIVIDEND_ANNUAL_SOCIETAL_BENEFIT:.1f}B\nPeace\nDividend',
...
output_path = get_figure_output_path('health-programs-vs-1-percent-treaty-societal-benefits-bar-chart.png')
