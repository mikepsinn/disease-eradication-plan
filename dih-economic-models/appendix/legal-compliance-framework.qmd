...
This phase occurs only _after_ the 1% Treaty is successfully ratified and the [DIH Treasury](../../brain/book/solution/dih.qmd) is funded. This is the point at which a security is distributed, and it will be handled in a fully compliant manner.
...
To maximize the effectiveness of the [dFDA Infrastructure](../../brain/book/solution/dfda.qmd), we recommend HHS sponsor an **FDA-X Prize** (\$500 million) to incentivize creation of an open-source, decentralized FDA platform enabling perpetual, patient-driven clinical trials.
