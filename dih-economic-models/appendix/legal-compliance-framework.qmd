...
The initial "activation energy" from sophisticated investors (VCs, funds, etc.) will still be raised via a traditional private placement for VICTORY bonds and tokens, conducted in full compliance with [Regulation D](../references.qmd#sec-reg-d) (for U.S. accredited investors) and [Regulation S](../references.qmd#sec-reg-s) (for non-U.S. investors). This ensures the core financing is secure while the mass distribution is handled via the safer "Points-then-Conversion" model.
...
- Upon ratification of the 1% Treaty, this entity may transition to managing operational infrastructure for the DIH Treasury and facilitating the mechanisms for investor payouts related to the government-issued VICTORY bonds.
