...
The capital required for the [1% Treaty](../../brain/book/solution/1-percent-treaty.qmd) is not for ongoing operations. It's "activation energy", the one-time push to overcome political inertia and unlock **[$27+ billion annually](../references.qmd#value-captured-by-1pct-treaty)** for global health.
...
- Lay the groundwork for the future capitalization of the [DIH](../../brain/book/solution/dih.qmd) treasury upon treaty ratification
...
- **ROI:** 10-20x political arbitrage + 463x economic arbitrage via [dFDA](../../brain/book/solution/dfda.qmd)
