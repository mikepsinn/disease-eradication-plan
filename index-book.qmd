...
- Year 2030: Still spending {{< var military_vs_medical_research_ratio >}} times more on killing people than curing them
...
Meanwhile, your species spends {{< var military_vs_medical_research_ratio >}} times more on bombs and wars and things than attempting to cure all diseases combined.
...
The $24.3B flowing to research at 82x efficiency creates **{{< var trial_capacity_multiplier >}}× trial capacity per year**. Over 20 years, that's **{{< var trial_capacity_cumulative_years_20yr >}} cumulative trial-capacity-equivalent years**, a massive expansion of our ability to test treatments.
...
They'll learn in history class that your generation could split atoms, edit genes, and land on the moon, but somehow couldn't figure out that spending {{< var military_vs_medical_research_ratio >}} times more on ending lives than saving them was mathematically stupid.
...
That's **{{< var military_vs_medical_research_ratio >}} times less** on curing all diseases combined than humans spend on new ways to create corpses.
