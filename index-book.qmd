...
The {{< var dih_treasury_to_medical_research_annual >}} flowing to research at 82x efficiency creates **{{< var trial_capacity_multiplier >}}× trial capacity per year**. Over 20 years, that's **{{< var trial_capacity_cumulative_years_20yr >}} cumulative trial-capacity-equivalent years**, a massive expansion of our ability to test treatments.
...
Instead of a committee of 200 bureaucrats giving their friends grants to write papers about diseases, [the DIH treasury](knowledge/solution/dih.qmd) directly subsidizes patients in your dFDA marketplace, letting them choose which trials to fund.

### A Decentralized Framework for Drug Assessment (dFDA)

**Amazon for Clinical Trials + Consumer Reports for Drugs**

[Your dFDA](knowledge/solution/dfda.qmd) achieves **{{< var trial_cost_reduction_factor >}}x cost reduction** through decentralized pragmatic trials.
...
[Your dFDA](knowledge/solution/dfda.qmd) fixes that with **[Outcome Labels](knowledge/solution/dfda.qmd)** - simple, data-driven summaries showing exactly what happens when real people try a treatment:
