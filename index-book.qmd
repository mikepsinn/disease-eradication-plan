...
The {{< var dih_treasury_to_medical_research_annual >}} flowing to pragmatic clinical trials at {{< var dfda_trial_cost_reduction_factor >}}x efficiency creates **{{< var dfda_trial_capacity_multiplier >}}× trial capacity per year**. Over 20 years, that's **{{< var trial_capacity_cumulative_years_20yr >}} cumulative trial-capacity-equivalent years**, a massive expansion of our ability to test treatments.
...
- **Oxford Already Did It**: [The RECOVERY trial](knowledge/appendix/recovery-trial.qmd) tested 6 treatments on 47,000 patients across 186 hospitals for {{< var recovery_trial_cost_per_patient >}}/patient (vs standard FDA phase 3 cost of {{< var traditional_phase3_cost_per_patient >}}), demonstrating a {{< var recovery_trial_cost_reduction_factor >}}x cost reduction at scale. Not in theory. In reality. With actual dying people who became not-dying people.
...
- **{{< var dfda_benefit_rd_only_annual >}} in annual R&D cost savings**: {{< var dfda_trial_cost_reduction_factor >}}x reduction in clinical trial costs (you were spending {{< var dfda_trial_cost_reduction_factor >}} times too much, which is like discovering you've been paying ${{< var dfda_trial_cost_reduction_factor >}} for toast when toast costs $1, except the toast is immortality)
- **{{< var dfda_efficacy_lag_elimination_deaths_averted >}} lives saved** from eliminating the {{< var efficacy_lag_years >}}-year efficacy lag (economist-speak for "humans who continue being alive and happy" - economists can't just say "living" like normal people, they have to "quality-adjust" it, as if there's such a thing as low-quality living, which I suppose there is if you've been to New Jersey) - [see regulatory mortality analysis](knowledge/appendix/regulatory-mortality-analysis.qmd)
  - **{{< var dfda_efficacy_lag_elimination_dalys >}} DALYs averted** from the one-time timeline shift
