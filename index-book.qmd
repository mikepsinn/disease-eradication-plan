...
published: true
image: /assets/og-images/knowledge\solution/1-percent-treaty-og-academic.jpg
---
...
- **Oxford Already Did It**: [The RECOVERY trial](knowledge/appendix/recovery-trial.qmd) tested 6 treatments on 47,000 patients across 186 hospitals for {{< var recovery_trial_cost_per_patient >}}/patient (vs standard FDA phase 3 cost of {{< var traditional_phase3_cost_per_patient >}}), demonstrating a {{< var recovery_trial_cost_reduction_factor >}} cost reduction at scale (consistent with systematic reviews showing median costs of ~{{< var pmc_pragmatic_trial_median_cost_per_patient >}}/patient). Not in theory. In reality. With actual dying people who became not-dying people.
...
- **{{< var dfda_efficacy_lag_elimination_deaths_averted >}} lives saved** from eliminating the {{< var efficacy_lag_years >}}-year efficacy lag (economist-speak for "humans who continue being alive and happy" - economists can't just say "living" like normal people, they have to "quality-adjust" it, as if there's such a thing as low-quality living, which I suppose there is if you've been to New Jersey) - [see regulatory mortality analysis](knowledge/appendix/regulatory-mortality-analysis.qmd)
  ...
  - For context: {{< var global_disease_deaths_daily >}} people die daily from disease and aging. Slower testing and rollout means some fraction of those deaths are avoidable by earlier access to effective treatments ([see regulatory mortality analysis](knowledge/appendix/regulatory-mortality-analysis.qmd))
...
- {{< var dfda_efficacy_lag_elimination_deaths_averted >}} lives saved from dFDA timeline shift ({{< var efficacy_lag_years >}}-year acceleration)
