...
- **{{< var dfda_qalys_rd_plus_delay_annual >}} Quality-Adjusted Life Years** (economist-speak for "humans who continue being alive and happy" - economists can't just say "living" like normal people, they have to "quality-adjust" it, as if there's such a thing as low-quality living, which I suppose there is if you've been to New Jersey) - [see regulatory mortality analysis](knowledge/appendix/regulatory-mortality-analysis.qmd)
  ...
  - For context: {{< var global_disease_deaths_daily >}} people die every day under the current system waiting for post-safety efficacy approval ([see regulatory mortality analysis](knowledge/appendix/regulatory-mortality-analysis.qmd))
