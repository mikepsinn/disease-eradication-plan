...
- You: "{{< var treaty_campaign_voting_bloc_target >}} million voters want to not die"
...
- **{{< var global_dfda_qalys_gained_annual >}} Quality-Adjusted Life Years** (economist-speak for "humans who continue being alive and happy" - economists can't just say "living" like normal people, they have to "quality-adjust" it, as if there's such a thing as low-quality living, which I suppose there is if you've been to New Jersey) - [see regulatory mortality analysis](knowledge/appendix/regulatory-mortality-analysis.qmd)
  - **{{< var dfda_lives_saved_annual >}} lives saved per year** ({{< var dfda_lives_saved_daily >}} per day) by eliminating the 7.2-year regulatory efficacy lag
  - This is the [comprehensive regulatory delay elimination approach](knowledge/appendix/regulatory-mortality-analysis.qmd) - returning to pre-1962 safety-only regulation (Phase I) and letting real-world evidence verify efficacy
  - For context: {{< var regulatory_delay_deaths_daily >}} people die every day under the current system waiting for approval ([see regulatory mortality analysis](knowledge/appendix/regulatory-mortality-analysis.qmd))
...
- **Per life saved**: Society makes {{< var system_profit_per_life_saved >}} profit
...
- This system: MAKES {{< var system_profit_per_life_saved >}}M per life saved
...
- **You personally get {{< var effective_hourly_rate_lifetime_benefit >}} in lifetime wealth and 72 extra years of life** (yes, you specifically)
