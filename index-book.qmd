...
The {{< var dih_treasury_to_medical_research_annual >}} flowing to pragmatic clinical trials at {{< var dfda_trial_cost_reduction_factor >}}x efficiency creates **{{< var trial_capacity_multiplier >}}× trial capacity per year**. Over 20 years, that's **{{< var trial_capacity_cumulative_years_20yr >}} cumulative trial-capacity-equivalent years**, a massive expansion of our ability to test treatments.
