...
- **[Economic Parameters](dih-economic-models/economic_parameters.py)**: Single source of truth for all economic values (military spending, clinical trial costs, ROI calculations, etc.). See the module docstring for usage.
