# How to Contribute to the Disease Eradication Plan
...
- **[Economic Parameters](dih_models/parameters.py)**: Single source of truth for all economic values (military spending, clinical trial costs, ROI calculations, etc.). See the module docstring for usage.
