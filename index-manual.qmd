...
1. It takes {{< var nuclear_winter_warhead_threshold_nounit >}} warheads to trigger nuclear winter and collapse your food system. You have 12,200. That is {{< var nuclear_winter_overkill_factor_nounit >}} apocalypses. You can only use one of them, because after the first one there is no civilization left to apocalypse. The other 121 just sit there, being expensive. The [1% Treaty](knowledge/solution/1-percent-treaty.qmd) [@1-pct-treaty-impact-paper-2025] asks you to settle for 121 apocalypses instead of {{< var nuclear_winter_overkill_factor_nounit >}}, in exchange for {{< var dfda_trial_capacity_multiplier >}} more clinical trials, which compresses disease eradication from {{< var status_quo_queue_clearance_years >}} to {{< var dfda_queue_clearance_years >}}. Would {{< var global_registered_voters_nounit >}} of your species prefer Option A (122 apocalypses, several centuries of continued dying from curable diseases) or Option B (121 apocalypses, disease cured in their lifetime)?

2. Is disease just your meat breaking in predictable ways that can be fixed by running the right clinical trials? *Yes. You find first treatments for 15 new diseases every year. {{< var diseases_without_effective_treatment_nounit >}} are still waiting. You have {{< var safe_compounds_count_nounit >}} known-safe medicinal compounds, of which {{< var unexplored_ratio >}} of their potential uses have never been tested. There is no physical law preventing disease eradication. There is only a funding law.*
...
17. For the wave to reach {{< var global_registered_voters_nounit >}}, exactly 2 of your 40 humans have to actually keep sharing. Two. Not two percent. Two humans. Everyone else can ignore you and the wave still reaches 4 billion. *Yes. You are responsible for 40 conversations, not 40 conversions. The 38 who don't pass it on had a nice conversation with someone who loves them. That's not failure.*
