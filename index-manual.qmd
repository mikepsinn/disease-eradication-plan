...
Pragmatic trials integrate into the standard healthcare system. Real patients participate instead of 200 people hand-picked by pharmaceutical companies. The whole thing uses your new [decentralized FDA](/knowledge/solution/dfda.qmd) protocol that reduces trial costs by {{< var dfda_trial_cost_reduction_factor >}} and funds {{< var dih_patients_fundable_annually >}} (versus the current {{< var current_trial_slots_available >}}). Remember that billion patients drowning in line for two life jackets? Your dFDA hands out 23 million.
...
An Incentive Alignment Bond (IAB) funds a policy campaign, then splits the resulting government savings three ways: 80% to the public good, 10% to investors as returns, and 10% to a Super PAC that rewards politicians who voted yes (campaign support while they're running, cushy post-office careers when they're done). Investors get rich, politicians get reelected, and 80% of the money goes where it's supposed to. Everyone's greed points at the same target. It's a war bond to fund any public good that's currently politically impossible.
