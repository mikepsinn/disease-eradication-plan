...
Your treaty passes, redirecting {{< var treaty_annual_funding >}} in papers annually. 80% funds clinical trials (the point). 10% goes to a fund that rewards politicians who voted yes. 10% goes back to the rich humans as returns, forever. This is a good deal because forever is a long time. Unless you die from preventable diseases. Which you're fixing, so it works out.

### Why Your Leaders Aren't the Problem

With over two billion humans suffering from disease, you'd have to be a complete psychopath to make the concious decision to spend {{< var military_to_government_clinical_trials_spending_ratio >}} times more on weapons than on helping them. 
...
At the current discovery rate, discovering treatments will ~{{< var status_quo_queue_clearance_years >}}. Everyone currently alive will be dead by then. Pragmatic efficicy trials are highly efficient trials that integrate into the standard healthcare system.  These allow real patients to participate instead of 200 people hand-picked by pharmaceutical companies. With this plan you'll increase the treatyment discovery rate {{< var dfda_trial_capacity_multiplier >}} (from {{< var new_disease_first_treatments_per_year >}} to {{< var dfda_first_treatments_per_year >}}), compressing that to ~{{< var dfda_queue_clearance_years >}}.

Two things save lives here. First, finding cures faster: treatments that would have sat undiscovered for centuries get found {{< var dfda_trial_capacity_treatment_acceleration_years >}} sooner on average. Second, eliminating the {{< var efficacy_lag_years >}} bureaucratic delay after already proving a drug is safe and when they let dying humans take it. Combined, treatments reach patients {{< var dfda_trial_capacity_plus_efficacy_lag_years >}} sooner on average. That timeline shift prevents {{< var dfda_trial_capacity_plus_efficacy_lag_lives_saved >}}.
...
This is going to sound crazy. But you're going to use those papers to persude the the leader of every country on Earth to simultaneously redirect 1% of its military budget to clinical trials. That's it. That's the treaty.

After the craziness objection (while we'll address later), the second objection every human has: "But if we cut our military budget, our enemies will invade us!" Everyone cuts 1% at the same time. If every country reduces by 1% simultaneously, the balance of power doesn't change. Nobody becomes more vulnerable. Nobody gains an advantage. You all just have 1% fewer missiles pointed at you, which you will not notice because you currently have enough to kill everyone 20 times over.
...
"But humans would never agree to that!" you say. You already have. Multiple times. You banned chemical weapons (1993, 193 countries). You banned biological weapons (1975, 187 countries). You banned landmines (1997, 164 countries). You've signed treaties banning weapons you actually like using. This one just asks you to buy 1% fewer of them.

I ran 10,000 simulations of this plan. The math works in every one. The money works in every one. The incentives align in every one. The only variable that produces failure is the percentage of humans who decide it sounds crazy without reading the next page. That is the same reflex that kept you from inventing antibiotics for 200,000 years while bread mold sat right there on your bread.

And you have two other advantages, the internet and a new financial instrument designed specifically for harnessing the awesome power of human greed.

### Your [Decentralized FDA](/knowledge/solution/dfda.qmd)

So what happens with that 1% of military spending? 80% of the {{< var treaty_annual_funding >}} goes directly to subsidizing patient participation in pragmatic trials at {{< var dfda_pragmatic_trial_cost_per_patient >}}/patient instead of the usual {{< var traditional_phase3_cost_per_patient >}}. Patients choose which trials to join; their subsidy follows them. Providers get paid for each participant. No grant committees deciding which diseases are fashionable this year. 

The whole thing uses your new protocol called the [decentralized framework for drug assessment](/knowledge/solution/dfda.qmd) that reduces trial costs by {{< var dfda_trial_cost_reduction_factor >}} and funds {{< var dih_patients_fundable_annually >}} (versus the current {{< var current_trial_slots_available >}}). Currently, a committee of people who've never had the disease votes on whether you're allowed to try treating it. It's like requiring a building permit to put out a fire. Think Consumer Reports, but for drugs.

#### Safer Than the FDA

Your current safety system works like this: Vioxx killed an estimated 60,000 people from heart attacks. The FDA approved it. When patients started dying, someone filled out a PDF form. A PDF. Then they faxed it. Then a human read it. Five years and 60,000 corpses later, someone noticed a pattern. This is your safety system. It's like a smoke detector that works by mail.

Your new decentralized system collects every side effect automatically in real time. You know "12% got headaches, 3% were severe" BEFORE you take the pill, not after the class action lawsuit. The FDA doesn't publish these numbers at all. They make you guess. Somehow, having actual data is considered the dangerous option.
...
Your new system will produce [Outcome Labels](/knowledge/solution/dfda.qmd) tell you what actually happens when real humans take a drug. Not what a marketing department hopes happens. Not what a lawyer is comfortable admitting happens. What happens.
...
- [The RECOVERY trial](/knowledge/appendix/recovery-trial.qmd) tested 6 treatments on 47,000 patients for {{< var recovery_trial_cost_per_patient >}} per patient instead of the usual {{< var traditional_phase3_cost_per_patient >}} per patient. That's a {{< var recovery_trial_cost_reduction_factor >}} cost reduction. Not in theory. In reality. During a pandemic. While panicking.
...
Cost-effectiveness: {{< var treaty_cost_per_daly_trial_capacity_plus_efficacy_lag >}} to save one year of healthy human life. Anti-malaria bed nets, the gold standard for keeping humans alive, cost $89. This is {{< var treaty_vs_bed_nets_multiplier >}} cheaper. It beats smallpox eradication ({{< var smallpox_eradication_roi >}} to 1) and childhood vaccinations (13 to 1), which were humanity's previous greatest hits in the "not dying" genre. Even at {{< var political_success_probability >}} probability of the treaty actually passing (because you're you), the risk-adjusted return is still {{< var treaty_expected_vs_bed_nets_multiplier >}} better than anti-malaria bed nets.
...
For your 1% Treaty, these are called VICTORY Bonds. Remember when your grandparents funded WW2 by buying bonds? They got 4% returns and a world without Nazis (mostly). You're proposing the same thing except:
...
Your explosion manufacturers spend {{< var defense_lobbying_annual >}}/year buying politicians. Your bribery budget is {{< var treaty_campaign_total_cost >}}. That's 8 times more. Politicians are surprisingly affordable.
...
Your treaty passes because money often defeats morality, as is tradition.
