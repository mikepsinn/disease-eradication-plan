...
You don't realize it yet, but the math suggests you are, quantifiably, the most important person in the history of human civilization. I understand this is a lot for a creature that still argues about how to merge in traffic. But every minute you spend deciding whether that's true, {{< var global_disease_deaths_per_minute >}} permanently stop. So perhaps read quickly.

By the time you finish this manual, you will have prevented {{< var dfda_trial_capacity_plus_efficacy_lag_lives_saved >}}, prevented {{< var dfda_trial_capacity_plus_efficacy_lag_suffering_hours >}} of suffering, generated {{< var dfda_trial_capacity_plus_efficacy_lag_economic_value >}} in value, and prevented the apocalypse (as a bonus).
...
This system has killed {{< var money_printer_war_deaths_nounit >}} of you in wars so unpopular they could only be funded by printing the money, since even humans won't voluntarily buy their own murder.
...
That's {{< var treaty_campaign_voting_bloc_target_nounit >}} humans. Sounds like a lot until you remember that more than 10 times as many of you installed a slot machine disguised as an app so it could drip-feed you strangers dancing, crying, and developing conspiracy theories in portrait mode. You can get {{< var treaty_campaign_voting_bloc_target_nounit >}} to vote yes or no on the treaty. {{< var treaty_campaign_viral_referendum_base_case >}} of the campaign budget goes to [paid referral bonuses](/knowledge/strategy/global-referendum.qmd) that make sharing their link to vote financially attractive. It's a pyramid scheme where the thing at the top of the pyramid is not dying from preventable diseases.
...
- Year 2032: First treatments from the accelerated pipeline reach patients. Diseases that would have waited centuries for trials are getting tested now. Nobody is cured of everything, but the queue is finally moving. Humans experience the novel sensation of progress.
...
I ran the numbers on your species' habit of ignoring good ideas. The [institutionalization rate](#what-to-do-when-they-try-to-institutionalize-you) is {{< var chain_dismiss_probability >}}. Nine out of ten humans will dismiss this as crazy. The math doesn't care.

There are {{< var chain_global_billionaire_count_nounit >}} billionaires on your planet and {{< var chain_world_leader_count_nounit >}} heads of state. The [chain reaction model](knowledge/appendix/treaty-feasibility.qmd#sec-chain-reaction-model) shows that even with {{< var chain_dismiss_probability >}} dismissal, approximately {{< var chain_expected_engaged_implementers_nounit >}} of them will engage with this idea within {{< var chain_horizon_years_nounit >}} years. Not "might." Will. Your dismissal rate is a rounding error when multiplied by {{< var chain_implementer_count_nounit >}} opportunities.

And here is the part that should bother you: acting on this is a [dominant strategy](knowledge/appendix/treaty-feasibility.qmd#sec-dominant-strategy-proof). It produces a better outcome than inaction regardless of what anyone else does. If others act too, the treaty passes and you earn {{< var victory_bond_annual_return_pct >}} returns. If no one else acts, the expected return is still {{< var treaty_expected_roi_trial_capacity_plus_efficacy_lag >}}:1 at {{< var political_success_probability >}} success probability. Rational agents always choose dominant strategies. Not because they want to. Because not choosing them is what "irrational" means. The only way to reject this is to [falsify one of three premises](knowledge/appendix/treaty-feasibility.qmd#the-contrapositive), and you are welcome to try.

This exact combination (verified referral bonuses with real money attached, Incentive Alignment Bonds paying {{< var victory_bond_annual_return_pct >}} returns, Super PAC legal bribery, and a blockchain-tracked {{< var global_population_activism_threshold_pct >}} participation trigger) has literally never existed in 13.8 billion years of matter rearranging itself. The old base rates don't apply. Even if you price in only a {{< var political_success_probability >}} probability of the treaty actually passing, the expected return is still {{< var treaty_expected_vs_bed_nets_multiplier >}} better than the best charity humanity has ever funded. The numbers are simply too large to ignore.
...
This is happening whether you participate or not. The math is public. The incentives are structural. Someone in the chain will do exactly what you're deciding not to. The only variable you control is how long it takes. Every minute you spend thinking about it, {{< var global_disease_deaths_per_minute >}} permanently stop. You're not deciding whether to act. You're deciding how many people die while you hesitate.
...
Of all the consciousness that has ever flickered into existence across 13.8 billion years of matter rearranging itself, yours arose in the infinitesimal sliver of time where the loop broke. Every organism that ever lived and died did so in the dark. You get to be alive for the part where it worked.
...
One action: forward [The Message](knowledge/appendix/recruitment-and-propaganda-plan.qmd#the-message) to the most powerful person you know. Not a friend. The most powerful person. They know someone more powerful, who knows someone more powerful, and in about fifteen hops it reaches someone who can actually do this. Every hop matters. Every day you don't, {{< var global_disease_deaths_daily_nounit >}} more humans permanently stop. The whole plan runs on one instruction repeated: send this up. You already know you're going to.
