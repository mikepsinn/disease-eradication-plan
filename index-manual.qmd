...
Imagine {{< var diseases_without_effective_treatment >}} people standing in line at a pharmacy that serves 15 customers per year. That's the current clinical trial system. At this rate, the last person in line gets served in ~{{< var status_quo_queue_clearance_years >}}. They'll be dead by then. So will you. So will everyone.

The dFDA is like opening {{< var dfda_trial_capacity_multiplier >}} more registers. Suddenly the line moves {{< var dfda_trial_capacity_multiplier >}} faster. The ~{{< var status_quo_queue_clearance_years >}} wait becomes ~{{< var dfda_queue_clearance_years >}}.

This is "trial capacity." More trials = more diseases tested = more cures arrive sooner. The time saved is the "timeline shift." Every year of timeline shift means {{< var global_disease_deaths_daily >}} × 365 fewer humans permanently discontinued.
...
- {{< var dfda_trial_capacity_plus_efficacy_lag_lives_saved >}} humans who continue existing because cures arrive {{< var dfda_trial_capacity_plus_efficacy_lag_years >}} years sooner (that's more people than currently exist, which sounds fake but is just math)
