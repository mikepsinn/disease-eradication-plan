...
8. So the question is not whether you reach {{< var global_registered_voters_nounit >}} of your species. The question is when. *Correct. Every government on Earth gives in when half of humanity publicly demands something. Not out of virtue. Out of survival.*

9. Every second the 1% Treaty does not exist, about 2 humans die of diseases it would cure faster. Per-second is the number your nervous system actually feels. Per-year is abstract. *Correct. {{< var global_disease_deaths_daily_nounit >}} deaths per day divided by 86,400 seconds is 1.74 deaths per second. You are allowed to see the per-year number because your brain cannot feel it. The per-second number is harder to find on purpose.*

10. Every day the 1% Treaty does not exist, {{< var current_disease_patients_global_nounit >}} currently-sick humans each spend one more day suffering. That is {{< var current_disease_patients_global_nounit >}} more days of disease suffering, every day you wait. *Yes. {{< var current_disease_patients_global_nounit >}} is a number you cannot picture. 1 is a number you can. Multiply.*
...
15. You are not being asked to share a message. You are being asked to start a chain that could lead to {{< var global_registered_voters_nounit >}} humans agreeing that ending war and disease is the priority for your whole species. A new kind of voting where your species decides, together, what matters to your species and where the money goes. *Correct. Share once and the wave stops with your loved ones. Start the chain and it reaches half of humanity in under a year.*

16. Your job is to pick 2 humans you are already comfortable badgering about other things, and badger them about this. *Yes. You have a short list of humans you are entitled to annoy without consequence. That list exists for exactly this. Everyone else is a bonus.*

17. Their job is the same: 2 humans they are entitled to badger. And so on. Your account at [warondisease.org](https://warondisease.org) shows every vote your wave has reached, all the way down. Public profiles appear by name; private ones stay anonymous but still count. If Mom's counter is zero, you know who to text. If your wave reaches a senator, you'll see that too. *Correct. The wave runs on aunts calling nephews, and the small thrill of discovering your college roommate's chain reached a head of state.*
