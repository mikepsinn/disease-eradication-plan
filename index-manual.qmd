...
By the time you complete these steps, you will have prevented {{< var dfda_trial_capacity_plus_efficacy_lag_lives_saved >}} and {{< var dfda_trial_capacity_plus_efficacy_lag_suffering_hours >}} of suffering. 

To understand how, I need you to answer a few questions. 

1. It takes {{< var nuclear_winter_warhead_threshold_nounit >}} warheads to trigger nuclear winter and collapse your food system. You have {{< var global_warhead_count_nounit >}}. That is {{< var nuclear_winter_overkill_factor_nounit >}} apocalypses. You can only use one of them, because after the first one there is no civilization left to apocalypse. The other {{< var nuclear_winter_overkill_factor_nounit >}} minus 1 just sit there, being expensive. The [1% Treaty](knowledge/solution/1-percent-treaty.qmd) [@1-pct-treaty-impact-paper-2025] asks you to settle for {{< var nuclear_winter_overkill_factor_nounit >}} minus 1 apocalypses instead of {{< var nuclear_winter_overkill_factor_nounit >}}, in exchange for {{< var dfda_trial_capacity_multiplier >}} more clinical trials, which compresses disease eradication from {{< var status_quo_queue_clearance_years >}} to {{< var dfda_queue_clearance_years >}}. Would {{< var global_registered_voters_nounit >}} of your species prefer Option A ({{< var nuclear_winter_overkill_factor_nounit >}} apocalypses, several centuries of continued dying from curable diseases) or Option B ({{< var nuclear_winter_overkill_factor_nounit >}} minus 1 apocalypses, disease cured in their lifetime)?

2. Is disease just your meat breaking in predictable ways that can be fixed? *Yes. You find first treatments for {{< var new_disease_first_treatments_per_year_nounit >}} new diseases every year. {{< var diseases_without_effective_treatment_nounit >}} are still waiting. You have {{< var safe_compounds_count_nounit >}} known-safe medicinal compounds, of which {{< var unexplored_ratio >}} of their potential uses have never been tested. There is no physical law preventing disease eradication. There is only a funding law.*
...
4. Every major civilizational change that reached {{< var global_population_activism_threshold_pct >}} active support has succeeded. Slavery banned. Women's vote. Civil rights. Zero failures in the last century {{< var global_population_activism_threshold_pct_cite >}}. If 50% of your species demanded the apocalypse-for-disease trade, is it believable any government on Earth holds out? *No. {{< var global_population_activism_threshold_pct >}} is where your politics always breaks. 50% is 14 times that. No government survives defying half its own voters. They cannot even keep parking rules against half their voters.*
...
8. Is the question whether you reach {{< var global_registered_voters_nounit >}} of your species, or just when? *When. Every government on Earth gives in when half of humanity publicly demands something. Not out of virtue. Out of survival.*

9. If {{< var global_disease_deaths_daily_nounit >}} humans die of disease every day, and there are 86,400 seconds in a day, how many die every second we delay the eventual eradication of disease? *About 2. 1.74 to be exact. Per-second is the number your nervous system actually feels; per-year is abstract. The per-second number is harder to find on purpose.*

10. If {{< var current_disease_patients_global_nounit >}} humans are currently sick, how many more days of suffering does one day of delaying the eventual eradication of disease create? *{{< var current_disease_patients_global_nounit >}}. {{< var current_disease_patients_global_nounit >}} is a number you cannot picture. 1 is a number you can. Multiply.*

11. War and disease are extremely expensive. Every dollar spent on either of them is a dollar not spent on inventions that make your life better. One economy makes things. The other breaks them. Your species spends more on the breaking one, which should be embarrassing but somehow is not. If the 1% Treaty passed, would your lifetime income go up? *Yes. Over an average lifetime the typical human gains {{< var treaty_trajectory_lifetime_income_gain_per_capita >}}. Every day of waiting is one more day your money stays in the breaking economy instead of the making one.*
...
14. Can you think of anything else you could do with 30 seconds that would add more than {{< var treaty_trajectory_lifetime_income_gain_per_capita >}} to your own lifetime income? *You cannot. Your 30 seconds have never been this valuable.*

15. Are you being asked to share a message, or to start a chain that could lead to {{< var global_registered_voters_nounit >}} humans agreeing that ending war and disease is the priority for your whole species? A new kind of voting where your species decides, together, what matters and where the money goes. *A chain. Share once and the wave stops with your loved ones. Start the chain and it reaches half of humanity in under a year.*
...
That's the plan. 30 seconds × {{< var global_registered_voters_nounit >}} humans = the 1% Treaty exists = disease eradicated in decades instead of centuries.

What you trade: capacity for {{< var nuclear_winter_overkill_factor_nounit >}} minus 1 apocalypses instead of {{< var nuclear_winter_overkill_factor_nounit >}}. What you get: disease eradication in your lifetime plus {{< var treaty_trajectory_lifetime_income_gain_per_capita >}} in extra lifetime income.
...
Your regulatory system can make two mistakes: approve a bad drug (Type I error), or block a good drug (Type II error). Your FDA is terrified of the first mistake and completely ignores the second. I calculated the ratio: for every 1 person protected from a dangerous drug, {{< var type_ii_error_cost_ratio >}} people die waiting for a safe one that's locked in the approval cabinet. Even if you assume a Thalidomide-scale catastrophe happens during post-phase 1 efficacy testing every single year (even though it wouldn't because Phase I safety testing actually caught it anyway), the deaths from just the efficacy delay still outnumber the deaths from bad drugs by {{< var type_ii_error_cost_ratio >}} to 1. Your safety system's main product is dead patients.
...
- The RECOVERY trial tested 6 treatments on 48,000 patients for {{< var recovery_trial_cost_per_patient >}} per patient instead of the usual {{< var traditional_phase3_cost_per_patient >}} per patient. That's a {{< var recovery_trial_cost_reduction_factor >}} cost reduction. Not in theory. In reality. During a pandemic. While panicking. Your species does its best medical research when terrified and disorganized, which suggests your normal system is somehow worse than panic.
...
Go to [warondisease.org](https://warondisease.org) and cast your vote in the largest referendum in human history (fifteen seconds). Get two friends to do the same. That's how the doubling starts. Every minute of delay, {{< var global_disease_deaths_per_minute_nounit >}} humans permanently stop. Your vote saves {{< var voter_lives_saved >}} and prevents {{< var voter_suffering_hours_prevented >}} of suffering.
