...
For your 1% Treaty, these are called VICTORY Incentive Alignment Bonds. Remember when your grandparents funded WW2 by buying bonds? They got 4% returns and a world without Nazis (mostly). You're proposing the same thing except:
...
- **Defense Contractors**: Keep 99% of their murder budget PLUS get {{< var victory_bond_annual_return_pct >}} returns.
- **Big Pharma**: Instead of paying {{< var traditional_phase3_cost_per_patient >}} for phase 2 and 3 trials, the treaty pay THEM for each patient that joins their trials.
