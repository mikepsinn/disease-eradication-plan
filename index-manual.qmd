...
### What If This Plan Is Wrong

It probably is. We wrote it because competitions need a starting entry, not because we think two aliens and a human with a laptop produced the optimal governance reform for a species of eight billion. The [Earth Optimization Prize](/knowledge/strategy/least-bad-idea-prize-paper.qmd) is a standing bounty for whoever can beat it. Submit a better plan, prove it works, collect the money. The current plan is the Earth Optimization Plan v1. Yours is v2. Every dollar in the prize pool is one more human publicly saying "I think not dying is worth funding," which, given the pluralistic ignorance problem, might be worth more than the dollar itself. And because contributions are structured as assurance contracts, you get your money back with interest if the threshold is not met. You are betting on humanity with a full refund if humanity disappoints you, which, based on your track record, is a reasonable hedge.
