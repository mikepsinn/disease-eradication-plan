...
The dFDA is like opening {{< var dfda_trial_capacity_multiplier >}} more registers. Instead of {{< var new_disease_first_treatments_per_year >}} diseases getting their first treatment per year, it's {{< var dfda_first_treatments_per_year >}}. The ~{{< var status_quo_queue_clearance_years >}} wait becomes ~{{< var dfda_queue_clearance_years >}}.
...
- **Lives saved**: {{< var dfda_efficacy_lag_elimination_deaths_averted >}} (dFDA timeline shift) + {{< var treaty_lives_saved_annual_global >}}/year (peace dividend)
...
Unlike charity, which requires infinite begging to finite donors, this creates {{< var combined_peace_health_dividends_annual_for_roi_calc >}} annually while saving {{< var dfda_efficacy_lag_elimination_deaths_averted >}} lives (dFDA timeline shift), operating until the heat death of the universe or until humans evolve into beings of pure energy, whichever happens first (probably the heat death thing).
