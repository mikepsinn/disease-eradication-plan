...
description: This is the entire manual for ending war and disease, compressed into one chapter for humans with short attention spans. TL;DR: Your species spends 604 times more on killing each other than on figuring out which medicines work. This is how you fix that using the most powerful force in the universe: human greed.
published: true
...
- [After WW2, humans cut military spending by 30%](/knowledge/proof.qmd#post-ww2) and accidentally created the greatest economic boom in history. You're asking for 1%. Even people who really, really, love exploding people should be able to handle 1%.
