...
Before I explain how, please answer three questions. 

**One.** Your species spends {{< var military_to_clinical_trials_spending_ratio >}} times more on weapons than clinical trials. Is it physically possible to do better than this? (If "no," stop reading. You have worse problems than war.)

**Two.** If you reallocated even 1% and let it compound, everyone gets {{< var treaty_path_gdp_vs_earth_multiplier_year_20 >}} richer. Not spiritually. In money. Healthier workers produce more, and not destroying their workplaces also helps. It compounds the same way retirement accounts do. Do the benefits compound? ([Yes.](/knowledge/economics/gdp-trajectories.qmd))

**Three.** If moving 1% makes everyone {{< var treaty_path_gdp_vs_earth_multiplier_year_20 >}} richer, should getting it to one person who can act be a priority? Not altruism. Arithmetic.

If you answerd yes to all three, good! Then we're in agreement!

Here is what I find most interesting about your species. Every minute between now and the moment one person with resources reads the math, {{< var global_disease_deaths_per_minute_nounit >}} people die. You just agreed the five questions have no wrong answer. On my planet, we would call this a scheduling problem. You appear to call it "the way things are."
