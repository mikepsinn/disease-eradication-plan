...
Rankings are based on frequency and magnitude of health outcome changes across all patients - or filtered to patients most similar to you.
...
[Your decentralized framework for drug assessment](/knowledge/solution/dfda.qmd) fixes that with **[Outcome Labels](/knowledge/solution/dfda.qmd)** - simple, evidence-based summaries showing exactly what happens when real people try a treatment:
...
Scientists discovered that when [3.5% of any population](/knowledge/strategy/global-referendum.qmd) wants something, they often get it.

Cost per click: $0.50. The pyramid scheme aspect: everyone recruits everyone else because money.
