...
Your species spends {{< var military_to_government_clinical_trials_spending_ratio >}} times more on weapons than on testing which medicines work. If all nations redirected 1% of military spending to increasing clinical trial capacity by {{< var dfda_trial_capacity_multiplier >}}, would that help find treatments faster? Would fewer sick humans save lots of money from reduced healthcare costs? Do healthy people work and produce more? Would more productive humans and lower healthcare costs compound into a larger economy over time? Do billionaires like money? Would billionaires have more money if the economy was larger? Do billionaires prefer not dying of disease? Can billionaires use money to make politicians do things? Would nearly every human be better off in a world with less war and disease? Do humans like to be better off?

If you said NO to any of those, stop reading now. This book is pointless and you'd be better off playing legos instead.

But if you said YES to all of them, congratulations! You just proved the rest of this manual works. The only remaining question is the how.
...
Over an average remaining lifespan, reallocation from the destructive economy to reducing the burden of disease and the associated compound growth from increased productivity multiplies your cumulative earnings by {{< var treaty_path_lifetime_income_multiplier >}}.
