...
- **Investors**: {{< var victory_bond_annual_return_pct >}} returns, which they will assume is a typo until you show them the math. Returns scale with every treaty expansion, so investors become the world's most aggressive pro-health and anti-war lobbying force. Not a sentence anyone expected to write.
