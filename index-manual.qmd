...
You spend {{< var treaty_campaign_budget_lobbying >}} in papers on Super PACs, which are like regular PACs but with capes. You explain to politicians that {{< var treaty_campaign_voting_bloc_target >}} million voters have discovered they enjoy being alive.
...
Imagine {{< var diseases_without_effective_treatment >}} people standing in line at a pharmacy that serves {{< var new_disease_first_treatments_per_year >}} customers per year. At this rate, the last person in line gets served in ~{{< var status_quo_queue_clearance_years >}}. They'll be dead by then. So will you. So will everyone.

Pragmatic trials at scale are like opening {{< var dfda_trial_capacity_multiplier >}} more registers. Instead of {{< var new_disease_first_treatments_per_year >}} diseases getting their first treatment per year, it's {{< var dfda_first_treatments_per_year >}}. The ~{{< var status_quo_queue_clearance_years >}} wait becomes ~{{< var dfda_queue_clearance_years >}}.

This is "trial capacity." More trials = more diseases tested = more first effective treatments arrive sooner. The time saved is the "timeline shift." Every year of timeline shift means {{< var global_disease_deaths_daily >}} × 365 fewer humans permanently discontinued.
...
The same fund that pays investors also pays for politician incentives. Both get {{< var victory_bond_funding_pct >}} of treaty revenue. When Senator Smith votes YES, their Public Good Score rises, independent Super PACs spend $2M supporting their reelection, and post-office opportunities unlock (fellowships, advisory boards, speaking circuits worth $200K-$500K/year). No money goes to politicians directly. What flows is reputation, electoral advantage, and career advancement. Investors aren't gambling on politicians becoming altruistic. They're gambling on politicians being self-interested.
...
Politicians are simple organisms with one evolutionary drive: reelection. You exploit this with {{< var treaty_campaign_budget_super_pacs >}} in Super PAC papers.
...
![A column chart comparing standard high-return investments against a 'self-funding' model where the cost basis reaches zero, resulting in an infinite ROI.](/assets/images/index-manual/index-manual-section-where-math-breaks-bw-academic.jpg)
...
{{< var treaty_redirected_spending_infinite_roi_latex >}}
...
- **Health dividend**: {{< var dfda_benefit_rd_only_annual >}} (money saved by not paying 10,000 people to document why 1 person is dying)
...
([See peace dividend calculation](knowledge/economics/peace-dividend.qmd) | [See dFDA health benefits breakdown](knowledge/appendix/dfda-impact-paper.qmd) | [See economic impact summary](knowledge/economics/1-pct-treaty-impact.qmd))
...
- **You get back**: {{< var combined_peace_health_dividends_annual_for_roi_calc >}} annually
- **Operating costs**: {{< var treaty_total_annual_costs >}}/year (less than a single fighter jet)
- **Lives saved**: {{< var dfda_efficacy_lag_elimination_deaths_averted >}} (timeline shift) + {{< var treaty_lives_saved_annual_global >}}/year (peace dividend)
...
Unlike charity, which requires infinite begging to finite donors, this creates {{< var combined_peace_health_dividends_annual_for_roi_calc >}} annually while saving {{< var dfda_efficacy_lag_elimination_deaths_averted >}} lives (first treatment timeline shift from increased trial capacity), operating until the heat death of the universe or until humans evolve into beings of pure energy, whichever happens first (probably the heat death thing).
...
The {{< var combined_peace_health_dividends_annual_for_roi_calc >}} annual benefit is like finding out your lottery ticket is also a cure for cancer and makes you better looking.
...
- **You personally could get {{< var effective_hourly_rate_lifetime_benefit >}} in lifetime wealth and extra years of life** (yes, you specifically)
