...
8. So the question is not whether you reach {{< var global_coordination_target_supporters_nounit >}}. The question is when. *Correct. Every government on Earth gives in when half of humanity publicly demands something. Not out of virtue. Out of survival.*
...
14. Can you think of anything else you could do with 30 seconds that would add more than {{< var treaty_trajectory_lifetime_income_gain_per_capita >}} to your own lifetime income? *You cannot. Your 30 seconds have never been this valuable. They will never be this valuable again.*

15. You are not being asked to share a message. You are being asked to start a chain that could lead to {{< var global_coordination_target_supporters_nounit >}} humans agreeing that ending war and disease is the priority for your whole species. A new kind of voting where your species decides, together, what matters to your species and where the money goes. *Correct. Share once and the wave stops with your loved ones. Start the chain and it reaches half of humanity in under a year, and may permanently upgrade how your species decides anything.*
...
That's the plan. 30 seconds × {{< var global_coordination_target_supporters_nounit >}} humans = the 1% Treaty exists = disease eradicated in decades instead of centuries.
