...
By the time you complete the steps in this manual, you will have prevented {{< var dfda_trial_capacity_plus_efficacy_lag_lives_saved >}} and {{< var dfda_trial_capacity_plus_efficacy_lag_suffering_hours >}} of suffering. By the time you finish *not* reading, you will have caused them. There is no third option. You opened the manual. The math is already your fault. The last 346 species I showed these numbers to said "that can't be right" and then went extinct. So I would strongly encourage you to read quickly.

Before I explain how, answer five questions. They take thirty seconds. Try to get one wrong.

**One.** Your species spends {{< var military_vs_medical_research_ratio >}} times more on weapons than medical research. Is it physically possible to do better than this? (If "no," stop reading. You have worse problems than war.)

**Two.** If you reallocated even 1% and let it compound, everyone gets {{< var treaty_path_gdp_vs_earth_multiplier_year_20 >}} richer. Not spiritually. In money. Do the benefits compound? ([Yes.](/knowledge/economics/gdp-trajectories.qmd))
...
**Four.** If moving 1% makes everyone {{< var treaty_path_gdp_vs_earth_multiplier_year_20 >}} richer, should getting it to one person who can act be a priority? Not altruism. Arithmetic.

**Five.** Then what are you waiting for?

If you answered honestly, you just agreed that ending war and disease is physically possible, compounding, unmatched, urgent, and waiting on one thing: the argument reaching one self-interested person with a checkbook. On Wishonia, this is the [Logical Inevitability Theorem](/knowledge/appendix/recruitment-and-propaganda-plan.qmd#logical-inevitability-theorem). The outcome is inevitable. The only variable is propagation speed.

Here is the part that should make you uncomfortable. Every minute between now and the moment one investor reads the math, {{< var global_disease_deaths_per_minute_nounit >}} people die. You just agreed the five questions have no wrong answer. The deaths are not a tragedy. They are a scheduling delay. Yours.
...
You already answered the [five questions](/knowledge/appendix/recruitment-and-propaganda-plan.qmd#logical-inevitability-theorem). You know "stop" isn't the unrealistic part. Getting one billionaire to read a PDF is.
...
Over an average remaining lifespan, the treaty path alone multiplies your cumulative earnings by {{< var treaty_path_lifetime_income_multiplier >}}. The full Wishonia path reaches {{< var wishonia_path_lifetime_income_multiplier >}}. For the average human, the treaty gains {{< var treaty_path_lifetime_income_gain_per_capita >}} in additional lifetime income; the Wishonia path gains {{< var wishonia_path_lifetime_income_gain_per_capita >}}. These are not projections. They are the compound interest on not spending {{< var military_vs_medical_research_ratio >}} times more on weapons than medicine. Your species invented compound interest and then pointed it at the wrong spreadsheet.
...
- Year 2048: The [model projects](knowledge/economics/gdp-trajectories.qmd) everyone {{< var wishonia_path_gdp_vs_earth_multiplier_year_20 >}} richer than the path you're currently on. Your children ask what "war" means. You change the subject.
...
That's the [Logical Inevitability Theorem](/knowledge/appendix/recruitment-and-propaganda-plan.qmd#logical-inevitability-theorem) with numbers attached. The [five questions](/knowledge/appendix/recruitment-and-propaganda-plan.qmd#logical-inevitability-theorem) still have no wrong answer.
...
This is happening whether you participate or not. The math is public. The incentives are structural. Someone in the chain will do exactly what you're deciding not to. The only variable you control is how long it takes. Each year of delay is a year the compounding hasn't started, which costs the average human {{< var treaty_path_lifetime_income_gain_per_capita >}} in lifetime income they will never recover. You're not deciding whether to act. You're deciding how many people die and how much poorer everyone stays while you hesitate.
...
Share this the most powerful person you know right now. Not a friend. The most powerful person. They know someone more powerful, who knows someone more powerful, and in about fifteen hops it reaches someone who can actually do this. Every minute this plan is delayed, {{< var global_disease_deaths_per_minute_nounit >}} more humans permanently stop. You are now the delay. The whole plan runs on one instruction repeated: send this up. You already know you're going to.
