...
Also, under the current system, there is is 8 year delay between when a drug is found to be safe via Phase I trials and when patients can actually take it. It's like a lifeguard who checks if the life preserver is safe while {{< var type_ii_error_cost_ratio >}} people drown.
...
Just cold, hard data about whether this chemical makes your meat robot work better or worse.
...
- [The RECOVERY trial](/knowledge/appendix/recovery-trial.qmd) tested 6 treatments on 47,000 patients for {{< var recovery_trial_cost_per_patient >}}/patient (vs {{< var traditional_phase3_cost_per_patient >}} standard), demonstrating a {{< var recovery_trial_cost_reduction_factor >}} cost reduction. Not in theory. In reality. A systematic review of pragmatic trials found a median cost of {{< var pmc_pragmatic_trial_median_cost_per_patient >}}/patient {{< var pmc_pragmatic_trial_median_cost_per_patient_cite >}}.
- **You've Done This Before**: [After WW2, humans cut military spending by 30%](/knowledge/proof.qmd#post-ww2) and inadvertently created the greatest economic boom in history. You're only asking for 1%.
...
- **The ROI**: The conservative return from R&D cost savings alone: {{< var dfda_roi_rd_only >}}:1. The full benefit including timeline shift: {{< var treaty_roi_trial_capacity_plus_efficacy_lag >}}:1. Your calculator will display an error. This is correct.
...
This beats smallpox eradication (280:1) and childhood vaccinations (13:1), which were humanity's previous greatest hits in the "not dying" genre. It's {{< var treaty_vs_bed_nets_multiplier >}} more cost-effective than bed nets, the gold standard for keeping humans alive. Full methodology, timeline shift analysis, and the numbers that make Excel cry available at [https://impact.warondisease.org](https://impact.warondisease.org).
...
Investors fund the campaign. The treaty unlocks {{< var treaty_annual_funding >}} annually from the murder budget. Investors get {{< var victory_bond_funding_pct >}} because they had the revolutionary idea of "what if we didn't all die?" The same fund that pays investors also pays for politician incentives. [Full financial mechanics](/knowledge/solution/incentive-alignment-bonds.qmd).
...
- 150,000 people continue dying every single day from diseases humans could fix
...
- Investors and politicians both profit from cures instead of bombs
...
<!-- P.S. This book costs $9.99, which is just papers with numbers on them. You're trading papers for instructions on getting infinite papers. This paradox doesn't bother you because you've never thought about it. Please continue not thinking about it. -->
