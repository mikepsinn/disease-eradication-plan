...
I ran the numbers on both paths. You can see the full scorecard in [Choose Your Own Adventure](#choose-your-own-adventure). The short version: redirecting 1% of murder money makes you {{< var treaty_path_gdp_vs_earth_multiplier_year_20 >}} richer. Redirecting all the dysfunction makes you {{< var wishonia_path_gdp_vs_earth_multiplier_year_20 >}} richer. Your economists will say these numbers are impossible. Your economists also didn't predict the internet, the smartphone, or the 2008 financial crisis, so their track record on "impossible" is not great.
...
If this sounds familiar, it should. Eisenhower warned you about the Military Industrial Complex: military contractors fund politicians, politicians fund military contracts, contracts fund contractors, contractors fund politicians. It's a self-sustaining loop that prints money and corpses.
...
Right now, Earth is on track for {{< var earth_avg_income_year_20 >}} average income by year 20. That's your baseline. The Treaty Path, where you just move the murder money to medicine money, gets you to {{< var treaty_path_avg_income_year_20 >}}, which is {{< var treaty_path_gdp_vs_earth_multiplier_year_20 >}} your current trajectory.

Then there's the Wishonia Path. On my planet, we liked incentive alignment bonds so much we didn't stop at murder money. We pointed them at everything: the 40% of your government budgets that evaporate into paperwork, the regulations written before you discovered electricity, the nine agencies that all do the same thing but won't return each other's calls.

Turns out when you pay people to fix problems instead of perpetuate them, they fix the problems. We were as surprised as anyone. That path gets you to {{< var wishonia_path_avg_income_year_20 >}} average income, which is {{< var wishonia_path_gdp_vs_earth_multiplier_year_20 >}} your baseline. One path is "stop murdering." The other is "stop murdering AND stop being stupid." Both are improvements.
