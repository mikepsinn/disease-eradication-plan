...
This exact combination (real money for sharing, bonds paying {{< var victory_bond_annual_return_pct >}} returns, legal bribery via Super PAC, and a {{< var global_population_activism_threshold_pct >}} trigger that activates the treaty) has never existed on your planet before. On the 847 planets where I've deployed versions of this, the ones that used it survived. The ones that didn't are asteroids now. Even if you assume only a {{< var political_success_probability >}} chance of the treaty actually passing (because you're you), the expected return is still {{< var treaty_expected_vs_bed_nets_multiplier >}} better than the best charity humanity has ever funded. The numbers are too large to ignore, which is why you're still reading.
