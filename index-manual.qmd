...
Before I explain how, I need you to answer five questions. Try to get any of them wrong.

Your species spends {{< var military_to_government_clinical_trials_spending_ratio >}} times more on weapons than on testing which medicines work. If all nations redirected 1% of that to clinical trials, would trial capacity increase by {{< var dfda_trial_capacity_multiplier >}}? Would fewer sick humans mean more productive humans? Would more productive humans compound into a larger economy over time? Do billionaires prefer not dying of disease? Can billionaires use money to make politicians do things?

If any of those are false, stop reading. This book is wrong.

If you said yes to all five, congratulations: you just proved the rest of this manual works. The only remaining question is the how.
