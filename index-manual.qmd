...
"But humans would never agree to that!" You already have. Multiple times. You banned chemical weapons (1993, 193 countries). You banned biological weapons (1975, 187 countries). You banned nuclear testing (1996, 187 countries). You've signed treaties banning weapons you actually like using. This one just asks you to buy 1% fewer of them.

### Your [dFDA](/knowledge/solution/dfda.qmd)

So where does the money go? Not to a committee of humans giving their friends grants to write papers about diseases. Most of the {{< var treaty_annual_funding >}} goes directly to subsidizing patient participation in pragmatic trials at {{< var dfda_pragmatic_trial_cost_per_patient >}}/patient instead of the usual {{< var traditional_phase3_cost_per_patient >}}. Patients choose which trials to join; their subsidy follows them. Providers get paid for each participant. No grant committees deciding which diseases are fashionable this year. You invented this system for restaurants (it's called Yelp). Now do it for not dying.
...
- [The RECOVERY trial](/knowledge/appendix/recovery-trial.qmd) tested 6 treatments on 47,000 patients for {{< var recovery_trial_cost_per_patient >}} instead of the usual {{< var traditional_phase3_cost_per_patient >}}. That's a {{< var recovery_trial_cost_reduction_factor >}} cost reduction. Not in theory. In reality. During a pandemic. While panicking.
...
That's 280 million humans. Sounds like a lot until you remember that more than 10 times as many of you downloaded TikTok to watch people twerk. You can get 280 million to click "yes" on not dying. {{< var treaty_campaign_viral_referendum_base_case >}} of the campaign budget goes to [paid referral bonuses](/knowledge/strategy/global-referendum.qmd) that make sharing the vote financially attractive. It's a pyramid scheme where the thing at the top of the pyramid is not dying from preventable diseases.
