...
That's the [Logical Inevitability Theorem](/knowledge/appendix/recruitment-and-propaganda-plan.qmd#logical-inevitability-theorem) with numbers attached. The theorem doesn't need {{< var chain_global_billionaire_count_nounit >}} billionaires. It needs one. And the [five questions](/knowledge/appendix/recruitment-and-propaganda-plan.qmd#logical-inevitability-theorem) still have no wrong answer.
